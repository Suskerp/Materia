    ...
    `}_uv(){const t=this._value("uv_index");if(null==t)return W;const e=ze.find(e=>t<=e.max),i=ze.map((t,i)=>{const s=(160-35*i)*Math.PI/180,o=50+23.5*Math.cos(s),n=52+23.5*Math.sin(s),a=t===e;return H`<circle cx=${o} cy=${n} r=${a?4.5:2.6}
      ...
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          ...
          <path d=${Wt(50,52,32,12)} class="shape-fill uv-fill" />
          ${i}
        </svg>
        <div class="overlay">
