...
`;function St(t){return t&&"string"==typeof t&&(t.includes("{{")||t.includes("{%"))}class Et extends at{static properties={hass:{attribute:!1},lovelace:{attribute:!1},_config:{state:!0},_selectedCard:{state:!0},_expandedButton:{state:!0}};static styles=n`
  ...
  `;setConfig(t){this._config=t,this._selectedCard=-1,this._expandedButton=null}get _mainSchema(){const t=this._config?.entity?.split(".")[0],e="cover"===t,i="light"===t;return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{template:{}}},{name:"subtitle",selector:{template:{}}},{name:"icon",selector:{template:{}},context:{icon_entity:"entity"}},{name:"columns",selector:{number:{min:1,max:6,mode:"slider"}}},...i||e?[{name:"show_slider",selector:{boolean:{}}}]:[],...i?[{name:"slider_turn_off",label:"Slider can turn off",selector:{boolean:{}}}]:[],{name:"show_sub_buttons",selector:{boolean:{}}},...e?[{name:"show_stop",label:"Show stop",selector:{boolean:{}}}]:[],{name:"color",selector:{template:{}}},{name:"color_on",selector:{template:{}}},{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}}]}_subButtonSchema(t){return[St(t?.icon)?{name:"icon",required:!0,selector:{template:{}}}:{name:"icon",required:!0,selector:{icon:{}}},{name:"name",label:"Label (optional)",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}render(){if(!this.hass||!this._config)return L``;const t=this._config.cards||[],e=t.length,i=this._selectedCard,o=i===e,s=i>=0&&i<e,n=Array.isArray(this._config.sub_buttons)?this._config.sub_buttons:[],a={columns:2,...xt(this._config)};return L`
      <ha-form
        .hass=${this.hass}
        .data=${a}
        .schema=${this._mainSchema}
