...
`;let ht;class dt extends nt{static properties={min:{type:Number},max:{type:Number},value:{type:Number},step:{type:Number},color:{type:String},trackColor:{type:String},disabled:{type:Boolean},liveUpdate:{type:Boolean,attribute:"live-update"}};static styles=o`
    :host {
      display: block;
      width: 100%;
  ...
  `;constructor(){super(),this.min=0,this.max=100,this.value=0,this.step=1,this.color="",this.trackColor="",this.disabled=!1,this.liveUpdate=!1,this._debounceTimer=null}get _fillColor(){return this.color||"var(--slider-color)"}get _trackColor(){return this.trackColor||"var(--slider-track-color)"}get _percentage(){const t=this.max-this.min;return 0===t?0:(this.value-this.min)/t*100}render(){const t=this._percentage,e=`linear-gradient(to right, ${this._fillColor} ${t}%, ${this._trackColor} ${t}%)`;return j`
    ...
    `}_onInput(t){const e=parseFloat(t.target.value);this.liveUpdate&&(clearTimeout(this._debounceTimer),this._debounceTimer=setTimeout(()=>{this._fireValueChanged(e)},100))}_onChange(t){clearTimeout(this._debounceTimer);const e=parseFloat(t.target.value);this._fireValueChanged(e)}_fireValueChanged(t){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t},bubbles:!0,composed:!0}))}}customElements.define("materia-slider",dt);const ut=t=>class extends t{_handleAction(t){if(t&&"none"!==t.action)switch(t.action){case"toggle":this.config?.entity&&this.hass.callService("homeassistant","toggle",{entity_id:this.config.entity});break;case"call-service":{const[e,i]=(t.service||"").split(".",2);e&&i&&this.hass.callService(e,i,{...t.service_data,...t.data},t.target);break}case"navigate":history.pushState(null,"",t.navigation_path),this.dispatchEvent(new Event("location-changed",{bubbles:!0,composed:!0}));break;case"more-info":this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t.entity||this.config?.entity}}))}}_fireMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}},pt=t=>t.name.replace(/_/g," ").replace(/^\w/,t=>t.toUpperCase());customElements.define("materia-light-switch-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
      ...
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class mt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-light-switch-editor")}static getStubConfig(){return{entity:"",name:"",icon:"mdi:track-light"}}static styles=o`
    :host { display: block; }
    ha-card {
  ...
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={icon:"mdi:track-light",...t}}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e="on"===t.state,i=this.config.name||t.attributes.friendly_name||this.config.entity,s=e?"On":"Off",a=e?"var(--md-sys-cust-color-on-light)":"var(--primary-text-color)";return j`
      <ha-card
        style="background-color: ${e?"var(--md-sys-cust-color-light-container)":"var(--ha-card-background)"}; color: ${a};"
    ...
    `}_handleTap(){this.hass.callService("light","toggle",{entity_id:this.config.entity})}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-light-switch",mt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-light-switch",name:"Materia Light Switch",description:"A native Lit light toggle switch card."});customElements.define("materia-light-dimmer-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
  ...
  `}customElements.define("materia-light-dimmer",gt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-light-dimmer",name:"Materia Light Dimmer",description:"A dimmable light slider card"});customElements.define("materia-cover-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"cover"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"show_stop",selector:{boolean:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class ft extends(ut(nt)){static properties={hass:{attribute:!1},_config:{state:!0}};static getConfigElement(){return document.createElement("materia-cover-editor")}static getStubConfig(){return{entity:"",name:"",icon:"mdi:window-shutter",show_stop:!0}}setConfig(t){if(!t.entity)throw new Error("entity is required");this._config={icon:"mdi:window-shutter",show_stop:!0,...t}}get _entity(){return this.hass?.states?.[this._config?.entity]}get _isOpen(){return"closed"!==this._entity?.state}get _position(){return this._entity?.attributes?.current_position??0}get _name(){return this._config.name||this._entity?.attributes?.friendly_name||""}get _icon(){return this._config.icon||"mdi:window-shutter"}get _stateDisplay(){const t=this._position;return 0===t?"Closed":100===t?"Open":`${t}% open`}_onSliderChanged(t){this.hass.callService("cover","set_cover_position",{entity_id:this._config.entity,position:t.detail.value})}_openCover(){this.hass.callService("cover","open_cover",{entity_id:this._config.entity})}_stopCover(){this.hass.callService("cover","stop_cover",{entity_id:this._config.entity})}_closeCover(){this.hass.callService("cover","close_cover",{entity_id:this._config.entity})}render(){if(!this._config||!this.hass)return j``;const t=this._isOpen;return j`
      <ha-card
        style=${t?"background-color: var(--md-sys-cust-color-light-container); color: var(--md-sys-cust-color-on-light);":""}
      >
        ...
        <div class="controls">
          <materia-slider
            ...
            .color=${t?"var(--md-sys-cust-color-light)":""}
            @value-changed=${this._onSliderChanged}
          ></materia-slider>
          <div class="buttons">
  ...
  `}customElements.define("materia-cover",ft),window.customCards=window.customCards||[],window.customCards.push({type:"materia-cover",name:"Materia Cover",description:"A cover card with position slider and up/stop/down controls"});customElements.define("materia-device-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"button_type",selector:{select:{options:["switch","state"]}}},{name:"active_state",selector:{text:{}}},{name:"color_active",selector:{text:{}}},{name:"color_on_active",selector:{text:{}}},{name:"show_state",selector:{boolean:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class vt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-device-editor")}static getStubConfig(){return{entity:"",name:"",icon:"mdi:power-plug",button_type:"switch",active_state:"on",show_state:!0}}static styles=o`
    :host { display: block; }
    ha-card {
      border-radius: var(--ha-card-border-radius, 18px);
      padding: 12px 16px;
    ...
    .name { font-size: 14px; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .state { font-size: 12px; opacity: 0.7; margin-top: 2px; }
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={icon:"mdi:power-plug",button_type:"switch",active_state:"on",color_active:"var(--md-sys-cust-color-device-container)",color_on_active:"var(--md-sys-cust-color-on-device)",show_state:!0,...t}}_isActive(t){if(!t)return!1;const e=t.state,i=this.config.active_state||"on";return e===String(i)||"open"===e}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=this._isActive(t),i=this.config.name||t.attributes.friendly_name||this.config.entity,s=e?this.config.color_active:"var(--ha-card-background)",a=e?this.config.color_on_active:"var(--primary-text-color)";return j`
      <ha-card
      ...
      >
        ...
        <div class="info">
          <div class="name">${i}</div>
          ${this.config.show_state?j`<div class="state">${t.state}</div>`:""}
        </div>
      </ha-card>
    `}_handleTap(){this.config.tap_action?this._handleAction(this.config.tap_action):this.hass.callService("homeassistant","toggle",{entity_id:this.config.entity})}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-device",vt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-device",name:"Materia Device",description:"A native Lit generic device/switch card with active-state colors."});customElements.define("materia-lock-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"lock"}}},{name:"name",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class _t extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-lock-editor")}static getStubConfig(){return{entity:"",name:""}}static styles=o`
    :host { display: block; }
    ha-card {
      border-radius: var(--ha-card-border-radius, 18px);
      padding: 12px 16px;
    ...
    .name { font-size: 14px; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .state { font-size: 12px; opacity: 0.7; margin-top: 2px; }
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e="locked"===t.state,i=this.config.name||t.attributes.friendly_name||this.config.entity,s=e?"m3o:lock":"m3o:lock-open-right",a=t.state.charAt(0).toUpperCase()+t.state.slice(1),o=e?"var(--md-sys-cust-color-on-device)":"var(--primary-text-color)";return j`
      <ha-card style="background-color: ${e?"var(--md-sys-cust-color-device-container)":"var(--ha-card-background)"}; color: ${o};">
    ...
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-lock",_t),window.customCards=window.customCards||[],window.customCards.push({type:"materia-lock",name:"Materia Lock",description:"A native Lit lock display card with conditional icons."});customElements.define("materia-battery-low-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class yt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-battery-low-editor")}static getStubConfig(){return{entity:"",name:""}}static styles=o`
    :host { display: block; }
    ha-card {
      border-radius: var(--ha-card-border-radius, 18px);
      padding: 12px 16px;
    ...
    .name { font-size: 14px; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .state { font-size: 12px; opacity: 0.7; margin-top: 2px; }
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}_getBatteryColors(t){return t<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:t<20?["var(--md-sys-cust-color-warning-container)","var(--md-sys-cust-color-on-warning-container)"]:["var(--ha-card-background)","var(--primary-text-color)"]}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=parseFloat(t.state)||0,i=this.config.name||t.attributes.friendly_name||this.config.entity,s=t.attributes.unit_of_measurement||"%",a=`${t.state}${s}`,[o,n]=this._getBatteryColors(e);return j`
      <ha-card style="background-color: ${o}; color: ${n};">
        <ha-icon icon="m3o:battery-android-alert" style="color: ${n};"></ha-icon>
        <div class="info">
          <div class="name">${i}</div>
          <div class="state">${a}</div>
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 1}}customElements.define("materia-battery-low",yt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-battery-low",name:"Materia Battery Low",description:"A native Lit low battery alert card with color thresholds."});customElements.define("materia-room-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"entity_type",selector:{select:{options:["light","cover"]}}},{name:"columns",selector:{number:{min:1,max:6}}},{name:"color_on",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        <div class="collapsible ${this._expanded?"expanded":""}">
          <div class="collapsible-inner">
            <div class="grid" style="--room-columns: ${i}">
              ${this._childCards?.map(t=>j`<div class="grid-item">${t}</div>`)}
            </div>
          </div>
        </div>
      </ha-card>
    `}_renderSubButtons(){const t=this._config.sub_button;return t&&Array.isArray(t)&&0!==t.length?t.map(t=>j`
        <ha-icon
          class="sub-btn"
        ...
        ></ha-icon>
      `):j``}getCardSize(){return this._expanded?3+(this._childCards?.length||0):2}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `}customElements.define("materia-room",bt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-room",name:"Materia Room",description:"A native expandable room section with title and grid of child cards"});customElements.define("materia-climate-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"name",required:!0,selector:{text:{}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}},{name:"outdoor_temp_entity",selector:{entity:{domain:"sensor"}}},{name:"step",selector:{number:{min:.5,max:5,step:.5,mode:"box"}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate",name:"Materia Climate",description:"A native climate thermostat card with mode-based theming"});customElements.define("materia-pill-toggle-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"left_name",selector:{text:{}}},{name:"right_name",selector:{text:{}}},{name:"left_state",selector:{text:{}}},{name:"right_state",selector:{text:{}}},{name:"left_service",required:!0,selector:{text:{}}},{name:"right_service",required:!0,selector:{text:{}}},{name:"height",selector:{text:{}}},{name:"color_active",selector:{text:{}}},{name:"color_on_active",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
    ...
    `}getCardSize(){return 2}static get styles(){return[lt,o`
      ...
      `]}}),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill-toggle",name:"Materia Pill Toggle",description:"A two-option pill toggle for any entity"});customElements.define("materia-sensor-row-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"name",required:!0,selector:{text:{}}},{name:"padding",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class xt extends(ut(nt)){static get properties(){return{hass:{attribute:!1},_config:{state:!0}}}static getConfigElement(){return document.createElement("materia-sensor-row-editor")}static getStubConfig(){return{entity:"",name:"",padding:"0px 20px"}}get config(){return this._config}setConfig(t){if(!t.entity)throw new Error("entity is required");if(!t.name)throw new Error("name is required");this._config={padding:"0px 20px",...t}}connectedCallback(){super.connectedCallback(),ct()}_handleTap(){this.hass&&this._config.tap_action&&this._handleAction(this._config.tap_action)}render(){if(!this.hass||!this._config)return j``;const t=this._config,e=this.hass.states[t.entity];if(!e)return j`<ha-card>Entity not found: ${t.entity}</ha-card>`;const i=e.state,s=e.attributes.unit_of_measurement||"",a=s?`${i} ${s}`:i,o=!!t.tap_action;return j`
      <ha-card
        class="${o?"clickable":""}"
    ...
    `}getCardSize(){return 1}static get styles(){return[lt,o`
        ha-card {
          box-shadow: none;
          border-radius: 18px;
        }
      ...
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class $t extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(){return{entity:""}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=t.state,i=t.attributes.temperature,s=t.attributes.temperature_unit||"°",a=wt[e]||"mdi:weather-partly-cloudy";let o=null;if(this.config.humidity_entity){const t=this.hass.states[this.config.humidity_entity];t&&(o=t.state)}null==o&&null!=t.attributes.humidity&&(o=t.attributes.humidity);const n=e.replace(/-|_/g," ");return j`
      <ha-card @click=${this._handleTap}>
        <div class="row">
          <ha-icon .icon=${a}></ha-icon>
          <div class="info">
            <div class="temp">${null!=i?`${i}${s}`:"—"}</div>
            <div class="condition">${n}</div>
          </div>
          ${null!=o?j`<div class="details">${o}%<br />humidity</div>`:""}
        </div>
      </ha-card>
    `}_handleTap(){this.config.tap_action?this._handleAction(this.config.tap_action):this._fireMoreInfo(this.config.entity)}getCardSize(){return 1}}customElements.define("materia-weather",$t),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather",name:"Materia Weather",description:"Weather display card with condition icons and humidity."});customElements.define("materia-sensor-display-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"unit",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Ct extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-sensor-display-editor")}static getStubConfig(){return{entity:"",name:"",icon:""}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}_classify(t){const e=this.config.ranges||[],i=parseFloat(t);for(const t of e)if(null==t.max||i<=t.max)return{label:t.label,color:t.color};return{label:"",color:""}}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=t.state,i=this.config.name||t.attributes.friendly_name||this.config.entity,s=this.config.icon||t.attributes.icon||"",a=this.config.unit||t.attributes.unit_of_measurement||"",o=this._classify(e);return j`
    ...
    `}_handleTap(){this.config.tap_action?this._handleAction(this.config.tap_action):this._fireMoreInfo(this.config.entity)}getCardSize(){return 1}}customElements.define("materia-sensor-display",Ct),window.customCards=window.customCards||[],window.customCards.push({type:"materia-sensor-display",name:"Materia Sensor Display",description:"Sensor display with range-to-label classification (AQI, etc.)."});customElements.define("materia-button-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}},{name:"variant",selector:{select:{options:[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"},{value:"device",label:"Device"},{value:"primary-container",label:"Primary Container"},{value:"secondary-container",label:"Secondary Container"},{value:"error-container",label:"Error Container"},{value:"device-container",label:"Device Container"},{value:"battery",label:"Battery"}]}}},{name:"show_state",selector:{boolean:{}}},{name:"active_state",selector:{text:{}}},{name:"state_display",selector:{text:{}}},{name:"color",selector:{text:{}}},{name:"color_on",selector:{text:{}}},{name:"color_map",selector:{text:{}}},{name:"color_on_map",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});const Et={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-secondary)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-error)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]};class kt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-button-editor")}static getStubConfig(){return{name:"",icon:"mdi:power-plug",variant:"primary",show_state:!1,active_state:"on"}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config={show_state:!1,active_state:"on",variant:"secondary",tap_action:{action:"toggle"},...t}}_isActive(t){if(!t)return!1;const e=t.state,i=this.config.active_state||"on";return e===String(i)||"open"===e}_getBatteryColors(t){const e=parseFloat(t?.state)||0;return e<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:e<20?["var(--md-sys-cust-color-warning-container)","var(--md-sys-cust-color-on-warning-container)"]:["var(--ha-card-background)","var(--primary-text-color)"]}render(){if(!this.hass||!this.config)return j``;const t=this.config.entity,e=t?this.hass.states[t]:void 0,i=this._isActive(e),s=this.config.variant||"secondary",a=this.config.show_state;let o,n;const r=this._parseMap(this.config.color_map),c=this._parseMap(this.config.color_on_map);if(r&&e&&void 0!==r[e.state])o=r[e.state],n=c&&c[e.state]||"var(--primary-text-color)";else if("battery"===s){const[t,i]=this._getBatteryColors(e);o=t,n=i}else if(i&&t)if(this.config.color_on)o=this.config.color_on,n=this.config.color?this.config.color:"var(--primary-text-color)";else{const t=Et[s]||Et.secondary;o=t[0],n=t[1]}else o="var(--ha-card-background)",n="var(--primary-text-color)";if(!a&&!t&&["primary","tertiary","error","primary-container","secondary-container","error-container","device-container"].includes(s)){const t=Et[s]||Et.secondary;o=t[0],n=t[1]}const l=a?"with-state":"no-state",h=i?"active":"inactive";let d="";if(a&&e)if(this.config.state_display)try{d=new Function("state","hass","entity",`return ${this.config.state_display}`)(e.state,this.hass,e)}catch(t){d=e.state}else d=e.state;return j`
      <ha-card
        class="${l} ${h}"
      ...
      >
        ...
        ${a?j`<div class="state">${d}</div>`:""}
      </ha-card>
    `}_parseMap(t){if(!t)return null;if("object"==typeof t)return t;try{return JSON.parse(t)}catch(t){return null}}_handleTap(){const t=this.config.tap_action||{action:"toggle"};this._handleAction(t)}getCardSize(){return 2}}customElements.define("materia-button",kt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"Material You small button with variants, state display, and battery mode."});const At={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},St={compact:"40px",default:"48px",large:"56px"};class zt extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};static styles=o`
    :host { display: block; }
    .option-card {
  ...
  `;setConfig(t){this._config=t}get _topSchema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"attribute",selector:{text:{}}},{name:"preset",selector:{select:{options:[{value:"",label:"None"},...Object.keys(At).map(t=>({value:t,label:t}))]}}},{name:"height",selector:{select:{options:[{value:"compact",label:"Compact (40px)"},{value:"default",label:"Default (48px)"},{value:"large",label:"Large (56px)"}]}}},{name:"color_active",selector:{text:{}}},{name:"color_on_active",selector:{text:{}}}]}_optionSchema(){return[{name:"label",required:!0,selector:{text:{}}},{name:"value",required:!0,selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"service",selector:{text:{}}}]}render(){if(!this.hass||!this._config)return j``;const t=this._config.options||[];return j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");if(!t.options||t.options.length<1)throw new Error("at least one option is required");this.config={height:"default",...t}}get _activeValue(){const t=this.hass?.states[this.config.entity];return this.config.attribute?String(t?.attributes?.[this.config.attribute]??""):t?.state??""}_colors(){const t=this.config.preset&&At[this.config.preset];return{active:this.config.color_active||t?.active||"var(--md-sys-color-primary)",onActive:this.config.color_on_active||t?.onActive||"var(--md-sys-color-on-primary)"}}render(){if(!this.hass||!this.config)return j``;const t=this.config.options,e=this._activeValue,i=St[this.config.height]||St.default,{active:s,onActive:a}=this._colors(),o=t.length;return j`
      <div class="container">
        ${t.map((t,n)=>{const r=String(t.value)===e;return j`
            <button
              style="
                height: ${i};
                border-radius: ${1===o?"999px":0===n?"999px 0 0 999px":n===o-1?"0 999px 999px 0":"0"};
                background: ${r?s:"var(--card-background-color)"};
                color: ${r?a:"var(--primary-text-color)"};
                border: ${r?`2px solid ${a}`:"1px solid transparent"};
              "
              @click=${()=>this._segmentTap(t)}
            >
              ${t.icon?j`<ha-icon .icon=${t.icon}></ha-icon>`:I}
              ${t.label}
            </button>
          `})}
      </div>
    `}_segmentTap(t){if(!t.service)return;const[e,i]=t.service.split(".",2);e&&i&&this.hass.callService(e,i,t.service_data||{})}getCardSize(){return 1}}customElements.define("materia-segmented-button",Ut),window.customCards=window.customCards||[],window.customCards.push({type:"materia-segmented-button",name:"Materia Segmented Button",description:"M3 segmented button group with presets"});class Tt extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};static styles=o`
    :host { display: block; }
    .yaml-label {
      font-size: 13px;
      font-weight: 500;
  ...
  `;setConfig(t){this._config=t}get _schema(){return[{name:"icon",required:!0,selector:{icon:{}}},{name:"variant",selector:{select:{options:[{value:"standard",label:"Standard"},{value:"outlined",label:"Outlined"},{value:"filled",label:"Filled"},{value:"filled-tonal",label:"Filled Tonal"}]}}},{name:"size",selector:{select:{options:[{value:"default",label:"Default (48px)"},{value:"large",label:"Large (56px)"}]}}},{name:"entity",selector:{entity:{}}}]}render(){return this.hass&&this._config?j`
      ...
      ></textarea>
    `:j``}_valueChanged(t){const e={...this._config,...t.detail.value,icon_map:this._config.icon_map,tap_action:this._config.tap_action};this._fireConfig(e)}_iconMapChanged(t){const e=t.target.value.trim();if(!e){const{icon_map:t,...e}=this._config;return void this._fireConfig(e)}try{const t=JSON.parse(e);this._fireConfig({...this._config,icon_map:t})}catch(t){}}_tapActionChanged(t){const e=t.target.value.trim();if(!e){const{tap_action:t,...e}=this._config;return void this._fireConfig(e)}try{const t=JSON.parse(e);this._fireConfig({...this._config,tap_action:t})}catch(t){}}_fireConfig(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}}customElements.define("materia-icon-button-editor",Tt);class Mt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-icon-button-editor")}static getStubConfig(){return{icon:"mdi:play",variant:"filled",size:"default"}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");this.config={variant:"filled",size:"default",...t}}_resolveIcon(){if(!this.config.icon_map||!this.config.entity)return this.config.icon;const t=this.hass?.states[this.config.entity]?.state;return this.config.icon_map[t]??this.config.icon_map.default??this.config.icon}_defaultTapAction(){return this.config.entity?{action:"toggle"}:{action:"none"}}render(){if(!this.config)return j``;const t=this.config.variant||"filled",e="large"===this.config.size?"large":"default",i=this._resolveIcon();return j`
    ...
    `}_handleTap(){const t=this.config.tap_action||this._defaultTapAction();this._handleAction(t)}getCardSize(){return 1}}customElements.define("materia-icon-button",Mt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-icon-button",name:"Materia Icon Button",description:"M3 icon button with variants"});customElements.define("materia-select-chip-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"option",required:!0,selector:{text:{}}},{name:"label",required:!0,selector:{text:{}}},{name:"position",selector:{select:{options:[{value:"left",label:"Left"},{value:"middle",label:"Middle"},{value:"right",label:"Right"}]}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class qt extends nt{static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-select-chip-editor")}static getStubConfig(){return{entity:"",option:"",label:"",position:"middle"}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");if(void 0===t.option)throw new Error("option is required");if(!t.label)throw new Error("label is required");this.config=t}_isActive(){const t=this.hass?.states[this.config.entity];return t?.state===String(this.config.option)}_getBorderRadius(t){const e=this.config.position||"",i="left"===e,s="right"===e;return`${i||t?"30px":"8px"} ${s||t?"30px":"8px"} ${s||t?"30px":"8px"} ${i||t?"30px":"8px"}`}render(){if(!this.hass||!this.config)return j``;const t=this._isActive(),e=this._getBorderRadius(t);return j`
    ...
    `}_handleTap(){this.hass.callService("select","select_option",{entity_id:this.config.entity,option:String(this.config.option)})}getCardSize(){return 1}}customElements.define("materia-select-chip",qt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-select-chip",name:"Materia Select Chip",description:"Material You select chip with active/inactive states and positional border-radius."});customElements.define("materia-checkbox-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"checked_entity",selector:{entity:{}}},{name:"checked_value",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Ot extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-checkbox-editor")}static getStubConfig(){return{entity:"",name:""}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={tap_action:{action:"toggle"},...t}}_isChecked(t){if(this.config.checked_entity&&this.config.checked_value){const t=this.hass?.states[this.config.checked_entity];if(t){const e=String(t.state??"").split(",").map(t=>t.trim());return e.includes(this.config.checked_value)}return!1}if(!t)return!1;const e=String(t.state??"").toLowerCase(),i=Number(e);return"on"===e||"true"===e||"home"===e||!Number.isNaN(i)&&i>0}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity],e=this._isChecked(t),i=this.config.name??t?.attributes?.friendly_name??this.config.entity,s=e?"mdi:checkbox-marked":"mdi:checkbox-blank-outline";return j`
    ...
    `}_handleTap(){const t=this.config.tap_action||{action:"toggle"};this._handleAction(t)}getCardSize(){return 1}}customElements.define("materia-checkbox",Ot),window.customCards=window.customCards||[],window.customCards.push({type:"materia-checkbox",name:"Materia Checkbox",description:"Material You checkbox row with name and toggle icon."});customElements.define("materia-circle-action-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"icon",required:!0,selector:{icon:{}}},{name:"size",selector:{select:{options:[{value:"normal",label:"Normal"},{value:"small",label:"Small"}]}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");this.config={size:"normal",...t}}render(){if(!this.config)return j``;const t="small"===this.config.size?"small":"normal";return j`
    ...
    `}_handleTap(){const t=this.config.tap_action;t&&this._handleAction(t)}getCardSize(){return 1}}customElements.define("materia-circle-action",Ft),window.customCards=window.customCards||[],window.customCards.push({type:"materia-circle-action",name:"Materia Circle Action",description:"Material You circular action button in normal (66px) or small (52px) sizes."});customElements.define("materia-tonal-button-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Dt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-tonal-button-editor")}static getStubConfig(){return{entity:"",name:"",icon:""}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config=t}render(){return this.config?j`
    ...
    `:j``}_handleTap(){const t=this.config.tap_action;t&&this._handleAction(t)}getCardSize(){return 1}}customElements.define("materia-tonal-button",Dt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-tonal-button",name:"Materia Tonal Button",description:"Material You tonal pill button with hover and active states."});customElements.define("materia-pill-badge-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}},{name:"active_state",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Pt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-pill-badge-editor")}static getStubConfig(){return{entity:"",name:"",icon:"",active_state:"on"}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config={active_state:"on",...t}}_isActive(){const t=this.hass?.states[this.config.entity];return t?.state===String(this.config.active_state)}render(){if(!this.hass||!this.config)return j``;const t=this._isActive();return j`
    ...
    `}_handleTap(){const t=this.config.tap_action;t?this._handleAction(t):this.config.entity&&this._fireMoreInfo(this.config.entity)}getCardSize(){return 1}}customElements.define("materia-pill-badge",Pt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill-badge",name:"Materia Pill Badge",description:"Material You pill badge card with active state highlighting."});customElements.define("materia-separator-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"label",selector:{text:{}}},{name:"color",selector:{text:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Nt extends nt{static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-separator-editor")}static getStubConfig(){return{label:""}}static styles=o`
    :host {
      display: block;
      padding: 8px 0;
    }
  ...
  `;setConfig(t){this.config={...t}}render(){if(!this.config)return j``;const t=this.config.color||"",e=t?`--separator-color: ${t}`:"",i=this.config.label;return i?j`
      <div class="separator" style="${e}">
        <div class="line"></div>
        <span class="label">${i}</span>
        <div class="line"></div>
      </div>
    `:j`<div class="separator" style="${e}"><div class="line"></div></div>`}getCardSize(){return 1}}customElements.define("materia-separator",Nt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-separator",name:"Materia Separator",description:"Simple horizontal line divider with optional label."});customElements.define("materia-select-editor",class extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}render(){return this.hass&&this._config?j`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:j``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Lt extends(ut(nt)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-select-editor")}static getStubConfig(){return{entity:""}}static styles=o`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}render(){if(!this.hass||!this.config)return j``;const t=this.hass.states[this.config.entity];if(!t)return j`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=this.config.name||t.attributes.friendly_name||this.config.entity,i=t.attributes.options||[],s=t.state;return j`
      <ha-card>
        <div class="row">
          ${this.config.icon?j`<ha-icon .icon=${this.config.icon}></ha-icon>`:""}
          <div class="info">
            <div class="name">${e}</div>
            <div class="current-option">${s}</div>
          </div>
          <select @change=${this._onSelect}>
            ${i.map(t=>j`<option value=${t} ?selected=${t===s}>${t}</option>`)}
          </select>
        </div>
      </ha-card>
    `}_onSelect(t){const e=t.target.value,i=this.config.entity,s=i.split(".")[0];this.hass.callService(s,"select_option",{entity_id:i,option:e})}getCardSize(){return 1}}customElements.define("materia-select",Lt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-select",name:"Materia Select",description:"Dropdown select for input_select / select entities."}),ct();console.info("%c MATERIA %c v0.2.0 ","color: white; background: #6750A4; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #6750A4; background: #E8DEF8; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");
