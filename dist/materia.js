 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,$=t=>t,k=w.trustedTypes,C=k?k.createPolicy("lit-html",{createHTML:t=>t}):void 0,S="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,A="?"+E,M=`<${A}>`,z=document,T=()=>z.createComment(""),F=t=>null===t||"object"!=typeof t&&"function"!=typeof t,O=Array.isArray,P="[ \t\n\f\r]",q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,U=/-->/g,D=/>/g,B=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),R=/'/g,N=/"/g,j=/^(?:script|style|textarea|title)$/i,L=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),I=L(1),W=L(2),H=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),G=new WeakMap,X=z.createTreeWalker(z,129);function Y(t,e){if(!O(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(e):e}const Z=(t,e)=>{const i=t.length-1,s=[];let o,n=2===e?"<svg>":3===e?"<math>":"",a=q;for(let e=0;e<i;e++){const i=t[e];let r,l,c=-1,d=0;for(;d<i.length&&(a.lastIndex=d,l=a.exec(i),null!==l);)d=a.lastIndex,a===q?"!--"===l[1]?a=U:void 0!==l[1]?a=D:void 0!==l[2]?(j.test(l[2])&&(o=RegExp("</"+l[2],"g")),a=B):void 0!==l[3]&&(a=B):a===B?">"===l[0]?(a=o??q,c=-1):void 0===l[1]?c=-2:(c=a.lastIndex-l[2].length,r=l[1],a=void 0===l[3]?B:'"'===l[3]?N:R):a===N||a===R?a=B:a===U||a===D?a=q:(a=B,o=void 0);const h=a===B&&t[e+1].startsWith("/>")?" ":"";n+=a===q?i+M:c>=0?(s.push(r),i.slice(0,c)+S+i.slice(c)+E+h):i+E+(-2===c?e:h)}return[Y(t,n+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class K{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,n=0;const a=t.length-1,r=this.parts,[l,c]=Z(t,e);if(this.el=K.createElement(l,i),X.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=X.nextNode())&&r.length<a;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(S)){const e=c[n++],i=s.getAttribute(t).split(E),a=/([.?@])?(.*)/.exec(e);r.push({type:1,index:o,name:a[2],strings:i,ctor:"."===a[1]?it:"?"===a[1]?st:"@"===a[1]?ot:et}),s.removeAttribute(t)}else t.startsWith(E)&&(r.push({type:6,index:o}),s.removeAttribute(t));if(j.test(s.tagName)){const t=s.textContent.split(E),e=t.length-1;if(e>0){s.textContent=k?k.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],T()),X.nextNode(),r.push({type:2,index:++o});s.append(t[e],T())}}}else if(8===s.nodeType)if(s.data===A)r.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(E,t+1));)r.push({type:7,index:o}),t+=E.length-1}o++}}static createElement(t,e){const i=z.createElement("template");return i.innerHTML=t,i}}function Q(t,e,i=t,s){if(e===H)return e;let o=void 0!==s?i._$Co?.[s]:i._$Cl;const n=F(e)?void 0:e._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),void 0===n?o=void 0:(o=new n(t),o._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=o:i._$Cl=o),void 0!==o&&(e=Q(t,o._$AS(t,e.values),o,s)),e}class J{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??z).importNode(e,!0);X.currentNode=s;let o=X.nextNode(),n=0,a=0,r=i[0];for(;void 0!==r;){if(n===r.index){let e;2===r.type?e=new tt(o,o.nextSibling,this,t):1===r.type?e=new r.ctor(o,r.name,r.strings,this,t):6===r.type&&(e=new nt(o,this,t)),this._$AV.push(e),r=i[++a]}n!==r?.index&&(o=X.nextNode(),n++)}return X.currentNode=z,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class tt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),F(t)?t===V||null==t||""===t?(this._$AH!==V&&this._$AR(),this._$AH=V):t!==this._$AH&&t!==H&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>O(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==V&&F(this._$AH)?this._$AA.nextSibling.data=t:this.T(z.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=K.createElement(Y(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new J(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=G.get(t.strings);return void 0===e&&G.set(t.strings,e=new K(t)),e}k(t){O(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new tt(this.O(T()),this.O(T()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=$(t).nextSibling;$(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}let et=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,o){this.type=1,this._$AH=V,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=V}_$AI(t,e=this,i,s){const o=this.strings;let n=!1;if(void 0===o)t=Q(this,t,e,0),n=!F(t)||t!==this._$AH&&t!==H,n&&(this._$AH=t);else{const s=t;let a,r;for(t=o[0],a=0;a<o.length-1;a++)r=Q(this,s[i+a],e,a),r===H&&(r=this._$AH[a]),n||=!F(r)||r!==this._$AH[a],r===V?t=V:t!==V&&(t+=(r??"")+o[a+1]),this._$AH[a]=r}n&&!s&&this.j(t)}j(t){t===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};class it extends et{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===V?void 0:t}}class st extends et{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==V)}}class ot extends et{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??V)===H)return;const i=this._$AH,s=t===V&&i!==V||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==V&&(i===V||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class nt{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const at=w.litHtmlPolyfillSupport;at?.(K,tt),(w.litHtmlVersions??=[]).push("3.3.2");const rt=(t,e,i)=>{const s=i?.renderBefore??e;let o=s._$litPart$;if(void 0===o){const t=i?.renderBefore??null;s._$litPart$=o=new tt(e.insertBefore(T(),t),t,void 0,i??{})}return o._$AI(t),o
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,$t=(t,e,i)=>({value:`var(--md-sys-cust-color-${t})`,swatch:`var(--md-sys-cust-color-${t}, ${i})`,label:e}),kt=(t,e)=>({value:`var(--md-sys-color-${t})`,swatch:`var(--md-sys-color-${t})`,label:e}),Ct=[{title:"Light",options:[$t("light","Light","#FEE082"),$t("light-container","Light container","#FEEFCA"),$t("on-light","On light","#745D00")]},{title:"Device",options:[$t("device","Device","#D9E2FE"),$t("device-container","Device container","#EDF0FF"),$t("on-device","On device","#0156CF")]},{title:"Climate · Heat",options:[$t("climate-heat","Heat","#FFDFD4"),$t("climate-heat-container","Heat container","#FFEEE9"),$t("on-climate-heat","On heat","#A14614")]},{title:"Climate · Cool",options:[$t("climate-cool","Cool","#D3E8FF"),$t("climate-cool-container","Cool container","#EAF3FF"),$t("on-climate-cool","On cool","#327EA7")]},{title:"Climate · Auto",options:[$t("climate-auto","Auto","#D4EBDD"),$t("climate-auto-container","Auto container","#EAF6EE"),$t("on-climate-auto","On auto","#2E5E44")]},{title:"Water · Eco",options:[$t("water-eco","Eco","#C8E6C9"),$t("water-eco-container","Eco container","#E6F4EA"),$t("on-water-eco","On eco","#256029")]},{title:"Water · Performance",options:[$t("water-performance","Performance","#FFD1B0"),$t("water-performance-container","Performance container","#FFEDE0"),$t("on-water-performance","On performance","#9C3A00")]},{title:"Warning",options:[$t("warning","Warning","#D9A000"),$t("warning-container","Warning container","#FEEFCA"),$t("on-warning","On warning","#FFFFFF")]},{title:"Severity scale",options:[$t("scale-green","Scale green","#5E9E50"),$t("scale-yellow","Scale yellow","#C7A128"),$t("scale-orange","Scale orange","#D9713C"),$t("scale-red","Scale red","#C94D42"),$t("scale-purple","Scale purple","#8A4DA3"),$t("scale-maroon","Scale maroon","#7A4040")]},{title:"System (theme)",options:[kt("primary","Primary"),kt("primary-container","Primary container"),kt("secondary","Secondary"),kt("secondary-container","Secondary container"),kt("tertiary","Tertiary"),kt("tertiary-container","Tertiary container"),kt("error","Error"),kt("error-container","Error container"),kt("surface-container","Surface container")]}],St=new Set(Ct.flatMap(t=>t.options.map(t=>t.value)));function Et(t){return t&&"string"==typeof t&&(t.includes("{{")||t.includes("{%"))}const At={template:{}};class Mt extends ct{static properties={label:{},value:{},_open:{state:!0},_customOpen:{state:!0}};static styles=n`
  ...
  `;setConfig(t){this._config=t,this._modes??={}}_formData(){return this._config||{}}get _sections(){return[]}_sectionsSignature(){return""}get _sectionsMemo(){const t=this._sectionsSignature();return this.__secSig===t&&this.__secVal||(this.__secSig=t,this.__secVal=this._sections),this.__secVal}_stableContext(t,e,i){const s={};for(const[t,o]of Object.entries(e))s[t]=i[o];this.__ctx??={};const o=this.__ctx[t];return o&&Object.keys(s).every(t=>o[t]===s[t])?o:(this.__ctx[t]=s,s)}_modeFor(t,e){const i=this._modes?.[t];return i||(Et(e)?"template":"simple")}_toggleMode(t){const e=this._formData()[t],i=this._modeFor(t,e);this._modes={...this._modes||{},[t]:"template"===i?"simple":"template"}}render(){if(!this.hass||!this._config)return I``;const t=this._formData();return I`
    ...
    `}_renderField(t,e){const i=e[t.name],s=t.label??xt(t),o=!!t.template,n=o?this._modeFor(t.name,i):"simple",a=t.context?this._stableContext(t.name,t.context,e):void 0;let r;return r=o&&"template"===n?I`
        <ha-selector
          class="field-control"
          .hass=${this.hass}
          .selector=${At}
    ...
    `}_fieldChanged(t,e){e.stopPropagation(),this._setField(t,e.detail?.value)}_setField(t,e){const i={...this._config};""===e||null==e?delete i[t]:i[t]=e,this._commit(i)}_commit(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}}const Tt=new Set(["cover"]);function Ft(t){if(!t?.entity)return{...t};const e=t.entity.split(".")[0],i={show_sub_buttons:!1,show_stop:!0,show_state:!0,subtitle_inline:!0};return Tt.has(e)&&(i.show_sub_buttons=!0),{...i,...t}}class Ot extends zt{static properties={_expandedButton:{state:!0}};static styles=[zt.styles,n`
      .section-header {
        display: flex;
        align-items: center;
...
`;class Bt extends zt{static properties={_selectedCard:{state:!0},_expandedButton:{state:!0}};static styles=[zt.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
...
`];customElements.define("materia-weather-editor",class extends zt{_formData(){return{show_temperature:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Sensors",icon:"mdi:water-percent",fields:[{name:"show_temperature",label:"Show temperature",selector:{boolean:{}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const It={sunny:"m3o:sunny",clear:"m3o:sunny","clear-night":"mdi:weather-night",partlycloudy:"m3o:partly-cloudy-day",partly_cloudy:"m3o:partly-cloudy-day",cloudy:"m3o:cloud",rainy:"m3o:rainy",pouring:"m3o:rainy",snowy:"mdi:weather-snowy",fog:"m3o:foggy",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",hail:"mdi:weather-hail",exceptional:"mdi:alert-circle-outline"},Wt={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class Ht extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e}}static styles=Lt;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"",s=!1!==this.config.show_temperature;let o=t?.attributes?.temperature,n=t?.attributes?.temperature_unit||"°";if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&(o=t.state,n=t.attributes?.unit_of_measurement||n)}const a=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||It[i]||"mdi:weather-partly-cloudy";let r=null;if(this.config.humidity_entity){const t=this.hass.states[this.config.humidity_entity];t&&(r=t.state)}null==r&&null!=t?.attributes?.humidity&&(r=t.attributes.humidity);const l=Wt[i]||this._capitalize(i.replace(/-|_/g," ")),c=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,d=s&&null!=o?`${o}${n}`:null;let h;h=e?"Unavailable":c||(d||(l||"—"));const p=[];e||(d&&h!==d&&p.push(d),h!==l&&p.push(l),null!=r&&p.push(`${r}%`));const u=p.join(" · ");return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-weather",Ht),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather",name:"Materia Weather",description:"Weather condition card with automatic icon mapping.",preview:!0});const Vt="var(--md-sys-cust-color-weather-sun, #FFC83D)",Gt="var(--md-sys-cust-color-weather-cloud, #E6EAF0)",Xt="var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)",Yt="var(--md-sys-cust-color-weather-rain, #5FA8F5)",Zt="var(--md-sys-cust-color-weather-sun, #FFC83D)",Kt="var(--md-sys-cust-color-weather-moon, #DCE3F7)";let Qt=0;function Jt(t,e,i,s){const o=.1*i,n=72,a=[];for(let s=0;s<n;s++){const r=s/n*Math.PI*2,l=i+o*Math.cos(9*r);a.push([t+l*Math.cos(r),e+l*Math.sin(r)])}let r=`M${a[0][0].toFixed(2)} ${a[0][1].toFixed(2)} `;for(let t=0;t<n;t++){const e=a[(t-1+n)%n],i=a[t],s=a[(t+1)%n],o=a[(t+2)%n],l=i[0]+(s[0]-e[0])/6,c=i[1]+(s[1]-e[1])/6,d=s[0]-(o[0]-i[0])/6,h=s[1]-(o[1]-i[1])/6;r+=`C${l.toFixed(2)} ${c.toFixed(2)} ${d.toFixed(2)} ${h.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return W`<path d=${r+"Z"} fill=${s} />`}function te(t,e,i,s){return W`
    ...
    ${t.map(t=>W`<circle cx=${t} cy=${e} r="1.2" />`)}
      ...
      <path d="M4 9 h11 a2.5 2.5 0 1 0-2.5-2.5" />
      <path d="M4 14 h14 a2.5 2.5 0 1 1-2.5 2.5" /></g>`,exceptional:t=>te(12,12,1.1,t.cloudDk)};function oe(t){const e=se[t]||se.cloudy,i=++Qt;return W`${function(t){return W`<defs>
...
`];customElements.define("materia-weather-tile-editor",class extends zt{_formData(){return{show_minmax:!0,mirror:!1,size:10,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"icon",label:"Custom icon (overrides the colored glyph)",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Min / Max",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show min / max",selector:{boolean:{}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"size",label:"Size (10 = fill)",selector:{number:{min:1,max:10,step:1,mode:"slider"}}},{name:"mirror",label:"Mirror (temperature left, icon right)",selector:{boolean:{}}},{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / temperature",color:!0,template:!0,selector:{text:{}}},{name:"minmax_color",label:"Min / max color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class ae extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedMinmaxColor:{state:!0},_forecast:{state:!0}};static styles=ne;static getConfigElement(){return document.createElement("materia-weather-tile-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e,show_minmax:!0}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("minmax_color","_resolvedMinmaxColor"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"";let s=t?.attributes?.temperature;if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&(s=t.state)}const o=null!=this._num(s)?`${this._num(s)}°`:"—",n=t=>{const e=t?this.hass.states[t]:null;return e&&!this._isUnavailable(e)?e.state:null};let a=n(this.config.low_entity),r=n(this.config.high_entity);const l=this._forecast?.[0]||t?.attributes?.forecast?.[0];null==a&&null!=l?.templow&&(a=l.templow),null==r&&null!=l?.temperature&&(r=l.temperature);const c=this.config.show_minmax&&(null!=this._num(a)||null!=this._num(r)),d=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,h=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,p=this._isTemplate(this.config.minmax_color)?this._resolvedMinmaxColor:this.config.minmax_color;let u="number"==typeof this.config.tilt?this.config.tilt:{right:-45,left:45,none:0}[this.config.tilt]??-45;this.config.mirror&&(u=-u);const m=this.config.icon_size??53,g=this.config.text_size??30,f=this.config.width??115,_=(this.config.height??85)/100,v=this.config.icon_x??5,b=this.config.icon_y??10,y=this.config.temp_x??10,x=this.config.temp_y??15,w=`--wt-size:${["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][Math.min(10,Math.max(1,this.config.size??10))-1]};--wt-tilt:${u}deg;--wt-icon-size:${m}cqi;--wt-temp-size:${g}cqi;--wt-width:${f}%;--wt-ratio:${_};--wt-icon-x:${v}%;--wt-icon-y:${b}%;--wt-temp-x:${y}%;--wt-temp-y:${x}%;${d?`--wt-bg:${d};`:""}${h?`--wt-fg:${h};`:""}`+(p?`--wt-minmax:${p};--wt-minmax-opacity:1;`:""),$=this.config.icon;return I`
      <ha-card>
        ...
        >
          ...
          ${$?I`<ha-icon class="wx-mono" .icon=${$}></ha-icon>`:W`<svg class="wx" viewBox="0 0 24 24">${oe(i)}</svg>`}
        </div>
      </ha-card>
...
`,le=[_t,gt,ft,re,n`
  ...
  `];customElements.define("materia-weather-hero-editor",class extends zt{_formData(){return{show_condition:!0,show_feels_like:!0,show_minmax:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"temperature_entity",label:"Real temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"feels_like_entity",label:"Feels-like sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"show_condition",label:"Show condition text",selector:{boolean:{}}},{name:"show_icon",label:"Show condition glyph",selector:{boolean:{}}},{name:"show_feels_like",label:"Show feels-like",selector:{boolean:{}}}]},{title:"Night / Day",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show night / day range",selector:{boolean:{}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"night_label",label:"Night label",selector:{text:{}}},{name:"day_label",label:"Day label",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const ce={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class de extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColorOn:{state:!0}};static styles=le;static getConfigElement(){return document.createElement("materia-weather-hero-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color_on","_resolvedColorOn"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"",s=ce[i]||this._capitalize(String(i).replace(/-|_/g," "));let o=t?.attributes?.temperature;if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&!this._isUnavailable(t)&&(o=t.state)}const n=this._num(o);let a=t?.attributes?.apparent_temperature;if(this.config.feels_like_entity){const t=this.hass.states[this.config.feels_like_entity];t&&!this._isUnavailable(t)&&(a=t.state)}const r=this._num(a),l=t=>{const e=t?this.hass.states[t]:null;return e&&!this._isUnavailable(e)?e.state:null};let c=l(this.config.low_entity),d=l(this.config.high_entity);const h=this._forecast?.[0]||t?.attributes?.forecast?.[0];null==c&&null!=h?.templow&&(c=h.templow),null==d&&null!=h?.temperature&&(d=h.temperature);const p=this._num(c),u=this._num(d),m=this.config.night_label??"Night",g=this.config.day_label??"Day",f=this.config.separator??"•",_=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on;return I`
      <ha-card>
        ...
        >
          ${!1!==this.config.show_condition?I`<div class="condition">
                ${!1===this.config.show_icon||e?"":W`<svg class="cond-glyph" viewBox="0 0 24 24">${oe(i)}</svg>`}
                <span>${e?"—":s}</span>
              </div>`:""}
          <div class="temp">
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}function he(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}function pe(t,{locale:e="en",showPrecip:i=!0,minPrecip:s=10}={}){return t.map(t=>{const o=he(t.temperature),n=he(t.precipitation_probability),a=new Date(t.datetime),r=Number.isNaN(a.getTime())?"":a.toLocaleTimeString(e,{hour:"numeric"});return I`
      <div class="hour">
...
`,me=[_t,gt,ft,re,ue,n`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-daily",fe),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-daily",name:"Materia Forecast Daily",description:"Pixel-style daily forecast pill row with colored glyphs and precipitation chance.",preview:!0});customElements.define("materia-forecast-hourly-editor",class extends zt{_formData(){return{hours:24,show_header:!0,show_precipitation:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",label:"Header title",selector:{text:{}}},{name:"show_header",label:"Show header",selector:{boolean:{}}},{name:"hours",label:"Hours shown",selector:{number:{min:6,max:48,step:1,mode:"slider"}}},{name:"show_precipitation",label:"Show precipitation chance",selector:{boolean:{}}},{name:"min_precipitation",label:"Hide below (%)",selector:{number:{min:0,max:100,step:5,mode:"box"}}}]}]}});class _e extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0}};static styles=me;static getConfigElement(){return document.createElement("materia-forecast-hourly-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&this._subscribeForecast()}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_onPointerDown(t){if("mouse"!==t.pointerType)return;const e=t.currentTarget;this._dragStartX=t.clientX,this._dragStartScroll=e.scrollLeft,this._captured=!1,this._dragPointerId=t.pointerId}_onPointerMove(t){if(null==this._dragStartX)return;const e=t.clientX-this._dragStartX;!this._captured&&Math.abs(e)>4&&(this._captured=!0,t.currentTarget.setPointerCapture(this._dragPointerId)),this._captured&&(t.currentTarget.scrollLeft=this._dragStartScroll-e)}_onPointerUp(t){null!=this._dragStartX&&(t.currentTarget.releasePointerCapture?.(t.pointerId),this._dragStartX=null)}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=(this._forecast||[]).slice(0,this.config.hours??24);if(!i.length)return I``;const s=this.hass?.locale?.language||navigator.language||"en";return I`
      <ha-card class="${e?"unavailable":""}">
        ...
        <div
          ...
          @pointercancel=${this._onPointerUp}
        >
          ${pe(i,{locale:s,showPrecip:!1!==this.config.show_precipitation,minPrecip:this.config.min_precipitation??10})}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}function ve(t,e,i,s=12){return be(t,e,i,{vertices:s,innerRadius:.8,rounding:.5,rotate:-Math.PI/2})}function be(t,e,i,{vertices:s,innerRadius:o=null,rounding:n=.2,rotate:a=0}={}){const r=[],l=null!=o?2*s:s;for(let s=0;s<l;s++){const n=null!=o&&s%2==1?i*o:i,c=a+s/l*Math.PI*2;r.push([t+n*Math.cos(c),e+n*Math.sin(c)])}const c=n*i,d=[];for(let t=0;t<l;t++){const e=r[(t-1+l)%l],i=r[t],s=r[(t+1)%l],o=[e[0]-i[0],e[1]-i[1]],n=[s[0]-i[0],s[1]-i[1]],a=Math.hypot(...o),h=Math.hypot(...n);o[0]/=a,o[1]/=a,n[0]/=h,n[1]/=h;const p=o[0]*n[0]+o[1]*n[1],u=Math.acos(Math.min(1,Math.max(-1,p)))/2;let m=c/Math.tan(u);m=Math.min(m,.5*a,.5*h);const g=m*Math.tan(u),f=[i[0]+o[0]*m,i[1]+o[1]*m],_=[i[0]+n[0]*m,i[1]+n[1]*m],v=o[0]*n[1]-o[1]*n[0];d.push({T1:f,T2:_,rEff:g,sweep:v>0?0:1})}let h=`M${d[0].T1[0].toFixed(2)} ${d[0].T1[1].toFixed(2)} `;for(let t=0;t<l;t++){const e=d[t],i=d[(t+1)%l];h+=`A${e.rEff.toFixed(2)} ${e.rEff.toFixed(2)} 0 0 ${e.sweep} ${e.T2[0].toFixed(2)} ${e.T2[1].toFixed(2)} `,h+=`L${i.T1[0].toFixed(2)} ${i.T1[1].toFixed(2)} `}return h+"Z"}function ye(t,e,i,s,o){const n=s=>{const o=(s-90)*Math.PI/180;return[t+i*Math.cos(o),e+i*Math.sin(o)]},[a,r]=n(s),[l,c]=n(o),d=Math.abs(o-s)>180?1:0;return`M${a.toFixed(2)} ${r.toFixed(2)} A${i} ${i} 0 ${d} 1 ${l.toFixed(2)} ${c.toFixed(2)}`}customElements.define("materia-forecast-hourly",_e),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-hourly",name:"Materia Forecast Hourly",description:"Pixel-style hourly forecast strip with colored glyphs and precipitation chance.",preview:!0});const xe=[_t,gt,ft,re,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],we=[{value:"wind",label:"Wind"},{value:"uv",label:"UV index"},{value:"aqi",label:"Air quality"},{value:"pollen",label:"Pollen"},{value:"precipitation",label:"Precipitation"},{value:"sun",label:"Sunrise & sunset"},{value:"visibility",label:"Visibility"},{value:"humidity",label:"Humidity"},{value:"pressure",label:"Pressure"}];customElements.define("materia-weather-metric-editor",class extends zt{_formData(){return{metric:"wind",...this._config}}_sectionsSignature(){return this._config?.metric||""}get _sections(){const t=this._config?.metric,e={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"metric",required:!0,selector:{select:{mode:"dropdown",options:we}}},..."sun"!==t&&"pollen"!==t?[{name:"entity",label:"Weather entity",selector:{entity:{domain:"weather"}}},{name:"sensor",label:"Sensor override (optional)",selector:{entity:{domain:"sensor"}}}]:[],{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon (overrides default)",selector:{icon:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"wind"===t&&i.fields.push({name:"unit",label:"Unit (converts from the source)",selector:{select:{mode:"dropdown",options:[{value:"km/h",label:"km/h"},{value:"m/s",label:"m/s"},{value:"mph",label:"mph"},{value:"kn",label:"knots"},{value:"bft",label:"Beaufort"}]}}},{name:"bearing_entity",label:"Bearing sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"from_label",label:'"From" label',selector:{text:{}}}),"humidity"===t&&i.fields.push({name:"dew_entity",label:"Dew point sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"dew_label",label:"Dew point label",selector:{text:{}}}),"pressure"===t&&i.fields.push({name:"min",label:"Gauge min",selector:{number:{mode:"box"}}},{name:"max",label:"Gauge max",selector:{number:{mode:"box"}}}),"precipitation"===t&&i.fields.push({name:"total_label",label:"Subtitle when raining",selector:{text:{}}},{name:"none_label",label:'"None expected" label',selector:{text:{}}}),"sun"===t&&i.fields.push({name:"sun_entity",label:"Sun entity",selector:{entity:{domain:"sun"}}}),"pollen"===t&&i.fields.push({name:"entities",label:"Pollen sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"variant",label:"Variant",selector:{select:{mode:"dropdown",options:[{value:"gauges",label:"Gauges (wide)"},{value:"small",label:"Small (dot list)"}]}}},{name:"max_shown",label:"Max species shown (worst first)",selector:{number:{min:1,max:6,step:1,mode:"slider"}}},{name:"hide_inactive",label:"Hide species at 'none'",selector:{boolean:{}}},{name:"max",label:"Scale max for numeric sensors (default 4)",selector:{number:{min:1,max:10,mode:"box"}}});const s={title:"Appearance",icon:"mdi:palette-outline",fields:[..."wind"===t?[{name:"shape_color",label:"Shape color",color:!0,template:!0,selector:{text:{}}}]:[],{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},o={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[e,i,s,o]:[e,s,o]}});const $e="var(--md-sys-cust-color-scale-green, #5E9E50)",ke="var(--md-sys-cust-color-scale-yellow, #C7A128)",Ce="var(--md-sys-cust-color-scale-orange, #D9713C)",Se="var(--md-sys-cust-color-scale-red, #C94D42)",Ee="var(--md-sys-cust-color-scale-purple, #8A4DA3)",Ae=[{max:2,label:"Low",color:$e},{max:5,label:"Moderate",color:ke},{max:7,label:"High",color:Ce},{max:10,label:"Very high",color:Se},{max:1/0,label:"Extreme",color:Ee}],Me=[{max:50,label:"Good air quality",color:$e},{max:100,label:"Moderate air quality",color:ke},{max:150,label:"Unhealthy for sensitive groups",color:Ce},{max:200,label:"Unhealthy air quality",color:Se},{max:300,label:"Very unhealthy air quality",color:Ee},{max:1/0,label:"Hazardous air quality",color:"var(--md-sys-cust-color-scale-maroon, #7A4040)"}],ze=["None","Low","Moderate","High","Very high"];class Te extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=xe;static getConfigElement(){return document.createElement("materia-weather-metric-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e,metric:"wind"}}setConfig(t){if(!t.metric)throw new Error("metric is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),"precipitation"!==this.config.metric||this.config.sensor?this._unsubForecast():this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){"precipitation"!==this.config?.metric||this.config.sensor||this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}_value(t){if(this.config.sensor){const t=this.hass.states[this.config.sensor];return t&&!this._isUnavailable(t)?this._numRaw(t.state):null}const e=this.hass.states[this.config.entity];return this._numRaw(e?.attributes?.[t])}_weatherAttr(t){return this.hass.states[this.config.entity]?.attributes?.[t]}_scallopWave(t){const e=200/12;let i=`M0 ${t+3.2} `;for(let s=0;s<200;s+=e)i+=`Q ${s+e/2} ${t-3.2} ${s+e} ${t+3.2} `;return i+"V100 H0 Z"}render(){if(!this.hass||!this.config)return I``;const t={wind:()=>this._wind(),uv:()=>this._uv(),aqi:()=>this._aqi(),pollen:()=>this._pollen(),precipitation:()=>this._precipitation(),sun:()=>this._sun(),visibility:()=>this._visibility(),humidity:()=>this._humidity(),pressure:()=>this._pressure()}[this.config.metric];if(!t)return I``;const e=t();if(e===V)return I``;const i=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,s=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,o=Math.min(10,Math.max(1,this.config.size??10));return I`
    ...
    `}_uv(){const t=this._value("uv_index");if(null==t)return V;const e=Ae.find(e=>t<=e.max),i=Ae.map((t,i)=>{const s=(160-35*i)*Math.PI/180,o=50+33*Math.cos(s),n=52+33*Math.sin(s),a=t===e;return W`<circle cx=${o} cy=${n} r=${a?4.5:2.6}
    ...
    `}_pressure(){const t=this._value("pressure");if(null==t)return V;const e=this.config.unit??this._weatherAttr("pressure_unit")??"hPa",i=this.config.min??("hPa"===e?950:28),s=this.config.max??("hPa"===e?1050:31),o=Math.min(1,Math.max(0,(t-i)/(s-i))),n=270*o-135,a=this.hass?.locale?.language||navigator.language||"en",r="hPa"===e?Math.round(t).toLocaleString(a):t;return I`
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          ...
          ${o>.01?W`<path d=${ye(50,52,37.5,-135,n)} class="gauge-fill thin" />`:""}
        </svg>
        <div class="overlay">
    ...
    `}_aqi(){const t=this._value("air_quality_index");if(null==t)return this.config.sensor?V:this._hint("mdi:waves",this.config.name??"Air quality","Point this tile at an AQI sensor");const e=Me.find(e=>t<=e.max),i=Math.min(.96,Math.max(.04,t/300));return I`
      <div class="rect-tile">
        ${this._header("mdi:waves",this.config.name??"Air quality")}
        <div class="big">${Math.round(t)}</div>
        <div class="aqi-bar">
          ${Me.slice(0,5).map(t=>I`<span style="background:${t.color}"></span>`)}
          <span style="background:${Me[5].color}"></span>
    ...
    `}_precipitation(){let t=null;if(this.config.sensor)t=this._value();else{const e=this._forecast?.[0];t=this._numRaw(e?.precipitation)}if(null==t)return V;const e=this.config.unit??this._weatherAttr("precipitation_unit")??"mm",i=this.config.none_label??"No precipitation expected",s=t>0?this.config.total_label??"Total rain for the day":i;return I`
      <div class="rect-tile precip">
        ...
        <div class="precip-bottom">
          <div class="sub">${s}</div>
          ${t>0?W`<svg class="precip-glyph" viewBox="0 0 24 24">${oe("rainy")}</svg>`:""}
        </div>
      </div>
    ...
    `}_sun(){const t=this.hass.states[this.config.sun_entity??"sun.sun"];if(!t)return V;const e=t.attributes?.next_rising,i=t.attributes?.next_setting;if(!e||!i)return V;const s=this.hass?.locale?.language||navigator.language||"en",o=t=>new Date(t).toLocaleTimeString(s,{hour:"numeric",minute:"2-digit"}),n=new Date(e).getTime(),a=new Date(i).getTime(),r=Date.now();let l=.5;if(a<n){const t=864e5-(n-a);l=Math.min(1,Math.max(0,1-(a-r)/t))}else l=r<n?0:1;const c=(1-l)*(1-l)*2+2*l*(1-l)*50+l*l*98,d=(1-l)*(1-l)*32+2*l*(1-l)*-4+l*l*32;return I`
      <div class="rect-tile sun">
        ...
        <svg class="sun-arc" viewBox="0 0 100 38">
          ...
          ${l>0&&l<1?W`<path d=${function(t,e,i,s=12,o=.1*i,n=0){const a=Math.max(8*s,48),r=[];for(let l=0;l<a;l++){const c=l/a*Math.PI*2,d=i+o*Math.cos(s*c+n);r.push([t+d*Math.cos(c),e+d*Math.sin(c)])}let l=`M${r[0][0].toFixed(2)} ${r[0][1].toFixed(2)} `;for(let t=0;t<a;t++){const e=r[(t-1+a)%a],i=r[t],s=r[(t+1)%a],o=r[(t+2)%a],n=i[0]+(s[0]-e[0])/6,c=i[1]+(s[1]-e[1])/6,d=s[0]-(o[0]-i[0])/6,h=s[1]-(o[1]-i[1])/6;l+=`C${n.toFixed(2)} ${c.toFixed(2)} ${d.toFixed(2)} ${h.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return l+"Z"}(c,d,5.5,9,.6)} fill="var(--md-sys-cust-color-weather-sun, #FFC83D)" />`:""}
        </svg>
        <div class="sun-times">
  ...
  `];customElements.define("materia-switch-editor",class extends zt{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",label:"Name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"secondary",label:"Secondary text / template",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Row color (e.g. escalate from state)",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}}]}]}});class Ne extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedSecondary:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=Re;static getConfigElement(){return document.createElement("materia-switch-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("switch.")||t.startsWith("input_boolean."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("Materia Switch: entity is required");this.config=t}updated(t){t.has("hass")&&this.hass&&(this._resolveField("secondary","_resolvedSecondary"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"))}get _stateObj(){return this.hass?.states[this.config.entity]}get _on(){return"on"===this._stateObj?.state}_tap(){this._handleAction(this.config.tap_action||{action:"toggle",entity:this.config.entity}),this._fireHaptic("light")}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(!t)return I`<ha-card class="row off">Unknown entity: ${this.config.entity}</ha-card>`;const e=this._on,i=this._isUnavailable(t),s=this.config.name||t.attributes.friendly_name||this.config.entity,o=this.config.icon||t.attributes.icon||(e?"mdi:toggle-switch":"mdi:toggle-switch-off-outline"),n=this.config.secondary?this._isTemplate(this.config.secondary)?this._resolvedSecondary:this.config.secondary:this.hass.formatEntityState?.(t)??t.state,a=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,r=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on;return I`
      ...
      >
        ...
        <div class="m3-switch ${e?"on":""}"><i></i></div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:1}}getCardSize(){return 1}}customElements.define("materia-switch",Ne),window.customCards=window.customCards||[],window.customCards.push({type:"materia-switch",name:"Materia Switch",description:"Toggle row with a spec M3 switch — templatable secondary text and state-driven colors.",preview:!0});const je=[_t,gt,ft,re,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Le=[{value:"auto",label:"Auto (from device class)"},{value:"percent",label:"Percent (filling cookie)"},{value:"temperature",label:"Temperature (thermometer)"},{value:"power",label:"Power (load bars)"},{value:"energy",label:"Energy"},{value:"binary",label:"On/off (spinning star)"},{value:"plain",label:"Plain value"}];customElements.define("materia-glance-tile-editor",class extends zt{_formData(){return{variant:"auto",...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){const t=this._config?.variant,e={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"variant",label:"Visualization",selector:{select:{mode:"dropdown",options:Le}}},{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Icon (overrides entity icon)",selector:{icon:{}}},{name:"label",label:"Subtitle",selector:{text:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"temperature"===t&&i.fields.push({name:"min",label:"Scale min (default 10°)",selector:{number:{mode:"box"}}},{name:"max",label:"Scale max (default 30°)",selector:{number:{mode:"box"}}}),"power"===t&&i.fields.push({name:"max",label:"Full-load watts (default 3000)",selector:{number:{mode:"box"}}});const s={title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Accent color (fill / bars / star)",color:!0,selector:{text:{}}},{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},o={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[e,i,s,o]:[e,s,o]}});const Ie="var(--md-sys-cust-color-weather-rain, #5fa8f5)",We="var(--md-sys-cust-color-scale-green, #5E9E50)",He="var(--md-sys-cust-color-scale-orange, #D9713C)",Ve="var(--md-sys-cust-color-scale-red, #C94D42)",Ge=["on","open","running","playing","heat","heating","home","true","active"];class Xe extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=je;static getConfigElement(){return document.createElement("materia-glance-tile-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("sensor."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("Materia Glance Tile: entity is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"))}get _stateObj(){return this.hass?.states[this.config.entity]}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _unit(){return this.config.unit??this._stateObj?.attributes?.unit_of_measurement??""}get _name(){return this.config.name??this._stateObj?.attributes?.friendly_name??this.config.entity}_icon(t){return this.config.icon||this._stateObj?.attributes?.icon||t}get _variant(){if(this.config.variant&&"auto"!==this.config.variant)return this.config.variant;const t=this._stateObj;if(!t)return"plain";const e=this.config.entity.split(".")[0],i=t.attributes.device_class,s=t.attributes.unit_of_measurement;return"binary_sensor"!==e&&"switch"!==e&&!Ge.includes(t.state)&&"off"!==t.state||null!=this._num(t.state)?"%"===s||"humidity"===i||"battery"===i||"moisture"===i?"percent":"temperature"===i||"°C"===s||"°F"===s?"temperature":"power"===i||"W"===s||"kW"===s?"power":"energy"===i||"kWh"===s||"Wh"===s||"MWh"===s?"energy":"plain":"binary"}_fmtState(){const t=this._stateObj;return this.hass.formatEntityState?.(t)??t.state}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(!t||this._isUnavailable(t))return I`<ha-card><div class="rect-tile unavailable">
      ...
      <ha-card
        style="--ms-size:${["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][o-1]};${i?`--ms-color:${i};`:""}${s?`--ms-color-on:${s};`:""}${this.config.accent?`--ms-accent:${this.config.accent};`:""}"
        @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info",entity:this.config.entity})}
      >
        ${e}
      </ha-card>
    `}_header(t){return I`<div class="header"><ha-icon icon=${this._icon(t)}></ha-icon><span>${this._name}</span></div>`}_percent(){const t=this._num(this._stateObj.state);if(null==t)return this._plain();const e=Math.min(1,Math.max(0,t/100)),i=this._stateObj.attributes.device_class;let s=null;"battery"===i?s=e>.4?We:e>.15?He:Ve:"humidity"!==i&&"moisture"!==i||(s=Ie),s&&(s=`color-mix(in srgb, ${s} 30%, transparent)`);const o=100-100*e,n="humidity"===i||"moisture"===i;let a;if(n){let t=`M-100 ${o.toFixed(1)}`;for(let e=-100;e<100;e+=25){t+=` Q ${e+12.5} ${(o+(e/25%2==0?-1.6:1.6)).toFixed(1)} ${e+25} ${o.toFixed(1)}`}a=t+" V102 H-100 Z"}else a=`M-2 ${o+2.5} Q 50 ${o-2.5} 102 ${o+2.5} V102 H-2 Z`;const r="battery"===i?"mdi:battery":"mdi:water-percent";return I`
      <div class="rect-tile clip">
        <svg class="fill-bg" viewBox="0 0 100 100" preserveAspectRatio="none">
          ${e>.005?W`<path d=${a}
                class="level-fill ${n?"drift":""}" style=${s?`fill:${s}`:""} />`:""}
        </svg>
        <div class="overlay">
          ${this._header(r)}
          <div class="big">${Math.round(t)}<span class="unit">%</span></div>
    ...
    `}_tempColor(t,e){const i="°F"===e?5*(t-32)/9:t;return i<16?Ie:i<23?We:i<27?He:Ve}_temperature(){const t=this._num(this._stateObj.state);if(null==t)return this._plain();const e=this._unit||"°C",i=this.config.min??("°F"===e?50:10),s=this.config.max??("°F"===e?86:30),o=Math.min(1,Math.max(0,(t-i)/(s-i))),n=this._tempColor(t,e);return I`
    ...
    `}_binary(){const t=Ge.includes(this._stateObj.state),e=be(50,50,46,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2});return I`
  ...
  `],Ze="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:var(--md-sys-color-secondary-container, rgba(120,120,128,.14));color:var(--md-sys-color-on-secondary-container, inherit);margin-bottom:6px;cursor:pointer;",Ke="border:none;background:transparent;color:inherit;cursor:pointer;padding:4px;display:grid;place-items:center;border-radius:50%;--mdc-icon-size:18px;",Qe="border:1.5px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.2));background:transparent;color:inherit;font-family:inherit;font-size:13px;font-weight:600;padding:8px 16px;border-radius:999px;cursor:pointer;display:inline-flex;align-items:center;gap:6px;";customElements.define("materia-climate-poc-editor",class extends zt{static properties={_secIdx:{state:!0},_cardIdx:{state:!0},_huiReady:{state:!0}};connectedCallback(){super.connectedCallback(),this._loadHui()}async _loadHui(){if(customElements.get("hui-card-picker")&&customElements.get("hui-card-element-editor"))this._huiReady=!0;else{try{const t=await pt(),e=await t.createCardElement({type:"vertical-stack",cards:[]});await(e?.constructor?.getConfigElement?.())}catch{}this._huiReady=!!customElements.get("hui-card-picker")}}_formData(){return{...this._config}}get _secs(){return this._config?.sections||[]}_setSecs(t){const e={...this._config};t.length?e.sections=t:delete e.sections,this._commit(e)}_patchSec(t,e){const i=[...this._secs],s={...i[t],...e};for(const t of Object.keys(e))void 0!==e[t]&&""!==e[t]&&null!==e[t]||delete s[t];i[t]=s,this._setSecs(i)}_moveSec(t,e){const i=[...this._secs],s=t+e;s<0||s>=i.length||([i[t],i[s]]=[i[s],i[t]],this._setSecs(i))}_addSec(){const t=this._secs.length;this._setSecs([...this._secs,{title:"New section",style:"section",cards:[]}]),this._secIdx=t}_patchCards(t,e){this._patchSec(t,{cards:e})}render(){return this.hass&&this._config?null!=this._secIdx&&null!=this._cardIdx?this._renderCardView():null!=this._secIdx?this._renderSectionView():super.render():I``}_back(t,e){return I`
    ...
    `}_renderExtra(){return I`
      <ha-expansion-panel outlined .header=${"Extra sections"} .secondary=${"Wallet sections or menus below Zones/Water heater"} .expanded=${!0}>
        <ha-icon slot="leading-icon" icon="mdi:wallet-outline"></ha-icon>
        <div style="padding:12px;">
          ${this._secs.map((t,e)=>I`
            <div style=${Ze} @click=${()=>{this._secIdx=e}}>
          ...
          `)}
          <button style=${Qe} @click=${()=>this._addSec()}>
    ...
    `}_renderSectionCards(t,e){const i=e.cards||[],s=(e,s)=>{const o=e+s;if(o<0||o>=i.length)return;const n=[...i];[n[e],n[o]]=[n[o],n[e]],this._patchCards(t,n)};return I`
      ${this._sel("Info entity (closed-bar status text)",{entity:{}},e.info_entity,e=>this._patchSec(t,{info_entity:e}))}
      ...
      ${i.map((e,o)=>I`
        <div style=${Ze} @click=${()=>{this._cardIdx=o}}>
          ...
          <button style=${Ke} title="Move up" @click=${t=>{t.stopPropagation(),s(o,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
          <button style=${Ke} title="Move down" @click=${t=>{t.stopPropagation(),s(o,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
          <button style=${Ke} title="Edit" @click=${t=>{t.stopPropagation(),this._cardIdx=o}}><ha-icon icon="mdi:pencil"></ha-icon></button>
          <button style=${Ke} title="Delete" @click=${e=>{e.stopPropagation(),this._patchCards(t,i.filter((t,e)=>e!==o))}}><ha-icon icon="mdi:delete"></ha-icon></button>
        </div>
      `)}
    ...
    `:(this._cardIdx=null,I``)}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"water_heater",label:"Water heater (optional)",selector:{entity:{domain:"water_heater"}}},{name:"zones",label:"Zone valves",helper:"Per-zone names, icons and temp sensors: zones: [{entity, name, icon, temp_entity}] in YAML.",selector:{entity:{domain:"switch",multiple:!0}}},{name:"zone_icon",label:"Zone icon (e.g. mdi:heating-coil for underfloor)",selector:{icon:{}}}]},{title:"Dial",icon:"mdi:thermostat",fields:[{name:"step",label:"Step",selector:{number:{min:.1,max:2,step:.1,mode:"box"}}},{name:"min_temp",label:"Dial min (default: entity)",selector:{number:{min:-30,max:40,step:.5,mode:"box"}}},{name:"max_temp",label:"Dial max (default: entity)",selector:{number:{min:0,max:60,step:.5,mode:"box"}}},{name:"steppers",label:"Stepper placement",selector:{select:{mode:"dropdown",options:[{value:"side",label:"Vertical, beside the dial"},{value:"below",label:"Below the dial"}]}}},{name:"wave",label:"Wave animation",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (hvac_action, or inferred from temps)"},{value:"always",label:"Always (whenever the mode is on)"},{value:"never",label:"Never"}]}}}]},{title:"Built-in sections",icon:"mdi:radiator",fields:[{name:"water",label:"Water heater style",selector:{select:{mode:"dropdown",options:[{value:"menu",label:"Menu (tap opens operation modes)"},{value:"section",label:"Wallet section"}]}}},{name:"reserve_height",label:"Keep the height of the tallest section (no reflow when cycling)",selector:{boolean:{}}},{name:"zones_title",label:"Zones section title",selector:{text:{}}},{name:"water_title",label:"Water heater section title",selector:{text:{}}}]}]}});const Je={heat:["var(--md-sys-cust-color-climate-heat-accent, #a14614)","var(--md-sys-cust-color-climate-heat-container, #ffeee9)"],cool:["var(--md-sys-cust-color-climate-cool-accent, #327ea7)","var(--md-sys-cust-color-climate-cool-container, #eaf3ff)"],auto:["var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))","var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))"],heat_cool:["var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))","var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))"],off:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"]};class ti extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_openSection:{state:!0}};static styles=Ye;static getConfigElement(){return document.createElement("materia-climate-poc-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("climate."))||"";return{entity:e,zones:[]}}setConfig(t){if(!t.entity)throw new Error("Materia Climate POC: entity is required");this.config={zones:[],...t},this._extraEls=null,this.isConnected&&this._createExtraCards()}firstUpdated(){this._createExtraCards()}updated(t){if(t.has("hass")&&this._extraEls){const t=this._openSection??0;this._extraEls[t]?.forEach(t=>{t.hass=this.hass})}this._reserveHeight()}get _entity(){return this.hass?.states[this.config.entity]}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _current(){return this._numRaw(this._entity?.attributes?.current_temperature)}get _boilerActive(){const t=this._entity?.attributes?.hvac_action;if("heating"===t)return!0;if(t&&"idle"!==t)return!1;const e=this._entity?.state,i=this._current,s=this._numRaw(this._entity?.attributes?.temperature);return"off"!==e&&null!=s&&(null==i?"heat"===e:i<s-.2)}get _zones(){return(this.config.zones||[]).map(t=>{const e="string"==typeof t?t:t.entity,i="on"===this.hass.states[e]?.state;return{entity:e,on:i,calling:i&&this._boilerActive}})}_fmt(t){return null==t?"—":Math.round(10*t)/10}_allZones(t){for(const e of this._zones)this._callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity})}_modeGroup(){const t=(this._entity?.attributes?.hvac_modes||[]).filter(t=>["heat","auto","off","cool","heat_cool"].includes(t));if(!t.length)return V;const[e,i]=Je[this._entity?.state]??Je.off;return I`
      ...
      ></materia-button-group>
    `}get _sectionConfigs(){const t=[];if(this.config.zones?.length){const e="var(--md-sys-cust-color-climate-heat-container, var(--md-sys-color-primary-container))",i="var(--md-sys-cust-color-climate-heat-accent, var(--md-sys-color-on-primary-container))";t.push({_builtin:"zones",style:"section",title:this.config.zones_title??"Zones",icon:this.config.zone_icon??"mdi:radiator",cards:this.config.zones.map(t=>{const s="string"==typeof t?{entity:t}:t,o=`is_state('${s.entity}', 'on') and state_attr('${this.config.entity}', 'hvac_action') == 'heating'`;return{type:"custom:materia-switch",entity:s.entity,name:s.name,icon:s.icon??this.config.zone_icon,flat:!0,secondary:`{% if ${o} %}Heating · open {{ relative_time(states.${s.entity}.last_changed) }}{% elif is_state('${s.entity}', 'on') %}At temperature{% else %}Off{% endif %}`+(s.temp_entity?`{% if states('${s.temp_entity}') not in ['unknown', 'unavailable'] %} · {{ states('${s.temp_entity}') | round(1) }}°{% endif %}`:""),color:`{% if ${o} %}${e}{% endif %}`,color_on:`{% if ${o} %}${i}{% endif %}`}})})}this.config.water_heater&&t.push({_builtin:"water",style:"section"===(this.config.water??"menu")?"section":"menu",title:this.config.water_title??"Water heater",icon:"mdi:water-boiler",entity:this.config.water_heater});for(const e of this.config.sections||[])t.push({style:"section",...e});return t}_menuCardConfig(t,e=!1){const i={type:"custom:materia-menu",entity:t.entity,icon:t.icon,name:t.title,menu_variant:"expressive"};if(t.options?.length&&(i.options=t.options),e&&"water"===t._builtin){const e=this._numRaw(this.hass.states[t.entity]?.attributes?.current_temperature);null!=e&&(i.substate=`${this._fmt(e)}°`)}return i}async _createExtraCards(){const t=this._extraGen=(this._extraGen||0)+1,e=this._sectionConfigs;if(!e.length)return void(this._extraEls=[]);const i=await pt(),s=await Promise.all(e.map(async t=>{if("menu"===t.style)return[];const e=t.cards??(t.entity?[this._menuCardConfig(t)]:[]);return(await Promise.all(e.map(async t=>{try{const e=await i.createCardElement(t);return e.hass=this.hass,e}catch{return null}}))).filter(Boolean)}));t===this._extraGen&&(this._extraEls=s,this.requestUpdate())}_accordionSections(){return this._sectionConfigs.map((t,e)=>{let i="",s=null;if("zones"===t._builtin){const t=this._zones,e=t.filter(t=>t.calling).length,o=t.filter(t=>t.on).length;i=e?`${e} of ${t.length} heating`:`${o} of ${t.length} on`,s=I`
          <div class="acc-actions">
            <button class="mini" @click=${()=>this._allZones(!1)}>All off</button>
            <button class="mini" @click=${()=>this._allZones(!0)}>All on</button>
          </div>
        `}else if("water"===t._builtin){const t=this.hass.states[this.config.water_heater],e=this._numRaw(t?.attributes?.current_temperature);i=t?`${this._capitalize(t.state)}${null!=e?` · ${this._fmt(e)}°`:""}`:""}else{const e=t.info_entity?this.hass.states[t.info_entity]:null;i=t.info??(e?this.hass.formatEntityState?.(e)??e.state:"")}return{style:t.style,menuConfig:"menu"===t.style?this._menuCardConfig(t,!0):null,title:t.title??`Section ${e+1}`,icon:t.icon,info:i,actions:s,body:this._extraEls?.[e]?.length?I`<div class="acc-cards">${this._extraEls[e]}</div>`:V}})}_openAcc(t){this._openSection!==t&&(this._openSection=t,this._fireHaptic("light"),this._extraEls?.[t]?.forEach(t=>{t.hass=this.hass}))}_reserveHeight(){const t=this.renderRoot?.querySelector(".stack");t&&(this.config.reserve_height?requestAnimationFrame(()=>{const e=[...t.querySelectorAll(".acc-inner")];if(!e.length)return;const i=t.querySelector(".acc-sec.open .acc-inner");t.style.minHeight="";const s=t.offsetHeight-(i?.offsetHeight||0),o=Math.max(...e.map(t=>t.scrollHeight));t.style.minHeight=`${s+o}px`}):t.style.minHeight="")}render(){if(!this.hass||!this.config)return I``;if(!this._entity)return I`<ha-card class="poc">Unknown entity: ${this.config.entity}</ha-card>`;const t=this._accordionSections(),e=t.findIndex(t=>"menu"!==t.style),i=this._openSection??e,[s,o]=Je[this._entity.state]??Je.off;return I`
      <ha-card class="poc" style="--poc-mode-accent:${s};--poc-mode-container:${o};">
        <materia-thermostat
          .hass=${this.hass}
          .config=${{entity:this.config.entity,show_modes:!1,wave:this.config.wave??"auto",steppers:this.config.steppers??"side",...null!=this.config.step?{step:this.config.step}:{},...null!=this.config.min_temp?{min_temp:this.config.min_temp}:{},...null!=this.config.max_temp?{max_temp:this.config.max_temp}:{}}}
        ></materia-thermostat>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6}}customElements.define("materia-climate-poc",ti),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate-poc",name:"Materia Climate POC",description:"Climate surface: thermostat dial hero + connected stack of modes, zone ladder and water heater.",preview:!1});const ei=[_t,ft,re,n`
    .wallet {
      display: flex;
      flex-direction: column;
      gap: 6px;
...
${i?"":I`<ha-icon class="s-chev" icon="m3of:arrow-drop-down"></ha-icon>`}
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const t=c?Math.max(h,g??h):oi,e=c?Math.min(t+8,135):oi;return e<134.5?W`<path d=${this._arcPath(e,135,d)} class="track" />`:""})()}
            ${c||null==g?"":W`<circle
                  cx=${this._pointAt(g,d)[0]} cy=${this._pointAt(g,d)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?W`<path d=${this._arcPath(oi,f,d)} class="sweep" style="stroke:${y}" />`:""}
  ...
  `];class hi extends zt{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[zt.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
  ...
  `];class fi extends zt{static properties={_expanded:{state:!0}};static styles=[zt.styles,n`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $i=(t,e)=>{const i=t._$AN;if(void 0===i)return!1;for(const t of i)t._$AO?.(e,!1),$i(t,e);return!0},ki=t=>{let e,i;do{if(void 0===(e=t._$AM))break;i=e._$AN,i.delete(t),t=e}while(0===i?.size)},Ci=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(void 0===i)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),Ai(e)}};function Si(t){void 0!==this._$AN?(ki(this),this._$AM=t,Ci(this)):this._$AM=t}function Ei(t,e=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(e)if(Array.isArray(s))for(let t=i;t<s.length;t++)$i(s[t],!1),ki(s[t]);else null!=s&&($i(s,!1),ki(s));else $i(this,t)}const Ai=t=>{t.type==xi&&(t._$AP??=Ei,t._$AQ??=Si)};class Mi extends wi{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Ci(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&($i(this,t),ki(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const zi=new WeakMap,Ti=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends Mi{render(t){return V}update(t,[e]){const i=e!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),V}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=zi.get(e);void 0===i&&(i=new WeakMap,zi.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return"function"==typeof this.G?zi.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class Fi extends zt{static properties={_expandedButton:{state:!0},_expandedOption:{state:!0}};static styles=[zt.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(t){super.setConfig(t),this._expandedButton??=null}_formData(){return{gap:8,padding:4,...this._config}}get _sections(){return[{title:"Layout",icon:"mdi:tune",fields:[{name:"gap",label:"Gap between buttons",selector:{number:{min:0,max:64,step:4,unit_of_measurement:"px",mode:"slider"}}},{name:"padding",label:"Vertical padding",selector:{number:{min:0,max:48,step:4,unit_of_measurement:"px",mode:"slider"}}}]}]}_renderExtra(){const t=this._config.buttons||[];return I`
      ...
      ${wt((t,e)=>this._moveButton(t,e),t.map((t,e)=>I`
            ...
            ${this._expandedButton===e?I`
                  <div class="button-body">
                    <materia-button-editor
                      .hass=${this.hass}
                      ${Ti(i=>{i&&i.__materiaIdx!==e&&(i.__materiaIdx=e,i.setConfig(t))})}
        ...
        `))}
    `}_moveButton(t,e){const i=[...this._config.buttons||[]],[s]=i.splice(t,1);i.splice(e,0,s),this._expandedButton=null,this._commit({...this._config,buttons:i})}_toggleButton(t){this._expandedButton=this._expandedButton===t?null:t}_addButton(){const t=[...this._config.buttons||[],{icon:"mdi:star",variant:"filled",size:"default"}];this._expandedButton=t.length-1,this._commit({...this._config,buttons:t})}_removeButton(t){const e=[...this._config.buttons||[]];e.splice(t,1),this._expandedButton===t&&(this._expandedButton=null),this._commit({...this._config,buttons:e})}_buttonChanged(t,e){const i=[...this._config.buttons||[]],s=i[t]?.options;i[t]=s&&!e.options?{...e,options:s}:e,this._commit({...this._config,buttons:i})}_optionSchema(t){return[Et(t?.icon)?{name:"icon",selector:{template:{}}}:{name:"icon",selector:{icon:{}}},{name:"label",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}_withButtonOptions(t,e){const i=[...this._config.buttons||[]],s={...i[t]},o=[...s.options||[]];e(o),o.length?s.options=o:delete s.options,i[t]=s,this._commit({...this._config,buttons:i})}_addOption(t){this._withButtonOptions(t,t=>{t.push({icon:"mdi:circle-outline"}),this._expandedOption=t.length-1})}_removeOption(t,e){this._expandedOption===e&&(this._expandedOption=null),this._withButtonOptions(t,t=>t.splice(e,1))}_moveOption(t,e,i){this._withButtonOptions(t,t=>{const[s]=t.splice(e,1);t.splice(i,0,s)}),this._expandedOption===e&&(this._expandedOption=i)}_optionChanged(t,e,i){this._withButtonOptions(t,t=>{t[e]={...t[e],...i}})}_toggleOption(t){this._expandedOption=this._expandedOption===t?null:t}}customElements.define("materia-icon-row-editor",Fi);const Oi=new Set(["split","split-button","materia-split-button"]);class Pi extends ct{static properties={hass:{attribute:!1},config:{state:!0}};static styles=[_t,n`
      .row {
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    `];static getConfigElement(){return document.createElement("materia-icon-row-editor")}static getStubConfig(){return{buttons:[{icon:"mdi:arrow-left",variant:"filled-tonal",size:"default"},{icon:"mdi:play",variant:"filled",size:"large"},{icon:"mdi:stop",variant:"filled",size:"large"},{icon:"mdi:arrow-right",variant:"filled-tonal",size:"default"}],gap:8,padding:4}}setConfig(t){if(!Array.isArray(t.buttons)||0===t.buttons.length)throw new Error("buttons array is required");this.config={gap:8,padding:4,...t}}getCardSize(){return 1}render(){if(!this.hass||!this.config)return I``;const t=this.config.gap??8,e=this.config.padding??4;return I`
      <div class="row" style="gap: ${t}px; padding: ${e}px 0;">
        ${this.config.buttons.map(t=>Oi.has(t.type)||Array.isArray(t.options)&&t.options.length>0?I`<materia-split-button
                .hass=${this.hass}
    ...
    `}}customElements.define("materia-icon-row",Pi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-icon-row",name:"Materia Icon Row",description:"A centered row of icon buttons with configurable spacing.",preview:!0});const qi={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-secondary)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-error)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-state":["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],"secondary-state":["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],"tertiary-state":["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],"error-state":["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],"device-state":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]},Ui=[_t,n`
    :host {
  ...
  `],Di=[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"},{value:"device",label:"Device"},{value:"primary-container",label:"Primary Container"},{value:"secondary-container",label:"Secondary Container"},{value:"error-container",label:"Error Container"},{value:"device-container",label:"Device Container"},{value:"primary-state",label:"Primary State"},{value:"secondary-state",label:"Secondary State"},{value:"tertiary-state",label:"Tertiary State"},{value:"error-state",label:"Error State"},{value:"device-state",label:"Device State"},{value:"battery",label:"Battery"}];customElements.define("materia-badge-editor",class extends zt{_sectionsSignature(){return this._config?.entity?"entity":"none"}get _sections(){const t=!!this._config?.entity,e=[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,template:!0,selector:{text:{}}},{name:"icon",required:!0,template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"variant",selector:{select:{mode:"dropdown",options:Di}}}]}];return t&&e.push({title:"State",icon:"mdi:state-machine",fields:[{name:"show_state",selector:{boolean:{}}},{name:"active_state",selector:{text:{}}},{name:"state_display",template:!0,selector:{text:{}}}]}),e.push({title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}),e}});const Bi={cover:"open",lock:["locked","locking"],vacuum:"cleaning",media_player:"playing",climate:"heat",alarm_control_panel:"armed_away"};class Ri extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedStateDisplay:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-badge-editor")}static getStubConfig(t){const e=(t?Object.keys(t.states):[]).find(t=>t.startsWith("light.")||t.startsWith("switch."))||"";return{name:"Badge",icon:"mdi:power-plug",variant:"primary",show_state:!1,active_state:"on",entity:e}}static styles=[ft,Ui];setConfig(t){if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config={show_state:!1,active_state:"on",variant:"secondary",tap_action:{action:"toggle"},...t}}updated(t){super.updated?.(t),t.has("hass")&&this.hass&&(this._resolveField("state_display","_resolvedStateDisplay"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}_isActive(t){if(!t)return!1;const e=t.state,i=this.config.active_state;if(null!=i)return Array.isArray(i)?i.includes(e):e===String(i);const s=t.entity_id.split(".")[0],o=Bi[s]||"on";return Array.isArray(o)?o.includes(e):e===o}_getBatteryColors(t){const e=parseFloat(t?.state);return Number.isNaN(e)?["var(--ha-card-background)","var(--primary-text-color)"]:e<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:e<20?["var(--md-sys-cust-color-warning-container, #ffecb3)","var(--md-sys-cust-color-on-warning-container, #6d4c00)"]:["var(--ha-card-background)","var(--primary-text-color)"]}get _templatesReady(){const t=this.config;return(!this._isTemplate(t.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(t.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(t.state_display)||void 0!==this._resolvedStateDisplay)&&((!this._isTemplate(t.icon)||void 0!==this._resolvedIcon)&&(!this._isTemplate(t.name)||void 0!==this._resolvedName))))}render(){if(!this.hass||!this.config)return I``;const t=this.config.entity,e=t?this.hass.states[t]:void 0,i=!!t&&this._isUnavailable(e),s=!i&&this._isActive(e),o=this.config.variant||"secondary",n=this.config.show_state;let a=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,r=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on;const l=["primary","tertiary","error","primary-container","secondary-container","error-container","device-container"];if(!a)if("battery"===o){const[t,i]=this._getBatteryColors(e);a=t,r=i}else if(l.includes(o)){const t=qi[o]||qi.secondary;a=t[0],r=r||t[1]}else if(s&&t){const t=qi[o]||qi.secondary;a=t[0],r=r||t[1]}else a="var(--ha-card-background)",r=r||"var(--primary-text-color)";r=r||"var(--primary-text-color)";const c=n?"with-state":"no-state",d=s?"active":"inactive";let h="";if(n&&i)h="Unavailable";else if(n&&e){const t=this.config.state_display&&(this.config.state_display.includes("{{")||this.config.state_display.includes("{%"));if(this._resolvedStateDisplay&&t)h=this._resolvedStateDisplay;else if(this.config.state_display&&!t)h=this.config.state_display;else{const t=e.state,i=Number(t);if(""===t||null==t||Number.isNaN(i))h=t;else{const t=e.attributes?.unit_of_measurement,s=Math.round(100*i)/100;h=t?"%"===t?`${s}%`:`${s} ${t}`:`${s}`}}h=this._capitalize(h)}return I`
    ...
    `}_handleTap(){if(this.config.double_tap_action?.action&&"none"!==this.config.double_tap_action.action){if(this._dblClickTimer)return;this._dblClickTimer=setTimeout(()=>{this._dblClickTimer=null,this._handleAction(this.config.tap_action||{action:"toggle"})},250)}else this._handleAction(this.config.tap_action||{action:"toggle"})}_handleDoubleTap(){this.config.double_tap_action?.action&&"none"!==this.config.double_tap_action.action&&(clearTimeout(this._dblClickTimer),this._dblClickTimer=null,this._handleAction(this.config.double_tap_action))}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._dblClickTimer),this._dblClickTimer=null}getCardSize(){return 2}}customElements.define("materia-badge",Ri),window.customCards=window.customCards||[],window.customCards.push({type:"materia-badge",name:"Materia Badge",description:"Square badge for dashboard headers.",preview:!0});const Ni={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},tertiary:{active:"var(--md-sys-color-tertiary)",onActive:"var(--md-sys-color-on-tertiary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat-container)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool-container)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto-container)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},ji={xs:{height:32,innerCorner:4},s:{height:36,innerCorner:8},m:{height:40,innerCorner:8},l:{height:48,innerCorner:16},xl:{height:56,innerCorner:20}},Li=[_t,gt,re,n`
    .group {
      display: flex;
      gap: 2px;
      width: 100%;
  ...
  `];class Ii extends zt{static properties={_expanded:{state:!0}};static styles=[zt.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
...
`];class Zi extends zt{static properties={_expanded:{state:!0}};static styles=[zt.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-menu",Ki),window.customCards=window.customCards||[],window.customCards.push({type:"materia-menu",name:"Materia Menu",description:"M3 vertical dropdown menu for select entities.",preview:!0});const Qi=n`
  :host {
    display: block;
  }
...
`;class Ji extends zt{static properties={_expanded:{state:!0}};static styles=[zt.styles,n`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
...
`;customElements.define("materia-media-progress-editor",class extends zt{_formData(){return{show_times:!0,seekable:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"show_times",selector:{boolean:{}}},{name:"seekable",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Wave color",color:!0,template:!0,selector:{text:{}}}]}]}});let is=0;class ss extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_w:{state:!0},_resolvedColor:{state:!0}};static styles=es;static getConfigElement(){return document.createElement("materia-media-progress-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("media_player."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config=t,this._cid??="mp-clip-"+ ++is}_position(){const t=this.hass?.states[this.config.entity];if(!t)return{pos:0,dur:0,playing:!1,live:!1};const e=Number(t.attributes.media_duration)||0;let i=Number(t.attributes.media_position)||0;const s="playing"===t.state,o=t.attributes.media_position_updated_at;s&&o&&(i+=(Date.now()-new Date(o).getTime())/1e3);const n=`${this.config.entity}|${t.attributes.media_content_id??t.attributes.media_title??""}`;return n!==this._latchKey&&(this._latchKey=n,this._live=!1),s?e>0&&i>=e-.25&&(this._live=!0):this._live=!1,e&&(i=Math.min(i,e)),{pos:Math.max(0,i),dur:e,playing:s,live:this._live}}_fmt(t){t=Math.max(0,Math.round(t));const e=Math.floor(t/3600),i=Math.floor(t%3600/60),s=t%60,o=t=>String(t).padStart(2,"0");return e>0?`${e}:${o(i)}:${o(s)}`:`${i}:${o(s)}`}_wavePath(t,e){let i="";for(let s=t;s<=e;s+=2){const t=14-2*Math.sin(2*Math.PI*s/32);i+=`${i?" L":"M"} ${s.toFixed(1)} ${t.toFixed(1)}`}return i||"M 0 14"}firstUpdated(){const t=this.shadowRoot?.querySelector(".bar");t&&(this._w=t.clientWidth,this._ro=new ResizeObserver(t=>{this._w=t[0].contentRect.width}),this._ro.observe(t))}updated(){const t=this.shadowRoot;this._clipRect=t?.querySelector("clipPath rect"),this._thumbEl=t?.querySelector(".thumb"),this._trackEl=t?.querySelector(".track"),this._posEl=t?.querySelector(".time");"playing"===this.hass?.states[this.config.entity]?.state&&!this._live?this._startLoop():this._stopLoop(),this.hass&&this._resolveField("color","_resolvedColor")}_startLoop(){if(this._raf)return;const t=()=>{this._raf=requestAnimationFrame(t),this._tickDom()};this._raf=requestAnimationFrame(t)}_tickDom(){const{pos:t,dur:e,live:i}=this._position(),s=this._w||300,o=(i?1:e>0?Math.min(1,t/e):0)*s;this._clipRect&&this._clipRect.setAttribute("width",Math.max(0,o)),this._thumbEl&&this._thumbEl.setAttribute("x",o-2),this._trackEl&&this._trackEl.setAttribute("x1",o),this._posEl&&(this._posEl.textContent=this._fmt(t)),i&&this._stopLoop()}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}_fullWave(t){return this._waveW!==t&&(this._waveW=t,this._wavePathCache=this._wavePath(-32,t+32)),this._wavePathCache}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),this._ro?.disconnect()}_seek(t){if(!1===this.config.seekable)return;const{dur:e}=this._position();if(!e)return;const i=t.currentTarget.getBoundingClientRect(),s=Math.max(0,Math.min(1,(t.clientX-i.left)/i.width));this._callService("media_player","media_seek",{entity_id:this.config.entity,seek_position:s*e})}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),{pos:i,dur:s,playing:o,live:n}=this._position(),a=this._w||300,r=(n?1:s>0?Math.min(1,i/s):0)*a,l=!1!==this.config.show_times,c=this._resolvedColor||this.config.color;return I`
    ...
    `}getCardSize(){return 1}}customElements.define("materia-media-progress",ss),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media-progress",name:"Materia Media Progress",description:"Wavy (M3 expressive) media seek bar with elapsed/duration and tap-to-seek.",preview:!0});const os=n`
  :host {
    display: block;
  }
      ...
      <ha-card style=${R}>
        <svg viewBox="0 0 100 100">
          ...
          ${m?W`
              ...
              `:""}
          ${_?W`<text class="date" x=${E} y=${A} font-size="8" text-anchor="middle" dominant-baseline="central" transform="rotate(${M.toFixed(1)} ${E} ${A})">${v}</text>`:""}
