        ...
        <div class="dial-wrap">
          ...
          >
            ...
            ${c?H`<g>
                  ...
                  <path d=${_e(u,m,2.9,12)} class="thumb-cookie" />
                </g>`:null!=p?H`<g>
                    <circle cx=${u} cy=${m} r="4.5" class="thumb muted" />
                    <path d=${_e(u,m,2.3,12)} class="thumb-cookie" />
                  </g>`:""}
          </svg>
