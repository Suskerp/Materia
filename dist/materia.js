...
/>`;class ve extends ce{static properties={gesture:{type:String,reflect:!0},label:{type:String},icon:{type:String},direction:{type:String},pending:{type:Boolean,reflect:!0},threshold:{type:Number},holdMs:{type:Number,attribute:"hold-ms"},disabled:{type:Boolean,reflect:!0},_p:{state:!0},_armed:{state:!0}};static styles=[ge,a`
      :host {
        display: block;
    ...
    `}}customElements.define("materia-drag-confirm",ve);class ye extends ce{static properties={year:{type:Number},month:{type:Number},selected:{type:Number},firstDay:{type:Number,attribute:"first-day"},noPast:{type:Boolean,attribute:"no-past"},locale:{type:String}};static styles=[ge,a`
      :host {
        display: block;
...
`,Ne=(e,t,i)=>({value:`var(--md-sys-cust-color-${e})`,swatch:`var(--md-sys-cust-color-${e}, ${i})`,label:t}),Re=(e,t)=>({value:`var(--md-sys-color-${e})`,swatch:`var(--md-sys-color-${e})`,label:t}),Pe=[{title:"Light",options:[Ne("light","Light","#FEE082"),Ne("light-container","Light container","#FEEFCA"),Ne("on-light","On light","#745D00")]},{title:"Device",options:[Ne("device","Device","#D9E2FE"),Ne("device-container","Device container","#EDF0FF"),Ne("on-device","On device","#0156CF")]},{title:"Climate · Heat",options:[Ne("climate-heat","Heat","#FFDFD4"),Ne("climate-heat-container","Heat container","#FFEEE9"),Ne("on-climate-heat","On heat","#A14614"),Ne("climate-heat-accent","Heat accent","#A14614")]},{title:"Climate · Cool",options:[Ne("climate-cool","Cool","#D3E8FF"),Ne("climate-cool-container","Cool container","#EAF3FF"),Ne("on-climate-cool","On cool","#327EA7"),Ne("climate-cool-accent","Cool accent","#327EA7")]},{title:"Climate · Auto",options:[Ne("climate-auto","Auto","#D4EBDD"),Ne("climate-auto-container","Auto container","#EAF6EE"),Ne("on-climate-auto","On auto","#2E5E44"),Ne("climate-auto-accent","Auto accent","#2E5E44")]},{title:"Water · Eco",options:[Ne("water-eco","Eco","#C8E6C9"),Ne("water-eco-container","Eco container","#E6F4EA"),Ne("on-water-eco","On eco","#256029")]},{title:"Water · Performance",options:[Ne("water-performance","Performance","#FFD1B0"),Ne("water-performance-container","Performance container","#FFEDE0"),Ne("on-water-performance","On performance","#9C3A00")]},{title:"Warning",options:[Ne("warning","Warning","#D9A000"),Ne("warning-container","Warning container","#FEEFCA"),Ne("on-warning","On warning","#FFFFFF"),Ne("on-warning-container","On warning container","#745D00")]},{title:"Error",options:[Ne("error","Error","#B3261E"),Ne("error-container","Error container","#F9DEDC"),Ne("on-error","On error","#FFFFFF"),Ne("on-error-container","On error container","#410E0B")]},{title:"Weather",options:[Ne("weather-sun","Sun","#F2B500"),Ne("weather-cloud","Cloud","#9FA9B7"),Ne("weather-cloud-dark","Cloud (dark)","#6F7A8A"),Ne("weather-rain","Rain","#2E86E0"),Ne("weather-snow","Snow","#AEB8C4"),Ne("weather-moon","Moon","#5961C2")]},{title:"Severity scale",options:[Ne("scale-green","Scale green","#5E9E50"),Ne("scale-yellow","Scale yellow","#C7A128"),Ne("scale-orange","Scale orange","#D9713C"),Ne("scale-red","Scale red","#C94D42"),Ne("scale-purple","Scale purple","#8A4DA3"),Ne("scale-maroon","Scale maroon","#7A4040")]},{title:"System (theme)",options:[Re("primary","Primary"),Re("primary-container","Primary container"),Re("secondary","Secondary"),Re("secondary-container","Secondary container"),Re("tertiary","Tertiary"),Re("tertiary-container","Tertiary container"),Re("error","Error"),Re("error-container","Error container"),Re("surface-container","Surface container")]}],Le=new Set(Pe.flatMap(e=>e.options.map(e=>e.value)));function Ue(e){return e&&"string"==typeof e&&(e.includes("{{")||e.includes("{%"))}const je={template:{}};class Be extends ce{static properties={label:{},value:{},_open:{state:!0},_customOpen:{state:!0}};static styles=a`
  ...
  `;setConfig(e){this._config=e,this._modes??={}}_formData(){return this._config||{}}get _sections(){return[]}_sectionsSignature(){return""}get _sectionsMemo(){const e=this._sectionsSignature();return this.__secSig===e&&this.__secVal||(this.__secSig=e,this.__secVal=this._sections),this.__secVal}_stableContext(e,t,i){const s={};for(const[e,n]of Object.entries(t))s[e]=i[n];this.__ctx??={};const n=this.__ctx[e];return n&&Object.keys(s).every(e=>n[e]===s[e])?n:(this.__ctx[e]=s,s)}_modeFor(e,t){const i=this._modes?.[e];return i||(Ue(t)?"template":"simple")}_toggleMode(e){const t=this._formData()[e],i=this._modeFor(e,t);this._modes={...this._modes||{},[e]:"template"===i?"simple":"template"}}render(){if(!this.hass||!this._config)return I``;const e=this._formData();return I`
    ...
    `}_renderField(e,t){const i=t[e.name],s=e.label??De(e),n=!!e.template,a=n?this._modeFor(e.name,i):"simple",o=e.context?this._stableContext(e.name,e.context,t):void 0;let r;return r=n&&"template"===a?I`
        <ha-selector
          class="field-control"
          .hass=${this.hass}
          .selector=${je}
      ...
      <ha-card>
        ...
        >
          ...
          <div class="icon-container">
            ${d?I`<div class="thumb" style="background-image: ${d};"></div>`:l?I`<ha-icon .icon=${l} style="color: ${a};"></ha-icon>`:I`<ha-state-icon
                    .hass=${this.hass}
                    .stateObj=${e}
                    style="color: ${a};"
                  ></ha-state-icon>`}
    ...
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}static styles=[Ee,Te,Me,Oe,Ae,Fe]}customElements.define("materia-card",Ze),window.customCards=window.customCards||[],window.customCards.push({type:"materia-card",name:"Materia Card",description:"Universal entity card. Auto-detects lights, covers, devices, locks, and scenes.",preview:!0});const Qe=a`
  .collapsible {
    display: grid;
...
`;class Je extends We{static properties={_selectedCard:{state:!0},_expandedButton:{state:!0}};static styles=[We.styles,a`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
...
`;customElements.define("materia-climate-editor",class extends We{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"name",required:!0,template:!0,selector:{text:{}}}]},{title:"Sensors",icon:"mdi:thermometer",fields:[{name:"temperature_entity",label:"Temperature sensor",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}},{name:"outdoor_temp_entity",label:"Outdoor temperature sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Behavior",icon:"mdi:tune",fields:[{name:"step",selector:{number:{min:.5,max:5,step:.5,mode:"box"}}}]}]}});class it extends(ze(ce)){static get properties(){return{hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_resolvedName:{state:!0}}}static styles=[Ee,Ae,tt];static getConfigElement(){return document.createElement("materia-climate-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("climate."))||"climate.example";return{entity:t,name:"Climate",step:.5}}setConfig(e){if(!e.entity)throw new Error("entity is required");if(!e.name)throw new Error("name is required");this.config={step:.5,...e}}getCardSize(){return 3}get _entity(){return this.hass?.states[this.config.entity]}get _mode(){return this._entity?.state??"off"}get _targetTemp(){return null!=this._optimisticTemp?this._optimisticTemp:this._entity?.attributes?.temperature}get _currentTemp(){return this.config.temperature_entity?this.hass?.states[this.config.temperature_entity]?.state:this._entity?.attributes?.current_temperature}get _humidity(){if(this.config.humidity_entity)return this.hass?.states[this.config.humidity_entity]?.state}get _outdoorTemp(){if(this.config.outdoor_temp_entity)return this.hass?.states[this.config.outdoor_temp_entity]?.state}_modeIcon(){switch(this._mode){case"heat":return"mdi:fire";case"cool":return"mdi:snowflake";case"auto":return"mdi:autorenew";default:return"mdi:power"}}_modeBg(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-climate-heat-container)";case"cool":return"var(--md-sys-cust-color-climate-cool-container)";case"auto":return"var(--md-sys-cust-color-climate-auto-container)";default:return"var(--md-sys-color-surface-container-highest, var(--md-sys-color-surface-variant))"}}_modeColor(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-on-climate-heat)";case"cool":return"var(--md-sys-cust-color-on-climate-cool)";case"auto":return"var(--md-sys-cust-color-on-climate-auto)";default:return"var(--primary-text-color)"}}_buttonBg(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-climate-heat)";case"cool":return"var(--md-sys-cust-color-climate-cool)";case"auto":return"var(--md-sys-cust-color-climate-auto)";default:return"var(--md-sys-color-surface-container-highest, var(--md-sys-color-surface-variant))"}}_buttonColor(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-on-climate-heat)";case"cool":return"var(--md-sys-cust-color-on-climate-cool, #fff)";case"auto":return"var(--md-sys-cust-color-on-climate-auto, #000)";default:return"var(--md-sys-color-on-surface)"}}_statusText(){const e=this._currentTemp,t=this._humidity,i=this._outdoorTemp,s=[];return null!=e&&s.push(`${e}°`),null!=t&&s.push(`${t}%`),null!=i&&s.push(`${i}°`),s.join(" · ")||""}_adjustTemp(e){const t=this._targetTemp;if(null==t)return;const i=this.config.step??.5,s=Number(this._entity?.attributes?.min_temp??7),n=Number(this._entity?.attributes?.max_temp??35),a=Math.min(n,Math.max(s,Math.round((Number(t)+e)/i)*i));this._optimisticTemp=a,this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:a}),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4)}updated(e){if(e.has("hass")&&this.hass&&this._resolveField("name","_resolvedName"),e.has("hass")&&null!=this._optimisticTemp){const e=Number(this._entity?.attributes?.temperature);Number.isFinite(e)&&Math.abs(e-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._optimisticTimer)}_handleTap(e){e.target.closest(".btn")||this._handleAction(this.config.tap_action??{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const e=this._entity,t=this._isUnavailable(e),i="off"===this._mode||t,s=t?"Unavailable":i?"Off":null!=this._targetTemp?Math.round(this._targetTemp):"—";return I`
    ...
    `}}customElements.define("materia-climate",it),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate",name:"Materia Climate",description:"Climate thermostat with mode-based theming and temperature controls.",preview:!0});const st=[Ee,Te,Ae,a`
  .container {
    position: relative;
    width: 100%;
    min-height: 50px;
...
`];customElements.define("materia-weather-editor",class extends We{_formData(){return{show_temperature:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Sensors",icon:"mdi:water-percent",fields:[{name:"show_temperature",label:"Show temperature",selector:{boolean:{}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const nt={sunny:"m3o:sunny",clear:"m3o:sunny","clear-night":"mdi:weather-night",partlycloudy:"m3o:partly-cloudy-day",partly_cloudy:"m3o:partly-cloudy-day",cloudy:"m3o:cloud",rainy:"m3o:rainy",pouring:"m3o:rainy",snowy:"mdi:weather-snowy",fog:"m3o:foggy",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",hail:"mdi:weather-hail",exceptional:"mdi:alert-circle-outline"},at={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class ot extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}static styles=st;setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"",s=!1!==this.config.show_temperature;let n=e?.attributes?.temperature,a=e?.attributes?.temperature_unit||"°";if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&(n=e.state,a=e.attributes?.unit_of_measurement||a)}const o=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||nt[i]||"mdi:weather-partly-cloudy";let r=null;if(this.config.humidity_entity){const e=this.hass.states[this.config.humidity_entity];e&&(r=e.state)}null==r&&null!=e?.attributes?.humidity&&(r=e.attributes.humidity);const l=at[i]||this._capitalize(i.replace(/-|_/g," ")),c=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,h=s&&null!=n?`${n}${a}`:null;let d;d=t?"Unavailable":c||(h||(l||"—"));const p=[];t||(h&&d!==h&&p.push(h),d!==l&&p.push(l),null!=r&&p.push(`${r}%`));const u=p.join(" · ");return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}function rt(e,t,i,s=12){return lt(e,t,i,{vertices:s,innerRadius:.8,rounding:.5,rotate:-Math.PI/2})}function lt(e,t,i,{vertices:s,innerRadius:n=null,rounding:a=.2,rotate:o=0}={}){const r=[],l=null!=n?2*s:s;for(let s=0;s<l;s++){const c=null!=n&&s%2==1?i*n:i,h=o+s/l*Math.PI*2;r.push({x:e+c*Math.cos(h),y:t+c*Math.sin(h),r:a*i})}return function(e){return ht(ct(e))}(r)}function ct(e){const t=e.length,i=[];for(let s=0;s<t;s++){const n=e[(s-1+t)%t],a=e[s],o=e[(s+1)%t],r=[n.x-a.x,n.y-a.y],l=[o.x-a.x,o.y-a.y],c=Math.hypot(...r),h=Math.hypot(...l);r[0]/=c,r[1]/=c,l[0]/=h,l[1]/=h;const d=r[0]*l[0]+r[1]*l[1],p=Math.acos(Math.min(1,Math.max(-1,d)))/2;let u=a.r/Math.tan(p);u=Math.min(u,.5*c,.5*h);const m=u*Math.tan(p),g=[a.x+r[0]*u,a.y+r[1]*u],f=[a.x+l[0]*u,a.y+l[1]*u],_=r[0]+l[0],b=r[1]+l[1],v=Math.hypot(_,b)||1,y=m/Math.sin(p),w=[a.x+_/v*y,a.y+b/v*y],x=r[0]*l[1]-r[1]*l[0];i.push({T1:g,T2:f,C:w,rEff:m,sweep:x>0?0:1})}return i}function ht(e){const t=e.length;let i=`M${e[0].T1[0].toFixed(2)} ${e[0].T1[1].toFixed(2)} `;for(let s=0;s<t;s++){const n=e[s],a=e[(s+1)%t];i+=`A${n.rEff.toFixed(2)} ${n.rEff.toFixed(2)} 0 0 ${n.sweep} ${n.T2[0].toFixed(2)} ${n.T2[1].toFixed(2)} `,i+=`L${a.T1[0].toFixed(2)} ${a.T1[1].toFixed(2)} `}return i+"Z"}function dt(e,t,i,s=0){return pt(e,t,i,s,[{x:.193,y:.277,r:.053},{x:.176,y:.055,r:.053}],10)}function pt(e,t,i,s,n,a){const o=[];for(let e=0;e<a;e++){const t=s+e/a*Math.PI*2,i=Math.cos(t),r=Math.sin(t);for(const e of n){const t=e.x-.5,s=e.y-.5;o.push({x:.5+t*i-s*r,y:.5+t*r+s*i,r:e.r})}}const r=ct(o),l=[];for(const e of r){const t=Math.atan2(e.T1[1]-e.C[1],e.T1[0]-e.C[0]);let i=Math.atan2(e.T2[1]-e.C[1],e.T2[0]-e.C[0])-t;if(1===e.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=8;s++){const n=t+i*s/8;l.push([e.C[0]+e.rEff*Math.cos(n),e.C[1]+e.rEff*Math.sin(n)])}}const c=Math.max(...l.map(([e,t])=>Math.hypot(e-.5,t-.5))),h=i/c,d=i=>[e+(i[0]-.5)*h,t+(i[1]-.5)*h];return ht(r.map(e=>({T1:d(e.T1),T2:d(e.T2),C:d(e.C),rEff:e.rEff*h,sweep:e.sweep})))}function ut(e,t,i,{points:s,reps:n=1,mirroring:a=!1,rotate:o=0}){const r=function(e,t,i,s=.5,n=.5){const a=[];if(!i){const i=e.length;for(let o=0;o<i*t;o++){const r=e[o%i],l=360*Math.floor(o/i)/t*(Math.PI/180),c=r.x-s,h=r.y-n;a.push({x:s+c*Math.cos(l)-h*Math.sin(l),y:n+c*Math.sin(l)+h*Math.cos(l),r:r.r})}return a}const o=e.map(e=>180*Math.atan2(e.y-n,e.x-s)/Math.PI),r=e.map(e=>Math.hypot(e.x-s,e.y-n)),l=2*t,c=360/l;for(let t=0;t<l;t++){const i=t%2==0;for(let l=0;l<e.length;l++){const h=i?l:e.length-1-l;if(!(h>0||i))continue;const d=(c*t+(i?o[h]:c-o[h]+2*o[0]))*(Math.PI/180);a.push({x:s+Math.cos(d)*r[h],y:n+Math.sin(d)*r[h],r:e[h].r})}}return a}(s,n,a),l=Math.cos(o),c=Math.sin(o),h=r.map(e=>{const t=e.x-.5,i=e.y-.5;return{x:.5+t*l-i*c,y:.5+t*c+i*l,r:e.r}}),d=ct(h),p=function(e){let t=1/0,i=1/0,s=-1/0,n=-1/0;const a=(e,a)=>{e<t&&(t=e),e>s&&(s=e),a<i&&(i=a),a>n&&(n=a)};for(const t of e){const e=Math.atan2(t.T1[1]-t.C[1],t.T1[0]-t.C[0]);let i=Math.atan2(t.T2[1]-t.C[1],t.T2[0]-t.C[0])-e;if(1===t.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=16;s++){const n=e+i*s/16;a(t.C[0]+t.rEff*Math.cos(n),t.C[1]+t.rEff*Math.sin(n))}}return{minX:t,minY:i,maxX:s,maxY:n}}(d),u=p.maxX-p.minX,m=p.maxY-p.minY,g=i/Math.max(u,m),f=(p.minX+p.maxX)/2,_=(p.minY+p.maxY)/2,b=i=>[e+(i[0]-f)*g,t+(i[1]-_)*g];return ht(d.map(e=>({T1:b(e.T1),T2:b(e.T2),C:b(e.C),rEff:e.rEff*g,sweep:e.sweep})))}function mt(e,t,i,s,n){const a=s=>{const n=(s-90)*Math.PI/180;return[e+i*Math.cos(n),t+i*Math.sin(n)]},[o,r]=a(s),[l,c]=a(n),h=Math.abs(n-s)>180?1:0;return`M${o.toFixed(2)} ${r.toFixed(2)} A${i} ${i} 0 ${h} 1 ${l.toFixed(2)} ${c.toFixed(2)}`}function gt(e,t,i,s){const n=Math.cos(2*Math.PI*s);if(s<.02||s>.98)return"";const a=Math.max(.01,Math.abs(n)*i).toFixed(2),o=`${e} ${t-i}`,r=`${e} ${t+i}`;return s<=.5?`M${o} A${i} ${i} 0 0 1 ${r} A${a} ${i} 0 0 ${n>0?0:1} ${o} Z`:`M${o} A${i} ${i} 0 0 0 ${r} A${a} ${i} 0 0 ${n>0?1:0} ${o} Z`}function ft(e,t){const i={new_moon:0,waxing_crescent:.125,first_quarter:.25,waxing_gibbous:.375,full_moon:.5,waning_gibbous:.625,last_quarter:.75,waning_crescent:.875},s=t?e?.states?.[t]:e?.states?.["sensor.moon_phase"]??e?.states?.["sensor.moon"];return s&&s.state in i?i[s.state]:null}customElements.define("materia-weather",ot),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather",name:"Materia Weather",description:"Weather condition card with automatic icon mapping.",preview:!0});const _t="var(--md-sys-cust-color-weather-sun, #FFC83D)",bt="var(--md-sys-cust-color-weather-cloud, #E6EAF0)",vt="var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)",yt="var(--md-sys-cust-color-weather-rain, #5FA8F5)",wt="var(--md-sys-cust-color-weather-sun, #FFC83D)",xt="var(--md-sys-cust-color-weather-moon, #DCE3F7)";let kt=0;function $t(e,t,i,s){const n=.1*i,a=72,o=[];for(let s=0;s<a;s++){const r=s/a*Math.PI*2,l=i+n*Math.cos(9*r);o.push([e+l*Math.cos(r),t+l*Math.sin(r)])}let r=`M${o[0][0].toFixed(2)} ${o[0][1].toFixed(2)} `;for(let e=0;e<a;e++){const t=o[(e-1+a)%a],i=o[e],s=o[(e+1)%a],n=o[(e+2)%a],l=i[0]+(s[0]-t[0])/6,c=i[1]+(s[1]-t[1])/6,h=s[0]-(n[0]-i[0])/6,d=s[1]-(n[1]-i[1])/6;r+=`C${l.toFixed(2)} ${c.toFixed(2)} ${h.toFixed(2)} ${d.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return H`<path d=${r+"Z"} fill=${s} />`}function Ct(e,t,i,s){return H`
  ...
  </g>`}function zt(e,t){return H`<g fill=${"var(--md-sys-cust-color-weather-snow, #FFFFFF)"}>
    ${e.map(e=>H`<circle cx=${e} cy=${t} r="1.2" />`)}
  </g>`}const Tt={sunny:e=>$t(12,12,7.5,e.sun),clear:e=>$t(12,12,7.5,e.sun),"clear-night":(e,t)=>{if(null==t)return H`<path d="M17 14.5 A7 7 0 1 1 10.5 5 A5.5 5.5 0 0 0 17 14.5 Z" fill=${e.moon} />`;const i=gt(12,12,7.2,t);return H`
      <circle cx="12" cy="12" r="7.2" fill="color-mix(in srgb, ${xt} 22%, transparent)" />
      ${i?H`<path d=${i} fill=${e.moon} />`:""}`},partlycloudy:e=>H`${$t(12,8,5.2,e.sun)}${Ct(10,15,.85,e.cloud)}`,partly_cloudy:e=>H`${$t(12,8,5.2,e.sun)}${Ct(10,15,.85,e.cloud)}`,cloudy:e=>Ct(12,12,1.1,e.cloudDk),rainy:e=>H`${Ct(12,10,1,e.cloudDk)}${St(yt,[8,12,16],17)}`,pouring:e=>H`${Ct(12,9.5,1,e.cloudDk)}${St(yt,[7,10,13,16],16.5)}`,snowy:e=>H`${Ct(12,10,1,e.cloud)}${zt([8,12,16],18)}`,"snowy-rainy":e=>H`${Ct(12,10,1,e.cloud)}${St(yt,[9,15],17)}${zt([12],18)}`,fog:e=>H`${Ct(12,9,.95,e.cloudDk)}<g stroke=${"var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)"} stroke-width="1.8" stroke-linecap="round">
      <line x1="6" y1="17" x2="18" y2="17" /><line x1="7.5" y1="20" x2="16.5" y2="20" /></g>`,hail:e=>H`${Ct(12,10,1,e.cloudDk)}${zt([8,12,16],18)}`,lightning:e=>H`${Ct(12,10,1,e.cloudDk)}<path d="M12 14 l-2.5 5 h2 l-1 4 4.5-6.5 h-2.2 l1.5-2.5 z" fill=${wt} />`,"lightning-rainy":e=>H`${Ct(12,9.5,1,e.cloudDk)}${St(yt,[8,16],17)}<path d="M12 14 l-2 4 h1.8 l-0.8 3.5 4-5.5 h-2 l1.3-2 z" fill=${wt} />`,windy:()=>H`<g stroke=${vt} stroke-width="2" stroke-linecap="round" fill="none">
      ...
      <path d="M4 9 h11 a2.5 2.5 0 1 0-2.5-2.5" />
      <path d="M4 14 h14 a2.5 2.5 0 1 1-2.5 2.5" /></g>`,exceptional:e=>Ct(12,12,1.1,e.cloudDk)};function At(e,t=null){const i=Tt[e]||Tt.cloudy,s=++kt;return H`${function(e){return H`<defs>
  ...
  </defs>`}(s)}${i(function(e){return{sun:`url(#wxSunG-${e})`,cloud:`url(#wxCloudG-${e})`,cloudDk:`url(#wxCloudDkG-${e})`,moon:`url(#wxMoonG-${e})`}}(s),t)}`}const Et=[Ee,Te,a`
  ha-card {
    background: none;
    border: none;
    box-shadow: none;
...
`];customElements.define("materia-weather-tile-editor",class extends We{_formData(){return{show_minmax:!1,size:10,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"icon",label:"Custom icon (overrides the colored glyph)",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Min / Max",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show min / max",selector:{boolean:{}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"size",label:"Size (10 = fill)",selector:{number:{min:1,max:10,step:1,mode:"slider"}}},{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / temperature",color:!0,template:!0,selector:{text:{}}},{name:"minmax_color",label:"Min / max color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class Mt extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedMinmaxColor:{state:!0},_forecast:{state:!0}};static styles=Et;static getConfigElement(){return document.createElement("materia-weather-tile-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,show_minmax:!0}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("minmax_color","_resolvedMinmaxColor"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"";let s=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&(s=e.state)}const n=null!=this._num(s)?`${this._num(s)}°`:"—",a=e=>{const t=e?this.hass.states[e]:null;return t&&!this._isUnavailable(t)?t.state:null};let o=a(this.config.low_entity),r=a(this.config.high_entity);const l=this._forecast?.[0]||e?.attributes?.forecast?.[0];null==o&&null!=l?.templow&&(o=l.templow),null==r&&null!=l?.temperature&&(r=l.temperature);const c=this.config.show_minmax&&(null!=this._num(o)||null!=this._num(r)),h=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,d=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,p=this._isTemplate(this.config.minmax_color)?this._resolvedMinmaxColor:this.config.minmax_color;let u="number"==typeof this.config.tilt?this.config.tilt:{right:-45,left:45,none:0}[this.config.tilt]??-45;this.config.mirror&&(u=-u);const m=this.config.icon_size??(c?34:36),g=this.config.text_size??(c?26:30),f=this.config.minmax_size??5.5,_=this.config.temp_x??5,b=this.config.temp_y??-18,v=this.config.icon_x??-5,y=this.config.icon_y??18,w=this.config.width??100,x=(this.config.height??85)/100,k=(this.config.pill_scale??88)/100,$=`--wt-size:${["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][Math.min(10,Math.max(1,this.config.size??10))-1]};--wt-tilt:${u}deg;--wt-pill-scale:${k};--wt-icon-size:${m}cqi;--wt-temp-size:${g}cqi;--wt-minmax-size:${f}cqi;--wt-width:${w}%;--wt-ratio:${x};--wt-temp-x:${_}cqi;--wt-temp-y:${b}cqi;--wt-icon-x:${v}cqi;--wt-icon-y:${y}cqi;${h?`--wt-bg:${h};`:""}${d?`--wt-fg:${d};`:""}`+(p?`--wt-minmax:${p};--wt-minmax-opacity:1;`:""),C=this.config.icon;return I`
  ...
  `];customElements.define("materia-weather-hero-editor",class extends We{_formData(){return{show_condition:!0,show_icon:!0,show_feels_like:!0,show_minmax:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Real temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"feels_like_entity",label:"Feels-like sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"show_condition",label:"Show condition text",selector:{boolean:{}}},{name:"show_icon",label:"Show condition glyph",selector:{boolean:{}}},{name:"show_feels_like",label:"Show feels-like",selector:{boolean:{}}}]},{title:"Night / Day",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show night / day range",selector:{boolean:{}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"night_label",label:"Night label",selector:{text:{}}},{name:"day_label",label:"Day label",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const Ft={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class Dt extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColorOn:{state:!0}};static styles=Ot;static getConfigElement(){return document.createElement("materia-weather-hero-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color_on","_resolvedColorOn"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"",s=Ft[i]||this._capitalize(String(i).replace(/-|_/g," "));let n=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&!this._isUnavailable(e)&&(n=e.state)}const a=this._num(n);let o=e?.attributes?.apparent_temperature;if(this.config.feels_like_entity){const e=this.hass.states[this.config.feels_like_entity];e&&!this._isUnavailable(e)&&(o=e.state)}const r=this._num(o),l=e=>{const t=e?this.hass.states[e]:null;return t&&!this._isUnavailable(t)?t.state:null};let c=l(this.config.low_entity),h=l(this.config.high_entity);const d=this._forecast?.[0]||e?.attributes?.forecast?.[0];null==c&&null!=d?.templow&&(c=d.templow),null==h&&null!=d?.temperature&&(h=d.temperature);const p=this._num(c),u=this._num(h),m=this.config.night_label??$e("wh_night",this.hass),g=this.config.day_label??$e("wh_day",this.hass),f=this.config.separator??"•",_=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}function qt(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}function Nt(e,{locale:t="en",showPrecip:i=!0,minPrecip:s=10,moonPhase:n=null}={}){return e.map(e=>{const a=qt(e.temperature),o=qt(e.precipitation_probability),r=new Date(e.datetime),l=Number.isNaN(r.getTime())?"":r.toLocaleTimeString(t,{hour:"numeric"});return I`
      <div class="hour">
        <span class="h-temp">${null!=a?`${a}°`:"—"}</span>
        <svg class="h-glyph" viewBox="0 0 24 24">${At(e.condition,n)}</svg>
        ${i&&null!=o&&o>=s?I`<span class="h-precip">${o}%</span>`:I`<span class="h-precip empty"></span>`}
        <span class="h-time">${l}</span>
      </div>
    `})}customElements.define("materia-weather-hero",Dt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-hero",name:"Materia Weather Hero",description:"Current-conditions hero: condition, huge temperature, feels-like and night/day range.",preview:!0});const Rt=a`
  .hours {
    display: flex;
    gap: 4px;
    overflow-x: auto;
...
`,Pt=[Ee,Te,Ae,ge,Rt,a`
  ...
  `];customElements.define("materia-forecast-daily-editor",class extends We{_formData(){return{days:10,show_hourly:!0,show_precipitation:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"days",label:"Days shown",selector:{number:{min:3,max:15,step:1,mode:"slider"}}},{name:"show_hourly",label:"Tap a day to expand its hourly detail",selector:{boolean:{}}},{name:"show_precipitation",label:"Show precipitation chance",selector:{boolean:{}}},{name:"min_precipitation",label:"Hide below (%)",selector:{number:{min:0,max:100,step:5,mode:"box"}}},{name:"today_label",label:"Label for today",selector:{text:{}}}]}]}});class Ut extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_hourly:{state:!0},_selected:{state:!0},_expanded:{state:!0}};static styles=Lt;static getConfigElement(){return document.createElement("materia-forecast-daily-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0,this._selected=0,this._expanded=!1}updated(e){e.has("hass")&&this.hass&&this._subscribeForecast()}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=null,this._hourly=[],this._hourlyByDay=new Map;const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});if(t.catch(()=>{}),this._fcUnsubs=[t],!1!==this.config.show_hourly){const t=this.hass.connection.subscribeMessage(e=>{this._hourly=e?.forecast||[];const t=new Map;for(const e of this._hourly){const i=this._dayKey(e.datetime);if(!i)continue;const s=t.get(i)||[];s.length<24&&s.push(e),t.set(i,s)}this._hourlyByDay=t},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e});t.catch(()=>{}),this._fcUnsubs.push(t)}}_unsubForecast(){for(const e of this._fcUnsubs||[])e.then(e=>e&&e()).catch(()=>{});this._fcUnsubs=null,this._fcEntity=void 0}_dayKey(e){const t=this.hass?.config?.time_zone;if(!this._dayFmt||this._dayFmtTz!==t){this._dayFmtTz=t;try{this._dayFmt=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"})}catch{this._dayFmt=new Intl.DateTimeFormat("en-CA",{year:"numeric",month:"2-digit",day:"2-digit"})}}const i=new Date(e);return Number.isNaN(i.getTime())?"":this._dayFmt.format(i)}_hoursFor(e){return e?.datetime&&this._hourlyByDay?.size&&this._hourlyByDay.get(this._dayKey(e.datetime))||[]}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}_dayLabel(e,t){const i=new Date(e);if(Number.isNaN(i.getTime()))return"";const s=new Date;if(0===t&&this._dayKey(e)===this._dayKey(s))return this.config.today_label??$e("fc_today",this.hass);const n=this.hass?.locale?.language||navigator.language||"en";return i.toLocaleDateString(n,{weekday:"short"})}_onPointerDown(e){if("mouse"!==e.pointerType)return;const t=e.currentTarget;this._dragStartX=e.clientX,this._dragStartScroll=t.scrollLeft,this._didDrag=!1,this._dragPointerId=e.pointerId}_onPointerMove(e){if(null==this._dragStartX)return;const t=e.clientX-this._dragStartX;!this._didDrag&&Math.abs(t)>4&&(this._didDrag=!0,e.currentTarget.setPointerCapture(this._dragPointerId)),this._didDrag&&(e.currentTarget.scrollLeft=this._dragStartScroll-t)}_onPointerUp(e){null!=this._dragStartX&&(e.currentTarget.releasePointerCapture?.(e.pointerId),this._dragStartX=null,setTimeout(()=>{this._didDrag=!1},0))}_select(e,t){this._didDrag||(this._expanded=e!==this._selected||!this._expanded,this._selected=e,this.dispatchEvent(new CustomEvent("materia-forecast-day-selected",{detail:{index:e,day:t},bubbles:!0,composed:!0})))}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=(this._forecast?.length?this._forecast:e?.attributes?.forecast||[]).slice(0,this.config.days??10);if(!i.length)return I``;const s=!1!==this.config.show_precipitation,n=this.config.min_precipitation??10,a=i[this._selected],o=!1!==this.config.show_hourly&&this._expanded&&a?this._hoursFor(a):[],r=this._expanded&&o.length>0,l=this.hass?.locale?.language||navigator.language||"en";return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-hourly",jt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-hourly",name:"Materia Forecast Hourly",description:"Pixel-style hourly forecast strip with colored glyphs and precipitation chance.",preview:!0});const Bt=[Ee,Te,Ae,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],It=[{value:"wind",label:"Wind"},{value:"uv",label:"UV index"},{value:"aqi",label:"Air quality"},{value:"pollen",label:"Pollen"},{value:"precipitation",label:"Precipitation"},{value:"sun",label:"Sunrise & sunset"},{value:"visibility",label:"Visibility"},{value:"humidity",label:"Humidity"},{value:"pressure",label:"Pressure"}],Ht={pollen:{variant:"gauges",max_shown:4}};customElements.define("materia-weather-metric-editor",class extends We{_formData(){return{metric:"wind",...Ht[this._config?.metric],...this._config}}_sectionsSignature(){return this._config?.metric||""}get _sections(){const e=this._config?.metric,t={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"metric",required:!0,selector:{select:{mode:"dropdown",options:It}}},..."sun"!==e&&"pollen"!==e?[{name:"entity",label:"Weather entity",selector:{entity:{domain:"weather"}}},{name:"sensor",label:"Sensor override (optional)",selector:{entity:{domain:"sensor"}}}]:[],{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon (overrides default)",selector:{icon:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"wind"===e&&i.fields.push({name:"unit",label:"Unit (converts from the source)",selector:{select:{mode:"dropdown",options:[{value:"km/h",label:"km/h"},{value:"m/s",label:"m/s"},{value:"mph",label:"mph"},{value:"kn",label:"knots"},{value:"bft",label:"Beaufort"}]}}},{name:"bearing_entity",label:"Bearing sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"from_label",label:'"From" label',selector:{text:{}}}),"humidity"===e&&i.fields.push({name:"dew_entity",label:"Dew point sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"dew_label",label:"Dew point label",selector:{text:{}}}),"pressure"===e&&i.fields.push({name:"min",label:"Gauge min",selector:{number:{mode:"box"}}},{name:"max",label:"Gauge max",selector:{number:{mode:"box"}}}),"precipitation"===e&&i.fields.push({name:"total_label",label:"Subtitle when raining",selector:{text:{}}},{name:"none_label",label:'"None expected" label',selector:{text:{}}}),"sun"===e&&i.fields.push({name:"sun_entity",label:"Sun entity",selector:{entity:{domain:"sun"}}},{name:"moon_entity",label:"Moon phase sensor (built-in Moon integration)",selector:{entity:{domain:"sensor"}}}),"pollen"===e&&i.fields.push({name:"entities",label:"Pollen sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"variant",label:"Variant",selector:{select:{mode:"dropdown",options:[{value:"gauges",label:"Gauges (wide)"},{value:"small",label:"Small (dot list)"}]}}},{name:"max_shown",label:"Max species shown (worst first)",selector:{number:{min:1,max:6,step:1,mode:"slider"}}},{name:"hide_inactive",label:"Hide species at 'none'",selector:{boolean:{}}},{name:"max",label:"Scale max for numeric sensors (default 4)",selector:{number:{min:1,max:10,mode:"box"}}});const s={title:"Appearance",icon:"mdi:palette-outline",fields:[..."wind"===e?[{name:"shape_color",label:"Shape color",color:!0,template:!0,selector:{text:{}}}]:[],{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},n={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[t,i,s,n]:[t,s,n]}});const Wt="var(--md-sys-cust-color-scale-green, #5E9E50)",Vt="var(--md-sys-cust-color-scale-yellow, #C7A128)",Gt="var(--md-sys-cust-color-scale-orange, #D9713C)",Xt="var(--md-sys-cust-color-scale-red, #C94D42)",Yt="var(--md-sys-cust-color-scale-purple, #8A4DA3)",Kt=[{max:2,label:"Low",color:Wt},{max:5,label:"Moderate",color:Vt},{max:7,label:"High",color:Gt},{max:10,label:"Very high",color:Xt},{max:1/0,label:"Extreme",color:Yt}],Zt=[{max:50,label:"Good air quality",color:Wt},{max:100,label:"Moderate air quality",color:Vt},{max:150,label:"Unhealthy for sensitive groups",color:Gt},{max:200,label:"Unhealthy air quality",color:Xt},{max:300,label:"Very unhealthy air quality",color:Yt},{max:1/0,label:"Hazardous air quality",color:"var(--md-sys-cust-color-scale-maroon, #7A4040)"}],Qt=["None","Low","Moderate","High","Very high"];class Jt extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=Bt;static getConfigElement(){return document.createElement("materia-weather-metric-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,metric:"wind"}}setConfig(e){if(!e.metric)throw new Error("metric is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),"precipitation"!==this.config.metric||this.config.sensor?this._unsubForecast():this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){"precipitation"!==this.config?.metric||this.config.sensor||this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_numRaw(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}_value(e){if(this.config.sensor){const e=this.hass.states[this.config.sensor];return e&&!this._isUnavailable(e)?this._numRaw(e.state):null}const t=this.hass.states[this.config.entity];return this._numRaw(t?.attributes?.[e])}_weatherAttr(e){return this.hass.states[this.config.entity]?.attributes?.[e]}_scallopWave(e){const t=200/12;let i=`M0 ${e+3.2} `;for(let s=0;s<200;s+=t)i+=`Q ${s+t/2} ${e-3.2} ${s+t} ${e+3.2} `;return i+"V100 H0 Z"}render(){if(!this.hass||!this.config)return I``;const e={wind:()=>this._wind(),uv:()=>this._uv(),aqi:()=>this._aqi(),pollen:()=>this._pollen(),precipitation:()=>this._precipitation(),sun:()=>this._sun(),visibility:()=>this._visibility(),humidity:()=>this._humidity(),pressure:()=>this._pressure()}[this.config.metric];if(!e)return I``;const t=e();if(t===V)return I``;const i=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,s=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,n=null!=this.config.size?Math.min(10,Math.max(1,this.config.size)):null;return I`
    ...
    `}_uv(){const e=this._value("uv_index");if(null==e)return V;const t=Kt.find(t=>e<=t.max),i=Kt.map((e,i)=>{const s=(160-35*i)*Math.PI/180,n=50+33*Math.cos(s),a=52+33*Math.sin(s),o=e===t;return H`<circle cx=${n} cy=${a} r=${o?4.5:2.6}
    ...
    `}_pressure(){const e=this._value("pressure");if(null==e)return V;const t=this.config.unit??this._weatherAttr("pressure_unit")??"hPa",i=this.config.min??("hPa"===t?950:28),s=this.config.max??("hPa"===t?1050:31),n=Math.min(1,Math.max(0,(e-i)/(s-i))),a=270*n-135,o=this.hass?.locale?.language||navigator.language||"en",r="hPa"===t?Math.round(e).toLocaleString(o):e;return I`
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          ...
          ${n>.01?H`<path d=${mt(50,52,37.5,-135,a)} class="gauge-fill thin" />`:""}
        </svg>
        <div class="overlay">
    ...
    `}_sun(){const e=this.hass.states[this.config.sun_entity??"sun.sun"];if(!e)return V;const t=e.attributes?.next_rising,i=e.attributes?.next_setting;if(!t||!i)return V;const s=this.hass?.locale?.language||navigator.language||"en",n=e=>new Date(e).toLocaleTimeString(s,{hour:"numeric",minute:"2-digit"}),a=e=>e.getHours()+e.getMinutes()/60,o=a(new Date(t)),r=a(new Date(i)),l=a(new Date),c=(r-o+24)%24||12,h=24-c,d=24,p=e=>e/24*100,u=e=>{const t=(e-o+24)%24;return t<=c?d-17*Math.sin(Math.PI*t/c):d+9*Math.sin(Math.PI*(t-c)/h)},m=(e,t)=>{const i=[];for(let s=e;s<t;s+=.25)i.push(`${p(s).toFixed(2)} ${u(s).toFixed(2)}`);return i.push(`${p(t).toFixed(2)} ${u(t).toFixed(2)}`),i.join(" L")},g=`M${p(o).toFixed(2)} 24 L${m(o,r)} Z`,f=o>.01?`M0 24 L${m(0,o)} Z`:"",_=r<23.99?`M${p(r).toFixed(2)} 24 L${m(r,24)} L100 24 Z`:"",b=(l-o+24)%24<=c,v=p(l),y=u(l),w=this.config.moon_entity??(this.hass.states["sensor.moon_phase"]?"sensor.moon_phase":"sensor.moon"),x=this.hass.states[w],k=ft(this.hass,this.config.moon_entity),$=k??.5;return I`
  ...
  `],customElements.define("materia-weather-glance-editor",ii);const si={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class ni extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedAlert:{state:!0}};static styles=ei;static getConfigElement(){return document.createElement("materia-weather-glance-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,metrics:["minmax"]}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={metrics:["minmax"],...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("alert","_resolvedAlert"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}_metricData(e,t){const i=t?.attributes||{},s=this._forecast?.[0]||i.forecast?.[0];let n=null,a=0;switch(e.type){case"condition":{const e=t?.state??"";n=si[e]||this._capitalize(String(e).replace(/-|_/g," ")),/lightning/.test(e)?a=3:/pouring|snowy|hail/.test(e)?a=2:/rainy|fog|windy/.test(e)&&(a=1);break}case"minmax":{const e=this._num(s?.temperature),t=this._num(s?.templow);if(null==e&&null==t)return null;n=`${null!=e?`${e}°`:"—"} ${null!=t?`${t}°`:"—"}`;break}case"wind":{const e=this._num(i.wind_speed);if(null==e)return null;const t=this._num(i.wind_bearing);n=`${e} ${i.wind_speed_unit??"km/h"}${null!=t?` ${o=t,["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round((o%360+360)%360/22.5)%16]}`:""}`,a=e>=88?4:e>=62?3:e>=39?2:e>=20?1:0;break}case"humidity":{const e=this._num(i.humidity);if(null==e)return null;n=`${e}%`,a=e>=85||e<=20?2:e>=70||e<=30?1:0;break}case"uv":{const e=this._num(i.uv_index);if(null==e)return null;n=`UV ${e}`,a=e>=11?4:e>=8?3:e>=6?2:e>=3?1:0;break}case"precipitation":{const t=s?.precipitation,o=null==t?null:Number(t);if(null==o||!Number.isFinite(o))return null;n=`${e.label??$e("wg_rain",this.hass)} ${o} ${i.precipitation_unit??"mm"}`,a=o>=10?3:o>=2?2:o>0?1:0;break}case"pressure":{const e=this._num(i.pressure);if(null==e)return null;n=`${e} ${i.pressure_unit??"hPa"}`,a=Math.abs(e-1013)>=25?2:Math.abs(e-1013)>=15?1:0;break}case"pollen":{const t={none:0,active:1,green:1,yellow:2,orange:3,red:4,purple:5},i=["None","Low","Low","Moderate","High","Very high","Extreme"],s=e.entities||this.config.pollen_entities||[];let o=null;for(const e of s){const i=this.hass.states[e];if(!i||this._isUnavailable(i))continue;const s=t[String(i.state).toLowerCase()]??this._num(i.state)??0;if(!o||s>o.v){const t=i.attributes.friendly_name||e,n=t.replace(/pollen/i,"").trim().split(/\s+/);o={v:s,label:n[n.length-1]||t}}}if(!o)return null;const r=e.label??this.config.pollen_label??$e("wm_pollen",this.hass);n=0===o.v?this.config.no_pollen_label??`${r} none`:`${r} ${o.label} ${i[o.v+1]??o.v}`,a=o.v;break}case"aqi":{const t=e.entity??this.config.aqi_entity,i=t?this.hass.states[t]:null;if(!i||this._isUnavailable(i))return null;const s=this._num(i.state);if(null==s)return null;n=`AQI ${s}`,a=s>200?4:s>150?3:s>100?2:s>50?1:0;break}case"sensor":{const t=e.entity?this.hass.states[e.entity]:null;if(!t||this._isUnavailable(t))return null;const i=e.unit??t.attributes.unit_of_measurement??"";n=`${e.label?`${e.label} `:""}${t.state}${i?` ${i}`:""}`;break}default:return null}var o;null!=e.severity&&(a=Number(e.severity)||0);return{text:n,sev:a,icon:e.icon??(this.config.show_metric_icons?{minmax:"mdi:thermometer",wind:"mdi:weather-windy",humidity:"mdi:water-percent",uv:"mdi:white-balance-sunny",precipitation:"m3o:rainy",pressure:"mdi:gauge",pollen:"m3of:allergy",aqi:"mdi:waves",sensor:"mdi:information-outline"}[e.type]:null),type:e.type}}_metricItems(e){const t=this.config.priority??["precipitation","pollen","aqi"],i=e=>{const i=t.indexOf(e);return-1===i?0:(t.length-i)/(t.length+1)},s=(this.config.metrics||[]).map(e=>"string"==typeof e?{type:e}:e).filter(e=>"condition"!==e.type),n=s.map(t=>this._metricData(t,e)).filter(Boolean);return this.config.sort_by_severity&&n.sort((e,t)=>t.sev+i(t.type)-(e.sev+i(e.type))),n}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"";let s=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&!this._isUnavailable(e)&&(s=e.state)}const n=this._num(s),a=this._isTemplate(this.config.alert)?this._resolvedAlert:this.config.alert,o=a?null:this._metricData({type:"condition"},e),r=this.config.max_metrics??1/0,l=this._metricItems(e).slice(0,r),c=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,h=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,d=this.config.show_chevron??"navigate"===this.config.tap_action?.action,p=e=>I`<span class="m">
    ...
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-weather-glance",ni),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-glance",name:"Materia Weather Glance",description:"Weather pill for the home screen: glyph, configurable metric lines or an alert, big temperature.",preview:!0});const ai=[Ee,Te,Ae,ge,a`
    ha-card {
      border-radius: 24px;
      padding: 16px 20px;
  ...
  `];class oi extends We{static styles=[We.styles,a`
      .yaml-note {
        margin-top: 14px;
        padding: 10px 12px;
        border-radius: 12px;
...
rows:
  ...
  - entity: sensor.over_kw
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1+(Array.isArray(this.config?.rows)&&this.config.rows.length?this.config.rows.length:this.config?.entities?.length||0)}}function li(e,t){return!(!Array.isArray(e)||0===e.length)&&e.every(e=>hi(e,t))}function ci(e){return Array.isArray(e)?e:null==e?[]:[e]}function hi(e,t){if(!e||"object"!=typeof e)return!1;switch(e.condition??"state"){case"state":{if(!e.entity)return!1;const i=t?.states?.[e.entity],s=e.attribute?i?.attributes?.[e.attribute]:i?.state,n=null==s?"":String(s);return null!=e.state?ci(e.state).map(String).includes(n):null!=e.state_not&&!ci(e.state_not).map(String).includes(n)}case"numeric_state":{if(!e.entity)return!1;const i=t?.states?.[e.entity],s=Number(e.attribute?i?.attributes?.[e.attribute]:i?.state);if(!Number.isFinite(s))return!1;const n=e=>Number("string"==typeof e&&t?.states?.[e]?t.states[e].state:e);return(null==e.above||s>n(e.above))&&((null==e.below||s<n(e.below))&&(null!=e.above||null!=e.below))}case"screen":return!!e.media_query&&window.matchMedia(e.media_query).matches;case"user":return ci(e.users).includes(t?.user?.id);case"and":return ci(e.conditions).every(e=>hi(e,t));case"or":return ci(e.conditions).some(e=>hi(e,t));case"not":return ci(e.conditions).length>0&&!ci(e.conditions).some(e=>hi(e,t));default:return!1}}customElements.define("materia-list",ri),window.customCards=window.customCards||[],window.customCards.push({type:"materia-list",name:"Materia List",description:"Rows of entity readings and/or lines of text — name left, value right, or icon plus a full-width line. Optional tonal surface.",preview:!0});const di=e=>class extends e{get _disabledByCondition(){const e=this.config?.disabled_when??this.config?.disabled;return Array.isArray(e)&&li(e,this.hass)}willUpdate(e){super.willUpdate?.(e),this.toggleAttribute("card-disabled",this._disabledByCondition)}},pi=a`
  :host([card-disabled]) {
    opacity: 0.38;
    pointer-events: none;
  }
`,ui=[Ee,Te,Ae,ge,a`
  ...
  `],xi=[{value:"percent",label:"Percent (filling cookie)"},{value:"battery",label:"Battery (vertical bar)"},{value:"temperature",label:"Temperature (thermometer)"},{value:"power",label:"Power (load bars)"},{value:"energy",label:"Energy"},{value:"binary",label:"On/off (spinning star)"},{value:"plain",label:"Plain value"},{value:"vacuum",label:"Robot vacuum (state + room + battery bar)"},{value:"fill",label:"Gauge · tile floods to the value"},{value:"bar",label:"Gauge · value over a track"},{value:"ladder",label:"Gauge · ladder of bars"},{value:"ring",label:"Gauge · ring beside the value"},{value:"status",label:"Status row (tonal, icon badge + state)"},{value:"scale",label:"Gauge · position on a ramp, with reference marks"},{value:"spark",label:"History · area sparkline hero"},{value:"sparkline",label:"History · bare line"},{value:"weekbars",label:"History · a bar per day"},{value:"events",label:"History · event ticks (tonal row)"}],ki=["spark","sparkline","weekbars","events"],$i=["weekbars","events"],Ci=["fill","bar","ladder","ring","scale"];customElements.define("materia-glance-tile-editor",class extends We{_formData(){const e=this._config?.variant;return{variant:"percent",..."percent"===e?{critical_dry:10,dry_below:20,soggy_above:60,dry_label:"Needs water now",soon_label:"Water soon",optimal_label:"Optimal",wet_label:"Overwatered"}:"power"===e?{max:3e3,bars:5}:"ladder"===e?{bars:5}:"status"===e?{dots:4}:"spark"===e||"sparkline"===e?{hours:24,points:48,history_refresh:5,show_delta:"spark"===e}:"weekbars"===e||"events"===e?{days:3,aggregate:"delta",history_refresh:5}:{},...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){const e=this._config?.variant,t={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"variant",label:"Category",required:!0,selector:{select:{mode:"dropdown",options:xi}}},{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Icon (overrides entity icon)",selector:{icon:{}}},{name:"label",label:"Subtitle",selector:{text:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"temperature"===e&&i.fields.push({name:"min",label:"Scale min (default 10°)",selector:{number:{mode:"box"}}},{name:"max",label:"Scale max (default 30°)",selector:{number:{mode:"box"}}}),"power"===e&&i.fields.push({name:"max",label:"Full-load watts (default 3000)",selector:{number:{mode:"box"}}},{name:"bars",label:"Number of bars (default 5)",selector:{number:{min:2,max:40,mode:"box"}}}),Ci.includes(e)&&i.fields.push({name:"min",label:"Scale min (default: the entity's min attribute, else 0)",selector:{number:{mode:"box",step:"any"}}},{name:"max",label:"Scale max (default: the entity's max attribute, else 100 for a %)",helper:"Without a max the gauge cannot be calibrated and the tile falls back to a plain value.",selector:{number:{mode:"box",step:"any"}}},{name:"caption",label:"Caption under the gauge",helper:"Your sentence, in your language. Placeholders: {value} {min} {max} {unit} {percent}. Jinja templates work too. Empty shows the bare top of the scale.",template:!0,selector:{text:{}}},{name:"precision",label:"Decimal places (default: at most 1)",selector:{number:{min:0,max:6,mode:"box"}}}),"ladder"===e&&i.fields.push({name:"bars",label:"Number of bars (default 5)",selector:{number:{min:2,max:40,mode:"box"}}}),"scale"===e&&i.fields.push({name:"good",label:"Which end is good",helper:"Left empty the ramp is a neutral track and the card passes no judgement — the value's position and the reference marks still show. Set it and the ramp runs through the severity scale in that direction. Never inferred from the entity.",selector:{select:{mode:"dropdown",options:[{value:"low",label:"Low values are good (consumption, latency)"},{value:"high",label:"High values are good (efficiency, signal)"}]}}},{name:"min_label",label:"Label at the low end",helper:"Your words. Placeholders: {bound} {unit} {value} {min} {max}. Empty shows the bare bound.",template:!0,selector:{text:{}}},{name:"max_label",label:"Label at the high end",helper:"Same placeholders. Empty shows the bare bound.",template:!0,selector:{text:{}}},{name:"show_delta",label:"Show the change pill",helper:"Fetches history only when switched on, since a change needs a window to measure over.",selector:{boolean:{}}}),"status"===e&&i.fields.push({name:"active_state",label:"State(s) that count as active",helper:'Comma-separated. Left empty it is derived from the domain (cover open, vacuum cleaning, media_player playing…), falling back to "on" — so a sensor reading "Connected" needs it spelled out here.',selector:{text:{}}},{name:"dots",label:"Indicator dots (default 4)",helper:"Filled to the value when the entity has a scale; otherwise they pulse while it is active.",selector:{number:{min:2,max:12,mode:"box"}}}),"plain"===e&&i.fields.push({name:"battery_entity",label:"Paired battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"vacuum"===e&&i.fields.push({name:"status_entity",label:"Detailed status sensor (shown as the state)",selector:{entity:{domain:"sensor"}}},{name:"room_entity",label:"Current room sensor (shown while cleaning)",selector:{entity:{domain:"sensor"}}},{name:"battery_entity",label:"Battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"percent"===e&&i.fields.push({name:"critical_dry",label:"Critical dry, ≤% (default 10 — red)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_below",label:"Water soon, ≤% (default 20 — orange)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"soggy_above",label:"Overwatered, >% (default 60 — blue)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_label",label:'"Needs water now" label',selector:{text:{}}},{name:"soon_label",label:'"Water soon" label',selector:{text:{}}},{name:"optimal_label",label:'"Optimal" label',selector:{text:{}}},{name:"wet_label",label:'"Overwatered" label',selector:{text:{}}}),ki.includes(e)&&($i.includes(e)?i.fields.push({name:"days",label:"Days of history (default 3)",helper:"Kept short on purpose: a window longer than your recorder keeps returns nothing at all, not a shorter series. Days with no data are simply not drawn.",selector:{number:{min:1,max:90,mode:"box"}}},{name:"aggregate",label:"What each bar measures (default: change)",helper:"change = how much the value moved that day (counters). mean/min/max/sum/count for measurements.",selector:{select:{mode:"dropdown",options:[{value:"delta",label:"Change across the day"},{value:"mean",label:"Average"},{value:"min",label:"Minimum"},{value:"max",label:"Maximum"},{value:"sum",label:"Sum of samples"},{value:"count",label:"Number of samples"}]}}}):i.fields.push({name:"hours",label:"Hours of history (default 24)",helper:"A window longer than your recorder keeps returns nothing at all.",selector:{number:{min:1,max:2160,mode:"box"}}},{name:"points",label:"Points plotted (default 48)",selector:{number:{min:2,max:400,mode:"box"}}},{name:"show_delta",label:"Show the change pill",selector:{boolean:{}}},{name:"delta_label",label:"Change pill text",helper:"Placeholders: {delta} {delta_pct} {from} {to} {unit} {hours} {days}. Empty shows just the signed change.",template:!0,selector:{text:{}}}),i.fields.push({name:"caption",label:"Caption",helper:"Your words. Placeholders: {value} {unit} {hours} {days} {buckets}. Jinja templates work too.",template:!0,selector:{text:{}}},{name:"history_refresh",label:"Refresh every N minutes (default 5)",helper:"History is polled on this interval, never on every state change.",selector:{number:{min:1,max:180,mode:"box"}}}));const s={title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Accent color (fill / bars / star)",color:!0,selector:{text:{}}},{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},n={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[t,i,s,n]:[t,s,n]}});const Si="var(--md-sys-cust-color-weather-rain, #5fa8f5)",zi="var(--md-sys-cust-color-scale-green, #5E9E50)",Ti="var(--md-sys-cust-color-scale-yellow, #C7A128)",Ai="var(--md-sys-cust-color-scale-orange, #D9713C)",Ei="var(--md-sys-cust-color-scale-red, #C94D42)",Mi=["on","open","running","playing","heat","heating","home","true","active"],Oi={cleaning:"gt_state_cleaning",docked:"gt_state_docked",paused:"gt_state_paused",idle:"gt_state_idle",returning:"gt_state_returning",error:"gt_state_error"},Fi=new Set(["spark","sparkline","weekbars","events"]);class Di extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedLabel:{state:!0},_resolvedCaption:{state:!0},_resolvedDeltaLabel:{state:!0},_resolvedMinLabel:{state:!0},_resolvedMaxLabel:{state:!0},_hist:{state:!0}};static styles=wi;static getConfigElement(){return document.createElement("materia-glance-tile-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("sensor."))||"";return{entity:t,variant:"percent"}}setConfig(e){if(!e.entity)throw new Error("Materia Glance Tile: entity is required");if(!e.variant)throw new Error("Materia Glance Tile: variant is required — pick the value category");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("label","_resolvedLabel"),this._resolveField("caption","_resolvedCaption"),this._resolveField("delta_label","_resolvedDeltaLabel"),this._resolveField("min_label","_resolvedMinLabel"),this._resolveField("max_label","_resolvedMaxLabel"),(Array.isArray(this.config.markers)?this.config.markers:[]).forEach((e,t)=>this._resolveTemplateValue(`marker_${t}`,e?.label)),this._loadHistory())}get _label(){return this._isTemplate(this.config.label)?this._resolvedLabel:this.config.label}get _stateObj(){return this.hass?.states[this.config.entity]}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}get _unit(){return this.config.unit??this._stateObj?.attributes?.unit_of_measurement??""}get _name(){return this.config.name??this._stateObj?.attributes?.friendly_name??this.config.entity}_icon(e){return this.config.icon||this._stateObj?.attributes?.icon||e}get _variant(){return this.config.variant}_fmtState(){const e=this._stateObj;return this.hass.formatEntityState?.(e)??e.state}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e||this._isUnavailable(e))return I`<ha-card><div class="rect-tile unavailable">
    ...
    `}_header(e){return I`<div class="header"><ha-icon icon=${this._icon(e)}></ha-icon><span>${this._name}</span></div>`}_moistureZone(e){const t=this.config.critical_dry??10,i=this.config.dry_below??20,s=this.config.soggy_above??60;return e<=t?{fill:Ei,status:this.config.dry_label??$e("gt_needs_water_now",this.hass)}:e<=i?{fill:Ai,status:this.config.soon_label??$e("gt_water_soon",this.hass)}:e<=s?{fill:zi,status:this.config.optimal_label??$e("gt_optimal",this.hass)}:{fill:Si,status:this.config.wet_label??$e("gt_overwatered",this.hass)}}_percent(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=Math.min(1,Math.max(0,e/100)),i=this._stateObj.attributes.device_class,s="moisture"===i;let n=null,a=null;if("battery"===i)n=t>.4?zi:t>.15?Ai:Ei;else if(s){const t=this._moistureZone(e);n=t.fill,a=t.status}else"humidity"===i&&(n=Si);n&&(n=`color-mix(in srgb, ${n} 30%, transparent)`);const o=100-100*t,r="humidity"===i||s;let l;if(r){let e=`M-100 ${o.toFixed(1)}`;for(let t=-100;t<100;t+=25){e+=` Q ${t+12.5} ${(o+(t/25%2==0?-1.6:1.6)).toFixed(1)} ${t+25} ${o.toFixed(1)}`}l=e+" V102 H-100 Z"}else l=`M-2 ${o+2.5} Q 50 ${o-2.5} 102 ${o+2.5} V102 H-2 Z`;const c="battery"===i?"mdi:battery":s?"mdi:sprout":"mdi:water-percent";return I`
    ...
    `}_tempColor(e,t){const i="°F"===t?5*(e-32)/9:e;return i<16?Si:i<23?zi:i<27?Ai:Ei}_temperature(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=this._unit||"°C",i=this.config.min??("°F"===t?50:10),s=this.config.max??("°F"===t?86:30),n=Math.min(1,Math.max(0,(e-i)/(s-i))),a=this._tempColor(e,t);return I`
      <div class="rect-tile left">
    ...
    `}_batteryColor(e){return e>.4?zi:e>.15?Ai:Ei}_battery(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=Math.min(1,Math.max(0,e/100)),i=this._batteryColor(t);return I`
      <div class="rect-tile left">
    ...
    `:this._plain()}_ladder(e={}){const t=this._gauge(e.power?Di._POWER_PRESET:null);if(!t)return this._plain();const i=Math.max(2,Math.min(40,Math.round(this._num(this.config.bars)??5))),s=Math.max(0,Math.min(i,Math.ceil(t.frac*i)));return I`
      <div class="rect-tile left gauge">
    ...
    `}_status(){const e=function(e,t){if(!e)return!1;const i=String(e.state);if(fi.has(i.toLowerCase()))return!1;const s=(e,t)=>String(e).toLowerCase()===String(t).toLowerCase();if(null!=t&&""!==t){const e=Array.isArray(t)?t:String(t).split(",").map(e=>e.trim()).filter(Boolean);return e.some(e=>s(e,i))}const n=String(e.entity_id||"").split(".")[0],a=gi[n]??"on";return(Array.isArray(a)?a:[a]).some(e=>s(e,i))}(this._stateObj,this.config.active_state),t=Math.max(2,Math.min(12,Math.round(this._num(this.config.dots)??4))),i=this._gauge(),s=i?Math.max(0,Math.min(t,Math.ceil(i.frac*t))):e?t:0;return I`
    ...
    `}_binary(){const e=Mi.includes(this._stateObj.state),t=lt(50,50,46,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2});return I`
    ...
    `}_fmtObj(e){return this.hass.formatEntityState?.(e)??e.state}_vacuumStateText(e){const t=Oi[String(e.state).toLowerCase()];return t?$e(t,this.hass):this._fmtObj(e)}_vacuum(){const e=this._stateObj,t="cleaning"===e.state,i=this.config.status_entity?this.hass.states[this.config.status_entity]:null,s=this._vacuumStateText(i??e),n=this.config.room_entity?this.hass.states[this.config.room_entity]:null,a=t&&n?this._fmtObj(n):"",o=this.config.battery_entity?this.hass.states[this.config.battery_entity]:null,r=o?this._num(o.state):null,l=null!=r?Math.min(1,Math.max(0,r/100)):null,c=null!=l?this._batteryColor(l):null;return I`
    ...
    `}getGridOptions(){return"status"===this._variant||"events"===this._variant?{columns:12,rows:"auto",min_columns:6}:"spark"===this._variant?{columns:12,rows:"auto",min_columns:4}:{columns:4,rows:"auto",min_columns:3}}getCardSize(){return 3}}customElements.define("materia-glance-tile",Di),window.customCards=window.customCards||[],window.customCards.push({type:"materia-glance-tile",name:"Materia Glance Tile",description:"Expressive view-only sensor tile — percent fill, thermometer, power bars, spinning pump star, and a graceful fallback.",preview:!0});const qi=dt(90,90,86),Ni=function(e,t,i,s=0){return pt(e,t,i,s,[{x:.457,y:.296,r:.007},{x:.5,y:-.051,r:.007}],15)}(90,90,88),Ri={rest:{bg:"var(--md-sys-color-secondary-container)",fg:"var(--md-sys-color-on-secondary-container)"},active:{bg:"var(--md-sys-cust-color-device, var(--md-sys-color-primary-container))",fg:"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-primary-container))"},sidekick:{bg:"var(--md-sys-color-surface-container-high, rgba(0, 0, 0, 0.06))",fg:"var(--md-sys-color-on-surface)"}},Pi=[Ee,Te,Ae,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Li=e=>class extends e{willUpdate(e){super.willUpdate?.(e);const t="sidekick"===this.config?.variant?"sidekick":null;t?this.setAttribute("variant",t):this.removeAttribute("variant")}get _sidekick(){return"sidekick"===this.config?.variant}_shellPair(e){return this._sidekick?Ri.sidekick:e?Ri.active:Ri.rest}_alertList(){return Array.isArray(this.config.alerts)?this.config.alerts:this.config.alert?[this.config.alert]:[]}_idle(e){return["off","idle","unknown","unavailable","false","0","none","","ok","docked"].includes(String(e??"").toLowerCase())}_alertText(e,t){if(null==t.text)return"";const i=this._isTemplate(t.text)?this._tplResults?.[`alertText${e}`]:t.text;return null==i?"":String(i).trim()}get _activeAlert(){const e=this._alertList();for(let t=0;t<e.length;t++){const i=e[t],s=this._alertText(t,i);if(i.entity){const e=this.hass?.states[i.entity];if(!e)continue;const t=String(e.state);if(null!=i.state){if(!(Array.isArray(i.state)?i.state.map(String):[String(i.state)]).includes(t))continue}else if(this._idle(t))continue;return{...i,text:s||(this.hass.formatEntityState?.(e)??t)}}if(s)return{...i,text:s}}return null}_resolveAlertTemplates(){this.config&&this._alertList().forEach((e,t)=>{null!=e.text&&this._resolveTemplateValue(`alertText${t}`,e.text)})}_renderBurst({alarm:e=!1,working:t=!1}={}){return!1===this.config.burst?V:I`
    ...
    `];static getConfigElement(){return document.createElement("materia-vacuum-hero-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("vacuum."))||"";return{entity:t,brand:"roborock"}}setConfig(e){if(!e.entity)throw new Error("Materia Vacuum Hero: entity is required");this.config={brand:"roborock",...e},this._discovered=null}updated(e){e.has("config")&&(this._discovered=null),e.has("hass")&&this.hass&&(this.config.alerts||[]).forEach((e,t)=>{null!=e.text&&this._resolveTemplateValue("alertText"+t,e.text)})}get _profile(){return e=this.config.brand,Ki[e]||Ki.generic;var e}get _stateObj(){return this.hass?.states[this.config.entity]}_siblings(){const e=this.hass?.entities?.[this.config.entity];if(!e)return[];const t=e.device_id,i=this.config.entity.split(".")[1]+"_";return Object.values(this.hass.entities).filter(e=>!e.disabled_by&&!e.hidden_by&&(t&&e.device_id===t||e.entity_id.split(".")[1].startsWith(i))).map(e=>e.entity_id)}get _caps(){if(this._discovered)return this._discovered;const e=this._siblings(),t=e.length>0,i=(t,i)=>{for(const s of t){const t=e.find(e=>!(i&&!i.includes(e.split(".")[0]))&&(e.split(".")[1].endsWith(s)||e.split(".")[1].includes(s)));if(t)return t}return null},s={};for(const[e,t]of Object.entries(Gi))s[e]=this.config[`${e}_entity`]??i(t,["sensor","binary_sensor"]);return s.consumables=this.config.consumable_entities??e.filter(e=>e.startsWith("sensor.")&&Xi.some(t=>e.includes(t))),t&&(this._discovered=s),s}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}_stateOf(e){if(!e)return null;const t=this.hass?.states[e];return t&&!this._isUnavailable(t)?t.state:null}_numOf(e){return this._num(this._stateOf(e))}get _idleStates(){return(this.config.idle_states??this._profile.idle_states).map(e=>String(e).toLowerCase())}get _working(){const e=this._stateObj;if(!e||this._isUnavailable(e))return!1;const t=String(this._stateOf(this._caps.status)??e.state).toLowerCase();return!this._idleStates.includes(t)}get _drying(){return"on"===this._stateOf(this._caps.mop_drying)}get _hasProgress(){const e=String(this._stateOf(this._caps.status)??this._stateObj?.state??"").toLowerCase();return!(this.config.no_progress_states??["return","empty","wash","dry","charg","dock","locat","seek","idle"]).some(t=>e.includes(t))}get _minutesLeft(){const e=this._numOf(this._caps.progress);if(null==e||e<=0||e>=100)return null;const t=this._caps.cleaning_time,i=this._numOf(t);if(null==i||i<=0)return null;const s=i*({s:1/60,sec:1/60,secs:1/60,seconds:1/60,min:1,mins:1,minutes:1,h:60,hr:60,hours:60}[String(this.hass?.states[t]?.attributes?.unit_of_measurement??"").toLowerCase()]??1/60),n=Math.round(s*(100-e)/e);return e<(this.config.eta_min_progress??5)?null:Math.max(1,n)}_pretty(e){if(null==e)return null;const t=String(e).replace(/[_-]+/g," ").trim();return t.charAt(0).toUpperCase()+t.slice(1)}_resetButtonFor(e){const t=["main_brush","side_brush","maintenance_brush","strainer","filter","sensor","mop"].find(t=>e.includes(t));return t?this._siblings().find(e=>e.startsWith("button.")&&e.includes("reset")&&e.includes(t))??null:null}_lowConsumables(){const e=this.config.consumable_hours??1,t=this.config.consumable_percent??5,i={s:1/3600,sec:1/3600,seconds:1/3600,min:1/60,minutes:1/60,h:1,hours:1,d:24};return(this._caps.consumables||[]).filter(s=>{const n=this._numOf(s);if(null==n)return!1;const a=String(this.hass.states[s]?.attributes?.unit_of_measurement??"").toLowerCase();if("%"===a)return n<=t;return n*(i[a]??1)<=e})}get _alerts(){const e=this._caps,t=(e,t,i)=>{const s=this._stateOf(e);if(null==s||["none","ok","off","no_error","0"].includes(String(s).toLowerCase()))return null;const n=(a=s,o=this.hass.locale?.language,Ji(Qi,a,o));var a,o;return{icon:t,text:n?`${i}: ${n}`:`${i}: ${this._pretty(s)}`,severity:"error",entity:e}},i=(e,t,i,s)=>"on"===this._stateOf(e)?{icon:t,text:i,severity:s,entity:e}:null,s=[t(e.error,"mdi:robot-vacuum-alert",this.config.error_label??"Vacuum error"),t(e.dock_error,"mdi:home-alert-outline",this.config.dock_error_label??"Dock error"),i(e.water_shortage,"mdi:water-alert-outline","Water shortage - cannot mop","error"),i(e.clean_water,"mdi:water-outline","Clean water tank needs refilling","warning"),i(e.dirty_water,"mdi:water-off-outline","Dirty water tank needs emptying","warning"),...this._lowConsumables().map(e=>{return{icon:"mdi:wrench-outline",text:(t=e,i=this.hass.locale?.language,Ji(Zi,t,i)??`${this.hass.states[e]?.attributes?.friendly_name??e} needs attention`),severity:"warning",entity:e,reset:this._resetButtonFor(e)};var t,i}),...(this.config.alerts||[]).map((e,t)=>{const i=null!=e.text&&this._isTemplate(e.text)?this._tplResults?.["alertText"+t]:e.text,s=null==i?"":String(i).trim();return null!=e.text&&0===s.length?null:{...e,text:s}})].filter(Boolean);return s}_severityPair(e){return"warning"===e?["var(--md-sys-cust-color-warning-container)","var(--md-sys-cust-color-on-warning-container)"]:["var(--md-sys-cust-color-error, var(--md-sys-color-error))","var(--md-sys-cust-color-on-error, var(--md-sys-color-on-error))"]}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e){if(this._lastGood){const e=this._lastGood;return I`
      ...
      </div></div></ha-card>`}const t=this._isUnavailable(e),i=this._caps,s=this._working,n=this._alerts[0]||null,a=this._numOf(i.battery),o=this._numOf(i.progress),r=this._stateOf(i.status)??e.state;let l=this._pretty(r);const c=String(r??"").toLowerCase(),h=c.includes("charg")||c.includes("dock");!s&&h&&null!=a&&a>=100&&(l=this.config.docked_label??$e("vh_docked",this.hass)),t&&(l=$e("unavailable",this.hass));const d=s&&null!=o&&this._hasProgress,p=d?Math.round(o):a,u=d?this.config.progress_caption??"done":this.config.battery_caption??$e("vh_battery_caption",this.hass);let m=null;if(s){const e=this._stateOf(i.room),t=this._minutesLeft,s=[];e&&!["unknown","unavailable"].includes(e)&&s.push(this._pretty(e)),null!=t&&s.push($e("vh_min_left",this.hass,{mins:t})),m=s.join(" - ")||null}else if(this._drying)m=this.config.drying_label??$e("vh_drying",this.hass);else{const e=this._stateOf(i.last_clean);if(e){const t=new Date(e);if(!Number.isNaN(t.getTime())){const e=Math.round((Date.now()-t.getTime())/6e4),i=e<60?$e("unit_min",this.hass,{n:Math.max(1,e)}):e<1440?$e("unit_hours",this.hass,{n:Math.round(e/60)}):$e("unit_days",this.hass,{n:Math.round(e/1440)});m=$e("vh_last_cleaned",this.hass,{rel:i})}}}const g=this._shellPair(s);let f=(s?this.config.working_color:this.config.color)??g.bg,_=(s?this.config.working_color_on:this.config.color_on)??g.fg;const b=null!=n&&(null==n.severity||"error"===n.severity);let v=null,y=null;if(n){const[e,t]="info"===n.severity?[f,_]:this._severityPair(n.severity);v=n.color??e,y=n.color_on??t,b&&!1!==this.config.alert_tints_hero&&(f=v,_=y)}const w=this.config.name??e.attributes?.friendly_name??this.config.entity,x=this.config.icon??"mdi:robot-vacuum";return this._lastGood={title:l,value:p,caption:u,secondary:m,name:w,icon:x,bg:f,fg:_},I`
      <ha-card style="--mh-bg:${f};--mh-fg:${_};--mh-alert-bg:${v??f};--mh-alert-fg:${y??_};--mh-calm-d:path('${es}');--mh-live-d:path('${ts}');">
        <div class="stack">
          <div
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}customElements.define("materia-vacuum-hero",is),window.customCards=window.customCards||[],window.customCards.push({type:"materia-vacuum-hero",name:"Materia Vacuum Hero",description:"Robot-vacuum headline — derived ETA, negated working states, and mop/consumable warnings. Roborock and Ecovacs.",preview:!0});const ss=[Ee,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-bar-select-editor",class extends We{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",selector:{text:{}}},{name:"attribute",label:"Attribute (e.g. fan_speed) instead of the state",selector:{text:{}}},{name:"off_option",label:'Option shown as its own round button (e.g. "off")',selector:{text:{}}},{name:"off_icon",label:"Icon for that button",selector:{icon:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Lit bar color",color:!0,template:!0,selector:{text:{}}},{name:"accent_on",label:"Glyph color on the accent fill",color:!0,template:!0,selector:{text:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[He]}]}});class rs extends(as(di(ze(ce)))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedAccent:{state:!0},_resolvedAccentOn:{state:!0}};static styles=[os,pi];static getConfigElement(){return document.createElement("materia-bar-select-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("select."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("Materia Bar Select: entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("accent","_resolvedAccent"),this._resolveField("accent_on","_resolvedAccentOn"),this._optimisticReconcile());const t=this._index;null!=this._prevIndex&&t!==this._prevIndex&&this._choreograph(this._prevIndex,t),this._prevIndex=t}get _stateObj(){return this.hass?.states[this.config.entity]}get _rungs(){const e=null!=this.config.off_option?String(this.config.off_option):null;return this._options.filter(t=>null==e||t!==e)}get _index(){return this._rungs.indexOf(String(this._current))}_optimisticActual(){const e=this._stateObj;if(!e)return null;const t=this.config.attribute?e.attributes?.[this.config.attribute]:e.state;return null==t?null:String(t)}get _current(){return this._optimistic}get _options(){if(this.config.options?.length)return this.config.options.map(String);const e=this._stateObj;if(!e)return[];if(this.config.attribute){const t=e.attributes?.[`${this.config.attribute}_list`];return Array.isArray(t)?t.map(String):[]}const t=e.attributes?.options;return Array.isArray(t)?t.map(String):[]}_fmt(e){const t=this._stateObj;if(!this.config.attribute&&t&&String(t.state)===String(e)){const e=this.hass.formatEntityState?.(t);if(e)return e}const i=String(e).replace(/[_-]+/g," ");return i.charAt(0).toUpperCase()+i.slice(1)}_set(e){const t=this._stateObj;if(!t)return;const i=t.entity_id.split(".")[0];if(this._fireHaptic?.("selection"),this._optimisticSet(e),this.config.service){const[i,s]=String(this.config.service).split("."),n=this.config.service_key||this.config.attribute||"option";return void this._callService(i,s,{entity_id:t.entity_id,[n]:e})}if(this.config.attribute){const s=this.config.attribute;return void this._callService(i,`set_${s}`,{entity_id:t.entity_id,[s]:e})}"select"!==i&&"input_select"!==i||this._callService(i,"select_option",{entity_id:t.entity_id,option:e})}_choreograph(e,t){if(window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches)return;const i=Array.from(this.shadowRoot?.querySelectorAll(".bar")||[]);if(!i.length)return;const s=t>e,n=[];for(let s=Math.min(e,t)+1;s<=Math.max(e,t);s++)i[s]&&n.push(i[s]);const a=s?n:n.reverse(),o=s?[{transform:"scaleY(0.94)"},{transform:"scaleY(1.07)",offset:.5},{transform:"scaleY(1)"}]:[{transform:"scaleY(1)"},{transform:"scaleY(0.84)",offset:.5},{transform:"scaleY(0.94)"}];a.forEach((e,t)=>{e.animate(o,{duration:300,delay:45*t,easing:s?"cubic-bezier(.2,1.5,.3,1)":"cubic-bezier(.3,0,.2,1)",fill:"none"})})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e||this._isUnavailable(e))return I`<ha-card><div class="tile unavailable">
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-bar-select",rs),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bar-select",name:"Materia Bar Select",description:"Tap-a-bar level picker — climbing bars for fan speeds, mop levels, any ordered select.",preview:!0});const ls=[Ee,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class cs extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
  ...
  `],ps="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:var(--md-sys-color-secondary-container, rgba(120,120,128,.14));color:var(--md-sys-color-on-secondary-container, inherit);margin-bottom:6px;cursor:pointer;",us="border:none;background:transparent;color:inherit;cursor:pointer;padding:4px;display:grid;place-items:center;border-radius:50%;--mdc-icon-size:18px;",ms="border:1.5px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.2));background:transparent;color:inherit;font-family:inherit;font-size:13px;font-weight:600;padding:8px 16px;border-radius:999px;cursor:pointer;display:inline-flex;align-items:center;gap:6px;";customElements.define("materia-climate-panel-editor",class extends We{static properties={_secIdx:{state:!0},_cardIdx:{state:!0},_huiReady:{state:!0}};connectedCallback(){super.connectedCallback(),this._loadHui()}async _loadHui(){if(customElements.get("hui-card-picker")&&customElements.get("hui-card-element-editor"))this._huiReady=!0;else{try{const e=await pe(),t=await e.createCardElement({type:"vertical-stack",cards:[]});await(t?.constructor?.getConfigElement?.())}catch{}this._huiReady=!!customElements.get("hui-card-picker")}}_formData(){return{steppers:"side",wave:"auto",...this._config}}get _secs(){return this._config?.sections||[]}_setSecs(e){const t={...this._config};e.length?t.sections=e:delete t.sections,this._commit(t)}_patchSec(e,t){const i=[...this._secs],s={...i[e],...t};for(const e of Object.keys(t))void 0!==t[e]&&""!==t[e]&&null!==t[e]||delete s[e];i[e]=s,this._setSecs(i)}_moveSec(e,t){const i=[...this._secs],s=e+t;s<0||s>=i.length||([i[e],i[s]]=[i[s],i[e]],this._setSecs(i))}_addSec(){const e=this._secs.length;this._setSecs([...this._secs,{title:"New section",style:"section",cards:[]}]),this._secIdx=e}_patchCards(e,t){this._patchSec(e,{cards:t})}render(){return this.hass&&this._config?null!=this._secIdx&&null!=this._cardIdx?this._renderCardView():null!=this._secIdx?this._renderSectionView():super.render():I``}_back(e,t){return I`
      ...
      <ha-expansion-panel outlined .header=${"Sections"} .secondary=${"Wallet sections and menus below the mode group"} .expanded=${!0}>
        ...
        <div style="padding:12px;">
          ${this._secs.map((e,t)=>I`
            <div style=${ps} @click=${()=>{this._secIdx=t}}>
              ...
              <button style=${us} title="Move up" @click=${e=>{e.stopPropagation(),this._moveSec(t,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
              <button style=${us} title="Move down" @click=${e=>{e.stopPropagation(),this._moveSec(t,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
              <button style=${us} title="Edit" @click=${e=>{e.stopPropagation(),this._secIdx=t}}><ha-icon icon="mdi:pencil"></ha-icon></button>
              <button style=${us} title="Delete" @click=${e=>{e.stopPropagation(),this._setSecs(this._secs.filter((e,i)=>i!==t))}}><ha-icon icon="mdi:delete"></ha-icon></button>
            </div>
          `)}
          <button style=${ms} @click=${()=>this._addSec()}>
    ...
    `}_renderMenuFields(e,t){const i=t.options||[],s=(t,s)=>{const n=i.map((e,i)=>i===t?{...e,...s}:e);for(const e of Object.keys(s))""!==s[e]&&null!=s[e]||delete n[t][e];this._patchSec(e,{options:n})};return I`
      ...
      ${i.map((t,n)=>I`
        <div style="display:flex;gap:6px;align-items:flex-start;margin-bottom:8px;">
          ...
          <button style="${us}margin-top:12px;" title="Remove option"
            @click=${()=>this._patchSec(e,{options:i.filter((e,t)=>t!==n)})}>
            <ha-icon icon="mdi:delete"></ha-icon>
          </button>
        </div>
      `)}
      <button style=${ms} @click=${()=>this._patchSec(e,{options:[...i,{label:"",value:""}]})}>
    ...
    `}_renderActions(e,t){const i=t.actions||[],s=(t,s)=>{const n=i.map((e,i)=>i===t?{...e,...s}:e);for(const e of Object.keys(s))""!==s[e]&&null!=s[e]||delete n[t][e];this._patchSec(e,{actions:n})};return I`
      ...
      ${i.map((t,n)=>I`
        <div style="border:1px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.15));border-radius:12px;padding:10px;margin-bottom:8px;">
          <div style="display:flex;gap:6px;align-items:flex-start;">
            ...
            <button style="${us}margin-top:12px;" title="Remove action"
      ...
      `)}
      <button style="${ms}margin-bottom:12px;" @click=${()=>this._patchSec(e,{actions:[...i,{label:""}]})}>
    ...
    `}_renderSectionCards(e,t){const i=t.cards||[],s=(t,s)=>{const n=t+s;if(n<0||n>=i.length)return;const a=[...i];[a[t],a[n]]=[a[n],a[t]],this._patchCards(e,a)};return I`
      ...
      ${i.map((t,n)=>I`
        <div style=${ps} @click=${()=>{this._cardIdx=n}}>
          ...
          <button style=${us} title="Move up" @click=${e=>{e.stopPropagation(),s(n,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
          <button style=${us} title="Move down" @click=${e=>{e.stopPropagation(),s(n,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
          <button style=${us} title="Edit" @click=${e=>{e.stopPropagation(),this._cardIdx=n}}><ha-icon icon="mdi:pencil"></ha-icon></button>
          <button style=${us} title="Delete" @click=${t=>{t.stopPropagation(),this._patchCards(e,i.filter((e,t)=>t!==n))}}><ha-icon icon="mdi:delete"></ha-icon></button>
        </div>
      `)}
  ...
  `],fs=-135,_s=270,bs="var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))",vs="var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))",ys={auto:{icon:"mdi:thermostat-auto",color:bs,on:vs,container:vs,onContainer:bs},heat_cool:{icon:"mdi:thermostat-auto",color:bs,on:vs,container:vs,onContainer:bs},heat:{icon:"m3o:mode-heat",color:"var(--md-sys-cust-color-climate-heat-accent, #a14614)",on:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",container:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",onContainer:"var(--md-sys-cust-color-climate-heat-accent, #a14614)"},cool:{icon:"mdi:snowflake",color:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)",on:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",container:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",onContainer:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)"},dry:{icon:"mdi:water-percent",color:bs,on:vs,container:vs,onContainer:bs},fan_only:{icon:"mdi:fan",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"},off:{icon:"m3o:power-settings-new",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"}};class ws extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_adjusting:{state:!0}};static styles=gs;setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e}}connectedCallback(){super.connectedCallback(),this._phase=0,this._amp=0,this._startLoop()}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),clearTimeout(this._optimisticTimer),clearTimeout(this._sendTimer)}get _entity(){return this.hass?.states[this.config.entity]}get _action(){return this._entity?.attributes?.hvac_action??""}get _waveAction(){const e=this._mode;if("off"===e||"never"===this.config.wave)return"";if("always"===this.config.wave)return"cool"===e?"cooling":"heating";const t="auto"===e||"heat_cool"===e,i=t?"holding":"",s=this._action;if("heating"===s||"cooling"===s)return s;if(s&&"idle"!==s)return"";const n=this._current,a=this._target;return null==a||"idle"===s?i:null==n?"cool"===e?"cooling":"heat"===e?"heating":i:("heat"===e||t)&&n<a-.2?"heating":("cool"===e||t)&&n>a+.2?"cooling":i}get _mode(){return this._entity?.state??"off"}get _target(){return null!=this._optimisticTemp?this._optimisticTemp:this._numRaw(this._entity?.attributes?.temperature)}get _current(){if(this.config.temperature_entity){const e=this.hass?.states[this.config.temperature_entity];if(e)return this._numRaw(e.state)}return this._numRaw(this._entity?.attributes?.current_temperature)}_numRaw(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}get _step(){return this.config.step??this._numRaw(this._entity?.attributes?.target_temp_step)??.5}get _scale(){return{min:this.config.min_temp??this._numRaw(this._entity?.attributes?.min_temp)??7,max:this.config.max_temp??this._numRaw(this._entity?.attributes?.max_temp)??35}}_startLoop(){if(this._raf)return;const e=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,t=()=>{const i=this._waveAction,s="heating"===i||"cooling"===i,n=e?0:s?1:"holding"===i?.35:0,a=this._amp+.06*(n-this._amp),o=Math.abs(a-n)<.01;if(this._amp=o?n:a,this._amp>.005||n>0){this._phase+="cooling"===i?.012:s?-.012:-.008;const e=this._waveGeom;if(e){const t=this.renderRoot?.querySelector("path.wave-seg");t&&t.setAttribute("d",this._wavePath(e.start,e.end,e.r))}this._raf=requestAnimationFrame(t)}else this._raf=null};this._raf=requestAnimationFrame(t)}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}updated(e){if(this._waveAction&&!this._raf&&this._startLoop(),e.has("hass")&&null!=this._optimisticTemp){const e=this._numRaw(this._entity?.attributes?.temperature);null!=e&&Math.abs(e-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}_modeGroupConfig(e,t,i){const s=`${this.config.entity}|${e.join()}|${t}|${i}|${this.config.mode_size??"m"}`;return this._mgKey!==s&&(this._mgKey=s,this._mgConfig={entity:this.config.entity,size:this.config.mode_size??"m",variant:"tonal",active_shape:"square",color_active:t,color_on_active:i,options:e.map(e=>({icon:ys[e].icon,value:e,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:e},target:{entity_id:this.config.entity}}}))}),this._mgConfig}_angleFor(e,t,i){const s=Math.min(1,Math.max(0,(e-t)/(i-t)));return fs+_s*s}_pointAt(e,t,i=0){const s=(e-90)*Math.PI/180,n=t+i;return[50+n*Math.cos(s),50+n*Math.sin(s)]}_wavePath(e,t,i){const s=t-e,n=1+.55*Math.max(0,Math.min(1,(90-s)/70)),a=Math.min(20,Math.max(6,s/3)),o=3.2*n*this._amp,r=[];for(let s=e;s<=t;s+=2){const n=s-e,l=o*Math.min(1,n/a)*Math.min(1,(t-s)/a)*Math.sin(n/7+this._phase);r.push(this._pointAt(s,i,l))}return r.push(this._pointAt(t,i,0)),"M"+r.map(([e,t])=>`${e.toFixed(2)} ${t.toFixed(2)}`).join(" L")}_arcPath(e,t,i){const[s,n]=this._pointAt(e,i),[a,o]=this._pointAt(t,i),r=t-e>180?1:0;return`M${s.toFixed(2)} ${n.toFixed(2)} A${i} ${i} 0 ${r} 1 ${a.toFixed(2)} ${o.toFixed(2)}`}_setTarget(e){const{min:t,max:i}=this._scale,s=this._step,n=Math.round(100*Math.min(i,Math.max(t,Math.round(e/s)*s)))/100;this._optimisticTemp=n,this._adjusting=!0,clearTimeout(this._adjustTimer),this._adjustTimer=setTimeout(()=>{this._adjusting=!1},650),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4),clearTimeout(this._sendTimer),this._sendTimer=setTimeout(()=>{this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:n})},350)}_nudge(e){const t=this._target;null!=t&&this._setTarget(t+e)}_dialPointer(e){if(!this._dialDragging&&"pointerdown"!==e.type)return;const t=this.renderRoot.querySelector(".dial").getBoundingClientRect(),i=(e.clientX-t.left)/t.width*100-50,s=(e.clientY-t.top)/t.height*100-50;let n=180*Math.atan2(s,i)/Math.PI+90;if(n>180&&(n-=360),n<-143||n>143)return;const a=Math.min(1,Math.max(0,(n-fs)/_s)),{min:o,max:r}=this._scale;"pointerdown"===e.type&&(this._dialDragging=!0,e.currentTarget.setPointerCapture(e.pointerId)),this._setTarget(o+a*(r-o))}_endDialDrag(e){this._dialDragging=!1,e.currentTarget.releasePointerCapture?.(e.pointerId)}render(){if(!this.hass||!this.config)return I``;const e=this._entity;if(!e)return I``;const t=this._isUnavailable(e),{min:i,max:s}=this._scale,n=this._target,a=this._current,o=this._mode,r=this._waveAction,l=ys[o]||ys.off,c="off"!==o&&null!=n,h=42,d=c?this._angleFor(n,i,s):fs,p=null!=n?this._angleFor(n,i,s):null,[u,m]=this._pointAt(c?d:p??d,h),g=null!=a?this._angleFor(a,i,s):null;let f=null,_=null,b=null;c&&"holding"===r?(_=fs,b=null!=g?Math.max(g,d):d):c&&null!=g?(f=Math.min(g,d),_=f,b=Math.max(g,d)):c&&(_=fs,b=d);const v="heating"===r?ys.heat:"cooling"===r?ys.cool:l,y=v.color,w=v.on,x=this.hass.formatEntityState?.(e)??o,k=this.hass.config?.unit_system?.temperature??"°C",$=(this.config.hvac_modes??e.attributes.hvac_modes??[]).filter(e=>ys[e]);return this._waveGeom=c&&null!=b&&b>_+.5?{start:_,end:b,r:h}:null,I`
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const e=c?Math.max(d,g??d):fs,t=c?Math.min(e+8,135):fs;return t<134.5?H`<path d=${this._arcPath(t,135,h)} class="track" />`:""})()}
            ${c||null==g?"":H`<circle
                  cx=${this._pointAt(g,h)[0]} cy=${this._pointAt(g,h)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?H`<path d=${this._arcPath(fs,f,h)} class="sweep" style="stroke:${y}" />`:""}
          ...
          <div class="center" @click=${()=>this._fireMoreInfo(this.config.entity)}>
            ...
            ${null!=a&&!1!==this.config.show_current?I`<div class="current-label">${this.config.current_label??$e("cp_currently",this.hass)} ${Math.round(10*a)/10}°</div>`:""}
          </div>
        </div>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6}}customElements.define("materia-climate-panel",ks),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate-panel",name:"Materia Climate Panel",description:"Climate panel: thermostat dial hero, mode group, and wallet sections you compose with any cards or menus.",preview:!0});const $s={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},tertiary:{active:"var(--md-sys-color-tertiary)",onActive:"var(--md-sys-color-on-tertiary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat-container)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool-container)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto-container)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},Cs={xs:{height:32,innerCorner:4},s:{height:40,innerCorner:8},m:{height:56,innerCorner:8},l:{height:96,innerCorner:16},xl:{height:136,innerCorner:20}},Ss=[Ee,Te,ge,a`
    .group {
      display: flex;
      gap: 2px;
      width: 100%;
  ...
  `];class Ts extends We{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[We.styles,a`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null,this._actionRows??=Object.entries(e.tap_action_map||{}).map(([e,t])=>({state:e,tap_action:t}))}_formData(){return{variant:"filled",size:"m",shape:"round",...this._config}}get _sections(){return[{title:"Button",icon:"mdi:gesture-tap-button",fields:[{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"label",template:!0,selector:{text:{}}},{name:"variant",selector:{select:{mode:"dropdown",options:[{value:"elevated",label:"Elevated"},{value:"filled",label:"Filled"},{value:"tonal",label:"Tonal"},{value:"outlined",label:"Outlined"},{value:"text",label:"Text"}]}}},{name:"role",label:"Color role",helper:"Unset = each variant's spec default (filled → primary, tonal → secondary).",selector:{select:{mode:"dropdown",options:[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"}]}}},{name:"size",selector:{select:{mode:"dropdown",options:[{value:"xs",label:"XS (32)"},{value:"s",label:"S (40)"},{value:"m",label:"M (56)"},{value:"l",label:"L (96)"},{value:"xl",label:"XL (136)"}]}}},{name:"shape",selector:{select:{mode:"dropdown",options:[{value:"round",label:"Round (pill)"},{value:"square",label:"Square"}]}}},{name:"wide",selector:{boolean:{}}},{name:"entity",selector:{entity:{}}},He]},{title:"Behavior",icon:"mdi:tune",fields:[{name:"active_state",label:"Active state",helper:"State(s) considered active (defaults by domain)",selector:{text:{}}},{name:"morph_on_active",label:"Morph shape when active",selector:{boolean:{}}},{name:"active_variant",label:"Variant when active",selector:{select:{mode:"dropdown",options:["filled","tonal","outlined","elevated","text"]}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Default action",selector:{ui_action:{}}}]}]}_renderExtra(){const e=this._actionRows||[];return I`
      ...
      ${e.map((e,t)=>I`
        ...
        `)}
    `}get _mappingSchema(){return[{name:"state",required:!0,helper:"Use 'default' for the fallback",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}_toggleExpand(e){this._expanded=this._expanded===e?null:e}_addMapping(){this._actionRows=[...this._actionRows||[],{state:""}],this._expanded=this._actionRows.length-1}_updateMapping(e,t){this._actionRows=(this._actionRows||[]).map((i,s)=>s===e?{...i,...t}:i),this._commitActionRows()}_removeMapping(e){this._actionRows=(this._actionRows||[]).filter((t,i)=>i!==e),this._expanded===e&&(this._expanded=null),this._commitActionRows()}_commitActionRows(){const e={};for(const t of this._actionRows||[])t.state&&t.tap_action&&(e[t.state]=t.tap_action);const{tap_action_map:t,...i}=this._config;this._commit(Object.keys(e).length?{...i,tap_action_map:e}:i)}}customElements.define("materia-button-editor",Ts);const As={"filled-tonal":"tonal",standard:"text"},Es={light:"on",switch:"on",fan:"on",input_boolean:"on",vacuum:"cleaning",lock:["locked","locking"],cover:"open",climate:"heat",media_player:"playing"};class Ms extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedLabel:{state:!0},_resolvedSubtitle:{state:!0},_resolvedDisabled:{state:!0}};static styles=zs;static getConfigElement(){return document.createElement("materia-button-editor")}static getStubConfig(){return{icon:"mdi:play",variant:"filled",size:"m",shape:"round"}}setConfig(e){if(!e.icon&&!e.label)throw new Error("icon or label is required");this.config={variant:"filled",size:"m",shape:"round",...e},this.toggleAttribute("wide",!!e.wide)}get _disabled(){const e=this.config?.disabled_when??this.config?.disabled;if(null==e)return!1;if("boolean"==typeof e)return e;if(Array.isArray(e))return li(e,this.hass);if(this._isTemplate(e)){const e=this._resolvedDisabled;return"True"===e||"true"===e||"1"===e}return"true"===e||"True"===e}updated(e){e.has("config")&&(this.toggleAttribute("wide",!!this.config?.wide),null!=this.config?.flex&&(this.style.flex=String(this.config.flex))),e.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("label","_resolvedLabel"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField(null!=this.config?.disabled_when?"disabled_when":"disabled","_resolvedDisabled"))}_isActive(e){if(!e)return!1;const t=e.entity_id.split(".")[0],i=this.config.active_state??Es[t]??"on";return Array.isArray(i)?i.includes(e.state):e.state===String(i)}_defaultTapAction(){return this.config.entity?{action:"toggle"}:{action:"none"}}_resolveTapAction(){if(this.config.tap_action_map&&this.config.entity){const e=this.hass?.states[this.config.entity]?.state,t=this.config.tap_action_map[e]??this.config.tap_action_map.default;if(t)return t}return this.config.tap_action||this._defaultTapAction()}_handleTap(){this._disabled||this._confirmMode||this._handleAction(this._resolveTapAction())}get _confirmMode(){const e=this.config?.confirm,t="hold"===e||!0===e?"hold":"slide"===e?"slide":null;if(!t)return null;if("both"===this.config?.confirm_direction)return t;const i=this.config?.entity?this.hass?.states?.[this.config.entity]:void 0;return i&&this._isActive(i)?null:t}get _gesture(){return this.__gesture??=new _e({host:this,surface:()=>this.shadowRoot?.querySelector(".btn"),onChange:()=>this.requestUpdate()}),this.__gesture.travel="full",this.__gesture}_syncGesture(){const e=this._gesture;return e.gesture=this._confirmMode??"hold",e.threshold=Number(this.config?.confirm_threshold??.55),e.holdMs=Number(this.config?.confirm_hold_ms??800),e.disabled=this._disabled,e}_onConfirmDown(e){this._confirmMode&&this._syncGesture().pointerDown(e)}_onConfirmKey(e){this._confirmMode&&this._syncGesture().keyDown(e)}_onConfirmed(){this._handleAction(this._resolveTapAction())}connectedCallback(){super.connectedCallback(),this.__onConfirm??=()=>this._onConfirmed(),this.addEventListener("confirm",this.__onConfirm)}disconnectedCallback(){super.disconnectedCallback?.(),this.removeEventListener("confirm",this.__onConfirm),this.__gesture?.destroy()}render(){if(!this.config)return I``;const e=this.config.entity?this.hass?.states?.[this.config.entity]:void 0,t=!!this.config.entity&&this._isUnavailable(e),i=this._disabled,s=As[this.config.variant]||this.config.variant||"filled",n=["primary","secondary","tertiary","error"].includes(this.config.role)?this.config.role:"",a=this.config.size??"m";let o="",r="";if("number"==typeof a||/^\d+$/.test(String(a))){const e=Number(a);r=`--mb-h:${e}px;--mb-icon:${Math.round(.43*e)}px;--mb-font:16px;--mb-px:${Math.round(.42*e)}px;--mb-rsq:${Math.round(.28*e)}px;--mb-gap:8px;`}else o=`size-${a}`;const l="square"===this.config.shape?"square":"round",c=this._isActive(e),h=this.config.active_variant,d=c&&h?As[h]||h:s,p=this.config.morph_on_active&&c?"round"===l?"square":"round":l,u=this._isTemplate(this.config.icon)?this._resolvedIcon||"":this.config.icon,m=this._isTemplate(this.config.label)?this._resolvedLabel||"":this.config.label,g=this._isTemplate(this.config.subtitle)?this._resolvedSubtitle||"":this.config.subtitle,f="stacked"===this.config.layout,_=!m&&!g,b=this._confirmMode,v=b?this._syncGesture():null;return I`
      <button
        class="btn variant-${d} ${n?`role-${n}`:""} ${o} shape-${p} ${c?"active":"inactive"} ${this.config.connected?`connected-${this.config.connected}`:""} ${_?"icon-only":""} ${f?"stacked":""} ${i?"disabled":""} ${t?"unavailable":""} ${b?"confirming":""} ${v?.armed?"armed":""} ${v&&v.settling&&!v.armed?"settling":""}"
        style=${r}${b?`--mb-p:${v.p};`:""}
        @click=${this._handleTap}
    ...
    `}getCardSize(){return 1}}customElements.define("materia-button",Ms),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"M3 button — icon and/or label, variants, sizes, shapes, and shape-morph on state.",preview:!0});const Os=[Ee,a`
  ...
  `];class Fs extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-split-button",Rs),window.customCards=window.customCards||[],window.customCards.push({type:"materia-split-button",name:"Materia Split Button",description:"M3 Expressive split button — a main action plus a menu of related actions.",preview:!0});class Ps extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
 ...
 */const Ws=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Ws(e,t);return!0},Vs=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Gs=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Ks(t)}};function Xs(e){void 0!==this._$AN?(Vs(this),this._$AM=e,Gs(this)):this._$AM=e}function Ys(e,t=!1,i=0){const s=this._$AH,n=this._$AN;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Ws(s[e],!1),Vs(s[e]);else null!=s&&(Ws(s,!1),Vs(s));else Ws(this,e)}const Ks=e=>{e.type==Bs&&(e._$AP??=Ys,e._$AQ??=Xs)};class Zs extends Hs{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Gs(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ws(this,e),Vs(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Qs=new WeakMap,Js=Is(class extends Zs{render(e){return V}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),V}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Qs.get(t);void 0===i&&(i=new WeakMap,Qs.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Qs.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class en extends We{static properties={_expandedButton:{state:!0},_expandedOption:{state:!0}};static styles=[We.styles,a`
            ...
            ${this._expandedButton===t?I`
                  <div class="button-body">
                    <materia-button-editor
                      .hass=${this.hass}
                      ${Js(i=>{i&&i.__materiaIdx!==t&&(i.__materiaIdx=t,i.setConfig(e))})}
  ...
  `];class sn extends We{static styles=[We.styles,a`
      .remap-row {
        display: flex;
        align-items: center;
        gap: 6px;
      ...
      >
        <div class="body">
          ...
          <materia-drag-confirm
            ...
            .label=${n?"locking"===s?this.config.locking_label??$e("lock_locking",this.hass):this.config.unlocking_label??$e("lock_unlocking",this.hass):v?b:_}
            .pending=${n}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 5}}customElements.define("materia-lock",an),window.customCards=window.customCards||[],window.customCards.push({type:"materia-lock",name:"Materia Lock",description:"Lock shape that morphs square→circle, with a drag-to-confirm or hold-to-confirm gesture. Works with no entity.",preview:!0});
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const on=Is(class extends Hs{constructor(){super(...arguments),this.key=V}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(((e,t=js)=>{e._$AH=t})(e),this.key=t),i}}),rn=[Ee,Te,Ae,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-schedule-editor",class extends We{_formData(){return{presentation:"inline",...this._config}}get _sections(){return[{title:"Setup",icon:"mdi:tune",fields:[{name:"name",label:"Eyebrow above the chosen moment",helper:'What is being scheduled — e.g. "Start cleaning".',selector:{text:{}}},{name:"presentation",label:"Presentation",helper:"Sheet drops the collapsed strip and renders the picker directly — for putting the card inside a browser_mod popup.",selector:{select:{mode:"dropdown",options:[{value:"inline",label:"Inline — collapsed strip that expands"},{value:"sheet",label:"Sheet — always open, for a modal"},{value:"manager",label:"Manager — list, add and edit several schedules"}]}}},{name:"empty_label",label:"Strip title when nothing is set",selector:{text:{}}},{name:"empty_sub",label:"Strip sub-line when nothing is set",selector:{text:{}}}]},{title:"Wiring",icon:"mdi:transit-connection-variant",fields:[{name:"confirm_action",label:"On confirm",helper:"Use $datetime, $date, $time, $duration, $weekdays, $repeat, $trigger, $label in the data.",selector:{ui_action:{default_action:"none"}}},{name:"trigger_action",label:"On confirm, trigger tab",helper:"Falls back to the confirm action when unset.",selector:{ui_action:{default_action:"none"}}},{name:"close_action",label:"How to dismiss the modal",helper:"Sheet presentation only. Defaults to browser_mod.close_popup.",selector:{ui_action:{default_action:"none"}}}]},{title:"Shortcuts",icon:"mdi:clock-fast",fields:[{name:"presets",label:'The "At a time" shortcuts',helper:'List of { label, offset: 90m|2h|1d } or { label, at: "09:00", days: 1 } or { label, at, weekday: 6 }. Each may carry its own tap_action. Empty for the built-in six.',selector:{object:{}}},{name:"minutes",label:"Minute options (default 0, 15, 30, 45)",selector:{object:{}}}]},{title:"Window (start-stop)",icon:"mdi:clock-start",fields:[{name:"manage_schedules",label:"Manage multiple schedules",helper:"Shows a parent-friendly list and lets people add or edit Scheduler entries without exposing entity IDs or service names.",selector:{boolean:{}}},{name:"targets",label:"Devices and friendly actions",helper:"List of {entity, name, icon, actions:[{service,label,icon}]}. Schedules controlling these devices are discovered automatically.",selector:{object:{}}},{name:"schedule_entities",label:"Additional schedule entities",helper:"Optional explicit switch.schedule_* list, for schedules that cannot be discovered through their target device.",selector:{entity:{domain:"switch",multiple:!0}}},{name:"schedule_entity",label:"Scheduler entity",helper:"A switch.schedule_* entity (HACS Scheduler integration). Reads its current window/weekdays on open, writes back with scheduler.edit. Implies a start+stop window.",selector:{entity:{domain:"switch"}}},{name:"show_stop",label:"Start+stop window without a scheduler entity",helper:"For driving a custom confirm_action with $start/$stop/$weekdays/$actions instead of binding to Scheduler.",selector:{boolean:{}}},{name:"actions",label:"Timeslot actions",helper:'What the window turns on/off, e.g. [{service: "switch.turn_on", target: {entity_id: "switch.pool_pump"}}]. Only needed when schedule_entity has no existing timeslot to read the actions from, or to override it.',selector:{object:{}}}]},{title:"Triggers",icon:"mdi:sensors",fields:[{name:"show_triggers",label:'Show the "When…" tab',helper:"Disable this for a straightforward clock-only scheduler.",selector:{boolean:{}}},{name:"triggers",label:"Non-clock triggers",helper:"List of { key, name, sub, icon }. Leave empty for the built-in four.",selector:{object:{}}}]}]}});class ln extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_open:{state:!0},_armed:{state:!0},_mode:{state:!0},_pick:{state:!0},_event:{state:!0},_customOpen:{state:!0},_viewY:{state:!0},_viewM:{state:!0},_date:{state:!0},_hour:{state:!0},_minute:{state:!0},_repeating:{state:!0},_days:{state:!0},_stopHour:{state:!0},_stopMinute:{state:!0},_startOpen:{state:!0},_stopOpen:{state:!0},_multipleSlots:{state:!0},_resolvedPending:{state:!0},_resolvedNextLabel:{state:!0},_resolvedNextSub:{state:!0},_activeScheduleEntity:{state:!0},_targetEntity:{state:!0},_targetAction:{state:!0},_removeArmed:{state:!0}};static styles=rn;static getConfigElement(){return document.createElement("materia-schedule-editor")}static getStubConfig(){return{name:"Start cleaning"}}setConfig(e){this.config={presentation:"inline",default_mode:"clock",...e},this._modeTouched||(this._mode=this._modes[0]),this._isManager&&!this._targetEntity&&this._selectTarget(this._managerTargets[0]?.entity)}get _isSheet(){return"sheet"===this.config.presentation}get _isSummary(){return"summary"===this.config.presentation}get _isManager(){return"manager"===this.config.presentation||!0===this.config.manage_schedules||Array.isArray(this.config.targets)}get _managerTargets(){return(this.config.targets||[]).map(e=>"string"==typeof e?{entity:e}:e).filter(e=>e?.entity)}get _scheduleEntity(){return this._activeScheduleEntity||this.config.schedule_entity||""}get _managedSchedules(){const e=new Set(this.config.schedule_entities||[]),t=new Set(this._managerTargets.map(e=>e.entity));return Object.values(this.hass?.states||{}).filter(e=>e.entity_id.startsWith("switch.schedule_")).filter(i=>e.has(i.entity_id)||(i.attributes.entities||[]).some(e=>t.has(e))).sort((e,t)=>String(e.attributes.next_trigger||"9999").localeCompare(String(t.attributes.next_trigger||"9999")))}_targetConfig(e=this._targetEntity){return this._managerTargets.find(t=>t.entity===e)||null}_targetName(e=this._targetEntity){return this._targetConfig(e)?.name||this.hass?.states?.[e]?.attributes?.friendly_name||e||$e("sched_choose_device",this.hass)}_targetActions(e=this._targetEntity){const t=this._targetConfig(e)?.actions;if(t?.length)return t.map(e=>"string"==typeof e?{service:e}:e);const i=String(e||"switch.unknown").split(".")[0];return[{service:`${i}.turn_on`,label:$e("state_on",this.hass),icon:"m3o:power-settings-new"},{service:`${i}.turn_off`,label:$e("state_off",this.hass),icon:"m3o:power-off"}]}_actionName(e=this._targetAction,t=this._targetEntity){const i=this._targetActions(t).find(t=>t.service===e);return i?.label||(String(e).endsWith("turn_off")?$e("state_off",this.hass):$e("state_on",this.hass))}_selectTarget(e){e&&(this._targetEntity=e,this._targetAction=this._targetActions(e)[0]?.service||null,this._dirty=!0)}_tpl(e,t){const i=this.config[e];if(null==i)return null;const s=this._isTemplate(i)?this[t]:i,n=null==s?"":String(s).trim();return n.length?n:null}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&(this._resolveField("pending","_resolvedPending"),this._resolveField("next_label","_resolvedNextLabel"),this._resolveField("next_sub","_resolvedNextSub"),(this.config.schedules||[]).forEach((e,t)=>{null!=e.label&&this._resolveTemplateValue(`schedLabel${t}`,e.label)}),this._scheduleEntity&&!this._dirty&&this._seedFromEntity()),this.toggleAttribute("sheet",this._isSheet),this._syncFoldHeight()}constructor(){super();const e=new Date;this._open=!1,this._armed=null,this._mode="clock",this._pick=null,this._event=null,this._customOpen=!1,this._viewY=e.getFullYear(),this._viewM=e.getMonth(),this._date=e.getDate(),this._hour=9,this._minute=0,this._repeating=!1,this._days=[!0,!0,!0,!0,!0,!1,!1],this._stopHour=10,this._stopMinute=0,this._startOpen=!1,this._stopOpen=!1,this._multipleSlots=!1,this._activeScheduleEntity=null,this._targetEntity=null,this._targetAction=null,this._removeArmed=!1,this._entityActions=null,this._dirty=!1}get _pickKey(){return this._pick}get _hasSelection(){return this._isWindow?!this._windowBlocked&&this._days.some(Boolean)&&(!this._isManager||!!this._targetEntity&&!!this._targetAction):"event"===this._mode?null!=this._event:null!=this._pick}get _isWindow(){return"clock"===this._mode&&(this._isManager||!0===this.config.show_stop||!!this._scheduleEntity)}get _windowBlocked(){return this._isWindow&&this._multipleSlots}get _windowOvernight(){return 60*this._stopHour+this._stopMinute<=60*this._hour+this._minute}get _windowLabel(){return`${this._pad(this._hour)}:${this._pad(this._minute)} → ${this._pad(this._stopHour)}:${this._pad(this._stopMinute)}`}get _windowDaysSummary(){if(this._days.every(Boolean))return $e("sched_window_daily",this.hass);if(!this._days.some(Boolean))return $e("sched_window_pick_days",this.hass);const e=new Intl.DateTimeFormat(this._lang,{weekday:"short"});return this._days.map((t,i)=>t?e.format(new Date(2024,0,1+i)):null).filter(Boolean).join(", ")}get _windowSub(){return this._windowOvernight?`${this._windowDaysSummary} · ${$e("sched_window_overnight",this.hass)}`:this._windowDaysSummary}_seedFromEntity(){const e=this._scheduleEntity;if(!e)return;const t=this.hass?.states[e];if(!t)return;const i=t.attributes.timeslots||[];if(this._multipleSlots=i.length>1,this._entityActions=t.attributes.actions??null,this._isManager){const e=(t.attributes.entities||[])[0];e&&(this._targetEntity=e);const i=(t.attributes.actions||[])[0]?.service;this._targetAction=i||this._targetActions(e)[0]?.service||null}const s=i[0],n=s&&/^(\d{1,2}):(\d{2})(?::\d{2})?\s*-\s*(\d{1,2}):(\d{2})(?::\d{2})?$/.exec(String(s).trim());n&&(this._hour=Number(n[1]),this._minute=Number(n[2]),this._stopHour=Number(n[3]),this._stopMinute=Number(n[4]));const a=(t.attributes.weekdays||[]).map(e=>String(e).toLowerCase());if(a.includes("daily"))this._days=[!0,!0,!0,!0,!0,!0,!0];else if(a.length){const e=["mon","tue","wed","thu","fri","sat","sun"];this._days=e.map(e=>a.includes(e))}}get _isWired(){return!!(this.config.confirm_action||this.config.trigger_action||this._scheduleEntity||this._isManager||(this.config.presets??[]).some(e=>e.tap_action)||(this.config.triggers??[]).some(e=>e.tap_action))}get _pending(){const e=this.config.pending;if(!e)return null;const t=this._isTemplate(e)?this._resolvedPending:e,i=null==t?"":String(t).trim();return i.length?i:null}get _modes(){if(this._isManager)return["clock"];const e=[];return!1!==this.config.show_time&&e.push("clock"),!1!==this.config.show_triggers&&e.push("event"),e.length||e.push("clock"),"event"===this.config.default_mode&&e.includes("event")?["event",...e.filter(e=>"event"!==e)]:e}get _lang(){return this.hass?.locale?.language||void 0}_pad(e){return String(e).padStart(2,"0")}_hhmm(e){return`${this._pad(e.getHours())}:${this._pad(e.getMinutes())}`}_dayTime(e){return`${new Intl.DateTimeFormat(this._lang,{weekday:"short"}).format(e)} ${this._hhmm(e)}`}get _defaultPresets(){return[{label:$e("sched_preset_1h",this.hass),offset:"1h"},{label:$e("sched_preset_4h",this.hass),offset:"4h"},{label:$e("sched_preset_tonight",this.hass),at:"23:00"},{label:$e("sched_preset_tomorrow",this.hass),at:"09:00",days:1,grow:1.4},{label:$e("sched_preset_noon",this.hass),at:"12:00"},{label:$e("sched_preset_saturday",this.hass),at:"10:00",weekday:6,grow:1.4}]}_resolvePreset(e,t){if(e.offset){const i=/^(\d+(?:\.\d+)?)\s*(m|h|d)$/i.exec(String(e.offset).trim());if(!i)return null;const s={m:6e4,h:36e5,d:864e5}[i[2].toLowerCase()];return new Date(t.getTime()+parseFloat(i[1])*s)}const i=/^(\d{1,2}):(\d{2})$/.exec(String(e.at??"").trim());if(!i)return null;const[s,n]=[Number(i[1]),Number(i[2])],a=new Date(t);if(a.setSeconds(0,0),a.setHours(s,n),null!=e.weekday){let i=(Number(e.weekday)%7-t.getDay()+7)%7;return 0===i&&a<=t&&(i=7),a.setDate(a.getDate()+i),a}return null!=e.days?(a.setDate(a.getDate()+Number(e.days)),a):(a<=t&&a.setDate(a.getDate()+1),a)}get _quick(){const e=new Date;return(this.config.presets??this._defaultPresets).map((t,i)=>{const s=this._resolvePreset(t,e);if(!s)return null;const n=s.toDateString()===e.toDateString();return{key:t.key??`p${i}`,name:t.label??"—",at:n?this._hhmm(s):this._dayTime(s),grow:t.grow??1,when:s,tap_action:t.tap_action}}).filter(Boolean)}get _defaultTriggers(){return[{key:"leave",label:$e("sched_trigger_leave",this.hass),secondary:$e("sched_trigger_leave_sub",this.hass),icon:"m3o:directions-walk"},{key:"empty",label:$e("sched_trigger_empty",this.hass),secondary:$e("sched_trigger_empty_sub",this.hass),icon:"m3o:person-off"},{key:"night",label:$e("sched_trigger_night",this.hass),secondary:$e("sched_trigger_night_sub",this.hass),icon:"m3o:bedtime"},{key:"sunset",label:$e("sched_trigger_sunset",this.hass),secondary:$e("sched_trigger_sunset_sub",this.hass),icon:"m3o:wb-twilight"}]}get _events(){return(this.config.triggers??this._defaultTriggers).map((e,t)=>({key:e.key??`t${t}`,name:e.label??e.name??"—",sub:e.secondary??e.sub??"",icon:e.icon??"m3o:sensors",tap_action:e.tap_action}))}get _describe(){if("event"===this._mode){const e=this._events.find(e=>e.key===this._event);return e?{head:e.name,sub:`${e.sub} · trigger`}:{head:$e("sched_pick_trigger",this.hass),sub:$e("sched_runs_whenever",this.hass)}}if(this._isWindow)return this._windowBlocked?{head:$e("sched_multi_slots_head",this.hass),sub:$e("sched_multi_slots_sub",this.hass)}:{head:this._windowLabel,sub:this._windowSub};if("custom"===this._pick){const e=new Intl.DateTimeFormat(this._lang,{day:"numeric",month:"long"}).format(new Date(this._viewY,this._viewM,this._date));return{head:`${this._pad(this._hour)}:${this._pad(this._minute)}`,sub:e}}const e=this._quick.find(e=>e.key===this._pickKey);return e?{head:e.at,sub:e.name}:{head:$e("sched_when_question",this.hass),sub:$e("sched_pick_moment",this.hass)}}get _dayNames(){const e=new Intl.DateTimeFormat(this._lang,{weekday:"narrow"});return Array.from({length:7},(t,i)=>e.format(new Date(2024,0,1+i)))}get _tabConfig(){const e={clock:{label:this.config.time_tab_label??$e("sched_at_a_time",this.hass),value:"clock",icon:"m3o:schedule"},event:{label:this.config.trigger_tab_label??$e("sched_when_ellipsis",this.hass),value:"event",icon:"m3o:sensors"}};return{size:"m",preset:"primary",options:this._modes.map(t=>e[t])}}get _minuteConfig(){return{size:"s",preset:"primary",options:(this.config.minutes??[0,15,30,45]).map(e=>({label:this._pad(e),value:String(e)}))}}get _weekdayConfig(){return{size:"s",preset:"primary",multi_select:!0,active_shape:"square",options:this._dayNames.map((e,t)=>({label:e,value:String(t)}))}}get _resolvedWhen(){return"event"===this._mode?null:"custom"===this._pickKey?new Date(this._viewY,this._viewM,this._date,this._hour,this._minute,0,0):this._quick.find(e=>e.key===this._pickKey)?.when??null}_actionContext(){const e=this._resolvedWhen,t=e=>String(e).padStart(2,"0");let i="",s="",n="",a="";if(e){s=`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`,n=`${t(e.getHours())}:${t(e.getMinutes())}`,i=`${s} ${n}:00`;const o=Math.max(0,Math.round((e.getTime()-Date.now())/1e3));a=`${t(Math.floor(o/3600))}:${t(Math.floor(o%3600/60))}:${t(o%60)}`}return{datetime:i,date:s,time:n,duration:a,weekdays:this._repeating?["mon","tue","wed","thu","fri","sat","sun"].filter((e,t)=>this._days[t]):[],repeat:!!this._repeating,trigger:this._event??"",label:this._describe.head}}_fill(e,t){if("string"==typeof e){const i=/^\$(\w+)$/.exec(e.trim());return i&&i[1]in t?t[i[1]]:e.replace(/\$(\w+)/g,(e,i)=>i in t?String(t[i]):e)}return Array.isArray(e)?e.map(e=>this._fill(e,t)):e&&"object"==typeof e?Object.fromEntries(Object.entries(e).map(([e,i])=>[e,this._fill(i,t)])):e}_syncFoldHeight(){const e=this.shadowRoot?.querySelector(".custom-body");if(e){const t=this.shadowRoot.querySelector(".custom-inner");e.style.height=this._customOpen&&t?`${t.scrollHeight}px`:"0px"}this.shadowRoot?.querySelectorAll(".win-edge").forEach(e=>{const t=e.querySelector(".win-body"),i=e.querySelector(".win-inner");t&&(t.style.height=e.classList.contains("open")&&i?`${i.scrollHeight}px`:"0px")})}_seedCustom(){const e=this._quick.find(e=>e.key===this._pickKey)?.when??new Date(Date.now()+36e5);this._viewY=e.getFullYear(),this._viewM=e.getMonth(),this._date=e.getDate();const t=[...this.config.minutes??[0,15,30,45]].sort((e,t)=>e-t),i=e.getMinutes(),s=t.find(e=>e>=i);this._minute=s??t[0],this._hour=null==s?(e.getHours()+1)%24:e.getHours()}_dismiss(){if(this._open=!1,this._dirty=!1,!this._isSheet)return;const e=this.config.close_action??{action:"fire-dom-event",browser_mod:{service:"browser_mod.close_popup",data:{}}};this._handleAction(e)}_commit(){if(!this._hasSelection)return;if(this._isWindow)return this._commitWindow();this._armed={...this._describe,repeating:this._repeating,mode:this._mode},this._open=!1;const e="event"===this._mode?this._events.find(e=>e.key===this._event):this._quick.find(e=>e.key===this._pickKey),t=e?.tap_action??("event"===this._mode?this.config.trigger_action:null)??this.config.confirm_action;t?this._handleAction(this._fill(t,this._actionContext())):this._fireHaptic("success"),this._isSheet&&this._dismiss()}_windowActionContext(){const e=`${this._pad(this._hour)}:${this._pad(this._minute)}`,t=`${this._pad(this._stopHour)}:${this._pad(this._stopMinute)}`,i=this._days.every(Boolean)?["daily"]:["mon","tue","wed","thu","fri","sat","sun"].filter((e,t)=>this._days[t]);return{start:e,stop:t,weekdays:i,actions:this._isManager?[{service:this._targetAction,entity_id:this._targetEntity}]:this.config.actions??this._entityActions??[],entity:this._scheduleEntity,name:`${this._targetName()} · ${this._windowLabel}`,label:this._windowLabel}}_defaultWindowAction(){if(!this._scheduleEntity&&!this._isManager)return null;const e=!!this._scheduleEntity;return{action:"perform-action",perform_action:e?"scheduler.edit":"scheduler.add",...e?{target:{entity_id:"$entity"}}:{},data:{weekdays:"$weekdays",repeat_type:"repeat",...e?{}:{name:"$name"},timeslots:[{start:"$start",stop:"$stop",actions:"$actions"}]}}}_commitWindow(){if(this._windowBlocked)return;this._armed={head:this._windowLabel,sub:this._windowDaysSummary,repeating:!0,mode:"window"},this._open=!1,this._dirty=!1;const e=this.config.confirm_action??this._defaultWindowAction();e?this._handleAction(this._fill(e,this._windowActionContext())):this._fireHaptic("success"),this._isManager&&(this._activeScheduleEntity=null),this._isSheet&&this._dismiss()}_renderStrip(){const e=this._armed,t=e?e.head:this.config.empty_label??$e("sched_not_scheduled",this.hass),i=e?e.sub:this.config.empty_sub??$e("sched_tap_to_pick",this.hass),s=e?"event"===e.mode?"m3o:sensors":"m3o:alarm":"m3o:add";return I`
    ...
    `}_openNewSchedule(){this._activeScheduleEntity=null,this._selectTarget(this._managerTargets[0]?.entity),this._hour=9,this._minute=0,this._stopHour=10,this._stopMinute=0,this._days=[!0,!0,!0,!0,!0,!0,!0],this._multipleSlots=!1,this._removeArmed=!1,this._dirty=!0,this._open=!0}_openSchedule(e){this._activeScheduleEntity=e.entity_id,this._dirty=!1,this._removeArmed=!1,this._seedFromEntity(),this._open=!0}_formatNext(e){const t=e.attributes.next_trigger;if(!t)return"on"===e.state?$e("sched_enabled",this.hass):$e("sched_disabled",this.hass);const i=new Date(t);return Number.isNaN(i.getTime())?String(t):new Intl.DateTimeFormat(this._lang,{weekday:"short",hour:"2-digit",minute:"2-digit"}).format(i)}_renderManager(){const e=this._managedSchedules;return I`<ha-card><div class="sheet manager">
      <div class="manager-head">
        ...
        <button class="manager-add" @click=${this._openNewSchedule}>
          <ha-icon icon="m3o:add"></ha-icon><span>${$e("sched_add_short",this.hass)}</span>
        </button>
      </div>
      <div class="schedule-list">
        ${e.length?e.map(e=>{const t=(e.attributes.entities||[])[0],i=(e.attributes.actions||[])[0]?.service,s=(e.attributes.timeslots||[])[0]||"";return I`<div class="schedule-row">
            <button class="schedule-main" @click=${()=>this._openSchedule(e)}>
              <ha-icon icon=${this._targetConfig(t)?.icon??"m3o:schedule"}></ha-icon>
              <span class="schedule-text">
                <span class="schedule-name">${this._targetName(t)} · ${this._actionName(i,t)}</span>
                <span class="schedule-sub">${s} · ${this._formatNext(e)}</span>
              </span>
    ...
    </div></ha-card>`}_renderManagerFields(){const e=this._managerTargets.map(e=>({value:e.entity,label:this._targetName(e.entity)})),t=this._targetActions().map(e=>({value:e.service,label:e.label||this._actionName(e.service)}));return I`<div class="manager-fields">
      <label><span>${$e("sched_device",this.hass)}</span>
        <ha-selector
          .hass=${this.hass}
          .selector=${{select:{mode:"dropdown",options:e}}}
          .value=${this._targetEntity||""}
          @value-changed=${e=>this._selectTarget(e.detail.value)}
        ></ha-selector>
      </label>
        ...
        <div class="sheet">
          <div class="echo">
            ...
            ${(()=>{const i=this._hasSelection?t.head:e??t.head,s=this._hasSelection?t.sub:e?this.config.pending_sub??$e("sched_pending_sub",this.hass):t.sub;return I`
                ${on(i,I`<span class="headline swap">${i}</span>`)}
                ${on(s,I`<span class="subline swap">${s}</span>`)}
              `})()}
          </div>
          ...
          <div class="actions">
            ...
            >
              ...
              <span>${this._repeating?$e("sched_save_schedule",this.hass):$e("sched_set_timer",this.hass)}</span>
            </button>
          </div>
    ...
    `}_renderWindow(){if(this._windowBlocked)return I`
      ...
      `;const e=I`<svg class="chev" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div class="window">
        <div class="win-edge ${this._startOpen?"open":""}">
          <button
            class="win-head"
            @click=${()=>{this._startOpen=!this._startOpen,this._stopOpen=!1}}
          >
          ...
          <div class="win-body">
            <div class="win-inner">
              <ha-selector
                ...
                @value-changed=${e=>{const[t,i]=String(e.detail.value||"").split(":").map(Number);Number.isFinite(t)&&Number.isFinite(i)&&(this._hour=t,this._minute=i,this._dirty=!0)}}
              ></ha-selector>
            </div>
          </div>
        </div>
        ...
        <div class="win-edge ${this._stopOpen?"open":""}">
          <button
            class="win-head"
            @click=${()=>{this._stopOpen=!this._stopOpen,this._startOpen=!1}}
          >
          ...
          <div class="win-body">
            <div class="win-inner">
              <ha-selector
                ...
                @value-changed=${e=>{const[t,i]=String(e.detail.value||"").split(":").map(Number);Number.isFinite(t)&&Number.isFinite(i)&&(this._stopHour=t,this._stopMinute=i,this._dirty=!0)}}
              ></ha-selector>
            </div>
          </div>
        </div>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return this._open||this._isSheet?10:2}}customElements.define("materia-schedule",ln),window.customCards=window.customCards||[],window.customCards.push({type:"materia-schedule",name:"Materia Schedule",description:"Shortcuts-first schedule picker — quick chips, non-clock triggers, and a calendar that stays folded until asked for. Mocked, no backend.",preview:!0});const cn=[Pi,a`
  ...
  `];class hn extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-select-hero",dn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-select-hero",name:"Materia Select Hero",description:"A select whose current option owns the panel — glyph, name, one line of consequence, and the option pills in one block. A variant of Materia Hero.",preview:!0});const pn=[Ee,Te,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-heading-editor",class extends We{_formData(){return{heading_style:"title",...this._config}}get _sections(){return[{title:"Heading",icon:"mdi:format-title",fields:[{name:"heading",required:!0,selector:{text:{}}},{name:"heading_style",label:"Style",selector:{select:{mode:"dropdown",options:[{value:"title",label:"Title"},{value:"subtitle",label:"Subtitle"}]}}},{name:"icon",selector:{icon:{}}},{name:"secondary",label:"Right-aligned meta line",template:!0,selector:{text:{}}},{name:"tap_action",selector:{ui_action:{default_action:"none"}}}]}]}});class un extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedSecondary:{state:!0}};static styles=pn;static getConfigElement(){return document.createElement("materia-heading-editor")}static getStubConfig(){return{heading:"Section"}}setConfig(e){this.config={...e}}updated(e){e.has("hass")&&this.hass&&this._resolveField("secondary","_resolvedSecondary")}get _secondary(){const e=this.config.secondary;if(null==e)return null;const t=this._isTemplate(e)?this._resolvedSecondary:e,i=null==t?"":String(t).trim();return i.length?i:null}render(){if(!this.config)return I``;const e="subtitle"===this.config.heading_style,t=this._secondary,i=!!this.config.tap_action;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-heading",un),window.customCards=window.customCards||[],window.customCards.push({type:"materia-heading",name:"Materia Heading",description:"Section heading in the family's display voice, with a templatable right-aligned meta line.",preview:!0});const mn=[Ee,Te,Ae,ge,a`
    ha-card {
      background: var(--ha-card-background, var(--card-background-color));
      overflow: hidden;
      container-type: inline-size;
  ...
  `];customElements.define("materia-doorbell-editor",class extends We{_formData(){return{...this._config}}get _sections(){return[{title:"Doorbell",icon:"mdi:doorbell",fields:[{name:"entity",label:"Doorbell entity",helper:"on = ringing. The countdown runs from its last change.",selector:{entity:{domain:["input_boolean","binary_sensor","switch"]}}},{name:"timeout",label:"Popup timeout (seconds)",helper:"Match the popup timeout so the top bar and the dialog agree.",selector:{number:{min:5,max:300,mode:"box"}}},{name:"ring_seconds",label:"Ring length (seconds)",helper:"How long the chime actually sounds — the ring lapses when it ends. Empty = same as the popup timeout.",selector:{number:{min:1,max:300,mode:"box"}}},{name:"name",label:"Eyebrow while ringing (default: Doorbell)",selector:{text:{}}},{name:"place",label:"Where the ring is from (default: Front door)",selector:{text:{}}},{name:"demo",label:"Preview a phase (demo)",helper:"Forces the card's face — the live phases only show during a real ring. Clear it for real use.",selector:{select:{mode:"dropdown",options:[{value:"ringing",label:"Ringing"},{value:"buzzing",label:"Buzzing"},{value:"buzzed",label:"Buzzed"},{value:"opened",label:"Opened"},{value:"lapsed",label:"Lapsed"}]}}}]},{title:"Buzz panel",icon:"mdi:bullhorn",fields:[{name:"buzz_action",label:"Tap-to-buzz action",helper:"The street-door buzzer. Leave empty to hide the panel.",selector:{ui_action:{default_action:"none"}}},{name:"buzz_entity",label:"Buzzing indicator",helper:"on = buzzing (usually the buzzer script itself).",selector:{entity:{}}},{name:"buzz_title",label:"Panel title (default: Buzz in)",selector:{text:{}}},{name:"buzz_sub",label:"Panel sub-line",helper:'Default: "Street door only", translated with the dashboard.',selector:{text:{}}}]},{title:"Open panel",icon:"mdi:lock-open-variant-outline",fields:[{name:"lock",label:"Lock",helper:"The gesture unlocks this. Leave empty to hide the panel.",selector:{entity:{domain:"lock"}}},{name:"open_gesture",label:"Open gesture",selector:{select:{mode:"dropdown",options:[{value:"slide",label:"Slide"},{value:"hold",label:"Hold"}]}}},{name:"open_action",label:"Open action (replaces the plain unlock)",helper:"For a let-them-in sequence that clears more than this one lock. Re-locking always drives the lock itself.",selector:{ui_action:{default_action:"none"}}},{name:"open_title",label:"Panel title (default: Open the front door)",selector:{text:{}}},{name:"open_sub",label:"Panel sub-line",helper:'Default: "Unlocks the front door for your visitor.", translated with the dashboard.',selector:{text:{}}}]},{title:"Bottom row",icon:"mdi:dots-horizontal",fields:[{name:"ignore_action",label:"Ignore",helper:"Empty hides the button. The whole row hides when nothing in it is configured.",selector:{ui_action:{default_action:"none"}}},{name:"replay_action",label:"Replay ring",helper:"Empty hides the button.",selector:{ui_action:{default_action:"none"}}},{name:"mute_entity",label:"Mute toggle entity",helper:"input_boolean silencing the chime. Empty hides the button.",selector:{entity:{domain:"input_boolean"}}}]}]}});const gn=rt(90,90,86,9),fn=6e3;class _n extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_now:{state:!0},_buzzedUntil:{state:!0}};static styles=mn;static getConfigElement(){return document.createElement("materia-doorbell-editor")}static getStubConfig(){return{entity:"",timeout:30}}setConfig(e){if(!e.entity)throw new Error("entity is required (on = ringing)");this.config={timeout:30,...e}}connectedCallback(){super.connectedCallback(),this._syncTicker()}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._tick),this._tick=null,clearTimeout(this._lingerTimer)}_on(e){const t=e?this.hass?.states[e]:void 0;return!!t&&["on","true","open","opening","unlocked","unlocking","running","active","home"].includes(String(t.state).toLowerCase())}get _ringSeconds(){return this.config.ring_seconds??this.config.timeout}get _ringing(){return null!=this._ringT0&&(Date.now()-this._ringT0)/1e3<this._ringSeconds}get _buzzing(){return this._on(this.config.buzz_entity)}get _buzzedRecently(){const e=this.config.timeout||0;if(this._buzzing)return!0;if(this._buzzedVia&&(Date.now()-this._buzzedVia)/1e3<=e)return!0;const t=this.config.buzz_entity?this.hass?.states[this.config.buzz_entity]:null;if(!t)return!1;const i=Date.parse(t.last_changed);return!Number.isNaN(i)&&(Date.now()-i)/1e3<=e}get _lockState(){const e=this.config.lock;return e?String(this.hass?.states[e]?.state??""):""}get _unlockedNow(){return["unlocked","unlocking"].includes(this._lockState)}get _openedViaCard(){return null!=this._openedVia&&(Date.now()-this._openedVia)/1e3<=(this.config.timeout||0)}get _opened(){if(this._buzzedRecently)return!0;if(!this._unlockedNow)return!1;const e=this.hass?.states[this.config.lock],t=e?Date.parse(e.last_changed):NaN;return!Number.isNaN(t)&&(Date.now()-t)/1e3<=(this.config.timeout||0)}get _unlocking(){return["unlocking","locking"].includes(this._lockState)}get _left(){return this._ringT0?Math.max(0,Math.ceil(this._ringSeconds-(Date.now()-this._ringT0)/1e3)):0}get _phase(){return this.config.demo?this.config.demo:this._opened?"opened":this._buzzing?"buzzing":this._buzzedUntil&&Date.now()<this._buzzedUntil?"buzzed":this._ringing?"ringing":"lapsed"}willUpdate(e){if(e.has("hass")||e.has("config")){if("ringing"===this.config?.demo)return void((!this._ringT0||(Date.now()-this._ringT0)/1e3>(this.config.timeout||0))&&(this._ringT0=Date.now()));if(!this._ringT0){const e=this.hass?.states[this.config?.entity],t=e?Date.parse(e.last_changed):NaN;!Number.isNaN(t)&&(Date.now()-t)/1e3<=(this.config.timeout||0)&&(this._ringT0=t)}this._ringT0&&(Date.now()-this._ringT0)/1e3>(this.config.timeout||0)&&(this._ringT0=null)}}updated(e){if(e.has("hass")){const e=this._buzzing;this._wasBuzzing&&!e&&(this._buzzedUntil=Date.now()+fn,clearTimeout(this._lingerTimer),this._lingerTimer=setTimeout(()=>this.requestUpdate(),6050)),this._wasBuzzing=e,this._syncTicker()}}get _windowLeft(){return this._ringT0?Math.max(0,Math.ceil((this.config.timeout||0)-(Date.now()-this._ringT0)/1e3)):0}_syncTicker(){const e=this._ringing||this._windowLeft>0;e&&!this._tick?this._tick=setInterval(()=>{this._now=Date.now()},1e3):!e&&this._tick&&(clearInterval(this._tick),this._tick=null)}_buzz(){this.config.buzz_action&&(this._buzzedVia=Date.now(),this._handleAction(this.config.buzz_action),this.config.buzz_entity||(this._buzzedUntil=Date.now()+fn,clearTimeout(this._lingerTimer),this._lingerTimer=setTimeout(()=>this.requestUpdate(),6050)))}_slide(){if(!this.config.lock)return;if(this.config.open_action)return this._openedVia=Date.now(),this._handleAction(this.config.open_action),void this.requestUpdate();const e="unlocked"===this._lockState?"lock":"unlock";this._callService("lock",e,{entity_id:this.config.lock})}_ignore(){this.config.ignore_action&&this._handleAction(this.config.ignore_action)}_replay(){this.config.replay_action&&this._handleAction(this.config.replay_action)}_toggleMute(){this.config.mute_entity&&this._callService("homeassistant","toggle",{entity_id:this.config.mute_entity})}_copy(e){const t=this.hass,i=this.config.place??$e("db_eyebrow_front",t),s=this._left;return{ringing:{eyebrow:this.config.name??$e("db_eyebrow",t),accent:!0,title:$e("db_title_ringing",t),sub:$e("db_sub_ringing",t,{place:i}),num:`${s}s`,numAccent:!0,cap:$e("db_count_before_lapse",t),icon:"m3of:notifications-active",chip:"live ringing"},buzzing:{eyebrow:$e("db_eyebrow_street",t),accent:!0,title:$e("db_title_buzzing",t),sub:$e("db_sub_buzzing",t),num:null,numAccent:!1,cap:null,icon:"m3o:door-open",chip:"live"},buzzed:{eyebrow:$e("db_eyebrow_street",t),accent:!1,title:$e("db_title_buzzed",t),sub:$e("db_sub_buzzed",t),num:null,numAccent:!1,cap:null,icon:"m3o:door-open",chip:"soft"},opened:{eyebrow:$e("db_eyebrow_front",t),accent:!1,title:$e("db_title_opened",t),titleAccent:!0,sub:this._unlockedNow?$e("db_sub_opened",t):$e("db_sub_buzzed",t),num:null,numAccent:!1,cap:null,icon:"m3o:lock-open-right",chip:"live"},lapsed:{eyebrow:this.config.name??$e("db_eyebrow",t),accent:!1,title:$e("db_title_lapsed",t),sub:$e("db_sub_lapsed",t),num:null,numAccent:!1,cap:null,icon:"m3o:notifications-off",chip:""}}[e]}render(){if(!this.config||!this.hass)return I``;const e=this._phase,t=this._copy(e),i=this._buzzing||"buzzing"===e,s=this.config.open_action?this._openedViaCard:this._unlockedNow,n=this.config.timeout>0&&this._ringT0?Math.round(this._windowLeft/this.config.timeout*100):100,a="buzzed"===e||this._buzzedRecently,o=$e(i?"db_buzz_busy":a?"db_buzz_done":"db_buzz_cta",this.hass),r=i?"m3o:door-open":a?"m3o:check-circle":"m3o:bolt",l=this._on(this.config.mute_entity);return I`
            ...
            ${this.config.buzz_action?I`
                  <div class="panel buzz ${i?"busy":""}" @click=${this._buzz}>
                    <div class="cookie-stage">
                      <svg class="wave one" viewBox="0 0 180 180"><path d=${gn}></path></svg>
                      <svg class="wave two" viewBox="0 0 180 180"><path d=${gn}></path></svg>
                      <svg class="cookie" viewBox="0 0 180 180"><path d=${gn}></path></svg>
    ...
    `}getCardSize(){return 5}}customElements.define("materia-doorbell",_n),window.customCards=window.customCards||[],window.customCards.push({type:"materia-doorbell",name:"Materia Doorbell",description:"Doorbell alert — countdown ring, tap-to-buzz, slide-to-unlock. Built for a browser_mod popup.",preview:!0});const bn=[Ee,Te,ge,a`
  ...
  `];class vn extends We{static properties={_expanded:{state:!0},_editingCard:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `:I`<ha-card>${s}</ha-card>`}getGridOptions(){return this._panes?{columns:12,rows:"auto"}:{columns:2,rows:"auto"}}getCardSize(){return this._panes?6:3}}customElements.define("materia-tabs",wn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-tabs",name:"Materia Tabs",description:"Vertical tab rail — the selected tab grows into the nav-rail indicator. Embed cards per tab, or pair with conditional cards.",preview:!0});const xn=[...ui,a`
  ...
  `];class kn extends We{static properties={_editingCard:{state:!0}};static styles=[We.styles,a`
      .cards-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return this._open&&this._cards?1+this._cards.length:1}}customElements.define("materia-expander",$n),window.customCards=window.customCards||[],window.customCards.push({type:"materia-expander",name:"Materia Expander",description:"Switch row that opens — the one control that matters stays inline, everything else lives behind the chevron.",preview:!0});const Cn=[Ee,Te,Ae,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-level-editor",class extends We{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",template:!0,selector:{text:{}}},{name:"attribute",label:"Attribute holding the level",helper:"Defaults per domain: volume_level, brightness, percentage, current_position. Leave empty for number helpers.",selector:{text:{}}},{name:"icon",label:"Leading icon",template:!0,selector:{icon:{}}},{name:"control_entity",label:"Trailing control entity",helper:"Adds an aligned circular toggle beside the slider, for example a media-player zone power control.",selector:{entity:{}}},{name:"control_icon",label:"Trailing control icon",selector:{icon:{}}},{name:"control_label",label:"Trailing control accessible label",selector:{text:{}}},{name:"control_action",label:"Trailing control action",selector:{ui_action:{default_action:"toggle"}}}]},{title:"Range",icon:"mdi:ruler",secondary:"Left empty, these come from the entity",fields:[{name:"min",label:"Minimum (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"max",label:"Maximum (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"max_entity",label:"Maximum from helper",helper:"Optional number/input_number whose live state caps the slider.",selector:{entity:{domain:["number","input_number","sensor"]}}},{name:"max_entity_factor",label:"Maximum helper scale factor",helper:"For example 0.01 converts a percentage helper (60) to media volume (0.60).",selector:{number:{mode:"box",step:"any"}}},{name:"step",label:"Step (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"unit",label:"Unit shown after the value",helper:"Defaults to the entity's unit, or % for volume and brightness.",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"variant",label:"Container",selector:{select:{mode:"dropdown",options:[{value:"filled",label:"Filled card"},{value:"flat",label:"Flat / no background"}]}}},{name:"slider_size",label:"Slider size",selector:{select:{mode:"dropdown",options:[{value:"xs",label:"XS · 16 dp"},{value:"s",label:"S · 24 dp"},{value:"m",label:"M · 40 dp"}]}}},{name:"color",label:"Tile background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Content color on it",color:!0,template:!0,selector:{text:{}}},{name:"slider_color",label:"Active track & handle",color:!0,template:!0,selector:{text:{}}},{name:"slider_track_color",label:"Inactive track",color:!0,template:!0,selector:{text:{}}},{name:"hide_stops",label:"Hide the stop indicators",helper:"The small M3 dots at each end of the track. Shown by default.",selector:{boolean:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[He]}]}});const Sn={volume_level:{min:0,max:1,step:.01,factor:100,unit:"%"},brightness:{min:0,max:255,step:1,factor:100/255,unit:"%"},percentage:{min:0,max:100,step:1,factor:1,unit:"%"},current_position:{min:0,max:100,step:1,factor:1,unit:"%"}},zn={media_player:"volume_level",light:"brightness",fan:"percentage",cover:"current_position"},Tn={media_player:["media_player.volume_set","volume_level"],light:["light.turn_on","brightness"],number:["number.set_value","value"],input_number:["input_number.set_value","value"],fan:["fan.set_percentage","percentage"],cover:["cover.set_cover_position","position"]},An=(e,t)=>{const i=Number(e);return Number.isFinite(i)?i:t},En=e=>{const t=String(e),i=t.indexOf(".");return i<0?0:Math.min(6,t.length-i-1)};class Mn extends(as(di(ze(ce)))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedLabel:{state:!0},_resolvedIcon:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedSliderColor:{state:!0},_resolvedSliderTrackColor:{state:!0},_dragging:{state:!0}};static styles=[Cn,pi];static getConfigElement(){return document.createElement("materia-level-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}),i=t.find(e=>e.startsWith("media_player."))||t.find(e=>e.startsWith("input_number."))||t.find(e=>e.startsWith("number."))||t.find(e=>e.startsWith("light."))||"";return{entity:i}}setConfig(e){if(!e.entity)throw new Error("Materia Level: entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("label","_resolvedLabel"),this._resolveField("icon","_resolvedIcon"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("slider_color","_resolvedSliderColor"),this._resolveField("slider_track_color","_resolvedSliderTrackColor"),this._optimisticReconcile())}get _stateObj(){return this.hass?.states[this.config.entity]}get _domain(){return String(this.config.entity||"").split(".")[0]}get _attribute(){return this.config.attribute??zn[this._domain]??null}get _scale(){const e=this._stateObj?.attributes||{},t=this.config.max_entity?Number(this.hass?.states?.[this.config.max_entity]?.state):NaN,i=Number.isFinite(t)?t*An(this.config.max_entity_factor,1):void 0,s=Sn[this._attribute]||{min:An(e.min,0),max:An(e.max,100),step:An(e.step,1),factor:1,unit:e.unit_of_measurement??""},n="percentage"===this._attribute?An(e.percentage_step,s.step):s.step;return{min:An(this.config.min,s.min),max:An(this.config.max??i,s.max),step:An(this.config.step,n),factor:s.factor,unit:this.config.unit??s.unit}}_optimisticActual(){const e=this._stateObj;if(!e)return null;const t=this._attribute?e.attributes?.[this._attribute]:e.state,i=Number(t);return Number.isFinite(i)?String(i):"light"===this._domain&&"off"===e.state?"0":null}get _current(){if(null!=this._dragging)return this._dragging;const e=Number(this._optimistic);return Number.isFinite(e)?e:null}_quantize(e,t){const{min:i,max:s,step:n}=t,a=n>0?Math.round((e-i)/n)*n+i:e,o=Math.min(s,Math.max(i,a));return Number(o.toFixed(En(n)))}_display(e,t){if(null==e)return"—";const i=e*t.factor,s=1===t.factor?En(t.step):0;return Number(i.toFixed(s)).toLocaleString(this.hass?.locale?.language||"en",{minimumFractionDigits:s,maximumFractionDigits:s})}_onDragging(e){e.stopPropagation();const t=Number(e.detail?.value);this._dragging=Number.isFinite(t)?t:null}_onCommit(e){e.stopPropagation();const t=Number(e.detail?.value);if(this._dragging=null,!Number.isFinite(t))return;const i=this._quantize(t,this._scale),s=this._stateObj;if(!s)return;const[n,a]=this._writeTarget();if(!n)return;if(this._fireHaptic("selection"),this._optimisticSet(i),!this.config.service&&"light"===this._domain&&i<=0)return void this._callService("light","turn_off",{entity_id:s.entity_id});const[o,r]=n.split(".");this._callService(o,r,{entity_id:s.entity_id,[a]:i})}_writeTarget(){if(this.config.service){const e=this.config.service_key||this._attribute||"value";return[String(this.config.service),e]}const e=Tn[this._domain];return e?[e[0],this.config.service_key||e[1]]:this._attribute?[`${this._domain}.set_${this._attribute}`,this.config.service_key||this._attribute]:[null,null]}_field(e,t){const i=this.config[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}_controlTap(){if(this.config.control_action)return void this._handleAction(this.config.control_action);const e=this.config.control_entity;e&&this._callService("homeassistant","toggle",{entity_id:e})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._scale,i=this._current,s=!e||this._isUnavailable(e)||"unknown"===e.state||null==i,n=this._field("label","_resolvedLabel")||e?.attributes?.friendly_name||this.config.entity,a=this._field("icon","_resolvedIcon"),o=this._field("color","_resolvedColor"),r=this._field("color_on","_resolvedColorOn"),l=this._field("slider_color","_resolvedSliderColor")||r||"var(--md-sys-color-primary, var(--primary-color))",c=this._field("slider_track_color","_resolvedSliderTrackColor")||"",h=this._display(i,t),d=t.unit,p=this.config.control_entity?this.hass.states[this.config.control_entity]:null,u=p&&!["off","unavailable","unknown"].includes(p.state),m=this.config.control_icon||"m3o:power-settings-new";return I`
      <ha-card class=${s?"unavailable":""} style="--ml-accent:${l};">
        <div class="level-row ${p?"with-control":""}">
          ...
          ${p?I`<button
            class="control ${u?"on":""}"
            aria-label=${this.config.control_label||p.attributes?.friendly_name||n}
            aria-pressed=${u?"true":"false"}
            @click=${this._controlTap}
          ><ha-icon .icon=${m}></ha-icon></button>`:V}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-level",Mn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-level",name:"Materia Level",description:"Entity-bound level row with an M3 Expressive slider — volumes, dimmers, number helpers, fan speeds.",preview:!0});const On=[Ee,Te,Ae,pi,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Fn=[{value:"home",label:"Home"},{value:"away",label:"Away"},{value:"night",label:"Night"},{value:"vacation",label:"Vacation"},{value:"custom",label:"Custom bypass"}];class Dn extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}_renderMode(e,t,i,s){const n=s.active?.key===e.key,a=this._isInert(e),o=this._holdKey===e.key,r=this._modeLabel(e),l=a?"m3o:lock":this.config[`icon_${e.key}`]??e.icon,c=n?s.triggered?"var(--md-sys-color-error)":s.accent:s.idleBg,h=n?s.triggered?"var(--md-sys-color-on-error)":s.accentOn:s.idleFg,d=!n&&s.notReady.length>0,p=d?"var(--md-sys-cust-color-warning, var(--md-sys-color-error))":n?s.idleBg:s.accent,u=d?"var(--md-sys-cust-color-on-warning, var(--md-sys-color-on-error))":n?s.idleFg:s.accentOn,m=a?$e("al_aria_inert",this.hass,{mode:r}):n?$e("al_aria_hold_disarm",this.hass):$e("al_aria_hold_arm",this.hass,{mode:r}),g=this._buttonHint(e),f=I`
    ...
    `}_renderZones(e){const t=e.filter(e=>e.safety),i=t.filter(e=>e.open||e.unavailable),s=e.filter(e=>e.open&&!e.safety),n=e.filter(e=>e.unavailable&&!e.safety),a=e.filter(e=>e.bypassed&&!e.safety),o=e.filter(e=>!(e.open||e.bypassed||e.unavailable||e.safety)),r=o.filter(e=>e.sensing).length,l=[...t].sort((e,t)=>{const i=e.open||e.unavailable?0:1,s=t.open||t.unavailable?0:1;return i!==s?i-s:null!=e.zone&&null!=t.zone?e.zone-t.zone:String(e.name).localeCompare(String(t.name))});return I`
      <div class="zones">
        ${s.length?I`
              <div class="zgroup">
        ...
        ${a.length?I`
              <div class="zgroup">
                <div class="zgroup-title warn">
                  ${$e(1===a.length?"al_zones_bypassed_one":"al_zones_bypassed_count",this.hass,{n:a.length})}
                </div>
                ${a.map(e=>this._zoneRow(e,"bypassed"))}
              </div>
            `:V}
        ...
        ${n.length?this._zoneSummary({icon:"m3o:sensors-off",cls:"unavail",label:$e(1===n.length?"al_zones_unavailable_one":"al_zones_unavailable",this.hass,{n:n.length}),aria:$e("al_aria_unavail_toggle",this.hass),open:this._unavailExpanded,toggle:()=>{this._unavailOpen=!this._unavailExpanded},rows:n}):V}
  ...
  `];customElements.define("materia-confirm-editor",class extends We{_formData(){return{gesture:"hold",require_gesture:"activate",hold_ms:800,threshold:.55,pending_timeout_ms:1e4,caption_warn:!0,...this._config}}_sectionsSignature(){return[this._config?.entity?"e":"",this._config?.gesture||"hold",this._config?.require_gesture||"activate",this._config?.action?"a":""].join("|")}get _sections(){const e="slide"!==(this._config?.gesture??"hold"),t=!!this._config?.entity;return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Entity to reflect and drive (optional)",helper:"With an entity and no actions below, the gesture turns it on and the active face turns it off — nothing else to configure. Leave empty to fire an action only.",selector:{entity:{}}},...t?[{name:"active_state",label:"State that counts as active",helper:'Defaults to the usual on/open/unlocked family. Set this for a control whose "on" is spelled something else.',selector:{text:{}}}]:[],{name:"action",label:"Action when committing",helper:"Fired when the gesture completes. Overrides the default turn-on.",selector:{ui_action:{default_action:"none"}}},{name:"deactivate_action",label:"Action when switching off",helper:"Fired by the active face. Overrides the default turn-off.",selector:{ui_action:{default_action:"none"}}}]},{title:"Gesture",icon:"mdi:gesture-tap-hold",fields:[{name:"gesture",label:"Commit gesture",selector:{select:{mode:"dropdown",options:[{value:"hold",label:"Press and hold"},{value:"slide",label:"Slide across"}]}}},{name:"require_gesture",label:"Which direction needs the gesture",helper:"Turning ON only, by default: switching an override off returns things to normal and costs nothing, and making the cheap direction ceremonial teaches people the gesture is a formality. Choose both where OFF is the dangerous direction — a control that disables a protection rather than enabling a cost.",selector:{select:{mode:"dropdown",options:[{value:"activate",label:"Only turning on"},{value:"both",label:"Both directions"}]}}},...e?[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}}]:[{name:"threshold",label:"Fraction of the track to cross (default 0.55)",selector:{number:{min:.2,max:1,step:.05,mode:"box"}}}],...t?[{name:"pending_timeout_ms",label:"Give up waiting for the entity after (ms, default 10000)",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}}]:[]]},{title:"Words",icon:"mdi:text-short",fields:[{name:"eyebrow",label:"Eyebrow (optional)",template:!0,selector:{text:{}}},{name:"label",label:"Gesture label",helper:"The instruction across the track. Keep it short — it sits on one line.",template:!0,selector:{text:{}}},{name:"caption",label:"Warning / consequence line",helper:"THE POINT OF THIS CARD. Shown before the gesture is touched and while it is held, which is strictly more informative than a dialog that appears after the decision and gets dismissed by reflex. Put the cost or the consequence here.",template:!0,selector:{text:{}}},{name:"caption_warn",label:"Colour the warning line",selector:{boolean:{}}},{name:"active_label",label:"Label while active",template:!0,selector:{text:{}}},{name:"active_caption",label:"Caption while active",helper:"Falls back to the warning line above when empty.",template:!0,selector:{text:{}}},..."both"===this._config?.require_gesture?[]:[{name:"deactivate_hint",label:'Active face hint (default "Tap to stop")',selector:{text:{}}}],...t?[{name:"busy_label",label:'While waiting (default "Working…")',selector:{text:{}}}]:[]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"active_color",label:"Background while active",color:!0,selector:{text:{}}},{name:"active_color_on",label:"Text while active",color:!0,selector:{text:{}}},{name:"track_color",label:"Gesture track",color:!0,selector:{text:{}}},{name:"track_color_on",label:"Text on the track",color:!0,selector:{text:{}}},...e?[]:[{name:"handle_color",label:"Slide handle",color:!0,selector:{text:{}}},{name:"handle_color_on",label:"Handle glyph",color:!0,selector:{text:{}}}],{name:"active_icon",label:'Icon while active (default "check-circle")',selector:{icon:{}}},{name:"gesture_icon",label:"Icon on the gesture handle (optional)",selector:{icon:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[He]}]}});const Xn=new Set(["on","true","open","opening","unlocked","unlocking","home","active"]);class Yn extends(di(ze(ce))){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_resolvedLabel:{state:!0},_resolvedActiveLabel:{state:!0},_resolvedCaption:{state:!0},_resolvedActiveCaption:{state:!0},_resolvedEyebrow:{state:!0}};static styles=Gn;static getConfigElement(){return document.createElement("materia-confirm-editor")}static getStubConfig(){return{gesture:"hold"}}setConfig(e){this.config={gesture:"hold",...e}}constructor(){super(),this._pending=null}connectedCallback(){super.connectedCallback(),this._unsub=Bi.subscribe(e=>{e===this.config?.entity&&this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=null,clearTimeout(this._pinTimer)}updated(e){e.has("hass")&&this.hass&&(this._resolveField("label","_resolvedLabel"),this._resolveField("active_label","_resolvedActiveLabel"),this._resolveField("caption","_resolvedCaption"),this._resolveField("active_caption","_resolvedActiveCaption"),this._resolveField("eyebrow","_resolvedEyebrow"),null!=this._pending&&this._entityActive===this._pending&&(this._pending=null,clearTimeout(this._pinTimer)))}_field(e,t){const i=this.config?.[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}get _stateObj(){return this.config?.entity?this.hass?.states[this.config.entity]:null}get _entityActive(){const e=this._stateObj;if(!e||this._isUnavailable(e))return null;const t=String(e.state).toLowerCase();return this.config.active_state?t===String(this.config.active_state).toLowerCase():Xn.has(t)}get _active(){return null!=this._pending?this._pending:!0===this._entityActive}get _busy(){return null!=this._pending&&this._entityActive!==this._pending}get _gestureBoth(){return"both"===this.config.require_gesture}get _showGesture(){return!this._active||this._gestureBoth}_commit(){const e=!this._active,t=this.config.entity;t&&(this._pending=e,clearTimeout(this._pinTimer),this._pinTimer=setTimeout(()=>{this._pending=null},Number(this.config.pending_timeout_ms??1e4)),Bi.publish(t,e?"on":"off",this._stateObj?.state));const i=e?this.config.action:this.config.deactivate_action;i?this._handleAction(i):t&&(this._fireHaptic("success"),this._callService("homeassistant",e?"turn_on":"turn_off",{entity_id:t}))}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(this.config.entity&&!e)return I`<ha-card><div class="body">
        ...
        >
          ...
          ${s?I`
                <materia-drag-confirm
                  ...
                  .label=${this._busy?this.config.busy_label??$e("cf_working",this.hass):i?d:h}
              ...
              `:I`
                <button
                  class="active-face"
                  aria-label=${this.config.deactivate_aria??$e("cf_tap_to_stop_aria",this.hass,{what:d})}
                  ?disabled=${t}
                  @click=${this._commit}
                >
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-confirm",Yn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-confirm",name:"Materia Confirm",description:"Press-and-hold to commit a consequential action, with the warning in plain view instead of in a dialog. No tap path.",preview:!0});const Kn=[Ee,Te,Ae,pi,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class Zn extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){const e=(this.config?.rows||[]).length;return(this.config?.eyebrow||this.config?.meta?1:0)+Math.ceil(e/2)+(this.config?.status?1:0)+(this.config?.footnote?1:0)||1}}customElements.define("materia-bars",ea),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bars",name:"Materia Bars",description:"Labelled readings as comparable bars on one shared scale, with a status sentence. A missing reading draws as unknown, never as zero.",preview:!0});const ta={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-on-secondary-container)"],"tertiary-container":["var(--md-sys-color-tertiary-container)","var(--md-sys-color-on-tertiary-container)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-state":["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],"secondary-state":["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],"tertiary-state":["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],"error-state":["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],"device-state":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]},ia=[Ee,ge,a`
    :host {
  ...
  `];customElements.define("materia-checkbox-editor",class extends We{get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",template:!0,selector:{text:{}}},{name:"checked_entity",selector:{entity:{}}},{name:"checked_value",selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"tap_action_checked",label:"Action (checked)",selector:{ui_action:{}}},{name:"tap_action_unchecked",label:"Action (unchecked)",selector:{ui_action:{}}}]}]}});class la extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-checkbox-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("input_boolean."))||"";return{entity:t,name:"Checkbox"}}static styles=[Ae,ra];setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={tap_action:{action:"toggle"},...e}}_isChecked(e){if(this.config.checked_entity){const e=this.hass?.states[this.config.checked_entity];if(!e)return!1;const t=String(e.state??"").split(",").map(e=>e.trim()).filter(Boolean);return this.config.checked_values?this.config.checked_values.every(e=>t.includes(e)):!!this.config.checked_value&&t.includes(this.config.checked_value)}if(!e)return!1;const t=String(e.state??"").toLowerCase(),i=Number(t);return"on"===t||"true"===t||"home"===t||!Number.isNaN(i)&&i>0}updated(e){e.has("hass")&&this.hass&&this._resolveField("name","_resolvedName")}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=!t&&this._isChecked(e),s=this._isTemplate(this.config.name)?this._resolvedName:this.config.name??e?.attributes?.friendly_name??this.config.entity,n=i?"mdi:checkbox-marked":"mdi:checkbox-blank-outline";return I`
    ...
    `}_handleTap(){const e=this.hass?.states[this.config.entity],t=this._isChecked(e);let i;i=t&&this.config.tap_action_checked?this.config.tap_action_checked:!t&&this.config.tap_action_unchecked?this.config.tap_action_unchecked:this.config.tap_action||{action:"toggle"},this._handleAction(i)}getCardSize(){return 1}}customElements.define("materia-checkbox",la),window.customCards=window.customCards||[],window.customCards.push({type:"materia-checkbox",name:"Materia Checkbox",description:"Checkbox with custom checked state logic.",preview:!0});const ca=[Ee,Te,a`
    .container {
      position: relative;
      width: 100%;
      min-height: 50px;
  ...
  `];customElements.define("materia-pill-editor",class extends We{_formData(){return{background:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"state_display",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}},{name:"background",selector:{boolean:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{}}}]}]}});class ha extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0},_resolvedStateDisplay:{state:!0}};static getConfigElement(){return document.createElement("materia-pill-editor")}static getStubConfig(e){const t=(e?Object.keys(e.states):[]).find(e=>e.startsWith("sensor."))||"";return{entity:t,name:"",icon:"mdi:information-outline"}}static styles=[Ae,ca];setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={icon:"mdi:information-outline",...e}}_classify(e){const t=this.config.ranges||[];if(!t.length)return{label:"",color:""};const i=parseFloat(e);if(Number.isNaN(i))return{label:"",color:""};for(const e of t)if(null==e.max||i<=e.max)return{label:e.label,color:e.color};return{label:"",color:""}}get _templatesReady(){const e=this.config;return(!this._isTemplate(e?.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(e?.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(e?.icon)||void 0!==this._resolvedIcon)&&(!this._isTemplate(e?.name)||void 0!==this._resolvedName)))}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"),this._resolveField("state_display","_resolvedStateDisplay"))}render(){if(!this.hass||!this.config)return I``;if(!this._templatesReady)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=this._isTemplate(this.config.name)?this._resolvedName:this.config.name||e?.attributes?.friendly_name||this.config.entity,s=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||e?.attributes?.icon||"",n=e?.attributes?.unit_of_measurement||"",a=e?.state??"",o=this.config.ranges||[],r=this._classify(a);let l;l=t?"Unavailable":this.config.state_display?this._isTemplate(this.config.state_display)?this._resolvedStateDisplay??"":this.config.state_display:o.length?n?`${a} · ${r.label||i}`:a:n?`${this._capitalize(a)} ${n}`:this._capitalize(a);const c=o.length?t?i:n||(r.label||i):"",h=this._resolvedColor||this.config.color||"var(--ha-card-background, var(--card-background-color))",d=this._resolvedColorOn||this.config.color_on||"var(--primary-text-color)",p=!1===this.config.background||"none"===this.config.background;return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-pill",ha),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill",name:"Materia Pill",description:"Compact info pill for sensors, weather, and status indicators.",preview:!0});const da=[Ee,Te,Ae,a`
  :host {
    position: relative;
    z-index: 1;
  }
...
`];class pa extends We{static properties={_expanded:{state:!0}};static styles=[We.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-menu",ua),window.customCards=window.customCards||[],window.customCards.push({type:"materia-menu",name:"Materia Menu",description:"M3 vertical dropdown menu for select entities.",preview:!0});const ma=a`
  :host {
    display: block;
  }
        ...
        <div class="wrap ${t?"unavailable":""}" style=${c?`--mp-color:${c};`:""}>
          ...
          ${l?I`
                <div class="times">
                  ...
                  <span class="time">${a?"∞":this._fmt(s)}</span>
                </div>
              `:V}
        </div>
      </ha-card>
    `}getCardSize(){return 1}}customElements.define("materia-media-progress",fa),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media-progress",name:"Materia Media Progress",description:"Wavy (M3 expressive) media seek bar with elapsed/duration and tap-to-seek.",preview:!0});const _a=a`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-editor",class extends We{_formData(){return{show_art:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"name",label:"Title",template:!0,selector:{text:{}}},{name:"subtitle",template:!0,selector:{text:{}}},{name:"image",helper:"Defaults to the entity's album art",template:!0,selector:{text:{}}},{name:"fallback_image",helper:"Shown when there's no art",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"show_art",selector:{boolean:{}}},{name:"art_size",label:"Art size (px)",selector:{number:{min:80,max:480,mode:"box"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class ba extends(ze(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedName:{state:!0},_resolvedSubtitle:{state:!0},_resolvedImage:{state:!0}};static styles=_a;static getConfigElement(){return document.createElement("materia-media-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("media_player."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config=e}updated(e){if(e.has("hass")&&this.hass){this._resolveField("name","_resolvedName"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField("image","_resolvedImage");const e=this._stateObj?.attributes?.media_title;e&&this._lastTrack&&e!==this._lastTrack&&(this._beat=!0,this.requestUpdate(),clearTimeout(this._beatTimer),this._beatTimer=setTimeout(()=>{this._beat=!1,this.requestUpdate()},900)),this._lastTrack=e}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._beatTimer)}get _stateObj(){return this.hass?.states[this.config.entity]}get _title(){if(this.config.name)return this._isTemplate(this.config.name)?this._resolvedName:this.config.name;const e=this._stateObj?.attributes;return e?.media_title||e?.friendly_name||""}get _subtitle(){if(this.config.subtitle)return this._isTemplate(this.config.subtitle)?this._resolvedSubtitle:this.config.subtitle;const e=this._stateObj?.attributes;return e?.media_artist||e?.media_album_name||""}get _image(){if(this.config.image){const e=this._isTemplate(this.config.image)?this._resolvedImage:this.config.image;if(e)return e}return this._stateObj?.attributes?.entity_picture||this.config.fallback_image||""}_tap(){this._handleAction(this.config.tap_action||{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._isUnavailable(e),i=this._image,s=this._title,n=this._subtitle,a=this.config.fallback_image,o=[i,a&&a!==i?a:null].filter(Boolean).map(e=>`url('${e}')`).join(", "),r=`${this.config.art_size?`--mm-art:${this.config.art_size}px;`:""}${o?`background-image:${o};`:""}`,l=!t&&!!e?.attributes?.media_title&&!["off","idle","standby"].includes(e.state),c=l&&"paused"===e.state;return I`
    ...
    `}getCardSize(){return 4}}customElements.define("materia-media",ba),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media",name:"Materia Media",description:"Now-playing card — album art, title and subtitle (all templatable).",preview:!0});const va=a`
  :host {
    display: block;
  }
      ...
      <ha-card style=${L}>
        <svg viewBox="0 0 100 100">
          ...
          ${m?(()=>{const t=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,i=(e.getSeconds()+(e.getMilliseconds?.()??0)/1e3)/60,s=t?800:Math.round(780+20*(1-Math.cos(2*Math.PI*i)));return H`
              ...
              `})():""}
          ${_?H`<text class="date" x=${z} y=${T} font-size="8" text-anchor="middle" dominant-baseline="central" transform="rotate(${A.toFixed(1)} ${z} ${T})">${b}</text>`:""}
