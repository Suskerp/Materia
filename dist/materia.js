...
`;class ft extends ct{static properties={gesture:{type:String,reflect:!0},label:{type:String},icon:{type:String},direction:{type:String},threshold:{type:Number},holdMs:{type:Number,attribute:"hold-ms"},disabled:{type:Boolean,reflect:!0},_p:{state:!0},_armed:{state:!0}};static styles=[gt,n`
    ...
    `];constructor(){super(),this.gesture="slide",this.label="",this.icon="mdi:arrow-right",this.direction="forward",this.threshold=.55,this.holdMs=800,this.disabled=!1,this._p=0,this._armed=!1,this._settling=!1,this._travel=0}disconnectedCallback(){super.disconnectedCallback(),this._cleanup()}willUpdate(t){t.has("direction")&&void 0!==t.get("direction")&&(this._p=0,this._settling=!1)}_measure(){const t=this._rect();this._travel=t?Math.max(0,t.width-t.height):0}_rect(){const t=this._frameId||0;return this._rectCache&&this._rectCacheFrame===t||(this._rectCache=this.shadowRoot?.querySelector(".track")?.getBoundingClientRect(),this._rectCacheFrame=t,this._frameRaf||(this._frameRaf=requestAnimationFrame(()=>{this._frameId=(this._frameId||0)+1,this._frameRaf=null}))),this._rectCache}_eventX(t){return void 0!==t.clientX&&0!==t.clientX?t.clientX:t.changedTouches?.[0]?t.changedTouches[0].clientX:t.touches?.[0]?t.touches[0].clientX:t.clientX||0}_haptic(t){this.dispatchEvent(new CustomEvent("haptic",{detail:t,bubbles:!0,composed:!0}))}_onPointerDown(t){this.disabled||t.button&&0!==t.button||t.isPrimary&&("touch"===t.pointerType&&t.clientX<=30||(this._startX=t.clientX,this._startY=t.clientY,this._pointerId=t.pointerId,this._rectCache=null,this._scrollIntent=!1,this._measure(),this._onUpRef=this._onPointerUp.bind(this),window.addEventListener("pointerup",this._onUpRef),window.addEventListener("pointercancel",this._onUpRef),this._onEarlyMoveRef=this._onEarlyMove.bind(this),window.addEventListener("pointermove",this._onEarlyMoveRef),"hold"===this.gesture&&this._engage(t)))}_onEarlyMove(t){if(this._scrollIntent)return;const e=Math.abs(t.clientX-this._startX),i=Math.abs(t.clientY-this._startY);if(i>10&&i>e+4)return this._scrollIntent=!0,"hold"===this.gesture&&this._release(!1),void this._dropEarlyMove();"hold"!==this.gesture&&e>6&&e>=i&&(this._dropEarlyMove(),this._engage(t))}_dropEarlyMove(){this._onEarlyMoveRef&&(window.removeEventListener("pointermove",this._onEarlyMoveRef),this._onEarlyMoveRef=null)}_engage(t){if(this._armed)return;this._armed=!0,this._settling=!1,this._engagedAt=Date.now(),this._grabX=this._eventX(t),this._grabP=this._p;const e=this.shadowRoot?.querySelector(".track");try{e?.setPointerCapture(this._pointerId)}catch(t){}document.documentElement.style.setProperty("touch-action","none"),document.documentElement.style.setProperty("overscroll-behavior","contain"),e?.addEventListener("touchmove",this._preventTouch,{passive:!1}),this._onVisibilityRef=()=>{document.hidden&&this._release(!1)},document.addEventListener("visibilitychange",this._onVisibilityRef),this._haptic("selection"),"hold"===this.gesture?(this._tick=this._tick.bind(this),this._raf=requestAnimationFrame(this._tick)):(this._onMoveRef=this._onDragMove.bind(this),window.addEventListener("pointermove",this._onMoveRef))}_preventTouch(t){t.preventDefault()}_tick(){if(!this._armed)return;const t=Math.min(1,(Date.now()-this._engagedAt)/Math.max(1,this.holdMs));this._p=t,t>=1?this._commit():this._raf=requestAnimationFrame(this._tick)}_onDragMove(t){if(!this._armed)return;"touch"===t.pointerType&&t.preventDefault();if(!this._rect()||this._travel<=0)return;const e=this._eventX(t)-this._grabX,i="backward"===this.direction?-e:e;this._p=Math.max(0,Math.min(1,this._grabP+i/this._travel))}_onPointerUp(t){if("pointercancel"===t.type&&this._engagedAt&&Date.now()-this._engagedAt<150)return clearTimeout(this._graceTimer),void(this._graceTimer=setTimeout(()=>this._release(!1),400));clearTimeout(this._graceTimer),this._release(this._armed&&"slide"===this.gesture&&this._p>=this.threshold)}_release(t){(this._armed||null!=this._startX)&&(t?this._commit():(this._settling=!0,this._p=0,this._cleanup()))}_commit(){this._settling=!0,this._p=1,this._cleanup(),this._haptic("success"),this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}_cleanup(){this._armed=!1,this._startX=null,this._scrollIntent=!1,this._engagedAt=null,this._rectCache=null,clearTimeout(this._graceTimer),this._raf&&(cancelAnimationFrame(this._raf),this._raf=null),this._dropEarlyMove();const t=this.shadowRoot?.querySelector(".track");document.documentElement.style.removeProperty("touch-action"),document.documentElement.style.removeProperty("overscroll-behavior"),t?.removeEventListener("touchmove",this._preventTouch);try{t?.releasePointerCapture(this._pointerId)}catch(t){}this._onVisibilityRef&&(document.removeEventListener("visibilitychange",this._onVisibilityRef),this._onVisibilityRef=null),this._onMoveRef&&(window.removeEventListener("pointermove",this._onMoveRef),this._onMoveRef=null),this._onUpRef&&(window.removeEventListener("pointerup",this._onUpRef),window.removeEventListener("pointercancel",this._onUpRef),this._onUpRef=null)}_onKeyDown(t){this.disabled||"Enter"!==t.key&&" "!==t.key&&"Spacebar"!==t.key||(t.preventDefault(),this._commit())}render(){const t="hold"===this.gesture,e="backward"===this.direction,i=e?1-this._p:this._p,o=this._settling&&!this._armed?"settling":"";return I`
      ...
      >
        ...
        <div class="label">
          ${t?I`<ha-icon .icon=${this.icon}></ha-icon>`:W}
...
`];customElements.define("materia-weather-editor",class extends Ot{_formData(){return{show_temperature:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Sensors",icon:"mdi:water-percent",fields:[{name:"show_temperature",label:"Show temperature",selector:{boolean:{}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const Wt={sunny:"m3o:sunny",clear:"m3o:sunny","clear-night":"mdi:weather-night",partlycloudy:"m3o:partly-cloudy-day",partly_cloudy:"m3o:partly-cloudy-day",cloudy:"m3o:cloud",rainy:"m3o:rainy",pouring:"m3o:rainy",snowy:"mdi:weather-snowy",fog:"m3o:foggy",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",hail:"mdi:weather-hail",exceptional:"mdi:alert-circle-outline"},Xt={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class Gt extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e}}static styles=Vt;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"",o=!1!==this.config.show_temperature;let s=t?.attributes?.temperature,n=t?.attributes?.temperature_unit||"°";if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&(s=t.state,n=t.attributes?.unit_of_measurement||n)}const a=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||Wt[i]||"mdi:weather-partly-cloudy";let r=null;if(this.config.humidity_entity){const t=this.hass.states[this.config.humidity_entity];t&&(r=t.state)}null==r&&null!=t?.attributes?.humidity&&(r=t.attributes.humidity);const l=Xt[i]||this._capitalize(i.replace(/-|_/g," ")),c=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,d=o&&null!=s?`${s}${n}`:null;let h;h=e?"Unavailable":c||(d||(l||"—"));const p=[];e||(d&&h!==d&&p.push(d),h!==l&&p.push(l),null!=r&&p.push(`${r}%`));const u=p.join(" · ");return I`
    ...
    </g>`}function me(t,e,i){return H`<g stroke=${t} stroke-width="1.8" stroke-linecap="round">
    ${e.map(t=>H`<line x1=${t} y1=${i} x2=${t-1.5} y2=${i+3.5} />`)}
  </g>`}function ge(t,e){return H`<g fill=${"var(--md-sys-cust-color-weather-snow, #FFFFFF)"}>
    ${t.map(t=>H`<circle cx=${t} cy=${e} r="1.2" />`)}
  </g>`}const fe={sunny:t=>pe(12,12,7.5,t.sun),clear:t=>pe(12,12,7.5,t.sun),"clear-night":(t,e)=>{if(null==e)return H`<path d="M17 14.5 A7 7 0 1 1 10.5 5 A5.5 5.5 0 0 0 17 14.5 Z" fill=${t.moon} />`;const i=oe(12,12,7.2,e);return H`
      <circle cx="12" cy="12" r="7.2" fill="color-mix(in srgb, ${de} 22%, transparent)" />
      ${i?H`<path d=${i} fill=${t.moon} />`:""}`},partlycloudy:t=>H`${pe(12,8,5.2,t.sun)}${ue(10,15,.85,t.cloud)}`,partly_cloudy:t=>H`${pe(12,8,5.2,t.sun)}${ue(10,15,.85,t.cloud)}`,cloudy:t=>ue(12,12,1.1,t.cloudDk),rainy:t=>H`${ue(12,10,1,t.cloudDk)}${me(le,[8,12,16],17)}`,pouring:t=>H`${ue(12,9.5,1,t.cloudDk)}${me(le,[7,10,13,16],16.5)}`,snowy:t=>H`${ue(12,10,1,t.cloud)}${ge([8,12,16],18)}`,"snowy-rainy":t=>H`${ue(12,10,1,t.cloud)}${me(le,[9,15],17)}${ge([12],18)}`,fog:t=>H`${ue(12,9,.95,t.cloudDk)}<g stroke=${"var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)"} stroke-width="1.8" stroke-linecap="round">
      <line x1="6" y1="17" x2="18" y2="17" /><line x1="7.5" y1="20" x2="16.5" y2="20" /></g>`,hail:t=>H`${ue(12,10,1,t.cloudDk)}${ge([8,12,16],18)}`,lightning:t=>H`${ue(12,10,1,t.cloudDk)}<path d="M12 14 l-2.5 5 h2 l-1 4 4.5-6.5 h-2.2 l1.5-2.5 z" fill=${ce} />`,"lightning-rainy":t=>H`${ue(12,9.5,1,t.cloudDk)}${me(le,[8,16],17)}<path d="M12 14 l-2 4 h1.8 l-0.8 3.5 4-5.5 h-2 l1.3-2 z" fill=${ce} />`,windy:()=>H`<g stroke=${re} stroke-width="2" stroke-linecap="round" fill="none">
      <path d="M4 9 h11 a2.5 2.5 0 1 0-2.5-2.5" />
      <path d="M4 14 h14 a2.5 2.5 0 1 1-2.5 2.5" /></g>`,"windy-variant":()=>H`<g stroke=${re} stroke-width="2" stroke-linecap="round" fill="none">
      <path d="M4 9 h11 a2.5 2.5 0 1 0-2.5-2.5" />
      <path d="M4 14 h14 a2.5 2.5 0 1 1-2.5 2.5" /></g>`,exceptional:t=>ue(12,12,1.1,t.cloudDk)};function _e(t,e=null){const i=fe[t]||fe.cloudy,o=++he;return H`${function(t){return H`<defs>
    <radialGradient id="wxSunG-${t}" cx="38%" cy="30%" r="80%">
      <stop offset="0%" stop-color="color-mix(in srgb, ${ne} 55%, #FFF4CF)" />
      <stop offset="55%" stop-color=${ne} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${ne} 72%, #B85C00)" />
    </radialGradient>
    <linearGradient id="wxCloudG-${t}" x1="0" y1="0" x2="0.25" y2="1">
      <stop offset="0%" stop-color="color-mix(in srgb, ${ae} 30%, #FFFFFF)" />
      <stop offset="70%" stop-color=${ae} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${ae} 78%, #8B94A5)" />
    </linearGradient>
    <linearGradient id="wxCloudDkG-${t}" x1="0" y1="0" x2="0.25" y2="1">
      <stop offset="0%" stop-color="color-mix(in srgb, ${re} 45%, #FFFFFF)" />
      <stop offset="70%" stop-color=${re} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${re} 72%, #5A6474)" />
    </linearGradient>
    <radialGradient id="wxMoonG-${t}" cx="35%" cy="28%" r="85%">
      <stop offset="0%" stop-color="color-mix(in srgb, ${de} 45%, #FFFFFF)" />
      <stop offset="60%" stop-color=${de} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${de} 62%, #4A5AB8)" />
    </radialGradient>
  </defs>`}(o)}${i(function(t){return{sun:`url(#wxSunG-${t})`,cloud:`url(#wxCloudG-${t})`,cloudDk:`url(#wxCloudDkG-${t})`,moon:`url(#wxMoonG-${t})`}}(o),e)}`}const be=[yt,bt,n`
  ha-card {
    background: none;
    border: none;
    box-shadow: none;
...
`];customElements.define("materia-weather-tile-editor",class extends Ot{_formData(){return{show_minmax:!0,mirror:!1,size:10,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"icon",label:"Custom icon (overrides the colored glyph)",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Min / Max",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show min / max",selector:{boolean:{}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"size",label:"Size (10 = fill)",selector:{number:{min:1,max:10,step:1,mode:"slider"}}},{name:"mirror",label:"Mirror (temperature left, icon right)",selector:{boolean:{}}},{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / temperature",color:!0,template:!0,selector:{text:{}}},{name:"minmax_color",label:"Min / max color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class ve extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedMinmaxColor:{state:!0},_forecast:{state:!0}};static styles=be;static getConfigElement(){return document.createElement("materia-weather-tile-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e,show_minmax:!0}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("minmax_color","_resolvedMinmaxColor"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"";let o=t?.attributes?.temperature;if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&(o=t.state)}const s=null!=this._num(o)?`${this._num(o)}°`:"—",n=t=>{const e=t?this.hass.states[t]:null;return e&&!this._isUnavailable(e)?e.state:null};let a=n(this.config.low_entity),r=n(this.config.high_entity);const l=this._forecast?.[0]||t?.attributes?.forecast?.[0];null==a&&null!=l?.templow&&(a=l.templow),null==r&&null!=l?.temperature&&(r=l.temperature);const c=this.config.show_minmax&&(null!=this._num(a)||null!=this._num(r)),d=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,h=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,p=this._isTemplate(this.config.minmax_color)?this._resolvedMinmaxColor:this.config.minmax_color;let u="number"==typeof this.config.tilt?this.config.tilt:{right:-45,left:45,none:0}[this.config.tilt]??-45;this.config.mirror&&(u=-u);const m=this.config.icon_size??53,g=this.config.text_size??30,f=this.config.width??115,_=(this.config.height??85)/100,b=this.config.icon_x??5,v=this.config.icon_y??10,y=this.config.temp_x??10,x=this.config.temp_y??15,w=`--wt-size:${["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][Math.min(10,Math.max(1,this.config.size??10))-1]};--wt-tilt:${u}deg;--wt-icon-size:${m}cqi;--wt-temp-size:${g}cqi;--wt-width:${f}%;--wt-ratio:${_};--wt-icon-x:${b}%;--wt-icon-y:${v}%;--wt-temp-x:${y}%;--wt-temp-y:${x}%;${d?`--wt-bg:${d};`:""}${h?`--wt-fg:${h};`:""}`+(p?`--wt-minmax:${p};--wt-minmax-opacity:1;`:""),$=this.config.icon;return I`
      <ha-card>
        ...
        >
          ...
          ${$?I`<ha-icon class="wx-mono" .icon=${$}></ha-icon>`:H`<svg class="wx" viewBox="0 0 24 24">${_e(i,se(this.hass,this.config.moon_entity))}</svg>`}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:6,rows:"auto",min_columns:4}}getCardSize(){return 3}}customElements.define("materia-weather-tile",ve),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-tile",name:"Materia Weather Tile",description:"Large blobby weather widget with a big temperature and colored condition icon.",preview:!0});const ye=[yt,bt,vt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-weather-hero-editor",class extends Ot{_formData(){return{show_condition:!0,show_icon:!0,show_feels_like:!0,show_minmax:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Real temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"feels_like_entity",label:"Feels-like sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"show_condition",label:"Show condition text",selector:{boolean:{}}},{name:"show_icon",label:"Show condition glyph",selector:{boolean:{}}},{name:"show_feels_like",label:"Show feels-like",selector:{boolean:{}}}]},{title:"Night / Day",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show night / day range",selector:{boolean:{}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"night_label",label:"Night label",selector:{text:{}}},{name:"day_label",label:"Day label",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const xe={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class we extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColorOn:{state:!0}};static styles=ye;static getConfigElement(){return document.createElement("materia-weather-hero-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color_on","_resolvedColorOn"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"",o=xe[i]||this._capitalize(String(i).replace(/-|_/g," "));let s=t?.attributes?.temperature;if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&!this._isUnavailable(t)&&(s=t.state)}const n=this._num(s);let a=t?.attributes?.apparent_temperature;if(this.config.feels_like_entity){const t=this.hass.states[this.config.feels_like_entity];t&&!this._isUnavailable(t)&&(a=t.state)}const r=this._num(a),l=t=>{const e=t?this.hass.states[t]:null;return e&&!this._isUnavailable(e)?e.state:null};let c=l(this.config.low_entity),d=l(this.config.high_entity);const h=this._forecast?.[0]||t?.attributes?.forecast?.[0];null==c&&null!=h?.templow&&(c=h.templow),null==d&&null!=h?.temperature&&(d=h.temperature);const p=this._num(c),u=this._num(d),m=this.config.night_label??"Night",g=this.config.day_label??"Day",f=this.config.separator??"•",_=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on;return I`
      <ha-card>
        ...
        >
          ${!1!==this.config.show_condition?I`<div class="condition">
                ${!1===this.config.show_icon||e?"":H`<svg class="cond-glyph" viewBox="0 0 24 24">${_e(i,se(this.hass,this.config.moon_entity))}</svg>`}
                <span>${e?"—":o}</span>
              </div>`:""}
          <div class="temp">
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}function $e(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}function ke(t,{locale:e="en",showPrecip:i=!0,minPrecip:o=10,moonPhase:s=null}={}){return t.map(t=>{const n=$e(t.temperature),a=$e(t.precipitation_probability),r=new Date(t.datetime),l=Number.isNaN(r.getTime())?"":r.toLocaleTimeString(e,{hour:"numeric"});return I`
      <div class="hour">
        <span class="h-temp">${null!=n?`${n}°`:"—"}</span>
        <svg class="h-glyph" viewBox="0 0 24 24">${_e(t.condition,s)}</svg>
        ${i&&null!=a&&a>=o?I`<span class="h-precip">${a}%</span>`:I`<span class="h-precip empty"></span>`}
        <span class="h-time">${l}</span>
      </div>
    `})}customElements.define("materia-weather-hero",we),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-hero",name:"Materia Weather Hero",description:"Current-conditions hero: condition, huge temperature, feels-like and night/day range.",preview:!0});const Ce=n`
  .hours {
    display: flex;
    gap: 4px;
    overflow-x: auto;
...
`,Se=[yt,bt,vt,gt,Ce,n`
        ...
        >
          ${i.map((t,e)=>{const i=this._num(t.temperature),n=this._num(t.templow),a=this._num(t.precipitation_probability),r=e===this._selected,l=!1!==this.config.show_hourly&&this._hoursFor(t).length>0;return I`
              ...
              >
                ...
                <svg class="glyph" viewBox="0 0 24 24">${_e(t.condition,se(this.hass,this.config.moon_entity))}</svg>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-daily",Ae),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-daily",name:"Materia Forecast Daily",description:"Pixel-style daily forecast pill row with colored glyphs and precipitation chance.",preview:!0});customElements.define("materia-forecast-hourly-editor",class extends Ot{_formData(){return{hours:24,show_header:!0,show_precipitation:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"name",label:"Header title",selector:{text:{}}},{name:"show_header",label:"Show header",selector:{boolean:{}}},{name:"hours",label:"Hours shown",selector:{number:{min:6,max:48,step:1,mode:"slider"}}},{name:"show_precipitation",label:"Show precipitation chance",selector:{boolean:{}}},{name:"min_precipitation",label:"Hide below (%)",selector:{number:{min:0,max:100,step:5,mode:"box"}}}]}]}});class Me extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0}};static styles=Se;static getConfigElement(){return document.createElement("materia-forecast-hourly-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&this._subscribeForecast()}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_onPointerDown(t){if("mouse"!==t.pointerType)return;const e=t.currentTarget;this._dragStartX=t.clientX,this._dragStartScroll=e.scrollLeft,this._captured=!1,this._dragPointerId=t.pointerId}_onPointerMove(t){if(null==this._dragStartX)return;const e=t.clientX-this._dragStartX;!this._captured&&Math.abs(e)>4&&(this._captured=!0,t.currentTarget.setPointerCapture(this._dragPointerId)),this._captured&&(t.currentTarget.scrollLeft=this._dragStartScroll-e)}_onPointerUp(t){null!=this._dragStartX&&(t.currentTarget.releasePointerCapture?.(t.pointerId),this._dragStartX=null)}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=(this._forecast||[]).slice(0,this.config.hours??24);if(!i.length)return I``;const o=this.hass?.locale?.language||navigator.language||"en";return I`
      <ha-card class="${e?"unavailable":""}">
        ...
        <div
          ...
          @pointercancel=${this._onPointerUp}
        >
          ${ke(i,{locale:o,showPrecip:!1!==this.config.show_precipitation,minPrecip:this.config.min_precipitation??10,moonPhase:se(this.hass,this.config.moon_entity)})}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-hourly",Me),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-hourly",name:"Materia Forecast Hourly",description:"Pixel-style hourly forecast strip with colored glyphs and precipitation chance.",preview:!0});const Te=[yt,bt,vt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Fe=[{value:"wind",label:"Wind"},{value:"uv",label:"UV index"},{value:"aqi",label:"Air quality"},{value:"pollen",label:"Pollen"},{value:"precipitation",label:"Precipitation"},{value:"sun",label:"Sunrise & sunset"},{value:"visibility",label:"Visibility"},{value:"humidity",label:"Humidity"},{value:"pressure",label:"Pressure"}];customElements.define("materia-weather-metric-editor",class extends Ot{_formData(){return{metric:"wind",...this._config}}_sectionsSignature(){return this._config?.metric||""}get _sections(){const t=this._config?.metric,e={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"metric",required:!0,selector:{select:{mode:"dropdown",options:Fe}}},..."sun"!==t&&"pollen"!==t?[{name:"entity",label:"Weather entity",selector:{entity:{domain:"weather"}}},{name:"sensor",label:"Sensor override (optional)",selector:{entity:{domain:"sensor"}}}]:[],{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon (overrides default)",selector:{icon:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"wind"===t&&i.fields.push({name:"unit",label:"Unit (converts from the source)",selector:{select:{mode:"dropdown",options:[{value:"km/h",label:"km/h"},{value:"m/s",label:"m/s"},{value:"mph",label:"mph"},{value:"kn",label:"knots"},{value:"bft",label:"Beaufort"}]}}},{name:"bearing_entity",label:"Bearing sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"from_label",label:'"From" label',selector:{text:{}}}),"humidity"===t&&i.fields.push({name:"dew_entity",label:"Dew point sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"dew_label",label:"Dew point label",selector:{text:{}}}),"pressure"===t&&i.fields.push({name:"min",label:"Gauge min",selector:{number:{mode:"box"}}},{name:"max",label:"Gauge max",selector:{number:{mode:"box"}}}),"precipitation"===t&&i.fields.push({name:"total_label",label:"Subtitle when raining",selector:{text:{}}},{name:"none_label",label:'"None expected" label',selector:{text:{}}}),"sun"===t&&i.fields.push({name:"sun_entity",label:"Sun entity",selector:{entity:{domain:"sun"}}},{name:"moon_entity",label:"Moon phase sensor (built-in Moon integration)",selector:{entity:{domain:"sensor"}}}),"pollen"===t&&i.fields.push({name:"entities",label:"Pollen sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"variant",label:"Variant",selector:{select:{mode:"dropdown",options:[{value:"gauges",label:"Gauges (wide)"},{value:"small",label:"Small (dot list)"}]}}},{name:"max_shown",label:"Max species shown (worst first)",selector:{number:{min:1,max:6,step:1,mode:"slider"}}},{name:"hide_inactive",label:"Hide species at 'none'",selector:{boolean:{}}},{name:"max",label:"Scale max for numeric sensors (default 4)",selector:{number:{min:1,max:10,mode:"box"}}});const o={title:"Appearance",icon:"mdi:palette-outline",fields:[..."wind"===t?[{name:"shape_color",label:"Shape color",color:!0,template:!0,selector:{text:{}}}]:[],{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},s={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[e,i,o,s]:[e,o,s]}});const ze="var(--md-sys-cust-color-scale-green, #5E9E50)",Oe="var(--md-sys-cust-color-scale-yellow, #C7A128)",Ue="var(--md-sys-cust-color-scale-orange, #D9713C)",Pe="var(--md-sys-cust-color-scale-red, #C94D42)",qe="var(--md-sys-cust-color-scale-purple, #8A4DA3)",De=[{max:2,label:"Low",color:ze},{max:5,label:"Moderate",color:Oe},{max:7,label:"High",color:Ue},{max:10,label:"Very high",color:Pe},{max:1/0,label:"Extreme",color:qe}],Re=[{max:50,label:"Good air quality",color:ze},{max:100,label:"Moderate air quality",color:Oe},{max:150,label:"Unhealthy for sensitive groups",color:Ue},{max:200,label:"Unhealthy air quality",color:Pe},{max:300,label:"Very unhealthy air quality",color:qe},{max:1/0,label:"Hazardous air quality",color:"var(--md-sys-cust-color-scale-maroon, #7A4040)"}],je=["None","Low","Moderate","High","Very high"];class Be extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=Te;static getConfigElement(){return document.createElement("materia-weather-metric-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e,metric:"wind"}}setConfig(t){if(!t.metric)throw new Error("metric is required");this.config={...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),"precipitation"!==this.config.metric||this.config.sensor?this._unsubForecast():this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){"precipitation"!==this.config?.metric||this.config.sensor||this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}_value(t){if(this.config.sensor){const t=this.hass.states[this.config.sensor];return t&&!this._isUnavailable(t)?this._numRaw(t.state):null}const e=this.hass.states[this.config.entity];return this._numRaw(e?.attributes?.[t])}_weatherAttr(t){return this.hass.states[this.config.entity]?.attributes?.[t]}_scallopWave(t){const e=200/12;let i=`M0 ${t+3.2} `;for(let o=0;o<200;o+=e)i+=`Q ${o+e/2} ${t-3.2} ${o+e} ${t+3.2} `;return i+"V100 H0 Z"}render(){if(!this.hass||!this.config)return I``;const t={wind:()=>this._wind(),uv:()=>this._uv(),aqi:()=>this._aqi(),pollen:()=>this._pollen(),precipitation:()=>this._precipitation(),sun:()=>this._sun(),visibility:()=>this._visibility(),humidity:()=>this._humidity(),pressure:()=>this._pressure()}[this.config.metric];if(!t)return I``;const e=t();if(e===W)return I``;const i=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,o=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,s=null!=this.config.size?Math.min(10,Math.max(1,this.config.size)):null;return I`
    ...
    `}_uv(){const t=this._value("uv_index");if(null==t)return W;const e=De.find(e=>t<=e.max),i=De.map((t,i)=>{const o=(160-35*i)*Math.PI/180,s=50+33*Math.cos(o),n=52+33*Math.sin(o),a=t===e;return H`<circle cx=${s} cy=${n} r=${a?4.5:2.6}
    ...
    `}_pressure(){const t=this._value("pressure");if(null==t)return W;const e=this.config.unit??this._weatherAttr("pressure_unit")??"hPa",i=this.config.min??("hPa"===e?950:28),o=this.config.max??("hPa"===e?1050:31),s=Math.min(1,Math.max(0,(t-i)/(o-i))),n=270*s-135,a=this.hass?.locale?.language||navigator.language||"en",r="hPa"===e?Math.round(t).toLocaleString(a):t;return I`
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          <circle cx="50" cy="52" r="45" class="shape-fill-c" />
          <path d=${ie(50,52,37.5,-135,135)} class="gauge-track thin" />
          ${s>.01?H`<path d=${ie(50,52,37.5,-135,n)} class="gauge-fill thin" />`:""}
        </svg>
        <div class="overlay">
    ...
    `}_aqi(){const t=this._value("air_quality_index");if(null==t)return this.config.sensor?W:this._hint("mdi:waves",this.config.name??"Air quality","Point this tile at an AQI sensor");const e=Re.find(e=>t<=e.max),i=Math.min(.96,Math.max(.04,t/300));return I`
      <div class="rect-tile left">
        ${this._header("mdi:waves",this.config.name??"Air quality")}
        <div class="big">${Math.round(t)}</div>
        <div class="aqi-bar">
          ${Re.slice(0,5).map(t=>I`<span style="background:${t.color}"></span>`)}
          <span style="background:${Re[5].color}"></span>
    ...
    `}_precipitation(){let t=null;if(this.config.sensor)t=this._value();else{const e=this._forecast?.[0];t=this._numRaw(e?.precipitation)}if(null==t)return W;const e=this.config.unit??this._weatherAttr("precipitation_unit")??"mm",i=this.config.none_label??"No precipitation expected",o=t>0?this.config.total_label??"Total rain for the day":i;return I`
      <div class="rect-tile precip">
        ...
        <div class="precip-bottom">
          <div class="sub">${o}</div>
          ${t>0?H`<svg class="precip-glyph" viewBox="0 0 24 24">${_e("rainy")}</svg>`:""}
        </div>
      </div>
    ...
    `}_sun(){const t=this.hass.states[this.config.sun_entity??"sun.sun"];if(!t)return W;const e=t.attributes?.next_rising,i=t.attributes?.next_setting;if(!e||!i)return W;const o=this.hass?.locale?.language||navigator.language||"en",s=t=>new Date(t).toLocaleTimeString(o,{hour:"numeric",minute:"2-digit"}),n=t=>t.getHours()+t.getMinutes()/60,a=n(new Date(e)),r=n(new Date(i)),l=n(new Date),c=(r-a+24)%24||12,d=24-c,h=24,p=t=>t/24*100,u=t=>{const e=(t-a+24)%24;return e<=c?h-17*Math.sin(Math.PI*e/c):h+9*Math.sin(Math.PI*(e-c)/d)},m=(t,e)=>{const i=[];for(let o=t;o<e;o+=.25)i.push(`${p(o).toFixed(2)} ${u(o).toFixed(2)}`);return i.push(`${p(e).toFixed(2)} ${u(e).toFixed(2)}`),i.join(" L")},g=`M${p(a).toFixed(2)} 24 L${m(a,r)} Z`,f=a>.01?`M0 24 L${m(0,a)} Z`:"",_=r<23.99?`M${p(r).toFixed(2)} 24 L${m(r,24)} L100 24 Z`:"",b=(l-a+24)%24<=c,v=p(l),y=u(l),x=this.config.moon_entity??(this.hass.states["sensor.moon_phase"]?"sensor.moon_phase":"sensor.moon"),w=this.hass.states[x],$=se(this.hass,this.config.moon_entity),k=$??.5;return I`
      <div class="rect-tile sun">
        ...
        <svg class="sun-arc cycle" viewBox="0 0 100 40">
          ...
          ${b?H`<path d=${function(t,e,i,o=12,s=.1*i,n=0){const a=Math.max(8*o,48),r=[];for(let l=0;l<a;l++){const c=l/a*Math.PI*2,d=i+s*Math.cos(o*c+n);r.push([t+d*Math.cos(c),e+d*Math.sin(c)])}let l=`M${r[0][0].toFixed(2)} ${r[0][1].toFixed(2)} `;for(let t=0;t<a;t++){const e=r[(t-1+a)%a],i=r[t],o=r[(t+1)%a],s=r[(t+2)%a],n=i[0]+(o[0]-e[0])/6,c=i[1]+(o[1]-e[1])/6,d=o[0]-(s[0]-i[0])/6,h=o[1]-(s[1]-i[1])/6;l+=`C${n.toFixed(2)} ${c.toFixed(2)} ${d.toFixed(2)} ${h.toFixed(2)} ${o[0].toFixed(2)} ${o[1].toFixed(2)} `}return l+"Z"}(v,y,5.5,9,.6)} fill="var(--md-sys-cust-color-weather-sun, #FFC83D)" />`:H`
                ...
                ${oe(v,y,4.6,k)?H`<path d=${oe(v,y,4.6,k)} class="moon-lit" />`:""}
              `}
        </svg>
        <div class="sun-times">
          ...
          ${o.map(t=>I`
              <div class="gauge">
                <svg viewBox="0 0 100 86">
                  <path d=${ie(50,50,40,-135,135)} class="gauge-track" />
                  ${t.frac>.01?H`<path d=${ie(50,50,40,-135,270*t.frac-135)} class="gauge-fill" style="stroke:${t.color||"var(--wm-accent, #7bc96a)"}" />`:""}
                </svg>
    ...
    `}getGridOptions(){const t="pollen"===this.config?.metric&&"small"!==this.config?.variant;return{columns:t?8:4,rows:"auto",min_columns:t?6:3}}getCardSize(){return 3}}customElements.define("materia-weather-metric",Be),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-metric",name:"Materia Weather Metric",description:"Expressive weather metric tiles: wind, UV, AQI, pollen, precipitation, sun, visibility, humidity, pressure.",preview:!0});const Le=[yt,bt,vt,gt,n`
    :host {
      display: block;
      height: 100%;
    }
  ...
  `],customElements.define("materia-weather-glance-editor",Ie);const He={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class Ve extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedAlert:{state:!0}};static styles=Le;static getConfigElement(){return document.createElement("materia-weather-glance-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("weather."))||"";return{entity:e,metrics:["minmax"]}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={metrics:["minmax"],...t},this._fcEntity=void 0}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("alert","_resolvedAlert"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const t=this.config?.entity;if(!this.hass||!t||this._fcEntity===t)return;this._unsubForecast(),this._fcEntity=t,this._forecast=[];const e=this.hass.connection.subscribeMessage(t=>{this._forecast=t?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:t});this._fcUnsub=e,e.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(t=>t&&t()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}_metricData(t,e){const i=e?.attributes||{},o=this._forecast?.[0]||i.forecast?.[0];let s=null,n=0;switch(t.type){case"condition":{const t=e?.state??"";s=He[t]||this._capitalize(String(t).replace(/-|_/g," ")),/lightning/.test(t)?n=3:/pouring|snowy|hail/.test(t)?n=2:/rainy|fog|windy/.test(t)&&(n=1);break}case"minmax":{const t=this._num(o?.temperature),e=this._num(o?.templow);if(null==t&&null==e)return null;s=`${null!=t?`${t}°`:"—"} ${null!=e?`${e}°`:"—"}`;break}case"wind":{const t=this._num(i.wind_speed);if(null==t)return null;const e=this._num(i.wind_bearing);s=`${t} ${i.wind_speed_unit??"km/h"}${null!=e?` ${a=e,["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round((a%360+360)%360/22.5)%16]}`:""}`,n=t>=88?4:t>=62?3:t>=39?2:t>=20?1:0;break}case"humidity":{const t=this._num(i.humidity);if(null==t)return null;s=`${t}%`,n=t>=85||t<=20?2:t>=70||t<=30?1:0;break}case"uv":{const t=this._num(i.uv_index);if(null==t)return null;s=`UV ${t}`,n=t>=11?4:t>=8?3:t>=6?2:t>=3?1:0;break}case"precipitation":{const e=o?.precipitation,a=null==e?null:Number(e);if(null==a||!Number.isFinite(a))return null;s=`${t.label??"Rain"} ${a} ${i.precipitation_unit??"mm"}`,n=a>=10?3:a>=2?2:a>0?1:0;break}case"pressure":{const t=this._num(i.pressure);if(null==t)return null;s=`${t} ${i.pressure_unit??"hPa"}`,n=Math.abs(t-1013)>=25?2:Math.abs(t-1013)>=15?1:0;break}case"pollen":{const e={none:0,active:1,green:1,yellow:2,orange:3,red:4,purple:5},i=["None","Low","Low","Moderate","High","Very high","Extreme"],o=t.entities||this.config.pollen_entities||[];let a=null;for(const t of o){const i=this.hass.states[t];if(!i||this._isUnavailable(i))continue;const o=e[String(i.state).toLowerCase()]??this._num(i.state)??0;if(!a||o>a.v){const e=i.attributes.friendly_name||t,s=e.replace(/pollen/i,"").trim().split(/\s+/);a={v:o,label:s[s.length-1]||e}}}if(!a)return null;const r=t.label??this.config.pollen_label??"Pollen";s=0===a.v?this.config.no_pollen_label??`${r} none`:`${r} ${a.label} ${i[a.v+1]??a.v}`,n=a.v;break}case"aqi":{const e=t.entity??this.config.aqi_entity,i=e?this.hass.states[e]:null;if(!i||this._isUnavailable(i))return null;const o=this._num(i.state);if(null==o)return null;s=`AQI ${o}`,n=o>200?4:o>150?3:o>100?2:o>50?1:0;break}case"sensor":{const e=t.entity?this.hass.states[t.entity]:null;if(!e||this._isUnavailable(e))return null;const i=t.unit??e.attributes.unit_of_measurement??"";s=`${t.label?`${t.label} `:""}${e.state}${i?` ${i}`:""}`;break}default:return null}var a;null!=t.severity&&(n=Number(t.severity)||0);return{text:s,sev:n,icon:t.icon??(this.config.show_metric_icons?{minmax:"mdi:thermometer",wind:"mdi:weather-windy",humidity:"mdi:water-percent",uv:"mdi:white-balance-sunny",precipitation:"m3o:rainy",pressure:"mdi:gauge",pollen:"m3of:allergy",aqi:"mdi:waves",sensor:"mdi:information-outline"}[t.type]:null),type:t.type}}_metricItems(t){const e=this.config.priority??["precipitation","pollen","aqi"],i=t=>{const i=e.indexOf(t);return-1===i?0:(e.length-i)/(e.length+1)},o=(this.config.metrics||[]).map(t=>"string"==typeof t?{type:t}:t).filter(t=>"condition"!==t.type),s=o.map(e=>this._metricData(e,t)).filter(Boolean);return this.config.sort_by_severity&&s.sort((t,e)=>e.sev+i(e.type)-(t.sev+i(t.type))),s}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=t?.state??"";let o=t?.attributes?.temperature;if(this.config.temperature_entity){const t=this.hass.states[this.config.temperature_entity];t&&!this._isUnavailable(t)&&(o=t.state)}const s=this._num(o),n=this._isTemplate(this.config.alert)?this._resolvedAlert:this.config.alert,a=n?null:this._metricData({type:"condition"},t),r=this.config.max_metrics??1/0,l=this._metricItems(t).slice(0,r),c=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,d=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,h=this.config.show_chevron??"navigate"===this.config.tap_action?.action,p=t=>I`<span class="m">
      ...
      <ha-card>
        <div
          ...
          @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info"})}
        >
          <svg class="glyph" viewBox="0 0 24 24">${_e(i,se(this.hass,this.config.moon_entity))}</svg>
          <div class="mid">
    ...
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-weather-glance",Ve),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-glance",name:"Materia Weather Glance",description:"Weather pill for the home screen: glyph, configurable metric lines or an alert, big temperature.",preview:!0});const We=[yt,bt,vt,gt,n`
    ha-card {
      border-radius: 24px;
      padding: 16px 20px;
  ...
  `];customElements.define("materia-list-editor",class extends Ot{get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"title",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon",selector:{icon:{}}},{name:"entities",label:"Entities (rows)",selector:{entity:{multiple:!0}}}]}]}});class Xe extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0}};static styles=We;static getConfigElement(){return document.createElement("materia-list-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("sensor."))||"";return{entities:e?[e]:[]}}setConfig(t){if(!t.entities?.length)throw new Error("Materia List: add at least one entity");this.config={...t}}_rowState(t,e){if(!e)return"—";if(t.attribute){const i=e.attributes?.[t.attribute];return null==i?"—":`${i}${t.unit?` ${t.unit}`:""}`}if(this._isUnavailable(e))return this.hass.formatEntityState?.(e)??e.state;if(t.unit){const i=Number(e.state);return Number.isFinite(i)?`${i} ${t.unit}`:e.state}return this.hass.formatEntityState?.(e)??e.state}render(){if(!this.hass||!this.config)return I``;const t=(this.config.entities||[]).map(t=>"string"==typeof t?{entity:t}:t);return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1+(this.config?.entities?.length||0)}}customElements.define("materia-list",Xe),window.customCards=window.customCards||[],window.customCards.push({type:"materia-list",name:"Materia List",description:"Entity rows with localized states — name left, value right, optional header.",preview:!0});const Ge=[yt,bt,vt,gt,n`
  ...
  `];customElements.define("materia-switch-editor",class extends Ot{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",label:"Name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"secondary",label:"Secondary text / template",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Row color (e.g. escalate from state)",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon color",color:!0,template:!0,selector:{text:{}}},{name:"switch_color",label:"Switch track color when on",color:!0,template:!0,selector:{text:{}}},{name:"switch_color_on",label:"Switch thumb color when on",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}}]}]}});class Ye extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedSecondary:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedSwitchColor:{state:!0},_resolvedSwitchColorOn:{state:!0}};static styles=Ge;static getConfigElement(){return document.createElement("materia-switch-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("switch.")||t.startsWith("input_boolean."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("Materia Switch: entity is required");this.config=t}updated(t){t.has("hass")&&this.hass&&(this._resolveField("secondary","_resolvedSecondary"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("switch_color","_resolvedSwitchColor"),this._resolveField("switch_color_on","_resolvedSwitchColorOn"))}get _stateObj(){return this.hass?.states[this.config.entity]}get _on(){return"on"===this._stateObj?.state}_tap(){this._handleAction(this.config.tap_action||{action:"toggle",entity:this.config.entity}),this._fireHaptic("light")}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(!t)return I`<ha-card class="row off">Unknown entity: ${this.config.entity}</ha-card>`;const e=this._on,i=this._isUnavailable(t),o=this.config.name||t.attributes.friendly_name||this.config.entity,s=this.config.icon||t.attributes.icon||(e?"mdi:toggle-switch":"mdi:toggle-switch-off-outline"),n=this.config.secondary?this._isTemplate(this.config.secondary)?this._resolvedSecondary:this.config.secondary:this.hass.formatEntityState?.(t)??t.state,a=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,r=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on,l=this._isTemplate(this.config.switch_color)?(this._resolvedSwitchColor||"").trim():this.config.switch_color,c=this._isTemplate(this.config.switch_color_on)?(this._resolvedSwitchColorOn||"").trim():this.config.switch_color_on;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:1}}getCardSize(){return 1}}customElements.define("materia-switch",Ye),window.customCards=window.customCards||[],window.customCards.push({type:"materia-switch",name:"Materia Switch",description:"Toggle row with a spec M3 switch — templatable secondary text and state-driven colors.",preview:!0});const Ke=[yt,bt,vt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Ze=[{value:"percent",label:"Percent (filling cookie)"},{value:"battery",label:"Battery (vertical bar)"},{value:"temperature",label:"Temperature (thermometer)"},{value:"power",label:"Power (load bars)"},{value:"energy",label:"Energy"},{value:"binary",label:"On/off (spinning star)"},{value:"plain",label:"Plain value"},{value:"vacuum",label:"Robot vacuum (state + room + battery bar)"}];customElements.define("materia-glance-tile-editor",class extends Ot{_formData(){return{variant:"percent",...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){const t=this._config?.variant,e={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"variant",label:"Category",required:!0,selector:{select:{mode:"dropdown",options:Ze}}},{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Icon (overrides entity icon)",selector:{icon:{}}},{name:"label",label:"Subtitle",selector:{text:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"temperature"===t&&i.fields.push({name:"min",label:"Scale min (default 10°)",selector:{number:{mode:"box"}}},{name:"max",label:"Scale max (default 30°)",selector:{number:{mode:"box"}}}),"power"===t&&i.fields.push({name:"max",label:"Full-load watts (default 3000)",selector:{number:{mode:"box"}}}),"plain"===t&&i.fields.push({name:"battery_entity",label:"Paired battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"vacuum"===t&&i.fields.push({name:"status_entity",label:"Detailed status sensor (shown as the state)",selector:{entity:{domain:"sensor"}}},{name:"room_entity",label:"Current room sensor (shown while cleaning)",selector:{entity:{domain:"sensor"}}},{name:"battery_entity",label:"Battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"percent"===t&&i.fields.push({name:"critical_dry",label:"Critical dry, ≤% (default 10 — red)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_below",label:"Water soon, ≤% (default 20 — orange)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"soggy_above",label:"Overwatered, >% (default 60 — blue)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_label",label:'"Needs water now" label',selector:{text:{}}},{name:"soon_label",label:'"Water soon" label',selector:{text:{}}},{name:"optimal_label",label:'"Optimal" label',selector:{text:{}}},{name:"wet_label",label:'"Overwatered" label',selector:{text:{}}});const o={title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Accent color (fill / bars / star)",color:!0,selector:{text:{}}},{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},s={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[e,i,o,s]:[e,o,s]}});const Qe="var(--md-sys-cust-color-weather-rain, #5fa8f5)",Je="var(--md-sys-cust-color-scale-green, #5E9E50)",ti="var(--md-sys-cust-color-scale-orange, #D9713C)",ei="var(--md-sys-cust-color-scale-red, #C94D42)",ii=["on","open","running","playing","heat","heating","home","true","active"];class oi extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedLabel:{state:!0}};static styles=Ke;static getConfigElement(){return document.createElement("materia-glance-tile-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("sensor."))||"";return{entity:e,variant:"percent"}}setConfig(t){if(!t.entity)throw new Error("Materia Glance Tile: entity is required");if(!t.variant)throw new Error("Materia Glance Tile: variant is required — pick the value category");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("label","_resolvedLabel"))}get _label(){return this._isTemplate(this.config.label)?this._resolvedLabel:this.config.label}get _stateObj(){return this.hass?.states[this.config.entity]}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _unit(){return this.config.unit??this._stateObj?.attributes?.unit_of_measurement??""}get _name(){return this.config.name??this._stateObj?.attributes?.friendly_name??this.config.entity}_icon(t){return this.config.icon||this._stateObj?.attributes?.icon||t}get _variant(){return this.config.variant}_fmtState(){const t=this._stateObj;return this.hass.formatEntityState?.(t)??t.state}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(!t||this._isUnavailable(t))return I`<ha-card><div class="rect-tile unavailable">
    ...
    `}_header(t){return I`<div class="header"><ha-icon icon=${this._icon(t)}></ha-icon><span>${this._name}</span></div>`}_moistureZone(t){const e=this.config.critical_dry??10,i=this.config.dry_below??20,o=this.config.soggy_above??60;return t<=e?{fill:ei,status:this.config.dry_label??"Needs water now"}:t<=i?{fill:ti,status:this.config.soon_label??"Water soon"}:t<=o?{fill:Je,status:this.config.optimal_label??"Optimal"}:{fill:Qe,status:this.config.wet_label??"Overwatered"}}_percent(){const t=this._num(this._stateObj.state);if(null==t)return this._plain();const e=Math.min(1,Math.max(0,t/100)),i=this._stateObj.attributes.device_class,o="moisture"===i;let s=null,n=null;if("battery"===i)s=e>.4?Je:e>.15?ti:ei;else if(o){const e=this._moistureZone(t);s=e.fill,n=e.status}else"humidity"===i&&(s=Qe);s&&(s=`color-mix(in srgb, ${s} 30%, transparent)`);const a=100-100*e,r="humidity"===i||o;let l;if(r){let t=`M-100 ${a.toFixed(1)}`;for(let e=-100;e<100;e+=25){t+=` Q ${e+12.5} ${(a+(e/25%2==0?-1.6:1.6)).toFixed(1)} ${e+25} ${a.toFixed(1)}`}l=t+" V102 H-100 Z"}else l=`M-2 ${a+2.5} Q 50 ${a-2.5} 102 ${a+2.5} V102 H-2 Z`;const c="battery"===i?"mdi:battery":o?"mdi:sprout":"mdi:water-percent";return I`
    ...
    `}_tempColor(t,e){const i="°F"===e?5*(t-32)/9:t;return i<16?Qe:i<23?Je:i<27?ti:ei}_temperature(){const t=this._num(this._stateObj.state);if(null==t)return this._plain();const e=this._unit||"°C",i=this.config.min??("°F"===e?50:10),o=this.config.max??("°F"===e?86:30),s=Math.min(1,Math.max(0,(t-i)/(o-i))),n=this._tempColor(t,e);return I`
      <div class="rect-tile left">
    ...
    `}_batteryColor(t){return t>.4?Je:t>.15?ti:ei}_battery(){const t=this._num(this._stateObj.state);if(null==t)return this._plain();const e=Math.min(1,Math.max(0,t/100)),i=this._batteryColor(e);return I`
      <div class="rect-tile left">
    ...
    `}_binary(){const t=ii.includes(this._stateObj.state),e=Kt(50,50,46,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2});return I`
    ...
    `}getGridOptions(){return{columns:4,rows:"auto",min_columns:3}}getCardSize(){return 3}}customElements.define("materia-glance-tile",oi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-glance-tile",name:"Materia Glance Tile",description:"Expressive view-only sensor tile — percent fill, thermometer, power bars, spinning pump star, and a graceful fallback.",preview:!0});const si=[yt,bt,vt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-hero-editor",class extends Ot{_formData(){return{burst:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",label:"Eyebrow text",selector:{text:{}}},{name:"icon",label:"Eyebrow icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"title",label:"Big title (defaults to the state)",template:!0,selector:{text:{}}},{name:"value",label:"Headline number (defaults to the state)",template:!0,selector:{text:{}}},{name:"unit",label:"Unit after the number",selector:{text:{}}},{name:"caption",label:"Caption beside the number",template:!0,selector:{text:{}}},{name:"secondary",label:"Sub-line",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"active_state",label:"State(s) that count as active",selector:{text:{}}},{name:"burst",label:"Show the turning burst",selector:{boolean:{}}},{name:"active_color",label:"Background while active",color:!0,template:!0,selector:{text:{}}},{name:"active_color_on",label:"Text while active",color:!0,template:!0,selector:{text:{}}},{name:"color",label:"Background at rest",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text at rest",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const ni={vacuum:"cleaning",light:"on",switch:"on",fan:"on",input_boolean:"on",lock:["locked","locking"],cover:"open",climate:"heat",media_player:"playing",binary_sensor:"on"};class ai extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedTitle:{state:!0},_resolvedValue:{state:!0},_resolvedCaption:{state:!0},_resolvedSecondary:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedActiveColor:{state:!0},_resolvedActiveColorOn:{state:!0}};static styles=si;static getConfigElement(){return document.createElement("materia-hero-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("sensor."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("Materia Hero: entity is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("title","_resolvedTitle"),this._resolveField("value","_resolvedValue"),this._resolveField("caption","_resolvedCaption"),this._resolveField("secondary","_resolvedSecondary"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("active_color","_resolvedActiveColor"),this._resolveField("active_color_on","_resolvedActiveColorOn"),this._alertList().forEach((t,e)=>{null!=t.text&&this._resolveTemplateValue(`alertText${e}`,t.text)}))}_alertList(){return Array.isArray(this.config.alerts)?this.config.alerts:this.config.alert?[this.config.alert]:[]}_idle(t){return["off","idle","unknown","unavailable","false","0","none","","ok","docked"].includes(String(t??"").toLowerCase())}_alertText(t,e){if(null==e.text)return"";const i=this._isTemplate(e.text)?this._tplResults?.[`alertText${t}`]:e.text;return null==i?"":String(i).trim()}get _activeAlert(){const t=this._alertList();for(let e=0;e<t.length;e++){const i=t[e],o=this._alertText(e,i);if(i.entity){const t=this.hass?.states[i.entity];if(!t)continue;const e=String(t.state);if(null!=i.state){if(!(Array.isArray(i.state)?i.state.map(String):[String(i.state)]).includes(e))continue}else if(this._idle(e))continue;return{...i,text:o||(this.hass.formatEntityState?.(t)??e)}}if(o)return{...i,text:o}}return null}_field(t,e){const i=this.config[t];if(null==i)return null;const o=this._isTemplate(i)?this[e]:i;return null==o||""===o?null:o}get _stateObj(){return this.hass?.states[this.config.entity]}_isActive(t){if(!t)return!1;const e=t.entity_id.split(".")[0],i=this.config.active_state??ni[e]??"on";return(Array.isArray(i)?i:[i]).some(e=>String(e)===t.state)}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj,e=this._isUnavailable(t),i=!e&&this._isActive(t),o=this.config.name??t?.attributes?.friendly_name??this.config.entity,s=this.config.icon??t?.attributes?.icon,n=this._field("title","_resolvedTitle")??(t?this.hass.formatEntityState?.(t)??t.state:"—");let a=this._field("value","_resolvedValue");if(null==a&&t){const e=this._num(t.state);null!=e&&(a=String(Math.round(e)))}const r=this.config.unit??(null!=a?t?.attributes?.unit_of_measurement:null),l=this._field("caption","_resolvedCaption"),c=this._field("secondary","_resolvedSecondary"),d=this._activeAlert,h=d?.color||"var(--md-sys-cust-color-error-container, var(--md-sys-color-error-container))",p=d?.color_on||"var(--md-sys-cust-color-on-error-container, var(--md-sys-color-on-error-container))",u=d&&!1!==this.config.alert_tints_hero,m=u?h:i?this._field("active_color","_resolvedActiveColor")??"var(--md-sys-cust-color-device, var(--md-sys-color-primary-container))":this._field("color","_resolvedColor")??"var(--md-sys-color-secondary-container)",g=u?p:i?this._field("active_color_on","_resolvedActiveColorOn")??"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-primary-container))":this._field("color_on","_resolvedColorOn")??"var(--md-sys-color-on-secondary-container)",f=te(90,90,86),_=Jt(90,90,88);return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}customElements.define("materia-vacuum-hero",mi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-vacuum-hero",name:"Materia Vacuum Hero",description:"Robot-vacuum headline — derived ETA, negated working states, and mop/consumable warnings. Roborock and Ecovacs.",preview:!0});const gi=[yt,bt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-chips-editor",class extends Ot{_formData(){return{show_check:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",label:"Entity holding the selection",selector:{entity:{}}},{name:"attribute",label:"Attribute (instead of the state)",selector:{text:{}}},{name:"multi_select",label:"Multi-select (state is a comma-separated list)",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"show_check",label:"Show the check on selected chips",selector:{boolean:{}}},{name:"color",label:"Selected chip color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Selected chip text",color:!0,template:!0,selector:{text:{}}}]}]}});class fi extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=gi;static getConfigElement(){return document.createElement("materia-chips-editor")}static getStubConfig(){return{chips:[{label:"Chip 1",value:"one"},{label:"Chip 2",value:"two"}]}}setConfig(t){if(!t.chips?.length)throw new Error("Materia Chips: at least one chip is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"))}get _stateObj(){return this.config.entity?this.hass?.states[this.config.entity]:null}get _current(){const t=this._stateObj;return t?this.config.attribute?t.attributes?.[this.config.attribute]:t.state:null}get _selected(){const t=this._current;return null==t||"unknown"===t||"unavailable"===t?[]:Array.isArray(t)?t.map(t=>String(t).trim()):this.config.multi_select?String(t).split(",").map(t=>t.trim()).filter(Boolean):[String(t)]}_chips(){return(this.config.chips||[]).map(t=>"string"==typeof t?{label:t,value:t}:t)}_tap(t){if(this._fireHaptic?.("light"),t.tap_action)return void this._handleAction(t.tap_action);const e=this._stateObj,i=e?.entity_id?.split(".")[0],o=t.value??t.label;"select"!==i&&"input_select"!==i||null==o||this._callService(i,"select_option",{entity_id:e.entity_id,option:String(o)})}render(){if(!this.hass||!this.config)return I``;const t=this._selected,e=(this._isTemplate(this.config.color)?this._resolvedColor:this.config.color)||"var(--md-sys-cust-color-device, var(--md-sys-color-secondary-container))",i=(this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on)||"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-secondary-container))",o=!1!==this.config.show_check;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-chips",fi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-chips",name:"Materia Chips",description:"M3 filter chips — wrapping, single or multi-select, with a check that slides in when chosen.",preview:!0});const _i=[yt,bt,vt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-bar-select-editor",class extends Ot{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",selector:{text:{}}},{name:"attribute",label:"Attribute (e.g. fan_speed) instead of the state",selector:{text:{}}},{name:"off_option",label:'Option shown as its own round button (e.g. "off")',selector:{text:{}}},{name:"off_icon",label:"Icon for that button",selector:{icon:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Lit bar color",color:!0,template:!0,selector:{text:{}}},{name:"accent_on",label:"Glyph color on the accent fill",color:!0,template:!0,selector:{text:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]}]}});class bi extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedAccent:{state:!0},_resolvedAccentOn:{state:!0}};static styles=_i;static getConfigElement(){return document.createElement("materia-bar-select-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("select."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("Materia Bar Select: entity is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("accent","_resolvedAccent"),this._resolveField("accent_on","_resolvedAccentOn"));const e=this._index;null!=this._prevIndex&&e!==this._prevIndex&&this._choreograph(this._prevIndex,e),this._prevIndex=e}get _stateObj(){return this.hass?.states[this.config.entity]}get _rungs(){const t=null!=this.config.off_option?String(this.config.off_option):null;return this._options.filter(e=>null==t||e!==t)}get _index(){return this._rungs.indexOf(String(this._current))}get _current(){const t=this._stateObj;if(!t)return null;const e=this.config.attribute?t.attributes?.[this.config.attribute]:t.state;return null==e?null:String(e)}get _options(){if(this.config.options?.length)return this.config.options.map(String);const t=this._stateObj;if(!t)return[];if(this.config.attribute){const e=t.attributes?.[`${this.config.attribute}_list`];return Array.isArray(e)?e.map(String):[]}const e=t.attributes?.options;return Array.isArray(e)?e.map(String):[]}_fmt(t){const e=this._stateObj;if(!this.config.attribute&&e&&String(e.state)===String(t)){const t=this.hass.formatEntityState?.(e);if(t)return t}const i=String(t).replace(/[_-]+/g," ");return i.charAt(0).toUpperCase()+i.slice(1)}_set(t){const e=this._stateObj;if(!e)return;const i=e.entity_id.split(".")[0];if(this._fireHaptic?.("light"),this.config.service){const[i,o]=String(this.config.service).split("."),s=this.config.service_key||this.config.attribute||"option";return void this._callService(i,o,{entity_id:e.entity_id,[s]:t})}if(this.config.attribute){const o=this.config.attribute;return void this._callService(i,`set_${o}`,{entity_id:e.entity_id,[o]:t})}"select"!==i&&"input_select"!==i||this._callService(i,"select_option",{entity_id:e.entity_id,option:t})}_choreograph(t,e){if(window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches)return;const i=Array.from(this.shadowRoot?.querySelectorAll(".bar")||[]);if(!i.length)return;const o=e>t,s=[];for(let o=Math.min(t,e)+1;o<=Math.max(t,e);o++)i[o]&&s.push(i[o]);const n=o?s:s.reverse(),a=o?[{transform:"scaleY(0.94)"},{transform:"scaleY(1.07)",offset:.5},{transform:"scaleY(1)"}]:[{transform:"scaleY(1)"},{transform:"scaleY(0.84)",offset:.5},{transform:"scaleY(0.94)"}];n.forEach((t,e)=>{t.animate(a,{duration:300,delay:45*e,easing:o?"cubic-bezier(.2,1.5,.3,1)":"cubic-bezier(.3,0,.2,1)",fill:"none"})})}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(!t||this._isUnavailable(t))return I`<ha-card><div class="tile unavailable">
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-bar-select",bi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bar-select",name:"Materia Bar Select",description:"Tap-a-bar level picker — climbing bars for fan speeds, mop levels, any ordered select.",preview:!0});const vi=[yt,bt,gt,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-carousel-editor",class extends Ot{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",label:"Entity holding the selection",selector:{entity:{}}},{name:"attribute",label:"Attribute (instead of the state)",selector:{text:{}}},{name:"multi_select",label:"Multi-select (state is a comma-separated list)",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Selected tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Selected tile text",color:!0,template:!0,selector:{text:{}}}]}]}});class yi extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=vi;static getConfigElement(){return document.createElement("materia-carousel-editor")}static getStubConfig(){return{items:[{label:"Item 1",value:"one"},{label:"Item 2",value:"two"}]}}setConfig(t){if(!t.items?.length)throw new Error("Materia Carousel: at least one item is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"))}get _stateObj(){return this.config.entity?this.hass?.states[this.config.entity]:null}get _current(){const t=this._stateObj;return t?this.config.attribute?t.attributes?.[this.config.attribute]:t.state:null}get _selected(){const t=this._current;return null==t||"unknown"===t||"unavailable"===t?[]:Array.isArray(t)?t.map(t=>String(t).trim()):this.config.multi_select?String(t).split(",").map(t=>t.trim()).filter(Boolean):[String(t)]}_items(){return(this.config.items||[]).map(t=>"string"==typeof t?{label:t,value:t}:t)}updated(t){super.updated?.(t);const e=new Set(this._selected.map(String));if(this._prevSel){const t=[...new Set([...e,...this._prevSel])].filter(t=>e.has(t)!==this._prevSel.has(t));t.length&&this._ripple(t,e)}this._prevSel=e}_ripple(t,e){if(window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches)return;const i=Array.from(this.shadowRoot?.querySelectorAll(".tile")||[]);if(!i.length)return;const o=this._items(),s=t.map(t=>o.findIndex(e=>String(e.value??e.label)===t)).filter(t=>t>=0);s.length&&i.forEach((t,e)=>{const i=Math.min(...s.map(t=>Math.abs(t-e)));if(i>2)return;const o=0===i?1.04:1===i?.985:.995,n=mt;t.animate([{transform:"scale(1)"},{transform:`scale(${o})`},{transform:"scale(1)"}],{duration:n.ms,delay:30*i,easing:n.easing,fill:"none"})})}_onPointerDown(t){this._stopMomentum(),"mouse"===t.pointerType&&(this._dragStartX=t.clientX,this._dragStartScroll=t.currentTarget.scrollLeft,this._captured=!1,this._didDrag=!1,this._dragPointerId=t.pointerId,this._lastX=t.clientX,this._lastT=performance.now(),this._velocity=0)}_onPointerMove(t){if(null==this._dragStartX)return;const e=t.clientX-this._dragStartX;if(!this._captured&&Math.abs(e)>4&&(this._captured=!0,this._didDrag=!0,t.currentTarget.setPointerCapture(this._dragPointerId)),!this._captured)return;t.currentTarget.scrollLeft=this._dragStartScroll-e;const i=performance.now(),o=i-this._lastT;if(o>0){const e=(this._lastX-t.clientX)/o;this._velocity=.7*this._velocity+.3*e,this._lastX=t.clientX,this._lastT=i}}_onPointerUp(t){if(null==this._dragStartX)return;const e=t.currentTarget;e.releasePointerCapture?.(t.pointerId),this._dragStartX=null,this._captured=!1,Math.abs(this._velocity)>.05&&this._startMomentum(e)}_startMomentum(t){let e=this._velocity,i=performance.now();const o=()=>{const s=performance.now(),n=Math.min(32,s-i);i=s;const a=t.scrollLeft;t.scrollLeft+=e*n,t.scrollLeft!==a?(e*=Math.pow(.95,n/16),this._raf=Math.abs(e)>.02?requestAnimationFrame(o):null):this._raf=null};this._raf=requestAnimationFrame(o)}_stopMomentum(){this._raf&&(cancelAnimationFrame(this._raf),this._raf=null)}disconnectedCallback(){super.disconnectedCallback(),this._stopMomentum()}_tap(t){if(this._didDrag)return void(this._didDrag=!1);if(this._fireHaptic?.("light"),t.tap_action)return void this._handleAction(t.tap_action);const e=this._stateObj,i=e?.entity_id?.split(".")[0],o=t.value??t.label;"select"!==i&&"input_select"!==i||null==o||this._callService(i,"select_option",{entity_id:e.entity_id,option:String(o)})}render(){if(!this.hass||!this.config)return I``;const t=this._selected,e=(this._isTemplate(this.config.color)?this._resolvedColor:this.config.color)||"var(--md-sys-cust-color-device, var(--md-sys-color-secondary-container))",i=(this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on)||"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-secondary-container))";return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-carousel",yi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-carousel",name:"Materia Carousel",description:"Scroll-snapping row of selectable tiles — the richer alternative to a chip row.",preview:!0});const xi=[yt,bt,vt,gt,n`
    ha-card.panel {
      display: flex;
      flex-direction: column;
  ...
  `],wi="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:var(--md-sys-color-secondary-container, rgba(120,120,128,.14));color:var(--md-sys-color-on-secondary-container, inherit);margin-bottom:6px;cursor:pointer;",$i="border:none;background:transparent;color:inherit;cursor:pointer;padding:4px;display:grid;place-items:center;border-radius:50%;--mdc-icon-size:18px;",ki="border:1.5px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.2));background:transparent;color:inherit;font-family:inherit;font-size:13px;font-weight:600;padding:8px 16px;border-radius:999px;cursor:pointer;display:inline-flex;align-items:center;gap:6px;";customElements.define("materia-climate-panel-editor",class extends Ot{static properties={_secIdx:{state:!0},_cardIdx:{state:!0},_huiReady:{state:!0}};connectedCallback(){super.connectedCallback(),this._loadHui()}async _loadHui(){if(customElements.get("hui-card-picker")&&customElements.get("hui-card-element-editor"))this._huiReady=!0;else{try{const t=await pt(),e=await t.createCardElement({type:"vertical-stack",cards:[]});await(e?.constructor?.getConfigElement?.())}catch{}this._huiReady=!!customElements.get("hui-card-picker")}}_formData(){return{...this._config}}get _secs(){return this._config?.sections||[]}_setSecs(t){const e={...this._config};t.length?e.sections=t:delete e.sections,this._commit(e)}_patchSec(t,e){const i=[...this._secs],o={...i[t],...e};for(const t of Object.keys(e))void 0!==e[t]&&""!==e[t]&&null!==e[t]||delete o[t];i[t]=o,this._setSecs(i)}_moveSec(t,e){const i=[...this._secs],o=t+e;o<0||o>=i.length||([i[t],i[o]]=[i[o],i[t]],this._setSecs(i))}_addSec(){const t=this._secs.length;this._setSecs([...this._secs,{title:"New section",style:"section",cards:[]}]),this._secIdx=t}_patchCards(t,e){this._patchSec(t,{cards:e})}render(){return this.hass&&this._config?null!=this._secIdx&&null!=this._cardIdx?this._renderCardView():null!=this._secIdx?this._renderSectionView():super.render():I``}_back(t,e){return I`
      ...
      <ha-expansion-panel outlined .header=${"Sections"} .secondary=${"Wallet sections and menus below the mode group"} .expanded=${!0}>
        ...
        <div style="padding:12px;">
          ${this._secs.map((t,e)=>I`
            <div style=${wi} @click=${()=>{this._secIdx=e}}>
              ...
              <button style=${$i} title="Move up" @click=${t=>{t.stopPropagation(),this._moveSec(e,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
              <button style=${$i} title="Move down" @click=${t=>{t.stopPropagation(),this._moveSec(e,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
              <button style=${$i} title="Edit" @click=${t=>{t.stopPropagation(),this._secIdx=e}}><ha-icon icon="mdi:pencil"></ha-icon></button>
              <button style=${$i} title="Delete" @click=${t=>{t.stopPropagation(),this._setSecs(this._secs.filter((t,i)=>i!==e))}}><ha-icon icon="mdi:delete"></ha-icon></button>
            </div>
          `)}
    ...
    `}_renderMenuFields(t,e){const i=e.options||[],o=(e,o)=>{const s=i.map((t,i)=>i===e?{...t,...o}:t);for(const t of Object.keys(o))""!==o[t]&&null!=o[t]||delete s[e][t];this._patchSec(t,{options:s})};return I`
      ...
      ${i.map((e,s)=>I`
        <div style="display:flex;gap:6px;align-items:flex-start;margin-bottom:8px;">
          ...
          <button style="${$i}margin-top:12px;" title="Remove option"
            @click=${()=>this._patchSec(t,{options:i.filter((t,e)=>e!==s)})}>
            <ha-icon icon="mdi:delete"></ha-icon>
          </button>
        </div>
      `)}
      <button style=${ki} @click=${()=>this._patchSec(t,{options:[...i,{label:"",value:""}]})}>
    ...
    `}_renderActions(t,e){const i=e.actions||[],o=(e,o)=>{const s=i.map((t,i)=>i===e?{...t,...o}:t);for(const t of Object.keys(o))""!==o[t]&&null!=o[t]||delete s[e][t];this._patchSec(t,{actions:s})};return I`
      ...
      ${i.map((e,s)=>I`
        <div style="border:1px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.15));border-radius:12px;padding:10px;margin-bottom:8px;">
          <div style="display:flex;gap:6px;align-items:flex-start;">
            ...
            <button style="${$i}margin-top:12px;" title="Remove action"
      ...
      `)}
      <button style="${ki}margin-bottom:12px;" @click=${()=>this._patchSec(t,{actions:[...i,{label:""}]})}>
    ...
    `}_renderSectionCards(t,e){const i=e.cards||[],o=(e,o)=>{const s=e+o;if(s<0||s>=i.length)return;const n=[...i];[n[e],n[s]]=[n[s],n[e]],this._patchCards(t,n)};return I`
      ...
      ${i.map((e,s)=>I`
        <div style=${wi} @click=${()=>{this._cardIdx=s}}>
          ...
          <button style=${$i} title="Move up" @click=${t=>{t.stopPropagation(),o(s,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
          <button style=${$i} title="Move down" @click=${t=>{t.stopPropagation(),o(s,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
          <button style=${$i} title="Edit" @click=${t=>{t.stopPropagation(),this._cardIdx=s}}><ha-icon icon="mdi:pencil"></ha-icon></button>
          <button style=${$i} title="Delete" @click=${e=>{e.stopPropagation(),this._patchCards(t,i.filter((t,e)=>e!==s))}}><ha-icon icon="mdi:delete"></ha-icon></button>
        </div>
      `)}
  ...
  `],Si=-135,Ei=270,Ai="var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))",Mi="var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))",Ti={auto:{icon:"mdi:thermostat-auto",color:Ai,on:Mi,container:Mi,onContainer:Ai},heat_cool:{icon:"mdi:thermostat-auto",color:Ai,on:Mi,container:Mi,onContainer:Ai},heat:{icon:"m3o:mode-heat",color:"var(--md-sys-cust-color-climate-heat-accent, #a14614)",on:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",container:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",onContainer:"var(--md-sys-cust-color-climate-heat-accent, #a14614)"},cool:{icon:"mdi:snowflake",color:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)",on:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",container:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",onContainer:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)"},dry:{icon:"mdi:water-percent",color:Ai,on:Mi,container:Mi,onContainer:Ai},fan_only:{icon:"mdi:fan",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"},off:{icon:"m3o:power-settings-new",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"}};class Fi extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_adjusting:{state:!0}};static styles=Ci;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}connectedCallback(){super.connectedCallback(),this._phase=0,this._amp=0,this._startLoop()}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),clearTimeout(this._optimisticTimer),clearTimeout(this._sendTimer)}get _entity(){return this.hass?.states[this.config.entity]}get _action(){return this._entity?.attributes?.hvac_action??""}get _waveAction(){const t=this._mode;if("off"===t||"never"===this.config.wave)return"";if("always"===this.config.wave)return"cool"===t?"cooling":"heating";const e="auto"===t||"heat_cool"===t,i=e?"holding":"",o=this._action;if("heating"===o||"cooling"===o)return o;if(o&&"idle"!==o)return"";const s=this._current,n=this._target;return null==n||"idle"===o?i:null==s?"cool"===t?"cooling":"heat"===t?"heating":i:("heat"===t||e)&&s<n-.2?"heating":("cool"===t||e)&&s>n+.2?"cooling":i}get _mode(){return this._entity?.state??"off"}get _target(){return null!=this._optimisticTemp?this._optimisticTemp:this._numRaw(this._entity?.attributes?.temperature)}get _current(){if(this.config.temperature_entity){const t=this.hass?.states[this.config.temperature_entity];if(t)return this._numRaw(t.state)}return this._numRaw(this._entity?.attributes?.current_temperature)}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _step(){return this.config.step??this._numRaw(this._entity?.attributes?.target_temp_step)??.5}get _scale(){return{min:this.config.min_temp??this._numRaw(this._entity?.attributes?.min_temp)??7,max:this.config.max_temp??this._numRaw(this._entity?.attributes?.max_temp)??35}}_startLoop(){if(this._raf)return;const t=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,e=()=>{const i=this._waveAction,o="heating"===i||"cooling"===i,s=t?0:o?1:"holding"===i?.35:0,n=this._amp+.06*(s-this._amp),a=Math.abs(n-s)<.01;if(this._amp=a?s:n,this._amp>.005||s>0){this._phase+="cooling"===i?.012:o?-.012:-.008;const t=this._waveGeom;if(t){const e=this.renderRoot?.querySelector("path.wave-seg");e&&e.setAttribute("d",this._wavePath(t.start,t.end,t.r))}this._raf=requestAnimationFrame(e)}else this._raf=null};this._raf=requestAnimationFrame(e)}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}updated(t){if(this._waveAction&&!this._raf&&this._startLoop(),t.has("hass")&&null!=this._optimisticTemp){const t=this._numRaw(this._entity?.attributes?.temperature);null!=t&&Math.abs(t-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}_modeGroupConfig(t,e,i){const o=`${this.config.entity}|${t.join()}|${e}|${i}|${this.config.mode_size??"m"}`;return this._mgKey!==o&&(this._mgKey=o,this._mgConfig={entity:this.config.entity,size:this.config.mode_size??"m",variant:"tonal",active_shape:"square",color_active:e,color_on_active:i,options:t.map(t=>({icon:Ti[t].icon,value:t,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:t},target:{entity_id:this.config.entity}}}))}),this._mgConfig}_angleFor(t,e,i){const o=Math.min(1,Math.max(0,(t-e)/(i-e)));return Si+Ei*o}_pointAt(t,e,i=0){const o=(t-90)*Math.PI/180,s=e+i;return[50+s*Math.cos(o),50+s*Math.sin(o)]}_wavePath(t,e,i){const o=e-t,s=1+.55*Math.max(0,Math.min(1,(90-o)/70)),n=Math.min(20,Math.max(6,o/3)),a=3.2*s*this._amp,r=[];for(let o=t;o<=e;o+=2){const s=o-t,l=a*Math.min(1,s/n)*Math.min(1,(e-o)/n)*Math.sin(s/7+this._phase);r.push(this._pointAt(o,i,l))}return r.push(this._pointAt(e,i,0)),"M"+r.map(([t,e])=>`${t.toFixed(2)} ${e.toFixed(2)}`).join(" L")}_arcPath(t,e,i){const[o,s]=this._pointAt(t,i),[n,a]=this._pointAt(e,i),r=e-t>180?1:0;return`M${o.toFixed(2)} ${s.toFixed(2)} A${i} ${i} 0 ${r} 1 ${n.toFixed(2)} ${a.toFixed(2)}`}_setTarget(t){const{min:e,max:i}=this._scale,o=this._step,s=Math.round(100*Math.min(i,Math.max(e,Math.round(t/o)*o)))/100;this._optimisticTemp=s,this._adjusting=!0,clearTimeout(this._adjustTimer),this._adjustTimer=setTimeout(()=>{this._adjusting=!1},650),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4),clearTimeout(this._sendTimer),this._sendTimer=setTimeout(()=>{this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:s})},350)}_nudge(t){const e=this._target;null!=e&&this._setTarget(e+t)}_dialPointer(t){if(!this._dialDragging&&"pointerdown"!==t.type)return;const e=this.renderRoot.querySelector(".dial").getBoundingClientRect(),i=(t.clientX-e.left)/e.width*100-50,o=(t.clientY-e.top)/e.height*100-50;let s=180*Math.atan2(o,i)/Math.PI+90;if(s>180&&(s-=360),s<-143||s>143)return;const n=Math.min(1,Math.max(0,(s-Si)/Ei)),{min:a,max:r}=this._scale;"pointerdown"===t.type&&(this._dialDragging=!0,t.currentTarget.setPointerCapture(t.pointerId)),this._setTarget(a+n*(r-a))}_endDialDrag(t){this._dialDragging=!1,t.currentTarget.releasePointerCapture?.(t.pointerId)}render(){if(!this.hass||!this.config)return I``;const t=this._entity;if(!t)return I``;const e=this._isUnavailable(t),{min:i,max:o}=this._scale,s=this._target,n=this._current,a=this._mode,r=this._waveAction,l=Ti[a]||Ti.off,c="off"!==a&&null!=s,d=42,h=c?this._angleFor(s,i,o):Si,p=null!=s?this._angleFor(s,i,o):null,[u,m]=this._pointAt(c?h:p??h,d),g=null!=n?this._angleFor(n,i,o):null;let f=null,_=null,b=null;c&&"holding"===r?(_=Si,b=null!=g?Math.max(g,h):h):c&&null!=g?(f=Math.min(g,h),_=f,b=Math.max(g,h)):c&&(_=Si,b=h);const v="heating"===r?Ti.heat:"cooling"===r?Ti.cool:l,y=v.color,x=v.on,w=this.hass.formatEntityState?.(t)??a,$=this.hass.config?.unit_system?.temperature??"°C",k=(this.config.hvac_modes??t.attributes.hvac_modes??[]).filter(t=>Ti[t]);return this._waveGeom=c&&null!=b&&b>_+.5?{start:_,end:b,r:d}:null,I`
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const t=c?Math.max(h,g??h):Si,e=c?Math.min(t+8,135):Si;return e<134.5?H`<path d=${this._arcPath(e,135,d)} class="track" />`:""})()}
            ${c||null==g?"":H`<circle
                  cx=${this._pointAt(g,d)[0]} cy=${this._pointAt(g,d)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?H`<path d=${this._arcPath(Si,f,d)} class="sweep" style="stroke:${y}" />`:""}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6}}customElements.define("materia-climate-panel",Oi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate-panel",name:"Materia Climate Panel",description:"Climate panel: thermostat dial hero, mode group, and wallet sections you compose with any cards or menus.",preview:!0});const Ui={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},tertiary:{active:"var(--md-sys-color-tertiary)",onActive:"var(--md-sys-color-on-tertiary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat-container)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool-container)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto-container)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},Pi={xs:{height:32,innerCorner:4},s:{height:40,innerCorner:8},m:{height:56,innerCorner:8},l:{height:96,innerCorner:16},xl:{height:136,innerCorner:20}},qi=[yt,bt,gt,n`
    .group {
      display: flex;
      gap: 2px;
      width: 100%;
  ...
  `];class Ri extends Ot{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[Ot.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-button",Li),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"M3 button — icon and/or label, variants, sizes, shapes, and shape-morph on state.",preview:!0});const Ni=[yt,n`
  ...
  `];class Ii extends Ot{static properties={_expanded:{state:!0}};static styles=[Ot.styles,n`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-split-button",Xi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-split-button",name:"Materia Split Button",description:"M3 Expressive split button — a main action plus a menu of related actions.",preview:!0});class Gi extends Ot{static properties={_expanded:{state:!0}};static styles=[Ot.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
  ...
  `];customElements.define("materia-lock-editor",class extends Ot{_formData(){return{gesture:"slide",shape:!0,initial_locked:!0,...this._config}}_sectionsSignature(){return`${this._config?.gesture||"slide"}|${this._config?.entity?"e":""}`}get _sections(){const t="hold"===this._config?.gesture,e=!!this._config?.entity;return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Lock (optional)",helper:"Leave empty to run self-contained — the card keeps its own state, with nothing to control.",selector:{entity:{domain:["lock","switch","input_boolean"]}}},{name:"gesture",label:"Commit gesture",selector:{select:{mode:"dropdown",options:[{value:"slide",label:"Slide the handle across"},{value:"hold",label:"Press and hold"}]}}},{name:"shape",label:"Show the morphing lock shape",selector:{boolean:{}}}]},{title:"Behaviour",icon:"mdi:cog-outline",fields:[...t?[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}}]:[{name:"threshold",label:"Commit past this fraction of the track (default 0.55)",selector:{number:{min:.3,max:1,step:.05,mode:"slider"}}}],...e?[{name:"locked_state",label:"State that means locked",helper:'Defaults to "locked" for a lock and "off" for a switch — a relay strike is energised to release the door.',selector:{text:{}}},{name:"pending_timeout_ms",label:"Give up waiting for the lock after (ms, default 10000)",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}}]:[{name:"initial_locked",label:"Start out locked",selector:{boolean:{}}}]]},{title:"Labels",icon:"mdi:text-short",fields:[...t?[{name:"unlock_hold_hint",label:'While locked (default "Hold to unlock")',selector:{text:{}}},{name:"lock_hold_hint",label:'While unlocked (default "Hold to lock")',selector:{text:{}}}]:[{name:"unlock_hint",label:'While locked (default "Slide to unlock")',selector:{text:{}}},{name:"lock_hint",label:'While unlocked (default "Slide to lock")',selector:{text:{}}}],...e?[{name:"locking_label",label:'While locking (default "Locking…")',selector:{text:{}}},{name:"unlocking_label",label:'While unlocking (default "Unlocking…")',selector:{text:{}}},{name:"jammed_label",label:'When jammed (default "Jammed — check the door")',selector:{text:{}}}]:[{name:"demo_label",label:'Self-contained note (default "Demo · no entity")',selector:{text:{}}}]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"unlocked_color",label:"Background while unlocked",color:!0,selector:{text:{}}},{name:"unlocked_color_on",label:"Text while unlocked",color:!0,selector:{text:{}}},{name:"locked_color",label:"Background while locked",color:!0,selector:{text:{}}},{name:"locked_color_on",label:"Text while locked",color:!0,selector:{text:{}}},{name:"accent",label:"Accent (locked glyph and handle)",color:!0,selector:{text:{}}},{name:"accent_on",label:"Ink on the accent",color:!0,selector:{text:{}}},{name:"locked_icon",label:"Icon while locked",selector:{icon:{}}},{name:"unlocked_icon",label:"Icon while unlocked",selector:{icon:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Tapping the shape",selector:{ui_action:{default_action:"more-info"}}}]}]}});class Qi extends(_t(ct)){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_local:{state:!0}};static styles=Zi;static getConfigElement(){return document.createElement("materia-lock-editor")}static getStubConfig(){return{gesture:"slide"}}setConfig(t){this.config={gesture:"slide",...t}}constructor(){super(),this._pending=null,this._local=null}get _stateObj(){return this.config?.entity?this.hass?.states[this.config.entity]:null}get _selfContained(){return!this.config?.entity}get _lockedState(){if(this.config.locked_state)return String(this.config.locked_state);const t=this.config.entity?.split(".")[0];return"switch"===t||"input_boolean"===t?"off":"locked"}get _entityLocked(){const t=this._stateObj;return!t||this._isUnavailable(t)?null:String(t.state)===this._lockedState}get _locked(){if(null!=this._pending)return this._pending;if(this._selfContained)return this._local??!1!==this.config.initial_locked;return this._entityLocked??this._local??!0}get _transitioning(){const t=String(this._stateObj?.state??"");return"locking"===t||"unlocking"===t||"jammed"===t?t:null!=this._pending?this._pending?"locking":"unlocking":null}updated(t){t.has("hass")&&null!=this._pending&&this._entityLocked===this._pending&&(this._pending=null,clearTimeout(this._pendingTimer))}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._pendingTimer)}_confirm(){const t=!this._locked;if(this._selfContained)return void(this._local=t);this._pending=t,clearTimeout(this._pendingTimer),this._pendingTimer=setTimeout(()=>{this._pending=null},this.config.pending_timeout_ms??1e4);const e=this.config.entity,i=e.split(".")[0];if("lock"===i)this._callService("lock",t?"lock":"unlock",{entity_id:e});else{const o="off"===this._lockedState,s=t?!o:o;this._callService(i,s?"turn_on":"turn_off",{entity_id:e})}}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(this.config.entity&&!t)return I`<ha-card><div class="body">
      ...
      >
        <div class="body">
          ${!1===this.config.shape?W:I`<div
              ...
              >
                <div class="shape ${i?"":"unlocked"}">
                  <ha-icon .icon=${p}></ha-icon>
                </div>
              </div>`}

          <materia-drag-confirm
            .gesture=${g?"hold":"slide"}
            .label=${g?m:u}
            .icon=${g?p:i?"m3o:arrow-forward":"m3o:arrow-back"}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 5}}customElements.define("materia-lock",Qi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-lock",name:"Materia Lock",description:"Lock shape that morphs square→circle, with a drag-to-confirm or hold-to-confirm gesture. Works with no entity.",preview:!0});const Ji={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-on-secondary-container)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-state":["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],"secondary-state":["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],"tertiary-state":["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],"error-state":["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],"device-state":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]},to=[yt,n`
    :host {
...
`];class co extends Ot{static properties={_expanded:{state:!0}};static styles=[Ot.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
...
`;class uo extends Ot{static properties={_expanded:{state:!0}};static styles=[Ot.styles,n`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return Math.max(2,2*(this.config?.options?.length||2))}}customElements.define("materia-button-stack",mo),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button-stack",name:"Materia Button Stack",description:"Vertical segmented button — stacked options with optional active-state highlighting.",preview:!0});const go=n`
  :host {
    display: block;
  }
