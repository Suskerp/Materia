      ...
      >
        <div class="dial-wrap">
          ...
          >
            ...
            ${c&&null!=_&&_>f+.5?H`<path d=${this._wavePath(f,_,d)} class="sweep wave-seg" style="stroke:${b}" />`:""}
            ${c&&null!=m?H`<circle
                  cx=${this._pointAt(m,d)[0]} cy=${this._pointAt(m,d)[1]}
        ...
        ${!1!==this.config.show_modes&&$.length?I`<materia-button-group
              .hass=${this.hass}
              .config=${this._modeGroupConfig($,b,y)}
            ></materia-button-group>`:""}
      </ha-card>
