...
`,bt=t=>t.label??t.name.replace(/_/g," ").replace(/^\w/,t=>t.toUpperCase()),yt=(t,e,i)=>({value:`var(--md-sys-cust-color-${t})`,swatch:`var(--md-sys-cust-color-${t}, ${i})`,label:e}),xt=(t,e)=>({value:`var(--md-sys-color-${t})`,swatch:`var(--md-sys-color-${t})`,label:e}),wt=[{title:"Light",options:[yt("light","Light","#FEE082"),yt("light-container","Light container","#FEEFCA"),yt("on-light","On light","#745D00")]},{title:"Device",options:[yt("device","Device","#D9E2FE"),yt("device-container","Device container","#EDF0FF"),yt("on-device","On device","#0156CF")]},{title:"Climate · Heat",options:[yt("climate-heat","Heat","#FFDFD4"),yt("climate-heat-container","Heat container","#FFEEE9"),yt("on-climate-heat","On heat","#A14614")]},{title:"Climate · Cool",options:[yt("climate-cool","Cool","#D3E8FF"),yt("climate-cool-container","Cool container","#EAF3FF"),yt("on-climate-cool","On cool","#327EA7")]},{title:"Climate · Auto",options:[yt("climate-auto","Auto","#D4EBDD"),yt("climate-auto-container","Auto container","#EAF6EE"),yt("on-climate-auto","On auto","#2E5E44")]},{title:"Water · Eco",options:[yt("water-eco","Eco","#C8E6C9"),yt("water-eco-container","Eco container","#E6F4EA"),yt("on-water-eco","On eco","#256029")]},{title:"Water · Performance",options:[yt("water-performance","Performance","#FFD1B0"),yt("water-performance-container","Performance container","#FFEDE0"),yt("on-water-performance","On performance","#9C3A00")]},{title:"Warning",options:[yt("warning","Warning","#D9A000"),yt("warning-container","Warning container","#FEEFCA"),yt("on-warning","On warning","#FFFFFF")]},{title:"System (theme)",options:[xt("primary","Primary"),xt("primary-container","Primary container"),xt("secondary","Secondary"),xt("secondary-container","Secondary container"),xt("tertiary","Tertiary"),xt("tertiary-container","Tertiary container"),xt("error","Error"),xt("error-container","Error container"),xt("surface-container","Surface container")]}],$t=new Set(wt.flatMap(t=>t.options.map(t=>t.value)));function Ct(t){return t&&"string"==typeof t&&(t.includes("{{")||t.includes("{%"))}const kt={template:{}};class At extends ct{static properties={label:{},value:{},_open:{state:!0},_customOpen:{state:!0}};static styles=n`
  ...
  `;setConfig(t){this._config=t,this._modes??={}}_formData(){return this._config||{}}get _sections(){return[]}_sectionsSignature(){return""}get _sectionsMemo(){const t=this._sectionsSignature();return this.__secSig===t&&this.__secVal||(this.__secSig=t,this.__secVal=this._sections),this.__secVal}_stableContext(t,e,i){const o={};for(const[t,s]of Object.entries(e))o[t]=i[s];this.__ctx??={};const s=this.__ctx[t];return s&&Object.keys(o).every(t=>s[t]===o[t])?s:(this.__ctx[t]=o,o)}_modeFor(t,e){const i=this._modes?.[t];return i||(Ct(e)?"template":"simple")}_toggleMode(t){const e=this._formData()[t],i=this._modeFor(t,e);this._modes={...this._modes||{},[t]:"template"===i?"simple":"template"}}render(){if(!this.hass||!this._config)return I``;const t=this._formData();return I`
    ...
    `}_renderField(t,e){const i=e[t.name],o=t.label??bt(t),s=!!t.template,n=s?this._modeFor(t.name,i):"simple",a=t.context?this._stableContext(t.name,t.context,e):void 0;let r;return r=s&&"template"===n?I`
        <ha-selector
          class="field-control"
          .hass=${this.hass}
          .selector=${kt}
    ...
    `}_toggleSubButton(t){this._expandedButton=this._expandedButton===t?null:t}_addSubButton(){const t=[...this._config.sub_buttons||[],{icon:"mdi:star"}];this._commit({...this._config,sub_buttons:t}),this._expandedButton=t.length-1}_removeSubButton(t){const e=[...this._config.sub_buttons||[]];e.splice(t,1),this._expandedButton===t&&(this._expandedButton=null);const i={...this._config};0===e.length?delete i.sub_buttons:i.sub_buttons=e,this._commit(i)}_subButtonChanged(t,e){const i=[...this._config.sub_buttons||[]];i[t]={...i[t],...e},this._commit({...this._config,sub_buttons:i})}_handleCardPicked(t){t.stopPropagation();const e=[...this._config.cards||[],t.detail.config];this._selectedCard=e.length-1,this._commit({...this._config,cards:e})}_handleChildChanged(t){if(t.stopPropagation(),t.detail.error)return;const e=[...this._config.cards||[]];e[this._selectedCard]=t.detail.config,this._commit({...this._config,cards:e})}_moveCard(t){const e=[...this._config.cards||[]],i=this._selectedCard,o=i+t;if(o<0||o>=e.length)return;const[s]=e.splice(i,1);e.splice(o,0,s),this._selectedCard=o,this._commit({...this._config,cards:e})}_removeCard(){const t=[...this._config.cards||[]];t.splice(this._selectedCard,1),this._selectedCard=Math.max(0,Math.min(this._selectedCard,t.length-1)),0===t.length&&(this._selectedCard=-1),this._commit({...this._config,cards:t})}}customElements.define("materia-room-editor",Bt);class Dt extends Ut{static properties={...Ut.properties,_expanded:{state:!0},_childCards:{state:!0}};static styles=[gt,ut,_t,ft,mt,vt,Mt];static getConfigElement(){return document.createElement("materia-room-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("light."))||"light.example";return{entity:e,columns:2,cards:[]}}constructor(){super(),this._expanded=!1,this._childCards=null}setConfig(t){if(!t.entity)throw new Error("entity is required");const e=this.config?.cards;this.config={columns:2,...t};const i=this.config.cards;JSON.stringify(e)!==JSON.stringify(i)&&(this._childCards=null,this.isConnected&&this._createChildCards())}firstUpdated(){this._createChildCards()}updated(t){super.updated?.(t),t.has("hass")&&this.hass&&this._childCards&&this._childCards.forEach(t=>t.hass=this.hass)}async _createChildCards(){const t=this.config?.cards;if(!t||0===t.length)return void(this._childCards=[]);const e=await async function(){return dt||(dt=await window.loadCardHelpers(),dt)}();this._childCards=await Promise.all(t.map(async t=>{const i=await e.createCardElement(t);return this.hass&&(i.hass=this.hass),i})),this.requestUpdate()}_toggleExpand(t){t?.stopPropagation?.(),this._expanded=!this._expanded,this._fireHaptic("selection")}render(){if(!this.config||!this.hass)return I``;const t=this._stateObj,e=this._isUnavailable(t),i=!e&&this._isActive,o=!e&&this._showSlider,s=e?[]:this._subButtons,n=this._getContainerBg(),a=this._getTextColor(),r=o&&i?this._fillPercent:0,c=this._domainConfig.sliderColor||this._domainConfig.colorActive,l=this._icon,d=e?"Unavailable":this._stateDisplay,h=this._subtitle,p=!1!==this.config.subtitle_inline,u=p&&h?d?`${d} · ${h}`:h:d,m=this.config.columns||2;return I`
      <ha-card>
        <div
          ...
          @click=${o?void 0:()=>this._handleTap()}
        >
          ${o?I`<div class="fill" style="width: ${r}%; background-color: ${c}; opacity: 1;"></div>`:W}
          ...
          <div class="name-container">
            <div class="name">${this._name}</div>
            ${!p&&h?I`<div class="subtitle">${h}</div>`:W}
            ${u?I`<div class="state">${u}</div>`:W}
          </div>
