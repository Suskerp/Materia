      ...
      >
        <div class="dial-wrap">
          ...
          >
            ...
            ${c?H`<circle cx=${u} cy=${m} r="5" class="thumb" style="stroke:${y}" />`:null!=p?H`<circle cx=${u} cy=${m} r="4" class="thumb muted" />`:""}
          </svg>
