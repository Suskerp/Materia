      ...
      <ha-card style="--mh-bg:${u};--mh-fg:${m};--mh-alert-bg:${f??u};--mh-alert-fg:${_??m};">
        <div class="stack">
          <div
            ...
            @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info",entity:this.config.entity})}
          >
            ${!1===this.config.burst?W:I`<svg class="burst ${g?"alarm":s?"working":""}" viewBox="0 0 180 180" aria-hidden="true">
      ...
      <ha-card style="--mcar-bg:${e};--mcar-fg:${i};">
        ...
        >
          ${this._items().map(e=>{const i=e.value??e.label,s=t.some(t=>t===String(i));return I`
              <button
                class="tile ${s?"on":""} ${this._disabled?"disabled":""}"
                @click=${()=>this._tap(e)}
      ...
      >
        <div class="body">
          ...
          ${s?I`<div class="pending">
                ${"jammed"===s?this.config.jammed_label??Tt("lock_jammed_hint",this.hass):"locking"===s?this.config.locking_label??Tt("lock_locking",this.hass):this.config.unlocking_label??Tt("lock_unlocking",this.hass)}
