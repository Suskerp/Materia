...
`,Dt=(t,e,i)=>({value:`var(--md-sys-cust-color-${t})`,swatch:`var(--md-sys-cust-color-${t}, ${i})`,label:e}),Pt=(t,e)=>({value:`var(--md-sys-color-${t})`,swatch:`var(--md-sys-color-${t})`,label:e}),qt=[{title:"Light",options:[Dt("light","Light","#FEE082"),Dt("light-container","Light container","#FEEFCA"),Dt("on-light","On light","#745D00")]},{title:"Device",options:[Dt("device","Device","#D9E2FE"),Dt("device-container","Device container","#EDF0FF"),Dt("on-device","On device","#0156CF")]},{title:"Climate · Heat",options:[Dt("climate-heat","Heat","#FFDFD4"),Dt("climate-heat-container","Heat container","#FFEEE9"),Dt("on-climate-heat","On heat","#A14614"),Dt("climate-heat-accent","Heat accent","#A14614")]},{title:"Climate · Cool",options:[Dt("climate-cool","Cool","#D3E8FF"),Dt("climate-cool-container","Cool container","#EAF3FF"),Dt("on-climate-cool","On cool","#327EA7"),Dt("climate-cool-accent","Cool accent","#327EA7")]},{title:"Climate · Auto",options:[Dt("climate-auto","Auto","#D4EBDD"),Dt("climate-auto-container","Auto container","#EAF6EE"),Dt("on-climate-auto","On auto","#2E5E44"),Dt("climate-auto-accent","Auto accent","#2E5E44")]},{title:"Water · Eco",options:[Dt("water-eco","Eco","#C8E6C9"),Dt("water-eco-container","Eco container","#E6F4EA"),Dt("on-water-eco","On eco","#256029")]},{title:"Water · Performance",options:[Dt("water-performance","Performance","#FFD1B0"),Dt("water-performance-container","Performance container","#FFEDE0"),Dt("on-water-performance","On performance","#9C3A00")]},{title:"Warning",options:[Dt("warning","Warning","#D9A000"),Dt("warning-container","Warning container","#FEEFCA"),Dt("on-warning","On warning","#FFFFFF"),Dt("on-warning-container","On warning container","#745D00")]},{title:"Error",options:[Dt("error","Error","#B3261E"),Dt("error-container","Error container","#F9DEDC"),Dt("on-error","On error","#FFFFFF"),Dt("on-error-container","On error container","#410E0B")]},{title:"Weather",options:[Dt("weather-sun","Sun","#F2B500"),Dt("weather-cloud","Cloud","#9FA9B7"),Dt("weather-cloud-dark","Cloud (dark)","#6F7A8A"),Dt("weather-rain","Rain","#2E86E0"),Dt("weather-snow","Snow","#AEB8C4"),Dt("weather-moon","Moon","#5961C2")]},{title:"Severity scale",options:[Dt("scale-green","Scale green","#5E9E50"),Dt("scale-yellow","Scale yellow","#C7A128"),Dt("scale-orange","Scale orange","#D9713C"),Dt("scale-red","Scale red","#C94D42"),Dt("scale-purple","Scale purple","#8A4DA3"),Dt("scale-maroon","Scale maroon","#7A4040")]},{title:"System (theme)",options:[Pt("primary","Primary"),Pt("primary-container","Primary container"),Pt("secondary","Secondary"),Pt("secondary-container","Secondary container"),Pt("tertiary","Tertiary"),Pt("tertiary-container","Tertiary container"),Pt("error","Error"),Pt("error-container","Error container"),Pt("surface-container","Surface container")]}],Ut=new Set(qt.flatMap(t=>t.options.map(t=>t.value)));function Rt(t){return t&&"string"==typeof t&&(t.includes("{{")||t.includes("{%"))}const jt={template:{}};class Nt extends ct{static properties={label:{},value:{},_open:{state:!0},_customOpen:{state:!0}};static styles=n`
  ...
  `;get _isCustom(){return!!this.value&&!Ut.has(this.value)}_option(t){for(const e of qt){const i=e.options.find(e=>e.value===t);if(i)return i}return null}get _currentLabel(){if(!this.value)return"Default";const t=this._option(this.value);return t?t.label:"Custom"}get _currentHex(){if(!this.value)return null;const t=this._option(this.value);return t?t.swatch:this.value}disconnectedCallback(){super.disconnectedCallback(),this._removeOutside()}render(){const t=this._currentHex,e=I`<ha-icon class="check" icon="mdi:check"></ha-icon>`;return I`
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const t=c?Math.max(h,g??h):Pi,e=c?Math.min(t+8,135):Pi;return e<134.5?H`<path d=${this._arcPath(e,135,d)} class="track" />`:""})()}
            ${c||null==g?"":H`<circle
                  cx=${this._pointAt(g,d)[0]} cy=${this._pointAt(g,d)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?H`<path d=${this._arcPath(Pi,f,d)} class="sweep" style="stroke:${y}" />`:""}
      ...
      <ha-card class=${e?"unavailable":""} style="--msh-bg:${n};--msh-fg:${a};">
        <div class="block">
          ...
          <div class="head">
            ...
            <div class="text">
              <div class="title">${e?Tt("unavailable",this.hass):r}</div>
...
`;customElements.define("materia-media-editor",class extends Lt{_formData(){return{show_art:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"name",label:"Title",template:!0,selector:{text:{}}},{name:"subtitle",template:!0,selector:{text:{}}},{name:"image",helper:"Defaults to the entity's album art",template:!0,selector:{text:{}}},{name:"fallback_image",helper:"Shown when there's no art",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"show_art",selector:{boolean:{}}},{name:"art_size",label:"Art size (px)",selector:{number:{min:80,max:480,mode:"box"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class Ps extends(xt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedName:{state:!0},_resolvedSubtitle:{state:!0},_resolvedImage:{state:!0}};static styles=Ds;static getConfigElement(){return document.createElement("materia-media-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("media_player."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config=t}updated(t){if(t.has("hass")&&this.hass){this._resolveField("name","_resolvedName"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField("image","_resolvedImage");const t=this._stateObj?.attributes?.media_title;t&&this._lastTrack&&t!==this._lastTrack&&(this._beat=!0,this.requestUpdate(),clearTimeout(this._beatTimer),this._beatTimer=setTimeout(()=>{this._beat=!1,this.requestUpdate()},900)),this._lastTrack=t}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._beatTimer)}get _stateObj(){return this.hass?.states[this.config.entity]}get _title(){if(this.config.name)return this._isTemplate(this.config.name)?this._resolvedName:this.config.name;const t=this._stateObj?.attributes;return t?.media_title||t?.friendly_name||""}get _subtitle(){if(this.config.subtitle)return this._isTemplate(this.config.subtitle)?this._resolvedSubtitle:this.config.subtitle;const t=this._stateObj?.attributes;return t?.media_artist||t?.media_album_name||""}get _image(){if(this.config.image){const t=this._isTemplate(this.config.image)?this._resolvedImage:this.config.image;if(t)return t}return this._stateObj?.attributes?.entity_picture||this.config.fallback_image||""}_tap(){this._handleAction(this.config.tap_action||{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj,e=this._isUnavailable(t),i=this._image,s=this._title,o=this._subtitle,n=`${this.config.art_size?`--mm-art:${this.config.art_size}px;`:""}${i?`background-image:url('${i}');`:""}`,a=!e&&!!t?.attributes?.media_title&&!["off","idle","standby"].includes(t.state),r=a&&"paused"===t.state;return I`
    ...
    `}getCardSize(){return 4}}customElements.define("materia-media",Ps),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media",name:"Materia Media",description:"Now-playing card — album art, title and subtitle (all templatable).",preview:!0});const qs=n`
  :host {
    display: block;
  }
