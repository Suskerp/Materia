      ...
      <ha-card class="${e?"unavailable":""}">
        <div class="dial-wrap">
          ...
          >
            ...
            ${c&&null!=g&&g>-134.5?H`<path d=${this._arcPath(Te,g,d)} class="sweep" style="stroke:${b}" />`:""}
        ...
        ${!1!==this.config.show_modes&&$.length?I`<materia-button-group
              .hass=${this.hass}
              .config=${{entity:this.config.entity,size:this.config.mode_size??"l",variant:"tonal",color_active:b,color_on_active:y,options:$.map(t=>({icon:Fe[t].icon,value:t,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:t},target:{entity_id:this.config.entity}}}))}}
            ></materia-button-group>`:""}
      </ha-card>
