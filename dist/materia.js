...
`;class ht extends at{static properties={min:{type:Number},max:{type:Number},value:{type:Number},step:{type:Number},color:{type:String},trackColor:{type:String},disabled:{type:Boolean},liveUpdate:{type:Boolean,attribute:"live-update"}};static styles=s`
  ...
  `;constructor(){super(),this.min=0,this.max=100,this.value=0,this.step=1,this.color="",this.trackColor="",this.disabled=!1,this.liveUpdate=!1,this._debounceTimer=null}get _fillColor(){return this.color||"var(--slider-color)"}get _trackColor(){return this.trackColor||"var(--slider-track-color)"}get _percentage(){const t=this.max-this.min;return 0===t?0:(this.value-this.min)/t*100}render(){const t=this._percentage,e=`linear-gradient(to right, ${this._fillColor} ${t}%, ${this._trackColor} ${t}%)`;return L`
    ...
    `}_onInput(t){const e=parseFloat(t.target.value);this.liveUpdate&&(clearTimeout(this._debounceTimer),this._debounceTimer=setTimeout(()=>{this._fireValueChanged(e)},100))}_onChange(t){clearTimeout(this._debounceTimer);const e=parseFloat(t.target.value);this._fireValueChanged(e)}_fireValueChanged(t){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t},bubbles:!0,composed:!0}))}}customElements.define("materia-slider",ht);const dt=t=>class extends t{_handleAction(t){if(t&&"none"!==t.action)switch(t.action){case"toggle":this.config?.entity&&this.hass.callService("homeassistant","toggle",{entity_id:this.config.entity});break;case"call-service":{const[e,i]=(t.service||"").split(".",2);e&&i&&this.hass.callService(e,i,{...t.service_data,...t.data},t.target);break}case"navigate":history.pushState(null,"",t.navigation_path),this.dispatchEvent(new Event("location-changed",{bubbles:!0,composed:!0}));break;case"more-info":this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t.entity||this.config?.entity}}))}}_capitalize(t){return t&&"string"==typeof t?t.charAt(0).toUpperCase()+t.slice(1):t}async _renderTemplate(t){if(!t||"string"!=typeof t||!t.includes("{{"))return t;try{return await this.hass.callWS({type:"render_template",template:t,entity_ids:this.config?.entity?[this.config.entity]:[]})}catch{return t}}get _hasNavigateAction(){return"navigate"===this.config?.tap_action?.action}_fireMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}},pt=t=>t.name.replace(/_/g," ").replace(/^\w/,t=>t.toUpperCase());customElements.define("materia-light-switch-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}render(){return this.hass&&this._config?L`
      ...
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class ut extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-light-switch-editor")}static getStubConfig(){return{entity:"",name:"",icon:"mdi:track-light"}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={icon:"mdi:track-light",...t}}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e="on"===t.state,i=this.config.name||t.attributes.friendly_name||this.config.entity,n=e?this._capitalize("On"):this._capitalize("Off"),o=e?"var(--md-sys-cust-color-on-light)":"var(--primary-text-color)";return L`
      <ha-card>
        <div
          class="container"
    ...
    `}_handleTap(){this.hass.callService("light","toggle",{entity_id:this.config.entity})}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-light-switch",ut),window.customCards=window.customCards||[],window.customCards.push({type:"materia-light-switch",name:"Materia Light Switch",description:"A native Lit light toggle switch card."});customElements.define("materia-light-dimmer-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class gt extends(dt(at)){static properties={hass:{attribute:!1},_config:{state:!0}};static getConfigElement(){return document.createElement("materia-light-dimmer-editor")}static getStubConfig(){return{entity:"",name:"",icon:"mdi:track-light"}}setConfig(t){if(!t.entity)throw new Error("entity is required");this._config={icon:"mdi:track-light",...t}}get _entity(){return this.hass?.states?.[this._config?.entity]}get _isOn(){return"on"===this._entity?.state}get _brightness(){return this._entity?.attributes?.brightness??0}get _brightnessPercent(){return Math.round(this._brightness/255*100)}get _name(){return this._config.name||this._entity?.attributes?.friendly_name||""}get _icon(){return this._config.icon||"mdi:track-light"}get _stateDisplay(){return this._isOn?`${this._brightnessPercent}%`:this._capitalize("Off")}_toggleLight(){this.hass.callService("light","toggle",{entity_id:this._config.entity})}_setBrightness(t){t<=3?this.hass.callService("light","turn_off",{entity_id:this._config.entity}):this.hass.callService("light","turn_on",{entity_id:this._config.entity,brightness:t})}_onPointerDown(t){this._startX=t.clientX,this._startY=t.clientY,this._dragging=!1}_onPointerMove(t){if(null==this._startX)return;const e=Math.abs(t.clientX-this._startX),i=Math.abs(t.clientY-this._startY);if(e>5&&e>i){this._dragging=!0,t.preventDefault();const e=t.currentTarget.getBoundingClientRect(),i=Math.max(0,Math.min(100,(t.clientX-e.left)/e.width*100)),n=this.shadowRoot.querySelector(".fill");n&&(n.style.width=i+"%")}}_onPointerUp(t){if(null!=this._startX){if(this._dragging){const e=t.currentTarget.getBoundingClientRect(),i=Math.max(0,Math.min(100,(t.clientX-e.left)/e.width*100)),n=Math.round(i/100*255);this._setBrightness(n)}else this._toggleLight();this._startX=null,this._dragging=!1}}render(){if(!this._config||!this.hass)return L``;const t=this._isOn,e=this._brightnessPercent;return L`
      <ha-card>
        <div class="container"
  ...
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={icon:"mdi:power-plug",button_type:"switch",color_active:"var(--md-sys-cust-color-device)",color_on_active:"var(--md-sys-cust-color-on-device)",show_state:!0,...t}}_getActiveState(){if(this.config.active_state)return String(this.config.active_state);const t=(this.config.entity||"").split(".")[0];return ft[t]||"on"}_isActive(t){if(!t)return!1;const e=this._getActiveState();return t.state===e}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=this._isActive(t),i=this.config.name||t.attributes.friendly_name||this.config.entity,n=this.config.icon,o=this.config.color_active,s=this.config.color_on_active,a=e?s:"var(--primary-text-color)";return L`
      <ha-card>
        ...
        >
          ...
          <div class="name-container">
            <div class="name">${i}</div>
            ${this.config.show_state?L`<div class="state">${this._capitalize(t.state)}</div>`:""}
          </div>
          ${this._hasNavigateAction?L`
            <ha-icon class="chevron" icon="mdi:chevron-right"></ha-icon>
          `:""}
    ...
    `}_handleTap(){this.config.tap_action?this._handleAction(this.config.tap_action):this.hass.callService("homeassistant","toggle",{entity_id:this.config.entity})}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-device",vt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-device",name:"Materia Device",description:"A native Lit generic device/switch card with active-state colors."});customElements.define("materia-lock-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"lock"}}},{name:"name",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class _t extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-lock-editor")}static getStubConfig(){return{entity:"",name:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e="locked"===t.state,i=this.config.name||t.attributes.friendly_name||this.config.entity,n=e?"m3o:lock":"m3o:lock-open-right",o=this._capitalize(t.state),s=e?"var(--md-sys-cust-color-on-device)":"var(--primary-text-color)";return L`
      <ha-card>
        <div
          class="container"
    ...
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-lock",_t),window.customCards=window.customCards||[],window.customCards.push({type:"materia-lock",name:"Materia Lock",description:"A native Lit lock display card with conditional icons."});customElements.define("materia-battery-low-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class yt extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-battery-low-editor")}static getStubConfig(){return{entity:"",name:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}_getBatteryColors(t){return t<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:t<20?["var(--md-sys-cust-color-warning-container)","var(--md-sys-cust-color-on-warning-container)"]:["var(--ha-card-background, var(--card-background-color))","var(--primary-text-color)"]}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=parseFloat(t.state)||0,i=this.config.name||t.attributes.friendly_name||this.config.entity,n=t.attributes.unit_of_measurement||"%",o=`${this._capitalize(t.state)}${n}`,[s,a]=this._getBatteryColors(e);return L`
      <ha-card>
        <div
          class="container"
    ...
    `}_renderSubButtons(){const t=this._config.sub_button;return t&&Array.isArray(t)&&0!==t.length?t.map(t=>L`
        <ha-icon
          class="sub-btn"
        ...
        ></ha-icon>
      `):L``}getCardSize(){return this._expanded?3+(this._childCards?.length||0):2}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `}customElements.define("materia-room",bt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-room",name:"Materia Room",description:"A native expandable room section with title and grid of child cards"});customElements.define("materia-climate-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"name",required:!0,selector:{text:{}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}},{name:"outdoor_temp_entity",selector:{entity:{domain:"sensor"}}},{name:"step",selector:{number:{min:.5,max:5,step:.5,mode:"box"}}}]}render(){return this.hass&&this._config?L`
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate",name:"Materia Climate",description:"A native climate thermostat card with mode-based theming"});customElements.define("materia-sensor-row-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"name",required:!0,selector:{text:{}}},{name:"padding",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class xt extends(dt(at)){static get properties(){return{hass:{attribute:!1},_config:{state:!0}}}static getConfigElement(){return document.createElement("materia-sensor-row-editor")}static getStubConfig(){return{entity:"",name:"",padding:"0px 20px"}}get config(){return this._config}setConfig(t){if(!t.entity)throw new Error("entity is required");if(!t.name)throw new Error("name is required");this._config={padding:"0px 20px",...t}}connectedCallback(){super.connectedCallback(),ct()}_handleTap(){this.hass&&this._config.tap_action&&this._handleAction(this._config.tap_action)}render(){if(!this.hass||!this._config)return L``;const t=this._config,e=this.hass.states[t.entity];if(!e)return L`<ha-card>Entity not found: ${t.entity}</ha-card>`;const i=e.state,n=e.attributes.unit_of_measurement||"",o=n?`${this._capitalize(i)} ${n}`:this._capitalize(i),s=!!t.tap_action;return L`
      <ha-card
        class="${s?"clickable":""}"
    ...
    `}}customElements.define("materia-sensor-row",xt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-sensor-row",name:"Materia Sensor Row",description:"A simple name/value row for displaying sensor data"});const wt={sunny:"m3o:sunny",clear:"m3o:sunny","clear-night":"mdi:weather-night",partlycloudy:"m3o:partly-cloudy-day",partly_cloudy:"m3o:partly-cloudy-day",cloudy:"m3o:cloud",rainy:"m3o:rainy",pouring:"m3o:rainy",snowy:"mdi:weather-snowy",fog:"m3o:foggy",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",hail:"mdi:weather-hail",exceptional:"mdi:alert-circle-outline"};customElements.define("materia-weather-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",selector:{text:{}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class $t extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(){return{entity:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=t.state,i=t.attributes.temperature,n=t.attributes.temperature_unit||"°",o=wt[e]||"mdi:weather-partly-cloudy";let s=null;if(this.config.humidity_entity){const t=this.hass.states[this.config.humidity_entity];t&&(s=t.state)}null==s&&null!=t.attributes.humidity&&(s=t.attributes.humidity);const a=e.replace(/-|_/g," ");return L`
    ...
    `}_handleTap(){this.config.tap_action?this._handleAction(this.config.tap_action):this._fireMoreInfo(this.config.entity)}getCardSize(){return 1}}customElements.define("materia-weather",$t),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather",name:"Materia Weather",description:"Weather display card with condition icons and humidity."});customElements.define("materia-sensor-display-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"unit",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Ct extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-sensor-display-editor")}static getStubConfig(){return{entity:"",name:"",icon:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;setConfig(t){this._config=t}get _schema(){return[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}},{name:"variant",selector:{select:{options:[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"},{value:"device",label:"Device"},{value:"primary-container",label:"Primary Container"},{value:"secondary-container",label:"Secondary Container"},{value:"error-container",label:"Error Container"},{value:"device-container",label:"Device Container"},{value:"battery",label:"Battery"}]}}},{name:"show_state",selector:{boolean:{}}},{name:"active_state",selector:{text:{}}},{name:"state_display",selector:{template:{}}},{name:"color",selector:{text:{}}},{name:"color_on",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      ...
      ></textarea>
    `:L``}_valueChanged(t){const e={...this._config,...t.detail.value,color_map:this._config.color_map,color_on_map:this._config.color_on_map};this._fireConfig(e)}_colorMapChanged(t){const e=t.target.value.trim();if(!e){const{color_map:t,...e}=this._config;return void this._fireConfig(e)}try{const t=JSON.parse(e);this._fireConfig({...this._config,color_map:t})}catch(t){}}_colorOnMapChanged(t){const e=t.target.value.trim();if(!e){const{color_on_map:t,...e}=this._config;return void this._fireConfig(e)}try{const t=JSON.parse(e);this._fireConfig({...this._config,color_on_map:t})}catch(t){}}_fireConfig(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}}customElements.define("materia-button-editor",kt);const Et={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-secondary)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-error)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]};class At extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-button-editor")}static getStubConfig(){return{name:"",icon:"mdi:power-plug",variant:"primary",show_state:!1,active_state:"on"}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config={show_state:!1,active_state:"on",variant:"secondary",tap_action:{action:"toggle"},...t}}_isActive(t){if(!t)return!1;const e=t.state,i=this.config.active_state||"on";return e===String(i)||"open"===e}_getBatteryColors(t){const e=parseFloat(t?.state)||0;return e<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:e<20?["var(--md-sys-cust-color-warning-container)","var(--md-sys-cust-color-on-warning-container)"]:["var(--ha-card-background)","var(--primary-text-color)"]}render(){if(!this.hass||!this.config)return L``;const t=this.config.entity,e=t?this.hass.states[t]:void 0,i=this._isActive(e),n=this.config.variant||"secondary",o=this.config.show_state;let s,a;const r=this._parseMap(this.config.color_map),c=this._parseMap(this.config.color_on_map);if(r&&e&&void 0!==r[e.state])s=r[e.state],a=c&&c[e.state]||"var(--primary-text-color)";else if("battery"===n){const[t,i]=this._getBatteryColors(e);s=t,a=i}else if(i&&t)if(this.config.color_on)s=this.config.color_on,a=this.config.color?this.config.color:"var(--primary-text-color)";else{const t=Et[n]||Et.secondary;s=t[0],a=t[1]}else s="var(--ha-card-background)",a="var(--primary-text-color)";if(!o&&!t&&["primary","tertiary","error","primary-container","secondary-container","error-container","device-container"].includes(n)){const t=Et[n]||Et.secondary;s=t[0],a=t[1]}const l=o?"with-state":"no-state",h=i?"active":"inactive";let d="";return o&&e&&(d=this.config.state_display&&!this.config.state_display.includes("{{")?this.config.state_display:e.state,d=this._capitalize(d)),L`
      <ha-card
        class="${l} ${h}"
        style="background-color: ${s}; color: ${a};"
        @click=${this._handleTap}
      >
        ...
        ${o?L`<div class="state">${d}</div>`:""}
      </ha-card>
    `}_parseMap(t){if(!t)return null;if("object"==typeof t)return t;try{return JSON.parse(t)}catch(t){return null}}_handleTap(){const t=this.config.tap_action||{action:"toggle"};this._handleAction(t)}getCardSize(){return 2}}customElements.define("materia-button",At),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"Material You small button with variants, state display, and battery mode."});const zt={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},St={xs:{height:32,innerCorner:4},s:{height:40,innerCorner:8},m:{height:48,innerCorner:8},l:{height:56,innerCorner:16},xl:{height:64,innerCorner:20}};class Ut extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config={...t}}get _schema(){return[{name:"entity",selector:{entity:{}}},{name:"attribute",selector:{text:{}}},{name:"preset",selector:{select:{options:[{value:"",label:"None"},...Object.keys(zt).map(t=>({value:t,label:t}))],mode:"dropdown"}}},{name:"size",selector:{select:{options:[{value:"xs",label:"XS (32dp)"},{value:"s",label:"S (40dp)"},{value:"m",label:"M (48dp)"},{value:"l",label:"L (56dp)"},{value:"xl",label:"XL (64dp)"}],mode:"dropdown"}}},{name:"color_active",selector:{text:{}}},{name:"color_on_active",selector:{text:{}}}]}static styles=s`
    .options-header {
      display: flex;
      align-items: center;
      justify-content: space-between;
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.options||!Array.isArray(t.options)||0===t.options.length)throw new Error("At least one option is required");this.config={size:"m",...t}}get _activeValue(){const t=this.hass?.states[this.config.entity];return this.config.attribute?String(t?.attributes?.[this.config.attribute]??""):t?.state??""}_getActiveColors(){return this.config.color_active&&this.config.color_on_active?{active:this.config.color_active,onActive:this.config.color_on_active}:this.config.preset&&zt[this.config.preset]?zt[this.config.preset]:zt.primary}render(){if(!this.hass||!this.config)return L``;const t=this.config.size||"m",{height:e,innerCorner:i}=St[t]||St.m,n=e/2,o=this._activeValue,s=this._getActiveColors(),a=this.config.options;return L`
    ...
    `}_handleOptionTap(t){t.service?this._handleAction({action:"call-service",service:t.service,service_data:t.service_data||{}}):this.config.entity&&this._fireMoreInfo(this.config.entity)}getCardSize(){return 1}}customElements.define("materia-button-group",Tt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button-group",name:"Materia Button Group",description:"M3 connected button group with presets and sizes."});class Mt extends at{static properties={hass:{attribute:!1},_config:{state:!0}};static styles=s`
    :host { display: block; }
    .yaml-label {
      font-size: 13px;
      font-weight: 500;
  ...
  `;setConfig(t){this._config=t}get _schema(){return[{name:"icon",required:!0,selector:{icon:{}}},{name:"variant",selector:{select:{options:[{value:"standard",label:"Standard"},{value:"outlined",label:"Outlined"},{value:"filled",label:"Filled"},{value:"filled-tonal",label:"Filled Tonal"}]}}},{name:"size",selector:{select:{options:[{value:"default",label:"Default (48px)"},{value:"large",label:"Large (56px)"}]}}},{name:"entity",selector:{entity:{}}}]}render(){return this.hass&&this._config?L`
      ...
      ></textarea>
    `:L``}_valueChanged(t){const e={...this._config,...t.detail.value,icon_map:this._config.icon_map,tap_action:this._config.tap_action};this._fireConfig(e)}_iconMapChanged(t){const e=t.target.value.trim();if(!e){const{icon_map:t,...e}=this._config;return void this._fireConfig(e)}try{const t=JSON.parse(e);this._fireConfig({...this._config,icon_map:t})}catch(t){}}_tapActionChanged(t){const e=t.target.value.trim();if(!e){const{tap_action:t,...e}=this._config;return void this._fireConfig(e)}try{const t=JSON.parse(e);this._fireConfig({...this._config,tap_action:t})}catch(t){}}_fireConfig(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}}customElements.define("materia-icon-button-editor",Mt);class Ot extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-icon-button-editor")}static getStubConfig(){return{icon:"mdi:play",variant:"filled",size:"default"}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");this.config={variant:"filled",size:"default",...t}}_resolveIcon(){if(!this.config.icon_map||!this.config.entity)return this.config.icon;const t=this.hass?.states[this.config.entity]?.state;return this.config.icon_map[t]??this.config.icon_map.default??this.config.icon}_defaultTapAction(){return this.config.entity?{action:"toggle"}:{action:"none"}}render(){if(!this.config)return L``;const t=this.config.variant||"filled",e="large"===this.config.size?"large":"default",i=this._resolveIcon();return L`
    ...
    `}_resolveTapAction(){if(this.config.tap_action_map&&this.config.entity){const t=this.hass?.states[this.config.entity]?.state,e=this.config.tap_action_map[t]??this.config.tap_action_map.default;if(e)return e}return this.config.tap_action||this._defaultTapAction()}_handleTap(){this._handleAction(this._resolveTapAction())}getCardSize(){return 1}}customElements.define("materia-icon-button",Ot),window.customCards=window.customCards||[],window.customCards.push({type:"materia-icon-button",name:"Materia Icon Button",description:"M3 icon button with variants"});customElements.define("materia-checkbox-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"checked_entity",selector:{entity:{}}},{name:"checked_value",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Ft extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-checkbox-editor")}static getStubConfig(){return{entity:"",name:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={tap_action:{action:"toggle"},...t}}_isChecked(t){if(this.config.checked_entity){const t=this.hass?.states[this.config.checked_entity];if(!t)return!1;const e=String(t.state??"").split(",").map(t=>t.trim()).filter(Boolean);return this.config.checked_values?this.config.checked_values.every(t=>e.includes(t)):!!this.config.checked_value&&e.includes(this.config.checked_value)}if(!t)return!1;const e=String(t.state??"").toLowerCase(),i=Number(e);return"on"===e||"true"===e||"home"===e||!Number.isNaN(i)&&i>0}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity],e=this._isChecked(t),i=this.config.name??t?.attributes?.friendly_name??this.config.entity,n=e?"mdi:checkbox-marked":"mdi:checkbox-blank-outline";return L`
    ...
    `}_handleTap(){const t=this.hass?.states[this.config.entity],e=this._isChecked(t);let i;i=e&&this.config.tap_action_checked?this.config.tap_action_checked:!e&&this.config.tap_action_unchecked?this.config.tap_action_unchecked:this.config.tap_action||{action:"toggle"},this._handleAction(i)}getCardSize(){return 1}}customElements.define("materia-checkbox",Ft),window.customCards=window.customCards||[],window.customCards.push({type:"materia-checkbox",name:"Materia Checkbox",description:"Material You checkbox row with name and toggle icon."});customElements.define("materia-circle-action-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"icon",required:!0,selector:{icon:{}}},{name:"size",selector:{select:{options:[{value:"normal",label:"Normal"},{value:"small",label:"Small"}]}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Nt extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-circle-action-editor")}static getStubConfig(){return{icon:"mdi:play",size:"normal"}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");this.config={size:"normal",...t}}render(){if(!this.config)return L``;const t="small"===this.config.size?"small":"normal";return L`
      <ha-card class="size-${t}" @click=${this._handleTap}>
        <ha-icon .icon=${this.config.icon}></ha-icon>
      </ha-card>
    `}_handleTap(){const t=this.config.tap_action;t&&this._handleAction(t)}getCardSize(){return 1}}customElements.define("materia-circle-action",Nt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-circle-action",name:"Materia Circle Action",description:"Material You circular action button in normal (66px) or small (52px) sizes."});customElements.define("materia-tonal-button-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Pt extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-tonal-button-editor")}static getStubConfig(){return{entity:"",name:"",icon:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config=t}render(){return this.config?L`
      <ha-card @click=${this._handleTap}>
        <div class="grid">
          <div class="icon-cell">
            <ha-icon .icon=${this.config.icon}></ha-icon>
    ...
    `:L``}_handleTap(){const t=this.config.tap_action;t&&this._handleAction(t)}getCardSize(){return 1}}customElements.define("materia-tonal-button",Pt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-tonal-button",name:"Materia Tonal Button",description:"Material You tonal pill button with hover and active states."});customElements.define("materia-pill-badge-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}},{name:"active_state",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class qt extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-pill-badge-editor")}static getStubConfig(){return{entity:"",name:"",icon:"",active_state:"on"}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={icon:"mdi:information-outline",...t}}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=this.config.name||t.attributes.friendly_name||this.config.entity,i=this.config.icon,n=t.attributes.unit_of_measurement||"",o=n?`${this._capitalize(t.state)} ${n}`:this._capitalize(t.state),s=this.config.color||"var(--ha-card-background, var(--card-background-color))",a=this.config.color_on||"var(--primary-text-color)";return L`
      <ha-card>
        <div
          class="container"
          style="background-color: ${s}; color: ${a};"
    ...
    `}_handleTap(){const t=this.config.tap_action||{action:"more-info"};this._handleAction(t)}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-pill",Rt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill",name:"Materia Pill",description:"Compact info pill card with configurable icon, name, state, and colors."});customElements.define("materia-separator-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"label",selector:{text:{}}},{name:"color",selector:{text:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class jt extends at{static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-separator-editor")}static getStubConfig(){return{label:""}}static styles=s`
    :host {
      display: block;
      padding: 8px 0;
    }
  ...
  `;setConfig(t){this.config={...t}}render(){if(!this.config)return L``;const t=this.config.color||"",e=t?`--separator-color: ${t}`:"",i=this.config.label;return i?L`
      <div class="separator" style="${e}">
        <div class="line"></div>
        <span class="label">${i}</span>
        <div class="line"></div>
      </div>
    `:L`<div class="separator" style="${e}"><div class="line"></div></div>`}getCardSize(){return 1}}customElements.define("materia-separator",jt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-separator",name:"Materia Separator",description:"Simple horizontal line divider with optional label."});customElements.define("materia-select-editor",class extends at{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}get _schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]}render(){return this.hass&&this._config?L`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:L``}_valueChanged(t){const e=t.detail.value;this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}});class Bt extends(dt(at)){static properties={hass:{attribute:!1},config:{state:!0}};static getConfigElement(){return document.createElement("materia-select-editor")}static getStubConfig(){return{entity:""}}static styles=s`
    :host {
      display: block;
      font-family: "Figtree", var(--ha-font-family, "Roboto"), sans-serif;
    }
  ...
  `;constructor(){super(),ct()}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}render(){if(!this.hass||!this.config)return L``;const t=this.hass.states[this.config.entity];if(!t)return L`<ha-card>Entity not found: ${this.config.entity}</ha-card>`;const e=this.config.name||t.attributes.friendly_name||this.config.entity,i=t.attributes.options||[],n=t.state;return L`
      <ha-card>
        <div class="row">
