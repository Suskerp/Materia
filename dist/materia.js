      ...
      <ha-card style="--mh-bg:${m};--mh-fg:${g};--mh-alert-bg:${h};--mh-alert-fg:${p};">
        ...
        >
          ${!1===this.config.burst?W:I`<svg class="burst ${i||d?"spin":""} ${d?"alarm":""}" viewBox="0 0 180 180" aria-hidden="true">
                ${d?H`<g class="loom"><path d=${_} /></g>`:H`<path d=${f} /><path d=${f} transform="rotate(45 90 90)" />`}
              </svg>`}
          <div class="content">
            <div class="eyebrow">
