          ...
          ${o.map(t=>I`
              <div class="gauge">
                <svg viewBox="0 0 100 100">
                  ...
                  ${t.frac>.01?H`<path d=${fe(50,50,40,-135,270*t.frac-135)} class="gauge-fill" style="stroke:${t.color||"var(--wm-accent, #7bc96a)"}" />`:""}
                </svg>
