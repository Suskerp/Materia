 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,k=e=>e,$=w.trustedTypes,C=$?$.createPolicy("lit-html",{createHTML:e=>e}):void 0,S="$lit$",z=`lit$${Math.random().toFixed(9).slice(2)}$`,T="?"+z,E=`<${T}>`,A=document,M=()=>A.createComment(""),O=e=>null===e||"object"!=typeof e&&"function"!=typeof e,F=Array.isArray,D="[ \t\n\f\r]",q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,R=/-->/g,P=/>/g,N=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),U=/'/g,L=/"/g,j=/^(?:script|style|textarea|title)$/i,B=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),I=B(1),H=B(2),W=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),G=new WeakMap,X=A.createTreeWalker(A,129);function Y(e,t){if(!F(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(t):t}const K=(e,t)=>{const i=e.length-1,s=[];let a,n=2===t?"<svg>":3===t?"<math>":"",o=q;for(let t=0;t<i;t++){const i=e[t];let r,l,c=-1,h=0;for(;h<i.length&&(o.lastIndex=h,l=o.exec(i),null!==l);)h=o.lastIndex,o===q?"!--"===l[1]?o=R:void 0!==l[1]?o=P:void 0!==l[2]?(j.test(l[2])&&(a=RegExp("</"+l[2],"g")),o=N):void 0!==l[3]&&(o=N):o===N?">"===l[0]?(o=a??q,c=-1):void 0===l[1]?c=-2:(c=o.lastIndex-l[2].length,r=l[1],o=void 0===l[3]?N:'"'===l[3]?L:U):o===L||o===U?o=N:o===R||o===P?o=q:(o=N,a=void 0);const d=o===N&&e[t+1].startsWith("/>")?" ":"";n+=o===q?i+E:c>=0?(s.push(r),i.slice(0,c)+S+i.slice(c)+z+d):i+z+(-2===c?t:d)}return[Y(e,n+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),s]};class Z{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,n=0;const o=e.length-1,r=this.parts,[l,c]=K(e,t);if(this.el=Z.createElement(l,i),X.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(s=X.nextNode())&&r.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(const e of s.getAttributeNames())if(e.endsWith(S)){const t=c[n++],i=s.getAttribute(e).split(z),o=/([.?@])?(.*)/.exec(t);r.push({type:1,index:a,name:o[2],strings:i,ctor:"."===o[1]?ie:"?"===o[1]?se:"@"===o[1]?ae:te}),s.removeAttribute(e)}else e.startsWith(z)&&(r.push({type:6,index:a}),s.removeAttribute(e));if(j.test(s.tagName)){const e=s.textContent.split(z),t=e.length-1;if(t>0){s.textContent=$?$.emptyScript:"";for(let i=0;i<t;i++)s.append(e[i],M()),X.nextNode(),r.push({type:2,index:++a});s.append(e[t],M())}}}else if(8===s.nodeType)if(s.data===T)r.push({type:2,index:a});else{let e=-1;for(;-1!==(e=s.data.indexOf(z,e+1));)r.push({type:7,index:a}),e+=z.length-1}a++}}static createElement(e,t){const i=A.createElement("template");return i.innerHTML=e,i}}function Q(e,t,i=e,s){if(t===W)return t;let a=void 0!==s?i._$Co?.[s]:i._$Cl;const n=O(t)?void 0:t._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),void 0===n?a=void 0:(a=new n(e),a._$AT(e,i,s)),void 0!==s?(i._$Co??=[])[s]=a:i._$Cl=a),void 0!==a&&(t=Q(e,a._$AS(e,t.values),a,s)),t}class J{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??A).importNode(t,!0);X.currentNode=s;let a=X.nextNode(),n=0,o=0,r=i[0];for(;void 0!==r;){if(n===r.index){let t;2===r.type?t=new ee(a,a.nextSibling,this,e):1===r.type?t=new r.ctor(a,r.name,r.strings,this,e):6===r.type&&(t=new ne(a,this,e)),this._$AV.push(t),r=i[++o]}n!==r?.index&&(a=X.nextNode(),n++)}return X.currentNode=A,s}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ee{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Q(this,e,t),O(e)?e===V||null==e||""===e?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==W&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>F(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==V&&O(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=Z.createElement(Y(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const e=new J(s,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=G.get(e.strings);return void 0===t&&G.set(e.strings,t=new Z(e)),t}k(e){F(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const a of e)s===t.length?t.push(i=new ee(this.O(M()),this.O(M()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=k(e).nextSibling;k(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}let te=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,a){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=V}_$AI(e,t=this,i,s){const a=this.strings;let n=!1;if(void 0===a)e=Q(this,e,t,0),n=!O(e)||e!==this._$AH&&e!==W,n&&(this._$AH=e);else{const s=e;let o,r;for(e=a[0],o=0;o<a.length-1;o++)r=Q(this,s[i+o],t,o),r===W&&(r=this._$AH[o]),n||=!O(r)||r!==this._$AH[o],r===V?e=V:e!==V&&(e+=(r??"")+a[o+1]),this._$AH[o]=r}n&&!s&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}};class ie extends te{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}}class se extends te{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==V)}}class ae extends te{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){if((e=Q(this,e,t,0)??V)===W)return;const i=this._$AH,s=e===V&&i!==V||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,a=e!==V&&(i===V||s);s&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ne{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Q(this,e)}}const oe=w.litHtmlPolyfillSupport;oe?.(Z,ee),(w.litHtmlVersions??=[]).push("3.3.2");const re=(e,t,i)=>{const s=i?.renderBefore??t;let a=s._$litPart$;if(void 0===a){const e=i?.renderBefore??null;s._$litPart$=a=new ee(t.insertBefore(M(),e),e,void 0,i??{})}return a._$AI(e),a
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */},le=globalThis;let ce=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=re(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}};ce._$litElement$=!0,ce.finalized=!0,le.litElementHydrateSupport?.({LitElement:ce});const he=le.litElementPolyfillSupport;let de;async function pe(){return de||(de=await window.loadCardHelpers(),de)}he?.({LitElement:ce}),(le.litElementVersions??=[]).push("4.2.2"),n`
  :host {
    display: block;
...
/>`;class be extends ce{static properties={gesture:{type:String,reflect:!0},label:{type:String},icon:{type:String},direction:{type:String},pending:{type:Boolean,reflect:!0},threshold:{type:Number},holdMs:{type:Number,attribute:"hold-ms"},disabled:{type:Boolean,reflect:!0},_p:{state:!0},_armed:{state:!0}};static styles=[ge,n`
      :host {
        display: block;
    ...
    `}}customElements.define("materia-drag-confirm",be);class ve extends ce{static properties={year:{type:Number},month:{type:Number},selected:{type:Number},firstDay:{type:Number,attribute:"first-day"},noPast:{type:Boolean,attribute:"no-past"},locale:{type:String}};static styles=[ge,n`
      :host {
        display: block;
...
`,qe=(e,t,i)=>({value:`var(--md-sys-cust-color-${e})`,swatch:`var(--md-sys-cust-color-${e}, ${i})`,label:t}),Re=(e,t)=>({value:`var(--md-sys-color-${e})`,swatch:`var(--md-sys-color-${e})`,label:t}),Pe=[{title:"Light",options:[qe("light","Light","#FEE082"),qe("light-container","Light container","#FEEFCA"),qe("on-light","On light","#745D00")]},{title:"Device",options:[qe("device","Device","#D9E2FE"),qe("device-container","Device container","#EDF0FF"),qe("on-device","On device","#0156CF")]},{title:"Climate · Heat",options:[qe("climate-heat","Heat","#FFDFD4"),qe("climate-heat-container","Heat container","#FFEEE9"),qe("on-climate-heat","On heat","#A14614"),qe("climate-heat-accent","Heat accent","#A14614")]},{title:"Climate · Cool",options:[qe("climate-cool","Cool","#D3E8FF"),qe("climate-cool-container","Cool container","#EAF3FF"),qe("on-climate-cool","On cool","#327EA7"),qe("climate-cool-accent","Cool accent","#327EA7")]},{title:"Climate · Auto",options:[qe("climate-auto","Auto","#D4EBDD"),qe("climate-auto-container","Auto container","#EAF6EE"),qe("on-climate-auto","On auto","#2E5E44"),qe("climate-auto-accent","Auto accent","#2E5E44")]},{title:"Water · Eco",options:[qe("water-eco","Eco","#C8E6C9"),qe("water-eco-container","Eco container","#E6F4EA"),qe("on-water-eco","On eco","#256029")]},{title:"Water · Performance",options:[qe("water-performance","Performance","#FFD1B0"),qe("water-performance-container","Performance container","#FFEDE0"),qe("on-water-performance","On performance","#9C3A00")]},{title:"Warning",options:[qe("warning","Warning","#D9A000"),qe("warning-container","Warning container","#FEEFCA"),qe("on-warning","On warning","#FFFFFF"),qe("on-warning-container","On warning container","#745D00")]},{title:"Error",options:[qe("error","Error","#B3261E"),qe("error-container","Error container","#F9DEDC"),qe("on-error","On error","#FFFFFF"),qe("on-error-container","On error container","#410E0B")]},{title:"Weather",options:[qe("weather-sun","Sun","#F2B500"),qe("weather-cloud","Cloud","#9FA9B7"),qe("weather-cloud-dark","Cloud (dark)","#6F7A8A"),qe("weather-rain","Rain","#2E86E0"),qe("weather-snow","Snow","#AEB8C4"),qe("weather-moon","Moon","#5961C2")]},{title:"Severity scale",options:[qe("scale-green","Scale green","#5E9E50"),qe("scale-yellow","Scale yellow","#C7A128"),qe("scale-orange","Scale orange","#D9713C"),qe("scale-red","Scale red","#C94D42"),qe("scale-purple","Scale purple","#8A4DA3"),qe("scale-maroon","Scale maroon","#7A4040")]},{title:"System (theme)",options:[Re("primary","Primary"),Re("primary-container","Primary container"),Re("secondary","Secondary"),Re("secondary-container","Secondary container"),Re("tertiary","Tertiary"),Re("tertiary-container","Tertiary container"),Re("error","Error"),Re("error-container","Error container"),Re("surface-container","Surface container")]}],Ne=new Set(Pe.flatMap(e=>e.options.map(e=>e.value)));function Ue(e){return e&&"string"==typeof e&&(e.includes("{{")||e.includes("{%"))}const Le={template:{}};class je extends ce{static properties={label:{},value:{},_open:{state:!0},_customOpen:{state:!0}};static styles=n`
  ...
  `;setConfig(e){this._config=e,this._modes??={}}_formData(){return this._config||{}}get _sections(){return[]}_sectionsSignature(){return""}get _sectionsMemo(){const e=this._sectionsSignature();return this.__secSig===e&&this.__secVal||(this.__secSig=e,this.__secVal=this._sections),this.__secVal}_stableContext(e,t,i){const s={};for(const[e,a]of Object.entries(t))s[e]=i[a];this.__ctx??={};const a=this.__ctx[e];return a&&Object.keys(s).every(e=>a[e]===s[e])?a:(this.__ctx[e]=s,s)}_modeFor(e,t){const i=this._modes?.[e];return i||(Ue(t)?"template":"simple")}_toggleMode(e){const t=this._formData()[e],i=this._modeFor(e,t);this._modes={...this._modes||{},[e]:"template"===i?"simple":"template"}}render(){if(!this.hass||!this._config)return I``;const e=this._formData();return I`
    ...
    `}_renderField(e,t){const i=t[e.name],s=e.label??Fe(e),a=!!e.template,n=a?this._modeFor(e.name,i):"simple",o=e.context?this._stableContext(e.name,e.context,t):void 0;let r;return r=a&&"template"===n?I`
        <ha-selector
          class="field-control"
          .hass=${this.hass}
          .selector=${Le}
      ...
      <ha-card>
        ...
        >
          ...
          <div class="icon-container">
            ${d?I`<div class="thumb" style="background-image: ${d};"></div>`:l?I`<ha-icon .icon=${l} style="color: ${n};"></ha-icon>`:I`<ha-state-icon
                    .hass=${this.hass}
                    .stateObj=${e}
                    style="color: ${n};"
                  ></ha-state-icon>`}
...
`;class Qe extends He{static properties={_selectedCard:{state:!0},_expandedButton:{state:!0}};static styles=[He.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
...
`;customElements.define("materia-climate-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"name",required:!0,template:!0,selector:{text:{}}}]},{title:"Sensors",icon:"mdi:thermometer",fields:[{name:"temperature_entity",label:"Temperature sensor",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}},{name:"outdoor_temp_entity",label:"Outdoor temperature sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Behavior",icon:"mdi:tune",fields:[{name:"step",selector:{number:{min:.5,max:5,step:.5,mode:"box"}}}]}]}});class tt extends(Se(ce)){static get properties(){return{hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_resolvedName:{state:!0}}}static styles=[Ee,Te,et];static getConfigElement(){return document.createElement("materia-climate-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("climate."))||"climate.example";return{entity:t,name:"Climate",step:.5}}setConfig(e){if(!e.entity)throw new Error("entity is required");if(!e.name)throw new Error("name is required");this.config={step:.5,...e}}getCardSize(){return 3}get _entity(){return this.hass?.states[this.config.entity]}get _mode(){return this._entity?.state??"off"}get _targetTemp(){return null!=this._optimisticTemp?this._optimisticTemp:this._entity?.attributes?.temperature}get _currentTemp(){return this.config.temperature_entity?this.hass?.states[this.config.temperature_entity]?.state:this._entity?.attributes?.current_temperature}get _humidity(){if(this.config.humidity_entity)return this.hass?.states[this.config.humidity_entity]?.state}get _outdoorTemp(){if(this.config.outdoor_temp_entity)return this.hass?.states[this.config.outdoor_temp_entity]?.state}_modeIcon(){switch(this._mode){case"heat":return"mdi:fire";case"cool":return"mdi:snowflake";case"auto":return"mdi:autorenew";default:return"mdi:power"}}_modeBg(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-climate-heat-container)";case"cool":return"var(--md-sys-cust-color-climate-cool-container)";case"auto":return"var(--md-sys-cust-color-climate-auto-container)";default:return"var(--md-sys-color-surface-container-highest, var(--md-sys-color-surface-variant))"}}_modeColor(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-on-climate-heat)";case"cool":return"var(--md-sys-cust-color-on-climate-cool)";case"auto":return"var(--md-sys-cust-color-on-climate-auto)";default:return"var(--primary-text-color)"}}_buttonBg(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-climate-heat)";case"cool":return"var(--md-sys-cust-color-climate-cool)";case"auto":return"var(--md-sys-cust-color-climate-auto)";default:return"var(--md-sys-color-surface-container-highest, var(--md-sys-color-surface-variant))"}}_buttonColor(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-on-climate-heat)";case"cool":return"var(--md-sys-cust-color-on-climate-cool, #fff)";case"auto":return"var(--md-sys-cust-color-on-climate-auto, #000)";default:return"var(--md-sys-color-on-surface)"}}_statusText(){const e=this._currentTemp,t=this._humidity,i=this._outdoorTemp,s=[];return null!=e&&s.push(`${e}°`),null!=t&&s.push(`${t}%`),null!=i&&s.push(`${i}°`),s.join(" · ")||""}_adjustTemp(e){const t=this._targetTemp;if(null==t)return;const i=this.config.step??.5,s=Number(this._entity?.attributes?.min_temp??7),a=Number(this._entity?.attributes?.max_temp??35),n=Math.min(a,Math.max(s,Math.round((Number(t)+e)/i)*i));this._optimisticTemp=n,this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:n}),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4)}updated(e){if(e.has("hass")&&this.hass&&this._resolveField("name","_resolvedName"),e.has("hass")&&null!=this._optimisticTemp){const e=Number(this._entity?.attributes?.temperature);Number.isFinite(e)&&Math.abs(e-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._optimisticTimer)}_handleTap(e){e.target.closest(".btn")||this._handleAction(this.config.tap_action??{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const e=this._entity,t=this._isUnavailable(e),i="off"===this._mode||t,s=t?"Unavailable":i?"Off":null!=this._targetTemp?Math.round(this._targetTemp):"—";return I`
    ...
    `}}customElements.define("materia-climate",tt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate",name:"Materia Climate",description:"Climate thermostat with mode-based theming and temperature controls.",preview:!0});const it=[Ee,ze,Te,n`
  .container {
    position: relative;
    width: 100%;
    min-height: 50px;
...
`];customElements.define("materia-weather-editor",class extends He{_formData(){return{show_temperature:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Sensors",icon:"mdi:water-percent",fields:[{name:"show_temperature",label:"Show temperature",selector:{boolean:{}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const st={sunny:"m3o:sunny",clear:"m3o:sunny","clear-night":"mdi:weather-night",partlycloudy:"m3o:partly-cloudy-day",partly_cloudy:"m3o:partly-cloudy-day",cloudy:"m3o:cloud",rainy:"m3o:rainy",pouring:"m3o:rainy",snowy:"mdi:weather-snowy",fog:"m3o:foggy",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",hail:"mdi:weather-hail",exceptional:"mdi:alert-circle-outline"},at={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class nt extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}static styles=it;setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"",s=!1!==this.config.show_temperature;let a=e?.attributes?.temperature,n=e?.attributes?.temperature_unit||"°";if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&(a=e.state,n=e.attributes?.unit_of_measurement||n)}const o=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||st[i]||"mdi:weather-partly-cloudy";let r=null;if(this.config.humidity_entity){const e=this.hass.states[this.config.humidity_entity];e&&(r=e.state)}null==r&&null!=e?.attributes?.humidity&&(r=e.attributes.humidity);const l=at[i]||this._capitalize(i.replace(/-|_/g," ")),c=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,h=s&&null!=a?`${a}${n}`:null;let d;d=t?"Unavailable":c||(h||(l||"—"));const p=[];t||(h&&d!==h&&p.push(h),d!==l&&p.push(l),null!=r&&p.push(`${r}%`));const u=p.join(" · ");return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}function ot(e,t,i,s=12){return rt(e,t,i,{vertices:s,innerRadius:.8,rounding:.5,rotate:-Math.PI/2})}function rt(e,t,i,{vertices:s,innerRadius:a=null,rounding:n=.2,rotate:o=0}={}){const r=[],l=null!=a?2*s:s;for(let s=0;s<l;s++){const c=null!=a&&s%2==1?i*a:i,h=o+s/l*Math.PI*2;r.push({x:e+c*Math.cos(h),y:t+c*Math.sin(h),r:n*i})}return function(e){return ct(lt(e))}(r)}function lt(e){const t=e.length,i=[];for(let s=0;s<t;s++){const a=e[(s-1+t)%t],n=e[s],o=e[(s+1)%t],r=[a.x-n.x,a.y-n.y],l=[o.x-n.x,o.y-n.y],c=Math.hypot(...r),h=Math.hypot(...l);r[0]/=c,r[1]/=c,l[0]/=h,l[1]/=h;const d=r[0]*l[0]+r[1]*l[1],p=Math.acos(Math.min(1,Math.max(-1,d)))/2;let u=n.r/Math.tan(p);u=Math.min(u,.5*c,.5*h);const m=u*Math.tan(p),g=[n.x+r[0]*u,n.y+r[1]*u],f=[n.x+l[0]*u,n.y+l[1]*u],_=r[0]+l[0],b=r[1]+l[1],v=Math.hypot(_,b)||1,y=m/Math.sin(p),x=[n.x+_/v*y,n.y+b/v*y],w=r[0]*l[1]-r[1]*l[0];i.push({T1:g,T2:f,C:x,rEff:m,sweep:w>0?0:1})}return i}function ct(e){const t=e.length;let i=`M${e[0].T1[0].toFixed(2)} ${e[0].T1[1].toFixed(2)} `;for(let s=0;s<t;s++){const a=e[s],n=e[(s+1)%t];i+=`A${a.rEff.toFixed(2)} ${a.rEff.toFixed(2)} 0 0 ${a.sweep} ${a.T2[0].toFixed(2)} ${a.T2[1].toFixed(2)} `,i+=`L${n.T1[0].toFixed(2)} ${n.T1[1].toFixed(2)} `}return i+"Z"}function ht(e,t,i,s=0){return dt(e,t,i,s,[{x:.193,y:.277,r:.053},{x:.176,y:.055,r:.053}],10)}function dt(e,t,i,s,a,n){const o=[];for(let e=0;e<n;e++){const t=s+e/n*Math.PI*2,i=Math.cos(t),r=Math.sin(t);for(const e of a){const t=e.x-.5,s=e.y-.5;o.push({x:.5+t*i-s*r,y:.5+t*r+s*i,r:e.r})}}const r=lt(o),l=[];for(const e of r){const t=Math.atan2(e.T1[1]-e.C[1],e.T1[0]-e.C[0]);let i=Math.atan2(e.T2[1]-e.C[1],e.T2[0]-e.C[0])-t;if(1===e.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=8;s++){const a=t+i*s/8;l.push([e.C[0]+e.rEff*Math.cos(a),e.C[1]+e.rEff*Math.sin(a)])}}const c=Math.max(...l.map(([e,t])=>Math.hypot(e-.5,t-.5))),h=i/c,d=i=>[e+(i[0]-.5)*h,t+(i[1]-.5)*h];return ct(r.map(e=>({T1:d(e.T1),T2:d(e.T2),C:d(e.C),rEff:e.rEff*h,sweep:e.sweep})))}function pt(e,t,i,{points:s,reps:a=1,mirroring:n=!1,rotate:o=0}){const r=function(e,t,i,s=.5,a=.5){const n=[];if(!i){const i=e.length;for(let o=0;o<i*t;o++){const r=e[o%i],l=360*Math.floor(o/i)/t*(Math.PI/180),c=r.x-s,h=r.y-a;n.push({x:s+c*Math.cos(l)-h*Math.sin(l),y:a+c*Math.sin(l)+h*Math.cos(l),r:r.r})}return n}const o=e.map(e=>180*Math.atan2(e.y-a,e.x-s)/Math.PI),r=e.map(e=>Math.hypot(e.x-s,e.y-a)),l=2*t,c=360/l;for(let t=0;t<l;t++){const i=t%2==0;for(let l=0;l<e.length;l++){const h=i?l:e.length-1-l;if(!(h>0||i))continue;const d=(c*t+(i?o[h]:c-o[h]+2*o[0]))*(Math.PI/180);n.push({x:s+Math.cos(d)*r[h],y:a+Math.sin(d)*r[h],r:e[h].r})}}return n}(s,a,n),l=Math.cos(o),c=Math.sin(o),h=r.map(e=>{const t=e.x-.5,i=e.y-.5;return{x:.5+t*l-i*c,y:.5+t*c+i*l,r:e.r}}),d=lt(h),p=function(e){let t=1/0,i=1/0,s=-1/0,a=-1/0;const n=(e,n)=>{e<t&&(t=e),e>s&&(s=e),n<i&&(i=n),n>a&&(a=n)};for(const t of e){const e=Math.atan2(t.T1[1]-t.C[1],t.T1[0]-t.C[0]);let i=Math.atan2(t.T2[1]-t.C[1],t.T2[0]-t.C[0])-e;if(1===t.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=16;s++){const a=e+i*s/16;n(t.C[0]+t.rEff*Math.cos(a),t.C[1]+t.rEff*Math.sin(a))}}return{minX:t,minY:i,maxX:s,maxY:a}}(d),u=p.maxX-p.minX,m=p.maxY-p.minY,g=i/Math.max(u,m),f=(p.minX+p.maxX)/2,_=(p.minY+p.maxY)/2,b=i=>[e+(i[0]-f)*g,t+(i[1]-_)*g];return ct(d.map(e=>({T1:b(e.T1),T2:b(e.T2),C:b(e.C),rEff:e.rEff*g,sweep:e.sweep})))}function ut(e,t,i,s,a){const n=s=>{const a=(s-90)*Math.PI/180;return[e+i*Math.cos(a),t+i*Math.sin(a)]},[o,r]=n(s),[l,c]=n(a),h=Math.abs(a-s)>180?1:0;return`M${o.toFixed(2)} ${r.toFixed(2)} A${i} ${i} 0 ${h} 1 ${l.toFixed(2)} ${c.toFixed(2)}`}function mt(e,t,i,s){const a=Math.cos(2*Math.PI*s);if(s<.02||s>.98)return"";const n=Math.max(.01,Math.abs(a)*i).toFixed(2),o=`${e} ${t-i}`,r=`${e} ${t+i}`;return s<=.5?`M${o} A${i} ${i} 0 0 1 ${r} A${n} ${i} 0 0 ${a>0?0:1} ${o} Z`:`M${o} A${i} ${i} 0 0 0 ${r} A${n} ${i} 0 0 ${a>0?1:0} ${o} Z`}function gt(e,t){const i={new_moon:0,waxing_crescent:.125,first_quarter:.25,waxing_gibbous:.375,full_moon:.5,waning_gibbous:.625,last_quarter:.75,waning_crescent:.875},s=t?e?.states?.[t]:e?.states?.["sensor.moon_phase"]??e?.states?.["sensor.moon"];return s&&s.state in i?i[s.state]:null}customElements.define("materia-weather",nt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather",name:"Materia Weather",description:"Weather condition card with automatic icon mapping.",preview:!0});const ft="var(--md-sys-cust-color-weather-sun, #FFC83D)",_t="var(--md-sys-cust-color-weather-cloud, #E6EAF0)",bt="var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)",vt="var(--md-sys-cust-color-weather-rain, #5FA8F5)",yt="var(--md-sys-cust-color-weather-sun, #FFC83D)",xt="var(--md-sys-cust-color-weather-moon, #DCE3F7)";let wt=0;function kt(e,t,i,s){const a=.1*i,n=72,o=[];for(let s=0;s<n;s++){const r=s/n*Math.PI*2,l=i+a*Math.cos(9*r);o.push([e+l*Math.cos(r),t+l*Math.sin(r)])}let r=`M${o[0][0].toFixed(2)} ${o[0][1].toFixed(2)} `;for(let e=0;e<n;e++){const t=o[(e-1+n)%n],i=o[e],s=o[(e+1)%n],a=o[(e+2)%n],l=i[0]+(s[0]-t[0])/6,c=i[1]+(s[1]-t[1])/6,h=s[0]-(a[0]-i[0])/6,d=s[1]-(a[1]-i[1])/6;r+=`C${l.toFixed(2)} ${c.toFixed(2)} ${h.toFixed(2)} ${d.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return H`<path d=${r+"Z"} fill=${s} />`}function $t(e,t,i,s){return H`
...
`];customElements.define("materia-weather-tile-editor",class extends He{_formData(){return{show_minmax:!1,size:10,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"icon",label:"Custom icon (overrides the colored glyph)",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Min / Max",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show min / max",selector:{boolean:{}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"size",label:"Size (10 = fill)",selector:{number:{min:1,max:10,step:1,mode:"slider"}}},{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / temperature",color:!0,template:!0,selector:{text:{}}},{name:"minmax_color",label:"Min / max color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class At extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedMinmaxColor:{state:!0},_forecast:{state:!0}};static styles=Et;static getConfigElement(){return document.createElement("materia-weather-tile-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,show_minmax:!0}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("minmax_color","_resolvedMinmaxColor"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"";let s=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&(s=e.state)}const a=null!=this._num(s)?`${this._num(s)}°`:"—",n=e=>{const t=e?this.hass.states[e]:null;return t&&!this._isUnavailable(t)?t.state:null};let o=n(this.config.low_entity),r=n(this.config.high_entity);const l=this._forecast?.[0]||e?.attributes?.forecast?.[0];null==o&&null!=l?.templow&&(o=l.templow),null==r&&null!=l?.temperature&&(r=l.temperature);const c=this.config.show_minmax&&(null!=this._num(o)||null!=this._num(r)),h=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,d=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,p=this._isTemplate(this.config.minmax_color)?this._resolvedMinmaxColor:this.config.minmax_color;let u="number"==typeof this.config.tilt?this.config.tilt:{right:-45,left:45,none:0}[this.config.tilt]??-45;this.config.mirror&&(u=-u);const m=this.config.icon_size??(c?34:36),g=this.config.text_size??(c?26:30),f=this.config.minmax_size??5.5,_=this.config.temp_x??5,b=this.config.temp_y??-18,v=this.config.icon_x??-5,y=this.config.icon_y??18,x=this.config.width??100,w=(this.config.height??85)/100,k=(this.config.pill_scale??88)/100,$=`--wt-size:${["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][Math.min(10,Math.max(1,this.config.size??10))-1]};--wt-tilt:${u}deg;--wt-pill-scale:${k};--wt-icon-size:${m}cqi;--wt-temp-size:${g}cqi;--wt-minmax-size:${f}cqi;--wt-width:${x}%;--wt-ratio:${w};--wt-temp-x:${_}cqi;--wt-temp-y:${b}cqi;--wt-icon-x:${v}cqi;--wt-icon-y:${y}cqi;${h?`--wt-bg:${h};`:""}${d?`--wt-fg:${d};`:""}`+(p?`--wt-minmax:${p};--wt-minmax-opacity:1;`:""),C=this.config.icon;return I`
  ...
  `];customElements.define("materia-weather-hero-editor",class extends He{_formData(){return{show_condition:!0,show_icon:!0,show_feels_like:!0,show_minmax:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Real temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"feels_like_entity",label:"Feels-like sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"show_condition",label:"Show condition text",selector:{boolean:{}}},{name:"show_icon",label:"Show condition glyph",selector:{boolean:{}}},{name:"show_feels_like",label:"Show feels-like",selector:{boolean:{}}}]},{title:"Night / Day",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show night / day range",selector:{boolean:{}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"night_label",label:"Night label",selector:{text:{}}},{name:"day_label",label:"Day label",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const Ot={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class Ft extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColorOn:{state:!0}};static styles=Mt;static getConfigElement(){return document.createElement("materia-weather-hero-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color_on","_resolvedColorOn"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"",s=Ot[i]||this._capitalize(String(i).replace(/-|_/g," "));let a=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&!this._isUnavailable(e)&&(a=e.state)}const n=this._num(a);let o=e?.attributes?.apparent_temperature;if(this.config.feels_like_entity){const e=this.hass.states[this.config.feels_like_entity];e&&!this._isUnavailable(e)&&(o=e.state)}const r=this._num(o),l=e=>{const t=e?this.hass.states[e]:null;return t&&!this._isUnavailable(t)?t.state:null};let c=l(this.config.low_entity),h=l(this.config.high_entity);const d=this._forecast?.[0]||e?.attributes?.forecast?.[0];null==c&&null!=d?.templow&&(c=d.templow),null==h&&null!=d?.temperature&&(h=d.temperature);const p=this._num(c),u=this._num(h),m=this.config.night_label??ke("wh_night",this.hass),g=this.config.day_label??ke("wh_day",this.hass),f=this.config.separator??"•",_=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}function Dt(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}function qt(e,{locale:t="en",showPrecip:i=!0,minPrecip:s=10,moonPhase:a=null}={}){return e.map(e=>{const n=Dt(e.temperature),o=Dt(e.precipitation_probability),r=new Date(e.datetime),l=Number.isNaN(r.getTime())?"":r.toLocaleTimeString(t,{hour:"numeric"});return I`
      <div class="hour">
        <span class="h-temp">${null!=n?`${n}°`:"—"}</span>
        <svg class="h-glyph" viewBox="0 0 24 24">${Tt(e.condition,a)}</svg>
        ${i&&null!=o&&o>=s?I`<span class="h-precip">${o}%</span>`:I`<span class="h-precip empty"></span>`}
        <span class="h-time">${l}</span>
      </div>
    `})}customElements.define("materia-weather-hero",Ft),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-hero",name:"Materia Weather Hero",description:"Current-conditions hero: condition, huge temperature, feels-like and night/day range.",preview:!0});const Rt=n`
  .hours {
    display: flex;
    gap: 4px;
    overflow-x: auto;
...
`,Pt=[Ee,ze,Te,ge,Rt,n`
  ...
  `];customElements.define("materia-forecast-daily-editor",class extends He{_formData(){return{days:10,show_hourly:!0,show_precipitation:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"days",label:"Days shown",selector:{number:{min:3,max:15,step:1,mode:"slider"}}},{name:"show_hourly",label:"Tap a day to expand its hourly detail",selector:{boolean:{}}},{name:"show_precipitation",label:"Show precipitation chance",selector:{boolean:{}}},{name:"min_precipitation",label:"Hide below (%)",selector:{number:{min:0,max:100,step:5,mode:"box"}}},{name:"today_label",label:"Label for today",selector:{text:{}}}]}]}});class Ut extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_hourly:{state:!0},_selected:{state:!0},_expanded:{state:!0}};static styles=Nt;static getConfigElement(){return document.createElement("materia-forecast-daily-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0,this._selected=0,this._expanded=!1}updated(e){e.has("hass")&&this.hass&&this._subscribeForecast()}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=null,this._hourly=[],this._hourlyByDay=new Map;const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});if(t.catch(()=>{}),this._fcUnsubs=[t],!1!==this.config.show_hourly){const t=this.hass.connection.subscribeMessage(e=>{this._hourly=e?.forecast||[];const t=new Map;for(const e of this._hourly){const i=this._dayKey(e.datetime);if(!i)continue;const s=t.get(i)||[];s.length<24&&s.push(e),t.set(i,s)}this._hourlyByDay=t},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e});t.catch(()=>{}),this._fcUnsubs.push(t)}}_unsubForecast(){for(const e of this._fcUnsubs||[])e.then(e=>e&&e()).catch(()=>{});this._fcUnsubs=null,this._fcEntity=void 0}_dayKey(e){const t=this.hass?.config?.time_zone;if(!this._dayFmt||this._dayFmtTz!==t){this._dayFmtTz=t;try{this._dayFmt=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"})}catch{this._dayFmt=new Intl.DateTimeFormat("en-CA",{year:"numeric",month:"2-digit",day:"2-digit"})}}const i=new Date(e);return Number.isNaN(i.getTime())?"":this._dayFmt.format(i)}_hoursFor(e){return e?.datetime&&this._hourlyByDay?.size&&this._hourlyByDay.get(this._dayKey(e.datetime))||[]}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}_dayLabel(e,t){const i=new Date(e);if(Number.isNaN(i.getTime()))return"";const s=new Date;if(0===t&&this._dayKey(e)===this._dayKey(s))return this.config.today_label??ke("fc_today",this.hass);const a=this.hass?.locale?.language||navigator.language||"en";return i.toLocaleDateString(a,{weekday:"short"})}_onPointerDown(e){if("mouse"!==e.pointerType)return;const t=e.currentTarget;this._dragStartX=e.clientX,this._dragStartScroll=t.scrollLeft,this._didDrag=!1,this._dragPointerId=e.pointerId}_onPointerMove(e){if(null==this._dragStartX)return;const t=e.clientX-this._dragStartX;!this._didDrag&&Math.abs(t)>4&&(this._didDrag=!0,e.currentTarget.setPointerCapture(this._dragPointerId)),this._didDrag&&(e.currentTarget.scrollLeft=this._dragStartScroll-t)}_onPointerUp(e){null!=this._dragStartX&&(e.currentTarget.releasePointerCapture?.(e.pointerId),this._dragStartX=null,setTimeout(()=>{this._didDrag=!1},0))}_select(e,t){this._didDrag||(this._expanded=e!==this._selected||!this._expanded,this._selected=e,this.dispatchEvent(new CustomEvent("materia-forecast-day-selected",{detail:{index:e,day:t},bubbles:!0,composed:!0})))}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=(this._forecast?.length?this._forecast:e?.attributes?.forecast||[]).slice(0,this.config.days??10);if(!i.length)return I``;const s=!1!==this.config.show_precipitation,a=this.config.min_precipitation??10,n=i[this._selected],o=!1!==this.config.show_hourly&&this._expanded&&n?this._hoursFor(n):[],r=this._expanded&&o.length>0,l=this.hass?.locale?.language||navigator.language||"en";return I`
        ...
        <div class="detail ${r?"open":""}">
          <div class="detail-inner">
            <div
              ...
              @pointercancel=${this._onPointerUp}
            >
              ${r?qt(o,{locale:l,showPrecip:s,minPrecip:a,moonPhase:gt(this.hass,this.config.moon_entity)}):""}
            </div>
          </div>
        </div>
      </ha-card>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-hourly",Lt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-hourly",name:"Materia Forecast Hourly",description:"Pixel-style hourly forecast strip with colored glyphs and precipitation chance.",preview:!0});const jt=[Ee,ze,Te,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Bt=[{value:"wind",label:"Wind"},{value:"uv",label:"UV index"},{value:"aqi",label:"Air quality"},{value:"pollen",label:"Pollen"},{value:"precipitation",label:"Precipitation"},{value:"sun",label:"Sunrise & sunset"},{value:"visibility",label:"Visibility"},{value:"humidity",label:"Humidity"},{value:"pressure",label:"Pressure"}],It={pollen:{variant:"gauges",max_shown:4}};customElements.define("materia-weather-metric-editor",class extends He{_formData(){return{metric:"wind",...It[this._config?.metric],...this._config}}_sectionsSignature(){return this._config?.metric||""}get _sections(){const e=this._config?.metric,t={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"metric",required:!0,selector:{select:{mode:"dropdown",options:Bt}}},..."sun"!==e&&"pollen"!==e?[{name:"entity",label:"Weather entity",selector:{entity:{domain:"weather"}}},{name:"sensor",label:"Sensor override (optional)",selector:{entity:{domain:"sensor"}}}]:[],{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon (overrides default)",selector:{icon:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"wind"===e&&i.fields.push({name:"unit",label:"Unit (converts from the source)",selector:{select:{mode:"dropdown",options:[{value:"km/h",label:"km/h"},{value:"m/s",label:"m/s"},{value:"mph",label:"mph"},{value:"kn",label:"knots"},{value:"bft",label:"Beaufort"}]}}},{name:"bearing_entity",label:"Bearing sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"from_label",label:'"From" label',selector:{text:{}}}),"humidity"===e&&i.fields.push({name:"dew_entity",label:"Dew point sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"dew_label",label:"Dew point label",selector:{text:{}}}),"pressure"===e&&i.fields.push({name:"min",label:"Gauge min",selector:{number:{mode:"box"}}},{name:"max",label:"Gauge max",selector:{number:{mode:"box"}}}),"precipitation"===e&&i.fields.push({name:"total_label",label:"Subtitle when raining",selector:{text:{}}},{name:"none_label",label:'"None expected" label',selector:{text:{}}}),"sun"===e&&i.fields.push({name:"sun_entity",label:"Sun entity",selector:{entity:{domain:"sun"}}},{name:"moon_entity",label:"Moon phase sensor (built-in Moon integration)",selector:{entity:{domain:"sensor"}}}),"pollen"===e&&i.fields.push({name:"entities",label:"Pollen sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"variant",label:"Variant",selector:{select:{mode:"dropdown",options:[{value:"gauges",label:"Gauges (wide)"},{value:"small",label:"Small (dot list)"}]}}},{name:"max_shown",label:"Max species shown (worst first)",selector:{number:{min:1,max:6,step:1,mode:"slider"}}},{name:"hide_inactive",label:"Hide species at 'none'",selector:{boolean:{}}},{name:"max",label:"Scale max for numeric sensors (default 4)",selector:{number:{min:1,max:10,mode:"box"}}});const s={title:"Appearance",icon:"mdi:palette-outline",fields:[..."wind"===e?[{name:"shape_color",label:"Shape color",color:!0,template:!0,selector:{text:{}}}]:[],{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},a={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[t,i,s,a]:[t,s,a]}});const Ht="var(--md-sys-cust-color-scale-green, #5E9E50)",Wt="var(--md-sys-cust-color-scale-yellow, #C7A128)",Vt="var(--md-sys-cust-color-scale-orange, #D9713C)",Gt="var(--md-sys-cust-color-scale-red, #C94D42)",Xt="var(--md-sys-cust-color-scale-purple, #8A4DA3)",Yt=[{max:2,label:"Low",color:Ht},{max:5,label:"Moderate",color:Wt},{max:7,label:"High",color:Vt},{max:10,label:"Very high",color:Gt},{max:1/0,label:"Extreme",color:Xt}],Kt=[{max:50,label:"Good air quality",color:Ht},{max:100,label:"Moderate air quality",color:Wt},{max:150,label:"Unhealthy for sensitive groups",color:Vt},{max:200,label:"Unhealthy air quality",color:Gt},{max:300,label:"Very unhealthy air quality",color:Xt},{max:1/0,label:"Hazardous air quality",color:"var(--md-sys-cust-color-scale-maroon, #7A4040)"}],Zt=["None","Low","Moderate","High","Very high"];class Qt extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=jt;static getConfigElement(){return document.createElement("materia-weather-metric-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,metric:"wind"}}setConfig(e){if(!e.metric)throw new Error("metric is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),"precipitation"!==this.config.metric||this.config.sensor?this._unsubForecast():this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){"precipitation"!==this.config?.metric||this.config.sensor||this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_numRaw(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}_value(e){if(this.config.sensor){const e=this.hass.states[this.config.sensor];return e&&!this._isUnavailable(e)?this._numRaw(e.state):null}const t=this.hass.states[this.config.entity];return this._numRaw(t?.attributes?.[e])}_weatherAttr(e){return this.hass.states[this.config.entity]?.attributes?.[e]}_scallopWave(e){const t=200/12;let i=`M0 ${e+3.2} `;for(let s=0;s<200;s+=t)i+=`Q ${s+t/2} ${e-3.2} ${s+t} ${e+3.2} `;return i+"V100 H0 Z"}render(){if(!this.hass||!this.config)return I``;const e={wind:()=>this._wind(),uv:()=>this._uv(),aqi:()=>this._aqi(),pollen:()=>this._pollen(),precipitation:()=>this._precipitation(),sun:()=>this._sun(),visibility:()=>this._visibility(),humidity:()=>this._humidity(),pressure:()=>this._pressure()}[this.config.metric];if(!e)return I``;const t=e();if(t===V)return I``;const i=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,s=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,a=null!=this.config.size?Math.min(10,Math.max(1,this.config.size)):null;return I`
    ...
    `}_uv(){const e=this._value("uv_index");if(null==e)return V;const t=Yt.find(t=>e<=t.max),i=Yt.map((e,i)=>{const s=(160-35*i)*Math.PI/180,a=50+33*Math.cos(s),n=52+33*Math.sin(s),o=e===t;return H`<circle cx=${a} cy=${n} r=${o?4.5:2.6}
    ...
    `}_pressure(){const e=this._value("pressure");if(null==e)return V;const t=this.config.unit??this._weatherAttr("pressure_unit")??"hPa",i=this.config.min??("hPa"===t?950:28),s=this.config.max??("hPa"===t?1050:31),a=Math.min(1,Math.max(0,(e-i)/(s-i))),n=270*a-135,o=this.hass?.locale?.language||navigator.language||"en",r="hPa"===t?Math.round(e).toLocaleString(o):e;return I`
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          ...
          ${a>.01?H`<path d=${ut(50,52,37.5,-135,n)} class="gauge-fill thin" />`:""}
        </svg>
        <div class="overlay">
    ...
    `}_sun(){const e=this.hass.states[this.config.sun_entity??"sun.sun"];if(!e)return V;const t=e.attributes?.next_rising,i=e.attributes?.next_setting;if(!t||!i)return V;const s=this.hass?.locale?.language||navigator.language||"en",a=e=>new Date(e).toLocaleTimeString(s,{hour:"numeric",minute:"2-digit"}),n=e=>e.getHours()+e.getMinutes()/60,o=n(new Date(t)),r=n(new Date(i)),l=n(new Date),c=(r-o+24)%24||12,h=24-c,d=24,p=e=>e/24*100,u=e=>{const t=(e-o+24)%24;return t<=c?d-17*Math.sin(Math.PI*t/c):d+9*Math.sin(Math.PI*(t-c)/h)},m=(e,t)=>{const i=[];for(let s=e;s<t;s+=.25)i.push(`${p(s).toFixed(2)} ${u(s).toFixed(2)}`);return i.push(`${p(t).toFixed(2)} ${u(t).toFixed(2)}`),i.join(" L")},g=`M${p(o).toFixed(2)} 24 L${m(o,r)} Z`,f=o>.01?`M0 24 L${m(0,o)} Z`:"",_=r<23.99?`M${p(r).toFixed(2)} 24 L${m(r,24)} L100 24 Z`:"",b=(l-o+24)%24<=c,v=p(l),y=u(l),x=this.config.moon_entity??(this.hass.states["sensor.moon_phase"]?"sensor.moon_phase":"sensor.moon"),w=this.hass.states[x],k=gt(this.hass,this.config.moon_entity),$=k??.5;return I`
      <div class="rect-tile sun">
        ...
        <svg class="sun-arc cycle" viewBox="0 0 100 40">
          ...
          ${b?H`<path d=${function(e,t,i,s=12,a=.1*i,n=0){const o=Math.max(8*s,48),r=[];for(let l=0;l<o;l++){const c=l/o*Math.PI*2,h=i+a*Math.cos(s*c+n);r.push([e+h*Math.cos(c),t+h*Math.sin(c)])}let l=`M${r[0][0].toFixed(2)} ${r[0][1].toFixed(2)} `;for(let e=0;e<o;e++){const t=r[(e-1+o)%o],i=r[e],s=r[(e+1)%o],a=r[(e+2)%o],n=i[0]+(s[0]-t[0])/6,c=i[1]+(s[1]-t[1])/6,h=s[0]-(a[0]-i[0])/6,d=s[1]-(a[1]-i[1])/6;l+=`C${n.toFixed(2)} ${c.toFixed(2)} ${h.toFixed(2)} ${d.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return l+"Z"}(v,y,5.5,9,.6)} fill="var(--md-sys-cust-color-weather-sun, #FFC83D)" />`:H`
  ...
  `];class ni extends He{static styles=[He.styles,n`
      .yaml-note {
        margin-top: 14px;
        padding: 10px 12px;
        border-radius: 12px;
...
rows:
  ...
  - entity: sensor.over_kw
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1+(Array.isArray(this.config?.rows)&&this.config.rows.length?this.config.rows.length:this.config?.entities?.length||0)}}function ri(e,t){return!(!Array.isArray(e)||0===e.length)&&e.every(e=>ci(e,t))}function li(e){return Array.isArray(e)?e:null==e?[]:[e]}function ci(e,t){if(!e||"object"!=typeof e)return!1;switch(e.condition??"state"){case"state":{if(!e.entity)return!1;const i=t?.states?.[e.entity],s=e.attribute?i?.attributes?.[e.attribute]:i?.state,a=null==s?"":String(s);return null!=e.state?li(e.state).map(String).includes(a):null!=e.state_not&&!li(e.state_not).map(String).includes(a)}case"numeric_state":{if(!e.entity)return!1;const i=t?.states?.[e.entity],s=Number(e.attribute?i?.attributes?.[e.attribute]:i?.state);if(!Number.isFinite(s))return!1;const a=e=>Number("string"==typeof e&&t?.states?.[e]?t.states[e].state:e);return(null==e.above||s>a(e.above))&&((null==e.below||s<a(e.below))&&(null!=e.above||null!=e.below))}case"screen":return!!e.media_query&&window.matchMedia(e.media_query).matches;case"user":return li(e.users).includes(t?.user?.id);case"and":return li(e.conditions).every(e=>ci(e,t));case"or":return li(e.conditions).some(e=>ci(e,t));case"not":return li(e.conditions).length>0&&!li(e.conditions).some(e=>ci(e,t));default:return!1}}customElements.define("materia-list",oi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-list",name:"Materia List",description:"Rows of entity readings and/or lines of text — name left, value right, or icon plus a full-width line. Optional tonal surface.",preview:!0});const hi=e=>class extends e{get _disabledByCondition(){const e=this.config?.disabled_when??this.config?.disabled;return Array.isArray(e)&&ri(e,this.hass)}willUpdate(e){super.willUpdate?.(e),this.toggleAttribute("card-disabled",this._disabledByCondition)}},di=n`
  :host([card-disabled]) {
    opacity: 0.38;
    pointer-events: none;
  }
`,pi=[Ee,ze,Te,ge,n`
  ...
  `];customElements.define("materia-switch-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",label:"Name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"secondary",label:"Secondary text / template",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Row color (e.g. escalate from state)",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon color",color:!0,template:!0,selector:{text:{}}},{name:"switch_color",label:"Switch track color when on",color:!0,template:!0,selector:{text:{}}},{name:"switch_color_on",label:"Switch thumb color when on",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});class ui extends(hi(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedSecondary:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedSwitchColor:{state:!0},_resolvedSwitchColorOn:{state:!0}};static styles=[pi,di];static getConfigElement(){return document.createElement("materia-switch-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("switch.")||e.startsWith("input_boolean."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("Materia Switch: entity is required");this.config=e}updated(e){e.has("hass")&&this.hass&&(this._resolveField("secondary","_resolvedSecondary"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("switch_color","_resolvedSwitchColor"),this._resolveField("switch_color_on","_resolvedSwitchColorOn"))}get _stateObj(){return this.hass?.states[this.config.entity]}get _on(){return"on"===this._stateObj?.state}_tap(){this._handleAction(this.config.tap_action||{action:"toggle",entity:this.config.entity}),this._fireHaptic("light")}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e)return I`<ha-card class="row off">Unknown entity: ${this.config.entity}</ha-card>`;const t=this._on,i=this._isUnavailable(e),s=this.config.name||e.attributes.friendly_name||this.config.entity,a=this.config.icon||e.attributes.icon||(t?"mdi:toggle-switch":"mdi:toggle-switch-off-outline"),n=this.config.secondary?this._isTemplate(this.config.secondary)?this._resolvedSecondary:this.config.secondary:this.hass.formatEntityState?.(e)??e.state,o=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,r=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on,l=this._isTemplate(this.config.switch_color)?(this._resolvedSwitchColor||"").trim():this.config.switch_color,c=this._isTemplate(this.config.switch_color_on)?(this._resolvedSwitchColorOn||"").trim():this.config.switch_color_on;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:1}}getCardSize(){return 1}}customElements.define("materia-switch",ui),window.customCards=window.customCards||[],window.customCards.push({type:"materia-switch",name:"Materia Switch",description:"Toggle row with a spec M3 switch — templatable secondary text and state-driven colors.",preview:!0});const mi={cover:"open",lock:["locked","locking"],vacuum:"cleaning",media_player:"playing",climate:"heat",alarm_control_panel:"armed_away",timer:"active"},gi=new Set(["unavailable","unknown","none",""]);const fi=new Set(["unavailable","unknown","none",""]);function _i(e){const t=e?.lu??e?.last_updated??e?.last_changed;if(null==t)return null;if("number"==typeof t)return t<1e12?1e3*t:t;const i=Date.parse(t);return Number.isFinite(i)?i:null}function bi(e){const t=e?.s??e?.state;if(null==t||fi.has(String(t).toLowerCase()))return null;const i=Number(t);return Number.isFinite(i)?i:null}const vi={mean:e=>e.reduce((e,t)=>e+t,0)/e.length,sum:e=>e.reduce((e,t)=>e+t,0),min:e=>Math.min(...e),max:e=>Math.max(...e),delta:e=>e[e.length-1]-e[0],count:e=>e.length};const yi=[Ee,ze,Te,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],xi=[{value:"percent",label:"Percent (filling cookie)"},{value:"battery",label:"Battery (vertical bar)"},{value:"temperature",label:"Temperature (thermometer)"},{value:"power",label:"Power (load bars)"},{value:"energy",label:"Energy"},{value:"binary",label:"On/off (spinning star)"},{value:"plain",label:"Plain value"},{value:"vacuum",label:"Robot vacuum (state + room + battery bar)"},{value:"fill",label:"Gauge · tile floods to the value"},{value:"bar",label:"Gauge · value over a track"},{value:"ladder",label:"Gauge · ladder of bars"},{value:"ring",label:"Gauge · ring beside the value"},{value:"status",label:"Status row (tonal, icon badge + state)"},{value:"scale",label:"Gauge · position on a ramp, with reference marks"},{value:"spark",label:"History · area sparkline hero"},{value:"sparkline",label:"History · bare line"},{value:"weekbars",label:"History · a bar per day"},{value:"events",label:"History · event ticks (tonal row)"}],wi=["spark","sparkline","weekbars","events"],ki=["weekbars","events"],$i=["fill","bar","ladder","ring","scale"];customElements.define("materia-glance-tile-editor",class extends He{_formData(){const e=this._config?.variant;return{variant:"percent",..."percent"===e?{critical_dry:10,dry_below:20,soggy_above:60,dry_label:"Needs water now",soon_label:"Water soon",optimal_label:"Optimal",wet_label:"Overwatered"}:"power"===e?{max:3e3,bars:5}:"ladder"===e?{bars:5}:"status"===e?{dots:4}:"spark"===e||"sparkline"===e?{hours:24,points:48,history_refresh:5,show_delta:"spark"===e}:"weekbars"===e||"events"===e?{days:3,aggregate:"delta",history_refresh:5}:{},...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){const e=this._config?.variant,t={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"variant",label:"Category",required:!0,selector:{select:{mode:"dropdown",options:xi}}},{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Icon (overrides entity icon)",selector:{icon:{}}},{name:"label",label:"Subtitle",selector:{text:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"temperature"===e&&i.fields.push({name:"min",label:"Scale min (default 10°)",selector:{number:{mode:"box"}}},{name:"max",label:"Scale max (default 30°)",selector:{number:{mode:"box"}}}),"power"===e&&i.fields.push({name:"max",label:"Full-load watts (default 3000)",selector:{number:{mode:"box"}}},{name:"bars",label:"Number of bars (default 5)",selector:{number:{min:2,max:40,mode:"box"}}}),$i.includes(e)&&i.fields.push({name:"min",label:"Scale min (default: the entity's min attribute, else 0)",selector:{number:{mode:"box",step:"any"}}},{name:"max",label:"Scale max (default: the entity's max attribute, else 100 for a %)",helper:"Without a max the gauge cannot be calibrated and the tile falls back to a plain value.",selector:{number:{mode:"box",step:"any"}}},{name:"caption",label:"Caption under the gauge",helper:"Your sentence, in your language. Placeholders: {value} {min} {max} {unit} {percent}. Jinja templates work too. Empty shows the bare top of the scale.",template:!0,selector:{text:{}}},{name:"precision",label:"Decimal places (default: at most 1)",selector:{number:{min:0,max:6,mode:"box"}}}),"ladder"===e&&i.fields.push({name:"bars",label:"Number of bars (default 5)",selector:{number:{min:2,max:40,mode:"box"}}}),"scale"===e&&i.fields.push({name:"good",label:"Which end is good",helper:"Left empty the ramp is a neutral track and the card passes no judgement — the value's position and the reference marks still show. Set it and the ramp runs through the severity scale in that direction. Never inferred from the entity.",selector:{select:{mode:"dropdown",options:[{value:"low",label:"Low values are good (consumption, latency)"},{value:"high",label:"High values are good (efficiency, signal)"}]}}},{name:"min_label",label:"Label at the low end",helper:"Your words. Placeholders: {bound} {unit} {value} {min} {max}. Empty shows the bare bound.",template:!0,selector:{text:{}}},{name:"max_label",label:"Label at the high end",helper:"Same placeholders. Empty shows the bare bound.",template:!0,selector:{text:{}}},{name:"show_delta",label:"Show the change pill",helper:"Fetches history only when switched on, since a change needs a window to measure over.",selector:{boolean:{}}}),"status"===e&&i.fields.push({name:"active_state",label:"State(s) that count as active",helper:'Comma-separated. Left empty it is derived from the domain (cover open, vacuum cleaning, media_player playing…), falling back to "on" — so a sensor reading "Connected" needs it spelled out here.',selector:{text:{}}},{name:"dots",label:"Indicator dots (default 4)",helper:"Filled to the value when the entity has a scale; otherwise they pulse while it is active.",selector:{number:{min:2,max:12,mode:"box"}}}),"plain"===e&&i.fields.push({name:"battery_entity",label:"Paired battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"vacuum"===e&&i.fields.push({name:"status_entity",label:"Detailed status sensor (shown as the state)",selector:{entity:{domain:"sensor"}}},{name:"room_entity",label:"Current room sensor (shown while cleaning)",selector:{entity:{domain:"sensor"}}},{name:"battery_entity",label:"Battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"percent"===e&&i.fields.push({name:"critical_dry",label:"Critical dry, ≤% (default 10 — red)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_below",label:"Water soon, ≤% (default 20 — orange)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"soggy_above",label:"Overwatered, >% (default 60 — blue)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_label",label:'"Needs water now" label',selector:{text:{}}},{name:"soon_label",label:'"Water soon" label',selector:{text:{}}},{name:"optimal_label",label:'"Optimal" label',selector:{text:{}}},{name:"wet_label",label:'"Overwatered" label',selector:{text:{}}}),wi.includes(e)&&(ki.includes(e)?i.fields.push({name:"days",label:"Days of history (default 3)",helper:"Kept short on purpose: a window longer than your recorder keeps returns nothing at all, not a shorter series. Days with no data are simply not drawn.",selector:{number:{min:1,max:90,mode:"box"}}},{name:"aggregate",label:"What each bar measures (default: change)",helper:"change = how much the value moved that day (counters). mean/min/max/sum/count for measurements.",selector:{select:{mode:"dropdown",options:[{value:"delta",label:"Change across the day"},{value:"mean",label:"Average"},{value:"min",label:"Minimum"},{value:"max",label:"Maximum"},{value:"sum",label:"Sum of samples"},{value:"count",label:"Number of samples"}]}}}):i.fields.push({name:"hours",label:"Hours of history (default 24)",helper:"A window longer than your recorder keeps returns nothing at all.",selector:{number:{min:1,max:2160,mode:"box"}}},{name:"points",label:"Points plotted (default 48)",selector:{number:{min:2,max:400,mode:"box"}}},{name:"show_delta",label:"Show the change pill",selector:{boolean:{}}},{name:"delta_label",label:"Change pill text",helper:"Placeholders: {delta} {delta_pct} {from} {to} {unit} {hours} {days}. Empty shows just the signed change.",template:!0,selector:{text:{}}}),i.fields.push({name:"caption",label:"Caption",helper:"Your words. Placeholders: {value} {unit} {hours} {days} {buckets}. Jinja templates work too.",template:!0,selector:{text:{}}},{name:"history_refresh",label:"Refresh every N minutes (default 5)",helper:"History is polled on this interval, never on every state change.",selector:{number:{min:1,max:180,mode:"box"}}}));const s={title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Accent color (fill / bars / star)",color:!0,selector:{text:{}}},{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},a={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[t,i,s,a]:[t,s,a]}});const Ci="var(--md-sys-cust-color-weather-rain, #5fa8f5)",Si="var(--md-sys-cust-color-scale-green, #5E9E50)",zi="var(--md-sys-cust-color-scale-yellow, #C7A128)",Ti="var(--md-sys-cust-color-scale-orange, #D9713C)",Ei="var(--md-sys-cust-color-scale-red, #C94D42)",Ai=["on","open","running","playing","heat","heating","home","true","active"],Mi={cleaning:"gt_state_cleaning",docked:"gt_state_docked",paused:"gt_state_paused",idle:"gt_state_idle",returning:"gt_state_returning",error:"gt_state_error"},Oi=new Set(["spark","sparkline","weekbars","events"]);class Fi extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedLabel:{state:!0},_resolvedCaption:{state:!0},_resolvedDeltaLabel:{state:!0},_resolvedMinLabel:{state:!0},_resolvedMaxLabel:{state:!0},_hist:{state:!0}};static styles=yi;static getConfigElement(){return document.createElement("materia-glance-tile-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("sensor."))||"";return{entity:t,variant:"percent"}}setConfig(e){if(!e.entity)throw new Error("Materia Glance Tile: entity is required");if(!e.variant)throw new Error("Materia Glance Tile: variant is required — pick the value category");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("label","_resolvedLabel"),this._resolveField("caption","_resolvedCaption"),this._resolveField("delta_label","_resolvedDeltaLabel"),this._resolveField("min_label","_resolvedMinLabel"),this._resolveField("max_label","_resolvedMaxLabel"),(Array.isArray(this.config.markers)?this.config.markers:[]).forEach((e,t)=>this._resolveTemplateValue(`marker_${t}`,e?.label)),this._loadHistory())}get _label(){return this._isTemplate(this.config.label)?this._resolvedLabel:this.config.label}get _stateObj(){return this.hass?.states[this.config.entity]}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}get _unit(){return this.config.unit??this._stateObj?.attributes?.unit_of_measurement??""}get _name(){return this.config.name??this._stateObj?.attributes?.friendly_name??this.config.entity}_icon(e){return this.config.icon||this._stateObj?.attributes?.icon||e}get _variant(){return this.config.variant}_fmtState(){const e=this._stateObj;return this.hass.formatEntityState?.(e)??e.state}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e||this._isUnavailable(e))return I`<ha-card><div class="rect-tile unavailable">
    ...
    `}_header(e){return I`<div class="header"><ha-icon icon=${this._icon(e)}></ha-icon><span>${this._name}</span></div>`}_moistureZone(e){const t=this.config.critical_dry??10,i=this.config.dry_below??20,s=this.config.soggy_above??60;return e<=t?{fill:Ei,status:this.config.dry_label??ke("gt_needs_water_now",this.hass)}:e<=i?{fill:Ti,status:this.config.soon_label??ke("gt_water_soon",this.hass)}:e<=s?{fill:Si,status:this.config.optimal_label??ke("gt_optimal",this.hass)}:{fill:Ci,status:this.config.wet_label??ke("gt_overwatered",this.hass)}}_percent(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=Math.min(1,Math.max(0,e/100)),i=this._stateObj.attributes.device_class,s="moisture"===i;let a=null,n=null;if("battery"===i)a=t>.4?Si:t>.15?Ti:Ei;else if(s){const t=this._moistureZone(e);a=t.fill,n=t.status}else"humidity"===i&&(a=Ci);a&&(a=`color-mix(in srgb, ${a} 30%, transparent)`);const o=100-100*t,r="humidity"===i||s;let l;if(r){let e=`M-100 ${o.toFixed(1)}`;for(let t=-100;t<100;t+=25){e+=` Q ${t+12.5} ${(o+(t/25%2==0?-1.6:1.6)).toFixed(1)} ${t+25} ${o.toFixed(1)}`}l=e+" V102 H-100 Z"}else l=`M-2 ${o+2.5} Q 50 ${o-2.5} 102 ${o+2.5} V102 H-2 Z`;const c="battery"===i?"mdi:battery":s?"mdi:sprout":"mdi:water-percent";return I`
    ...
    `}_tempColor(e,t){const i="°F"===t?5*(e-32)/9:e;return i<16?Ci:i<23?Si:i<27?Ti:Ei}_temperature(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=this._unit||"°C",i=this.config.min??("°F"===t?50:10),s=this.config.max??("°F"===t?86:30),a=Math.min(1,Math.max(0,(e-i)/(s-i))),n=this._tempColor(e,t);return I`
      <div class="rect-tile left">
    ...
    `}_batteryColor(e){return e>.4?Si:e>.15?Ti:Ei}_battery(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=Math.min(1,Math.max(0,e/100)),i=this._batteryColor(t);return I`
      <div class="rect-tile left">
    ...
    `:this._plain()}_ladder(e={}){const t=this._gauge(e.power?Fi._POWER_PRESET:null);if(!t)return this._plain();const i=Math.max(2,Math.min(40,Math.round(this._num(this.config.bars)??5))),s=Math.max(0,Math.min(i,Math.ceil(t.frac*i)));return I`
      <div class="rect-tile left gauge">
    ...
    `}_status(){const e=function(e,t){if(!e)return!1;const i=String(e.state);if(gi.has(i.toLowerCase()))return!1;const s=(e,t)=>String(e).toLowerCase()===String(t).toLowerCase();if(null!=t&&""!==t){const e=Array.isArray(t)?t:String(t).split(",").map(e=>e.trim()).filter(Boolean);return e.some(e=>s(e,i))}const a=String(e.entity_id||"").split(".")[0],n=mi[a]??"on";return(Array.isArray(n)?n:[n]).some(e=>s(e,i))}(this._stateObj,this.config.active_state),t=Math.max(2,Math.min(12,Math.round(this._num(this.config.dots)??4))),i=this._gauge(),s=i?Math.max(0,Math.min(t,Math.ceil(i.frac*t))):e?t:0;return I`
    ...
    `}_binary(){const e=Ai.includes(this._stateObj.state),t=rt(50,50,46,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2});return I`
    ...
    `}_fmtObj(e){return this.hass.formatEntityState?.(e)??e.state}_vacuumStateText(e){const t=Mi[String(e.state).toLowerCase()];return t?ke(t,this.hass):this._fmtObj(e)}_vacuum(){const e=this._stateObj,t="cleaning"===e.state,i=this.config.status_entity?this.hass.states[this.config.status_entity]:null,s=this._vacuumStateText(i??e),a=this.config.room_entity?this.hass.states[this.config.room_entity]:null,n=t&&a?this._fmtObj(a):"",o=this.config.battery_entity?this.hass.states[this.config.battery_entity]:null,r=o?this._num(o.state):null,l=null!=r?Math.min(1,Math.max(0,r/100)):null,c=null!=l?this._batteryColor(l):null;return I`
    ...
    `}get _histHours(){if("weekbars"===this._variant||"events"===this._variant){const e=this._num(this.config.days)??3;return 24*Math.max(1,Math.min(90,Math.round(e)))}return Math.max(1,Math.min(2160,Math.round(this._num(this.config.hours)??24)))}get _needsHistory(){return Oi.has(this._variant)||!0===this.config?.show_delta}get _histSeries(){return function(e,t,i=Date.now()){const s=e||[],a=t?.state;if(null==a||fi.has(String(a).toLowerCase()))return s;const n=Number(a);if(!Number.isFinite(n))return s;const o=_i({lu:t.last_changed??t.last_updated});if(null==o)return s;const r=Math.min(o,i),l=s[s.length-1];if(l&&l.v===n&&l.t>=r)return s;const c=[...s,{t:r,v:n}];return c.sort((e,t)=>e.t-t.t),c}(this._hist||[],this._stateObj)}connectedCallback(){if(super.connectedCallback(),!this._needsHistory)return;const e=Math.max(1,Math.min(180,Math.round(this._num(this.config?.history_refresh)??5)));this._histTimer=setInterval(()=>this._loadHistory(!0),60*e*1e3)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._histTimer),this._histTimer=null}_loadHistory(e=!1){if(!this._needsHistory||!this.hass||!this.config?.entity)return;const t=`${this.config.entity}|${this._histHours}`;if(!e&&this._histKey===t)return;this._histKey=t;const i=this._histToken=(this._histToken||0)+1;(async function(e,t,i,s=Date.now()){if(!(e?.connection&&t&&i>0))return[];const a=new Date(s-3600*i*1e3).toISOString();try{const i=await e.connection.sendMessagePromise({type:"history/history_during_period",start_time:a,end_time:new Date(s).toISOString(),entity_ids:[t],minimal_response:!0,no_attributes:!0}),n=i?.[t]||[],o=[];for(const e of n){const t=_i(e);null!=t&&o.push({t:t,v:bi(e)})}return o.sort((e,t)=>e.t-t.t),o}catch(e){return[]}})(this.hass,this.config.entity,this._histHours).then(e=>{i===this._histToken&&(this._hist=e)})}_fmtSigned(e){return(e>=0?"+":"")+this._fmtNum(e)}_deltaPill(e){if(!1===this.config.show_delta)return V;const t=function(e){const t=(e||[]).filter(e=>null!=e.v);if(t.length<2)return null;const i=t[0].v,s=t[t.length-1].v;return{from:i,to:s,abs:s-i,pct:0===i?null:(s-i)/Math.abs(i)*100}}(e);if(!t)return V;const i=this._unit,s={delta:this._fmtSigned(t.abs)+(i?` ${i}`:""),delta_pct:null==t.pct?"":`${this._fmtSigned(t.pct)}%`,from:this._fmtNum(t.from),to:this._fmtNum(t.to),unit:i,hours:String(this._histHours),days:String(Math.round(this._histHours/24))},a=this.config.delta_label,n=null!=a&&""!==a?this._interpolate(this._isTemplate(a)?this._resolvedDeltaLabel:a,null,s):s.delta;if(null==n||""===n)return V;const o=t.abs>0?"m3o:trending-up":t.abs<0?"m3o:trending-down":"m3o:trending-flat";return I`<div class="delta-pill">
      ...
      >
        ...
        ${this._valueRow({display:c,unit:this._unit},e.area?this._deltaPill(a):V)}
        ${e.area?V:d}
        ${h?I`<div class="gauge-caption">${h}</div>`:V}
      </div>
    `}_bucketBars(e){const t=function(e,{days:t=7,aggregate:i="delta",now:s=Date.now()}={}){const a=vi[i]||vi.delta,n=Math.max(1,Math.min(90,Math.round(t)));if(!e?.length)return[];const o=new Date(s);o.setHours(0,0,0,0);const r=864e5,l=o.getTime()-(n-1)*r,c=new Map;for(const t of e){if(null==t.v||t.t<l)continue;const e=Math.floor((t.t-l)/r);e<0||e>=n||(c.has(e)||c.set(e,[]),c.get(e).push(t.v))}const h=[];for(let e=0;e<n;e++){const t=c.get(e);if(!t||!t.length)continue;const i=a(t);h.push({t:l+e*r,v:Number.isFinite(i)?i:0,samples:t.length})}return h}(this._histSeries,{days:this._num(this.config.days)??3,aggregate:this.config.aggregate||"delta"}),i=this._gauge(),s=i?i.accent:this._gaugeAccent(1),a=Math.max(...t.map(e=>Math.max(0,e.v)),0),n=e.events?32:34,o=t.length?I`<div class=${e.events?"ticks":"weekbars"} style="--g-accent:${s}">
          ${t.map((i,s)=>{const o=Math.max(0,i.v),r=o<=0,l=r||a<=0?6:Math.max(6,o/a*n),c=e.events?r?"stub":"on":s===t.length-1?"current":"past";return I`<i class=${c} style="height:${l.toFixed(1)}px"></i>`})}
    ...
    `}getGridOptions(){return"status"===this._variant||"events"===this._variant?{columns:12,rows:"auto",min_columns:6}:"spark"===this._variant?{columns:12,rows:"auto",min_columns:4}:{columns:4,rows:"auto",min_columns:3}}getCardSize(){return 3}}customElements.define("materia-glance-tile",Fi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-glance-tile",name:"Materia Glance Tile",description:"Expressive view-only sensor tile — percent fill, thermometer, power bars, spinning pump star, and a graceful fallback.",preview:!0});const Di=ht(90,90,86),qi=function(e,t,i,s=0){return dt(e,t,i,s,[{x:.457,y:.296,r:.007},{x:.5,y:-.051,r:.007}],15)}(90,90,88),Ri={rest:{bg:"var(--md-sys-color-secondary-container)",fg:"var(--md-sys-color-on-secondary-container)"},active:{bg:"var(--md-sys-cust-color-device, var(--md-sys-color-primary-container))",fg:"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-primary-container))"},sidekick:{bg:"var(--md-sys-color-surface-container-high, rgba(0, 0, 0, 0.06))",fg:"var(--md-sys-color-on-surface)"}},Pi=[Ee,ze,Te,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Ni=e=>class extends e{willUpdate(e){super.willUpdate?.(e);const t="sidekick"===this.config?.variant?"sidekick":null;t?this.setAttribute("variant",t):this.removeAttribute("variant")}get _sidekick(){return"sidekick"===this.config?.variant}_shellPair(e){return this._sidekick?Ri.sidekick:e?Ri.active:Ri.rest}_alertList(){return Array.isArray(this.config.alerts)?this.config.alerts:this.config.alert?[this.config.alert]:[]}_idle(e){return["off","idle","unknown","unavailable","false","0","none","","ok","docked"].includes(String(e??"").toLowerCase())}_alertText(e,t){if(null==t.text)return"";const i=this._isTemplate(t.text)?this._tplResults?.[`alertText${e}`]:t.text;return null==i?"":String(i).trim()}get _activeAlert(){const e=this._alertList();for(let t=0;t<e.length;t++){const i=e[t],s=this._alertText(t,i);if(i.entity){const e=this.hass?.states[i.entity];if(!e)continue;const t=String(e.state);if(null!=i.state){if(!(Array.isArray(i.state)?i.state.map(String):[String(i.state)]).includes(t))continue}else if(this._idle(t))continue;return{...i,text:s||(this.hass.formatEntityState?.(e)??t)}}if(s)return{...i,text:s}}return null}_resolveAlertTemplates(){this.config&&this._alertList().forEach((e,t)=>{null!=e.text&&this._resolveTemplateValue(`alertText${t}`,e.text)})}_renderBurst({alarm:e=!1,working:t=!1}={}){return!1===this.config.burst?V:I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}customElements.define("materia-vacuum-hero",ts),window.customCards=window.customCards||[],window.customCards.push({type:"materia-vacuum-hero",name:"Materia Vacuum Hero",description:"Robot-vacuum headline — derived ETA, negated working states, and mop/consumable warnings. Roborock and Ecovacs.",preview:!0});const is=[Ee,ze,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-bar-select-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",selector:{text:{}}},{name:"attribute",label:"Attribute (e.g. fan_speed) instead of the state",selector:{text:{}}},{name:"off_option",label:'Option shown as its own round button (e.g. "off")',selector:{text:{}}},{name:"off_icon",label:"Icon for that button",selector:{icon:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Lit bar color",color:!0,template:!0,selector:{text:{}}},{name:"accent_on",label:"Glyph color on the accent fill",color:!0,template:!0,selector:{text:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});class os extends(as(hi(Se(ce)))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedAccent:{state:!0},_resolvedAccentOn:{state:!0}};static styles=[ns,di];static getConfigElement(){return document.createElement("materia-bar-select-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("select."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("Materia Bar Select: entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("accent","_resolvedAccent"),this._resolveField("accent_on","_resolvedAccentOn"),this._optimisticReconcile());const t=this._index;null!=this._prevIndex&&t!==this._prevIndex&&this._choreograph(this._prevIndex,t),this._prevIndex=t}get _stateObj(){return this.hass?.states[this.config.entity]}get _rungs(){const e=null!=this.config.off_option?String(this.config.off_option):null;return this._options.filter(t=>null==e||t!==e)}get _index(){return this._rungs.indexOf(String(this._current))}_optimisticActual(){const e=this._stateObj;if(!e)return null;const t=this.config.attribute?e.attributes?.[this.config.attribute]:e.state;return null==t?null:String(t)}get _current(){return this._optimistic}get _options(){if(this.config.options?.length)return this.config.options.map(String);const e=this._stateObj;if(!e)return[];if(this.config.attribute){const t=e.attributes?.[`${this.config.attribute}_list`];return Array.isArray(t)?t.map(String):[]}const t=e.attributes?.options;return Array.isArray(t)?t.map(String):[]}_fmt(e){const t=this._stateObj;if(!this.config.attribute&&t&&String(t.state)===String(e)){const e=this.hass.formatEntityState?.(t);if(e)return e}const i=String(e).replace(/[_-]+/g," ");return i.charAt(0).toUpperCase()+i.slice(1)}_set(e){const t=this._stateObj;if(!t)return;const i=t.entity_id.split(".")[0];if(this._fireHaptic?.("selection"),this._optimisticSet(e),this.config.service){const[i,s]=String(this.config.service).split("."),a=this.config.service_key||this.config.attribute||"option";return void this._callService(i,s,{entity_id:t.entity_id,[a]:e})}if(this.config.attribute){const s=this.config.attribute;return void this._callService(i,`set_${s}`,{entity_id:t.entity_id,[s]:e})}"select"!==i&&"input_select"!==i||this._callService(i,"select_option",{entity_id:t.entity_id,option:e})}_choreograph(e,t){if(window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches)return;const i=Array.from(this.shadowRoot?.querySelectorAll(".bar")||[]);if(!i.length)return;const s=t>e,a=[];for(let s=Math.min(e,t)+1;s<=Math.max(e,t);s++)i[s]&&a.push(i[s]);const n=s?a:a.reverse(),o=s?[{transform:"scaleY(0.94)"},{transform:"scaleY(1.07)",offset:.5},{transform:"scaleY(1)"}]:[{transform:"scaleY(1)"},{transform:"scaleY(0.84)",offset:.5},{transform:"scaleY(0.94)"}];n.forEach((e,t)=>{e.animate(o,{duration:300,delay:45*t,easing:s?"cubic-bezier(.2,1.5,.3,1)":"cubic-bezier(.3,0,.2,1)",fill:"none"})})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e||this._isUnavailable(e))return I`<ha-card><div class="tile unavailable">
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-bar-select",os),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bar-select",name:"Materia Bar Select",description:"Tap-a-bar level picker — climbing bars for fan speeds, mop levels, any ordered select.",preview:!0});const rs=[Ee,ze,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class ls extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
  ...
  `],ds="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:var(--md-sys-color-secondary-container, rgba(120,120,128,.14));color:var(--md-sys-color-on-secondary-container, inherit);margin-bottom:6px;cursor:pointer;",ps="border:none;background:transparent;color:inherit;cursor:pointer;padding:4px;display:grid;place-items:center;border-radius:50%;--mdc-icon-size:18px;",us="border:1.5px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.2));background:transparent;color:inherit;font-family:inherit;font-size:13px;font-weight:600;padding:8px 16px;border-radius:999px;cursor:pointer;display:inline-flex;align-items:center;gap:6px;";customElements.define("materia-climate-panel-editor",class extends He{static properties={_secIdx:{state:!0},_cardIdx:{state:!0},_huiReady:{state:!0}};connectedCallback(){super.connectedCallback(),this._loadHui()}async _loadHui(){if(customElements.get("hui-card-picker")&&customElements.get("hui-card-element-editor"))this._huiReady=!0;else{try{const e=await pe(),t=await e.createCardElement({type:"vertical-stack",cards:[]});await(t?.constructor?.getConfigElement?.())}catch{}this._huiReady=!!customElements.get("hui-card-picker")}}_formData(){return{steppers:"side",wave:"auto",...this._config}}get _secs(){return this._config?.sections||[]}_setSecs(e){const t={...this._config};e.length?t.sections=e:delete t.sections,this._commit(t)}_patchSec(e,t){const i=[...this._secs],s={...i[e],...t};for(const e of Object.keys(t))void 0!==t[e]&&""!==t[e]&&null!==t[e]||delete s[e];i[e]=s,this._setSecs(i)}_moveSec(e,t){const i=[...this._secs],s=e+t;s<0||s>=i.length||([i[e],i[s]]=[i[s],i[e]],this._setSecs(i))}_addSec(){const e=this._secs.length;this._setSecs([...this._secs,{title:"New section",style:"section",cards:[]}]),this._secIdx=e}_patchCards(e,t){this._patchSec(e,{cards:t})}render(){return this.hass&&this._config?null!=this._secIdx&&null!=this._cardIdx?this._renderCardView():null!=this._secIdx?this._renderSectionView():super.render():I``}_back(e,t){return I`
      ...
      <ha-expansion-panel outlined .header=${"Sections"} .secondary=${"Wallet sections and menus below the mode group"} .expanded=${!0}>
        ...
        <div style="padding:12px;">
          ${this._secs.map((e,t)=>I`
            <div style=${ds} @click=${()=>{this._secIdx=t}}>
              ...
              <button style=${ps} title="Move up" @click=${e=>{e.stopPropagation(),this._moveSec(t,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
              <button style=${ps} title="Move down" @click=${e=>{e.stopPropagation(),this._moveSec(t,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
              <button style=${ps} title="Edit" @click=${e=>{e.stopPropagation(),this._secIdx=t}}><ha-icon icon="mdi:pencil"></ha-icon></button>
              <button style=${ps} title="Delete" @click=${e=>{e.stopPropagation(),this._setSecs(this._secs.filter((e,i)=>i!==t))}}><ha-icon icon="mdi:delete"></ha-icon></button>
            </div>
          `)}
          <button style=${us} @click=${()=>this._addSec()}>
    ...
    `}_renderMenuFields(e,t){const i=t.options||[],s=(t,s)=>{const a=i.map((e,i)=>i===t?{...e,...s}:e);for(const e of Object.keys(s))""!==s[e]&&null!=s[e]||delete a[t][e];this._patchSec(e,{options:a})};return I`
      ...
      ${i.map((t,a)=>I`
        <div style="display:flex;gap:6px;align-items:flex-start;margin-bottom:8px;">
          ...
          <button style="${ps}margin-top:12px;" title="Remove option"
            @click=${()=>this._patchSec(e,{options:i.filter((e,t)=>t!==a)})}>
            <ha-icon icon="mdi:delete"></ha-icon>
          </button>
        </div>
      `)}
      <button style=${us} @click=${()=>this._patchSec(e,{options:[...i,{label:"",value:""}]})}>
    ...
    `}_renderActions(e,t){const i=t.actions||[],s=(t,s)=>{const a=i.map((e,i)=>i===t?{...e,...s}:e);for(const e of Object.keys(s))""!==s[e]&&null!=s[e]||delete a[t][e];this._patchSec(e,{actions:a})};return I`
      ...
      ${i.map((t,a)=>I`
        <div style="border:1px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.15));border-radius:12px;padding:10px;margin-bottom:8px;">
          <div style="display:flex;gap:6px;align-items:flex-start;">
            ...
            <button style="${ps}margin-top:12px;" title="Remove action"
      ...
      `)}
      <button style="${us}margin-bottom:12px;" @click=${()=>this._patchSec(e,{actions:[...i,{label:""}]})}>
    ...
    `}_renderSectionCards(e,t){const i=t.cards||[],s=(t,s)=>{const a=t+s;if(a<0||a>=i.length)return;const n=[...i];[n[t],n[a]]=[n[a],n[t]],this._patchCards(e,n)};return I`
      ...
      ${i.map((t,a)=>I`
        <div style=${ds} @click=${()=>{this._cardIdx=a}}>
          ...
          <button style=${ps} title="Move up" @click=${e=>{e.stopPropagation(),s(a,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
          <button style=${ps} title="Move down" @click=${e=>{e.stopPropagation(),s(a,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
          <button style=${ps} title="Edit" @click=${e=>{e.stopPropagation(),this._cardIdx=a}}><ha-icon icon="mdi:pencil"></ha-icon></button>
          <button style=${ps} title="Delete" @click=${t=>{t.stopPropagation(),this._patchCards(e,i.filter((e,t)=>t!==a))}}><ha-icon icon="mdi:delete"></ha-icon></button>
        </div>
      `)}
  ...
  `],gs=-135,fs=270,_s="var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))",bs="var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))",vs={auto:{icon:"mdi:thermostat-auto",color:_s,on:bs,container:bs,onContainer:_s},heat_cool:{icon:"mdi:thermostat-auto",color:_s,on:bs,container:bs,onContainer:_s},heat:{icon:"m3o:mode-heat",color:"var(--md-sys-cust-color-climate-heat-accent, #a14614)",on:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",container:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",onContainer:"var(--md-sys-cust-color-climate-heat-accent, #a14614)"},cool:{icon:"mdi:snowflake",color:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)",on:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",container:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",onContainer:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)"},dry:{icon:"mdi:water-percent",color:_s,on:bs,container:bs,onContainer:_s},fan_only:{icon:"mdi:fan",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"},off:{icon:"m3o:power-settings-new",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"}};class ys extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_adjusting:{state:!0}};static styles=ms;setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e}}connectedCallback(){super.connectedCallback(),this._phase=0,this._amp=0,this._startLoop()}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),clearTimeout(this._optimisticTimer),clearTimeout(this._sendTimer)}get _entity(){return this.hass?.states[this.config.entity]}get _action(){return this._entity?.attributes?.hvac_action??""}get _waveAction(){const e=this._mode;if("off"===e||"never"===this.config.wave)return"";if("always"===this.config.wave)return"cool"===e?"cooling":"heating";const t="auto"===e||"heat_cool"===e,i=t?"holding":"",s=this._action;if("heating"===s||"cooling"===s)return s;if(s&&"idle"!==s)return"";const a=this._current,n=this._target;return null==n||"idle"===s?i:null==a?"cool"===e?"cooling":"heat"===e?"heating":i:("heat"===e||t)&&a<n-.2?"heating":("cool"===e||t)&&a>n+.2?"cooling":i}get _mode(){return this._entity?.state??"off"}get _target(){return null!=this._optimisticTemp?this._optimisticTemp:this._numRaw(this._entity?.attributes?.temperature)}get _current(){if(this.config.temperature_entity){const e=this.hass?.states[this.config.temperature_entity];if(e)return this._numRaw(e.state)}return this._numRaw(this._entity?.attributes?.current_temperature)}_numRaw(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}get _step(){return this.config.step??this._numRaw(this._entity?.attributes?.target_temp_step)??.5}get _scale(){return{min:this.config.min_temp??this._numRaw(this._entity?.attributes?.min_temp)??7,max:this.config.max_temp??this._numRaw(this._entity?.attributes?.max_temp)??35}}_startLoop(){if(this._raf)return;const e=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,t=()=>{const i=this._waveAction,s="heating"===i||"cooling"===i,a=e?0:s?1:"holding"===i?.35:0,n=this._amp+.06*(a-this._amp),o=Math.abs(n-a)<.01;if(this._amp=o?a:n,this._amp>.005||a>0){this._phase+="cooling"===i?.012:s?-.012:-.008;const e=this._waveGeom;if(e){const t=this.renderRoot?.querySelector("path.wave-seg");t&&t.setAttribute("d",this._wavePath(e.start,e.end,e.r))}this._raf=requestAnimationFrame(t)}else this._raf=null};this._raf=requestAnimationFrame(t)}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}updated(e){if(this._waveAction&&!this._raf&&this._startLoop(),e.has("hass")&&null!=this._optimisticTemp){const e=this._numRaw(this._entity?.attributes?.temperature);null!=e&&Math.abs(e-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}_modeGroupConfig(e,t,i){const s=`${this.config.entity}|${e.join()}|${t}|${i}|${this.config.mode_size??"m"}`;return this._mgKey!==s&&(this._mgKey=s,this._mgConfig={entity:this.config.entity,size:this.config.mode_size??"m",variant:"tonal",active_shape:"square",color_active:t,color_on_active:i,options:e.map(e=>({icon:vs[e].icon,value:e,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:e},target:{entity_id:this.config.entity}}}))}),this._mgConfig}_angleFor(e,t,i){const s=Math.min(1,Math.max(0,(e-t)/(i-t)));return gs+fs*s}_pointAt(e,t,i=0){const s=(e-90)*Math.PI/180,a=t+i;return[50+a*Math.cos(s),50+a*Math.sin(s)]}_wavePath(e,t,i){const s=t-e,a=1+.55*Math.max(0,Math.min(1,(90-s)/70)),n=Math.min(20,Math.max(6,s/3)),o=3.2*a*this._amp,r=[];for(let s=e;s<=t;s+=2){const a=s-e,l=o*Math.min(1,a/n)*Math.min(1,(t-s)/n)*Math.sin(a/7+this._phase);r.push(this._pointAt(s,i,l))}return r.push(this._pointAt(t,i,0)),"M"+r.map(([e,t])=>`${e.toFixed(2)} ${t.toFixed(2)}`).join(" L")}_arcPath(e,t,i){const[s,a]=this._pointAt(e,i),[n,o]=this._pointAt(t,i),r=t-e>180?1:0;return`M${s.toFixed(2)} ${a.toFixed(2)} A${i} ${i} 0 ${r} 1 ${n.toFixed(2)} ${o.toFixed(2)}`}_setTarget(e){const{min:t,max:i}=this._scale,s=this._step,a=Math.round(100*Math.min(i,Math.max(t,Math.round(e/s)*s)))/100;this._optimisticTemp=a,this._adjusting=!0,clearTimeout(this._adjustTimer),this._adjustTimer=setTimeout(()=>{this._adjusting=!1},650),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4),clearTimeout(this._sendTimer),this._sendTimer=setTimeout(()=>{this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:a})},350)}_nudge(e){const t=this._target;null!=t&&this._setTarget(t+e)}_dialPointer(e){if(!this._dialDragging&&"pointerdown"!==e.type)return;const t=this.renderRoot.querySelector(".dial").getBoundingClientRect(),i=(e.clientX-t.left)/t.width*100-50,s=(e.clientY-t.top)/t.height*100-50;let a=180*Math.atan2(s,i)/Math.PI+90;if(a>180&&(a-=360),a<-143||a>143)return;const n=Math.min(1,Math.max(0,(a-gs)/fs)),{min:o,max:r}=this._scale;"pointerdown"===e.type&&(this._dialDragging=!0,e.currentTarget.setPointerCapture(e.pointerId)),this._setTarget(o+n*(r-o))}_endDialDrag(e){this._dialDragging=!1,e.currentTarget.releasePointerCapture?.(e.pointerId)}render(){if(!this.hass||!this.config)return I``;const e=this._entity;if(!e)return I``;const t=this._isUnavailable(e),{min:i,max:s}=this._scale,a=this._target,n=this._current,o=this._mode,r=this._waveAction,l=vs[o]||vs.off,c="off"!==o&&null!=a,h=42,d=c?this._angleFor(a,i,s):gs,p=null!=a?this._angleFor(a,i,s):null,[u,m]=this._pointAt(c?d:p??d,h),g=null!=n?this._angleFor(n,i,s):null;let f=null,_=null,b=null;c&&"holding"===r?(_=gs,b=null!=g?Math.max(g,d):d):c&&null!=g?(f=Math.min(g,d),_=f,b=Math.max(g,d)):c&&(_=gs,b=d);const v="heating"===r?vs.heat:"cooling"===r?vs.cool:l,y=v.color,x=v.on,w=this.hass.formatEntityState?.(e)??o,k=this.hass.config?.unit_system?.temperature??"°C",$=(this.config.hvac_modes??e.attributes.hvac_modes??[]).filter(e=>vs[e]);return this._waveGeom=c&&null!=b&&b>_+.5?{start:_,end:b,r:h}:null,I`
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const e=c?Math.max(d,g??d):gs,t=c?Math.min(e+8,135):gs;return t<134.5?H`<path d=${this._arcPath(t,135,h)} class="track" />`:""})()}
            ${c||null==g?"":H`<circle
                  cx=${this._pointAt(g,h)[0]} cy=${this._pointAt(g,h)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?H`<path d=${this._arcPath(gs,f,h)} class="sweep" style="stroke:${y}" />`:""}
          ...
          <div class="center" @click=${()=>this._fireMoreInfo(this.config.entity)}>
            ...
            ${null!=n&&!1!==this.config.show_current?I`<div class="current-label">${this.config.current_label??ke("cp_currently",this.hass)} ${Math.round(10*n)/10}°</div>`:""}
          </div>
        </div>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6}}customElements.define("materia-climate-panel",ws),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate-panel",name:"Materia Climate Panel",description:"Climate panel: thermostat dial hero, mode group, and wallet sections you compose with any cards or menus.",preview:!0});const ks={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},tertiary:{active:"var(--md-sys-color-tertiary)",onActive:"var(--md-sys-color-on-tertiary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat-container)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool-container)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto-container)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},$s={xs:{height:32,innerCorner:4},s:{height:40,innerCorner:8},m:{height:56,innerCorner:8},l:{height:96,innerCorner:16},xl:{height:136,innerCorner:20}},Cs=[Ee,ze,ge,n`
    .group {
      display: flex;
      gap: 2px;
      width: 100%;
  ...
  `];class zs extends He{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[He.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null,this._actionRows??=Object.entries(e.tap_action_map||{}).map(([e,t])=>({state:e,tap_action:t}))}_formData(){return{variant:"filled",size:"m",shape:"round",...this._config}}get _sections(){return[{title:"Button",icon:"mdi:gesture-tap-button",fields:[{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"label",template:!0,selector:{text:{}}},{name:"variant",selector:{select:{mode:"dropdown",options:[{value:"elevated",label:"Elevated"},{value:"filled",label:"Filled"},{value:"tonal",label:"Tonal"},{value:"outlined",label:"Outlined"},{value:"text",label:"Text"}]}}},{name:"role",label:"Color role",helper:"Unset = each variant's spec default (filled → primary, tonal → secondary).",selector:{select:{mode:"dropdown",options:[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"}]}}},{name:"size",selector:{select:{mode:"dropdown",options:[{value:"xs",label:"XS (32)"},{value:"s",label:"S (40)"},{value:"m",label:"M (56)"},{value:"l",label:"L (96)"},{value:"xl",label:"XL (136)"}]}}},{name:"shape",selector:{select:{mode:"dropdown",options:[{value:"round",label:"Round (pill)"},{value:"square",label:"Square"}]}}},{name:"wide",selector:{boolean:{}}},{name:"entity",selector:{entity:{}}},Ie]},{title:"Behavior",icon:"mdi:tune",fields:[{name:"active_state",label:"Active state",helper:"State(s) considered active (defaults by domain)",selector:{text:{}}},{name:"morph_on_active",label:"Morph shape when active",selector:{boolean:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Default action",selector:{ui_action:{}}}]}]}_renderExtra(){const e=this._actionRows||[];return I`
      ...
      ${e.map((e,t)=>I`
        ...
        `)}
    `}get _mappingSchema(){return[{name:"state",required:!0,helper:"Use 'default' for the fallback",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}_toggleExpand(e){this._expanded=this._expanded===e?null:e}_addMapping(){this._actionRows=[...this._actionRows||[],{state:""}],this._expanded=this._actionRows.length-1}_updateMapping(e,t){this._actionRows=(this._actionRows||[]).map((i,s)=>s===e?{...i,...t}:i),this._commitActionRows()}_removeMapping(e){this._actionRows=(this._actionRows||[]).filter((t,i)=>i!==e),this._expanded===e&&(this._expanded=null),this._commitActionRows()}_commitActionRows(){const e={};for(const t of this._actionRows||[])t.state&&t.tap_action&&(e[t.state]=t.tap_action);const{tap_action_map:t,...i}=this._config;this._commit(Object.keys(e).length?{...i,tap_action_map:e}:i)}}customElements.define("materia-button-editor",zs);const Ts={"filled-tonal":"tonal",standard:"text"},Es={light:"on",switch:"on",fan:"on",input_boolean:"on",vacuum:"cleaning",lock:["locked","locking"],cover:"open",climate:"heat",media_player:"playing"};class As extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedLabel:{state:!0},_resolvedSubtitle:{state:!0},_resolvedDisabled:{state:!0}};static styles=Ss;static getConfigElement(){return document.createElement("materia-button-editor")}static getStubConfig(){return{icon:"mdi:play",variant:"filled",size:"m",shape:"round"}}setConfig(e){if(!e.icon&&!e.label)throw new Error("icon or label is required");this.config={variant:"filled",size:"m",shape:"round",...e},this.toggleAttribute("wide",!!e.wide)}get _disabled(){const e=this.config?.disabled_when??this.config?.disabled;if(null==e)return!1;if("boolean"==typeof e)return e;if(Array.isArray(e))return ri(e,this.hass);if(this._isTemplate(e)){const e=this._resolvedDisabled;return"True"===e||"true"===e||"1"===e}return"true"===e||"True"===e}updated(e){e.has("config")&&(this.toggleAttribute("wide",!!this.config?.wide),null!=this.config?.flex&&(this.style.flex=String(this.config.flex))),e.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("label","_resolvedLabel"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField(null!=this.config?.disabled_when?"disabled_when":"disabled","_resolvedDisabled"))}_isActive(e){if(!e)return!1;const t=e.entity_id.split(".")[0],i=this.config.active_state??Es[t]??"on";return Array.isArray(i)?i.includes(e.state):e.state===String(i)}_defaultTapAction(){return this.config.entity?{action:"toggle"}:{action:"none"}}_resolveTapAction(){if(this.config.tap_action_map&&this.config.entity){const e=this.hass?.states[this.config.entity]?.state,t=this.config.tap_action_map[e]??this.config.tap_action_map.default;if(t)return t}return this.config.tap_action||this._defaultTapAction()}_handleTap(){this._disabled||this._handleAction(this._resolveTapAction())}render(){if(!this.config)return I``;const e=this.config.entity?this.hass?.states?.[this.config.entity]:void 0,t=!!this.config.entity&&this._isUnavailable(e),i=this._disabled,s=Ts[this.config.variant]||this.config.variant||"filled",a=["primary","secondary","tertiary","error"].includes(this.config.role)?this.config.role:"",n=this.config.size??"m";let o="",r="";if("number"==typeof n||/^\d+$/.test(String(n))){const e=Number(n);r=`--mb-h:${e}px;--mb-icon:${Math.round(.43*e)}px;--mb-font:16px;--mb-px:${Math.round(.42*e)}px;--mb-rsq:${Math.round(.28*e)}px;--mb-gap:8px;`}else o=`size-${n}`;const l="square"===this.config.shape?"square":"round",c=this._isActive(e),h=this.config.morph_on_active&&c?"square":l,d=this._isTemplate(this.config.icon)?this._resolvedIcon||"":this.config.icon,p=this._isTemplate(this.config.label)?this._resolvedLabel||"":this.config.label,u=this._isTemplate(this.config.subtitle)?this._resolvedSubtitle||"":this.config.subtitle,m="stacked"===this.config.layout,g=!p&&!u;return I`
      <button
        class="btn variant-${s} ${a?`role-${a}`:""} ${o} shape-${h} ${this.config.connected?`connected-${this.config.connected}`:""} ${g?"icon-only":""} ${m?"stacked":""} ${i?"disabled":""} ${t?"unavailable":""}"
        style=${r}
        @click=${this._handleTap}
      >
    ...
    `}getCardSize(){return 1}}customElements.define("materia-button",As),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"M3 button — icon and/or label, variants, sizes, shapes, and shape-morph on state.",preview:!0});const Ms=[Ee,n`
  ...
  `];class Os extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,n`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
 ...
 */const Hs=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Hs(e,t);return!0},Ws=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Vs=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Ys(t)}};function Gs(e){void 0!==this._$AN?(Ws(this),this._$AM=e,Vs(this)):this._$AM=e}function Xs(e,t=!1,i=0){const s=this._$AH,a=this._$AN;if(void 0!==a&&0!==a.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Hs(s[e],!1),Ws(s[e]);else null!=s&&(Hs(s,!1),Ws(s));else Hs(this,e)}const Ys=e=>{e.type==js&&(e._$AP??=Xs,e._$AQ??=Gs)};class Ks extends Is{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Vs(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Hs(this,e),Ws(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Zs=new WeakMap,Qs=Bs(class extends Ks{render(e){return V}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),V}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Zs.get(t);void 0===i&&(i=new WeakMap,Zs.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Zs.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class Js extends He{static properties={_expandedButton:{state:!0},_expandedOption:{state:!0}};static styles=[He.styles,n`
            ...
            ${this._expandedButton===t?I`
                  <div class="button-body">
                    <materia-button-editor
                      .hass=${this.hass}
                      ${Qs(i=>{i&&i.__materiaIdx!==t&&(i.__materiaIdx=t,i.setConfig(e))})}
  ...
  `];class ta extends He{static styles=[He.styles,n`
      .remap-row {
        display: flex;
        align-items: center;
        gap: 6px;
      ...
      >
        <div class="body">
          ...
          <materia-drag-confirm
            ...
            .label=${a?"locking"===s?this.config.locking_label??ke("lock_locking",this.hass):this.config.unlocking_label??ke("lock_unlocking",this.hass):v?b:_}
            .pending=${a}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 5}}customElements.define("materia-lock",sa),window.customCards=window.customCards||[],window.customCards.push({type:"materia-lock",name:"Materia Lock",description:"Lock shape that morphs square→circle, with a drag-to-confirm or hold-to-confirm gesture. Works with no entity.",preview:!0});
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const aa=Bs(class extends Is{constructor(){super(...arguments),this.key=V}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(((e,t=Ls)=>{e._$AH=t})(e),this.key=t),i}}),na=[Ee,ze,Te,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-schedule-editor",class extends He{_formData(){return{presentation:"inline",...this._config}}get _sections(){return[{title:"Setup",icon:"mdi:tune",fields:[{name:"name",label:"Eyebrow above the chosen moment",helper:'What is being scheduled — e.g. "Start cleaning".',selector:{text:{}}},{name:"presentation",label:"Presentation",helper:"Sheet drops the collapsed strip and renders the picker directly — for putting the card inside a browser_mod popup.",selector:{select:{mode:"dropdown",options:[{value:"inline",label:"Inline — collapsed strip that expands"},{value:"sheet",label:"Sheet — always open, for a modal"}]}}},{name:"empty_label",label:"Strip title when nothing is set",selector:{text:{}}},{name:"empty_sub",label:"Strip sub-line when nothing is set",selector:{text:{}}}]},{title:"Wiring",icon:"mdi:transit-connection-variant",fields:[{name:"confirm_action",label:"On confirm",helper:"Use $datetime, $date, $time, $duration, $weekdays, $repeat, $trigger, $label in the data.",selector:{ui_action:{default_action:"none"}}},{name:"trigger_action",label:"On confirm, trigger tab",helper:"Falls back to the confirm action when unset.",selector:{ui_action:{default_action:"none"}}},{name:"close_action",label:"How to dismiss the modal",helper:"Sheet presentation only. Defaults to browser_mod.close_popup.",selector:{ui_action:{default_action:"none"}}}]},{title:"Shortcuts",icon:"mdi:clock-fast",fields:[{name:"presets",label:'The "At a time" shortcuts',helper:'List of { label, offset: 90m|2h|1d } or { label, at: "09:00", days: 1 } or { label, at, weekday: 6 }. Each may carry its own tap_action. Empty for the built-in six.',selector:{object:{}}},{name:"minutes",label:"Minute options (default 0, 15, 30, 45)",selector:{object:{}}}]},{title:"Triggers",icon:"mdi:sensors",fields:[{name:"triggers",label:"Non-clock triggers",helper:"List of { key, name, sub, icon }. Leave empty for the built-in four.",selector:{object:{}}}]}]}});class oa extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_open:{state:!0},_armed:{state:!0},_mode:{state:!0},_pick:{state:!0},_event:{state:!0},_customOpen:{state:!0},_viewY:{state:!0},_viewM:{state:!0},_date:{state:!0},_hour:{state:!0},_minute:{state:!0},_repeating:{state:!0},_days:{state:!0},_resolvedPending:{state:!0},_resolvedNextLabel:{state:!0},_resolvedNextSub:{state:!0}};static styles=na;static getConfigElement(){return document.createElement("materia-schedule-editor")}static getStubConfig(){return{name:"Start cleaning"}}setConfig(e){this.config={presentation:"inline",default_mode:"clock",...e},this._modeTouched||(this._mode=this._modes[0])}get _isSheet(){return"sheet"===this.config.presentation}get _isSummary(){return"summary"===this.config.presentation}_tpl(e,t){const i=this.config[e];if(null==i)return null;const s=this._isTemplate(i)?this[t]:i,a=null==s?"":String(s).trim();return a.length?a:null}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&(this._resolveField("pending","_resolvedPending"),this._resolveField("next_label","_resolvedNextLabel"),this._resolveField("next_sub","_resolvedNextSub"),(this.config.schedules||[]).forEach((e,t)=>{null!=e.label&&this._resolveTemplateValue(`schedLabel${t}`,e.label)})),this.toggleAttribute("sheet",this._isSheet),this._syncFoldHeight()}constructor(){super();const e=new Date;this._open=!1,this._armed=null,this._mode="clock",this._pick=null,this._event=null,this._customOpen=!1,this._viewY=e.getFullYear(),this._viewM=e.getMonth(),this._date=e.getDate(),this._hour=9,this._minute=0,this._repeating=!1,this._days=[!0,!0,!0,!0,!0,!1,!1]}get _pickKey(){return this._pick}get _hasSelection(){return"event"===this._mode?null!=this._event:null!=this._pick}get _isWired(){return!!(this.config.confirm_action||this.config.trigger_action||(this.config.presets??[]).some(e=>e.tap_action)||(this.config.triggers??[]).some(e=>e.tap_action))}get _pending(){const e=this.config.pending;if(!e)return null;const t=this._isTemplate(e)?this._resolvedPending:e,i=null==t?"":String(t).trim();return i.length?i:null}get _modes(){const e=[];return!1!==this.config.show_time&&e.push("clock"),!1!==this.config.show_triggers&&e.push("event"),e.length||e.push("clock"),"event"===this.config.default_mode&&e.includes("event")?["event",...e.filter(e=>"event"!==e)]:e}get _lang(){return this.hass?.locale?.language||void 0}_pad(e){return String(e).padStart(2,"0")}_hhmm(e){return`${this._pad(e.getHours())}:${this._pad(e.getMinutes())}`}_dayTime(e){return`${new Intl.DateTimeFormat(this._lang,{weekday:"short"}).format(e)} ${this._hhmm(e)}`}get _defaultPresets(){return[{label:ke("sched_preset_1h",this.hass),offset:"1h"},{label:ke("sched_preset_4h",this.hass),offset:"4h"},{label:ke("sched_preset_tonight",this.hass),at:"23:00"},{label:ke("sched_preset_tomorrow",this.hass),at:"09:00",days:1,grow:1.4},{label:ke("sched_preset_noon",this.hass),at:"12:00"},{label:ke("sched_preset_saturday",this.hass),at:"10:00",weekday:6,grow:1.4}]}_resolvePreset(e,t){if(e.offset){const i=/^(\d+(?:\.\d+)?)\s*(m|h|d)$/i.exec(String(e.offset).trim());if(!i)return null;const s={m:6e4,h:36e5,d:864e5}[i[2].toLowerCase()];return new Date(t.getTime()+parseFloat(i[1])*s)}const i=/^(\d{1,2}):(\d{2})$/.exec(String(e.at??"").trim());if(!i)return null;const[s,a]=[Number(i[1]),Number(i[2])],n=new Date(t);if(n.setSeconds(0,0),n.setHours(s,a),null!=e.weekday){let i=(Number(e.weekday)%7-t.getDay()+7)%7;return 0===i&&n<=t&&(i=7),n.setDate(n.getDate()+i),n}return null!=e.days?(n.setDate(n.getDate()+Number(e.days)),n):(n<=t&&n.setDate(n.getDate()+1),n)}get _quick(){const e=new Date;return(this.config.presets??this._defaultPresets).map((t,i)=>{const s=this._resolvePreset(t,e);if(!s)return null;const a=s.toDateString()===e.toDateString();return{key:t.key??`p${i}`,name:t.label??"—",at:a?this._hhmm(s):this._dayTime(s),grow:t.grow??1,when:s,tap_action:t.tap_action}}).filter(Boolean)}get _defaultTriggers(){return[{key:"leave",label:ke("sched_trigger_leave",this.hass),secondary:ke("sched_trigger_leave_sub",this.hass),icon:"m3o:directions-walk"},{key:"empty",label:ke("sched_trigger_empty",this.hass),secondary:ke("sched_trigger_empty_sub",this.hass),icon:"m3o:person-off"},{key:"night",label:ke("sched_trigger_night",this.hass),secondary:ke("sched_trigger_night_sub",this.hass),icon:"m3o:bedtime"},{key:"sunset",label:ke("sched_trigger_sunset",this.hass),secondary:ke("sched_trigger_sunset_sub",this.hass),icon:"m3o:wb-twilight"}]}get _events(){return(this.config.triggers??this._defaultTriggers).map((e,t)=>({key:e.key??`t${t}`,name:e.label??e.name??"—",sub:e.secondary??e.sub??"",icon:e.icon??"m3o:sensors",tap_action:e.tap_action}))}get _describe(){if("event"===this._mode){const e=this._events.find(e=>e.key===this._event);return e?{head:e.name,sub:`${e.sub} · trigger`}:{head:ke("sched_pick_trigger",this.hass),sub:ke("sched_runs_whenever",this.hass)}}if("custom"===this._pick){const e=new Intl.DateTimeFormat(this._lang,{day:"numeric",month:"long"}).format(new Date(this._viewY,this._viewM,this._date));return{head:`${this._pad(this._hour)}:${this._pad(this._minute)}`,sub:e}}const e=this._quick.find(e=>e.key===this._pickKey);return e?{head:e.at,sub:e.name}:{head:ke("sched_when_question",this.hass),sub:ke("sched_pick_moment",this.hass)}}get _dayNames(){const e=new Intl.DateTimeFormat(this._lang,{weekday:"narrow"});return Array.from({length:7},(t,i)=>e.format(new Date(2024,0,1+i)))}get _tabConfig(){const e={clock:{label:this.config.time_tab_label??ke("sched_at_a_time",this.hass),value:"clock",icon:"m3o:schedule"},event:{label:this.config.trigger_tab_label??ke("sched_when_ellipsis",this.hass),value:"event",icon:"m3o:sensors"}};return{size:"m",preset:"primary",options:this._modes.map(t=>e[t])}}get _minuteConfig(){return{size:"s",preset:"primary",options:(this.config.minutes??[0,15,30,45]).map(e=>({label:this._pad(e),value:String(e)}))}}get _weekdayConfig(){return{size:"s",preset:"primary",multi_select:!0,active_shape:"square",options:this._dayNames.map((e,t)=>({label:e,value:String(t)}))}}get _resolvedWhen(){return"event"===this._mode?null:"custom"===this._pickKey?new Date(this._viewY,this._viewM,this._date,this._hour,this._minute,0,0):this._quick.find(e=>e.key===this._pickKey)?.when??null}_actionContext(){const e=this._resolvedWhen,t=e=>String(e).padStart(2,"0");let i="",s="",a="",n="";if(e){s=`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`,a=`${t(e.getHours())}:${t(e.getMinutes())}`,i=`${s} ${a}:00`;const o=Math.max(0,Math.round((e.getTime()-Date.now())/1e3));n=`${t(Math.floor(o/3600))}:${t(Math.floor(o%3600/60))}:${t(o%60)}`}return{datetime:i,date:s,time:a,duration:n,weekdays:this._repeating?["mon","tue","wed","thu","fri","sat","sun"].filter((e,t)=>this._days[t]):[],repeat:!!this._repeating,trigger:this._event??"",label:this._describe.head}}_fill(e,t){if("string"==typeof e){const i=/^\$(\w+)$/.exec(e.trim());return i&&i[1]in t?t[i[1]]:e.replace(/\$(\w+)/g,(e,i)=>i in t?String(t[i]):e)}return Array.isArray(e)?e.map(e=>this._fill(e,t)):e&&"object"==typeof e?Object.fromEntries(Object.entries(e).map(([e,i])=>[e,this._fill(i,t)])):e}_syncFoldHeight(){const e=this.shadowRoot?.querySelector(".custom-body");if(!e)return;const t=this.shadowRoot.querySelector(".custom-inner");e.style.height=this._customOpen&&t?`${t.scrollHeight}px`:"0px"}_seedCustom(){const e=this._quick.find(e=>e.key===this._pickKey)?.when??new Date(Date.now()+36e5);this._viewY=e.getFullYear(),this._viewM=e.getMonth(),this._date=e.getDate();const t=[...this.config.minutes??[0,15,30,45]].sort((e,t)=>e-t),i=e.getMinutes(),s=t.find(e=>e>=i);this._minute=s??t[0],this._hour=null==s?(e.getHours()+1)%24:e.getHours()}_dismiss(){if(this._open=!1,!this._isSheet)return;const e=this.config.close_action??{action:"fire-dom-event",browser_mod:{service:"browser_mod.close_popup",data:{}}};this._handleAction(e)}_commit(){if(!this._hasSelection)return;this._armed={...this._describe,repeating:this._repeating,mode:this._mode},this._open=!1;const e="event"===this._mode?this._events.find(e=>e.key===this._event):this._quick.find(e=>e.key===this._pickKey),t=e?.tap_action??("event"===this._mode?this.config.trigger_action:null)??this.config.confirm_action;t?this._handleAction(this._fill(t,this._actionContext())):this._fireHaptic("success"),this._isSheet&&this._dismiss()}_renderStrip(){const e=this._armed,t=e?e.head:this.config.empty_label??ke("sched_not_scheduled",this.hass),i=e?e.sub:this.config.empty_sub??ke("sched_tap_to_pick",this.hass),s=e?"event"===e.mode?"m3o:sensors":"m3o:alarm":"m3o:add";return I`
        ...
        <div class="sheet">
          <div class="echo">
            ...
            ${(()=>{const i=this._hasSelection?t.head:e??t.head,s=this._hasSelection?t.sub:e?this.config.pending_sub??ke("sched_pending_sub",this.hass):t.sub;return I`
                ${aa(i,I`<span class="headline swap">${i}</span>`)}
                ${aa(s,I`<span class="subline swap">${s}</span>`)}
              `})()}
          </div>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return this._open||this._isSheet?10:2}}customElements.define("materia-schedule",oa),window.customCards=window.customCards||[],window.customCards.push({type:"materia-schedule",name:"Materia Schedule",description:"Shortcuts-first schedule picker — quick chips, non-clock triggers, and a calendar that stays folded until asked for. Mocked, no backend.",preview:!0});const ra=[Pi,n`
  ...
  `];class la extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-select-hero",ca),window.customCards=window.customCards||[],window.customCards.push({type:"materia-select-hero",name:"Materia Select Hero",description:"A select whose current option owns the panel — glyph, name, one line of consequence, and the option pills in one block. A variant of Materia Hero.",preview:!0});const ha=[Ee,ze,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-heading-editor",class extends He{_formData(){return{heading_style:"title",...this._config}}get _sections(){return[{title:"Heading",icon:"mdi:format-title",fields:[{name:"heading",required:!0,selector:{text:{}}},{name:"heading_style",label:"Style",selector:{select:{mode:"dropdown",options:[{value:"title",label:"Title"},{value:"subtitle",label:"Subtitle"}]}}},{name:"icon",selector:{icon:{}}},{name:"secondary",label:"Right-aligned meta line",template:!0,selector:{text:{}}},{name:"tap_action",selector:{ui_action:{default_action:"none"}}}]}]}});class da extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedSecondary:{state:!0}};static styles=ha;static getConfigElement(){return document.createElement("materia-heading-editor")}static getStubConfig(){return{heading:"Section"}}setConfig(e){this.config={...e}}updated(e){e.has("hass")&&this.hass&&this._resolveField("secondary","_resolvedSecondary")}get _secondary(){const e=this.config.secondary;if(null==e)return null;const t=this._isTemplate(e)?this._resolvedSecondary:e,i=null==t?"":String(t).trim();return i.length?i:null}render(){if(!this.config)return I``;const e="subtitle"===this.config.heading_style,t=this._secondary,i=!!this.config.tap_action;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-heading",da),window.customCards=window.customCards||[],window.customCards.push({type:"materia-heading",name:"Materia Heading",description:"Section heading in the family's display voice, with a templatable right-aligned meta line.",preview:!0});const pa=[Ee,ze,Te,ge,n`
    ha-card {
      background: var(--ha-card-background, var(--card-background-color));
      overflow: hidden;
      container-type: inline-size;
  ...
  `];customElements.define("materia-doorbell-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Doorbell",icon:"mdi:doorbell",fields:[{name:"entity",label:"Doorbell entity",helper:"on = ringing. The countdown runs from its last change.",selector:{entity:{domain:["input_boolean","binary_sensor","switch"]}}},{name:"timeout",label:"Popup timeout (seconds)",helper:"Match the popup timeout so the top bar and the dialog agree.",selector:{number:{min:5,max:300,mode:"box"}}},{name:"ring_seconds",label:"Ring length (seconds)",helper:"How long the chime actually sounds — the ring lapses when it ends. Empty = same as the popup timeout.",selector:{number:{min:1,max:300,mode:"box"}}},{name:"name",label:"Eyebrow while ringing (default: Doorbell)",selector:{text:{}}},{name:"place",label:"Where the ring is from (default: Front door)",selector:{text:{}}},{name:"demo",label:"Preview a phase (demo)",helper:"Forces the card's face — the live phases only show during a real ring. Clear it for real use.",selector:{select:{mode:"dropdown",options:[{value:"ringing",label:"Ringing"},{value:"buzzing",label:"Buzzing"},{value:"buzzed",label:"Buzzed"},{value:"opened",label:"Opened"},{value:"lapsed",label:"Lapsed"}]}}}]},{title:"Buzz panel",icon:"mdi:bullhorn",fields:[{name:"buzz_action",label:"Tap-to-buzz action",helper:"The street-door buzzer. Leave empty to hide the panel.",selector:{ui_action:{default_action:"none"}}},{name:"buzz_entity",label:"Buzzing indicator",helper:"on = buzzing (usually the buzzer script itself).",selector:{entity:{}}},{name:"buzz_title",label:"Panel title (default: Buzz in)",selector:{text:{}}},{name:"buzz_sub",label:"Panel sub-line",helper:'Default: "Street door only", translated with the dashboard.',selector:{text:{}}}]},{title:"Open panel",icon:"mdi:lock-open-variant-outline",fields:[{name:"lock",label:"Lock",helper:"The gesture unlocks this. Leave empty to hide the panel.",selector:{entity:{domain:"lock"}}},{name:"open_gesture",label:"Open gesture",selector:{select:{mode:"dropdown",options:[{value:"slide",label:"Slide"},{value:"hold",label:"Hold"}]}}},{name:"open_action",label:"Open action (replaces the plain unlock)",helper:"For a let-them-in sequence that clears more than this one lock. Re-locking always drives the lock itself.",selector:{ui_action:{default_action:"none"}}},{name:"open_title",label:"Panel title (default: Open the front door)",selector:{text:{}}},{name:"open_sub",label:"Panel sub-line",helper:'Default: "Unlocks the front door for your visitor.", translated with the dashboard.',selector:{text:{}}}]},{title:"Bottom row",icon:"mdi:dots-horizontal",fields:[{name:"ignore_action",label:"Ignore",helper:"Empty hides the button. The whole row hides when nothing in it is configured.",selector:{ui_action:{default_action:"none"}}},{name:"replay_action",label:"Replay ring",helper:"Empty hides the button.",selector:{ui_action:{default_action:"none"}}},{name:"mute_entity",label:"Mute toggle entity",helper:"input_boolean silencing the chime. Empty hides the button.",selector:{entity:{domain:"input_boolean"}}}]}]}});const ua=ot(90,90,86,9),ma=6e3;class ga extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_now:{state:!0},_buzzedUntil:{state:!0}};static styles=pa;static getConfigElement(){return document.createElement("materia-doorbell-editor")}static getStubConfig(){return{entity:"",timeout:30}}setConfig(e){if(!e.entity)throw new Error("entity is required (on = ringing)");this.config={timeout:30,...e}}connectedCallback(){super.connectedCallback(),this._syncTicker()}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._tick),this._tick=null,clearTimeout(this._lingerTimer)}_on(e){const t=e?this.hass?.states[e]:void 0;return!!t&&["on","true","open","opening","unlocked","unlocking","running","active","home"].includes(String(t.state).toLowerCase())}get _ringSeconds(){return this.config.ring_seconds??this.config.timeout}get _ringing(){return null!=this._ringT0&&(Date.now()-this._ringT0)/1e3<this._ringSeconds}get _buzzing(){return this._on(this.config.buzz_entity)}get _buzzedRecently(){const e=this.config.timeout||0;if(this._buzzing)return!0;if(this._buzzedVia&&(Date.now()-this._buzzedVia)/1e3<=e)return!0;const t=this.config.buzz_entity?this.hass?.states[this.config.buzz_entity]:null;if(!t)return!1;const i=Date.parse(t.last_changed);return!Number.isNaN(i)&&(Date.now()-i)/1e3<=e}get _lockState(){const e=this.config.lock;return e?String(this.hass?.states[e]?.state??""):""}get _unlockedNow(){return["unlocked","unlocking"].includes(this._lockState)}get _openedViaCard(){return null!=this._openedVia&&(Date.now()-this._openedVia)/1e3<=(this.config.timeout||0)}get _opened(){if(this._buzzedRecently)return!0;if(!this._unlockedNow)return!1;const e=this.hass?.states[this.config.lock],t=e?Date.parse(e.last_changed):NaN;return!Number.isNaN(t)&&(Date.now()-t)/1e3<=(this.config.timeout||0)}get _unlocking(){return["unlocking","locking"].includes(this._lockState)}get _left(){return this._ringT0?Math.max(0,Math.ceil(this._ringSeconds-(Date.now()-this._ringT0)/1e3)):0}get _phase(){return this.config.demo?this.config.demo:this._opened?"opened":this._buzzing?"buzzing":this._buzzedUntil&&Date.now()<this._buzzedUntil?"buzzed":this._ringing?"ringing":"lapsed"}willUpdate(e){if(e.has("hass")||e.has("config")){if("ringing"===this.config?.demo)return void((!this._ringT0||(Date.now()-this._ringT0)/1e3>(this.config.timeout||0))&&(this._ringT0=Date.now()));if(!this._ringT0){const e=this.hass?.states[this.config?.entity],t=e?Date.parse(e.last_changed):NaN;!Number.isNaN(t)&&(Date.now()-t)/1e3<=(this.config.timeout||0)&&(this._ringT0=t)}this._ringT0&&(Date.now()-this._ringT0)/1e3>(this.config.timeout||0)&&(this._ringT0=null)}}updated(e){if(e.has("hass")){const e=this._buzzing;this._wasBuzzing&&!e&&(this._buzzedUntil=Date.now()+ma,clearTimeout(this._lingerTimer),this._lingerTimer=setTimeout(()=>this.requestUpdate(),6050)),this._wasBuzzing=e,this._syncTicker()}}get _windowLeft(){return this._ringT0?Math.max(0,Math.ceil((this.config.timeout||0)-(Date.now()-this._ringT0)/1e3)):0}_syncTicker(){const e=this._ringing||this._windowLeft>0;e&&!this._tick?this._tick=setInterval(()=>{this._now=Date.now()},1e3):!e&&this._tick&&(clearInterval(this._tick),this._tick=null)}_buzz(){this.config.buzz_action&&(this._buzzedVia=Date.now(),this._handleAction(this.config.buzz_action),this.config.buzz_entity||(this._buzzedUntil=Date.now()+ma,clearTimeout(this._lingerTimer),this._lingerTimer=setTimeout(()=>this.requestUpdate(),6050)))}_slide(){if(!this.config.lock)return;if(this.config.open_action)return this._openedVia=Date.now(),this._handleAction(this.config.open_action),void this.requestUpdate();const e="unlocked"===this._lockState?"lock":"unlock";this._callService("lock",e,{entity_id:this.config.lock})}_ignore(){this.config.ignore_action&&this._handleAction(this.config.ignore_action)}_replay(){this.config.replay_action&&this._handleAction(this.config.replay_action)}_toggleMute(){this.config.mute_entity&&this._callService("homeassistant","toggle",{entity_id:this.config.mute_entity})}_copy(e){const t=this.hass,i=this.config.place??ke("db_eyebrow_front",t),s=this._left;return{ringing:{eyebrow:this.config.name??ke("db_eyebrow",t),accent:!0,title:ke("db_title_ringing",t),sub:ke("db_sub_ringing",t,{place:i}),num:`${s}s`,numAccent:!0,cap:ke("db_count_before_lapse",t),icon:"m3of:notifications-active",chip:"live ringing"},buzzing:{eyebrow:ke("db_eyebrow_street",t),accent:!0,title:ke("db_title_buzzing",t),sub:ke("db_sub_buzzing",t),num:null,numAccent:!1,cap:null,icon:"m3o:door-open",chip:"live"},buzzed:{eyebrow:ke("db_eyebrow_street",t),accent:!1,title:ke("db_title_buzzed",t),sub:ke("db_sub_buzzed",t),num:null,numAccent:!1,cap:null,icon:"m3o:door-open",chip:"soft"},opened:{eyebrow:ke("db_eyebrow_front",t),accent:!1,title:ke("db_title_opened",t),titleAccent:!0,sub:this._unlockedNow?ke("db_sub_opened",t):ke("db_sub_buzzed",t),num:null,numAccent:!1,cap:null,icon:"m3o:lock-open-right",chip:"live"},lapsed:{eyebrow:this.config.name??ke("db_eyebrow",t),accent:!1,title:ke("db_title_lapsed",t),sub:ke("db_sub_lapsed",t),num:null,numAccent:!1,cap:null,icon:"m3o:notifications-off",chip:""}}[e]}render(){if(!this.config||!this.hass)return I``;const e=this._phase,t=this._copy(e),i=this._buzzing||"buzzing"===e,s=this.config.open_action?this._openedViaCard:this._unlockedNow,a=this.config.timeout>0&&this._ringT0?Math.round(this._windowLeft/this.config.timeout*100):100,n="buzzed"===e||this._buzzedRecently,o=ke(i?"db_buzz_busy":n?"db_buzz_done":"db_buzz_cta",this.hass),r=i?"m3o:door-open":n?"m3o:check-circle":"m3o:bolt",l=this._on(this.config.mute_entity);return I`
            ...
            ${this.config.buzz_action?I`
                  <div class="panel buzz ${i?"busy":""}" @click=${this._buzz}>
                    <div class="cookie-stage">
                      <svg class="wave one" viewBox="0 0 180 180"><path d=${ua}></path></svg>
                      <svg class="wave two" viewBox="0 0 180 180"><path d=${ua}></path></svg>
                      <svg class="cookie" viewBox="0 0 180 180"><path d=${ua}></path></svg>
    ...
    `}getCardSize(){return 5}}customElements.define("materia-doorbell",ga),window.customCards=window.customCards||[],window.customCards.push({type:"materia-doorbell",name:"Materia Doorbell",description:"Doorbell alert — countdown ring, tap-to-buzz, slide-to-unlock. Built for a browser_mod popup.",preview:!0});const fa=[Ee,ze,ge,n`
  ...
  `];class _a extends He{static properties={_expanded:{state:!0},_editingCard:{state:!0}};static styles=[He.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `:I`<ha-card>${s}</ha-card>`}getGridOptions(){return this._panes?{columns:12,rows:"auto"}:{columns:2,rows:"auto"}}getCardSize(){return this._panes?6:3}}customElements.define("materia-tabs",va),window.customCards=window.customCards||[],window.customCards.push({type:"materia-tabs",name:"Materia Tabs",description:"Vertical tab rail — the selected tab grows into the nav-rail indicator. Embed cards per tab, or pair with conditional cards.",preview:!0});const ya=[...pi,n`
  ...
  `];class xa extends He{static properties={_editingCard:{state:!0}};static styles=[He.styles,n`
      .cards-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return this._open&&this._cards?1+this._cards.length:1}}customElements.define("materia-expander",wa),window.customCards=window.customCards||[],window.customCards.push({type:"materia-expander",name:"Materia Expander",description:"Switch row that opens — the one control that matters stays inline, everything else lives behind the chevron.",preview:!0});const ka=[Ee,ze,Te,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-level-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",template:!0,selector:{text:{}}},{name:"attribute",label:"Attribute holding the level",helper:"Defaults per domain: volume_level, brightness, percentage, current_position. Leave empty for number helpers.",selector:{text:{}}},{name:"icon",label:"Leading icon",template:!0,selector:{icon:{}}}]},{title:"Range",icon:"mdi:ruler",secondary:"Left empty, these come from the entity",fields:[{name:"min",label:"Minimum (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"max",label:"Maximum (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"step",label:"Step (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"unit",label:"Unit shown after the value",helper:"Defaults to the entity's unit, or % for volume and brightness.",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Tile background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Content color on it",color:!0,template:!0,selector:{text:{}}},{name:"slider_color",label:"Active track & handle",color:!0,template:!0,selector:{text:{}}},{name:"slider_track_color",label:"Inactive track",color:!0,template:!0,selector:{text:{}}},{name:"hide_stops",label:"Hide the stop indicators",helper:"The small M3 dots at each end of the track. Shown by default.",selector:{boolean:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});const $a={volume_level:{min:0,max:1,step:.01,factor:100,unit:"%"},brightness:{min:0,max:255,step:1,factor:100/255,unit:"%"},percentage:{min:0,max:100,step:1,factor:1,unit:"%"},current_position:{min:0,max:100,step:1,factor:1,unit:"%"}},Ca={media_player:"volume_level",light:"brightness",fan:"percentage",cover:"current_position"},Sa={media_player:["media_player.volume_set","volume_level"],light:["light.turn_on","brightness"],number:["number.set_value","value"],input_number:["input_number.set_value","value"],fan:["fan.set_percentage","percentage"],cover:["cover.set_cover_position","position"]},za=(e,t)=>{const i=Number(e);return Number.isFinite(i)?i:t},Ta=e=>{const t=String(e),i=t.indexOf(".");return i<0?0:Math.min(6,t.length-i-1)};class Ea extends(as(hi(Se(ce)))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedLabel:{state:!0},_resolvedIcon:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedSliderColor:{state:!0},_resolvedSliderTrackColor:{state:!0},_dragging:{state:!0}};static styles=[ka,di];static getConfigElement(){return document.createElement("materia-level-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}),i=t.find(e=>e.startsWith("media_player."))||t.find(e=>e.startsWith("input_number."))||t.find(e=>e.startsWith("number."))||t.find(e=>e.startsWith("light."))||"";return{entity:i}}setConfig(e){if(!e.entity)throw new Error("Materia Level: entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("label","_resolvedLabel"),this._resolveField("icon","_resolvedIcon"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("slider_color","_resolvedSliderColor"),this._resolveField("slider_track_color","_resolvedSliderTrackColor"),this._optimisticReconcile())}get _stateObj(){return this.hass?.states[this.config.entity]}get _domain(){return String(this.config.entity||"").split(".")[0]}get _attribute(){return this.config.attribute??Ca[this._domain]??null}get _scale(){const e=this._stateObj?.attributes||{},t=$a[this._attribute]||{min:za(e.min,0),max:za(e.max,100),step:za(e.step,1),factor:1,unit:e.unit_of_measurement??""},i="percentage"===this._attribute?za(e.percentage_step,t.step):t.step;return{min:za(this.config.min,t.min),max:za(this.config.max,t.max),step:za(this.config.step,i),factor:t.factor,unit:this.config.unit??t.unit}}_optimisticActual(){const e=this._stateObj;if(!e)return null;const t=this._attribute?e.attributes?.[this._attribute]:e.state,i=Number(t);return Number.isFinite(i)?String(i):"light"===this._domain&&"off"===e.state?"0":null}get _current(){if(null!=this._dragging)return this._dragging;const e=Number(this._optimistic);return Number.isFinite(e)?e:null}_quantize(e,t){const{min:i,max:s,step:a}=t,n=a>0?Math.round((e-i)/a)*a+i:e,o=Math.min(s,Math.max(i,n));return Number(o.toFixed(Ta(a)))}_display(e,t){if(null==e)return"—";const i=e*t.factor,s=1===t.factor?Ta(t.step):0;return Number(i.toFixed(s)).toLocaleString(this.hass?.locale?.language||"en",{minimumFractionDigits:s,maximumFractionDigits:s})}_onDragging(e){e.stopPropagation();const t=Number(e.detail?.value);this._dragging=Number.isFinite(t)?t:null}_onCommit(e){e.stopPropagation();const t=Number(e.detail?.value);if(this._dragging=null,!Number.isFinite(t))return;const i=this._quantize(t,this._scale),s=this._stateObj;if(!s)return;const[a,n]=this._writeTarget();if(!a)return;if(this._fireHaptic("selection"),this._optimisticSet(i),!this.config.service&&"light"===this._domain&&i<=0)return void this._callService("light","turn_off",{entity_id:s.entity_id});const[o,r]=a.split(".");this._callService(o,r,{entity_id:s.entity_id,[n]:i})}_writeTarget(){if(this.config.service){const e=this.config.service_key||this._attribute||"value";return[String(this.config.service),e]}const e=Sa[this._domain];return e?[e[0],this.config.service_key||e[1]]:this._attribute?[`${this._domain}.set_${this._attribute}`,this.config.service_key||this._attribute]:[null,null]}_field(e,t){const i=this.config[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._scale,i=this._current,s=!e||this._isUnavailable(e)||"unknown"===e.state||null==i,a=this._field("label","_resolvedLabel")||e?.attributes?.friendly_name||this.config.entity,n=this._field("icon","_resolvedIcon"),o=this._field("color","_resolvedColor"),r=this._field("color_on","_resolvedColorOn"),l=this._field("slider_color","_resolvedSliderColor")||r||"var(--md-sys-color-primary, var(--primary-color))",c=this._field("slider_track_color","_resolvedSliderTrackColor")||"",h=this._display(i,t),d=t.unit;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-level",Ea),window.customCards=window.customCards||[],window.customCards.push({type:"materia-level",name:"Materia Level",description:"Entity-bound level row with an M3 Expressive slider — volumes, dimmers, number helpers, fan speeds.",preview:!0});const Aa=[Ee,ze,Te,di,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Ma=[{value:"home",label:"Home"},{value:"away",label:"Away"},{value:"night",label:"Night"},{value:"vacation",label:"Vacation"},{value:"custom",label:"Custom bypass"}];class Oa extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}}customElements.define("materia-alarm-editor",Oa);const Fa=[{key:"home",feature:1,state:"armed_home",service:"alarm_arm_home",icon:"m3o:home",hero:"m3o:shield-person"},{key:"away",feature:2,state:"armed_away",service:"alarm_arm_away",icon:"m3o:directions-walk",hero:"m3o:shield-lock"},{key:"night",feature:4,state:"armed_night",service:"alarm_arm_night",icon:"m3o:bedtime",hero:"m3o:shield-moon"},{key:"vacation",feature:32,state:"armed_vacation",service:"alarm_arm_vacation",icon:"m3o:beach-access",hero:"m3o:shield-lock"},{key:"custom",feature:16,state:"armed_custom_bypass",service:"alarm_arm_custom_bypass",icon:"m3o:tune",hero:"m3o:shield-lock"}],Da=new Set(Fa.map(e=>e.state)),qa=new Set(["arming","pending"]),Ra=new Set(["on","true","open","opening","unlocked","unlocking","detected","running","active","home"]),Pa=new Set(["motion","occupancy","presence","vibration","sound","moving","running","light"]),Na=new Set(["door","window","opening","garage_door","lock","tamper"]),Ua=new Set(["smoke","gas","heat","moisture","co","safety","problem"]),La=["fire","smoke","heat","gas","water","flood"],ja=["motion","walk","presence","occupancy","radar"],Ba=["door","window","garage","gate","lock","shield","bell","wardrobe","cupboard","curtain","shutter","blind"],Ia=me.ms;class Ha extends(hi(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_holdKey:{state:!0},_settling:{state:!0},_hint:{state:!0},_refused:{state:!0},_zonesOpen:{state:!0},_unavailOpen:{state:!0},_safetyOpen:{state:!0},_turn:{state:!0},_shake:{state:!0},_sweeping:{state:!0}};static styles=Aa;static getConfigElement(){return document.createElement("materia-alarm-editor")}static getStubConfig(e){const t=e?Object.keys(e.states):[],i=t.find(e=>e.startsWith("alarm_control_panel.")),s=i?{entity:i}:{},a=t.find(e=>/^sensor\..*zone\d+state$/i.test(e));if(a){const t=a.split(".")[1].replace(/_?zone\d+state$/i,"");s.zone_filter="sensor."+t+"_zone";const i=e?.services?.[t];i?.bypass&&i?.unbypass&&(s.bypass_action={action:"perform-action",perform_action:t+".bypass",data:{zone:"{zone}"}},s.unbypass_action={action:"perform-action",perform_action:t+".unbypass",data:{zone:"{zone}"}})}return s}setConfig(e){this.config={...e}}constructor(){super(),this._pending=null,this._holdKey=null,this._p=0,this._settling=!1,this._hint=null,this._refused=null,this._zonesOpen=void 0,this._unavailOpen=!1,this._safetyOpen=!1,this._turn=!1,this._shake=!1,this._sweeping=!1,this._turnDir=1}connectedCallback(){super.connectedCallback(),this._unsub=ji.subscribe(e=>{e===this.config?.entity&&this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=null,clearTimeout(this._pinTimer),clearTimeout(this._hintTimer),clearTimeout(this._refuseTimer),clearTimeout(this._turnTimer),clearTimeout(this._shakeTimer),clearTimeout(this._latchTimer),this._stopSweep(),this._cleanupGesture()}get _stateObj(){return this.hass?.states[this.config?.entity]}get _rawState(){return String(this._stateObj?.state??"")}get _state(){if(this._pending)return this._pending;const e=this._rawState;return ji.peek(this.config.entity,e)||e}get _busy(){const e=this._rawState;return!!qa.has(e)||!!this._pending&&e!==this._pending}get _triggered(){return"triggered"===this._state}get _disarming(){return"disarmed"===this._pending}get _armedish(){const e=this._state;return Da.has(e)||qa.has(e)||"triggered"===e}get _pose(){return this._armedish}get _reduceMotion(){return!!window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches}get _features(){return Number(this._stateObj?.attributes?.supported_features??0)}get _modes(){const e=this._features;let t=Fa.filter(t=>0!==(e&t.feature));t.length||this.config.modes||(t=Fa.filter(e=>"home"===e.key||"away"===e.key));const i=this.config.modes;return Array.isArray(i)&&i.length&&(t=i.map(e=>{const t=String(e).replace(/^armed_/,"").replace("custom_bypass","custom");return Fa.find(e=>e.key===t)}).filter(Boolean)),t}get _activeMode(){const e=this._modes,t=this._state,i=e.find(e=>e.state===t);return i||(("triggered"===t||"pending"===t||"arming"===t)&&(e.find(e=>e.state===this._lastArmed)||e[0])||null)}updated(e){const t=this._lastPose;if(this._lastPose=this._pose,t!==this._lastPose&&(this._poseAt=performance.now()),!e.has("hass"))return;const i=this._rawState;Da.has(i)&&(this._lastArmed=i),this._pending&&(i===this._pending?this._clearPin():qa.has(i)||i===this._pinFrom||this._clearPin()),this._punctuate(i)}_punctuate(e){const t=""!==e&&!qa.has(e)&&"unavailable"!==e&&"unknown"!==e,i=this._lastSettled;t&&(this._lastSettled=e),t&&void 0!==i&&i!==e&&(performance.now()-(this._poseAt??-1/0)<Ia||this._playTurn("disarmed"===e?-1:1))}get _armDurationMs(){const e="pending"===this._rawState||"pending"===this._state?"pending_duration_ms":"arming_duration_ms",t=Number(this.config?.[e]);return Number.isFinite(t)&&t>0?t:null}get _armAnchor(){const e=qa.has(this._rawState)?Date.parse(this._stateObj?.last_changed??""):NaN,t=null!=this._pending?this._pinAt:void 0;return null!=t&&Number.isFinite(e)?Math.min(t,e):null!=t?t:Number.isFinite(e)?e:null}get _canSweep(){return this._busy&&null!=this._armDurationMs&&null!=this._armAnchor}_syncSweep(){this._canSweep?this._startSweep():this._stopSweep()}_startSweep(){if(this._sweepRaf)return;this._sweeping=!0;const e=()=>{if(!this._canSweep)return void this._stopSweep();const t=this._armDurationMs,i=Math.min(1,Math.max(0,(Date.now()-this._armAnchor)/t)),s=this._reduceMotion?1/Math.max(1,t/1e3):0,a=s?Math.floor(i/s)*s:i;this._applyArmP(Math.min(1,a)),this._sweepRaf=requestAnimationFrame(e)};this._sweepRaf=requestAnimationFrame(e)}_stopSweep(){this._sweepRaf&&(cancelAnimationFrame(this._sweepRaf),this._sweepRaf=null),this.shadowRoot?.querySelector(".shape")?.style.removeProperty("--ma-p"),this._sweeping=!1}_applyArmP(e){this.shadowRoot?.querySelector(".shape")?.style.setProperty("--ma-p",String(e))}_playTurn(e){this._reduceMotion||(clearTimeout(this._turnTimer),this._turnDir=e,this._turn=!1,requestAnimationFrame(()=>{this._turn=!0,this._turnTimer=setTimeout(()=>{this._turn=!1},650)}))}_playShake(){this._reduceMotion||(clearTimeout(this._shakeTimer),this._shake=!1,requestAnimationFrame(()=>{this._shake=!0,this._shakeTimer=setTimeout(()=>{this._shake=!1},500)}))}_clearPin(){this._pending=null,clearTimeout(this._pinTimer)}_zoneWord(e){const t=String(e?.state??"").trim();return t&&"unknown"!==t?t:String(e?.attributes?.status??e?.attributes?.state??t).trim()}_zoneUnavailable(e){if(!e)return!0;const t=this._zoneWord(e).toLowerCase();return""===t||"unavailable"===t||"unknown"===t||"none"===t}_zoneBypassed(e){return/^bypass/i.test(this._zoneWord(e))}_inferBypassed(e,t){if(this._zoneBypassed(e))return!0;if(t)return!1;if(!1===this.config?.bypass_from_can_bypass)return!1;if(!this.config?.unbypass_action)return!1;const i=e?.attributes?.can_bypass;return!(!1!==i&&"false"!==String(i).toLowerCase())&&(!this._zoneUnavailable(e)&&!this._zoneNotReady(e))}_zoneNotReady(e){const t=this._zoneWord(e).toLowerCase();return"not ready"===t||"notready"===t||Ra.has(t)}get _zonePattern(){return this.config.zone_pattern??"zone(\\d+)state$"}_zoneNumber(e){const t=this._zonePattern;if(this.__zoneReSrc!==t){this.__zoneReSrc=t;try{this.__zoneRe=new RegExp(t,"i")}catch(e){this.__zoneRe=null}}if(!this.__zoneRe)return null;const i=this.__zoneRe.exec(String(e??""));if(!i||void 0===i[1])return null;const s=Number(i[1]);return Number.isFinite(s)?s:null}get _settleMs(){return Math.max(0,Number(this.config.zone_settle_ms??8e3))}_book(e){this._zoneBook??=new Map;let t=this._zoneBook.get(e);return t||(t={word:null,flips:[],latched:!1,readyAt:null},this._zoneBook.set(e,t)),t}_flapping(e,t){const i=Math.max(1e3,Number(this.config.zone_flap_window_ms??6e4)),s=Math.max(2,Number(this.config.zone_flap_count??6));for(;e.flips.length&&t-e.flips[0]>i;)e.flips.shift();return e.flips.length>=s}_classify(e,t,i,s){if("boolean"==typeof e?.safety)return{transient:!1,safety:e.safety,by:"config"};if("boolean"==typeof e?.transient)return{transient:e.transient,safety:!1,by:"config"};const a=t?.attributes;if(!!(!a||!a.device_class&&!a.icon)&&i.known)return{...i.known};const n=a?.device_class;if(n){if(Ua.has(n))return this._remember(i,{transient:!1,safety:!0,by:"device_class"});if(Pa.has(n))return this._remember(i,{transient:!0,safety:!1,by:"device_class"});if(Na.has(n))return this._remember(i,{transient:!1,safety:!1,by:"device_class"})}const o=String(a?.icon??"").toLowerCase();if(o){const e=e=>e.some(e=>o.includes(e));if(e(La))return this._remember(i,{transient:!1,safety:!0,by:"icon"});if(e(ja))return this._remember(i,{transient:!0,safety:!1,by:"icon"});if(e(Ba))return this._remember(i,{transient:!1,safety:!1,by:"icon"})}if(!1===this.config.zone_flap_detect)return{transient:!1,safety:!1,by:"default"};const r=this._flapping(i,s);return{transient:r,safety:!1,by:r?"flapping":"default"}}_remember(e,t){return e.known=t,t}willUpdate(e){super.willUpdate?.(e),this._surveyZones(),this._syncSweep()}_surveyZones(){if(!this.hass||!this.config)return;const e=Date.now(),t=this._settleMs;let i=1/0;for(const s of this._zoneConfigs()){const a=this.hass.states[s.entity],n=this._book(s.entity),o=this._zoneWord(a);n.word!==o&&(null!==n.word&&n.flips.push(e),n.word=o);const r=this._classify(s,a,n,e),l=r.transient;n.transient=l,n.safety=r.safety,n.classifiedBy=r.by;const c=this._zoneUnavailable(a),h=!c&&this._inferBypassed(a,r.safety);!l&&!c&&!h&&this._zoneNotReady(a)?(n.latched=!0,n.readyAt=null):n.latched&&(null==n.readyAt&&(n.readyAt=e),e-n.readyAt>=t?(n.latched=!1,n.readyAt=null):i=Math.min(i,n.readyAt+t)),(c||h||l)&&n.latched&&(n.latched=!1,n.readyAt=null)}clearTimeout(this._latchTimer),i!==1/0&&(this._latchTimer=setTimeout(()=>this.requestUpdate(),Math.max(16,i-e)))}_zoneConfigs(){const e=Array.isArray(this.config.zones)?this.config.zones:null;return(e&&e.length?e:this._discoverZones()).filter(e=>e&&e.entity)}_discoverZones(){const e=this.config.zone_filter;if(!e||!this.hass?.states)return[];const t=String(e);let i;if(/[\\^$.*+?()[\]{}|]/.test(t))try{const e=new RegExp(t,"i");i=t=>e.test(t)}catch(e){i=e=>e.startsWith(t)}else i=e=>e.startsWith(t);return Object.keys(this.hass.states).filter(i).map(e=>({entity:e}))}_canSkip(e){if(e.unavailable)return!1;if(e.safety&&!0!==this.config.allow_safety_bypass)return!1;if(!this.config.bypass_action||null==e.zone)return!1;const t=e.st?.attributes?.can_bypass;return null==t||(!0===t||1===t||/^(true|yes|1)$/i.test(String(t)))}_canUnskip(e){return!!this.config.unbypass_action&&null!=e.zone}get _selfBypassed(){return this.__selfBypassed??=new Set,this.__selfBypassed}_canUndo(e){return!!this._canUnskip(e)&&(e.bypassed||this._selfBypassed.has(e.entity))}get _zones(){const e=this._zoneConfigs().map(e=>{const t=this.hass?.states[e.entity],i=this._zoneBook?.get(e.entity),s=i?.transient??!1,a=i?.safety??!1,n=this._zoneUnavailable(t),o=!n&&this._inferBypassed(t,a),r=!n&&!o&&this._zoneNotReady(t),l={...e,st:t,zone:this._zoneNumber(e.entity),unavailable:n,bypassed:o,transient:s,safety:a,classifiedBy:i?.classifiedBy??"default",sensing:s&&r,open:i?!s&&i.latched:!s&&r,name:e.name||t?.attributes?.friendly_name||t?.attributes?.name||e.entity,icon:e.icon||t?.attributes?.icon||"m3o:sensors"};return l.skippable=this._canSkip(l),l.unskippable=this._canUnskip(l),l.undoable=this._canUndo(l),l}).filter(e=>!1!==this.config.show_unavailable||!e.unavailable),t=e=>e.bypassed?3:e.open?0:e.unavailable?1:2;return e.sort((e,i)=>{const s=t(e)-t(i);return s||(null!=e.zone&&null!=i.zone?e.zone-i.zone:String(e.name).localeCompare(String(i.name)))})}_notReady(e){return e.filter(e=>e.open)}_withZone(e,t){if("string"==typeof e)return"{zone}"===e.trim()?t:e.includes("{zone}")?e.split("{zone}").join(String(t)):e;if(Array.isArray(e))return e.map(e=>this._withZone(e,t));if(e&&"object"==typeof e){const i={};for(const[s,a]of Object.entries(e))i[s]=this._withZone(a,t);return i}return e}_fireZoneAction(e,t){const i="bypass"===t?this.config.bypass_action:this.config.unbypass_action;i&&null!=e.zone&&("bypass"!==t||e.skippable)&&("bypass"===t?this._selfBypassed.add(e.entity):this._selfBypassed.delete(e.entity),this._handleAction(this._withZone(i,e.zone)),this.requestUpdate())}get _holdMs(){return Math.max(300,Number(this.config.hold_ms??800))}_isInert(e){if(this.config.direct_switch)return!1;const t=this._activeMode;return!!t&&t.key!==e.key}_showHint(e,t,i="warning"){clearTimeout(this._hintTimer),clearTimeout(this._refuseTimer),this._hint={key:e,text:t},this._refused=e,this._fireHaptic(i),this._hintTimer=setTimeout(()=>{this._hint=null},Number(this.config.hint_ms??2e3)),this._refuseTimer=setTimeout(()=>{this._refused=null},450)}_refusalFor(e){if(this._isInert(e))return ke("al_hint_disarm_first",this.hass);return this._activeMode?.key===e.key||!this._stateObj?.attributes?.code_arm_required||this.config.code?null:ke("al_hint_code_required",this.hass)}_onPointerDown(e,t){if(this._isUnavailable(this._stateObj))return;if(e.button&&0!==e.button)return;if(!e.isPrimary)return;if("touch"===e.pointerType&&e.clientX<=30)return;const i=this._refusalFor(t);i?this._showHint(t.key,i):(this._startX=e.clientX,this._startY=e.clientY,this._pointerId=e.pointerId,this._scrollIntent=!1,this._holdEl=e.currentTarget,this._target=e.currentTarget,this._onUpRef=this._onPointerUp.bind(this),window.addEventListener("pointerup",this._onUpRef),window.addEventListener("pointercancel",this._onUpRef),this._onEarlyMoveRef=this._onEarlyMove.bind(this),window.addEventListener("pointermove",this._onEarlyMoveRef),this._engage(t))}_onEarlyMove(e){if(this._scrollIntent)return;const t=Math.abs(e.clientX-this._startX),i=Math.abs(e.clientY-this._startY);i>10&&i>t+4&&(this._scrollIntent=!0,this._release(!1))}_engage(e){if(!this._holdKey){this._holdKey=e.key,this._settling=!1,this._p=0,this._engagedAt=Date.now(),this._holdMode=e;try{this._target?.setPointerCapture?.(this._pointerId)}catch(e){}this._target&&(document.documentElement.style.setProperty("touch-action","none"),document.documentElement.style.setProperty("overscroll-behavior","contain"),this._target.addEventListener("touchmove",this._preventTouch,{passive:!1})),this._onVisibilityRef=()=>{document.hidden&&this._release(!1)},document.addEventListener("visibilitychange",this._onVisibilityRef),this._tick=this._tick.bind(this),this._raf=requestAnimationFrame(this._tick)}}_applyP(){this._holdEl?.style.setProperty("--ma-p",String(this._p))}_preventTouch(e){e.preventDefault()}_tick(){if(!this._holdKey)return;const e=Math.min(1,(Date.now()-this._engagedAt)/this._holdMs);this._p=e,e>=1?this._commit():(this._applyP(),this._raf=requestAnimationFrame(this._tick))}_onPointerUp(e){if("pointercancel"===e.type&&this._engagedAt&&Date.now()-this._engagedAt<150)return clearTimeout(this._graceTimer),void(this._graceTimer=setTimeout(()=>this._release(!1),400));clearTimeout(this._graceTimer),this._release(!1)}_release(e){(this._holdKey||null!=this._startX)&&(e?this._commit():(this._settling=!0,this._p=0,this._cleanupGesture()))}_commit(){const e=this._holdMode;if(this._cleanupGesture(),!e)return;const t=this._activeMode?.key===e.key,i=t?"disarmed":e.state,s=t?"alarm_disarm":e.service;this._settling=!1,this._p=0,this._pinFrom=this._rawState,this._pinAt=Date.now(),this._pending=i,clearTimeout(this._pinTimer),this._armPinExpiry(),ji.publish(this.config.entity,i,this._pinFrom);const a={entity_id:this.config.entity};this.config.code&&(a.code=String(this.config.code)),this._fireHaptic("success"),this._callService("alarm_control_panel",s,a)}_armPinExpiry(){clearTimeout(this._pinTimer),this._pinTimer=setTimeout(()=>{this._pending&&(qa.has(this._rawState)?this._armPinExpiry():(this._pending=null,this._fireHaptic("warning"),this._playShake()))},Number(this.config.pending_timeout_ms??2e4))}_cleanupGesture(){if(this._holdEl?.style.removeProperty("--ma-p"),this._holdKey=null,this._holdMode=null,this._holdEl=null,this._startX=null,this._engagedAt=null,this._scrollIntent=!1,clearTimeout(this._graceTimer),this._raf&&(cancelAnimationFrame(this._raf),this._raf=null),document.documentElement.style.removeProperty("touch-action"),document.documentElement.style.removeProperty("overscroll-behavior"),this._target){this._target.removeEventListener("touchmove",this._preventTouch);try{this._target.releasePointerCapture?.(this._pointerId)}catch(e){}this._target=null}this._onVisibilityRef&&(document.removeEventListener("visibilitychange",this._onVisibilityRef),this._onVisibilityRef=null),this._onEarlyMoveRef&&(window.removeEventListener("pointermove",this._onEarlyMoveRef),this._onEarlyMoveRef=null),this._onUpRef&&(window.removeEventListener("pointerup",this._onUpRef),window.removeEventListener("pointercancel",this._onUpRef),this._onUpRef=null)}_isHoldKey(e){return"Enter"===e.key||" "===e.key||"Spacebar"===e.key}_onKeyDown(e,t){if(!this._isHoldKey(e))return;if(e.preventDefault(),e.repeat)return;if(this._isUnavailable(this._stateObj))return;const i=this._refusalFor(t);i?this._showHint(t.key,i):(this._target=null,this._holdEl=e.currentTarget,this._engage(t))}_onKeyUp(e){this._isHoldKey(e)&&this._release(!1)}_time(e){if(!e)return"";const t=this.hass?.locale?.language||"en";return new Date(e).toLocaleTimeString(t,{hour:"numeric",minute:"2-digit"})}_modeLabel(e){return this.config[`label_${e.key}`]??ke(`al_mode_${e.key}`,this.hass)}_title(){const e=this._state;if(this._isUnavailable(this._stateObj))return ke("unavailable",this.hass);if("triggered"===e)return ke("al_state_triggered",this.hass);if("arming"===e)return ke("al_state_arming",this.hass);if("pending"===e)return ke("al_state_pending",this.hass);if("disarmed"===e)return ke("al_state_disarmed",this.hass);const t=Fa.find(t=>t.state===e);return ke(t?`al_state_armed_${t.key}`:"al_state_unknown",this.hass)}_sub(e){const t=this._state,i=this._stateObj;if(this._isUnavailable(i))return{text:ke("al_sub_unavailable",this.hass),warn:!0};if("triggered"===t)return{text:ke("al_sub_triggered",this.hass,{time:this._time(i?.last_changed)}),warn:!0};if("pending"===t)return null==this._pending?{text:"",warn:!1}:{text:ke("al_sub_pending",this.hass),warn:!0};if(this._busy)return null==this._pending?{text:"",warn:!1}:{text:ke(this._disarming?"al_sub_disarming":"al_sub_arming",this.hass),warn:!1};if("disarmed"===t){if(!e.length)return{text:ke("al_sub_ready",this.hass),warn:!1};return{text:ke(1===e.length?"al_sub_not_ready_one":"al_sub_not_ready",this.hass,{n:e.length}),warn:!0}}return Da.has(t)?{text:ke("al_sub_armed_since",this.hass,{time:this._time(i?.last_changed)}),warn:!1}:{text:"",warn:!1}}_buttonHint(e){return this._hint?.key===e.key?this._hint.text:this._holdKey===e.key?ke("al_hint_holding",this.hass):this._busy&&this._disarming?ke("al_hint_disarming",this.hass):this._isInert(e)?ke("al_hint_disarm_first",this.hass):this._activeMode?.key===e.key?"pending"===this._rawState?ke("al_hint_hold_to_disarm",this.hass):this._busy?ke(this._disarming?"al_hint_disarming":"al_hint_arming",this.hass):ke("al_hint_hold_to_disarm",this.hass):ke("al_hint_hold_to_arm",this.hass)}_footnote(e){if(this._hint)return{text:this._hint.text,tone:"warn"};const t=this._state,i=this._activeMode;if(this._isUnavailable(this._stateObj))return{text:ke("al_sub_unavailable",this.hass),tone:"warn"};if("triggered"===t)return{text:ke("al_foot_triggered",this.hass,{mode:i?this._modeLabel(i):""}),tone:"alert"};if("pending"===t)return{text:ke("al_foot_pending",this.hass),tone:"alert"};if(this._busy)return this._disarming?{text:"",tone:""}:{text:ke("al_hint_hold_to_disarm",this.hass),tone:""};if(i){return{text:ke("al_foot_armed",this.hass,{mode:this._modeLabel(i)})+(this.config.direct_switch||this._modes.length<2?"":` ${ke("al_foot_locked_modes",this.hass)}`),tone:""}}return{text:ke("al_foot_disarmed",this.hass),tone:""}}_radius(e,t,i){if(i)return"28px";const s="48px",a="16px";return 1===t?s:0===e?`${s} ${a} ${a} ${s}`:e===t-1?`${a} ${s} ${s} ${a}`:a}render(){if(!this.hass||!this.config)return I``;const e="--ma-bg:var(--md-sys-color-surface-container-low, var(--card-background-color));--ma-fg:var(--md-sys-color-on-surface);";if(!this.config.entity)return I`<ha-card style=${e}><div class="body">
      ...
      </div></ha-card>`;const i=this._isUnavailable(t),s=this._zones,a=this._notReady(s),n=this._triggered,o=this._armedish,r=this._modes,l=this._activeMode,c=n?"var(--md-sys-color-error-container)":this.config.background??"var(--md-sys-color-surface-container-low, var(--card-background-color))",h=n?"var(--md-sys-color-on-error-container)":this.config.background_on??"var(--md-sys-color-on-surface)",d=this.config.armed_color??"var(--md-sys-color-primary)",p=this.config.armed_color_on??"var(--md-sys-color-on-primary)",u=this._canSweep&&!n,m=n?"var(--md-sys-color-error)":o?u?`color-mix(in srgb, ${d} 30%, transparent)`:d:`color-mix(in srgb, ${h} 12%, transparent)`,g=n?"var(--md-sys-color-on-error)":o?u?d:p:d,f=n?this.config.triggered_icon??"m3o:crisis-alert":l&&Da.has(this._state)?this.config[`icon_${l.key}`]??l.hero:this.config.disarmed_icon??"m3o:shield",_=this._sub(a),b=this._footnote(a),v=this.config.tap_action||{action:"more-info",entity:this.config.entity},y="none"!==v.action;return I`
        ...
        <div class="body ${n?"triggered":""}">
          ...
          ${r.length?I`
                <div class="modes" role="group" aria-label=${ke("al_aria_modes",this.hass)}>
                  ${r.map((e,t)=>this._renderMode(e,t,r.length,{active:l,notReady:a,triggered:n,accent:d,accentOn:p,idleBg:"var(--md-sys-color-secondary-container)",idleFg:"var(--md-sys-color-on-secondary-container)",unavailable:i}))}
                </div>
    ...
    `}_renderMode(e,t,i,s){const a=s.active?.key===e.key,n=this._isInert(e),o=this._holdKey===e.key,r=this._modeLabel(e),l=n?"m3o:lock":this.config[`icon_${e.key}`]??e.icon,c=a?s.triggered?"var(--md-sys-color-error)":s.accent:s.idleBg,h=a?s.triggered?"var(--md-sys-color-on-error)":s.accentOn:s.idleFg,d=!a&&s.notReady.length>0,p=d?"var(--md-sys-cust-color-warning, var(--md-sys-color-error))":a?s.idleBg:s.accent,u=d?"var(--md-sys-cust-color-on-warning, var(--md-sys-color-on-error))":a?s.idleFg:s.accentOn,m=n?ke("al_aria_inert",this.hass,{mode:r}):a?ke("al_aria_hold_disarm",this.hass):ke("al_aria_hold_arm",this.hass,{mode:r}),g=this._buttonHint(e),f=I`
    ...
    `;return I`
      <button
        ...
        style="border-radius:${this._radius(t,i,a)};--ma-btn-bg:${c};--ma-btn-fg:${h};--ma-sweep:${p};--ma-sweep-ink:${u};--ma-p:${o?this._p:0};"
        aria-label=${m}
    ...
    `}get _zonesExpanded(){return this._zonesOpen??!!this.config.zones_start_expanded}get _unavailExpanded(){return!!this._unavailOpen}get _safetyExpanded(){return!!this._safetyOpen}_zoneRow(e,t=""){const i=e.sensing?ke("al_zone_sensing",this.hass):this.hass.formatEntityState?.(e.st)??this._zoneWord(e.st);return I`
      <div class="zrow ${t} ${e.sensing?"sensing":""}">
        ...
        ${e.undoable?I`
              ...
              >
                ...
                <span>${ke("al_zone_unbypass",this.hass)}</span>
              </button>
            `:e.skippable?I`
              <button
                class="chip"
        ...
        ${n.length?I`
              <div class="zgroup">
                <div class="zgroup-title warn">
                  ${ke(1===n.length?"al_zones_bypassed_one":"al_zones_bypassed_count",this.hass,{n:n.length})}
                </div>
                ${n.map(e=>this._zoneRow(e,"bypassed"))}
              </div>
            `:V}

        ${t.length?this._zoneSummary({icon:i.length?"m3o:warning":"m3of:check-circle",cls:i.length?"safety-fault":"safety-ok",label:i.length?ke(1===i.length?"al_zones_safety_fault_one":"al_zones_safety_fault",this.hass,{n:i.length}):ke(1===t.length?"al_zones_safety_ok_one":"al_zones_safety_ok",this.hass,{n:t.length}),aria:ke("al_aria_safety_toggle",this.hass),open:this._safetyExpanded,toggle:()=>{this._safetyOpen=!this._safetyExpanded},rows:l}):V}

        ${a.length?this._zoneSummary({icon:"m3o:sensors-off",cls:"unavail",label:ke(1===a.length?"al_zones_unavailable_one":"al_zones_unavailable",this.hass,{n:a.length}),aria:ke("al_aria_unavail_toggle",this.hass),open:this._unavailExpanded,toggle:()=>{this._unavailOpen=!this._unavailExpanded},rows:a}):V}

        ${o.length?this._zoneSummary({icon:"m3of:check-circle",cls:"ok",label:r?ke("al_zones_ready_sensing",this.hass,{n:o.length-r,m:r}):ke(1===o.length?"al_zones_ready_one":"al_zones_ready_count",this.hass,{n:o.length}),aria:ke("al_aria_zones_toggle",this.hass),open:this._zonesExpanded,toggle:()=>{this._zonesOpen=!this._zonesExpanded},rows:o}):V}

      </div>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6+(!!this.config?.zone_filter||Array.isArray(this.config?.zones)&&this.config.zones.length>0?2:0)}}customElements.define("materia-alarm",Ha),window.customCards=window.customCards||[],window.customCards.push({type:"materia-alarm",name:"Materia Alarm",description:"Alarm panel where arming IS the gesture: press and hold the mode you want. Zone list with bypass, and the not-ready warning lives inside the hold.",preview:!0});const Wa=[Ee,ze,Te,di,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-confirm-editor",class extends He{_formData(){return{gesture:"hold",require_gesture:"activate",hold_ms:800,threshold:.55,pending_timeout_ms:1e4,caption_warn:!0,...this._config}}_sectionsSignature(){return[this._config?.entity?"e":"",this._config?.gesture||"hold",this._config?.require_gesture||"activate",this._config?.action?"a":""].join("|")}get _sections(){const e="slide"!==(this._config?.gesture??"hold"),t=!!this._config?.entity;return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Entity to reflect and drive (optional)",helper:"With an entity and no actions below, the gesture turns it on and the active face turns it off — nothing else to configure. Leave empty to fire an action only.",selector:{entity:{}}},...t?[{name:"active_state",label:"State that counts as active",helper:'Defaults to the usual on/open/unlocked family. Set this for a control whose "on" is spelled something else.',selector:{text:{}}}]:[],{name:"action",label:"Action when committing",helper:"Fired when the gesture completes. Overrides the default turn-on.",selector:{ui_action:{default_action:"none"}}},{name:"deactivate_action",label:"Action when switching off",helper:"Fired by the active face. Overrides the default turn-off.",selector:{ui_action:{default_action:"none"}}}]},{title:"Gesture",icon:"mdi:gesture-tap-hold",fields:[{name:"gesture",label:"Commit gesture",selector:{select:{mode:"dropdown",options:[{value:"hold",label:"Press and hold"},{value:"slide",label:"Slide across"}]}}},{name:"require_gesture",label:"Which direction needs the gesture",helper:"Turning ON only, by default: switching an override off returns things to normal and costs nothing, and making the cheap direction ceremonial teaches people the gesture is a formality. Choose both where OFF is the dangerous direction — a control that disables a protection rather than enabling a cost.",selector:{select:{mode:"dropdown",options:[{value:"activate",label:"Only turning on"},{value:"both",label:"Both directions"}]}}},...e?[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}}]:[{name:"threshold",label:"Fraction of the track to cross (default 0.55)",selector:{number:{min:.2,max:1,step:.05,mode:"box"}}}],...t?[{name:"pending_timeout_ms",label:"Give up waiting for the entity after (ms, default 10000)",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}}]:[]]},{title:"Words",icon:"mdi:text-short",fields:[{name:"eyebrow",label:"Eyebrow (optional)",template:!0,selector:{text:{}}},{name:"label",label:"Gesture label",helper:"The instruction across the track. Keep it short — it sits on one line.",template:!0,selector:{text:{}}},{name:"caption",label:"Warning / consequence line",helper:"THE POINT OF THIS CARD. Shown before the gesture is touched and while it is held, which is strictly more informative than a dialog that appears after the decision and gets dismissed by reflex. Put the cost or the consequence here.",template:!0,selector:{text:{}}},{name:"caption_warn",label:"Colour the warning line",selector:{boolean:{}}},{name:"active_label",label:"Label while active",template:!0,selector:{text:{}}},{name:"active_caption",label:"Caption while active",helper:"Falls back to the warning line above when empty.",template:!0,selector:{text:{}}},..."both"===this._config?.require_gesture?[]:[{name:"deactivate_hint",label:'Active face hint (default "Tap to stop")',selector:{text:{}}}],...t?[{name:"busy_label",label:'While waiting (default "Working…")',selector:{text:{}}}]:[]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"active_color",label:"Background while active",color:!0,selector:{text:{}}},{name:"active_color_on",label:"Text while active",color:!0,selector:{text:{}}},{name:"track_color",label:"Gesture track",color:!0,selector:{text:{}}},{name:"track_color_on",label:"Text on the track",color:!0,selector:{text:{}}},...e?[]:[{name:"handle_color",label:"Slide handle",color:!0,selector:{text:{}}},{name:"handle_color_on",label:"Handle glyph",color:!0,selector:{text:{}}}],{name:"active_icon",label:'Icon while active (default "check-circle")',selector:{icon:{}}},{name:"gesture_icon",label:"Icon on the gesture handle (optional)",selector:{icon:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});const Va=new Set(["on","true","open","opening","unlocked","unlocking","home","active"]);class Ga extends(hi(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_resolvedLabel:{state:!0},_resolvedActiveLabel:{state:!0},_resolvedCaption:{state:!0},_resolvedActiveCaption:{state:!0},_resolvedEyebrow:{state:!0}};static styles=Wa;static getConfigElement(){return document.createElement("materia-confirm-editor")}static getStubConfig(){return{gesture:"hold"}}setConfig(e){this.config={gesture:"hold",...e}}constructor(){super(),this._pending=null}connectedCallback(){super.connectedCallback(),this._unsub=ji.subscribe(e=>{e===this.config?.entity&&this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=null,clearTimeout(this._pinTimer)}updated(e){e.has("hass")&&this.hass&&(this._resolveField("label","_resolvedLabel"),this._resolveField("active_label","_resolvedActiveLabel"),this._resolveField("caption","_resolvedCaption"),this._resolveField("active_caption","_resolvedActiveCaption"),this._resolveField("eyebrow","_resolvedEyebrow"),null!=this._pending&&this._entityActive===this._pending&&(this._pending=null,clearTimeout(this._pinTimer)))}_field(e,t){const i=this.config?.[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}get _stateObj(){return this.config?.entity?this.hass?.states[this.config.entity]:null}get _entityActive(){const e=this._stateObj;if(!e||this._isUnavailable(e))return null;const t=String(e.state).toLowerCase();return this.config.active_state?t===String(this.config.active_state).toLowerCase():Va.has(t)}get _active(){return null!=this._pending?this._pending:!0===this._entityActive}get _busy(){return null!=this._pending&&this._entityActive!==this._pending}get _gestureBoth(){return"both"===this.config.require_gesture}get _showGesture(){return!this._active||this._gestureBoth}_commit(){const e=!this._active,t=this.config.entity;t&&(this._pending=e,clearTimeout(this._pinTimer),this._pinTimer=setTimeout(()=>{this._pending=null},Number(this.config.pending_timeout_ms??1e4)),ji.publish(t,e?"on":"off",this._stateObj?.state));const i=e?this.config.action:this.config.deactivate_action;i?this._handleAction(i):t&&(this._fireHaptic("success"),this._callService("homeassistant",e?"turn_on":"turn_off",{entity_id:t}))}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(this.config.entity&&!e)return I`<ha-card><div class="body">
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-confirm",Ga),window.customCards=window.customCards||[],window.customCards.push({type:"materia-confirm",name:"Materia Confirm",description:"Press-and-hold to commit a consequential action, with the warning in plain view instead of in a dialog. No tap path.",preview:!0});const Xa=[Ee,ze,Te,di,ge,n`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class Ya extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){const e=(this.config?.rows||[]).length;return(this.config?.eyebrow||this.config?.meta?1:0)+Math.ceil(e/2)+(this.config?.status?1:0)+(this.config?.footnote?1:0)||1}}customElements.define("materia-bars",Za),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bars",name:"Materia Bars",description:"Labelled readings as comparable bars on one shared scale, with a status sentence. A missing reading draws as unknown, never as zero.",preview:!0});const Qa={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-on-secondary-container)"],"tertiary-container":["var(--md-sys-color-tertiary-container)","var(--md-sys-color-on-tertiary-container)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-state":["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],"secondary-state":["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],"tertiary-state":["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],"error-state":["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],"device-state":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]},Ja=[Ee,ge,n`
    :host {
  ...
  `];customElements.define("materia-pill-editor",class extends He{_formData(){return{background:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"state_display",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}},{name:"background",selector:{boolean:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{}}}]}]}});class ln extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0},_resolvedStateDisplay:{state:!0}};static getConfigElement(){return document.createElement("materia-pill-editor")}static getStubConfig(e){const t=(e?Object.keys(e.states):[]).find(e=>e.startsWith("sensor."))||"";return{entity:t,name:"",icon:"mdi:information-outline"}}static styles=[Te,rn];setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={icon:"mdi:information-outline",...e}}_classify(e){const t=this.config.ranges||[];if(!t.length)return{label:"",color:""};const i=parseFloat(e);if(Number.isNaN(i))return{label:"",color:""};for(const e of t)if(null==e.max||i<=e.max)return{label:e.label,color:e.color};return{label:"",color:""}}get _templatesReady(){const e=this.config;return(!this._isTemplate(e?.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(e?.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(e?.icon)||void 0!==this._resolvedIcon)&&(!this._isTemplate(e?.name)||void 0!==this._resolvedName)))}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"),this._resolveField("state_display","_resolvedStateDisplay"))}render(){if(!this.hass||!this.config)return I``;if(!this._templatesReady)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=this._isTemplate(this.config.name)?this._resolvedName:this.config.name||e?.attributes?.friendly_name||this.config.entity,s=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||e?.attributes?.icon||"",a=e?.attributes?.unit_of_measurement||"",n=e?.state??"",o=this.config.ranges||[],r=this._classify(n);let l;l=t?"Unavailable":this.config.state_display?this._isTemplate(this.config.state_display)?this._resolvedStateDisplay??"":this.config.state_display:o.length?a?`${n} · ${r.label||i}`:n:a?`${this._capitalize(n)} ${a}`:this._capitalize(n);const c=o.length?t?i:a||(r.label||i):"",h=this._resolvedColor||this.config.color||"var(--ha-card-background, var(--card-background-color))",d=this._resolvedColorOn||this.config.color_on||"var(--primary-text-color)",p=!1===this.config.background||"none"===this.config.background;return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-pill",ln),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill",name:"Materia Pill",description:"Compact info pill for sensors, weather, and status indicators.",preview:!0});const cn=[Ee,ze,Te,n`
  :host {
    position: relative;
    z-index: 1;
  }
...
`];class hn extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-menu",dn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-menu",name:"Materia Menu",description:"M3 vertical dropdown menu for select entities.",preview:!0});const pn=n`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-progress-editor",class extends He{_formData(){return{show_times:!0,seekable:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"show_times",selector:{boolean:{}}},{name:"seekable",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Wave color",color:!0,template:!0,selector:{text:{}}}]}]}});let un=0;class mn extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_w:{state:!0},_resolvedColor:{state:!0}};static styles=pn;static getConfigElement(){return document.createElement("materia-media-progress-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("media_player."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config=e,this._cid??="mp-clip-"+ ++un}_position(){const e=this.hass?.states[this.config.entity];if(!e)return{pos:0,dur:0,playing:!1,live:!1};const t=Number(e.attributes.media_duration)||0;let i=Number(e.attributes.media_position)||0;const s="playing"===e.state,a=e.attributes.media_position_updated_at,n=`${this.config.entity}|${e.attributes.media_content_id??e.attributes.media_title??""}`;if(n!==this._latchKey&&(this._trackAnchorAt=Date.now()),s&&a){const e=Math.max(new Date(a).getTime(),this._trackAnchorAt??0);i+=Math.max(0,Date.now()-e)/1e3}return n!==this._latchKey&&(this._latchKey=n,this._live=!1),s?t>0&&i>=t-.25&&(this._live=!0):this._live=!1,t&&(i=Math.min(i,t)),{pos:Math.max(0,i),dur:t,playing:s,live:this._live}}_fmt(e){e=Math.max(0,Math.round(e));const t=Math.floor(e/3600),i=Math.floor(e%3600/60),s=e%60,a=e=>String(e).padStart(2,"0");return t>0?`${t}:${a(i)}:${a(s)}`:`${i}:${a(s)}`}_wavePath(e,t){let i="";for(let s=e;s<=t;s+=2){const e=14-2*Math.sin(2*Math.PI*s/32);i+=`${i?" L":"M"} ${s.toFixed(1)} ${e.toFixed(1)}`}return i||"M 0 14"}firstUpdated(){const e=this.shadowRoot?.querySelector(".bar");e&&(this._w=e.clientWidth,this._ro=new ResizeObserver(e=>{this._w=e[0].contentRect.width}),this._ro.observe(e))}updated(){const e=this.shadowRoot;this._clipRect=e?.querySelector("clipPath rect"),this._thumbEl=e?.querySelector(".thumb"),this._trackEl=e?.querySelector(".track"),this._posEl=e?.querySelector(".time");"playing"===this.hass?.states[this.config.entity]?.state&&!this._live?this._startLoop():this._stopLoop(),this.hass&&this._resolveField("color","_resolvedColor")}_startLoop(){if(this._raf)return;const e=()=>{this._raf=requestAnimationFrame(e),this._tickDom()};this._raf=requestAnimationFrame(e)}_tickDom(){const{pos:e,dur:t,live:i}=this._position(),s=this._w||300,a=(i?1:t>0?Math.min(1,e/t):0)*s;this._clipRect&&this._clipRect.setAttribute("width",Math.max(0,a)),this._thumbEl&&this._thumbEl.setAttribute("x",a-2),this._trackEl&&this._trackEl.setAttribute("x1",a),this._posEl&&(this._posEl.textContent=this._fmt(e)),i&&this._stopLoop()}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}_fullWave(e){return this._waveW!==e&&(this._waveW=e,this._wavePathCache=this._wavePath(-32,e+32)),this._wavePathCache}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),this._ro?.disconnect()}_seek(e){if(!1===this.config.seekable)return;const{dur:t}=this._position();if(!t)return;const i=e.currentTarget.getBoundingClientRect(),s=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width));this._callService("media_player","media_seek",{entity_id:this.config.entity,seek_position:s*t})}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),{pos:i,dur:s,playing:a,live:n}=this._position(),o=this._w||300,r=(n?1:s>0?Math.min(1,i/s):0)*o,l=!1!==this.config.show_times,c=this._resolvedColor||this.config.color;return I`
          ...
          <div class="bar" @pointerdown=${this._seek}>
            <svg width="100%" height=${28}>
              ...
              <g clip-path="url(#${this._cid})">
                <path class="wave ${a?"playing":""}" d=${this._fullWave(o)}></path>
              </g>
    ...
    `}getCardSize(){return 1}}customElements.define("materia-media-progress",mn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media-progress",name:"Materia Media Progress",description:"Wavy (M3 expressive) media seek bar with elapsed/duration and tap-to-seek.",preview:!0});const gn=n`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-editor",class extends He{_formData(){return{show_art:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"name",label:"Title",template:!0,selector:{text:{}}},{name:"subtitle",template:!0,selector:{text:{}}},{name:"image",helper:"Defaults to the entity's album art",template:!0,selector:{text:{}}},{name:"fallback_image",helper:"Shown when there's no art",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"show_art",selector:{boolean:{}}},{name:"art_size",label:"Art size (px)",selector:{number:{min:80,max:480,mode:"box"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class fn extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedName:{state:!0},_resolvedSubtitle:{state:!0},_resolvedImage:{state:!0}};static styles=gn;static getConfigElement(){return document.createElement("materia-media-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("media_player."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config=e}updated(e){if(e.has("hass")&&this.hass){this._resolveField("name","_resolvedName"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField("image","_resolvedImage");const e=this._stateObj?.attributes?.media_title;e&&this._lastTrack&&e!==this._lastTrack&&(this._beat=!0,this.requestUpdate(),clearTimeout(this._beatTimer),this._beatTimer=setTimeout(()=>{this._beat=!1,this.requestUpdate()},900)),this._lastTrack=e}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._beatTimer)}get _stateObj(){return this.hass?.states[this.config.entity]}get _title(){if(this.config.name)return this._isTemplate(this.config.name)?this._resolvedName:this.config.name;const e=this._stateObj?.attributes;return e?.media_title||e?.friendly_name||""}get _subtitle(){if(this.config.subtitle)return this._isTemplate(this.config.subtitle)?this._resolvedSubtitle:this.config.subtitle;const e=this._stateObj?.attributes;return e?.media_artist||e?.media_album_name||""}get _image(){if(this.config.image){const e=this._isTemplate(this.config.image)?this._resolvedImage:this.config.image;if(e)return e}return this._stateObj?.attributes?.entity_picture||this.config.fallback_image||""}_tap(){this._handleAction(this.config.tap_action||{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._isUnavailable(e),i=this._image,s=this._title,a=this._subtitle,n=this.config.fallback_image,o=[i,n&&n!==i?n:null].filter(Boolean).map(e=>`url('${e}')`).join(", "),r=`${this.config.art_size?`--mm-art:${this.config.art_size}px;`:""}${o?`background-image:${o};`:""}`,l=!t&&!!e?.attributes?.media_title&&!["off","idle","standby"].includes(e.state),c=l&&"paused"===e.state;return I`
    ...
    `}getCardSize(){return 4}}customElements.define("materia-media",fn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media",name:"Materia Media",description:"Now-playing card — album art, title and subtitle (all templatable).",preview:!0});const _n=n`
  :host {
    display: block;
  }
