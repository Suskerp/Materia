...
/>`;class _e extends ce{static properties={gesture:{type:String,reflect:!0},label:{type:String},icon:{type:String},direction:{type:String},pending:{type:Boolean,reflect:!0},threshold:{type:Number},holdMs:{type:Number,attribute:"hold-ms"},disabled:{type:Boolean,reflect:!0},_p:{state:!0},_armed:{state:!0}};static styles=[ge,n`
  ...
  stroke-linecap="round"
  stroke-linejoin="round"
/>`;class ve extends ce{static properties={stops:{type:Array},boundaries:{type:Array},pos:{type:Number},label:{type:String},stopLabels:{type:Array},pending:{type:Boolean,reflect:!0},disabled:{type:Boolean,reflect:!0},_dragIndex:{state:!0},_armed:{state:!0}};static styles=[ge,n`
      :host {
        display: block;
      ...
      <div class="wrap">
        ...
        >
          ...
          <div class="thumb ${o}">
            ...
            ${r?.icon?I`<ha-icon .icon=${r.icon}></ha-icon>`:W}
          </div>
        </div>
 ...
 */const Ts=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Ts(e,t);return!0},zs=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Ms=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Ds(t)}};function Fs(e){void 0!==this._$AN?(zs(this),this._$AM=e,Ms(this)):this._$AM=e}function Os(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Ts(s[e],!1),zs(s[e]);else null!=s&&(Ts(s,!1),zs(s));else Ts(this,e)}const Ds=e=>{e.type==Ss&&(e._$AP??=Os,e._$AQ??=Fs)};class qs extends As{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Ms(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ts(this,e),zs(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ps=new WeakMap,Us=Es(class extends qs{render(e){return W}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),W}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Ps.get(t);void 0===i&&(i=new WeakMap,Ps.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Ps.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class Rs extends Ve{static properties={_expandedButton:{state:!0},_expandedOption:{state:!0}};static styles=[Ve.styles,n`
  ...
  `];customElements.define("materia-lock-editor",class extends Ve{_formData(){return{gesture:"slide",shape:!0,shape_style:"cookie9",initial_locked:!0,unlock_service:"unlock",...this._config}}_sectionsSignature(){return`${this._config?.gesture||"slide"}|${this._config?.entity?.split(".")[0]||""}`}get _sections(){const e="hold"===this._config?.gesture,t="track"===this._config?.gesture,i=!!this._config?.entity;return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Lock (optional)",helper:"Leave empty to run self-contained — the card keeps its own state, with nothing to control.",selector:{entity:{domain:["lock","switch","input_boolean"]}}},...!!this._config?.entity?.startsWith("lock.")&&!t?[{name:"unlock_service",label:"Unlatch service",helper:'Open is for strikes/relays that don\'t stay meaningfully "unlocked" — the door swings rather than sitting unlatched (lock.open instead of lock.unlock). Locking always uses lock.lock.',selector:{select:{mode:"dropdown",options:[{value:"unlock",label:"Unlock (lock.unlock)"},{value:"open",label:"Open (lock.open)"}]}}}]:[],{name:"gesture",label:"Commit gesture",helper:t?'One physical track, three stops: Locked, Unlocked (a real resting state), Open (a momentary unlatch you must drag past a detent to reach — always a drag, never a tap). The lock settling back to "unlocked" on its own re-centers the track with no gesture needed.':void 0,selector:{select:{mode:"dropdown",options:[{value:"slide",label:"Slide the handle across"},{value:"hold",label:"Press and hold"},{value:"track",label:"Drag across a 3-stop track (locked / unlocked / open)"}]}}},{name:"shape",label:"Show the morphing lock shape",selector:{boolean:{}}}]},{title:"Behaviour",icon:"mdi:cog-outline",fields:[...e?[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}}]:[],...i?[{name:"locked_state",label:"State that means locked",helper:'Defaults to "locked" for a lock and "off" for a switch — a relay strike is energised to release the door.',selector:{text:{}}},{name:"pending_timeout_ms",label:"Give up waiting for the lock after (ms, default 10000)",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}}]:[{name:"initial_locked",label:"Start out locked",selector:{boolean:{}}}]]},{title:"Labels",icon:"mdi:text-short",fields:[...t?[{name:"track_labels",label:"Show Locked / Unlocked / Open captions under the track",helper:"Off by default — the track's icon and position already say what it's doing; captions are an extra, opt-in explanation.",selector:{boolean:{}}}]:e?[{name:"unlock_hold_hint",label:'While locked (default "Hold to unlock")',selector:{text:{}}},{name:"lock_hold_hint",label:'While unlocked (default "Hold to lock")',selector:{text:{}}}]:[{name:"unlock_hint",label:'While locked (default "Slide to unlock")',selector:{text:{}}},{name:"lock_hint",label:'While unlocked (default "Slide to lock")',selector:{text:{}}}],...i?[{name:"locking_label",label:'While locking (default "Locking…")',selector:{text:{}}},{name:"unlocking_label",label:'While unlocking (default "Unlocking…")',selector:{text:{}}},...t?[{name:"opening_label",label:'While opening (default "Opening…")',selector:{text:{}}}]:[],{name:"jammed_label",label:'When jammed (default "Jammed — check the door")',selector:{text:{}}}]:[{name:"demo_label",label:'Self-contained note (default "Demo · no entity")',selector:{text:{}}}]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"unlocked_color",label:"Background while unlocked",color:!0,selector:{text:{}}},{name:"unlocked_color_on",label:"Text while unlocked",color:!0,selector:{text:{}}},{name:"locked_color",label:"Background while locked",color:!0,selector:{text:{}}},{name:"locked_color_on",label:"Text while locked",color:!0,selector:{text:{}}},{name:"accent",label:"Accent (locked glyph and handle)",color:!0,selector:{text:{}}},{name:"accent_on",label:"Ink on the accent",color:!0,selector:{text:{}}},{name:"locked_icon",label:"Icon while locked",selector:{icon:{}}},{name:"unlocked_icon",label:"Icon while unlocked",selector:{icon:{}}},...t?[{name:"open_icon",label:"Icon for the Open stop (default door-open)",selector:{icon:{}}}]:[]]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Tapping the shape",selector:{ui_action:{default_action:"more-info"}}}]}]}});const Ns={squircle:{vector:!1,rot:45},cookie9:{vector:!0,rot:20,path:()=>rt(90,90,86,9)},pill:{vector:!0,rot:45,path:()=>function(e,t,i,s=0){return ut(e,t,i,{points:[{x:.961,y:.039,r:.426},{x:1.001,y:.428,r:0},{x:1,y:.609,r:1}],reps:2,mirroring:!0,rotate:s})}(90,90,172)},gem:{vector:!0,rot:90,path:()=>function(e,t,i,s=0){return ut(e,t,i,{points:[{x:.499,y:1.023,r:.241},{x:-.005,y:.792,r:.208},{x:.073,y:.258,r:.228},{x:.433,y:-0,r:.491}],reps:1,mirroring:!0,rotate:s})}(90,90,172)}};class Ls extends(Ee(ce)){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_local:{state:!0},_spinning:{state:!0}};static styles=Bs;static getConfigElement(){return document.createElement("materia-lock-editor")}static getStubConfig(){return{gesture:"slide"}}setConfig(e){this.config={gesture:"slide",...e}}constructor(){super(),this._pending=null,this._local=null}get _stateObj(){return this.config?.entity?this.hass?.states[this.config.entity]:null}get _selfContained(){return!this.config?.entity}get _lockedState(){if(this.config.locked_state)return String(this.config.locked_state);const e=this.config.entity?.split(".")[0];return"switch"===e||"input_boolean"===e?"off":"locked"}get _entityLocked(){const e=this._stateObj;return!e||this._isUnavailable(e)?null:String(e.state)===this._lockedState}get _locked(){if(this._selfContained)return this._local??!1!==this.config.initial_locked;if("unlocking"===String(this._stateObj?.state??""))return!0;return this._entityLocked??this._local??!0}get _trackIndex(){if(this._trackFlourish)return 2;if(this._selfContained)return this._locked?0:1;const e=String(this._stateObj?.state??"");return"open"===e||"opening"===e?2:"unlocking"===e?0:"locking"===e?1:this._entityLocked?0:1}_onTrackSelect(e){const t=e.detail.index;if(this._selfContained)return 2===t?(this._trackFlourish=!0,this.requestUpdate(),clearTimeout(this._trackFlourishTimer),void(this._trackFlourishTimer=setTimeout(()=>{this._trackFlourish=!1,this._local=!1,this.requestUpdate()},1200))):void(this._local=0===t);const i=this.config.entity,s=i.split(".")[0];if("lock"!==s){const e="off"===this._lockedState,o=0===t?!e:e;return void this._callService(s,o?"turn_on":"turn_off",{entity_id:i})}0===t?(Ti.publish(i,"locking",this._stateObj?.state),this._callService("lock","lock",{entity_id:i})):1===t?(Ti.publish(i,"unlocking",this._stateObj?.state),this._callService("lock","unlock",{entity_id:i})):this._callService("lock","open",{entity_id:i})}get _transitioning(){const e=String(this._stateObj?.state??"");return"locking"===e||"unlocking"===e||"jammed"===e?e:null!=this._pending?this._pending?"locking":"unlocking":null}updated(e){e.has("hass")&&null!=this._pending&&this._entityLocked===this._pending&&(this._pending=null,clearTimeout(this._pendingTimer)),this._compensatePoseTurn(),this._syncSpin()}_compensatePoseTurn(){const e=!this._locked,t=this._lastPose;if(this._lastPose=e,void 0===t||t===e)return;if(!this._spinning||!this._spins)return;const i=this._shapeStyle.rot;if(this._spinDeg=(this._spinDeg??0)+(e?-i:i),this._applySpin(),"stop"===this._spinMode){const e=Math.min(1,(performance.now()-this._stopT0)/this._stopDur),t=2*(this._stopTo-this._stopFrom)*(1-e)/(this._stopDur/1e3);this._planStop(this._spinDeg,Math.max(t,8))}}get _shapeStyle(){return Ns[this.config.shape_style]??Ns.cookie9}get _spins(){const e=this._shapeStyle;return e.vector&&2*e.rot<=45&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches}get _inFlight(){const e=this._transitioning;return"locking"===e||"unlocking"===e}_syncSpin(){this._inFlight&&this._spins?this._spinUp():this._spinDown()}_spinUp(){if("ramp"===this._spinMode||"cruise"===this._spinMode)return;const e="stop"===this._spinMode;if(this._spinMode="ramp",this._spinning=!0,this._spinDeg=this._spinDeg??0,this._spinVel=e?0:this._spinVel??0,this._spinRaf)return;let t=performance.now();const i=e=>{const s=Math.min(.05,(e-t)/1e3);if(t=e,"ramp"===this._spinMode)this._spinVel=Math.min(40,this._spinVel+80*s),this._spinVel>=40&&(this._spinMode="cruise"),this._spinDeg+=this._spinVel*s;else if("cruise"===this._spinMode)this._spinDeg+=40*s;else{if("stop"!==this._spinMode)return void(this._spinRaf=null);{const t=Math.min(1,(e-this._stopT0)/this._stopDur),i=1-(1-t)*(1-t);if(this._spinDeg=this._stopFrom+(this._stopTo-this._stopFrom)*i,t>=1)return this._spinDeg=this._stopTo%360,this._applySpin(),this._spinMode=null,this._spinVel=0,this._spinning=!1,void(this._spinRaf=null)}}this._applySpin(),this._spinRaf=requestAnimationFrame(i)};this._spinRaf=requestAnimationFrame(i)}_spinDown(){"ramp"!==this._spinMode&&"cruise"!==this._spinMode||this._planStop(this._spinDeg??0,Math.max(this._spinVel??40,8))}_planStop(e,t){const i=2*this._shapeStyle.rot,s=.55*t/2;let o=Math.ceil((e+s)/i)*i;2*(o-e)/t>2.6&&(o=e+s),this._stopFrom=e,this._stopTo=o,this._stopDur=2*(o-e)/t*1e3,this._stopT0=performance.now(),this._spinMode="stop"}_applySpin(){const e=this.shadowRoot?.querySelector(".shape");e?.style.setProperty("--ml-spin",(this._spinDeg%360).toFixed(2)+"deg")}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._pendingTimer),clearTimeout(this._trackFlourishTimer),this._spinRaf&&cancelAnimationFrame(this._spinRaf),this._spinRaf=null,this._spinMode=null}_confirm(){const e=!this._locked;if(this._selfContained)return void(this._local=e);this._pending=e,clearTimeout(this._pendingTimer),this._pendingTimer=setTimeout(()=>{this._pending=null},this.config.pending_timeout_ms??1e4);const t=this.config.entity,i=t.split(".")[0];if("lock"===i){Ti.publish(t,e?"locking":"unlocking",this._stateObj?.state);const i="open"===this.config.unlock_service?"open":"unlock";this._callService("lock",e?"lock":i,{entity_id:t})}else{const s="off"===this._lockedState,o=e?!s:s;this._callService(i,o?"turn_on":"turn_off",{entity_id:t})}}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(this.config.entity&&!e)return I`<ha-card><div class="body">
      ...
      </div></ha-card>`;const t=!!e&&this._isUnavailable(e),i=this._locked,s=this._transitioning,o="locking"===s||"unlocking"===s,n=i?this.config.locked_color??"var(--md-sys-color-surface-container-low, var(--card-background-color))":this.config.unlocked_color??"var(--md-sys-cust-color-device, var(--md-sys-color-primary-container))",a=i?this.config.locked_color_on??"var(--md-sys-color-on-surface)":this.config.unlocked_color_on??"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-primary-container))",r=this.config.accent??"var(--md-sys-color-primary)",l=this.config.accent_on??"var(--md-sys-color-on-primary)",c=i?`color-mix(in srgb, ${a} 12%, transparent)`:a,d=i?r:n,h=i?r:a,p=i?l:n,u=i?this.config.locked_icon??"m3o:lock":this.config.unlocked_icon??"m3o:lock-open-right",m=this._shapeStyle,g=i?this.config.unlock_hint??$e("lock_slide_to_unlock",this.hass):this.config.lock_hint??$e("lock_slide_to_lock",this.hass),f=i?this.config.unlock_hold_hint??$e("lock_hold_to_unlock",this.hass):this.config.lock_hold_hint??$e("lock_hold_to_lock",this.hass),_="hold"===this.config.gesture,b="track"===this.config.gesture,v=String(this._stateObj?.state??""),y="locking"===v||"unlocking"===v||"open"===v||"opening"===v,x="locking"===v?this.config.locking_label??$e("lock_locking",this.hass):"unlocking"===v?this.config.unlocking_label??$e("lock_unlocking",this.hass):"open"===v||"opening"===v?this.config.opening_label??$e("lock_opening",this.hass):"",w=[{value:"locked",icon:this.config.locked_icon??"m3o:lock"},{value:"unlocked",icon:this.config.unlocked_icon??"m3o:lock-open-right"},{value:"open",icon:this.config.open_icon??"m3o:door-open"}],k=this.config.track_labels?[$e("lock_track_locked",this.hass),$e("lock_track_unlocked",this.hass),$e("lock_track_open",this.hass)]:null;return I`
      <ha-card
        class=${t?"unavailable":""}
          ...
          ${b?I`
              ...
              `:I`
                <materia-drag-confirm
                  ...
                  .label=${o?"locking"===s?this.config.locking_label??$e("lock_locking",this.hass):this.config.unlocking_label??$e("lock_unlocking",this.hass):_?f:g}
                  .pending=${o}
