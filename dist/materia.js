...
`,he=[ft,mt,gt,se,de,n`
  ...
  `];customElements.define("materia-thermostat-editor",class extends Mt{_formData(){return{step:.5,show_modes:!0,show_current:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"temperature_entity",label:"Current-temp sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"step",label:"Step",selector:{number:{min:.1,max:2,step:.1,mode:"box"}}},{name:"show_current",label:"Show current temperature",selector:{boolean:{}}},{name:"current_label",label:'"Currently" label',selector:{text:{}}},{name:"wave",label:"Wave animation",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (hvac_action, or inferred from temps)"},{value:"always",label:"Always (whenever the mode is on)"},{value:"never",label:"Never"}]}}}]},{title:"Modes",icon:"mdi:sun-snowflake-variant",fields:[{name:"show_modes",label:"Show mode buttons",selector:{boolean:{}}},{name:"mode_size",label:"Mode button size",selector:{select:{mode:"dropdown",options:[{value:"s",label:"S"},{value:"m",label:"M"},{value:"l",label:"L"},{value:"xl",label:"XL"}]}}}]}]}});const Te=-135,ze=270,Fe={auto:{icon:"mdi:thermostat-auto",color:"var(--md-sys-cust-color-climate-auto, var(--md-sys-color-primary))"},heat_cool:{icon:"mdi:autorenew",color:"var(--md-sys-cust-color-climate-auto, var(--md-sys-color-primary))"},heat:{icon:"mdi:fire",color:"var(--md-sys-cust-color-climate-heat, #ff8a65)"},cool:{icon:"mdi:snowflake",color:"var(--md-sys-cust-color-climate-cool, #64b5f6)"},dry:{icon:"mdi:water-percent",color:"var(--md-sys-cust-color-climate-auto, var(--md-sys-color-primary))"},fan_only:{icon:"mdi:fan",color:"var(--md-sys-color-secondary)"},off:{icon:"mdi:power",color:"var(--md-sys-color-on-surface-variant)"}};class Oe extends(ut(ct)){static properties={hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_phase:{state:!0},_amp:{state:!0}};static styles=Me;static getConfigElement(){return document.createElement("materia-thermostat-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("climate."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={step:.5,...t}}connectedCallback(){super.connectedCallback(),this._phase=0,this._amp=0,this._startLoop()}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop()}get _entity(){return this.hass?.states[this.config.entity]}get _action(){return this._entity?.attributes?.hvac_action??""}get _waveAction(){const t=this._mode;if("off"===t||"never"===this.config.wave)return"";if("always"===this.config.wave)return"cool"===t?"cooling":"heating";const e=this._action;if("heating"===e||"cooling"===e)return e;if(e&&"idle"!==e)return"";const i=this._current,o=this._target;return null==o||"idle"===e?"":null==i?"cool"===t?"cooling":"heat"===t?"heating":"":("heat"===t||"auto"===t||"heat_cool"===t)&&i<o-.2?"heating":("cool"===t||"auto"===t||"heat_cool"===t)&&i>o+.2?"cooling":""}get _mode(){return this._entity?.state??"off"}get _target(){return null!=this._optimisticTemp?this._optimisticTemp:this._numRaw(this._entity?.attributes?.temperature)}get _current(){if(this.config.temperature_entity){const t=this.hass?.states[this.config.temperature_entity];if(t)return this._numRaw(t.state)}return this._numRaw(this._entity?.attributes?.current_temperature)}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}_startLoop(){if(this._raf)return;const t=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,e=()=>{const i=this._waveAction,o=("heating"===i||"cooling"===i)&&!t?1:0,s=this._amp+.06*(o-this._amp),n=Math.abs(s-o)<.01;this._amp=n?o:s,this._amp>.005?(this._phase+="cooling"===i?.045:-.045,this._raf=requestAnimationFrame(e)):this._raf=null};this._raf=requestAnimationFrame(e)}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}updated(t){if(this._waveAction&&!this._raf&&this._startLoop(),t.has("hass")&&null!=this._optimisticTemp){this._numRaw(this._entity?.attributes?.temperature)===this._optimisticTemp&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}_angleFor(t,e,i){const o=Math.min(1,Math.max(0,(t-e)/(i-e)));return Te+ze*o}_pointAt(t,e,i=0){const o=(t-90)*Math.PI/180,s=e+i;return[50+s*Math.cos(o),50+s*Math.sin(o)]}_wavePath(t,e){const i=3.2*this._amp,o=[];for(let s=Te;s<=t;s+=2){const n=s-Te,a=i*Math.min(1,n/25)*Math.min(1,(t-s)/25)*Math.sin(n/7+this._phase);o.push(this._pointAt(s,e,a))}return o.push(this._pointAt(t,e,0)),"M"+o.map(([t,e])=>`${t.toFixed(2)} ${e.toFixed(2)}`).join(" L")}_arcPath(t,e,i){const[o,s]=this._pointAt(t,i),[n,a]=this._pointAt(e,i),r=e-t>180?1:0;return`M${o.toFixed(2)} ${s.toFixed(2)} A${i} ${i} 0 ${r} 1 ${n.toFixed(2)} ${a.toFixed(2)}`}_setTarget(t){const e=this._numRaw(this._entity?.attributes?.min_temp)??7,i=this._numRaw(this._entity?.attributes?.max_temp)??35,o=this.config.step??.5,s=Math.min(i,Math.max(e,Math.round(t/o)*o));this._optimisticTemp=s,clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4),clearTimeout(this._sendTimer),this._sendTimer=setTimeout(()=>{this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:s})},350)}_nudge(t){const e=this._target;null!=e&&this._setTarget(e+t)}_dialPointer(t){if(!this._dialDragging&&"pointerdown"!==t.type)return;const e=this.renderRoot.querySelector(".dial").getBoundingClientRect(),i=(t.clientX-e.left)/e.width*100-50,o=(t.clientY-e.top)/e.height*100-50;let s=180*Math.atan2(o,i)/Math.PI+90;if(s>180&&(s-=360),s<-143||s>143)return;const n=Math.min(1,Math.max(0,(s-Te)/ze)),a=this._numRaw(this._entity?.attributes?.min_temp)??7,r=this._numRaw(this._entity?.attributes?.max_temp)??35;"pointerdown"===t.type&&(this._dialDragging=!0,t.currentTarget.setPointerCapture(t.pointerId)),this._setTarget(a+n*(r-a))}_endDialDrag(t){this._dialDragging=!1,t.currentTarget.releasePointerCapture?.(t.pointerId)}_setMode(t){this._callService("climate","set_hvac_mode",{entity_id:this.config.entity,hvac_mode:t})}render(){if(!this.hass||!this.config)return I``;const t=this._entity;if(!t)return I``;const e=this._isUnavailable(t),i=this._numRaw(t.attributes.min_temp)??7,o=this._numRaw(t.attributes.max_temp)??35,s=this._target,n=this._current,a=this._mode,r=this._waveAction,l=Fe[a]||Fe.off,c="off"!==a&&null!=s,d=c?this._angleFor(s,i,o):Te,[h,p]=this._pointAt(d,42),u=null!=n?this._angleFor(n,i,o):null,m="heating"===r?Fe.heat.color:"cooling"===r?Fe.cool.color:l.color,g=this.hass.formatEntityState?.(t)??a,f=this.hass.config?.unit_system?.temperature??"°C",_=(this.config.hvac_modes??t.attributes.hvac_modes??[]).filter(t=>Fe[t]);return I`
      <ha-card class="${e?"unavailable":""}">
        <div class="dial-wrap">
          ...
          >
            <path d=${this._arcPath(Te,135,42)} class="track" />
            ${null!=u?H`<circle
        ...
        ${!1!==this.config.show_modes&&_.length?I`<materia-button-group
              .hass=${this.hass}
              .config=${{entity:this.config.entity,size:this.config.mode_size??"l",variant:"tonal",color_active:m,color_on_active:"var(--md-sys-color-surface, #fff)",options:_.map(t=>({icon:Fe[t].icon,value:t,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:t},target:{entity_id:this.config.entity}}}))}}
            ></materia-button-group>`:""}
      </ha-card>
  ...
  `];class Ue extends Mt{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[Mt.styles,n`
    ...
    `}getCardSize(){return 1}}customElements.define("materia-button",Be),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"M3 button — icon and/or label, variants, sizes, shapes, and shape-morph on state.",preview:!0});const Re=[ft,n`
