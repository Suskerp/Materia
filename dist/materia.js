...
`,me=[_t,gt,ft,re,ue,n`
  ...
  `],Ne=[{value:"auto",label:"Auto (from device class)"},{value:"percent",label:"Percent (filling cookie)"},{value:"temperature",label:"Temperature (thermometer)"},{value:"power",label:"Power (load bars)"},{value:"energy",label:"Energy"},{value:"binary",label:"On/off (spinning star)"},{value:"plain",label:"Plain value"}];customElements.define("materia-glance-tile-editor",class extends Mt{_formData(){return{variant:"auto",...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){const t=this._config?.variant,e={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"variant",label:"Visualization",selector:{select:{mode:"dropdown",options:Ne}}},{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Icon (overrides entity icon)",selector:{icon:{}}},{name:"label",label:"Subtitle",selector:{text:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"temperature"===t&&i.fields.push({name:"min",label:"Scale min (default 10°)",selector:{number:{mode:"box"}}},{name:"max",label:"Scale max (default 30°)",selector:{number:{mode:"box"}}}),"power"===t&&i.fields.push({name:"max",label:"Full-load watts (default 3000)",selector:{number:{mode:"box"}}});const s={title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Accent color (fill / bars / star)",color:!0,selector:{text:{}}},{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},o={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[e,i,s,o]:[e,s,o]}});const je="var(--md-sys-cust-color-weather-rain, #5fa8f5)",Le="var(--md-sys-cust-color-scale-green, #5E9E50)",Ie="var(--md-sys-cust-color-scale-orange, #D9713C)",We="var(--md-sys-cust-color-scale-red, #C94D42)",He=["on","open","running","playing","heat","heating","home","true","active"];class Ve extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=Re;static getConfigElement(){return document.createElement("materia-glance-tile-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("sensor."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("Materia Glance Tile: entity is required");this.config={...t}}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"))}get _stateObj(){return this.hass?.states[this.config.entity]}_num(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _unit(){return this.config.unit??this._stateObj?.attributes?.unit_of_measurement??""}get _name(){return this.config.name??this._stateObj?.attributes?.friendly_name??this.config.entity}_icon(t){return this.config.icon||this._stateObj?.attributes?.icon||t}get _variant(){if(this.config.variant&&"auto"!==this.config.variant)return this.config.variant;const t=this._stateObj;if(!t)return"plain";const e=this.config.entity.split(".")[0],i=t.attributes.device_class,s=t.attributes.unit_of_measurement;return"binary_sensor"!==e&&"switch"!==e&&!He.includes(t.state)&&"off"!==t.state||null!=this._num(t.state)?"%"===s||"humidity"===i||"battery"===i||"moisture"===i?"percent":"temperature"===i||"°C"===s||"°F"===s?"temperature":"power"===i||"W"===s||"kW"===s?"power":"energy"===i||"kWh"===s||"Wh"===s||"MWh"===s?"energy":"plain":"binary"}_fmtState(){const t=this._stateObj;return this.hass.formatEntityState?.(t)??t.state}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj;if(!t||this._isUnavailable(t))return I`<ha-card><div class="rect-tile unavailable">
    ...
    `}_binary(){const t=He.includes(this._stateObj.state),e=be(50,52,45,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2});return I`
      <div class="shape-tile ${t?"active":""}">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          ${t?W`<g class="spin"><path d=${e} class="shape-fill on" /></g>`:W`<circle cx="50" cy="52" r="43" class="shape-fill" />`}
        </svg>
        <div class="overlay">
  ...
  `];customElements.define("materia-climate-poc-editor",class extends Mt{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"water_heater",label:"Water heater (optional)",selector:{entity:{domain:"water_heater"}}},{name:"zones",label:"Zone valves",helper:"Per-zone names, icons and temp sensors: use zones: [{entity, name, icon, temp_entity}] in YAML.",selector:{entity:{domain:"switch",multiple:!0}}},{name:"zone_icon",label:"Zone icon (e.g. mdi:heating-coil for underfloor)",selector:{icon:{}}}]},{title:"Dial",icon:"mdi:thermostat",fields:[{name:"step",label:"Step",selector:{number:{min:.1,max:2,step:.1,mode:"box"}}},{name:"min_temp",label:"Dial min (default: entity)",selector:{number:{min:-30,max:40,step:.5,mode:"box"}}},{name:"max_temp",label:"Dial max (default: entity)",selector:{number:{min:0,max:60,step:.5,mode:"box"}}},{name:"steppers",label:"Stepper placement",selector:{select:{mode:"dropdown",options:[{value:"side",label:"Vertical, beside the dial"},{value:"below",label:"Below the dial"}]}}},{name:"wave",label:"Wave animation",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (hvac_action, or inferred from temps)"},{value:"always",label:"Always (whenever the mode is on)"},{value:"never",label:"Never"}]}}}]},{title:"Sections",icon:"mdi:wallet-outline",secondary:"Zones and Water heater appear automatically",fields:[{name:"zones_title",label:"Zones section title",selector:{text:{}}},{name:"water_title",label:"Water heater section title",selector:{text:{}}},{name:"sections",label:"Extra sections (YAML)",helper:"Each extra section is {title, icon, info_entity?, cards: [...]} — e.g. a Schedule section with any cards inside.",selector:{object:{}}}]}]}});class Xe extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_openSection:{state:!0}};static styles=Ge;static getConfigElement(){return document.createElement("materia-climate-poc-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("climate."))||"";return{entity:e,zones:[]}}setConfig(t){if(!t.entity)throw new Error("Materia Climate POC: entity is required");this.config={zones:[],...t},this._extraEls=null,this.isConnected&&this._createExtraCards()}firstUpdated(){this._createExtraCards()}updated(t){if(t.has("hass")&&this._extraEls){const t=(this._zones.length?1:0)+(this.config.water_heater?1:0),e=(this._openSection??0)-t;e>=0&&this._extraEls[e]&&this._extraEls[e].forEach(t=>{t.hass=this.hass})}}get _entity(){return this.hass?.states[this.config.entity]}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _current(){return this._numRaw(this._entity?.attributes?.current_temperature)}get _boilerActive(){const t=this._entity?.attributes?.hvac_action;if("heating"===t)return!0;if(t&&"idle"!==t)return!1;const e=this._entity?.state,i=this._current,s=this._numRaw(this._entity?.attributes?.temperature);return"off"!==e&&null!=s&&(null==i?"heat"===e:i<s-.2)}_zoneModel(t){const e=this.hass.states[t.entity],i="on"===e?.state,s=i&&this._boilerActive,o=t.temp_entity?this._numRaw(this.hass.states[t.temp_entity]?.state):null;let n=null;return e?.last_changed&&(n=Math.max(0,Math.round((Date.now()-new Date(e.last_changed).getTime())/6e4))),{...t,name:t.name||e?.attributes?.friendly_name||t.entity,on:i,calling:s,temp:o,sinceMin:n}}get _zones(){return(this.config.zones||[]).map(t=>this._zoneModel("string"==typeof t?{entity:t}:t))}_fmt(t){return null==t?"—":Math.round(10*t)/10}_toggleZone(t){this._callService("switch",t.on?"turn_off":"turn_on",{entity_id:t.entity}),this._fireHaptic("light")}_allZones(t){for(const e of this._zones)this._callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity})}_zoneRow(t){const e=t.calling?"calling":t.on?"idle":"off",i=t.icon||this.config.zone_icon||(t.on?"mdi:radiator":"mdi:radiator-off"),s=t.calling?`Heating · open ${t.sinceMin} min`:t.on?"At temperature":"Off";return I`
    ...
    `}_modeGroup(){const t=(this._entity?.attributes?.hvac_modes||[]).filter(t=>["heat","auto","off","cool","heat_cool"].includes(t));if(!t.length)return V;const e={heat:["var(--md-sys-cust-color-climate-heat-accent, #a14614)","var(--md-sys-cust-color-climate-heat-container, #ffeee9)"],cool:["var(--md-sys-cust-color-climate-cool-accent, #327ea7)","var(--md-sys-cust-color-climate-cool-container, #eaf3ff)"],auto:["var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))","var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))"],heat_cool:["var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))","var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))"],off:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"]},[i,s]=e[this._entity?.state]??e.off;return I`
    ...
    `}async _createExtraCards(){const t=this._extraGen=(this._extraGen||0)+1,e=this.config.sections||[];if(!e.length)return void(this._extraEls=[]);const i=await pt(),s=await Promise.all(e.map(async t=>(await Promise.all((t.cards||[]).map(async t=>{try{const e=await i.createCardElement(t);return e.hass=this.hass,e}catch{return null}}))).filter(Boolean)));t===this._extraGen&&(this._extraEls=s,this.requestUpdate())}_accordionSections(){const t=this._zones,e=t.filter(t=>t.calling).length,i=t.filter(t=>t.on).length,s=[];t.length&&s.push({title:this.config.zones_title??"Zones",icon:this.config.zone_icon??"mdi:radiator",info:e?`${e} of ${t.length} heating`:`${i} of ${t.length} on`,body:I`
          <div class="acc-actions">
            <button class="mini" @click=${()=>this._allZones(!1)}>All off</button>
            <button class="mini" @click=${()=>this._allZones(!0)}>All on</button>
          </div>
          <div class="zones">${t.map(t=>this._zoneRow(t))}</div>
        `});const o=this.config.water_heater?this.hass.states[this.config.water_heater]:null;if(o){const t=this._numRaw(o.attributes?.current_temperature);s.push({title:this.config.water_title??"Water heater",icon:"mdi:water-boiler",info:`${this._capitalize(o.state)}${null!=t?` · ${this._fmt(t)}°`:""}`,body:this._waterRow()})}return(this.config.sections||[]).forEach((t,e)=>{const i=t.info_entity?this.hass.states[t.info_entity]:null;s.push({title:t.title??`Section ${e+1}`,icon:t.icon,info:t.info??(i?this.hass.formatEntityState?.(i)??i.state:""),body:this._extraEls?.[e]?.length?I`<div class="acc-cards">${this._extraEls[e]}</div>`:V})}),s}_openAcc(t){if(this._openSection===t)return;this._openSection=t,this._fireHaptic("light");const e=t-(this._zones.length?1:0)-(this.config.water_heater?1:0);e>=0&&this._extraEls?.[e]&&this._extraEls[e].forEach(t=>{t.hass=this.hass})}render(){if(!this.hass||!this.config)return I``;if(!this._entity)return I`<ha-card class="poc">Unknown entity: ${this.config.entity}</ha-card>`;const t=this._openSection??0,e=this._accordionSections();return I`
      <ha-card class="poc">
        <materia-thermostat
          .hass=${this.hass}
          ...
          ${e.map((e,i)=>I`
            <div class="seg acc-sec ${t===i?"open":""}">
              <div class="acc-bar" @click=${()=>this._openAcc(i)}>
                ...
                <span class="acc-info">${t===i?"":e.info}</span>
                ${t===i?V:I`<ha-icon class="acc-chev" icon="mdi:chevron-down"></ha-icon>`}
              </div>
              <div class="acc-body"><div class="acc-inner">${t===i?e.body:V}</div></div>
            </div>
          `)}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6}}customElements.define("materia-climate-poc",Xe),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate-poc",name:"Materia Climate POC",description:"Climate surface: thermostat dial hero + connected stack of modes, zone ladder and water heater.",preview:!1});const Ye=[_t,ft,re,n`
    .wallet {
      display: flex;
      flex-direction: column;
      gap: 6px;
...
${i?"":I`<ha-icon class="s-chev" icon="m3of:arrow-drop-down"></ha-icon>`}
  ...
  `];customElements.define("materia-thermostat-editor",class extends Mt{_formData(){return{step:.5,show_modes:!0,show_current:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"temperature_entity",label:"Current-temp sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"step",label:"Step",selector:{number:{min:.1,max:2,step:.1,mode:"box"}}},{name:"min_temp",label:"Dial min (default: entity)",selector:{number:{min:-30,max:40,step:.5,mode:"box"}}},{name:"max_temp",label:"Dial max (default: entity)",selector:{number:{min:0,max:60,step:.5,mode:"box"}}},{name:"show_current",label:"Show current temperature",selector:{boolean:{}}},{name:"current_label",label:'"Currently" label',selector:{text:{}}},{name:"steppers",label:"Stepper placement",selector:{select:{mode:"dropdown",options:[{value:"below",label:"Below the dial"},{value:"side",label:"Vertical, beside the dial"}]}}},{name:"wave",label:"Wave animation",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (hvac_action, or inferred from temps)"},{value:"always",label:"Always (whenever the mode is on)"},{value:"never",label:"Never"}]}}}]},{title:"Modes",icon:"mdi:sun-snowflake-variant",fields:[{name:"show_modes",label:"Show mode buttons",selector:{boolean:{}}},{name:"mode_size",label:"Mode button size",selector:{select:{mode:"dropdown",options:[{value:"s",label:"S"},{value:"m",label:"M"},{value:"l",label:"L"},{value:"xl",label:"XL"}]}}}]}]}});const Qe=-135,Je=270,ti="var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))",ei="var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))",ii={auto:{icon:"mdi:thermostat-auto",color:ti,on:ei,container:ei,onContainer:ti},heat_cool:{icon:"mdi:thermostat-auto",color:ti,on:ei,container:ei,onContainer:ti},heat:{icon:"m3o:mode-heat",color:"var(--md-sys-cust-color-climate-heat-accent, #a14614)",on:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",container:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",onContainer:"var(--md-sys-cust-color-climate-heat-accent, #a14614)"},cool:{icon:"mdi:snowflake",color:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)",on:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",container:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",onContainer:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)"},dry:{icon:"mdi:water-percent",color:ti,on:ei,container:ei,onContainer:ti},fan_only:{icon:"mdi:fan",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"},off:{icon:"m3o:power-settings-new",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"}};class si extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0}};static styles=Ke;static getConfigElement(){return document.createElement("materia-thermostat-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("climate."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={...t}}connectedCallback(){super.connectedCallback(),this._phase=0,this._amp=0,this._startLoop()}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),clearTimeout(this._optimisticTimer),clearTimeout(this._sendTimer)}get _entity(){return this.hass?.states[this.config.entity]}get _action(){return this._entity?.attributes?.hvac_action??""}get _waveAction(){const t=this._mode;if("off"===t||"never"===this.config.wave)return"";if("always"===this.config.wave)return"cool"===t?"cooling":"heating";const e="auto"===t||"heat_cool"===t,i=e?"holding":"",s=this._action;if("heating"===s||"cooling"===s)return s;if(s&&"idle"!==s)return"";const o=this._current,n=this._target;return null==n||"idle"===s?i:null==o?"cool"===t?"cooling":"heat"===t?"heating":i:("heat"===t||e)&&o<n-.2?"heating":("cool"===t||e)&&o>n+.2?"cooling":i}get _mode(){return this._entity?.state??"off"}get _target(){return null!=this._optimisticTemp?this._optimisticTemp:this._numRaw(this._entity?.attributes?.temperature)}get _current(){if(this.config.temperature_entity){const t=this.hass?.states[this.config.temperature_entity];if(t)return this._numRaw(t.state)}return this._numRaw(this._entity?.attributes?.current_temperature)}_numRaw(t){if(null==t||""===t||"unknown"===t||"unavailable"===t)return null;const e=Number(t);return Number.isFinite(e)?e:null}get _step(){return this.config.step??this._numRaw(this._entity?.attributes?.target_temp_step)??.5}get _scale(){return{min:this.config.min_temp??this._numRaw(this._entity?.attributes?.min_temp)??7,max:this.config.max_temp??this._numRaw(this._entity?.attributes?.max_temp)??35}}_startLoop(){if(this._raf)return;const t=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,e=()=>{const i=this._waveAction,s="heating"===i||"cooling"===i,o=t?0:s?1:"holding"===i?.35:0,n=this._amp+.06*(o-this._amp),a=Math.abs(n-o)<.01;if(this._amp=a?o:n,this._amp>.005||o>0){this._phase+="cooling"===i?.012:s?-.012:-.008;const t=this._waveGeom;if(t){const e=this.renderRoot?.querySelector("path.wave-seg");e&&e.setAttribute("d",this._wavePath(t.start,t.end,t.r))}this._raf=requestAnimationFrame(e)}else this._raf=null};this._raf=requestAnimationFrame(e)}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}updated(t){if(this._waveAction&&!this._raf&&this._startLoop(),t.has("hass")&&null!=this._optimisticTemp){const t=this._numRaw(this._entity?.attributes?.temperature);null!=t&&Math.abs(t-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}_modeGroupConfig(t,e,i){const s=`${this.config.entity}|${t.join()}|${e}|${i}|${this.config.mode_size??"l"}`;return this._mgKey!==s&&(this._mgKey=s,this._mgConfig={entity:this.config.entity,size:this.config.mode_size??"l",variant:"tonal",active_shape:"square",color_active:e,color_on_active:i,options:t.map(t=>({icon:ii[t].icon,value:t,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:t},target:{entity_id:this.config.entity}}}))}),this._mgConfig}_angleFor(t,e,i){const s=Math.min(1,Math.max(0,(t-e)/(i-e)));return Qe+Je*s}_pointAt(t,e,i=0){const s=(t-90)*Math.PI/180,o=e+i;return[50+o*Math.cos(s),50+o*Math.sin(s)]}_wavePath(t,e,i){const s=3.2*this._amp,o=[];for(let n=t;n<=e;n+=2){const a=n-t,r=s*Math.min(1,a/20)*Math.min(1,(e-n)/20)*Math.sin(a/7+this._phase);o.push(this._pointAt(n,i,r))}return o.push(this._pointAt(e,i,0)),"M"+o.map(([t,e])=>`${t.toFixed(2)} ${e.toFixed(2)}`).join(" L")}_arcPath(t,e,i){const[s,o]=this._pointAt(t,i),[n,a]=this._pointAt(e,i),r=e-t>180?1:0;return`M${s.toFixed(2)} ${o.toFixed(2)} A${i} ${i} 0 ${r} 1 ${n.toFixed(2)} ${a.toFixed(2)}`}_setTarget(t){const{min:e,max:i}=this._scale,s=this._step,o=Math.round(100*Math.min(i,Math.max(e,Math.round(t/s)*s)))/100;this._optimisticTemp=o,clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4),clearTimeout(this._sendTimer),this._sendTimer=setTimeout(()=>{this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:o})},350)}_nudge(t){const e=this._target;null!=e&&this._setTarget(e+t)}_dialPointer(t){if(!this._dialDragging&&"pointerdown"!==t.type)return;const e=this.renderRoot.querySelector(".dial").getBoundingClientRect(),i=(t.clientX-e.left)/e.width*100-50,s=(t.clientY-e.top)/e.height*100-50;let o=180*Math.atan2(s,i)/Math.PI+90;if(o>180&&(o-=360),o<-143||o>143)return;const n=Math.min(1,Math.max(0,(o-Qe)/Je)),{min:a,max:r}=this._scale;"pointerdown"===t.type&&(this._dialDragging=!0,t.currentTarget.setPointerCapture(t.pointerId)),this._setTarget(a+n*(r-a))}_endDialDrag(t){this._dialDragging=!1,t.currentTarget.releasePointerCapture?.(t.pointerId)}render(){if(!this.hass||!this.config)return I``;const t=this._entity;if(!t)return I``;const e=this._isUnavailable(t),{min:i,max:s}=this._scale,o=this._target,n=this._current,a=this._mode,r=this._waveAction,l=ii[a]||ii.off,c="off"!==a&&null!=o,d=42,h=c?this._angleFor(o,i,s):Qe,p=null!=o?this._angleFor(o,i,s):null,[u,m]=this._pointAt(c?h:p??h,d),g=null!=n?this._angleFor(n,i,s):null;let f=null,_=null,v=null;c&&"holding"===r?(_=Qe,v=null!=g?Math.max(g,h):h):c&&null!=g?(f=Math.min(g,h),_=f,v=Math.max(g,h)):c&&(_=Qe,v=h);const b="heating"===r?ii.heat:"cooling"===r?ii.cool:l,y=b.color,x=b.on,w=this.hass.formatEntityState?.(t)??a,$=this.hass.config?.unit_system?.temperature??"°C",k=(this.config.hvac_modes??t.attributes.hvac_modes??[]).filter(t=>ii[t]);return this._waveGeom=c&&null!=v&&v>_+.5?{start:_,end:v,r:d}:null,I`
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const t=c?Math.max(h,g??h):Qe,e=c?Math.min(t+8,135):Qe;return e<134.5?W`<path d=${this._arcPath(e,135,d)} class="track" />`:""})()}
            ${c||null==g?"":W`<circle
                  cx=${this._pointAt(g,d)[0]} cy=${this._pointAt(g,d)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?W`<path d=${this._arcPath(Qe,f,d)} class="sweep" style="stroke:${y}" />`:""}
    ...
    `}getGridOptions(){return{columns:6,rows:"auto",min_columns:4}}getCardSize(){return 5}}customElements.define("materia-thermostat",si),window.customCards=window.customCards||[],window.customCards.push({type:"materia-thermostat",name:"Materia Thermostat",description:"Expressive thermostat dial — the active sweep is a living wavy line that moves with heating/cooling.",preview:!0});const oi=[_t,n`
    :host {
      display: flex;
      align-items: center;
      justify-content: center;
  ...
  `];class ni extends Mt{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[Mt.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-button",li),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"M3 button — icon and/or label, variants, sizes, shapes, and shape-morph on state.",preview:!0});const ci=[_t,n`
  ...
  `];class di extends Mt{static properties={_expanded:{state:!0}};static styles=[Mt.styles,n`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _i=(t,e)=>{const i=t._$AN;if(void 0===i)return!1;for(const t of i)t._$AO?.(e,!1),_i(t,e);return!0},vi=t=>{let e,i;do{if(void 0===(e=t._$AM))break;i=e._$AN,i.delete(t),t=e}while(0===i?.size)},bi=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(void 0===i)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),wi(e)}};function yi(t){void 0!==this._$AN?(vi(this),this._$AM=t,bi(this)):this._$AM=t}function xi(t,e=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(e)if(Array.isArray(s))for(let t=i;t<s.length;t++)_i(s[t],!1),vi(s[t]);else null!=s&&(_i(s,!1),vi(s));else _i(this,t)}const wi=t=>{t.type==gi&&(t._$AP??=xi,t._$AQ??=yi)};class $i extends fi{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),bi(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(_i(this,t),vi(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const ki=new WeakMap,Ci=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends $i{render(t){return V}update(t,[e]){const i=e!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),V}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=ki.get(e);void 0===i&&(i=new WeakMap,ki.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return"function"==typeof this.G?ki.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class Si extends Mt{static properties={_expandedButton:{state:!0},_expandedOption:{state:!0}};static styles=[Mt.styles,n`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
            ...
            ${this._expandedButton===e?I`
                  <div class="button-body">
                    <materia-button-editor
                      .hass=${this.hass}
                      ${Ci(i=>{i&&i.__materiaIdx!==e&&(i.__materiaIdx=e,i.setConfig(t))})}
    ...
    `}}customElements.define("materia-icon-row",Ai),window.customCards=window.customCards||[],window.customCards.push({type:"materia-icon-row",name:"Materia Icon Row",description:"A centered row of icon buttons with configurable spacing.",preview:!0});const zi={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-secondary)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-error)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-state":["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],"secondary-state":["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],"tertiary-state":["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],"error-state":["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],"device-state":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]},Mi=[_t,n`
    :host {
  ...
  `],Ti=[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"},{value:"device",label:"Device"},{value:"primary-container",label:"Primary Container"},{value:"secondary-container",label:"Secondary Container"},{value:"error-container",label:"Error Container"},{value:"device-container",label:"Device Container"},{value:"primary-state",label:"Primary State"},{value:"secondary-state",label:"Secondary State"},{value:"tertiary-state",label:"Tertiary State"},{value:"error-state",label:"Error State"},{value:"device-state",label:"Device State"},{value:"battery",label:"Battery"}];customElements.define("materia-badge-editor",class extends Mt{_sectionsSignature(){return this._config?.entity?"entity":"none"}get _sections(){const t=!!this._config?.entity,e=[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,template:!0,selector:{text:{}}},{name:"icon",required:!0,template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"variant",selector:{select:{mode:"dropdown",options:Ti}}}]}];return t&&e.push({title:"State",icon:"mdi:state-machine",fields:[{name:"show_state",selector:{boolean:{}}},{name:"active_state",selector:{text:{}}},{name:"state_display",template:!0,selector:{text:{}}}]}),e.push({title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}),e}});const Fi={cover:"open",lock:["locked","locking"],vacuum:"cleaning",media_player:"playing",climate:"heat",alarm_control_panel:"armed_away"};class Oi extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedStateDisplay:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-badge-editor")}static getStubConfig(t){const e=(t?Object.keys(t.states):[]).find(t=>t.startsWith("light.")||t.startsWith("switch."))||"";return{name:"Badge",icon:"mdi:power-plug",variant:"primary",show_state:!1,active_state:"on",entity:e}}static styles=[ft,Mi];setConfig(t){if(!t.icon)throw new Error("icon is required");if(!t.name)throw new Error("name is required");this.config={show_state:!1,active_state:"on",variant:"secondary",tap_action:{action:"toggle"},...t}}updated(t){super.updated?.(t),t.has("hass")&&this.hass&&(this._resolveField("state_display","_resolvedStateDisplay"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}_isActive(t){if(!t)return!1;const e=t.state,i=this.config.active_state;if(null!=i)return Array.isArray(i)?i.includes(e):e===String(i);const s=t.entity_id.split(".")[0],o=Fi[s]||"on";return Array.isArray(o)?o.includes(e):e===o}_getBatteryColors(t){const e=parseFloat(t?.state);return Number.isNaN(e)?["var(--ha-card-background)","var(--primary-text-color)"]:e<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:e<20?["var(--md-sys-cust-color-warning-container, #ffecb3)","var(--md-sys-cust-color-on-warning-container, #6d4c00)"]:["var(--ha-card-background)","var(--primary-text-color)"]}get _templatesReady(){const t=this.config;return(!this._isTemplate(t.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(t.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(t.state_display)||void 0!==this._resolvedStateDisplay)&&((!this._isTemplate(t.icon)||void 0!==this._resolvedIcon)&&(!this._isTemplate(t.name)||void 0!==this._resolvedName))))}render(){if(!this.hass||!this.config)return I``;const t=this.config.entity,e=t?this.hass.states[t]:void 0,i=!!t&&this._isUnavailable(e),s=!i&&this._isActive(e),o=this.config.variant||"secondary",n=this.config.show_state;let a=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,r=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on;const l=["primary","tertiary","error","primary-container","secondary-container","error-container","device-container"];if(!a)if("battery"===o){const[t,i]=this._getBatteryColors(e);a=t,r=i}else if(l.includes(o)){const t=zi[o]||zi.secondary;a=t[0],r=r||t[1]}else if(s&&t){const t=zi[o]||zi.secondary;a=t[0],r=r||t[1]}else a="var(--ha-card-background)",r=r||"var(--primary-text-color)";r=r||"var(--primary-text-color)";const c=n?"with-state":"no-state",d=s?"active":"inactive";let h="";if(n&&i)h="Unavailable";else if(n&&e){const t=this.config.state_display&&(this.config.state_display.includes("{{")||this.config.state_display.includes("{%"));if(this._resolvedStateDisplay&&t)h=this._resolvedStateDisplay;else if(this.config.state_display&&!t)h=this.config.state_display;else{const t=e.state,i=Number(t);if(""===t||null==t||Number.isNaN(i))h=t;else{const t=e.attributes?.unit_of_measurement,s=Math.round(100*i)/100;h=t?"%"===t?`${s}%`:`${s} ${t}`:`${s}`}}h=this._capitalize(h)}return I`
    ...
    `}_handleTap(){if(this.config.double_tap_action?.action&&"none"!==this.config.double_tap_action.action){if(this._dblClickTimer)return;this._dblClickTimer=setTimeout(()=>{this._dblClickTimer=null,this._handleAction(this.config.tap_action||{action:"toggle"})},250)}else this._handleAction(this.config.tap_action||{action:"toggle"})}_handleDoubleTap(){this.config.double_tap_action?.action&&"none"!==this.config.double_tap_action.action&&(clearTimeout(this._dblClickTimer),this._dblClickTimer=null,this._handleAction(this.config.double_tap_action))}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._dblClickTimer),this._dblClickTimer=null}getCardSize(){return 2}}customElements.define("materia-badge",Oi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-badge",name:"Materia Badge",description:"Square badge for dashboard headers.",preview:!0});const Pi={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},tertiary:{active:"var(--md-sys-color-tertiary)",onActive:"var(--md-sys-color-on-tertiary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat-container)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool-container)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto-container)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},Ui={xs:{height:32,innerCorner:4},s:{height:36,innerCorner:8},m:{height:40,innerCorner:8},l:{height:48,innerCorner:16},xl:{height:56,innerCorner:20}},qi=[_t,gt,re,n`
    .group {
      display: flex;
      gap: 2px;
      width: 100%;
  ...
  `];customElements.define("materia-pill-editor",class extends Mt{_formData(){return{background:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"state_display",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}},{name:"background",selector:{boolean:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{}}}]}]}});class Li extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0},_resolvedStateDisplay:{state:!0}};static getConfigElement(){return document.createElement("materia-pill-editor")}static getStubConfig(t){const e=(t?Object.keys(t.states):[]).find(t=>t.startsWith("sensor."))||"";return{entity:e,name:"",icon:"mdi:information-outline"}}static styles=[ft,ji];setConfig(t){if(!t.entity)throw new Error("entity is required");this.config={icon:"mdi:information-outline",...t}}_classify(t){const e=this.config.ranges||[];if(!e.length)return{label:"",color:""};const i=parseFloat(t);if(Number.isNaN(i))return{label:"",color:""};for(const t of e)if(null==t.max||i<=t.max)return{label:t.label,color:t.color};return{label:"",color:""}}get _templatesReady(){const t=this.config;return(!this._isTemplate(t?.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(t?.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(t?.icon)||void 0!==this._resolvedIcon)&&(!this._isTemplate(t?.name)||void 0!==this._resolvedName)))}updated(t){t.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"),this._resolveField("state_display","_resolvedStateDisplay"))}render(){if(!this.hass||!this.config)return I``;if(!this._templatesReady)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),i=this._isTemplate(this.config.name)?this._resolvedName:this.config.name||t?.attributes?.friendly_name||this.config.entity,s=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||t?.attributes?.icon||"",o=t?.attributes?.unit_of_measurement||"",n=t?.state??"",a=this.config.ranges||[],r=this._classify(n);let l;l=e?"Unavailable":this.config.state_display?this._isTemplate(this.config.state_display)?this._resolvedStateDisplay??"":this.config.state_display:a.length?o?`${n} · ${r.label||i}`:n:o?`${this._capitalize(n)} ${o}`:this._capitalize(n);const c=a.length?e?i:o||(r.label||i):"",d=this._resolvedColor||this.config.color||"var(--ha-card-background, var(--card-background-color))",h=this._resolvedColorOn||this.config.color_on||"var(--primary-text-color)",p=!1===this.config.background||"none"===this.config.background;return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-pill",Li),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill",name:"Materia Pill",description:"Compact info pill for sensors, weather, and status indicators.",preview:!0});const Ii=[_t,gt,ft,n`
  :host {
    position: relative;
    z-index: 1;
  }
...
`];class Wi extends Mt{static properties={_expanded:{state:!0}};static styles=[Mt.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}getCardSize(){return 1}}customElements.define("materia-menu",Hi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-menu",name:"Materia Menu",description:"M3 vertical dropdown menu for select entities.",preview:!0});const Vi=n`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-progress-editor",class extends Mt{_formData(){return{show_times:!0,seekable:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"show_times",selector:{boolean:{}}},{name:"seekable",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Wave color",color:!0,template:!0,selector:{text:{}}}]}]}});let Zi=0;class Ki extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_w:{state:!0},_resolvedColor:{state:!0}};static styles=Yi;static getConfigElement(){return document.createElement("materia-media-progress-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("media_player."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config=t,this._cid??="mp-clip-"+ ++Zi}_position(){const t=this.hass?.states[this.config.entity];if(!t)return{pos:0,dur:0,playing:!1,live:!1};const e=Number(t.attributes.media_duration)||0;let i=Number(t.attributes.media_position)||0;const s="playing"===t.state,o=t.attributes.media_position_updated_at;s&&o&&(i+=(Date.now()-new Date(o).getTime())/1e3);const n=`${this.config.entity}|${t.attributes.media_content_id??t.attributes.media_title??""}`;return n!==this._latchKey&&(this._latchKey=n,this._live=!1),s?e>0&&i>=e-.25&&(this._live=!0):this._live=!1,e&&(i=Math.min(i,e)),{pos:Math.max(0,i),dur:e,playing:s,live:this._live}}_fmt(t){t=Math.max(0,Math.round(t));const e=Math.floor(t/3600),i=Math.floor(t%3600/60),s=t%60,o=t=>String(t).padStart(2,"0");return e>0?`${e}:${o(i)}:${o(s)}`:`${i}:${o(s)}`}_wavePath(t,e){let i="";for(let s=t;s<=e;s+=2){const t=14-2*Math.sin(2*Math.PI*s/32);i+=`${i?" L":"M"} ${s.toFixed(1)} ${t.toFixed(1)}`}return i||"M 0 14"}firstUpdated(){const t=this.shadowRoot?.querySelector(".bar");t&&(this._w=t.clientWidth,this._ro=new ResizeObserver(t=>{this._w=t[0].contentRect.width}),this._ro.observe(t))}updated(){const t=this.shadowRoot;this._clipRect=t?.querySelector("clipPath rect"),this._thumbEl=t?.querySelector(".thumb"),this._trackEl=t?.querySelector(".track"),this._posEl=t?.querySelector(".time");"playing"===this.hass?.states[this.config.entity]?.state&&!this._live?this._startLoop():this._stopLoop(),this.hass&&this._resolveField("color","_resolvedColor")}_startLoop(){if(this._raf)return;const t=()=>{this._raf=requestAnimationFrame(t),this._tickDom()};this._raf=requestAnimationFrame(t)}_tickDom(){const{pos:t,dur:e,live:i}=this._position(),s=this._w||300,o=(i?1:e>0?Math.min(1,t/e):0)*s;this._clipRect&&this._clipRect.setAttribute("width",Math.max(0,o)),this._thumbEl&&this._thumbEl.setAttribute("x",o-2),this._trackEl&&this._trackEl.setAttribute("x1",o),this._posEl&&(this._posEl.textContent=this._fmt(t)),i&&this._stopLoop()}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}_fullWave(t){return this._waveW!==t&&(this._waveW=t,this._wavePathCache=this._wavePath(-32,t+32)),this._wavePathCache}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),this._ro?.disconnect()}_seek(t){if(!1===this.config.seekable)return;const{dur:e}=this._position();if(!e)return;const i=t.currentTarget.getBoundingClientRect(),s=Math.max(0,Math.min(1,(t.clientX-i.left)/i.width));this._callService("media_player","media_seek",{entity_id:this.config.entity,seek_position:s*e})}render(){if(!this.hass||!this.config)return I``;const t=this.hass.states[this.config.entity],e=this._isUnavailable(t),{pos:i,dur:s,playing:o,live:n}=this._position(),a=this._w||300,r=(n?1:s>0?Math.min(1,i/s):0)*a,l=!1!==this.config.show_times,c=this._resolvedColor||this.config.color;return I`
    ...
    `}getCardSize(){return 1}}customElements.define("materia-media-progress",Ki),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media-progress",name:"Materia Media Progress",description:"Wavy (M3 expressive) media seek bar with elapsed/duration and tap-to-seek.",preview:!0});const Qi=n`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-editor",class extends Mt{_formData(){return{show_art:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"name",label:"Title",template:!0,selector:{text:{}}},{name:"subtitle",template:!0,selector:{text:{}}},{name:"image",helper:"Defaults to the entity's album art",template:!0,selector:{text:{}}},{name:"fallback_image",helper:"Shown when there's no art",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"show_art",selector:{boolean:{}}},{name:"art_size",label:"Art size (px)",selector:{number:{min:80,max:480,mode:"box"}}},{name:"art_shape",label:"Art shape",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (rotates per track)"},{value:"square",label:"Square (classic)"},{value:"cookie12",label:"Cookie (12)"},{value:"cookie9",label:"Cookie (9)"},{value:"cookie7",label:"Cookie (7)"},{value:"sunny",label:"Sunny"}]}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const Ji={cookie12:ve(50,50,49,12),cookie9:ve(50,50,49,9),cookie7:ve(50,50,49,7),sunny:be(50,50,49,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2})};class ts extends(mt(ct)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedName:{state:!0},_resolvedSubtitle:{state:!0},_resolvedImage:{state:!0}};static styles=Qi;static getConfigElement(){return document.createElement("materia-media-editor")}static getStubConfig(t){const e=Object.keys(t?.states||{}).find(t=>t.startsWith("media_player."))||"";return{entity:e}}setConfig(t){if(!t.entity)throw new Error("entity is required");this.config=t}updated(t){t.has("hass")&&this.hass&&(this._resolveField("name","_resolvedName"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField("image","_resolvedImage"))}get _stateObj(){return this.hass?.states[this.config.entity]}get _title(){if(this.config.name)return this._isTemplate(this.config.name)?this._resolvedName:this.config.name;const t=this._stateObj?.attributes;return t?.media_title||t?.friendly_name||""}get _subtitle(){if(this.config.subtitle)return this._isTemplate(this.config.subtitle)?this._resolvedSubtitle:this.config.subtitle;const t=this._stateObj?.attributes;return t?.media_artist||t?.media_album_name||""}get _image(){if(this.config.image){const t=this._isTemplate(this.config.image)?this._resolvedImage:this.config.image;if(t)return t}return this._stateObj?.attributes?.entity_picture||this.config.fallback_image||""}_tap(){this._handleAction(this.config.tap_action||{action:"more-info"})}static ART_SHAPES=["cookie12","cookie9","cookie7","sunny"];_artShape(t,e){const i=this.config.art_shape;if("square"===i)return null;if(i&&ts.ART_SHAPES.includes(i))return i;const s=String(t?.attributes?.media_content_id||e||this.config.entity||"");let o=0;for(let t=0;t<s.length;t++)o=(o<<5)-o+s.charCodeAt(t)|0;return ts.ART_SHAPES[Math.abs(o)%ts.ART_SHAPES.length]}render(){if(!this.hass||!this.config)return I``;const t=this._stateObj,e=this._isUnavailable(t),i=this._image,s=this._title,o=this._subtitle,n=`${this.config.art_size?`--mm-art:${this.config.art_size}px;`:""}${i?`background-image:url('${i}');`:""}`,a=!1===this.config.show_art?null:this._artShape(t,s);return I`
          ...
          ${a?W`<svg width="0" height="0" style="position:absolute" aria-hidden="true">
                <defs>
                  <clipPath id="artclip-${a}" clipPathUnits="objectBoundingBox">
                    <path transform="scale(0.01)" d=${Ji[a]} />
                  </clipPath>
                </defs>
              </svg>`:V}
    ...
    `}getCardSize(){return 4}}customElements.define("materia-media",ts),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media",name:"Materia Media",description:"Now-playing card — album art, title and subtitle (all templatable).",preview:!0});const es=n`
  :host {
    display: block;
  }
