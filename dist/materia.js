      ...
      <ha-card>
        ...
        >
          ...
          <div class="icon-container">
            ${c?L`<ha-icon .icon=${c} style="color: ${n};"></ha-icon>`:L`<ha-state-icon
                  .hass=${this.hass}
                  .stateObj=${t}
                  style="color: ${n};"
                ></ha-state-icon>`}
