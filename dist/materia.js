 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,k=e=>e,$=w.trustedTypes,C=$?$.createPolicy("lit-html",{createHTML:e=>e}):void 0,S="$lit$",z=`lit$${Math.random().toFixed(9).slice(2)}$`,T="?"+z,E=`<${T}>`,A=document,M=()=>A.createComment(""),O=e=>null===e||"object"!=typeof e&&"function"!=typeof e,F=Array.isArray,D="[ \t\n\f\r]",q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,P=/-->/g,R=/>/g,N=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),L=/'/g,U=/"/g,j=/^(?:script|style|textarea|title)$/i,B=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),I=B(1),H=B(2),W=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),G=new WeakMap,X=A.createTreeWalker(A,129);function Y(e,t){if(!F(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(t):t}const K=(e,t)=>{const i=e.length-1,s=[];let n,a=2===t?"<svg>":3===t?"<math>":"",o=q;for(let t=0;t<i;t++){const i=e[t];let r,l,c=-1,h=0;for(;h<i.length&&(o.lastIndex=h,l=o.exec(i),null!==l);)h=o.lastIndex,o===q?"!--"===l[1]?o=P:void 0!==l[1]?o=R:void 0!==l[2]?(j.test(l[2])&&(n=RegExp("</"+l[2],"g")),o=N):void 0!==l[3]&&(o=N):o===N?">"===l[0]?(o=n??q,c=-1):void 0===l[1]?c=-2:(c=o.lastIndex-l[2].length,r=l[1],o=void 0===l[3]?N:'"'===l[3]?U:L):o===U||o===L?o=N:o===P||o===R?o=q:(o=N,n=void 0);const d=o===N&&e[t+1].startsWith("/>")?" ":"";a+=o===q?i+E:c>=0?(s.push(r),i.slice(0,c)+S+i.slice(c)+z+d):i+z+(-2===c?t:d)}return[Y(e,a+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),s]};class Z{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let n=0,a=0;const o=e.length-1,r=this.parts,[l,c]=K(e,t);if(this.el=Z.createElement(l,i),X.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(s=X.nextNode())&&r.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(const e of s.getAttributeNames())if(e.endsWith(S)){const t=c[a++],i=s.getAttribute(e).split(z),o=/([.?@])?(.*)/.exec(t);r.push({type:1,index:n,name:o[2],strings:i,ctor:"."===o[1]?ie:"?"===o[1]?se:"@"===o[1]?ne:te}),s.removeAttribute(e)}else e.startsWith(z)&&(r.push({type:6,index:n}),s.removeAttribute(e));if(j.test(s.tagName)){const e=s.textContent.split(z),t=e.length-1;if(t>0){s.textContent=$?$.emptyScript:"";for(let i=0;i<t;i++)s.append(e[i],M()),X.nextNode(),r.push({type:2,index:++n});s.append(e[t],M())}}}else if(8===s.nodeType)if(s.data===T)r.push({type:2,index:n});else{let e=-1;for(;-1!==(e=s.data.indexOf(z,e+1));)r.push({type:7,index:n}),e+=z.length-1}n++}}static createElement(e,t){const i=A.createElement("template");return i.innerHTML=e,i}}function Q(e,t,i=e,s){if(t===W)return t;let n=void 0!==s?i._$Co?.[s]:i._$Cl;const a=O(t)?void 0:t._$litDirective$;return n?.constructor!==a&&(n?._$AO?.(!1),void 0===a?n=void 0:(n=new a(e),n._$AT(e,i,s)),void 0!==s?(i._$Co??=[])[s]=n:i._$Cl=n),void 0!==n&&(t=Q(e,n._$AS(e,t.values),n,s)),t}class J{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??A).importNode(t,!0);X.currentNode=s;let n=X.nextNode(),a=0,o=0,r=i[0];for(;void 0!==r;){if(a===r.index){let t;2===r.type?t=new ee(n,n.nextSibling,this,e):1===r.type?t=new r.ctor(n,r.name,r.strings,this,e):6===r.type&&(t=new ae(n,this,e)),this._$AV.push(t),r=i[++o]}a!==r?.index&&(n=X.nextNode(),a++)}return X.currentNode=A,s}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ee{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Q(this,e,t),O(e)?e===V||null==e||""===e?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==W&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>F(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==V&&O(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=Z.createElement(Y(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const e=new J(s,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=G.get(e.strings);return void 0===t&&G.set(e.strings,t=new Z(e)),t}k(e){F(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const n of e)s===t.length?t.push(i=new ee(this.O(M()),this.O(M()),this,this.options)):i=t[s],i._$AI(n),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=k(e).nextSibling;k(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}let te=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,n){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=V}_$AI(e,t=this,i,s){const n=this.strings;let a=!1;if(void 0===n)e=Q(this,e,t,0),a=!O(e)||e!==this._$AH&&e!==W,a&&(this._$AH=e);else{const s=e;let o,r;for(e=n[0],o=0;o<n.length-1;o++)r=Q(this,s[i+o],t,o),r===W&&(r=this._$AH[o]),a||=!O(r)||r!==this._$AH[o],r===V?e=V:e!==V&&(e+=(r??"")+n[o+1]),this._$AH[o]=r}a&&!s&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}};class ie extends te{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}}class se extends te{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==V)}}class ne extends te{constructor(e,t,i,s,n){super(e,t,i,s,n),this.type=5}_$AI(e,t=this){if((e=Q(this,e,t,0)??V)===W)return;const i=this._$AH,s=e===V&&i!==V||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==V&&(i===V||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ae{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Q(this,e)}}const oe=w.litHtmlPolyfillSupport;oe?.(Z,ee),(w.litHtmlVersions??=[]).push("3.3.2");const re=(e,t,i)=>{const s=i?.renderBefore??t;let n=s._$litPart$;if(void 0===n){const e=i?.renderBefore??null;s._$litPart$=n=new ee(t.insertBefore(M(),e),e,void 0,i??{})}return n._$AI(e),n
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */},le=globalThis;let ce=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=re(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}};ce._$litElement$=!0,ce.finalized=!0,le.litElementHydrateSupport?.({LitElement:ce});const he=le.litElementPolyfillSupport;let de;async function pe(){return de||(de=await window.loadCardHelpers(),de)}he?.({LitElement:ce}),(le.litElementVersions??=[]).push("4.2.2"),a`
  :host {
    display: block;
...
`;const ue={ms:342,easing:"linear(0, 0.0731, 0.247, 0.463, 0.6769, 0.8602, 0.9987, 1.089, 1.1357, 1.1476, 1.1353, 1.1088, 1.0767, 1.0453, 1.0187, 0.9989, 0.9861, 0.9796, 0.9782, 0.9803, 0.9843, 0.9891, 0.9937, 0.9975, 1.0004, 1.0022, 1.003, 1.0032, 1.0029, 1.0023, 1.0016, 1)"},me={ms:533},ge=a`
  :host {
...
/>`;class be extends ce{static properties={gesture:{type:String,reflect:!0},label:{type:String},icon:{type:String},direction:{type:String},pending:{type:Boolean,reflect:!0},threshold:{type:Number},holdMs:{type:Number,attribute:"hold-ms"},disabled:{type:Boolean,reflect:!0},_p:{state:!0},_armed:{state:!0}};static styles=[ge,a`
      :host {
        display: block;
    ...
    `}}customElements.define("materia-drag-confirm",be);class ve extends ce{static properties={year:{type:Number},month:{type:Number},selected:{type:Number},firstDay:{type:Number,attribute:"first-day"},noPast:{type:Boolean,attribute:"no-past"},locale:{type:String}};static styles=[ge,a`
      :host {
        display: block;
    ...
    `];constructor(){super();const e=new Date;this.year=e.getFullYear(),this.month=e.getMonth(),this.selected=null,this.firstDay=1,this.noPast=!1,this.locale=""}get _locale(){return this.locale||void 0}get _dayNames(){const e=new Intl.DateTimeFormat(this._locale,{weekday:"narrow"});return Array.from({length:7},(t,i)=>e.format(new Date(2024,0,1+(i+(0===this.firstDay?6:0))%7)))}get _monthLabel(){return new Intl.DateTimeFormat(this._locale,{month:"long",year:"numeric"}).format(new Date(this.year,this.month,1))}_shift(e){let t=this.month+e,i=this.year;t<0?(t=11,i-=1):t>11&&(t=0,i+=1),this.dispatchEvent(new CustomEvent("month-changed",{detail:{year:i,month:t},bubbles:!0,composed:!0}))}_pick(e){this.dispatchEvent(new CustomEvent("date-selected",{detail:{date:new Date(this.year,this.month,e),day:e},bubbles:!0,composed:!0}))}render(){const e=(new Date(this.year,this.month,1).getDay()-this.firstDay+7)%7,t=new Date(this.year,this.month+1,0).getDate(),i=new Date,s=i.getFullYear()===this.year&&i.getMonth()===this.month,n=i.getDate(),a=[...Array.from({length:e},()=>null),...Array.from({length:t},(e,t)=>t+1)];return I`
      <div class="head">
...
`,Fe=e=>e.label??e.name.replace(/_/g," ").replace(/^\w/,e=>e.toUpperCase()),De=(e,t)=>I`
  <ha-sortable
...
`,qe=(e,t,i)=>({value:`var(--md-sys-cust-color-${e})`,swatch:`var(--md-sys-cust-color-${e}, ${i})`,label:t}),Pe=(e,t)=>({value:`var(--md-sys-color-${e})`,swatch:`var(--md-sys-color-${e})`,label:t}),Re=[{title:"Light",options:[qe("light","Light","#FEE082"),qe("light-container","Light container","#FEEFCA"),qe("on-light","On light","#745D00")]},{title:"Device",options:[qe("device","Device","#D9E2FE"),qe("device-container","Device container","#EDF0FF"),qe("on-device","On device","#0156CF")]},{title:"Climate · Heat",options:[qe("climate-heat","Heat","#FFDFD4"),qe("climate-heat-container","Heat container","#FFEEE9"),qe("on-climate-heat","On heat","#A14614"),qe("climate-heat-accent","Heat accent","#A14614")]},{title:"Climate · Cool",options:[qe("climate-cool","Cool","#D3E8FF"),qe("climate-cool-container","Cool container","#EAF3FF"),qe("on-climate-cool","On cool","#327EA7"),qe("climate-cool-accent","Cool accent","#327EA7")]},{title:"Climate · Auto",options:[qe("climate-auto","Auto","#D4EBDD"),qe("climate-auto-container","Auto container","#EAF6EE"),qe("on-climate-auto","On auto","#2E5E44"),qe("climate-auto-accent","Auto accent","#2E5E44")]},{title:"Water · Eco",options:[qe("water-eco","Eco","#C8E6C9"),qe("water-eco-container","Eco container","#E6F4EA"),qe("on-water-eco","On eco","#256029")]},{title:"Water · Performance",options:[qe("water-performance","Performance","#FFD1B0"),qe("water-performance-container","Performance container","#FFEDE0"),qe("on-water-performance","On performance","#9C3A00")]},{title:"Warning",options:[qe("warning","Warning","#D9A000"),qe("warning-container","Warning container","#FEEFCA"),qe("on-warning","On warning","#FFFFFF"),qe("on-warning-container","On warning container","#745D00")]},{title:"Error",options:[qe("error","Error","#B3261E"),qe("error-container","Error container","#F9DEDC"),qe("on-error","On error","#FFFFFF"),qe("on-error-container","On error container","#410E0B")]},{title:"Weather",options:[qe("weather-sun","Sun","#F2B500"),qe("weather-cloud","Cloud","#9FA9B7"),qe("weather-cloud-dark","Cloud (dark)","#6F7A8A"),qe("weather-rain","Rain","#2E86E0"),qe("weather-snow","Snow","#AEB8C4"),qe("weather-moon","Moon","#5961C2")]},{title:"Severity scale",options:[qe("scale-green","Scale green","#5E9E50"),qe("scale-yellow","Scale yellow","#C7A128"),qe("scale-orange","Scale orange","#D9713C"),qe("scale-red","Scale red","#C94D42"),qe("scale-purple","Scale purple","#8A4DA3"),qe("scale-maroon","Scale maroon","#7A4040")]},{title:"System (theme)",options:[Pe("primary","Primary"),Pe("primary-container","Primary container"),Pe("secondary","Secondary"),Pe("secondary-container","Secondary container"),Pe("tertiary","Tertiary"),Pe("tertiary-container","Tertiary container"),Pe("error","Error"),Pe("error-container","Error container"),Pe("surface-container","Surface container")]}],Ne=new Set(Re.flatMap(e=>e.options.map(e=>e.value)));function Le(e){return e&&"string"==typeof e&&(e.includes("{{")||e.includes("{%"))}const Ue={template:{}};class je extends ce{static properties={label:{},value:{},_open:{state:!0},_customOpen:{state:!0}};static styles=a`
  ...
  `;setConfig(e){this._config=e,this._modes??={}}_formData(){return this._config||{}}get _sections(){return[]}_sectionsSignature(){return""}get _sectionsMemo(){const e=this._sectionsSignature();return this.__secSig===e&&this.__secVal||(this.__secSig=e,this.__secVal=this._sections),this.__secVal}_stableContext(e,t,i){const s={};for(const[e,n]of Object.entries(t))s[e]=i[n];this.__ctx??={};const n=this.__ctx[e];return n&&Object.keys(s).every(e=>n[e]===s[e])?n:(this.__ctx[e]=s,s)}_modeFor(e,t){const i=this._modes?.[e];return i||(Le(t)?"template":"simple")}_toggleMode(e){const t=this._formData()[e],i=this._modeFor(e,t);this._modes={...this._modes||{},[e]:"template"===i?"simple":"template"}}render(){if(!this.hass||!this._config)return I``;const e=this._formData();return I`
    ...
    `}_renderField(e,t){const i=t[e.name],s=e.label??Fe(e),n=!!e.template,a=n?this._modeFor(e.name,i):"simple",o=e.context?this._stableContext(e.name,e.context,t):void 0;let r;return r=n&&"template"===a?I`
        <ha-selector
          class="field-control"
          .hass=${this.hass}
          .selector=${Ue}
      ...
      <div class="field" @value-changed=${t=>this._fieldChanged(e.name,t)}>
        ...
        ${n?I`
              <ha-icon-button
                class="tpl-toggle ${"template"===a?"active":""}"
                .label=${"template"===a?"Use simple input":"Use a template"}
    ...
    `}_fieldChanged(e,t){t.stopPropagation(),this._setField(e,t.detail?.value)}_setField(e,t){const i={...this._config};""===t||null==t?delete i[e]:i[e]=t,this._commit(i)}_commit(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}}const We=new Set(["cover"]);function Ve(e){if(!e?.entity)return{...e};const t=e.entity.split(".")[0],i={show_sub_buttons:!1,show_stop:!0,show_state:!0,subtitle_inline:!0};return We.has(t)&&(i.show_sub_buttons=!0),"light"!==t&&"cover"!==t||(i.show_slider=!0),{...i,...e}}class Ge extends He{static properties={_expandedButton:{state:!0}};static styles=[He.styles,a`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
      ...
      ${e.map((e,t)=>I`
          <div class="button-card">
            <div class="button-header" @click=${()=>this._toggleButton(t)}>
              <span>${e.name||(e.icon&&!Le(e.icon)?e.icon:`Button ${t+1}`)}</span>
      ...
      <ha-card>
        ...
        >
          ...
          <div class="icon-container">
            ${l?I`<ha-icon .icon=${l} style="color: ${a};"></ha-icon>`:I`<ha-state-icon
                  .hass=${this.hass}
                  .stateObj=${e}
                  style="color: ${a};"
                ></ha-state-icon>`}
          ...
          <div class="name-container">
            ...
            ${!d&&h?I`<div class="subtitle">${h}</div>`:""}
    ...
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}static styles=[Ee,ze,Ae,Me,Te,Oe]}customElements.define("materia-card",Ke),window.customCards=window.customCards||[],window.customCards.push({type:"materia-card",name:"Materia Card",description:"Universal entity card. Auto-detects lights, covers, devices, locks, and scenes.",preview:!0});const Ze=a`
  .collapsible {
    display: grid;
...
`;class Qe extends He{static properties={_selectedCard:{state:!0},_expandedButton:{state:!0}};static styles=[He.styles,a`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `}_toggleSubButton(e){this._expandedButton=this._expandedButton===e?null:e}_addSubButton(){const e=[...this._config.sub_buttons||[],{icon:"mdi:star"}];this._commit({...this._config,sub_buttons:e}),this._expandedButton=e.length-1}_removeSubButton(e){const t=[...this._config.sub_buttons||[]];t.splice(e,1),this._expandedButton===e&&(this._expandedButton=null);const i={...this._config};0===t.length?delete i.sub_buttons:i.sub_buttons=t,this._commit(i)}_subButtonChanged(e,t){const i=[...this._config.sub_buttons||[]];i[e]={...i[e],...t},this._commit({...this._config,sub_buttons:i})}_handleCardPicked(e){e.stopPropagation();const t=[...this._config.cards||[],e.detail.config];this._selectedCard=t.length-1,this._commit({...this._config,cards:t})}_handleChildChanged(e){if(e.stopPropagation(),e.detail.error)return;const t=[...this._config.cards||[]];t[this._selectedCard]=e.detail.config,this._commit({...this._config,cards:t})}_moveCard(e){const t=[...this._config.cards||[]],i=this._selectedCard,s=i+e;if(s<0||s>=t.length)return;const[n]=t.splice(i,1);t.splice(s,0,n),this._selectedCard=s,this._commit({...this._config,cards:t})}_removeCard(){const e=[...this._config.cards||[]];e.splice(this._selectedCard,1),this._selectedCard=Math.max(0,Math.min(this._selectedCard,e.length-1)),0===e.length&&(this._selectedCard=-1),this._commit({...this._config,cards:e})}}customElements.define("materia-room-editor",Qe);class Je extends Ke{static properties={...Ke.properties,_expanded:{state:!0},_childCards:{state:!0}};static styles=[Ee,ze,Ae,Me,Te,Oe,Ze];static getConfigElement(){return document.createElement("materia-room-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("light."))||"light.example";return{entity:t,columns:2,cards:[]}}constructor(){super(),this._expanded=!1,this._childCards=null}setConfig(e){if(!e.entity)throw new Error("entity is required");const t=this.config?.cards;this.config={columns:2,...e};const i=this.config.cards;JSON.stringify(t)!==JSON.stringify(i)&&(this._childCards=null,this.isConnected&&this._createChildCards())}firstUpdated(){this._createChildCards()}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&this._childCards&&this._childCards.forEach(e=>e.hass=this.hass)}async _createChildCards(){const e=this.config?.cards;if(!e||0===e.length)return void(this._childCards=[]);const t=await pe();this._childCards=await Promise.all(e.map(async e=>{const i=await t.createCardElement(e);return this.hass&&(i.hass=this.hass),i})),this.requestUpdate()}_toggleExpand(e){e?.stopPropagation?.(),this._expanded=!this._expanded,this._fireHaptic("selection")}render(){if(!this.config||!this.hass)return I``;const e=this._stateObj,t=this._isUnavailable(e);!t&&this._isActive;const i=!t&&this._showSlider,s=t?[]:this._subButtons,n=this._getContainerBg(),a=this._getTextColor(),o=i?this._fillPercent:0,r=this._domainConfig.sliderColor||this._domainConfig.colorActive,l=this._icon,c=t?ke("unavailable",this.hass):this._stateDisplay,h=this._subtitle,d=!1!==this.config.subtitle_inline,p=d&&h?c?`${c} · ${h}`:h:c,u=this.config.columns||2;return I`
      <ha-card>
        ...
        >
          ...
          <div class="icon-container">
            ${l?I`<ha-icon .icon=${l} style="color: ${a};"></ha-icon>`:I`<ha-state-icon .hass=${this.hass} .stateObj=${e} style="color: ${a};"></ha-state-icon>`}
          </div>

          <div class="name-container">
            <div class="name">${this._name}</div>
            ${!d&&h?I`<div class="subtitle">${h}</div>`:V}
    ...
    `}getCardSize(){return this._expanded?3+(this._childCards?.length||0):2}getGridOptions(){return{columns:12,rows:"auto"}}}customElements.define("materia-room",Je),window.customCards=window.customCards||[],window.customCards.push({type:"materia-room",name:"Materia Room",description:"Materia card with expandable child-card grid.",preview:!0});const et=a`
  ha-card {
    border-radius: 30px;
...
`;customElements.define("materia-climate-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"name",required:!0,template:!0,selector:{text:{}}}]},{title:"Sensors",icon:"mdi:thermometer",fields:[{name:"temperature_entity",label:"Temperature sensor",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}},{name:"outdoor_temp_entity",label:"Outdoor temperature sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Behavior",icon:"mdi:tune",fields:[{name:"step",selector:{number:{min:.5,max:5,step:.5,mode:"box"}}}]}]}});class tt extends(Se(ce)){static get properties(){return{hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_resolvedName:{state:!0}}}static styles=[Ee,Te,et];static getConfigElement(){return document.createElement("materia-climate-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("climate."))||"climate.example";return{entity:t,name:"Climate",step:.5}}setConfig(e){if(!e.entity)throw new Error("entity is required");if(!e.name)throw new Error("name is required");this.config={step:.5,...e}}getCardSize(){return 3}get _entity(){return this.hass?.states[this.config.entity]}get _mode(){return this._entity?.state??"off"}get _targetTemp(){return null!=this._optimisticTemp?this._optimisticTemp:this._entity?.attributes?.temperature}get _currentTemp(){return this.config.temperature_entity?this.hass?.states[this.config.temperature_entity]?.state:this._entity?.attributes?.current_temperature}get _humidity(){if(this.config.humidity_entity)return this.hass?.states[this.config.humidity_entity]?.state}get _outdoorTemp(){if(this.config.outdoor_temp_entity)return this.hass?.states[this.config.outdoor_temp_entity]?.state}_modeIcon(){switch(this._mode){case"heat":return"mdi:fire";case"cool":return"mdi:snowflake";case"auto":return"mdi:autorenew";default:return"mdi:power"}}_modeBg(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-climate-heat-container)";case"cool":return"var(--md-sys-cust-color-climate-cool-container)";case"auto":return"var(--md-sys-cust-color-climate-auto-container)";default:return"var(--md-sys-color-surface-container-highest, var(--md-sys-color-surface-variant))"}}_modeColor(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-on-climate-heat)";case"cool":return"var(--md-sys-cust-color-on-climate-cool)";case"auto":return"var(--md-sys-cust-color-on-climate-auto)";default:return"var(--primary-text-color)"}}_buttonBg(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-climate-heat)";case"cool":return"var(--md-sys-cust-color-climate-cool)";case"auto":return"var(--md-sys-cust-color-climate-auto)";default:return"var(--md-sys-color-surface-container-highest, var(--md-sys-color-surface-variant))"}}_buttonColor(){switch(this._mode){case"heat":return"var(--md-sys-cust-color-on-climate-heat)";case"cool":return"var(--md-sys-cust-color-on-climate-cool, #fff)";case"auto":return"var(--md-sys-cust-color-on-climate-auto, #000)";default:return"var(--md-sys-color-on-surface)"}}_statusText(){const e=this._currentTemp,t=this._humidity,i=this._outdoorTemp,s=[];return null!=e&&s.push(`${e}°`),null!=t&&s.push(`${t}%`),null!=i&&s.push(`${i}°`),s.join(" · ")||""}_adjustTemp(e){const t=this._targetTemp;if(null==t)return;const i=this.config.step??.5,s=Number(this._entity?.attributes?.min_temp??7),n=Number(this._entity?.attributes?.max_temp??35),a=Math.min(n,Math.max(s,Math.round((Number(t)+e)/i)*i));this._optimisticTemp=a,this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:a}),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4)}updated(e){if(e.has("hass")&&this.hass&&this._resolveField("name","_resolvedName"),e.has("hass")&&null!=this._optimisticTemp){const e=Number(this._entity?.attributes?.temperature);Number.isFinite(e)&&Math.abs(e-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._optimisticTimer)}_handleTap(e){e.target.closest(".btn")||this._handleAction(this.config.tap_action??{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const e=this._entity,t=this._isUnavailable(e),i="off"===this._mode||t,s=t?"Unavailable":i?"Off":null!=this._targetTemp?Math.round(this._targetTemp):"—";return I`
    ...
    `}}customElements.define("materia-climate",tt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate",name:"Materia Climate",description:"Climate thermostat with mode-based theming and temperature controls.",preview:!0});const it=[Ee,ze,Te,a`
  .container {
    position: relative;
    width: 100%;
    min-height: 50px;
...
`];customElements.define("materia-weather-editor",class extends He{_formData(){return{show_temperature:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Sensors",icon:"mdi:water-percent",fields:[{name:"show_temperature",label:"Show temperature",selector:{boolean:{}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity_entity",label:"Humidity sensor",selector:{entity:{domain:"sensor"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const st={sunny:"m3o:sunny",clear:"m3o:sunny","clear-night":"mdi:weather-night",partlycloudy:"m3o:partly-cloudy-day",partly_cloudy:"m3o:partly-cloudy-day",cloudy:"m3o:cloud",rainy:"m3o:rainy",pouring:"m3o:rainy",snowy:"mdi:weather-snowy",fog:"m3o:foggy",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning","lightning-rainy":"mdi:weather-lightning-rainy",hail:"mdi:weather-hail",exceptional:"mdi:alert-circle-outline"},nt={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class at extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0}};static getConfigElement(){return document.createElement("materia-weather-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}static styles=it;setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"))}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"",s=!1!==this.config.show_temperature;let n=e?.attributes?.temperature,a=e?.attributes?.temperature_unit||"°";if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&(n=e.state,a=e.attributes?.unit_of_measurement||a)}const o=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||st[i]||"mdi:weather-partly-cloudy";let r=null;if(this.config.humidity_entity){const e=this.hass.states[this.config.humidity_entity];e&&(r=e.state)}null==r&&null!=e?.attributes?.humidity&&(r=e.attributes.humidity);const l=nt[i]||this._capitalize(i.replace(/-|_/g," ")),c=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,h=s&&null!=n?`${n}${a}`:null;let d;d=t?"Unavailable":c||(h||(l||"—"));const p=[];t||(h&&d!==h&&p.push(h),d!==l&&p.push(l),null!=r&&p.push(`${r}%`));const u=p.join(" · ");return I`
      <ha-card>
        <div
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}function ot(e,t,i,s=12){return rt(e,t,i,{vertices:s,innerRadius:.8,rounding:.5,rotate:-Math.PI/2})}function rt(e,t,i,{vertices:s,innerRadius:n=null,rounding:a=.2,rotate:o=0}={}){const r=[],l=null!=n?2*s:s;for(let s=0;s<l;s++){const c=null!=n&&s%2==1?i*n:i,h=o+s/l*Math.PI*2;r.push({x:e+c*Math.cos(h),y:t+c*Math.sin(h),r:a*i})}return function(e){return ct(lt(e))}(r)}function lt(e){const t=e.length,i=[];for(let s=0;s<t;s++){const n=e[(s-1+t)%t],a=e[s],o=e[(s+1)%t],r=[n.x-a.x,n.y-a.y],l=[o.x-a.x,o.y-a.y],c=Math.hypot(...r),h=Math.hypot(...l);r[0]/=c,r[1]/=c,l[0]/=h,l[1]/=h;const d=r[0]*l[0]+r[1]*l[1],p=Math.acos(Math.min(1,Math.max(-1,d)))/2;let u=a.r/Math.tan(p);u=Math.min(u,.5*c,.5*h);const m=u*Math.tan(p),g=[a.x+r[0]*u,a.y+r[1]*u],f=[a.x+l[0]*u,a.y+l[1]*u],_=r[0]+l[0],b=r[1]+l[1],v=Math.hypot(_,b)||1,y=m/Math.sin(p),x=[a.x+_/v*y,a.y+b/v*y],w=r[0]*l[1]-r[1]*l[0];i.push({T1:g,T2:f,C:x,rEff:m,sweep:w>0?0:1})}return i}function ct(e){const t=e.length;let i=`M${e[0].T1[0].toFixed(2)} ${e[0].T1[1].toFixed(2)} `;for(let s=0;s<t;s++){const n=e[s],a=e[(s+1)%t];i+=`A${n.rEff.toFixed(2)} ${n.rEff.toFixed(2)} 0 0 ${n.sweep} ${n.T2[0].toFixed(2)} ${n.T2[1].toFixed(2)} `,i+=`L${a.T1[0].toFixed(2)} ${a.T1[1].toFixed(2)} `}return i+"Z"}function ht(e,t,i,s=0){return dt(e,t,i,s,[{x:.193,y:.277,r:.053},{x:.176,y:.055,r:.053}],10)}function dt(e,t,i,s,n,a){const o=[];for(let e=0;e<a;e++){const t=s+e/a*Math.PI*2,i=Math.cos(t),r=Math.sin(t);for(const e of n){const t=e.x-.5,s=e.y-.5;o.push({x:.5+t*i-s*r,y:.5+t*r+s*i,r:e.r})}}const r=lt(o),l=[];for(const e of r){const t=Math.atan2(e.T1[1]-e.C[1],e.T1[0]-e.C[0]);let i=Math.atan2(e.T2[1]-e.C[1],e.T2[0]-e.C[0])-t;if(1===e.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=8;s++){const n=t+i*s/8;l.push([e.C[0]+e.rEff*Math.cos(n),e.C[1]+e.rEff*Math.sin(n)])}}const c=Math.max(...l.map(([e,t])=>Math.hypot(e-.5,t-.5))),h=i/c,d=i=>[e+(i[0]-.5)*h,t+(i[1]-.5)*h];return ct(r.map(e=>({T1:d(e.T1),T2:d(e.T2),C:d(e.C),rEff:e.rEff*h,sweep:e.sweep})))}function pt(e,t,i,{points:s,reps:n=1,mirroring:a=!1,rotate:o=0}){const r=function(e,t,i,s=.5,n=.5){const a=[];if(!i){const i=e.length;for(let o=0;o<i*t;o++){const r=e[o%i],l=360*Math.floor(o/i)/t*(Math.PI/180),c=r.x-s,h=r.y-n;a.push({x:s+c*Math.cos(l)-h*Math.sin(l),y:n+c*Math.sin(l)+h*Math.cos(l),r:r.r})}return a}const o=e.map(e=>180*Math.atan2(e.y-n,e.x-s)/Math.PI),r=e.map(e=>Math.hypot(e.x-s,e.y-n)),l=2*t,c=360/l;for(let t=0;t<l;t++){const i=t%2==0;for(let l=0;l<e.length;l++){const h=i?l:e.length-1-l;if(!(h>0||i))continue;const d=(c*t+(i?o[h]:c-o[h]+2*o[0]))*(Math.PI/180);a.push({x:s+Math.cos(d)*r[h],y:n+Math.sin(d)*r[h],r:e[h].r})}}return a}(s,n,a),l=Math.cos(o),c=Math.sin(o),h=r.map(e=>{const t=e.x-.5,i=e.y-.5;return{x:.5+t*l-i*c,y:.5+t*c+i*l,r:e.r}}),d=lt(h),p=function(e){let t=1/0,i=1/0,s=-1/0,n=-1/0;const a=(e,a)=>{e<t&&(t=e),e>s&&(s=e),a<i&&(i=a),a>n&&(n=a)};for(const t of e){const e=Math.atan2(t.T1[1]-t.C[1],t.T1[0]-t.C[0]);let i=Math.atan2(t.T2[1]-t.C[1],t.T2[0]-t.C[0])-e;if(1===t.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=16;s++){const n=e+i*s/16;a(t.C[0]+t.rEff*Math.cos(n),t.C[1]+t.rEff*Math.sin(n))}}return{minX:t,minY:i,maxX:s,maxY:n}}(d),u=p.maxX-p.minX,m=p.maxY-p.minY,g=i/Math.max(u,m),f=(p.minX+p.maxX)/2,_=(p.minY+p.maxY)/2,b=i=>[e+(i[0]-f)*g,t+(i[1]-_)*g];return ct(d.map(e=>({T1:b(e.T1),T2:b(e.T2),C:b(e.C),rEff:e.rEff*g,sweep:e.sweep})))}function ut(e,t,i,s,n){const a=s=>{const n=(s-90)*Math.PI/180;return[e+i*Math.cos(n),t+i*Math.sin(n)]},[o,r]=a(s),[l,c]=a(n),h=Math.abs(n-s)>180?1:0;return`M${o.toFixed(2)} ${r.toFixed(2)} A${i} ${i} 0 ${h} 1 ${l.toFixed(2)} ${c.toFixed(2)}`}function mt(e,t,i,s){const n=Math.cos(2*Math.PI*s);if(s<.02||s>.98)return"";const a=Math.max(.01,Math.abs(n)*i).toFixed(2),o=`${e} ${t-i}`,r=`${e} ${t+i}`;return s<=.5?`M${o} A${i} ${i} 0 0 1 ${r} A${a} ${i} 0 0 ${n>0?0:1} ${o} Z`:`M${o} A${i} ${i} 0 0 0 ${r} A${a} ${i} 0 0 ${n>0?1:0} ${o} Z`}function gt(e,t){const i={new_moon:0,waxing_crescent:.125,first_quarter:.25,waxing_gibbous:.375,full_moon:.5,waning_gibbous:.625,last_quarter:.75,waning_crescent:.875},s=t?e?.states?.[t]:e?.states?.["sensor.moon_phase"]??e?.states?.["sensor.moon"];return s&&s.state in i?i[s.state]:null}customElements.define("materia-weather",at),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather",name:"Materia Weather",description:"Weather condition card with automatic icon mapping.",preview:!0});const ft="var(--md-sys-cust-color-weather-sun, #FFC83D)",_t="var(--md-sys-cust-color-weather-cloud, #E6EAF0)",bt="var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)",vt="var(--md-sys-cust-color-weather-rain, #5FA8F5)",yt="var(--md-sys-cust-color-weather-sun, #FFC83D)",xt="var(--md-sys-cust-color-weather-moon, #DCE3F7)";let wt=0;function kt(e,t,i,s){const n=.1*i,a=72,o=[];for(let s=0;s<a;s++){const r=s/a*Math.PI*2,l=i+n*Math.cos(9*r);o.push([e+l*Math.cos(r),t+l*Math.sin(r)])}let r=`M${o[0][0].toFixed(2)} ${o[0][1].toFixed(2)} `;for(let e=0;e<a;e++){const t=o[(e-1+a)%a],i=o[e],s=o[(e+1)%a],n=o[(e+2)%a],l=i[0]+(s[0]-t[0])/6,c=i[1]+(s[1]-t[1])/6,h=s[0]-(n[0]-i[0])/6,d=s[1]-(n[1]-i[1])/6;r+=`C${l.toFixed(2)} ${c.toFixed(2)} ${h.toFixed(2)} ${d.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return H`<path d=${r+"Z"} fill=${s} />`}function $t(e,t,i,s){return H`
    ...
    </g>`}function Ct(e,t,i){return H`<g stroke=${e} stroke-width="1.8" stroke-linecap="round">
    ${t.map(e=>H`<line x1=${e} y1=${i} x2=${e-1.5} y2=${i+3.5} />`)}
  </g>`}function St(e,t){return H`<g fill=${"var(--md-sys-cust-color-weather-snow, #FFFFFF)"}>
    ${e.map(e=>H`<circle cx=${e} cy=${t} r="1.2" />`)}
  </g>`}const zt={sunny:e=>kt(12,12,7.5,e.sun),clear:e=>kt(12,12,7.5,e.sun),"clear-night":(e,t)=>{if(null==t)return H`<path d="M17 14.5 A7 7 0 1 1 10.5 5 A5.5 5.5 0 0 0 17 14.5 Z" fill=${e.moon} />`;const i=mt(12,12,7.2,t);return H`
      <circle cx="12" cy="12" r="7.2" fill="color-mix(in srgb, ${xt} 22%, transparent)" />
      ${i?H`<path d=${i} fill=${e.moon} />`:""}`},partlycloudy:e=>H`${kt(12,8,5.2,e.sun)}${$t(10,15,.85,e.cloud)}`,partly_cloudy:e=>H`${kt(12,8,5.2,e.sun)}${$t(10,15,.85,e.cloud)}`,cloudy:e=>$t(12,12,1.1,e.cloudDk),rainy:e=>H`${$t(12,10,1,e.cloudDk)}${Ct(vt,[8,12,16],17)}`,pouring:e=>H`${$t(12,9.5,1,e.cloudDk)}${Ct(vt,[7,10,13,16],16.5)}`,snowy:e=>H`${$t(12,10,1,e.cloud)}${St([8,12,16],18)}`,"snowy-rainy":e=>H`${$t(12,10,1,e.cloud)}${Ct(vt,[9,15],17)}${St([12],18)}`,fog:e=>H`${$t(12,9,.95,e.cloudDk)}<g stroke=${"var(--md-sys-cust-color-weather-cloud-dark, #C7CEDA)"} stroke-width="1.8" stroke-linecap="round">
      <line x1="6" y1="17" x2="18" y2="17" /><line x1="7.5" y1="20" x2="16.5" y2="20" /></g>`,hail:e=>H`${$t(12,10,1,e.cloudDk)}${St([8,12,16],18)}`,lightning:e=>H`${$t(12,10,1,e.cloudDk)}<path d="M12 14 l-2.5 5 h2 l-1 4 4.5-6.5 h-2.2 l1.5-2.5 z" fill=${yt} />`,"lightning-rainy":e=>H`${$t(12,9.5,1,e.cloudDk)}${Ct(vt,[8,16],17)}<path d="M12 14 l-2 4 h1.8 l-0.8 3.5 4-5.5 h-2 l1.3-2 z" fill=${yt} />`,windy:()=>H`<g stroke=${bt} stroke-width="2" stroke-linecap="round" fill="none">
      <path d="M4 9 h11 a2.5 2.5 0 1 0-2.5-2.5" />
      <path d="M4 14 h14 a2.5 2.5 0 1 1-2.5 2.5" /></g>`,"windy-variant":()=>H`<g stroke=${bt} stroke-width="2" stroke-linecap="round" fill="none">
      <path d="M4 9 h11 a2.5 2.5 0 1 0-2.5-2.5" />
      <path d="M4 14 h14 a2.5 2.5 0 1 1-2.5 2.5" /></g>`,exceptional:e=>$t(12,12,1.1,e.cloudDk)};function Tt(e,t=null){const i=zt[e]||zt.cloudy,s=++wt;return H`${function(e){return H`<defs>
    <radialGradient id="wxSunG-${e}" cx="38%" cy="30%" r="80%">
      <stop offset="0%" stop-color="color-mix(in srgb, ${ft} 55%, #FFF4CF)" />
      <stop offset="55%" stop-color=${ft} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${ft} 72%, #B85C00)" />
    </radialGradient>
    <linearGradient id="wxCloudG-${e}" x1="0" y1="0" x2="0.25" y2="1">
      <stop offset="0%" stop-color="color-mix(in srgb, ${_t} 30%, #FFFFFF)" />
      <stop offset="70%" stop-color=${_t} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${_t} 78%, #8B94A5)" />
    </linearGradient>
    <linearGradient id="wxCloudDkG-${e}" x1="0" y1="0" x2="0.25" y2="1">
      <stop offset="0%" stop-color="color-mix(in srgb, ${bt} 45%, #FFFFFF)" />
      <stop offset="70%" stop-color=${bt} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${bt} 72%, #5A6474)" />
    </linearGradient>
    <radialGradient id="wxMoonG-${e}" cx="35%" cy="28%" r="85%">
      <stop offset="0%" stop-color="color-mix(in srgb, ${xt} 45%, #FFFFFF)" />
      <stop offset="60%" stop-color=${xt} />
      <stop offset="100%" stop-color="color-mix(in srgb, ${xt} 62%, #4A5AB8)" />
    </radialGradient>
  </defs>`}(s)}${i(function(e){return{sun:`url(#wxSunG-${e})`,cloud:`url(#wxCloudG-${e})`,cloudDk:`url(#wxCloudDkG-${e})`,moon:`url(#wxMoonG-${e})`}}(s),t)}`}const Et=[Ee,ze,a`
  ha-card {
    background: none;
    border: none;
    box-shadow: none;
...
`];customElements.define("materia-weather-tile-editor",class extends He{_formData(){return{show_minmax:!1,size:10,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"icon",label:"Custom icon (overrides the colored glyph)",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}}]},{title:"Min / Max",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show min / max",selector:{boolean:{}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"size",label:"Size (10 = fill)",selector:{number:{min:1,max:10,step:1,mode:"slider"}}},{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / temperature",color:!0,template:!0,selector:{text:{}}},{name:"minmax_color",label:"Min / max color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class At extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedMinmaxColor:{state:!0},_forecast:{state:!0}};static styles=Et;static getConfigElement(){return document.createElement("materia-weather-tile-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,show_minmax:!0}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("minmax_color","_resolvedMinmaxColor"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"";let s=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&(s=e.state)}const n=null!=this._num(s)?`${this._num(s)}°`:"—",a=e=>{const t=e?this.hass.states[e]:null;return t&&!this._isUnavailable(t)?t.state:null};let o=a(this.config.low_entity),r=a(this.config.high_entity);const l=this._forecast?.[0]||e?.attributes?.forecast?.[0];null==o&&null!=l?.templow&&(o=l.templow),null==r&&null!=l?.temperature&&(r=l.temperature);const c=this.config.show_minmax&&(null!=this._num(o)||null!=this._num(r)),h=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,d=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,p=this._isTemplate(this.config.minmax_color)?this._resolvedMinmaxColor:this.config.minmax_color;let u="number"==typeof this.config.tilt?this.config.tilt:{right:-45,left:45,none:0}[this.config.tilt]??-45;this.config.mirror&&(u=-u);const m=this.config.icon_size??(c?34:36),g=this.config.text_size??(c?26:30),f=this.config.minmax_size??5.5,_=this.config.temp_x??5,b=this.config.temp_y??-18,v=this.config.icon_x??-5,y=this.config.icon_y??18,x=this.config.width??100,w=(this.config.height??85)/100,k=(this.config.pill_scale??88)/100,$=`--wt-size:${["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][Math.min(10,Math.max(1,this.config.size??10))-1]};--wt-tilt:${u}deg;--wt-pill-scale:${k};--wt-icon-size:${m}cqi;--wt-temp-size:${g}cqi;--wt-minmax-size:${f}cqi;--wt-width:${x}%;--wt-ratio:${w};--wt-temp-x:${_}cqi;--wt-temp-y:${b}cqi;--wt-icon-x:${v}cqi;--wt-icon-y:${y}cqi;${h?`--wt-bg:${h};`:""}${d?`--wt-fg:${d};`:""}`+(p?`--wt-minmax:${p};--wt-minmax-opacity:1;`:""),C=this.config.icon;return I`
  ...
  `];customElements.define("materia-weather-hero-editor",class extends He{_formData(){return{show_condition:!0,show_icon:!0,show_feels_like:!0,show_minmax:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",label:"Real temperature sensor (optional)",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"feels_like_entity",label:"Feels-like sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"show_condition",label:"Show condition text",selector:{boolean:{}}},{name:"show_icon",label:"Show condition glyph",selector:{boolean:{}}},{name:"show_feels_like",label:"Show feels-like",selector:{boolean:{}}}]},{title:"Night / Day",icon:"mdi:thermometer-lines",fields:[{name:"show_minmax",label:"Show night / day range",selector:{boolean:{}}},{name:"low_entity",label:"Low sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"high_entity",label:"High sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"night_label",label:"Night label",selector:{text:{}}},{name:"day_label",label:"Day label",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});const Ot={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class Ft extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColorOn:{state:!0}};static styles=Mt;static getConfigElement(){return document.createElement("materia-weather-hero-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color_on","_resolvedColorOn"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"",s=Ot[i]||this._capitalize(String(i).replace(/-|_/g," "));let n=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&!this._isUnavailable(e)&&(n=e.state)}const a=this._num(n);let o=e?.attributes?.apparent_temperature;if(this.config.feels_like_entity){const e=this.hass.states[this.config.feels_like_entity];e&&!this._isUnavailable(e)&&(o=e.state)}const r=this._num(o),l=e=>{const t=e?this.hass.states[e]:null;return t&&!this._isUnavailable(t)?t.state:null};let c=l(this.config.low_entity),h=l(this.config.high_entity);const d=this._forecast?.[0]||e?.attributes?.forecast?.[0];null==c&&null!=d?.templow&&(c=d.templow),null==h&&null!=d?.temperature&&(h=d.temperature);const p=this._num(c),u=this._num(h),m=this.config.night_label??ke("wh_night",this.hass),g=this.config.day_label??ke("wh_day",this.hass),f=this.config.separator??"•",_=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on;return I`
      <ha-card>
        <div
        ...
        >
          ${!1!==this.config.show_condition?I`<div class="condition">
                ${!1===this.config.show_icon||t?"":H`<svg class="cond-glyph" viewBox="0 0 24 24">${Tt(i,gt(this.hass,this.config.moon_entity))}</svg>`}
                <span>${t?"—":s}</span>
              </div>`:""}
          <div class="temp">
            <span class="temp-value">${t||null==a?"—":a}</span><span class="temp-deg">°</span>
          </div>
          ${!1===this.config.show_feels_like||null==r||t?"":I`<div class="feels">${this.config.feels_like_label??ke("wh_feels_like",this.hass)} ${r}°</div>`}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}function Dt(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}function qt(e,{locale:t="en",showPrecip:i=!0,minPrecip:s=10,moonPhase:n=null}={}){return e.map(e=>{const a=Dt(e.temperature),o=Dt(e.precipitation_probability),r=new Date(e.datetime),l=Number.isNaN(r.getTime())?"":r.toLocaleTimeString(t,{hour:"numeric"});return I`
      <div class="hour">
        <span class="h-temp">${null!=a?`${a}°`:"—"}</span>
        <svg class="h-glyph" viewBox="0 0 24 24">${Tt(e.condition,n)}</svg>
        ${i&&null!=o&&o>=s?I`<span class="h-precip">${o}%</span>`:I`<span class="h-precip empty"></span>`}
        <span class="h-time">${l}</span>
      </div>
    `})}customElements.define("materia-weather-hero",Ft),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-hero",name:"Materia Weather Hero",description:"Current-conditions hero: condition, huge temperature, feels-like and night/day range.",preview:!0});const Pt=a`
  .hours {
    display: flex;
    gap: 4px;
    overflow-x: auto;
...
`,Rt=[Ee,ze,Te,ge,Pt,a`
  ...
  `];customElements.define("materia-forecast-daily-editor",class extends He{_formData(){return{days:10,show_hourly:!0,show_precipitation:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"days",label:"Days shown",selector:{number:{min:3,max:15,step:1,mode:"slider"}}},{name:"show_hourly",label:"Tap a day to expand its hourly detail",selector:{boolean:{}}},{name:"show_precipitation",label:"Show precipitation chance",selector:{boolean:{}}},{name:"min_precipitation",label:"Hide below (%)",selector:{number:{min:0,max:100,step:5,mode:"box"}}},{name:"today_label",label:"Label for today",selector:{text:{}}}]}]}});class Lt extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_hourly:{state:!0},_selected:{state:!0},_expanded:{state:!0}};static styles=Nt;static getConfigElement(){return document.createElement("materia-forecast-daily-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0,this._selected=0,this._expanded=!1}updated(e){e.has("hass")&&this.hass&&this._subscribeForecast()}connectedCallback(){super.connectedCallback(),this._subscribeForecast()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=null,this._hourly=[],this._hourlyByDay=new Map;const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});if(t.catch(()=>{}),this._fcUnsubs=[t],!1!==this.config.show_hourly){const t=this.hass.connection.subscribeMessage(e=>{this._hourly=e?.forecast||[];const t=new Map;for(const e of this._hourly){const i=this._dayKey(e.datetime);if(!i)continue;const s=t.get(i)||[];s.length<24&&s.push(e),t.set(i,s)}this._hourlyByDay=t},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e});t.catch(()=>{}),this._fcUnsubs.push(t)}}_unsubForecast(){for(const e of this._fcUnsubs||[])e.then(e=>e&&e()).catch(()=>{});this._fcUnsubs=null,this._fcEntity=void 0}_dayKey(e){const t=this.hass?.config?.time_zone;if(!this._dayFmt||this._dayFmtTz!==t){this._dayFmtTz=t;try{this._dayFmt=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"})}catch{this._dayFmt=new Intl.DateTimeFormat("en-CA",{year:"numeric",month:"2-digit",day:"2-digit"})}}const i=new Date(e);return Number.isNaN(i.getTime())?"":this._dayFmt.format(i)}_hoursFor(e){return e?.datetime&&this._hourlyByDay?.size&&this._hourlyByDay.get(this._dayKey(e.datetime))||[]}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}_dayLabel(e,t){const i=new Date(e);if(Number.isNaN(i.getTime()))return"";const s=new Date;if(0===t&&this._dayKey(e)===this._dayKey(s))return this.config.today_label??ke("fc_today",this.hass);const n=this.hass?.locale?.language||navigator.language||"en";return i.toLocaleDateString(n,{weekday:"short"})}_onPointerDown(e){if("mouse"!==e.pointerType)return;const t=e.currentTarget;this._dragStartX=e.clientX,this._dragStartScroll=t.scrollLeft,this._didDrag=!1,this._dragPointerId=e.pointerId}_onPointerMove(e){if(null==this._dragStartX)return;const t=e.clientX-this._dragStartX;!this._didDrag&&Math.abs(t)>4&&(this._didDrag=!0,e.currentTarget.setPointerCapture(this._dragPointerId)),this._didDrag&&(e.currentTarget.scrollLeft=this._dragStartScroll-t)}_onPointerUp(e){null!=this._dragStartX&&(e.currentTarget.releasePointerCapture?.(e.pointerId),this._dragStartX=null,setTimeout(()=>{this._didDrag=!1},0))}_select(e,t){this._didDrag||(this._expanded=e!==this._selected||!this._expanded,this._selected=e,this.dispatchEvent(new CustomEvent("materia-forecast-day-selected",{detail:{index:e,day:t},bubbles:!0,composed:!0})))}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=(this._forecast?.length?this._forecast:e?.attributes?.forecast||[]).slice(0,this.config.days??10);if(!i.length)return I``;const s=!1!==this.config.show_precipitation,n=this.config.min_precipitation??10,a=i[this._selected],o=!1!==this.config.show_hourly&&this._expanded&&a?this._hoursFor(a):[],r=this._expanded&&o.length>0,l=this.hass?.locale?.language||navigator.language||"en";return I`
      <ha-card>
        ...
        >
          ${i.map((e,t)=>{const i=this._num(e.temperature),a=this._num(e.templow),o=this._num(e.precipitation_probability),r=t===this._selected,l=!1!==this.config.show_hourly&&this._hoursFor(e).length>0;return I`
              <button
                class="pill ${r?"selected":""} ${l?"":"static"}"
                @click=${l?()=>this._select(t,e):void 0}
              >
                <span class="hi">${null!=i?`${i}°`:"—"}</span>
                <span class="lo">${null!=a?`${a}°`:"—"}</span>
                <svg class="glyph" viewBox="0 0 24 24">${Tt(e.condition,gt(this.hass,this.config.moon_entity))}</svg>
                ${s&&null!=o&&o>=n?I`<span class="precip">${o}%</span>`:I`<span class="precip empty"></span>`}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-daily",Lt),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-daily",name:"Materia Forecast Daily",description:"Pixel-style daily forecast pill row with colored glyphs and precipitation chance.",preview:!0});customElements.define("materia-forecast-hourly-editor",class extends He{_formData(){return{hours:24,show_header:!0,show_precipitation:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"weather"}}},{name:"moon_entity",label:"Moon phase sensor (default: sensor.moon)",selector:{entity:{domain:"sensor"}}},{name:"name",label:"Header title",selector:{text:{}}},{name:"show_header",label:"Show header",selector:{boolean:{}}},{name:"hours",label:"Hours shown",selector:{number:{min:6,max:48,step:1,mode:"slider"}}},{name:"show_precipitation",label:"Show precipitation chance",selector:{boolean:{}}},{name:"min_precipitation",label:"Hide below (%)",selector:{number:{min:0,max:100,step:5,mode:"box"}}}]}]}});class Ut extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0}};static styles=Rt;static getConfigElement(){return document.createElement("materia-forecast-hourly-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&this._subscribeForecast()}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_onPointerDown(e){if("mouse"!==e.pointerType)return;const t=e.currentTarget;this._dragStartX=e.clientX,this._dragStartScroll=t.scrollLeft,this._captured=!1,this._dragPointerId=e.pointerId}_onPointerMove(e){if(null==this._dragStartX)return;const t=e.clientX-this._dragStartX;!this._captured&&Math.abs(t)>4&&(this._captured=!0,e.currentTarget.setPointerCapture(this._dragPointerId)),this._captured&&(e.currentTarget.scrollLeft=this._dragStartScroll-t)}_onPointerUp(e){null!=this._dragStartX&&(e.currentTarget.releasePointerCapture?.(e.pointerId),this._dragStartX=null)}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=(this._forecast||[]).slice(0,this.config.hours??24);if(!i.length)return I``;const s=this.hass?.locale?.language||navigator.language||"en";return I`
      <ha-card class="${t?"unavailable":""}">
        ...
        <div
          ...
          @pointercancel=${this._onPointerUp}
        >
          ${qt(i,{locale:s,showPrecip:!1!==this.config.show_precipitation,minPrecip:this.config.min_precipitation??10,moonPhase:gt(this.hass,this.config.moon_entity)})}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-forecast-hourly",Ut),window.customCards=window.customCards||[],window.customCards.push({type:"materia-forecast-hourly",name:"Materia Forecast Hourly",description:"Pixel-style hourly forecast strip with colored glyphs and precipitation chance.",preview:!0});const jt=[Ee,ze,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Bt=[{value:"wind",label:"Wind"},{value:"uv",label:"UV index"},{value:"aqi",label:"Air quality"},{value:"pollen",label:"Pollen"},{value:"precipitation",label:"Precipitation"},{value:"sun",label:"Sunrise & sunset"},{value:"visibility",label:"Visibility"},{value:"humidity",label:"Humidity"},{value:"pressure",label:"Pressure"}],It={pollen:{variant:"gauges",max_shown:4}};customElements.define("materia-weather-metric-editor",class extends He{_formData(){return{metric:"wind",...It[this._config?.metric],...this._config}}_sectionsSignature(){return this._config?.metric||""}get _sections(){const e=this._config?.metric,t={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"metric",required:!0,selector:{select:{mode:"dropdown",options:Bt}}},..."sun"!==e&&"pollen"!==e?[{name:"entity",label:"Weather entity",selector:{entity:{domain:"weather"}}},{name:"sensor",label:"Sensor override (optional)",selector:{entity:{domain:"sensor"}}}]:[],{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon (overrides default)",selector:{icon:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"wind"===e&&i.fields.push({name:"unit",label:"Unit (converts from the source)",selector:{select:{mode:"dropdown",options:[{value:"km/h",label:"km/h"},{value:"m/s",label:"m/s"},{value:"mph",label:"mph"},{value:"kn",label:"knots"},{value:"bft",label:"Beaufort"}]}}},{name:"bearing_entity",label:"Bearing sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"from_label",label:'"From" label',selector:{text:{}}}),"humidity"===e&&i.fields.push({name:"dew_entity",label:"Dew point sensor (optional)",selector:{entity:{domain:"sensor"}}},{name:"dew_label",label:"Dew point label",selector:{text:{}}}),"pressure"===e&&i.fields.push({name:"min",label:"Gauge min",selector:{number:{mode:"box"}}},{name:"max",label:"Gauge max",selector:{number:{mode:"box"}}}),"precipitation"===e&&i.fields.push({name:"total_label",label:"Subtitle when raining",selector:{text:{}}},{name:"none_label",label:'"None expected" label',selector:{text:{}}}),"sun"===e&&i.fields.push({name:"sun_entity",label:"Sun entity",selector:{entity:{domain:"sun"}}},{name:"moon_entity",label:"Moon phase sensor (built-in Moon integration)",selector:{entity:{domain:"sensor"}}}),"pollen"===e&&i.fields.push({name:"entities",label:"Pollen sensors",selector:{entity:{domain:"sensor",multiple:!0}}},{name:"variant",label:"Variant",selector:{select:{mode:"dropdown",options:[{value:"gauges",label:"Gauges (wide)"},{value:"small",label:"Small (dot list)"}]}}},{name:"max_shown",label:"Max species shown (worst first)",selector:{number:{min:1,max:6,step:1,mode:"slider"}}},{name:"hide_inactive",label:"Hide species at 'none'",selector:{boolean:{}}},{name:"max",label:"Scale max for numeric sensors (default 4)",selector:{number:{min:1,max:10,mode:"box"}}});const s={title:"Appearance",icon:"mdi:palette-outline",fields:[..."wind"===e?[{name:"shape_color",label:"Shape color",color:!0,template:!0,selector:{text:{}}}]:[],{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},n={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[t,i,s,n]:[t,s,n]}});const Ht="var(--md-sys-cust-color-scale-green, #5E9E50)",Wt="var(--md-sys-cust-color-scale-yellow, #C7A128)",Vt="var(--md-sys-cust-color-scale-orange, #D9713C)",Gt="var(--md-sys-cust-color-scale-red, #C94D42)",Xt="var(--md-sys-cust-color-scale-purple, #8A4DA3)",Yt=[{max:2,label:"Low",color:Ht},{max:5,label:"Moderate",color:Wt},{max:7,label:"High",color:Vt},{max:10,label:"Very high",color:Gt},{max:1/0,label:"Extreme",color:Xt}],Kt=[{max:50,label:"Good air quality",color:Ht},{max:100,label:"Moderate air quality",color:Wt},{max:150,label:"Unhealthy for sensitive groups",color:Vt},{max:200,label:"Unhealthy air quality",color:Gt},{max:300,label:"Very unhealthy air quality",color:Xt},{max:1/0,label:"Hazardous air quality",color:"var(--md-sys-cust-color-scale-maroon, #7A4040)"}],Zt=["None","Low","Moderate","High","Very high"];class Qt extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0}};static styles=jt;static getConfigElement(){return document.createElement("materia-weather-metric-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,metric:"wind"}}setConfig(e){if(!e.metric)throw new Error("metric is required");this.config={...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),"precipitation"!==this.config.metric||this.config.sensor?this._unsubForecast():this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){"precipitation"!==this.config?.metric||this.config.sensor||this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_numRaw(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}_value(e){if(this.config.sensor){const e=this.hass.states[this.config.sensor];return e&&!this._isUnavailable(e)?this._numRaw(e.state):null}const t=this.hass.states[this.config.entity];return this._numRaw(t?.attributes?.[e])}_weatherAttr(e){return this.hass.states[this.config.entity]?.attributes?.[e]}_scallopWave(e){const t=200/12;let i=`M0 ${e+3.2} `;for(let s=0;s<200;s+=t)i+=`Q ${s+t/2} ${e-3.2} ${s+t} ${e+3.2} `;return i+"V100 H0 Z"}render(){if(!this.hass||!this.config)return I``;const e={wind:()=>this._wind(),uv:()=>this._uv(),aqi:()=>this._aqi(),pollen:()=>this._pollen(),precipitation:()=>this._precipitation(),sun:()=>this._sun(),visibility:()=>this._visibility(),humidity:()=>this._humidity(),pressure:()=>this._pressure()}[this.config.metric];if(!e)return I``;const t=e();if(t===V)return I``;const i=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,s=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,n=null!=this.config.size?Math.min(10,Math.max(1,this.config.size)):null;return I`
    ...
    `}_convertWind(e,t,i){const s={"km/h":1,"m/s":3.6,mph:1.609344,kn:1.852,knots:1.852,"ft/s":1.09728};if(!i||i===t)return{v:e,u:t};const n=e*(s[t]??1);if("bft"===i){let e=[1,5,11,19,28,38,49,61,74,88,102,117].findIndex(e=>n<e);return-1===e&&(e=12),{v:e,u:"Bft"}}return{v:n/(s[i]??1),u:i}}_wind(){const e=this._value("wind_speed");if(null==e)return V;const t=this.config.sensor?this.hass.states[this.config.sensor]?.attributes?.unit_of_measurement??"km/h":this._weatherAttr("wind_speed_unit")??"km/h",{v:i,u:s}=this._convertWind(e,t,this.config.unit);let n=this.config.bearing_entity?this._numRaw(this.hass.states[this.config.bearing_entity]?.state):this._numRaw(this._weatherAttr("wind_bearing"));const a=null!=n?`${this.config.from_label??ke("wm_wind_from",this.hass)} ${o=n,["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round((o%360+360)%360/22.5)%16]}`:"";var o;const r=(null!=n?(n+180)%360:0)*Math.PI/180;return I`
      <div class="rect-tile clip wind">
        <svg class="blob-bg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          <path d=${function(e,t,i,s=0){const n=Math.cos(s),a=Math.sin(s),o=lt([{x:.5,y:.892,r:.313},{x:-.216,y:1.05,r:.207},{x:.499,y:-.16,r:.215},{x:1.225,y:1.06,r:.211}].map(e=>({x:e.x*n-e.y*a,y:e.x*a+e.y*n,r:e.r}))),r=[];for(const e of o){const t=Math.atan2(e.T1[1]-e.C[1],e.T1[0]-e.C[0]);let i=Math.atan2(e.T2[1]-e.C[1],e.T2[0]-e.C[0])-t;if(1===e.sweep)for(;i<0;)i+=2*Math.PI;else for(;i>0;)i-=2*Math.PI;for(let s=0;s<=16;s++){const n=t+i*s/16;r.push([e.C[0]+e.rEff*Math.cos(n),e.C[1]+e.rEff*Math.sin(n)])}}let l=0,c=0,h=0;for(let e=0;e<r.length;e++){const[t,i]=r[e],[s,n]=r[(e+1)%r.length],a=t*n-s*i;l+=a,c+=(t+s)*a,h+=(i+n)*a}l/=2,c/=6*l,h/=6*l;const d=Math.max(...r.map(([e,t])=>Math.hypot(e-c,t-h))),p=i/d,u=i=>[e+(i[0]-c)*p,t+(i[1]-h)*p];return ct(o.map(e=>({T1:u(e.T1),T2:u(e.T2),C:u(e.C),rEff:e.rEff*p,sweep:e.sweep})))}(50,50,36,r)} class="blob-fill" />
        </svg>
        <div class="overlay">
          ${this._header("mdi:weather-windy",this.config.name??"Wind")}
          <div class="big">${Math.round(i)}<span class="unit"> ${s}</span></div>
          ${a?I`<div class="sub">${a}</div>`:""}
        </div>
      </div>
    `}_uv(){const e=this._value("uv_index");if(null==e)return V;const t=Yt.find(t=>e<=t.max),i=Yt.map((e,i)=>{const s=(160-35*i)*Math.PI/180,n=50+33*Math.cos(s),a=52+33*Math.sin(s),o=e===t;return H`<circle cx=${n} cy=${a} r=${o?4.5:2.6}
      ...
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          <path d=${ot(50,52,45,12)} class="shape-fill" />
          ${i}
        </svg>
        <div class="overlay">
    ...
    `}_visibility(){const e=this._value("visibility");if(null==e)return this.config.sensor?V:this._hint("mdi:eye-outline",this.config.name??"Visibility","Weather entity has no visibility — add a sensor");const t=this.config.unit??this._weatherAttr("visibility_unit")??"km";return I`
      <div class="shape-tile">
        <svg class="shape" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
          ...
          <path d=${ot(50,52,32,12)} class="shape-fill visibility-fill" />
        </svg>
        <div class="overlay">
    ...
    `}_aqi(){const e=this._value("air_quality_index");if(null==e)return this.config.sensor?V:this._hint("mdi:waves",this.config.name??"Air quality","Point this tile at an AQI sensor");const t=Kt.find(t=>e<=t.max),i=Math.min(.96,Math.max(.04,e/300));return I`
      <div class="rect-tile left">
        ${this._header("mdi:waves",this.config.name??"Air quality")}
        <div class="big">${Math.round(e)}</div>
        <div class="aqi-bar">
          ${Kt.slice(0,5).map(e=>I`<span style="background:${e.color}"></span>`)}
          <span style="background:${Kt[5].color}"></span>
          <i class="aqi-dot" style="left:${(100*i).toFixed(1)}%; border-color:${t.color}"></i>
        </div>
        <div class="sub">${t.label}</div>
      </div>
    `}_precipitation(){let e=null;if(this.config.sensor)e=this._value();else{const t=this._forecast?.[0];e=this._numRaw(t?.precipitation)}if(null==e)return V;const t=this.config.unit??this._weatherAttr("precipitation_unit")??"mm",i=this.config.none_label??ke("wm_no_precip",this.hass),s=e>0?this.config.total_label??ke("wm_total_rain",this.hass):i;return I`
      <div class="rect-tile precip">
        ${this._header("m3o:rainy",this.config.name??"Precipitation")}
        <div class="big">${e}<span class="unit"> ${t}</span></div>
        <div class="precip-bottom">
          <div class="sub">${s}</div>
          ${e>0?H`<svg class="precip-glyph" viewBox="0 0 24 24">${Tt("rainy")}</svg>`:""}
        </div>
      </div>
    `}_humidity(){const e=this._value("humidity");if(null==e)return this.config.sensor?V:this._hint("mdi:water-percent",this.config.name??"Humidity","Weather entity has no humidity — add a sensor");const t=this.config.dew_entity?this._numRaw(this.hass.states[this.config.dew_entity]?.state):this._numRaw(this._weatherAttr("dew_point")),i=100-78*Math.min(1,Math.max(0,e/100)),s=this._scallopWave(i);return I`
      <div class="rect-tile left clip">
        ...
        ${null!=t?I`<div class="dew"><span class="dew-chip">${Math.round(t)}°</span> ${this.config.dew_label??ke("wm_dew_point",this.hass)}</div>`:""}
      </div>
    `}_sun(){const e=this.hass.states[this.config.sun_entity??"sun.sun"];if(!e)return V;const t=e.attributes?.next_rising,i=e.attributes?.next_setting;if(!t||!i)return V;const s=this.hass?.locale?.language||navigator.language||"en",n=e=>new Date(e).toLocaleTimeString(s,{hour:"numeric",minute:"2-digit"}),a=e=>e.getHours()+e.getMinutes()/60,o=a(new Date(t)),r=a(new Date(i)),l=a(new Date),c=(r-o+24)%24||12,h=24-c,d=24,p=e=>e/24*100,u=e=>{const t=(e-o+24)%24;return t<=c?d-17*Math.sin(Math.PI*t/c):d+9*Math.sin(Math.PI*(t-c)/h)},m=(e,t)=>{const i=[];for(let s=e;s<t;s+=.25)i.push(`${p(s).toFixed(2)} ${u(s).toFixed(2)}`);return i.push(`${p(t).toFixed(2)} ${u(t).toFixed(2)}`),i.join(" L")},g=`M${p(o).toFixed(2)} 24 L${m(o,r)} Z`,f=o>.01?`M0 24 L${m(0,o)} Z`:"",_=r<23.99?`M${p(r).toFixed(2)} 24 L${m(r,24)} L100 24 Z`:"",b=(l-o+24)%24<=c,v=p(l),y=u(l),x=this.config.moon_entity??(this.hass.states["sensor.moon_phase"]?"sensor.moon_phase":"sensor.moon"),w=this.hass.states[x],k=gt(this.hass,this.config.moon_entity),$=k??.5;return I`
      <div class="rect-tile sun">
        ...
        <svg class="sun-arc cycle" viewBox="0 0 100 40">
          ...
          <line x1="0" y1=${d} x2="100" y2=${d} class="horizon" />
          ${b?H`<path d=${function(e,t,i,s=12,n=.1*i,a=0){const o=Math.max(8*s,48),r=[];for(let l=0;l<o;l++){const c=l/o*Math.PI*2,h=i+n*Math.cos(s*c+a);r.push([e+h*Math.cos(c),t+h*Math.sin(c)])}let l=`M${r[0][0].toFixed(2)} ${r[0][1].toFixed(2)} `;for(let e=0;e<o;e++){const t=r[(e-1+o)%o],i=r[e],s=r[(e+1)%o],n=r[(e+2)%o],a=i[0]+(s[0]-t[0])/6,c=i[1]+(s[1]-t[1])/6,h=s[0]-(n[0]-i[0])/6,d=s[1]-(n[1]-i[1])/6;l+=`C${a.toFixed(2)} ${c.toFixed(2)} ${h.toFixed(2)} ${d.toFixed(2)} ${s[0].toFixed(2)} ${s[1].toFixed(2)} `}return l+"Z"}(v,y,5.5,9,.6)} fill="var(--md-sys-cust-color-weather-sun, #FFC83D)" />`:H`
                <circle cx=${v.toFixed(2)} cy=${y.toFixed(2)} r="4.6" class="moon-dark" />
                ${mt(v,y,4.6,$)?H`<path d=${mt(v,y,4.6,$)} class="moon-lit" />`:""}
              `}
        </svg>
        <div class="sun-times">
          <div><ha-icon icon="mdi:weather-sunset-up"></ha-icon> ${n(t)}</div>
          <div><ha-icon icon="mdi:weather-sunset-down"></ha-icon> ${n(i)}</div>
    ...
    `}_pollen(){const e={none:{v:0,label:"None",color:"var(--md-sys-color-outline, #9E9E9E)"},active:{v:1,label:"Active",color:Ht},green:{v:1,label:"Low",color:Ht},yellow:{v:2,label:"Moderate",color:Wt},orange:{v:3,label:"High",color:Vt},red:{v:4,label:"Very high",color:Gt},purple:{v:5,label:"Extreme",color:Xt}},t=this.config.max??4;let i=this.config.entities;i?.length||(i=[this.config.grass_entity&&{entity:this.config.grass_entity,label:this.config.grass_label??"Grass",icon:"mdi:grass"},this.config.tree_entity&&{entity:this.config.tree_entity,label:this.config.tree_label??"Tree",icon:"mdi:tree-outline"},this.config.weed_entity&&{entity:this.config.weed_entity,label:this.config.weed_label??"Weed",icon:"mdi:sprout-outline"}].filter(Boolean));const s=(i||[]).map(i=>{const s="string"==typeof i?{entity:i}:i,n=this.hass.states[s.entity];if(!n||this._isUnavailable(n))return null;const a=String(n.state).toLowerCase();let o,r,l;if(a in e){const t=e[a];o=t.v/5,r=t.label,l=t.color}else{const e=this._numRaw(a);if(null==e)return null;o=Math.min(1,Math.max(0,e/t)),r=`${e}/${t} ${Zt[Math.min(Zt.length-1,Math.round(o*(Zt.length-1)))]}`,l=null}let c=s.label;if(!c){const e=n.attributes.friendly_name||s.entity,t=e.replace(/pollen/i,"").trim().split(/\s+/);c=t[t.length-1]||e}return{label:c,icon:s.icon||n.attributes.icon||"m3of:allergy",frac:o,levelLabel:r,color:l}}).filter(Boolean).filter(e=>!this.config.hide_inactive||e.frac>0).sort((e,t)=>t.frac-e.frac).slice(0,this.config.max_shown??4);if(!s.length){return this.config.entities?.length||this.config.grass_entity||this.config.tree_entity||this.config.weed_entity?V:this._hint("m3of:allergy",this.config.name??"Pollen","Add pollen sensors")}return"small"===this.config.variant?I`
          ...
          ${s.map(e=>I`
              <div class="gauge">
                <svg viewBox="0 0 100 86">
                  <path d=${ut(50,50,40,-135,135)} class="gauge-track" />
                  ${e.frac>.01?H`<path d=${ut(50,50,40,-135,270*e.frac-135)} class="gauge-fill" style="stroke:${e.color||"var(--wm-accent, #7bc96a)"}" />`:""}
                </svg>
  ...
  `],customElements.define("materia-weather-glance-editor",ti);const ii={"clear-night":"Clear night",partlycloudy:"Partly cloudy",partly_cloudy:"Partly cloudy","lightning-rainy":"Thunderstorm","snowy-rainy":"Sleet",exceptional:"Exceptional"};class si extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_forecast:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedAlert:{state:!0}};static styles=Jt;static getConfigElement(){return document.createElement("materia-weather-glance-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("weather."))||"";return{entity:t,metrics:["minmax"]}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={metrics:["minmax"],...e},this._fcEntity=void 0}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("alert","_resolvedAlert"),this._subscribeForecast())}connectedCallback(){super.connectedCallback(),this._resubOnConnect()}disconnectedCallback(){super.disconnectedCallback(),this._unsubForecast()}_resubOnConnect(){this._subscribeForecast()}_subscribeForecast(){const e=this.config?.entity;if(!this.hass||!e||this._fcEntity===e)return;this._unsubForecast(),this._fcEntity=e,this._forecast=[];const t=this.hass.connection.subscribeMessage(e=>{this._forecast=e?.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:e});this._fcUnsub=t,t.catch(()=>{})}_unsubForecast(){this._fcUnsub&&(this._fcUnsub.then(e=>e&&e()).catch(()=>{}),this._fcUnsub=null),this._fcEntity=void 0}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?Math.round(t):null}_metricData(e,t){const i=t?.attributes||{},s=this._forecast?.[0]||i.forecast?.[0];let n=null,a=0;switch(e.type){case"condition":{const e=t?.state??"";n=ii[e]||this._capitalize(String(e).replace(/-|_/g," ")),/lightning/.test(e)?a=3:/pouring|snowy|hail/.test(e)?a=2:/rainy|fog|windy/.test(e)&&(a=1);break}case"minmax":{const e=this._num(s?.temperature),t=this._num(s?.templow);if(null==e&&null==t)return null;n=`${null!=e?`${e}°`:"—"} ${null!=t?`${t}°`:"—"}`;break}case"wind":{const e=this._num(i.wind_speed);if(null==e)return null;const t=this._num(i.wind_bearing);n=`${e} ${i.wind_speed_unit??"km/h"}${null!=t?` ${o=t,["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round((o%360+360)%360/22.5)%16]}`:""}`,a=e>=88?4:e>=62?3:e>=39?2:e>=20?1:0;break}case"humidity":{const e=this._num(i.humidity);if(null==e)return null;n=`${e}%`,a=e>=85||e<=20?2:e>=70||e<=30?1:0;break}case"uv":{const e=this._num(i.uv_index);if(null==e)return null;n=`UV ${e}`,a=e>=11?4:e>=8?3:e>=6?2:e>=3?1:0;break}case"precipitation":{const t=s?.precipitation,o=null==t?null:Number(t);if(null==o||!Number.isFinite(o))return null;n=`${e.label??ke("wg_rain",this.hass)} ${o} ${i.precipitation_unit??"mm"}`,a=o>=10?3:o>=2?2:o>0?1:0;break}case"pressure":{const e=this._num(i.pressure);if(null==e)return null;n=`${e} ${i.pressure_unit??"hPa"}`,a=Math.abs(e-1013)>=25?2:Math.abs(e-1013)>=15?1:0;break}case"pollen":{const t={none:0,active:1,green:1,yellow:2,orange:3,red:4,purple:5},i=["None","Low","Low","Moderate","High","Very high","Extreme"],s=e.entities||this.config.pollen_entities||[];let o=null;for(const e of s){const i=this.hass.states[e];if(!i||this._isUnavailable(i))continue;const s=t[String(i.state).toLowerCase()]??this._num(i.state)??0;if(!o||s>o.v){const t=i.attributes.friendly_name||e,n=t.replace(/pollen/i,"").trim().split(/\s+/);o={v:s,label:n[n.length-1]||t}}}if(!o)return null;const r=e.label??this.config.pollen_label??ke("wm_pollen",this.hass);n=0===o.v?this.config.no_pollen_label??`${r} none`:`${r} ${o.label} ${i[o.v+1]??o.v}`,a=o.v;break}case"aqi":{const t=e.entity??this.config.aqi_entity,i=t?this.hass.states[t]:null;if(!i||this._isUnavailable(i))return null;const s=this._num(i.state);if(null==s)return null;n=`AQI ${s}`,a=s>200?4:s>150?3:s>100?2:s>50?1:0;break}case"sensor":{const t=e.entity?this.hass.states[e.entity]:null;if(!t||this._isUnavailable(t))return null;const i=e.unit??t.attributes.unit_of_measurement??"";n=`${e.label?`${e.label} `:""}${t.state}${i?` ${i}`:""}`;break}default:return null}var o;null!=e.severity&&(a=Number(e.severity)||0);return{text:n,sev:a,icon:e.icon??(this.config.show_metric_icons?{minmax:"mdi:thermometer",wind:"mdi:weather-windy",humidity:"mdi:water-percent",uv:"mdi:white-balance-sunny",precipitation:"m3o:rainy",pressure:"mdi:gauge",pollen:"m3of:allergy",aqi:"mdi:waves",sensor:"mdi:information-outline"}[e.type]:null),type:e.type}}_metricItems(e){const t=this.config.priority??["precipitation","pollen","aqi"],i=e=>{const i=t.indexOf(e);return-1===i?0:(t.length-i)/(t.length+1)},s=(this.config.metrics||[]).map(e=>"string"==typeof e?{type:e}:e).filter(e=>"condition"!==e.type),n=s.map(t=>this._metricData(t,e)).filter(Boolean);return this.config.sort_by_severity&&n.sort((e,t)=>t.sev+i(t.type)-(e.sev+i(e.type))),n}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=e?.state??"";let s=e?.attributes?.temperature;if(this.config.temperature_entity){const e=this.hass.states[this.config.temperature_entity];e&&!this._isUnavailable(e)&&(s=e.state)}const n=this._num(s),a=this._isTemplate(this.config.alert)?this._resolvedAlert:this.config.alert,o=a?null:this._metricData({type:"condition"},e),r=this.config.max_metrics??1/0,l=this._metricItems(e).slice(0,r),c=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,h=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,d=this.config.show_chevron??"navigate"===this.config.tap_action?.action,p=e=>I`<span class="m">
      ${e.icon?I`<ha-icon .icon=${e.icon}></ha-icon>`:""}${e.text}
    </span>`;return I`
      <ha-card>
        <div
          class="glance ${t?"unavailable":""}"
          style="${c?`--wg-bg:${c};`:""}${h?`--wg-fg:${h};`:""}"
          @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info"})}
        >
          <svg class="glyph" viewBox="0 0 24 24">${Tt(i,gt(this.hass,this.config.moon_entity))}</svg>
          <div class="mid">
            ${a||o?I`<div class="line1">
                  ${a?I`<ha-icon icon="mdi:alert-outline"></ha-icon>`:""}
                  ${a?I`<span>${a}</span>`:p(o)}
                </div>`:""}
          ...
          <div class="now">${t||null==n?"—":`${n}°`}</div>
          ${d?I`<ha-icon class="chev" icon="mdi:chevron-right"></ha-icon>`:""}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:1.5}}getCardSize(){return 2}}customElements.define("materia-weather-glance",si),window.customCards=window.customCards||[],window.customCards.push({type:"materia-weather-glance",name:"Materia Weather Glance",description:"Weather pill for the home screen: glyph, configurable metric lines or an alert, big temperature.",preview:!0});const ni=[Ee,ze,Te,ge,a`
    ha-card {
      border-radius: 24px;
      padding: 16px 20px;
  ...
  `];customElements.define("materia-list-editor",class extends He{get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"title",label:"Title",selector:{text:{}}},{name:"icon",label:"Header icon",selector:{icon:{}}},{name:"entities",label:"Entities (rows)",selector:{entity:{multiple:!0}}}]}]}});class ai extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0}};static styles=ni;static getConfigElement(){return document.createElement("materia-list-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("sensor."))||"";return{entities:t?[t]:[]}}setConfig(e){if(!e.entities?.length)throw new Error("Materia List: add at least one entity");this.config={...e}}_rowState(e,t){if(!t)return"—";if(e.attribute){const i=t.attributes?.[e.attribute];return null==i?"—":`${i}${e.unit?` ${e.unit}`:""}`}if(this._isUnavailable(t))return this.hass.formatEntityState?.(t)??t.state;if(e.unit){const i=Number(t.state);return Number.isFinite(i)?`${i} ${e.unit}`:t.state}return this.hass.formatEntityState?.(t)??t.state}render(){if(!this.hass||!this.config)return I``;const e=(this.config.entities||[]).map(e=>"string"==typeof e?{entity:e}:e);return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1+(this.config?.entities?.length||0)}}function oi(e,t){return!(!Array.isArray(e)||0===e.length)&&e.every(e=>li(e,t))}function ri(e){return Array.isArray(e)?e:null==e?[]:[e]}function li(e,t){if(!e||"object"!=typeof e)return!1;switch(e.condition??"state"){case"state":{if(!e.entity)return!1;const i=t?.states?.[e.entity],s=e.attribute?i?.attributes?.[e.attribute]:i?.state,n=null==s?"":String(s);return null!=e.state?ri(e.state).map(String).includes(n):null!=e.state_not&&!ri(e.state_not).map(String).includes(n)}case"numeric_state":{if(!e.entity)return!1;const i=t?.states?.[e.entity],s=Number(e.attribute?i?.attributes?.[e.attribute]:i?.state);if(!Number.isFinite(s))return!1;const n=e=>Number("string"==typeof e&&t?.states?.[e]?t.states[e].state:e);return(null==e.above||s>n(e.above))&&((null==e.below||s<n(e.below))&&(null!=e.above||null!=e.below))}case"screen":return!!e.media_query&&window.matchMedia(e.media_query).matches;case"user":return ri(e.users).includes(t?.user?.id);case"and":return ri(e.conditions).every(e=>li(e,t));case"or":return ri(e.conditions).some(e=>li(e,t));case"not":return ri(e.conditions).length>0&&!ri(e.conditions).some(e=>li(e,t));default:return!1}}customElements.define("materia-list",ai),window.customCards=window.customCards||[],window.customCards.push({type:"materia-list",name:"Materia List",description:"Entity rows with localized states — name left, value right, optional header.",preview:!0});const ci=e=>class extends e{get _disabledByCondition(){const e=this.config?.disabled_when??this.config?.disabled;return Array.isArray(e)&&oi(e,this.hass)}willUpdate(e){super.willUpdate?.(e),this.toggleAttribute("card-disabled",this._disabledByCondition)}},hi=a`
  :host([card-disabled]) {
    opacity: 0.38;
    pointer-events: none;
  }
`,di=[Ee,ze,Te,ge,a`
  ...
  `],yi=[{value:"percent",label:"Percent (filling cookie)"},{value:"battery",label:"Battery (vertical bar)"},{value:"temperature",label:"Temperature (thermometer)"},{value:"power",label:"Power (load bars)"},{value:"energy",label:"Energy"},{value:"binary",label:"On/off (spinning star)"},{value:"plain",label:"Plain value"},{value:"vacuum",label:"Robot vacuum (state + room + battery bar)"},{value:"fill",label:"Gauge · tile floods to the value"},{value:"bar",label:"Gauge · value over a track"},{value:"ladder",label:"Gauge · ladder of bars"},{value:"ring",label:"Gauge · ring beside the value"},{value:"status",label:"Status row (tonal, icon badge + state)"},{value:"scale",label:"Gauge · position on a ramp, with reference marks"},{value:"spark",label:"History · area sparkline hero"},{value:"sparkline",label:"History · bare line"},{value:"weekbars",label:"History · a bar per day"},{value:"events",label:"History · event ticks (tonal row)"}],xi=["spark","sparkline","weekbars","events"],wi=["weekbars","events"],ki=["fill","bar","ladder","ring","scale"];customElements.define("materia-glance-tile-editor",class extends He{_formData(){const e=this._config?.variant;return{variant:"percent",..."percent"===e?{critical_dry:10,dry_below:20,soggy_above:60,dry_label:"Needs water now",soon_label:"Water soon",optimal_label:"Optimal",wet_label:"Overwatered"}:"power"===e?{max:3e3,bars:5}:"ladder"===e?{bars:5}:"status"===e?{dots:4}:"spark"===e||"sparkline"===e?{hours:24,points:48,history_refresh:5,show_delta:"spark"===e}:"weekbars"===e||"events"===e?{days:3,aggregate:"delta",history_refresh:5}:{},...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){const e=this._config?.variant,t={title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"variant",label:"Category",required:!0,selector:{select:{mode:"dropdown",options:yi}}},{name:"name",label:"Title",selector:{text:{}}},{name:"icon",label:"Icon (overrides entity icon)",selector:{icon:{}}},{name:"label",label:"Subtitle",selector:{text:{}}}]},i={title:"Options",icon:"mdi:tune",fields:[]};"temperature"===e&&i.fields.push({name:"min",label:"Scale min (default 10°)",selector:{number:{mode:"box"}}},{name:"max",label:"Scale max (default 30°)",selector:{number:{mode:"box"}}}),"power"===e&&i.fields.push({name:"max",label:"Full-load watts (default 3000)",selector:{number:{mode:"box"}}},{name:"bars",label:"Number of bars (default 5)",selector:{number:{min:2,max:40,mode:"box"}}}),ki.includes(e)&&i.fields.push({name:"min",label:"Scale min (default: the entity's min attribute, else 0)",selector:{number:{mode:"box",step:"any"}}},{name:"max",label:"Scale max (default: the entity's max attribute, else 100 for a %)",helper:"Without a max the gauge cannot be calibrated and the tile falls back to a plain value.",selector:{number:{mode:"box",step:"any"}}},{name:"caption",label:"Caption under the gauge",helper:"Your sentence, in your language. Placeholders: {value} {min} {max} {unit} {percent}. Jinja templates work too. Empty shows the bare top of the scale.",template:!0,selector:{text:{}}},{name:"precision",label:"Decimal places (default: at most 1)",selector:{number:{min:0,max:6,mode:"box"}}}),"ladder"===e&&i.fields.push({name:"bars",label:"Number of bars (default 5)",selector:{number:{min:2,max:40,mode:"box"}}}),"scale"===e&&i.fields.push({name:"good",label:"Which end is good",helper:"Left empty the ramp is a neutral track and the card passes no judgement — the value's position and the reference marks still show. Set it and the ramp runs through the severity scale in that direction. Never inferred from the entity.",selector:{select:{mode:"dropdown",options:[{value:"low",label:"Low values are good (consumption, latency)"},{value:"high",label:"High values are good (efficiency, signal)"}]}}},{name:"min_label",label:"Label at the low end",helper:"Your words. Placeholders: {bound} {unit} {value} {min} {max}. Empty shows the bare bound.",template:!0,selector:{text:{}}},{name:"max_label",label:"Label at the high end",helper:"Same placeholders. Empty shows the bare bound.",template:!0,selector:{text:{}}},{name:"show_delta",label:"Show the change pill",helper:"Fetches history only when switched on, since a change needs a window to measure over.",selector:{boolean:{}}}),"status"===e&&i.fields.push({name:"active_state",label:"State(s) that count as active",helper:'Comma-separated. Left empty it is derived from the domain (cover open, vacuum cleaning, media_player playing…), falling back to "on" — so a sensor reading "Connected" needs it spelled out here.',selector:{text:{}}},{name:"dots",label:"Indicator dots (default 4)",helper:"Filled to the value when the entity has a scale; otherwise they pulse while it is active.",selector:{number:{min:2,max:12,mode:"box"}}}),"plain"===e&&i.fields.push({name:"battery_entity",label:"Paired battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"vacuum"===e&&i.fields.push({name:"status_entity",label:"Detailed status sensor (shown as the state)",selector:{entity:{domain:"sensor"}}},{name:"room_entity",label:"Current room sensor (shown while cleaning)",selector:{entity:{domain:"sensor"}}},{name:"battery_entity",label:"Battery sensor (adds the vertical bar)",selector:{entity:{domain:"sensor"}}}),"percent"===e&&i.fields.push({name:"critical_dry",label:"Critical dry, ≤% (default 10 — red)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_below",label:"Water soon, ≤% (default 20 — orange)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"soggy_above",label:"Overwatered, >% (default 60 — blue)",selector:{number:{min:0,max:100,mode:"box"}}},{name:"dry_label",label:'"Needs water now" label',selector:{text:{}}},{name:"soon_label",label:'"Water soon" label',selector:{text:{}}},{name:"optimal_label",label:'"Optimal" label',selector:{text:{}}},{name:"wet_label",label:'"Overwatered" label',selector:{text:{}}}),xi.includes(e)&&(wi.includes(e)?i.fields.push({name:"days",label:"Days of history (default 3)",helper:"Kept short on purpose: a window longer than your recorder keeps returns nothing at all, not a shorter series. Days with no data are simply not drawn.",selector:{number:{min:1,max:90,mode:"box"}}},{name:"aggregate",label:"What each bar measures (default: change)",helper:"change = how much the value moved that day (counters). mean/min/max/sum/count for measurements.",selector:{select:{mode:"dropdown",options:[{value:"delta",label:"Change across the day"},{value:"mean",label:"Average"},{value:"min",label:"Minimum"},{value:"max",label:"Maximum"},{value:"sum",label:"Sum of samples"},{value:"count",label:"Number of samples"}]}}}):i.fields.push({name:"hours",label:"Hours of history (default 24)",helper:"A window longer than your recorder keeps returns nothing at all.",selector:{number:{min:1,max:2160,mode:"box"}}},{name:"points",label:"Points plotted (default 48)",selector:{number:{min:2,max:400,mode:"box"}}},{name:"show_delta",label:"Show the change pill",selector:{boolean:{}}},{name:"delta_label",label:"Change pill text",helper:"Placeholders: {delta} {delta_pct} {from} {to} {unit} {hours} {days}. Empty shows just the signed change.",template:!0,selector:{text:{}}}),i.fields.push({name:"caption",label:"Caption",helper:"Your words. Placeholders: {value} {unit} {hours} {days} {buckets}. Jinja templates work too.",template:!0,selector:{text:{}}},{name:"history_refresh",label:"Refresh every N minutes (default 5)",helper:"History is polled on this interval, never on every state change.",selector:{number:{min:1,max:180,mode:"box"}}}));const s={title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Accent color (fill / bars / star)",color:!0,selector:{text:{}}},{name:"color",label:"Tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text color",color:!0,template:!0,selector:{text:{}}}]},n={title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]};return i.fields.length?[t,i,s,n]:[t,s,n]}});const $i="var(--md-sys-cust-color-weather-rain, #5fa8f5)",Ci="var(--md-sys-cust-color-scale-green, #5E9E50)",Si="var(--md-sys-cust-color-scale-yellow, #C7A128)",zi="var(--md-sys-cust-color-scale-orange, #D9713C)",Ti="var(--md-sys-cust-color-scale-red, #C94D42)",Ei=["on","open","running","playing","heat","heating","home","true","active"],Ai=new Set(["spark","sparkline","weekbars","events"]);class Mi extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedLabel:{state:!0},_resolvedCaption:{state:!0},_resolvedDeltaLabel:{state:!0},_resolvedMinLabel:{state:!0},_resolvedMaxLabel:{state:!0},_hist:{state:!0}};static styles=vi;static getConfigElement(){return document.createElement("materia-glance-tile-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("sensor."))||"";return{entity:t,variant:"percent"}}setConfig(e){if(!e.entity)throw new Error("Materia Glance Tile: entity is required");if(!e.variant)throw new Error("Materia Glance Tile: variant is required — pick the value category");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("label","_resolvedLabel"),this._resolveField("caption","_resolvedCaption"),this._resolveField("delta_label","_resolvedDeltaLabel"),this._resolveField("min_label","_resolvedMinLabel"),this._resolveField("max_label","_resolvedMaxLabel"),(Array.isArray(this.config.markers)?this.config.markers:[]).forEach((e,t)=>this._resolveTemplateValue(`marker_${t}`,e?.label)),this._loadHistory())}get _label(){return this._isTemplate(this.config.label)?this._resolvedLabel:this.config.label}get _stateObj(){return this.hass?.states[this.config.entity]}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}get _unit(){return this.config.unit??this._stateObj?.attributes?.unit_of_measurement??""}get _name(){return this.config.name??this._stateObj?.attributes?.friendly_name??this.config.entity}_icon(e){return this.config.icon||this._stateObj?.attributes?.icon||e}get _variant(){return this.config.variant}_fmtState(){const e=this._stateObj;return this.hass.formatEntityState?.(e)??e.state}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e||this._isUnavailable(e))return I`<ha-card><div class="rect-tile unavailable">
      ...
      </div></ha-card>`;const t={percent:()=>this._percent(),battery:()=>this._battery(),temperature:()=>this._temperature(),power:()=>this._ladder({power:!0}),ladder:()=>this._ladder({}),fill:()=>this._fill(),bar:()=>this._bar(),ring:()=>this._ring(),status:()=>this._status(),scale:()=>this._scale(),spark:()=>this._spark({area:!0}),sparkline:()=>this._spark({area:!1}),weekbars:()=>this._bucketBars({events:!1}),events:()=>this._bucketBars({events:!0}),energy:()=>this._energy(),binary:()=>this._binary(),plain:()=>this._plain(),vacuum:()=>this._vacuum()},i=(t[this._variant]||t.plain)(),s=this._isTemplate(this.config.color)?this._resolvedColor:this.config.color,n=this._isTemplate(this.config.color_on)?this._resolvedColorOn:this.config.color_on,a=null!=this.config.size?Math.min(10,Math.max(1,this.config.size)):null,o=null!=a?["120px","150px","185px","225px","270px","320px","380px","460px","560px","none"][a-1]:"200px";return I`
      <ha-card
        style="--ms-size:${o};${null!=a?`--ms-size-row:${o};`:""}${s?`--ms-color:${s};`:""}${n?`--ms-color-on:${n};`:""}${this.config.accent?`--ms-accent:${this.config.accent};`:""}"
        @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info",entity:this.config.entity})}
      >
        ${i}
      </ha-card>
    `}_header(e){return I`<div class="header"><ha-icon icon=${this._icon(e)}></ha-icon><span>${this._name}</span></div>`}_moistureZone(e){const t=this.config.critical_dry??10,i=this.config.dry_below??20,s=this.config.soggy_above??60;return e<=t?{fill:Ti,status:this.config.dry_label??ke("gt_needs_water_now",this.hass)}:e<=i?{fill:zi,status:this.config.soon_label??ke("gt_water_soon",this.hass)}:e<=s?{fill:Ci,status:this.config.optimal_label??ke("gt_optimal",this.hass)}:{fill:$i,status:this.config.wet_label??ke("gt_overwatered",this.hass)}}_percent(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=Math.min(1,Math.max(0,e/100)),i=this._stateObj.attributes.device_class,s="moisture"===i;let n=null,a=null;if("battery"===i)n=t>.4?Ci:t>.15?zi:Ti;else if(s){const t=this._moistureZone(e);n=t.fill,a=t.status}else"humidity"===i&&(n=$i);n&&(n=`color-mix(in srgb, ${n} 30%, transparent)`);const o=100-100*t,r="humidity"===i||s;let l;if(r){let e=`M-100 ${o.toFixed(1)}`;for(let t=-100;t<100;t+=25){e+=` Q ${t+12.5} ${(o+(t/25%2==0?-1.6:1.6)).toFixed(1)} ${t+25} ${o.toFixed(1)}`}l=e+" V102 H-100 Z"}else l=`M-2 ${o+2.5} Q 50 ${o-2.5} 102 ${o+2.5} V102 H-2 Z`;const c="battery"===i?"mdi:battery":s?"mdi:sprout":"mdi:water-percent";return I`
      <div class="rect-tile clip">
        <svg class="fill-bg" viewBox="0 0 100 100" preserveAspectRatio="none">
          ${t>.005?H`<path d=${l}
                class="level-fill ${r?"drift":""}" style=${n?`fill:${n}`:""} />`:""}
        </svg>
        <div class="overlay">
          ${this._header(c)}
          <div class="big">${Math.round(e)}<span class="unit">%</span></div>
          ${this._label??a?I`<div class="sub">${this._label??a}</div>`:""}
        </div>
      </div>
    `}_tempColor(e,t){const i="°F"===t?5*(e-32)/9:e;return i<16?$i:i<23?Ci:i<27?zi:Ti}_temperature(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=this._unit||"°C",i=this.config.min??("°F"===t?50:10),s=this.config.max??("°F"===t?86:30),n=Math.min(1,Math.max(0,(e-i)/(s-i))),a=this._tempColor(e,t);return I`
      <div class="rect-tile left">
        ...
        <div class="split-row">
          ...
          <div class="thermo">
            <i style="height:${Math.max(8,100*n)}%;background:${a}"></i>
          </div>
        </div>
      </div>
    `}_batteryColor(e){return e>.4?Ci:e>.15?zi:Ti}_battery(){const e=this._num(this._stateObj.state);if(null==e)return this._plain();const t=Math.min(1,Math.max(0,e/100)),i=this._batteryColor(t);return I`
      <div class="rect-tile left">
    ...
    `:this._plain()}_ladder(e={}){const t=this._gauge(e.power?Mi._POWER_PRESET:null);if(!t)return this._plain();const i=Math.max(2,Math.min(40,Math.round(this._num(this.config.bars)??5))),s=Math.max(0,Math.min(i,Math.ceil(t.frac*i)));return I`
      <div class="rect-tile left gauge">
    ...
    `}_valueRow(e,t=V){return I`<div class="value-row">${this._gaugeValueLine(e)}${t}</div>`}_rampGradient(e){const t=(e||[]).filter(e=>e&&e.color);if(!t.length)return null;const i=[];let s=0;return t.forEach((e,n)=>{const a=this._num(e.below),o=null==a?100:Math.max(s,Math.min(100,a)),r=(s+o)/2;0===n&&i.push(`${e.color} 0%`),i.push(`${e.color} ${r.toFixed(1)}%`),n===t.length-1&&i.push(`${e.color} 100%`),s=o}),`linear-gradient(90deg, ${i.join(", ")})`}_scaleRamp(){const e=this._rampGradient(this.config.ramp);if(e)return e;const t=String(this.config.good??"").toLowerCase();if("low"!==t&&"high"!==t)return null;const i="low"===t?[Ci,Si,Ti]:[Ti,Si,Ci];return`linear-gradient(90deg, ${i[0]} 0%, ${i[1]} 55%, ${i[2]} 100%)`}_scaleMarkers(e){const t=Array.isArray(this.config.markers)?this.config.markers:[],i=[];return t.forEach((t,s)=>{const n=t?.value;let a=this._num(n);if(null==a&&"string"==typeof n&&n.includes(".")&&(a=this._num(this.hass?.states?.[n]?.state)),null==a)return;const o=Math.min(1,Math.max(0,(a-e.min)/(e.max-e.min))),r={marker:this._fmtNum(a),unit:e.unit??""},l=t?.label;let c="";null!=l&&""!==l&&(c=this._isTemplate(l)?this._interpolate(this._tplResults?.[`marker_${s}`]??"",e,r):this._interpolate(l,e,r)),i.push({frac:o,label:c,color:t?.color})}),i}_endLabel(e,t,i,s){const n=this.config[e];if(null==n||""===n)return this._fmtNum(i);const a=this._isTemplate(n)?this[t]:n;return null==a?"":this._interpolate(a,s,{bound:this._fmtNum(i),unit:s.unit??""})}_scale(){const e=this._gauge();if(!e)return this._plain();const t=this._scaleRamp(),i=this._scaleMarkers(e),s=this.config.show_delta?this._deltaPill(this._histSeries):V,n=e=>`${(100*e).toFixed(3)}%`;return I`
      <div class="rect-tile left gauge scale-tile">
        ...
        <div class="ramp" style=${t?`background:${t}`:V}>
          ${i.map(e=>I`<i
                class="ref"
                style="left:${n(e.frac)}${e.color?`;--ref-color:${e.color}`:""}"
              ></i>`)}
          <i class="here" style="left:${n(e.frac)}"></i>
        </div>
        <div class="scale-labels">
          <span class="lo">${this._endLabel("min_label","_resolvedMinLabel",e.min,e)}</span>
          ${i.map(e=>e.label?I`<span class="ref-label" style="left:${n(e.frac)}">${e.label}</span>`:V)}
          <span class="hi">${this._endLabel("max_label","_resolvedMaxLabel",e.max,e)}</span>
        </div>
      </div>
    `}_status(){const e=function(e,t){if(!e)return!1;const i=String(e.state);if(mi.has(i.toLowerCase()))return!1;const s=(e,t)=>String(e).toLowerCase()===String(t).toLowerCase();if(null!=t&&""!==t){const e=Array.isArray(t)?t:String(t).split(",").map(e=>e.trim()).filter(Boolean);return e.some(e=>s(e,i))}const n=String(e.entity_id||"").split(".")[0],a=ui[n]??"on";return(Array.isArray(a)?a:[a]).some(e=>s(e,i))}(this._stateObj,this.config.active_state),t=Math.max(2,Math.min(12,Math.round(this._num(this.config.dots)??4))),i=this._gauge(),s=i?Math.max(0,Math.min(t,Math.ceil(i.frac*t))):e?t:0;return I`
    ...
    `}_binary(){const e=Ei.includes(this._stateObj.state),t=rt(50,50,46,{vertices:8,innerRadius:.8,rounding:.15,rotate:-Math.PI/2});return I`
    ...
    `}_fmtObj(e){return this.hass.formatEntityState?.(e)??e.state}_vacuum(){const e="cleaning"===this._stateObj.state,t=this.config.status_entity?this.hass.states[this.config.status_entity]:null,i=t?this._fmtObj(t):this._fmtState(),s=this.config.room_entity?this.hass.states[this.config.room_entity]:null,n=e&&s?this._fmtObj(s):"",a=this.config.battery_entity?this.hass.states[this.config.battery_entity]:null,o=a?this._num(a.state):null,r=null!=o?Math.min(1,Math.max(0,o/100)):null,l=null!=r?this._batteryColor(r):null;return I`
    ...
    `}get _histHours(){if("weekbars"===this._variant||"events"===this._variant){const e=this._num(this.config.days)??3;return 24*Math.max(1,Math.min(90,Math.round(e)))}return Math.max(1,Math.min(2160,Math.round(this._num(this.config.hours)??24)))}get _needsHistory(){return Ai.has(this._variant)||!0===this.config?.show_delta}get _histSeries(){return function(e,t,i=Date.now()){const s=e||[],n=t?.state;if(null==n||gi.has(String(n).toLowerCase()))return s;const a=Number(n);if(!Number.isFinite(a))return s;const o=fi({lu:t.last_changed??t.last_updated});if(null==o)return s;const r=Math.min(o,i),l=s[s.length-1];if(l&&l.v===a&&l.t>=r)return s;const c=[...s,{t:r,v:a}];return c.sort((e,t)=>e.t-t.t),c}(this._hist||[],this._stateObj)}connectedCallback(){if(super.connectedCallback(),!this._needsHistory)return;const e=Math.max(1,Math.min(180,Math.round(this._num(this.config?.history_refresh)??5)));this._histTimer=setInterval(()=>this._loadHistory(!0),60*e*1e3)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._histTimer),this._histTimer=null}_loadHistory(e=!1){if(!this._needsHistory||!this.hass||!this.config?.entity)return;const t=`${this.config.entity}|${this._histHours}`;if(!e&&this._histKey===t)return;this._histKey=t;const i=this._histToken=(this._histToken||0)+1;(async function(e,t,i,s=Date.now()){if(!(e?.connection&&t&&i>0))return[];const n=new Date(s-3600*i*1e3).toISOString();try{const i=await e.connection.sendMessagePromise({type:"history/history_during_period",start_time:n,end_time:new Date(s).toISOString(),entity_ids:[t],minimal_response:!0,no_attributes:!0}),a=i?.[t]||[],o=[];for(const e of a){const t=fi(e);null!=t&&o.push({t:t,v:_i(e)})}return o.sort((e,t)=>e.t-t.t),o}catch(e){return[]}})(this.hass,this.config.entity,this._histHours).then(e=>{i===this._histToken&&(this._hist=e)})}_fmtSigned(e){return(e>=0?"+":"")+this._fmtNum(e)}_deltaPill(e){if(!1===this.config.show_delta)return V;const t=function(e){const t=(e||[]).filter(e=>null!=e.v);if(t.length<2)return null;const i=t[0].v,s=t[t.length-1].v;return{from:i,to:s,abs:s-i,pct:0===i?null:(s-i)/Math.abs(i)*100}}(e);if(!t)return V;const i=this._unit,s={delta:this._fmtSigned(t.abs)+(i?` ${i}`:""),delta_pct:null==t.pct?"":`${this._fmtSigned(t.pct)}%`,from:this._fmtNum(t.from),to:this._fmtNum(t.to),unit:i,hours:String(this._histHours),days:String(Math.round(this._histHours/24))},n=this.config.delta_label,a=null!=n&&""!==n?this._interpolate(this._isTemplate(n)?this._resolvedDeltaLabel:n,null,s):s.delta;if(null==a||""===a)return V;const o=t.abs>0?"m3o:trending-up":t.abs<0?"m3o:trending-down":"m3o:trending-flat";return I`<div class="delta-pill">
      <ha-icon icon=${o}></ha-icon><span>${a}</span>
    </div>`}_sparkPaths(e,t,i,s){const n=e.filter(e=>null!=e.v).map(e=>e.v);if(!n.length)return[];const a=Math.min(...n),o=Math.max(...n)-a,r=i-2*s,l=e.length,c=e=>l>1?e/(l-1)*t:t/2,h=e=>0===o?s+r/2:s+(1-(e-a)/o)*r,d=[];for(const t of function(e){const t=[];let i=[];for(const s of e||[])null==s.v?(i.length&&t.push(i),i=[]):i.push(s);return i.length&&t.push(i),t}(e)){const s=t.map(t=>e.indexOf(t));let n="";t.forEach((e,t)=>{n+=`${0===t?"M":" L"}${c(s[t]).toFixed(2)} ${h(e.v).toFixed(2)}`}),1===t.length&&(n+=` L${(c(s[0])+.01).toFixed(2)} ${h(t[0].v).toFixed(2)}`);const a=c(s[0]),o=c(s[s.length-1]);d.push({line:n,area:`${n} L${o.toFixed(2)} ${i} L${a.toFixed(2)} ${i} Z`})}return d}_spark(e){const t=this._num(this._stateObj.state);if(null==t)return this._plain();const i=this._gauge(),s=i?i.accent:this._gaugeAccent(1),n=this._histSeries,a=function(e,t,i,s=Date.now()){const n=Math.max(2,Math.min(400,Math.round(t)));if(!(e?.length&&i>0))return[];const a=s-3600*i*1e3,o=(s-a)/n,r=[];let l=0,c=null;for(let t=0;t<n;t++){const i=a+o*(t+.5);for(;l<e.length&&e[l].t<=i;)c=e[l].v,l++;r.push({t:i,v:0===l?null:c})}return r}(n,this._num(this.config.points)??48,this._histHours),o=e.area?340:120,r=e.area?60:26,l=this._sparkPaths(a,o,r,e.area?6:3),c=this._fmtNum(t),h=this.config.caption?this._interpolate(this._isTemplate(this.config.caption)?this._resolvedCaption??"":this.config.caption,i,{hours:String(this._histHours),days:String(Math.round(this._histHours/24))}):this._label??"",d=l.length?I`<svg
      ...
      >
        ...
        ${this._valueRow({display:c,unit:this._unit},e.area?this._deltaPill(n):V)}
        ${e.area?V:d}
        ${h?I`<div class="gauge-caption">${h}</div>`:V}
      </div>
    `}_bucketBars(e){const t=function(e,{days:t=7,aggregate:i="delta",now:s=Date.now()}={}){const n=bi[i]||bi.delta,a=Math.max(1,Math.min(90,Math.round(t)));if(!e?.length)return[];const o=new Date(s);o.setHours(0,0,0,0);const r=864e5,l=o.getTime()-(a-1)*r,c=new Map;for(const t of e){if(null==t.v||t.t<l)continue;const e=Math.floor((t.t-l)/r);e<0||e>=a||(c.has(e)||c.set(e,[]),c.get(e).push(t.v))}const h=[];for(let e=0;e<a;e++){const t=c.get(e);if(!t||!t.length)continue;const i=n(t);h.push({t:l+e*r,v:Number.isFinite(i)?i:0,samples:t.length})}return h}(this._histSeries,{days:this._num(this.config.days)??3,aggregate:this.config.aggregate||"delta"}),i=this._gauge(),s=i?i.accent:this._gaugeAccent(1),n=Math.max(...t.map(e=>Math.max(0,e.v)),0),a=e.events?32:34,o=t.length?I`<div class=${e.events?"ticks":"weekbars"} style="--g-accent:${s}">
          ${t.map((i,s)=>{const o=Math.max(0,i.v),r=o<=0,l=r||n<=0?6:Math.max(6,o/n*a),c=e.events?r?"stub":"on":s===t.length-1?"current":"past";return I`<i class=${c} style="height:${l.toFixed(1)}px"></i>`})}
        </div>`:V,r={hours:String(this._histHours),days:String(Math.round(this._histHours/24)),buckets:String(t.length)},l=this.config.caption?this._interpolate(this._isTemplate(this.config.caption)?this._resolvedCaption??"":this.config.caption,i,r):this._label??"";if(e.events)return I`
        <div class="event-row">
          <div class="event-title">${this._name}</div>
          ${o}
          ${l?I`<div class="gauge-caption">${l}</div>`:V}
        </div>
      `;const c=this._num(this._stateObj.state);return I`
      <div class="rect-tile left gauge">
        ${this._header("m3o:bar-chart")}
        <div class="gauge-main">
          ${null!=c?this._gaugeValueLine({display:this._fmtNum(c),unit:this._unit}):V}
          ${o}
          ${l?I`<div class="gauge-caption">${l}</div>`:V}
        </div>
      </div>
    `}getGridOptions(){return"status"===this._variant||"events"===this._variant?{columns:12,rows:"auto",min_columns:6}:"spark"===this._variant?{columns:12,rows:"auto",min_columns:4}:{columns:4,rows:"auto",min_columns:3}}getCardSize(){return 3}}customElements.define("materia-glance-tile",Mi),window.customCards=window.customCards||[],window.customCards.push({type:"materia-glance-tile",name:"Materia Glance Tile",description:"Expressive view-only sensor tile — percent fill, thermometer, power bars, spinning pump star, and a graceful fallback.",preview:!0});const Oi=ht(90,90,86),Fi=function(e,t,i,s=0){return dt(e,t,i,s,[{x:.457,y:.296,r:.007},{x:.5,y:-.051,r:.007}],15)}(90,90,88),Di={rest:{bg:"var(--md-sys-color-secondary-container)",fg:"var(--md-sys-color-on-secondary-container)"},active:{bg:"var(--md-sys-cust-color-device, var(--md-sys-color-primary-container))",fg:"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-primary-container))"},sidekick:{bg:"var(--md-sys-color-surface-container-high, rgba(0, 0, 0, 0.06))",fg:"var(--md-sys-color-on-surface)"}},qi=[Ee,ze,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],Pi=e=>class extends e{willUpdate(e){super.willUpdate?.(e);const t="sidekick"===this.config?.variant?"sidekick":null;t?this.setAttribute("variant",t):this.removeAttribute("variant")}get _sidekick(){return"sidekick"===this.config?.variant}_shellPair(e){return this._sidekick?Di.sidekick:e?Di.active:Di.rest}_alertList(){return Array.isArray(this.config.alerts)?this.config.alerts:this.config.alert?[this.config.alert]:[]}_idle(e){return["off","idle","unknown","unavailable","false","0","none","","ok","docked"].includes(String(e??"").toLowerCase())}_alertText(e,t){if(null==t.text)return"";const i=this._isTemplate(t.text)?this._tplResults?.[`alertText${e}`]:t.text;return null==i?"":String(i).trim()}get _activeAlert(){const e=this._alertList();for(let t=0;t<e.length;t++){const i=e[t],s=this._alertText(t,i);if(i.entity){const e=this.hass?.states[i.entity];if(!e)continue;const t=String(e.state);if(null!=i.state){if(!(Array.isArray(i.state)?i.state.map(String):[String(i.state)]).includes(t))continue}else if(this._idle(t))continue;return{...i,text:s||(this.hass.formatEntityState?.(e)??t)}}if(s)return{...i,text:s}}return null}_resolveAlertTemplates(){this.config&&this._alertList().forEach((e,t)=>{null!=e.text&&this._resolveTemplateValue(`alertText${t}`,e.text)})}_renderBurst({alarm:e=!1,working:t=!1}={}){return!1===this.config.burst?V:I`
      ...
      <ha-card style="--mh-bg:${y};--mh-fg:${x};--mh-alert-bg:${m};--mh-alert-fg:${g};">
        ...
        <div
          ...
          @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info",entity:this.config.entity})}
        >
          ${this._renderBurst({alarm:!!u,working:a})}
          <div class="content">
            <div class="eyebrow">
              ${r?I`<ha-icon .icon=${r}></ha-icon>`:V}
              <span>${o}</span>
            </div>
            <div class="title">${t?ke("unavailable",this.hass):l}</div>
            ${null!=c?I`<div class="figure">
                  <span class="value">${c}</span>
                  ${h?I`<span class="unit">${h}</span>`:V}
                  ${d?I`<span class="caption">${d}</span>`:V}
                </div>`:V}
    ...
    `];static getConfigElement(){return document.createElement("materia-vacuum-hero-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("vacuum."))||"";return{entity:t,brand:"roborock"}}setConfig(e){if(!e.entity)throw new Error("Materia Vacuum Hero: entity is required");this.config={brand:"roborock",...e},this._discovered=null}updated(e){e.has("config")&&(this._discovered=null),e.has("hass")&&this.hass&&(this.config.alerts||[]).forEach((e,t)=>{null!=e.text&&this._resolveTemplateValue("alertText"+t,e.text)})}get _profile(){return e=this.config.brand,Gi[e]||Gi.generic;var e}get _stateObj(){return this.hass?.states[this.config.entity]}_siblings(){const e=this.hass?.entities?.[this.config.entity];if(!e)return[];const t=e.device_id,i=this.config.entity.split(".")[1]+"_";return Object.values(this.hass.entities).filter(e=>!e.disabled_by&&!e.hidden_by&&(t&&e.device_id===t||e.entity_id.split(".")[1].startsWith(i))).map(e=>e.entity_id)}get _caps(){if(this._discovered)return this._discovered;const e=this._siblings(),t=e.length>0,i=(t,i)=>{for(const s of t){const t=e.find(e=>!(i&&!i.includes(e.split(".")[0]))&&(e.split(".")[1].endsWith(s)||e.split(".")[1].includes(s)));if(t)return t}return null},s={};for(const[e,t]of Object.entries(Hi))s[e]=this.config[`${e}_entity`]??i(t,["sensor","binary_sensor"]);return s.consumables=this.config.consumable_entities??e.filter(e=>e.startsWith("sensor.")&&Wi.some(t=>e.includes(t))),t&&(this._discovered=s),s}_num(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}_stateOf(e){if(!e)return null;const t=this.hass?.states[e];return t&&!this._isUnavailable(t)?t.state:null}_numOf(e){return this._num(this._stateOf(e))}get _idleStates(){return(this.config.idle_states??this._profile.idle_states).map(e=>String(e).toLowerCase())}get _working(){const e=this._stateObj;if(!e||this._isUnavailable(e))return!1;const t=String(this._stateOf(this._caps.status)??e.state).toLowerCase();return!this._idleStates.includes(t)}get _drying(){return"on"===this._stateOf(this._caps.mop_drying)}get _hasProgress(){const e=String(this._stateOf(this._caps.status)??this._stateObj?.state??"").toLowerCase();return!(this.config.no_progress_states??["return","empty","wash","dry","charg","dock","locat","seek","idle"]).some(t=>e.includes(t))}get _minutesLeft(){const e=this._numOf(this._caps.progress);if(null==e||e<=0||e>=100)return null;const t=this._caps.cleaning_time,i=this._numOf(t);if(null==i||i<=0)return null;const s=i*({s:1/60,sec:1/60,secs:1/60,seconds:1/60,min:1,mins:1,minutes:1,h:60,hr:60,hours:60}[String(this.hass?.states[t]?.attributes?.unit_of_measurement??"").toLowerCase()]??1/60),n=Math.round(s*(100-e)/e);return e<(this.config.eta_min_progress??5)?null:Math.max(1,n)}_pretty(e){if(null==e)return null;const t=String(e).replace(/[_-]+/g," ").trim();return t.charAt(0).toUpperCase()+t.slice(1)}_resetButtonFor(e){const t=["main_brush","side_brush","maintenance_brush","strainer","filter","sensor","mop"].find(t=>e.includes(t));return t?this._siblings().find(e=>e.startsWith("button.")&&e.includes("reset")&&e.includes(t))??null:null}_lowConsumables(){const e=this.config.consumable_hours??1,t=this.config.consumable_percent??5,i={s:1/3600,sec:1/3600,seconds:1/3600,min:1/60,minutes:1/60,h:1,hours:1,d:24};return(this._caps.consumables||[]).filter(s=>{const n=this._numOf(s);if(null==n)return!1;const a=String(this.hass.states[s]?.attributes?.unit_of_measurement??"").toLowerCase();if("%"===a)return n<=t;return n*(i[a]??1)<=e})}get _alerts(){const e=this._caps,t=(e,t,i)=>{const s=this._stateOf(e);if(null==s||["none","ok","off","no_error","0"].includes(String(s).toLowerCase()))return null;const n=(a=s,o=this.hass.locale?.language,Ki(Yi,a,o));var a,o;return{icon:t,text:n?`${i}: ${n}`:`${i}: ${this._pretty(s)}`,severity:"error",entity:e}},i=(e,t,i,s)=>"on"===this._stateOf(e)?{icon:t,text:i,severity:s,entity:e}:null,s=[t(e.error,"mdi:robot-vacuum-alert",this.config.error_label??"Vacuum error"),t(e.dock_error,"mdi:home-alert-outline",this.config.dock_error_label??"Dock error"),i(e.water_shortage,"mdi:water-alert-outline","Water shortage - cannot mop","error"),i(e.clean_water,"mdi:water-outline","Clean water tank needs refilling","warning"),i(e.dirty_water,"mdi:water-off-outline","Dirty water tank needs emptying","warning"),...this._lowConsumables().map(e=>{return{icon:"mdi:wrench-outline",text:(t=e,i=this.hass.locale?.language,Ki(Xi,t,i)??`${this.hass.states[e]?.attributes?.friendly_name??e} needs attention`),severity:"warning",entity:e,reset:this._resetButtonFor(e)};var t,i}),...(this.config.alerts||[]).map((e,t)=>{const i=null!=e.text&&this._isTemplate(e.text)?this._tplResults?.["alertText"+t]:e.text,s=null==i?"":String(i).trim();return null!=e.text&&0===s.length?null:{...e,text:s}})].filter(Boolean);return s}_severityPair(e){return"warning"===e?["var(--md-sys-cust-color-warning-container)","var(--md-sys-cust-color-on-warning-container)"]:["var(--md-sys-cust-color-error, var(--md-sys-color-error))","var(--md-sys-cust-color-on-error, var(--md-sys-color-on-error))"]}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e){if(this._lastGood){const e=this._lastGood;return I`
      ...
      </div></div></ha-card>`}const t=this._isUnavailable(e),i=this._caps,s=this._working,n=this._alerts[0]||null,a=this._numOf(i.battery),o=this._numOf(i.progress),r=this._stateOf(i.status)??e.state;let l=this._pretty(r);const c=String(r??"").toLowerCase(),h=c.includes("charg")||c.includes("dock");!s&&h&&null!=a&&a>=100&&(l=this.config.docked_label??ke("vh_docked",this.hass)),t&&(l=ke("unavailable",this.hass));const d=s&&null!=o&&this._hasProgress,p=d?Math.round(o):a,u=d?this.config.progress_caption??"done":this.config.battery_caption??ke("vh_battery_caption",this.hass);let m=null;if(s){const e=this._stateOf(i.room),t=this._minutesLeft,s=[];e&&!["unknown","unavailable"].includes(e)&&s.push(this._pretty(e)),null!=t&&s.push(ke("vh_min_left",this.hass,{mins:t})),m=s.join(" - ")||null}else if(this._drying)m=this.config.drying_label??ke("vh_drying",this.hass);else{const e=this._stateOf(i.last_clean);if(e){const t=new Date(e);if(!Number.isNaN(t.getTime())){const e=Math.round((Date.now()-t.getTime())/6e4),i=e<60?ke("unit_min",this.hass,{n:Math.max(1,e)}):e<1440?ke("unit_hours",this.hass,{n:Math.round(e/60)}):ke("unit_days",this.hass,{n:Math.round(e/1440)});m=ke("vh_last_cleaned",this.hass,{rel:i})}}}const g=this._shellPair(s);let f=(s?this.config.working_color:this.config.color)??g.bg,_=(s?this.config.working_color_on:this.config.color_on)??g.fg;const b=null!=n&&(null==n.severity||"error"===n.severity);let v=null,y=null;if(n){const[e,t]="info"===n.severity?[f,_]:this._severityPair(n.severity);v=n.color??e,y=n.color_on??t,b&&!1!==this.config.alert_tints_hero&&(f=v,_=y)}const x=this.config.name??e.attributes?.friendly_name??this.config.entity,w=this.config.icon??"mdi:robot-vacuum";return this._lastGood={title:l,value:p,caption:u,secondary:m,name:x,icon:w,bg:f,fg:_},I`
      <ha-card style="--mh-bg:${f};--mh-fg:${_};--mh-alert-bg:${v??f};--mh-alert-fg:${y??_};--mh-calm-d:path('${Zi}');--mh-live-d:path('${Qi}');">
        <div class="stack">
          <div
            class="hero ${t?"unavailable":""} ${n?"attached":""}"
            @click=${()=>this._handleAction(this.config.tap_action||{action:"more-info",entity:this.config.entity})}
          >
          ...
          ${n?I`<div
                class="alert"
                role="status"
                @click=${()=>this._handleAction(n.tap_action||{action:"more-info",entity:n.entity||this.config.entity})}
              >
                <ha-icon .icon=${n.icon??"mdi:alert-circle-outline"}></ha-icon>
                <span>${n.text}</span>
                ${n.reset?I`<button
                      class="alert-action"
                      title="Reset"
                      @click=${e=>{e.stopPropagation(),this._fireHaptic?.("light"),this._callService("button","press",{},{entity_id:n.reset})}}
                    >
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 4}}customElements.define("materia-vacuum-hero",Ji),window.customCards=window.customCards||[],window.customCards.push({type:"materia-vacuum-hero",name:"Materia Vacuum Hero",description:"Robot-vacuum headline — derived ETA, negated working states, and mop/consumable warnings. Roborock and Ecovacs.",preview:!0});const es=[Ee,ze,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-bar-select-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",selector:{text:{}}},{name:"attribute",label:"Attribute (e.g. fan_speed) instead of the state",selector:{text:{}}},{name:"off_option",label:'Option shown as its own round button (e.g. "off")',selector:{text:{}}},{name:"off_icon",label:"Icon for that button",selector:{icon:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"accent",label:"Lit bar color",color:!0,template:!0,selector:{text:{}}},{name:"accent_on",label:"Glyph color on the accent fill",color:!0,template:!0,selector:{text:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});class ns extends(is(ci(Se(ce)))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedAccent:{state:!0},_resolvedAccentOn:{state:!0}};static styles=[ss,hi];static getConfigElement(){return document.createElement("materia-bar-select-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("select."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("Materia Bar Select: entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("accent","_resolvedAccent"),this._resolveField("accent_on","_resolvedAccentOn"),this._optimisticReconcile());const t=this._index;null!=this._prevIndex&&t!==this._prevIndex&&this._choreograph(this._prevIndex,t),this._prevIndex=t}get _stateObj(){return this.hass?.states[this.config.entity]}get _rungs(){const e=null!=this.config.off_option?String(this.config.off_option):null;return this._options.filter(t=>null==e||t!==e)}get _index(){return this._rungs.indexOf(String(this._current))}_optimisticActual(){const e=this._stateObj;if(!e)return null;const t=this.config.attribute?e.attributes?.[this.config.attribute]:e.state;return null==t?null:String(t)}get _current(){return this._optimistic}get _options(){if(this.config.options?.length)return this.config.options.map(String);const e=this._stateObj;if(!e)return[];if(this.config.attribute){const t=e.attributes?.[`${this.config.attribute}_list`];return Array.isArray(t)?t.map(String):[]}const t=e.attributes?.options;return Array.isArray(t)?t.map(String):[]}_fmt(e){const t=this._stateObj;if(!this.config.attribute&&t&&String(t.state)===String(e)){const e=this.hass.formatEntityState?.(t);if(e)return e}const i=String(e).replace(/[_-]+/g," ");return i.charAt(0).toUpperCase()+i.slice(1)}_set(e){const t=this._stateObj;if(!t)return;const i=t.entity_id.split(".")[0];if(this._fireHaptic?.("selection"),this._optimisticSet(e),this.config.service){const[i,s]=String(this.config.service).split("."),n=this.config.service_key||this.config.attribute||"option";return void this._callService(i,s,{entity_id:t.entity_id,[n]:e})}if(this.config.attribute){const s=this.config.attribute;return void this._callService(i,`set_${s}`,{entity_id:t.entity_id,[s]:e})}"select"!==i&&"input_select"!==i||this._callService(i,"select_option",{entity_id:t.entity_id,option:e})}_choreograph(e,t){if(window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches)return;const i=Array.from(this.shadowRoot?.querySelectorAll(".bar")||[]);if(!i.length)return;const s=t>e,n=[];for(let s=Math.min(e,t)+1;s<=Math.max(e,t);s++)i[s]&&n.push(i[s]);const a=s?n:n.reverse(),o=s?[{transform:"scaleY(0.94)"},{transform:"scaleY(1.07)",offset:.5},{transform:"scaleY(1)"}]:[{transform:"scaleY(1)"},{transform:"scaleY(0.84)",offset:.5},{transform:"scaleY(0.94)"}];a.forEach((e,t)=>{e.animate(o,{duration:300,delay:45*t,easing:s?"cubic-bezier(.2,1.5,.3,1)":"cubic-bezier(.3,0,.2,1)",fill:"none"})})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(!e||this._isUnavailable(e))return I`<ha-card><div class="tile unavailable">
      ...
      <ha-card style="--bs-accent:${t};--bs-accent-on:${i};">
        <div class="tile">
          ...
          <div class="bars">
            ${o.map((e,t)=>I`<button
                class="bar ${r>=t?"lit":""}"
                style="height:${l>1?34+66*t/(l-1):100}%;transition-delay:${(e=>h>0?e>c&&e<=r?45*(e-c-1):0:h<0&&e>r&&e<=c?45*(c-e):0)(t)}ms"
                @click=${()=>this._set(e)}
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-bar-select",ns),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bar-select",name:"Materia Bar Select",description:"Tap-a-bar level picker — climbing bars for fan speeds, mop levels, any ordered select.",preview:!0});const as=[Ee,ze,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class os extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null}_formData(){return{...this._config}}get _sections(){const e=!!this._config?.sort_by_history,t=(this._config?.items||[]).some(e=>e.entity);return[{title:"Content",icon:"mdi:card-text-outline",fields:[...t?[]:[{name:"entity",label:"Entity holding the selection (optional)",helper:"Only needed when items don't carry their own entity — a room queue's text, an input_select.",selector:{entity:{}}},{name:"attribute",label:"Attribute (instead of the state)",selector:{text:{}}},{name:"multi_select",label:"Multi-select (state is a comma-separated list)",selector:{boolean:{}}}],{name:"carousel",label:"Carousel (horizontal scroll instead of a wrapped grid)",selector:{boolean:{}}}]},{title:"Auto-sort",icon:"mdi:sort-variant",fields:[{name:"sort_by_history",label:"Sort by pick frequency on load",helper:"Reads the tracked entity's recent history once when the card loads and puts the most-often-picked values first — the tiles you actually use float to the front instead of always sitting in configured order.",selector:{boolean:{}}},...e?[{name:"sort_history_days",label:"History window, in days (default 30)",selector:{number:{min:1,max:365,mode:"box"}}}]:[]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Selected tile color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Selected tile text",color:!0,template:!0,selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}get _itemSchema(){return[{name:"label",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}}},{name:"secondary",label:"Secondary line (optional)",selector:{text:{}}},{name:"entity",label:"Entity (optional — this tile's own state)",helper:"A room's own input_boolean, say — drives the tile's highlight independent of the card's tracked entity.",selector:{entity:{}}},{name:"value",label:"Value (when there's no per-item entity)",selector:{text:{}}},{name:"tap_action",label:"Action (overrides the default toggle/select)",selector:{ui_action:{default_action:"none"}}}]}_renderExtra(){const e=this._config?.items||[];return I`
      ...
      ${De((e,t)=>this._moveItem(e,t),e.map((e,t)=>I`
  ...
  `],cs="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:var(--md-sys-color-secondary-container, rgba(120,120,128,.14));color:var(--md-sys-color-on-secondary-container, inherit);margin-bottom:6px;cursor:pointer;",hs="border:none;background:transparent;color:inherit;cursor:pointer;padding:4px;display:grid;place-items:center;border-radius:50%;--mdc-icon-size:18px;",ds="border:1.5px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.2));background:transparent;color:inherit;font-family:inherit;font-size:13px;font-weight:600;padding:8px 16px;border-radius:999px;cursor:pointer;display:inline-flex;align-items:center;gap:6px;";customElements.define("materia-climate-panel-editor",class extends He{static properties={_secIdx:{state:!0},_cardIdx:{state:!0},_huiReady:{state:!0}};connectedCallback(){super.connectedCallback(),this._loadHui()}async _loadHui(){if(customElements.get("hui-card-picker")&&customElements.get("hui-card-element-editor"))this._huiReady=!0;else{try{const e=await pe(),t=await e.createCardElement({type:"vertical-stack",cards:[]});await(t?.constructor?.getConfigElement?.())}catch{}this._huiReady=!!customElements.get("hui-card-picker")}}_formData(){return{steppers:"side",wave:"auto",...this._config}}get _secs(){return this._config?.sections||[]}_setSecs(e){const t={...this._config};e.length?t.sections=e:delete t.sections,this._commit(t)}_patchSec(e,t){const i=[...this._secs],s={...i[e],...t};for(const e of Object.keys(t))void 0!==t[e]&&""!==t[e]&&null!==t[e]||delete s[e];i[e]=s,this._setSecs(i)}_moveSec(e,t){const i=[...this._secs],s=e+t;s<0||s>=i.length||([i[e],i[s]]=[i[s],i[e]],this._setSecs(i))}_addSec(){const e=this._secs.length;this._setSecs([...this._secs,{title:"New section",style:"section",cards:[]}]),this._secIdx=e}_patchCards(e,t){this._patchSec(e,{cards:t})}render(){return this.hass&&this._config?null!=this._secIdx&&null!=this._cardIdx?this._renderCardView():null!=this._secIdx?this._renderSectionView():super.render():I``}_back(e,t){return I`
      ...
      <ha-expansion-panel outlined .header=${"Sections"} .secondary=${"Wallet sections and menus below the mode group"} .expanded=${!0}>
        ...
        <div style="padding:12px;">
          ${this._secs.map((e,t)=>I`
            <div style=${cs} @click=${()=>{this._secIdx=t}}>
              ...
              <button style=${hs} title="Move up" @click=${e=>{e.stopPropagation(),this._moveSec(t,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
              <button style=${hs} title="Move down" @click=${e=>{e.stopPropagation(),this._moveSec(t,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
              <button style=${hs} title="Edit" @click=${e=>{e.stopPropagation(),this._secIdx=t}}><ha-icon icon="mdi:pencil"></ha-icon></button>
              <button style=${hs} title="Delete" @click=${e=>{e.stopPropagation(),this._setSecs(this._secs.filter((e,i)=>i!==t))}}><ha-icon icon="mdi:delete"></ha-icon></button>
            </div>
          `)}
          <button style=${ds} @click=${()=>this._addSec()}>
    ...
    `}_renderMenuFields(e,t){const i=t.options||[],s=(t,s)=>{const n=i.map((e,i)=>i===t?{...e,...s}:e);for(const e of Object.keys(s))""!==s[e]&&null!=s[e]||delete n[t][e];this._patchSec(e,{options:n})};return I`
      ...
      ${i.map((t,n)=>I`
        <div style="display:flex;gap:6px;align-items:flex-start;margin-bottom:8px;">
          <div style="flex:1;" @value-changed=${e=>{e.stopPropagation(),s(n,{label:e.detail.value})}}>
            <ha-selector .hass=${this.hass} .selector=${{text:{}}} .value=${t.label} .label=${"Label"}></ha-selector>
          </div>
          <div style="flex:1;" @value-changed=${e=>{e.stopPropagation(),s(n,{value:e.detail.value})}}>
            <ha-selector .hass=${this.hass} .selector=${{text:{}}} .value=${t.value} .label=${"Value"}></ha-selector>
          </div>
          <div style="flex:1;" @value-changed=${e=>{e.stopPropagation(),s(n,{icon:e.detail.value})}}>
            <ha-selector .hass=${this.hass} .selector=${{icon:{}}} .value=${t.icon} .label=${"Icon"}></ha-selector>
          </div>
          <button style="${hs}margin-top:12px;" title="Remove option"
            @click=${()=>this._patchSec(e,{options:i.filter((e,t)=>t!==n)})}>
            <ha-icon icon="mdi:delete"></ha-icon>
          </button>
        </div>
      `)}
      <button style=${ds} @click=${()=>this._patchSec(e,{options:[...i,{label:"",value:""}]})}>
        <ha-icon icon="mdi:plus" style="--mdc-icon-size:16px;"></ha-icon>Add option
      </button>
    `}_renderActions(e,t){const i=t.actions||[],s=(t,s)=>{const n=i.map((e,i)=>i===t?{...e,...s}:e);for(const e of Object.keys(s))""!==s[e]&&null!=s[e]||delete n[t][e];this._patchSec(e,{actions:n})};return I`
      ...
      ${i.map((t,n)=>I`
        <div style="border:1px solid var(--md-sys-color-outline-variant, rgba(0,0,0,.15));border-radius:12px;padding:10px;margin-bottom:8px;">
          <div style="display:flex;gap:6px;align-items:flex-start;">
            ...
            <button style="${hs}margin-top:12px;" title="Remove action"
              @click=${()=>this._patchSec(e,{actions:i.filter((e,t)=>t!==n)})}>
              <ha-icon icon="mdi:delete"></ha-icon>
            </button>
          </div>
          <div style="margin-top:8px;" @value-changed=${e=>{e.stopPropagation(),s(n,{tap_action:e.detail.value})}}>
            <ha-selector .hass=${this.hass} .selector=${{ui_action:{}}} .value=${t.tap_action} .label=${"Action"}></ha-selector>
          </div>
        </div>
      `)}
      <button style="${ds}margin-bottom:12px;" @click=${()=>this._patchSec(e,{actions:[...i,{label:""}]})}>
        <ha-icon icon="mdi:plus" style="--mdc-icon-size:16px;"></ha-icon>Add action
      </button>
    `}_renderSectionCards(e,t){const i=t.cards||[],s=(t,s)=>{const n=t+s;if(n<0||n>=i.length)return;const a=[...i];[a[t],a[n]]=[a[n],a[t]],this._patchCards(e,a)};return I`
      ...
      ${i.map((t,n)=>I`
        <div style=${cs} @click=${()=>{this._cardIdx=n}}>
          <span style="opacity:.6;font-weight:600;">${n+1}</span>
          <span style="flex:1;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${t.type||"card"}</span>
          <button style=${hs} title="Move up" @click=${e=>{e.stopPropagation(),s(n,-1)}}><ha-icon icon="mdi:arrow-up"></ha-icon></button>
          <button style=${hs} title="Move down" @click=${e=>{e.stopPropagation(),s(n,1)}}><ha-icon icon="mdi:arrow-down"></ha-icon></button>
          <button style=${hs} title="Edit" @click=${e=>{e.stopPropagation(),this._cardIdx=n}}><ha-icon icon="mdi:pencil"></ha-icon></button>
          <button style=${hs} title="Delete" @click=${t=>{t.stopPropagation(),this._patchCards(e,i.filter((e,t)=>t!==n))}}><ha-icon icon="mdi:delete"></ha-icon></button>
        </div>
      `)}
  ...
  `],us=-135,ms=270,gs="var(--md-sys-cust-color-climate-auto-accent, var(--md-sys-color-primary))",fs="var(--md-sys-cust-color-climate-auto-container, var(--md-sys-color-primary-container))",_s={auto:{icon:"mdi:thermostat-auto",color:gs,on:fs,container:fs,onContainer:gs},heat_cool:{icon:"mdi:thermostat-auto",color:gs,on:fs,container:fs,onContainer:gs},heat:{icon:"m3o:mode-heat",color:"var(--md-sys-cust-color-climate-heat-accent, #a14614)",on:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",container:"var(--md-sys-cust-color-climate-heat-container, #ffeee9)",onContainer:"var(--md-sys-cust-color-climate-heat-accent, #a14614)"},cool:{icon:"mdi:snowflake",color:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)",on:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",container:"var(--md-sys-cust-color-climate-cool-container, #eaf3ff)",onContainer:"var(--md-sys-cust-color-climate-cool-accent, #327ea7)"},dry:{icon:"mdi:water-percent",color:gs,on:fs,container:fs,onContainer:gs},fan_only:{icon:"mdi:fan",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"},off:{icon:"m3o:power-settings-new",color:"var(--md-sys-color-secondary)",on:"var(--md-sys-color-on-secondary)",container:"var(--md-sys-color-secondary-container)",onContainer:"var(--md-sys-color-on-secondary-container)"}};class bs extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_optimisticTemp:{state:!0},_adjusting:{state:!0}};static styles=ps;setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={...e}}connectedCallback(){super.connectedCallback(),this._phase=0,this._amp=0,this._startLoop()}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),clearTimeout(this._optimisticTimer),clearTimeout(this._sendTimer)}get _entity(){return this.hass?.states[this.config.entity]}get _action(){return this._entity?.attributes?.hvac_action??""}get _waveAction(){const e=this._mode;if("off"===e||"never"===this.config.wave)return"";if("always"===this.config.wave)return"cool"===e?"cooling":"heating";const t="auto"===e||"heat_cool"===e,i=t?"holding":"",s=this._action;if("heating"===s||"cooling"===s)return s;if(s&&"idle"!==s)return"";const n=this._current,a=this._target;return null==a||"idle"===s?i:null==n?"cool"===e?"cooling":"heat"===e?"heating":i:("heat"===e||t)&&n<a-.2?"heating":("cool"===e||t)&&n>a+.2?"cooling":i}get _mode(){return this._entity?.state??"off"}get _target(){return null!=this._optimisticTemp?this._optimisticTemp:this._numRaw(this._entity?.attributes?.temperature)}get _current(){if(this.config.temperature_entity){const e=this.hass?.states[this.config.temperature_entity];if(e)return this._numRaw(e.state)}return this._numRaw(this._entity?.attributes?.current_temperature)}_numRaw(e){if(null==e||""===e||"unknown"===e||"unavailable"===e)return null;const t=Number(e);return Number.isFinite(t)?t:null}get _step(){return this.config.step??this._numRaw(this._entity?.attributes?.target_temp_step)??.5}get _scale(){return{min:this.config.min_temp??this._numRaw(this._entity?.attributes?.min_temp)??7,max:this.config.max_temp??this._numRaw(this._entity?.attributes?.max_temp)??35}}_startLoop(){if(this._raf)return;const e=window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches,t=()=>{const i=this._waveAction,s="heating"===i||"cooling"===i,n=e?0:s?1:"holding"===i?.35:0,a=this._amp+.06*(n-this._amp),o=Math.abs(a-n)<.01;if(this._amp=o?n:a,this._amp>.005||n>0){this._phase+="cooling"===i?.012:s?-.012:-.008;const e=this._waveGeom;if(e){const t=this.renderRoot?.querySelector("path.wave-seg");t&&t.setAttribute("d",this._wavePath(e.start,e.end,e.r))}this._raf=requestAnimationFrame(t)}else this._raf=null};this._raf=requestAnimationFrame(t)}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}updated(e){if(this._waveAction&&!this._raf&&this._startLoop(),e.has("hass")&&null!=this._optimisticTemp){const e=this._numRaw(this._entity?.attributes?.temperature);null!=e&&Math.abs(e-this._optimisticTemp)<1e-6&&(this._optimisticTemp=null,clearTimeout(this._optimisticTimer))}}_modeGroupConfig(e,t,i){const s=`${this.config.entity}|${e.join()}|${t}|${i}|${this.config.mode_size??"m"}`;return this._mgKey!==s&&(this._mgKey=s,this._mgConfig={entity:this.config.entity,size:this.config.mode_size??"m",variant:"tonal",active_shape:"square",color_active:t,color_on_active:i,options:e.map(e=>({icon:_s[e].icon,value:e,tap_action:{action:"perform-action",perform_action:"climate.set_hvac_mode",data:{hvac_mode:e},target:{entity_id:this.config.entity}}}))}),this._mgConfig}_angleFor(e,t,i){const s=Math.min(1,Math.max(0,(e-t)/(i-t)));return us+ms*s}_pointAt(e,t,i=0){const s=(e-90)*Math.PI/180,n=t+i;return[50+n*Math.cos(s),50+n*Math.sin(s)]}_wavePath(e,t,i){const s=t-e,n=1+.55*Math.max(0,Math.min(1,(90-s)/70)),a=Math.min(20,Math.max(6,s/3)),o=3.2*n*this._amp,r=[];for(let s=e;s<=t;s+=2){const n=s-e,l=o*Math.min(1,n/a)*Math.min(1,(t-s)/a)*Math.sin(n/7+this._phase);r.push(this._pointAt(s,i,l))}return r.push(this._pointAt(t,i,0)),"M"+r.map(([e,t])=>`${e.toFixed(2)} ${t.toFixed(2)}`).join(" L")}_arcPath(e,t,i){const[s,n]=this._pointAt(e,i),[a,o]=this._pointAt(t,i),r=t-e>180?1:0;return`M${s.toFixed(2)} ${n.toFixed(2)} A${i} ${i} 0 ${r} 1 ${a.toFixed(2)} ${o.toFixed(2)}`}_setTarget(e){const{min:t,max:i}=this._scale,s=this._step,n=Math.round(100*Math.min(i,Math.max(t,Math.round(e/s)*s)))/100;this._optimisticTemp=n,this._adjusting=!0,clearTimeout(this._adjustTimer),this._adjustTimer=setTimeout(()=>{this._adjusting=!1},650),clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticTemp=null},1e4),clearTimeout(this._sendTimer),this._sendTimer=setTimeout(()=>{this._callService("climate","set_temperature",{entity_id:this.config.entity,temperature:n})},350)}_nudge(e){const t=this._target;null!=t&&this._setTarget(t+e)}_dialPointer(e){if(!this._dialDragging&&"pointerdown"!==e.type)return;const t=this.renderRoot.querySelector(".dial").getBoundingClientRect(),i=(e.clientX-t.left)/t.width*100-50,s=(e.clientY-t.top)/t.height*100-50;let n=180*Math.atan2(s,i)/Math.PI+90;if(n>180&&(n-=360),n<-143||n>143)return;const a=Math.min(1,Math.max(0,(n-us)/ms)),{min:o,max:r}=this._scale;"pointerdown"===e.type&&(this._dialDragging=!0,e.currentTarget.setPointerCapture(e.pointerId)),this._setTarget(o+a*(r-o))}_endDialDrag(e){this._dialDragging=!1,e.currentTarget.releasePointerCapture?.(e.pointerId)}render(){if(!this.hass||!this.config)return I``;const e=this._entity;if(!e)return I``;const t=this._isUnavailable(e),{min:i,max:s}=this._scale,n=this._target,a=this._current,o=this._mode,r=this._waveAction,l=_s[o]||_s.off,c="off"!==o&&null!=n,h=42,d=c?this._angleFor(n,i,s):us,p=null!=n?this._angleFor(n,i,s):null,[u,m]=this._pointAt(c?d:p??d,h),g=null!=a?this._angleFor(a,i,s):null;let f=null,_=null,b=null;c&&"holding"===r?(_=us,b=null!=g?Math.max(g,d):d):c&&null!=g?(f=Math.min(g,d),_=f,b=Math.max(g,d)):c&&(_=us,b=d);const v="heating"===r?_s.heat:"cooling"===r?_s.cool:l,y=v.color,x=v.on,w=this.hass.formatEntityState?.(e)??o,k=this.hass.config?.unit_system?.temperature??"°C",$=(this.config.hvac_modes??e.attributes.hvac_modes??[]).filter(e=>_s[e]);return this._waveGeom=c&&null!=b&&b>_+.5?{start:_,end:b,r:h}:null,I`
      <ha-card
        class="${t?"unavailable":""}"
      ...
      >
        ...
        <div class="dial-wrap">
          <svg class="dial" viewBox="0 0 100 100">
            ...
            />
            ${(()=>{const e=c?Math.max(d,g??d):us,t=c?Math.min(e+8,135):us;return t<134.5?H`<path d=${this._arcPath(t,135,h)} class="track" />`:""})()}
            ${c||null==g?"":H`<circle
                  cx=${this._pointAt(g,h)[0]} cy=${this._pointAt(g,h)[1]}
                  r="1.6" class="current-dot" />`}
            ${c&&null!=f&&f>-134.5?H`<path d=${this._arcPath(us,f,h)} class="sweep" style="stroke:${y}" />`:""}
            ${c&&null!=b&&b>_+.5?H`<path d=${this._wavePath(_,b,h)} class="sweep wave-seg" style="stroke:${y}" />`:""}
            ${c&&null!=g?H`<circle
                  cx=${this._pointAt(g,h)[0]} cy=${this._pointAt(g,h)[1]}
                  r="3.4" class="current-knob" style="fill:${y}" />`:""}
            ${c?H`<g>
                  <circle cx=${u} cy=${m} r="5.5" class="thumb" style="fill:${y}" />
                  <path d=${ot(u,m,3.7,12)} class="thumb-cookie" />
                </g>`:null!=p?H`<g>
          ...
          <div class="center" @click=${()=>this._fireMoreInfo(this.config.entity)}>
            ...
            <div class="target ${this._adjusting?"adjusting":""}">
              ${null!=n?Math.round(10*n)/10:null!=a?Math.round(10*a)/10:"—"}<span class="deg">${k}</span>
            </div>
            ${null!=a&&!1!==this.config.show_current?I`<div class="current-label">${this.config.current_label??ke("cp_currently",this.hass)} ${Math.round(10*a)/10}°</div>`:""}
          </div>
        </div>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 6}}customElements.define("materia-climate-panel",ys),window.customCards=window.customCards||[],window.customCards.push({type:"materia-climate-panel",name:"Materia Climate Panel",description:"Climate panel: thermostat dial hero, mode group, and wallet sections you compose with any cards or menus.",preview:!0});const xs={primary:{active:"var(--md-sys-color-primary)",onActive:"var(--md-sys-color-on-primary)"},secondary:{active:"var(--md-sys-color-secondary)",onActive:"var(--md-sys-color-on-secondary)"},tertiary:{active:"var(--md-sys-color-tertiary)",onActive:"var(--md-sys-color-on-tertiary)"},"climate-heat":{active:"var(--md-sys-cust-color-climate-heat-container)",onActive:"var(--md-sys-cust-color-on-climate-heat)"},"climate-cool":{active:"var(--md-sys-cust-color-climate-cool-container)",onActive:"var(--md-sys-cust-color-on-climate-cool)"},"climate-auto":{active:"var(--md-sys-cust-color-climate-auto-container)",onActive:"var(--md-sys-cust-color-on-climate-auto)"},light:{active:"var(--md-sys-cust-color-light)",onActive:"var(--md-sys-cust-color-on-light)"},device:{active:"var(--md-sys-cust-color-device)",onActive:"var(--md-sys-cust-color-on-device)"}},ws={xs:{height:32,innerCorner:4},s:{height:40,innerCorner:8},m:{height:56,innerCorner:8},l:{height:96,innerCorner:16},xl:{height:136,innerCorner:20}},ks=[Ee,ze,ge,a`
    .group {
      display: flex;
      gap: 2px;
      width: 100%;
  ...
  `];class Cs extends He{static properties={_expanded:{state:!0},_actionRows:{state:!0}};static styles=[He.styles,a`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null,this._actionRows??=Object.entries(e.tap_action_map||{}).map(([e,t])=>({state:e,tap_action:t}))}_formData(){return{variant:"filled",size:"m",shape:"round",...this._config}}get _sections(){return[{title:"Button",icon:"mdi:gesture-tap-button",fields:[{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"label",template:!0,selector:{text:{}}},{name:"variant",selector:{select:{mode:"dropdown",options:[{value:"elevated",label:"Elevated"},{value:"filled",label:"Filled"},{value:"tonal",label:"Tonal"},{value:"outlined",label:"Outlined"},{value:"text",label:"Text"}]}}},{name:"role",label:"Color role",helper:"Unset = each variant's spec default (filled → primary, tonal → secondary).",selector:{select:{mode:"dropdown",options:[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"}]}}},{name:"size",selector:{select:{mode:"dropdown",options:[{value:"xs",label:"XS (32)"},{value:"s",label:"S (40)"},{value:"m",label:"M (56)"},{value:"l",label:"L (96)"},{value:"xl",label:"XL (136)"}]}}},{name:"shape",selector:{select:{mode:"dropdown",options:[{value:"round",label:"Round (pill)"},{value:"square",label:"Square"}]}}},{name:"wide",selector:{boolean:{}}},{name:"entity",selector:{entity:{}}},Ie]},{title:"Behavior",icon:"mdi:tune",fields:[{name:"active_state",label:"Active state",helper:"State(s) considered active (defaults by domain)",selector:{text:{}}},{name:"morph_on_active",label:"Morph shape when active",selector:{boolean:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Default action",selector:{ui_action:{}}}]}]}_renderExtra(){const e=this._actionRows||[];return I`
      ...
      ${e.map((e,t)=>I`
        ...
        `)}
    `}get _mappingSchema(){return[{name:"state",required:!0,helper:"Use 'default' for the fallback",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}_toggleExpand(e){this._expanded=this._expanded===e?null:e}_addMapping(){this._actionRows=[...this._actionRows||[],{state:""}],this._expanded=this._actionRows.length-1}_updateMapping(e,t){this._actionRows=(this._actionRows||[]).map((i,s)=>s===e?{...i,...t}:i),this._commitActionRows()}_removeMapping(e){this._actionRows=(this._actionRows||[]).filter((t,i)=>i!==e),this._expanded===e&&(this._expanded=null),this._commitActionRows()}_commitActionRows(){const e={};for(const t of this._actionRows||[])t.state&&t.tap_action&&(e[t.state]=t.tap_action);const{tap_action_map:t,...i}=this._config;this._commit(Object.keys(e).length?{...i,tap_action_map:e}:i)}}customElements.define("materia-button-editor",Cs);const Ss={"filled-tonal":"tonal",standard:"text"},zs={light:"on",switch:"on",fan:"on",input_boolean:"on",vacuum:"cleaning",lock:["locked","locking"],cover:"open",climate:"heat",media_player:"playing"};class Ts extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedIcon:{state:!0},_resolvedLabel:{state:!0},_resolvedSubtitle:{state:!0},_resolvedDisabled:{state:!0}};static styles=$s;static getConfigElement(){return document.createElement("materia-button-editor")}static getStubConfig(){return{icon:"mdi:play",variant:"filled",size:"m",shape:"round"}}setConfig(e){if(!e.icon&&!e.label)throw new Error("icon or label is required");this.config={variant:"filled",size:"m",shape:"round",...e},this.toggleAttribute("wide",!!e.wide)}get _disabled(){const e=this.config?.disabled_when??this.config?.disabled;if(null==e)return!1;if("boolean"==typeof e)return e;if(Array.isArray(e))return oi(e,this.hass);if(this._isTemplate(e)){const e=this._resolvedDisabled;return"True"===e||"true"===e||"1"===e}return"true"===e||"True"===e}updated(e){e.has("config")&&(this.toggleAttribute("wide",!!this.config?.wide),null!=this.config?.flex&&(this.style.flex=String(this.config.flex))),e.has("hass")&&this.hass&&(this._resolveField("icon","_resolvedIcon"),this._resolveField("label","_resolvedLabel"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField(null!=this.config?.disabled_when?"disabled_when":"disabled","_resolvedDisabled"))}_isActive(e){if(!e)return!1;const t=e.entity_id.split(".")[0],i=this.config.active_state??zs[t]??"on";return Array.isArray(i)?i.includes(e.state):e.state===String(i)}_defaultTapAction(){return this.config.entity?{action:"toggle"}:{action:"none"}}_resolveTapAction(){if(this.config.tap_action_map&&this.config.entity){const e=this.hass?.states[this.config.entity]?.state,t=this.config.tap_action_map[e]??this.config.tap_action_map.default;if(t)return t}return this.config.tap_action||this._defaultTapAction()}_handleTap(){this._disabled||this._handleAction(this._resolveTapAction())}render(){if(!this.config)return I``;const e=this.config.entity?this.hass?.states?.[this.config.entity]:void 0,t=!!this.config.entity&&this._isUnavailable(e),i=this._disabled,s=Ss[this.config.variant]||this.config.variant||"filled",n=["primary","secondary","tertiary","error"].includes(this.config.role)?this.config.role:"",a=this.config.size??"m";let o="",r="";if("number"==typeof a||/^\d+$/.test(String(a))){const e=Number(a);r=`--mb-h:${e}px;--mb-icon:${Math.round(.43*e)}px;--mb-font:16px;--mb-px:${Math.round(.42*e)}px;--mb-rsq:${Math.round(.28*e)}px;--mb-gap:8px;`}else o=`size-${a}`;const l="square"===this.config.shape?"square":"round",c=this._isActive(e),h=this.config.morph_on_active&&c?"square":l,d=this._isTemplate(this.config.icon)?this._resolvedIcon||"":this.config.icon,p=this._isTemplate(this.config.label)?this._resolvedLabel||"":this.config.label,u=this._isTemplate(this.config.subtitle)?this._resolvedSubtitle||"":this.config.subtitle,m="stacked"===this.config.layout,g=!p&&!u;return I`
      <button
        class="btn variant-${s} ${n?`role-${n}`:""} ${o} shape-${h} ${this.config.connected?`connected-${this.config.connected}`:""} ${g?"icon-only":""} ${m?"stacked":""} ${i?"disabled":""} ${t?"unavailable":""}"
        style=${r}
        @click=${this._handleTap}
      >
        ${d?I`<ha-icon .icon=${d}></ha-icon>`:V}
        ${p||u?I`<span class="text">
              ${p?I`<span class="label">${p}</span>`:V}
              ${u?I`<span class="sub">${u}</span>`:V}
            </span>`:V}
      </button>
    `}getCardSize(){return 1}}customElements.define("materia-button",Ts),window.customCards=window.customCards||[],window.customCards.push({type:"materia-button",name:"Materia Button",description:"M3 button — icon and/or label, variants, sizes, shapes, and shape-morph on state.",preview:!0});const Es=[Ee,a`
  ...
  `];class As extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .opt-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null}_formData(){return{variant:"tonal",size:"s",menu_position:"bottom-right",...this._config}}get _sections(){return[{title:"Leading button",icon:"mdi:card-text-outline",fields:[{name:"icon",template:!0,selector:{icon:{}}},{name:"label",template:!0,selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{default_action:"more-info"}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"variant",selector:{select:{mode:"dropdown",options:[{value:"filled",label:"Filled"},{value:"tonal",label:"Tonal"},{value:"elevated",label:"Elevated"},{value:"outlined",label:"Outlined"}]}}},{name:"size",selector:{select:{mode:"dropdown",options:[{value:"xs",label:"Extra small"},{value:"s",label:"Small"},{value:"m",label:"Medium"},{value:"l",label:"Large"},{value:"xl",label:"Extra large"}]}}},{name:"menu_position",label:"Menu alignment",selector:{select:{mode:"dropdown",options:[{value:"bottom-right",label:"Below · right-aligned"},{value:"bottom-left",label:"Below · left-aligned"},{value:"top-right",label:"Above · right-aligned"},{value:"top-left",label:"Above · left-aligned"}]}}},{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}_optionSchema(e){return[Le(e?.icon)?{name:"icon",selector:{template:{}}}:{name:"icon",selector:{icon:{}}},{name:"label",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}_renderExtra(){const e=Array.isArray(this._config.options)?this._config.options:[];return I`
      ...
      ${De((e,t)=>this._moveOption(e,t),e.map((e,t)=>I`
            <div class="opt-card">
              <div class="opt-row">
                <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
                <span>${e.label||(e.icon&&!Le(e.icon)?e.icon:`Option ${t+1}`)}</span>
    ...
    `}getCardSize(){return 1}}customElements.define("materia-split-button",Ds),window.customCards=window.customCards||[],window.customCards.push({type:"materia-split-button",name:"Materia Split Button",description:"M3 Expressive split button — a main action plus a menu of related actions.",preview:!0});class qs extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null}_formData(){return{group:"connected",size:"m",variant:"tonal",...this._config}}_sectionsSignature(){return`${this._config?.group||""}|${this._config?.preset||""}|${this._config?.multi_select?1:0}`}get _sections(){const e="standard"===this._config?.group,t=[...Object.keys(xs).map(e=>({value:e,label:e.charAt(0).toUpperCase()+e.slice(1).replace(/-/g," ")})),{value:"custom",label:"Custom"}],i=[{title:"Setup",icon:"mdi:tune",fields:[{name:"group",label:"Configuration",selector:{select:{mode:"dropdown",options:[{value:"connected",label:"Connected (segmented, entity-driven)"},{value:"standard",label:"Standard (spaced row of buttons)"}]}}},...e?[]:[{name:"entity",selector:{entity:{}}},{name:"attribute",selector:{text:{}}},{name:"preset",label:"Color preset",selector:{select:{mode:"dropdown",options:t}}}],{name:"size",label:"Size (applies to the whole group)",selector:{select:{mode:"dropdown",options:[{value:"xs",label:"XS (32dp)"},{value:"s",label:"S (40dp)"},{value:"m",label:"M (56dp)"},{value:"l",label:"L (96dp)"},{value:"xl",label:"XL (136dp)"}]}}},{name:"variant",label:"Style",selector:{select:{mode:"dropdown",options:[{value:"filled",label:"Filled"},{value:"tonal",label:"Tonal"}]}}},...e?[]:[{name:"multi_select",label:"Multi-select",selector:{boolean:{}}}],...!e&&this._config?.multi_select?[{name:"columns",label:"Max columns",selector:{number:{min:1,max:8,mode:"box"}}}]:[]]}];return i.push({title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}),"custom"===this._config?.preset&&i.push({title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color_active",label:"Active color",color:!0,template:!0,selector:{text:{}}},{name:"color_on_active",label:"Active text color",color:!0,template:!0,selector:{text:{}}}]}),i}get _optionSchema(){return[{name:"label",selector:{text:{}}},{name:"entity",label:"Entity (optional — this button's own state)",selector:{entity:{}}},{name:"value",label:"Value (state that = active; blank = on/truthy)",selector:{text:{}}},{name:"active",label:"Active template (overrides everything, e.g. attribute logic)",template:!0,selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{default_action:"call-service"}}}]}get _buttonSchema(){return[{name:"label",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}}},{name:"entity",label:"Entity (optional — drives active state)",selector:{entity:{}}},{name:"variant",selector:{select:{mode:"dropdown",options:[{value:"filled",label:"Filled"},{value:"tonal",label:"Tonal"}]}}},{name:"wide",label:"Wide (stretch to share the row)",selector:{boolean:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{default_action:"call-service"}}}]}get _listKey(){return"standard"===this._config?.group?"buttons":"options"}_renderExtra(){const e=this._listKey,t="buttons"===e,i=this._config[e]||[],s=t?this._buttonSchema:this._optionSchema;return I`
      ...
      ${De((e,t)=>this._moveOption(e,t),i.map((e,i)=>I`
            <div class="option-card">
              <div class="option-header">
                <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
          ...
          `))}
    `}_addOption(){const e=this._listKey,t=[...this._config[e]||[],"buttons"===e?{icon:"",variant:"tonal"}:{label:"",value:"",icon:""}];this._expanded=t.length-1,this._commit({...this._config,[e]:t})}_removeOption(e){const t=this._listKey,i=[...this._config[t]||[]];i.splice(e,1),this._expanded===e&&(this._expanded=null),this._commit({...this._config,[t]:i})}_moveOption(e,t){const i=this._listKey,s=[...this._config[i]||[]],[n]=s.splice(e,1);s.splice(t,0,n),this._expanded===e&&(this._expanded=t),this._commit({...this._config,[i]:s})}_updateOptionForm(e,t){const i=this._listKey,s=[...this._config[i]||[]];s[e]={...s[e],...t},this._commit({...this._config,[i]:s})}_toggleExpand(e){this._expanded=this._expanded===e?null:e}}customElements.define("materia-button-group-editor",qs);const Ps=new Set(["split","split-button","materia-split-button"]);class Rs extends(ci(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},value:{type:String},_localValue:{state:!0},_optimisticValue:{state:!0},_optimisticEntities:{state:!0},_resolvedColorActive:{state:!0},_resolvedColorOnActive:{state:!0}};static getConfigElement(){return document.createElement("materia-button-group-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("input_select.")||e.startsWith("select."))||"";return{entity:t,size:"m",options:[{label:"Option 1",value:"1"},{label:"Option 2",value:"2"}]}}static styles=[Te,ks,hi];setConfig(e){this.config={size:"m",...e}}get _resolvedOptions(){if(this.config.options?.length)return this.config.options;const e=this.hass?.states[this.config.entity],t=this.config.entity?.split(".")[0];return"input_select"!==t&&"select"!==t||!e?.attributes?.options?[]:e.attributes.options.map(e=>({label:this._capitalize(e),value:e,tap_action:{action:"perform-action",perform_action:`${t}.select_option`,data:{option:e},target:{entity_id:this.config.entity}}}))}get _activeValue(){if(!this.config?.entity)return this._localValue??String(this.value??"");if(null!=this._optimisticValue)return this._optimisticValue;const e=this.hass?.states[this.config.entity];return this.config.attribute?String(e?.attributes?.[this.config.attribute]??""):e?.state??""}_truthy(e){const t=String(e??"").toLowerCase();return""!==t&&!["off","closed","idle","standby","unavailable","unknown","not_home","false","0","none","auto_off"].includes(t)}_entityOptionActive(e){const t=e.entity,i=this._optimisticEntities?.[t],s=this.hass?.states[t]?.state;if(null!=e.value&&""!==e.value){const t=String(e.value).toLowerCase();return i&&null!=i.value?i.value===t:String(s??"").toLowerCase()===t}return i&&null!=i.active?i.active:this._truthy(s)}_tplTruthy(e){if("boolean"==typeof e)return e;const t=String(e??"").trim().toLowerCase();return["true","on","yes","1","open","home","active"].includes(t)}_isOptionActive(e,t){if(null!=e.active)return this._isTemplate(e.active)?this._tplTruthy(this._tplResults?.[`optActive${t}`]):this._tplTruthy(e.active);if(e.entity)return this._entityOptionActive(e);if(this.config.multi_select){const t=this._activeValue.split(",").map(e=>e.trim().toLowerCase()).filter(Boolean);return t.includes(String(e.value).toLowerCase())}return String(e.value)===this._activeValue}_getActiveColors(){const e=this._resolvedColorActive||this.config.color_active,t=this._resolvedColorOnActive||this.config.color_on_active;return e&&t?{active:e,onActive:t}:this.config.preset&&xs[this.config.preset]?xs[this.config.preset]:xs.secondary}_renderStandard(){const e=this.config.gap??8,t=this.config.padding??4,i=this.config.size||"m";return I`
      <ha-card>
        <div class="row" style="gap: ${e}px; padding: ${t}px 0;">
          ${(this.config.buttons||[]).map(e=>{const t=Ps.has(e.type)||Array.isArray(e.options)&&e.options.length>0,{size:s,type:n,...a}=e,o={variant:"filled",...a,size:i};return t?I`<materia-split-button .hass=${this.hass} .config=${o}></materia-split-button>`:I`<materia-button .hass=${this.hass} .config=${o}></materia-button>`})}
        </div>
      </ha-card>
    `}render(){if(!this.hass||!this.config)return I``;if("standard"===this.config.group)return this._renderStandard();const e=this.config.entity?this.hass.states[this.config.entity]:void 0,t=!!e&&this._isUnavailable(e),i=this.config.size||"m",{height:s,innerCorner:n}=ws[i]||ws.m,a=s/2;this._activeValue;const o=this._getActiveColors(),r=this._resolvedOptions,l=this.config.variant||"tonal";if(!r.length)return I``;const c=this.config.multi_select,h=this.config.columns||0;return I`
      <ha-card>
        <div class="group ${t?"unavailable":""} ${c?"multi":""}"
          style="${c?`--btn-height: ${s}px;`:`height: ${s}px;`} ${h?`--btn-columns: ${h};`:""}">
          ${r.map((e,t)=>{const i=this._isOptionActive(e,t),d=0===t,p=t===r.length-1,u="square"===this.config.active_shape,m=u?Math.min(n,Math.max(6,Math.round(.18*s))):a;let g;if(c)if(i)g=`${m}px`;else{const e=h||r.length,i=Math.floor(t/e),s=t%e,o=0===i,l=i===Math.ceil(r.length/e)-1,c=0===s,d=s===e-1||t===r.length-1;g=`${o&&c?a:n}px ${o&&d?a:n}px ${l&&d?a:n}px ${l&&c?a:n}px`}else{const e=i?`${m}px`:`${n}px`,t=i&&u?`${m}px`:`${a}px`;g=1===r.length?t:d?`${t} ${e} ${e} ${t}`:p?`${e} ${t} ${t} ${e}`:e}const f=i?o.active:void 0,_=i?o.onActive:void 0;return I`
              <button
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bs=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Bs(e,t);return!0},Is=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Hs=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Gs(t)}};function Ws(e){void 0!==this._$AN?(Is(this),this._$AM=e,Hs(this)):this._$AM=e}function Vs(e,t=!1,i=0){const s=this._$AH,n=this._$AN;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Bs(s[e],!1),Is(s[e]);else null!=s&&(Bs(s,!1),Is(s));else Bs(this,e)}const Gs=e=>{e.type==Ls&&(e._$AP??=Vs,e._$AQ??=Ws)};class Xs extends js{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Hs(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Bs(this,e),Is(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ys=new WeakMap,Ks=Us(class extends Xs{render(e){return V}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),V}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Ys.get(t);void 0===i&&(i=new WeakMap,Ys.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Ys.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class Zs extends He{static properties={_expandedButton:{state:!0},_expandedOption:{state:!0}};static styles=[He.styles,a`
      .section-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expandedButton??=null}_formData(){return{gap:8,padding:4,...this._config}}get _sections(){return[{title:"Layout",icon:"mdi:tune",fields:[]}]}_renderExtra(){const e=this._config.buttons||[];return I`
      ...
      ${De((e,t)=>this._moveButton(e,t),e.map((e,t)=>I`
          <div class="button-card">
            <div class="button-header" @click=${()=>this._toggleButton(t)}>
              <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
              <span>${e.icon&&!Le(e.icon)?e.icon:`Button ${t+1}`}${e.options?.length?" · split":""}</span>
              <ha-icon-button @click=${e=>{e.stopPropagation(),this._toggleButton(t)}}>
                <ha-icon icon=${this._expandedButton===t?"mdi:chevron-up":"mdi:chevron-down"}></ha-icon>
              </ha-icon-button>
              <ha-icon-button @click=${e=>{e.stopPropagation(),this._removeButton(t)}}>
            ...
            ${this._expandedButton===t?I`
                  <div class="button-body">
                    <materia-button-editor
                      .hass=${this.hass}
                      ${Ks(i=>{i&&i.__materiaIdx!==t&&(i.__materiaIdx=t,i.setConfig(e))})}
                    ...
                    ${e.options?.length?I`<ha-form
                        ...
                        ></ha-form>`:""}
                    ${De((e,i)=>this._moveOption(t,e,i),(e.options||[]).map((e,i)=>I`
                          <div class="opt-card">
                            <div class="opt-row">
                              <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
                              <span>${e.label||(e.icon&&!Le(e.icon)?e.icon:`Option ${i+1}`)}</span>
        ...
        `))}
    `}_moveButton(e,t){const i=[...this._config.buttons||[]],[s]=i.splice(e,1);i.splice(t,0,s),this._expandedButton=null,this._commit({...this._config,buttons:i})}_toggleButton(e){this._expandedButton=this._expandedButton===e?null:e}_addButton(){const e=[...this._config.buttons||[],{icon:"mdi:star",variant:"filled",size:"default"}];this._expandedButton=e.length-1,this._commit({...this._config,buttons:e})}_removeButton(e){const t=[...this._config.buttons||[]];t.splice(e,1),this._expandedButton===e&&(this._expandedButton=null),this._commit({...this._config,buttons:t})}_buttonChanged(e,t){const i=[...this._config.buttons||[]],s=i[e]?.options;i[e]=s&&!t.options?{...t,options:s}:t,this._commit({...this._config,buttons:i})}_optionSchema(e){return[Le(e?.icon)?{name:"icon",selector:{template:{}}}:{name:"icon",selector:{icon:{}}},{name:"label",selector:{text:{}}},{name:"tap_action",label:"Action",selector:{ui_action:{}}}]}_withButtonOptions(e,t){const i=[...this._config.buttons||[]],s={...i[e]},n=[...s.options||[]];t(n),n.length?s.options=n:delete s.options,i[e]=s,this._commit({...this._config,buttons:i})}_addOption(e){this._withButtonOptions(e,e=>{e.push({icon:"mdi:circle-outline"}),this._expandedOption=e.length-1})}_removeOption(e,t){this._expandedOption===t&&(this._expandedOption=null),this._withButtonOptions(e,e=>e.splice(t,1))}_moveOption(e,t,i){this._withButtonOptions(e,e=>{const[s]=e.splice(t,1);e.splice(i,0,s)}),this._expandedOption===t&&(this._expandedOption=i)}_optionChanged(e,t,i){this._withButtonOptions(e,e=>{e[t]={...e[t],...i}})}_toggleOption(e){this._expandedOption=this._expandedOption===e?null:e}}customElements.define("materia-icon-row-editor",Zs);customElements.define("materia-icon-row",class extends Rs{static getConfigElement(){return document.createElement("materia-icon-row-editor")}setConfig(e){super.setConfig({...e,group:"standard"})}});const Qs=[Ee,ze,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class Js extends He{static styles=[He.styles,a`
      .remap-row {
        display: flex;
        align-items: center;
        gap: 6px;
    ...
    `];_formData(){return{gesture:"slide",shape:!0,shape_style:"cookie9",initial_locked:!0,unlock_service:"unlock",...this._config}}_sectionsSignature(){return`${this._config?.gesture||"slide"}|${this._config?.entity?.split(".")[0]||""}|${this._config?.open_action?"o":""}`}get _sections(){const e="hold"===this._config?.gesture,t=!!this._config?.entity,i=!!this._config?.entity?.startsWith("lock."),s=!!this._config?.open_action;return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Lock (optional)",helper:"Leave empty to run self-contained — the card keeps its own state, with nothing to control.",selector:{entity:{domain:["lock","switch","input_boolean"]}}},...i?[{name:"unlock_service",label:"Unlatch service",helper:'Open is for strikes/relays that don\'t stay meaningfully "unlocked" — the door swings rather than sitting unlatched (lock.open instead of lock.unlock). Locking always uses lock.lock.',selector:{select:{mode:"dropdown",options:[{value:"unlock",label:"Unlock (lock.unlock)"},{value:"open",label:"Open (lock.open)"}]}}}]:[],{name:"gesture",label:"Commit gesture",selector:{select:{mode:"dropdown",options:[{value:"slide",label:"Slide the handle across"},{value:"hold",label:"Press and hold"}]}}},{name:"shape",label:"Show the morphing lock shape",selector:{boolean:{}}}]},{title:"Open button",icon:"mdi:door-open",expanded:s,fields:[{name:"open_action",label:"Open action",helper:"A separate, extra action available ONLY once unlocked (a relay pulse, a multi-step let-them-in sequence) — never a substitute for the gesture above, and disabled entirely while locked. Leave empty to hide the button.",selector:{ui_action:{default_action:"none"}}},...s?[{name:"open_button_icon",label:'Icon (default "door-open")',selector:{icon:{}}},{name:"open_button_label",label:'Label (default "Open")',selector:{text:{}}}]:[]]},{title:"Behaviour",icon:"mdi:cog-outline",fields:[...e?[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}}]:[],...t?[{name:"locked_state",label:"State that means locked",helper:'Defaults to "locked" for a lock and "off" for a switch — a relay strike is energised to release the door.',selector:{text:{}}},{name:"pending_timeout_ms",label:"Give up waiting for the lock after (ms, default 10000)",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}}]:[{name:"initial_locked",label:"Start out locked",selector:{boolean:{}}}]]},{title:"Labels",icon:"mdi:text-short",fields:[...e?[{name:"unlock_hold_hint",label:'While locked (default "Hold to unlock")',selector:{text:{}}},{name:"lock_hold_hint",label:'While unlocked (default "Hold to lock")',selector:{text:{}}}]:[{name:"unlock_hint",label:'While locked (default "Slide to unlock")',selector:{text:{}}},{name:"lock_hint",label:'While unlocked (default "Slide to lock")',selector:{text:{}}}],...t?[{name:"locking_label",label:'While locking (default "Locking…")',selector:{text:{}}},{name:"unlocking_label",label:'While unlocking (default "Unlocking…")',selector:{text:{}}},{name:"jammed_label",label:'When jammed (default "Jammed — check the door")',selector:{text:{}}}]:[{name:"demo_label",label:'Self-contained note (default "Demo · no entity")',selector:{text:{}}}]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"unlocked_color",label:"Background while unlocked",color:!0,selector:{text:{}}},{name:"unlocked_color_on",label:"Text while unlocked",color:!0,selector:{text:{}}},{name:"locked_color",label:"Background while locked",color:!0,selector:{text:{}}},{name:"locked_color_on",label:"Text while locked",color:!0,selector:{text:{}}},{name:"accent",label:"Accent (locked glyph and handle)",color:!0,selector:{text:{}}},{name:"accent_on",label:"Ink on the accent",color:!0,selector:{text:{}}},{name:"locked_icon",label:"Icon while locked",selector:{icon:{}}},{name:"unlocked_icon",label:"Icon while unlocked",selector:{icon:{}}},...t?[{name:"open_icon",label:'Icon while literally open (default "door-open")',helper:"Rides on top of the unlocked colour, never its own — only the glyph changes.",selector:{icon:{}}},{name:"jammed_color",label:"Background while jammed (default error container)",color:!0,selector:{text:{}}},{name:"jammed_color_on",label:"Text while jammed",color:!0,selector:{text:{}}},{name:"jammed_icon",label:'Icon while jammed (default "warning")',selector:{icon:{}}}]:[]]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Tapping the shape",selector:{ui_action:{default_action:"more-info"}}}]}]}get _showRemapList(){return!!this._config?.entity}_remapEntries(){const e=this._config?.state_remap||{};return Object.entries(e).map(([e,t])=>({from:e,to:t}))}_commitRemap(e){const t={};for(const i of e)i.from&&(t[i.from]=i.to??"");this._commit({...this._config,state_remap:t})}_addRemap(){this._commitRemap([...this._remapEntries(),{from:"",to:""}])}_removeRemap(e){const t=[...this._remapEntries()];t.splice(e,1),this._commitRemap(t)}_updateRemapFrom(e,t){const i=[...this._remapEntries()];i[e]={...i[e],from:t},this._commitRemap(i)}_updateRemapTo(e,t){const i=[...this._remapEntries()];i[e]={...i[e],to:t},this._commitRemap(i)}_renderExtra(){if(!this._showRemapList)return"";const e=this._remapEntries();return I`
      ...
      ${e.map((e,t)=>I`
        ...
        `)}
    `}}customElements.define("materia-lock-editor",Js);const en={squircle:{vector:!1,rot:45},cookie9:{vector:!0,rot:20,path:()=>ot(90,90,86,9)},pill:{vector:!0,rot:45,path:()=>function(e,t,i,s=0){return pt(e,t,i,{points:[{x:.961,y:.039,r:.426},{x:1.001,y:.428,r:0},{x:1,y:.609,r:1}],reps:2,mirroring:!0,rotate:s})}(90,90,172)},gem:{vector:!0,rot:90,path:()=>function(e,t,i,s=0){return pt(e,t,i,{points:[{x:.499,y:1.023,r:.241},{x:-.005,y:.792,r:.208},{x:.073,y:.258,r:.228},{x:.433,y:-0,r:.491}],reps:1,mirroring:!0,rotate:s})}(90,90,172)}};class tn extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_local:{state:!0},_spinning:{state:!0},_openSpin:{state:!0},_openPending:{state:!0}};static styles=Qs;static getConfigElement(){return document.createElement("materia-lock-editor")}static getStubConfig(){return{gesture:"slide"}}setConfig(e){this.config={gesture:"slide",...e}}constructor(){super(),this._pending=null,this._local=null,this._openSpin=!1,this._openPending=!1}get _stateObj(){return this.config?.entity?this.hass?.states[this.config.entity]:null}get _selfContained(){return!this.config?.entity}get _rawState(){const e=String(this._stateObj?.state??""),t=this.config?.state_remap||{};return Object.prototype.hasOwnProperty.call(t,e)?t[e]:e}get _effectiveState(){return Ui(this._rawState,this._lastFamily,this._lockedState)}get _lockedState(){if(this.config.locked_state)return String(this.config.locked_state);const e=this.config.entity?.split(".")[0];return"switch"===e||"input_boolean"===e?"off":"locked"}get _entityLocked(){const e=this._stateObj;return!e||this._isUnavailable(e)?null:this._effectiveState===this._lockedState}get _locked(){if(this._selfContained)return this._local??!1!==this.config.initial_locked;const e=this._stateObj;return!e||this._isUnavailable(e)?this._local??!0:"unlocking"===this._effectiveState||this._effectiveState===this._lockedState}get _transitioning(){if(this._selfContained)return null;const e=this._effectiveState;return"locking"===e||"unlocking"===e||"jammed"===e?e:null!=this._pending?this._pending?"locking":"unlocking":null}updated(e){if(e.has("hass")&&(null!=this._pending&&this._entityLocked===this._pending&&(this._pending=null,clearTimeout(this._pendingTimer)),!this._selfContained)){const e=this._effectiveState;ji(e)||(this._lastFamily=e===this._lockedState?"locked":"unlocked"),!this._openPending||"open"!==e&&"opening"!==e||(this._openPending=!1,clearTimeout(this._openPendingTimer))}this._compensatePoseTurn(),this._syncSpin()}_compensatePoseTurn(){const e=!this._locked,t=this._lastPose;if(this._lastPose=e,void 0===t||t===e)return;if(!this._spinning||!this._spins)return;const i=this._shapeStyle.rot;if(this._spinDeg=(this._spinDeg??0)+(e?-i:i),this._applySpin(),"stop"===this._spinMode){const e=Math.min(1,(performance.now()-this._stopT0)/this._stopDur),t=2*(this._stopTo-this._stopFrom)*(1-e)/(this._stopDur/1e3);this._planStop(this._spinDeg,Math.max(t,8))}}get _shapeStyle(){return en[this.config.shape_style]??en.cookie9}get _spins(){const e=this._shapeStyle;return e.vector&&2*e.rot<=45&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches}get _inFlight(){const e=this._transitioning;return"locking"===e||"unlocking"===e}_syncSpin(){this._inFlight&&this._spins?this._spinUp():this._spinDown()}_spinUp(){if("ramp"===this._spinMode||"cruise"===this._spinMode)return;const e="stop"===this._spinMode;if(this._spinMode="ramp",this._spinning=!0,this._spinDeg=this._spinDeg??0,this._spinVel=e?0:this._spinVel??0,this._spinRaf)return;let t=performance.now();const i=e=>{const s=Math.min(.05,(e-t)/1e3);if(t=e,"ramp"===this._spinMode)this._spinVel=Math.min(40,this._spinVel+80*s),this._spinVel>=40&&(this._spinMode="cruise"),this._spinDeg+=this._spinVel*s;else if("cruise"===this._spinMode)this._spinDeg+=40*s;else{if("stop"!==this._spinMode)return void(this._spinRaf=null);{const t=Math.min(1,(e-this._stopT0)/this._stopDur),i=1-(1-t)*(1-t);if(this._spinDeg=this._stopFrom+(this._stopTo-this._stopFrom)*i,t>=1)return this._spinDeg=this._stopTo%360,this._applySpin(),this._spinMode=null,this._spinVel=0,this._spinning=!1,void(this._spinRaf=null)}}this._applySpin(),this._spinRaf=requestAnimationFrame(i)};this._spinRaf=requestAnimationFrame(i)}_spinDown(){"ramp"!==this._spinMode&&"cruise"!==this._spinMode||this._planStop(this._spinDeg??0,Math.max(this._spinVel??40,8))}_planStop(e,t){const i=2*this._shapeStyle.rot,s=.55*t/2;let n=Math.ceil((e+s)/i)*i;2*(n-e)/t>2.6&&(n=e+s),this._stopFrom=e,this._stopTo=n,this._stopDur=2*(n-e)/t*1e3,this._stopT0=performance.now(),this._spinMode="stop"}_applySpin(){const e=this.shadowRoot?.querySelector(".shape");e?.style.setProperty("--ml-spin",(this._spinDeg%360).toFixed(2)+"deg")}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._pendingTimer),clearTimeout(this._openSpinTimer),clearTimeout(this._openPendingTimer),this._spinRaf&&cancelAnimationFrame(this._spinRaf),this._spinRaf=null,this._spinMode=null}_spinOpenShape(){clearTimeout(this._openSpinTimer),this._openSpin=!1,requestAnimationFrame(()=>{this._openSpin=!0,this._openSpinTimer=setTimeout(()=>{this._openSpin=!1},650)})}_confirm(){const e=!this._locked;if(this._selfContained)return void(this._local=e);this._pending=e,clearTimeout(this._pendingTimer),this._pendingTimer=setTimeout(()=>{this._pending=null},this.config.pending_timeout_ms??1e4);const t=this.config.entity,i=t.split(".")[0];if("lock"===i){Li.publish(t,e?"locking":"unlocking",this._stateObj?.state);const i="open"===this.config.unlock_service?"open":"unlock";this._callService("lock",e?"lock":i,{entity_id:t})}else{const s="off"===this._lockedState,n=e?!s:s;this._callService(i,n?"turn_on":"turn_off",{entity_id:t})}}_openTap(){!this._locked&&this.config.open_action&&(this._spinOpenShape(),this._selfContained||(this._openPending=!0,clearTimeout(this._openPendingTimer),this._openPendingTimer=setTimeout(()=>{this._openPending=!1},this.config.pending_timeout_ms??1e4),Li.publish(this.config.entity,"open",this._stateObj?.state)),this._handleAction(this.config.open_action))}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(this.config.entity&&!e)return I`<ha-card><div class="body">
        <div class="pending">${ke("entity_not_found_with_id",this.hass,{entity:this.config.entity})}</div>
      </div></ha-card>`;const t=!!e&&this._isUnavailable(e),i=this._locked,s=this._transitioning,n="locking"===s||"unlocking"===s,a="jammed"===s,o=a?this.config.jammed_color??"var(--md-sys-color-error-container)":i?this.config.locked_color??"var(--md-sys-color-surface-container-low, var(--card-background-color))":this.config.unlocked_color??"var(--md-sys-cust-color-device, var(--md-sys-color-primary-container))",r=a?this.config.jammed_color_on??"var(--md-sys-color-on-error-container)":i?this.config.locked_color_on??"var(--md-sys-color-on-surface)":this.config.unlocked_color_on??"var(--md-sys-cust-color-on-device, var(--md-sys-color-on-primary-container))",l=this.config.accent??"var(--md-sys-color-primary)",c=this.config.accent_on??"var(--md-sys-color-on-primary)",h=a?o:i?`color-mix(in srgb, ${r} 12%, transparent)`:r,d=a?r:i?l:o,p=a?r:i?l:r,u=a?o:i?c:o,m=!this._selfContained&&(this._openPending||"open"===this._effectiveState||"opening"===this._effectiveState),g=a?this.config.jammed_icon??"m3o:warning":m?this.config.open_icon??"m3o:door-open":i?this.config.locked_icon??"m3o:lock":this.config.unlocked_icon??"m3o:lock-open-right",f=this._shapeStyle,_=i?this.config.unlock_hint??ke("lock_slide_to_unlock",this.hass):this.config.lock_hint??ke("lock_slide_to_lock",this.hass),b=i?this.config.unlock_hold_hint??ke("lock_hold_to_unlock",this.hass):this.config.lock_hold_hint??ke("lock_hold_to_lock",this.hass),v="hold"===this.config.gesture;return I`
      <ha-card
        class=${t?"unavailable":""}
        style="--ml-bg:${o};--ml-fg:${r};--ml-shape-bg:${h};--ml-shape-fg:${d};--ml-handle-bg:${p};--ml-handle-fg:${u};"
      >
        <div class="body">
          ${!1===this.config.shape?V:I`<div
              ...
              >
                <div
                  class="shape ${i?"":"unlocked"} ${a?"jammed":""} ${f.vector?"vector":""} ${n&&!this._spins?"working":""} ${this._spinning?"spinning":""} ${this._openSpin?"spin-once":""}"
          ...
          <materia-drag-confirm
            ...
            .label=${n?"locking"===s?this.config.locking_label??ke("lock_locking",this.hass):this.config.unlocking_label??ke("lock_unlocking",this.hass):v?b:_}
            .pending=${n}
          ...
          ${this.config.open_action?I`
                ...
                >
                  ...
                  <span>${this.config.open_button_label??ke("lock_open_button",this.hass)}</span>
                </button>
              `:V}

          ${a?I`<div class="pending">
                ${this.config.jammed_label??ke("lock_jammed_hint",this.hass)}
              </div>`:this._selfContained?I`<div class="demo-note">
                ${this.config.demo_label??ke("lock_demo_note",this.hass)}
              </div>`:V}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 5}}customElements.define("materia-lock",tn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-lock",name:"Materia Lock",description:"Lock shape that morphs square→circle, with a drag-to-confirm or hold-to-confirm gesture. Works with no entity.",preview:!0});
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const sn=Us(class extends js{constructor(){super(...arguments),this.key=V}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(((e,t=Ns)=>{e._$AH=t})(e),this.key=t),i}}),nn=[Ee,ze,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-schedule-editor",class extends He{_formData(){return{presentation:"inline",...this._config}}get _sections(){return[{title:"Setup",icon:"mdi:tune",fields:[{name:"name",label:"Eyebrow above the chosen moment",helper:'What is being scheduled — e.g. "Start cleaning".',selector:{text:{}}},{name:"presentation",label:"Presentation",helper:"Sheet drops the collapsed strip and renders the picker directly — for putting the card inside a browser_mod popup.",selector:{select:{mode:"dropdown",options:[{value:"inline",label:"Inline — collapsed strip that expands"},{value:"sheet",label:"Sheet — always open, for a modal"}]}}},{name:"empty_label",label:"Strip title when nothing is set",selector:{text:{}}},{name:"empty_sub",label:"Strip sub-line when nothing is set",selector:{text:{}}}]},{title:"Wiring",icon:"mdi:transit-connection-variant",fields:[{name:"confirm_action",label:"On confirm",helper:"Use $datetime, $date, $time, $duration, $weekdays, $repeat, $trigger, $label in the data.",selector:{ui_action:{default_action:"none"}}},{name:"trigger_action",label:"On confirm, trigger tab",helper:"Falls back to the confirm action when unset.",selector:{ui_action:{default_action:"none"}}},{name:"close_action",label:"How to dismiss the modal",helper:"Sheet presentation only. Defaults to browser_mod.close_popup.",selector:{ui_action:{default_action:"none"}}}]},{title:"Shortcuts",icon:"mdi:clock-fast",fields:[{name:"presets",label:'The "At a time" shortcuts',helper:'List of { label, offset: 90m|2h|1d } or { label, at: "09:00", days: 1 } or { label, at, weekday: 6 }. Each may carry its own tap_action. Empty for the built-in six.',selector:{object:{}}},{name:"minutes",label:"Minute options (default 0, 15, 30, 45)",selector:{object:{}}}]},{title:"Triggers",icon:"mdi:sensors",fields:[{name:"triggers",label:"Non-clock triggers",helper:"List of { key, name, sub, icon }. Leave empty for the built-in four.",selector:{object:{}}}]}]}});class an extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_open:{state:!0},_armed:{state:!0},_mode:{state:!0},_pick:{state:!0},_event:{state:!0},_customOpen:{state:!0},_viewY:{state:!0},_viewM:{state:!0},_date:{state:!0},_hour:{state:!0},_minute:{state:!0},_repeating:{state:!0},_days:{state:!0},_resolvedPending:{state:!0},_resolvedNextLabel:{state:!0},_resolvedNextSub:{state:!0}};static styles=nn;static getConfigElement(){return document.createElement("materia-schedule-editor")}static getStubConfig(){return{name:"Start cleaning"}}setConfig(e){this.config={presentation:"inline",default_mode:"clock",...e},this._modeTouched||(this._mode=this._modes[0])}get _isSheet(){return"sheet"===this.config.presentation}get _isSummary(){return"summary"===this.config.presentation}_tpl(e,t){const i=this.config[e];if(null==i)return null;const s=this._isTemplate(i)?this[t]:i,n=null==s?"":String(s).trim();return n.length?n:null}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&(this._resolveField("pending","_resolvedPending"),this._resolveField("next_label","_resolvedNextLabel"),this._resolveField("next_sub","_resolvedNextSub"),(this.config.schedules||[]).forEach((e,t)=>{null!=e.label&&this._resolveTemplateValue(`schedLabel${t}`,e.label)})),this.toggleAttribute("sheet",this._isSheet),this._syncFoldHeight()}constructor(){super();const e=new Date;this._open=!1,this._armed=null,this._mode="clock",this._pick=null,this._event=null,this._customOpen=!1,this._viewY=e.getFullYear(),this._viewM=e.getMonth(),this._date=e.getDate(),this._hour=9,this._minute=0,this._repeating=!1,this._days=[!0,!0,!0,!0,!0,!1,!1]}get _pickKey(){return this._pick}get _hasSelection(){return"event"===this._mode?null!=this._event:null!=this._pick}get _isWired(){return!!(this.config.confirm_action||this.config.trigger_action||(this.config.presets??[]).some(e=>e.tap_action)||(this.config.triggers??[]).some(e=>e.tap_action))}get _pending(){const e=this.config.pending;if(!e)return null;const t=this._isTemplate(e)?this._resolvedPending:e,i=null==t?"":String(t).trim();return i.length?i:null}get _modes(){const e=[];return!1!==this.config.show_time&&e.push("clock"),!1!==this.config.show_triggers&&e.push("event"),e.length||e.push("clock"),"event"===this.config.default_mode&&e.includes("event")?["event",...e.filter(e=>"event"!==e)]:e}get _lang(){return this.hass?.locale?.language||void 0}_pad(e){return String(e).padStart(2,"0")}_hhmm(e){return`${this._pad(e.getHours())}:${this._pad(e.getMinutes())}`}_dayTime(e){return`${new Intl.DateTimeFormat(this._lang,{weekday:"short"}).format(e)} ${this._hhmm(e)}`}get _defaultPresets(){return[{label:ke("sched_preset_1h",this.hass),offset:"1h"},{label:ke("sched_preset_4h",this.hass),offset:"4h"},{label:ke("sched_preset_tonight",this.hass),at:"23:00"},{label:ke("sched_preset_tomorrow",this.hass),at:"09:00",days:1,grow:1.4},{label:ke("sched_preset_noon",this.hass),at:"12:00"},{label:ke("sched_preset_saturday",this.hass),at:"10:00",weekday:6,grow:1.4}]}_resolvePreset(e,t){if(e.offset){const i=/^(\d+(?:\.\d+)?)\s*(m|h|d)$/i.exec(String(e.offset).trim());if(!i)return null;const s={m:6e4,h:36e5,d:864e5}[i[2].toLowerCase()];return new Date(t.getTime()+parseFloat(i[1])*s)}const i=/^(\d{1,2}):(\d{2})$/.exec(String(e.at??"").trim());if(!i)return null;const[s,n]=[Number(i[1]),Number(i[2])],a=new Date(t);if(a.setSeconds(0,0),a.setHours(s,n),null!=e.weekday){let i=(Number(e.weekday)%7-t.getDay()+7)%7;return 0===i&&a<=t&&(i=7),a.setDate(a.getDate()+i),a}return null!=e.days?(a.setDate(a.getDate()+Number(e.days)),a):(a<=t&&a.setDate(a.getDate()+1),a)}get _quick(){const e=new Date;return(this.config.presets??this._defaultPresets).map((t,i)=>{const s=this._resolvePreset(t,e);if(!s)return null;const n=s.toDateString()===e.toDateString();return{key:t.key??`p${i}`,name:t.label??"—",at:n?this._hhmm(s):this._dayTime(s),grow:t.grow??1,when:s,tap_action:t.tap_action}}).filter(Boolean)}get _defaultTriggers(){return[{key:"leave",label:ke("sched_trigger_leave",this.hass),secondary:ke("sched_trigger_leave_sub",this.hass),icon:"m3o:directions-walk"},{key:"empty",label:ke("sched_trigger_empty",this.hass),secondary:ke("sched_trigger_empty_sub",this.hass),icon:"m3o:person-off"},{key:"night",label:ke("sched_trigger_night",this.hass),secondary:ke("sched_trigger_night_sub",this.hass),icon:"m3o:bedtime"},{key:"sunset",label:ke("sched_trigger_sunset",this.hass),secondary:ke("sched_trigger_sunset_sub",this.hass),icon:"m3o:wb-twilight"}]}get _events(){return(this.config.triggers??this._defaultTriggers).map((e,t)=>({key:e.key??`t${t}`,name:e.label??e.name??"—",sub:e.secondary??e.sub??"",icon:e.icon??"m3o:sensors",tap_action:e.tap_action}))}get _describe(){if("event"===this._mode){const e=this._events.find(e=>e.key===this._event);return e?{head:e.name,sub:`${e.sub} · trigger`}:{head:ke("sched_pick_trigger",this.hass),sub:ke("sched_runs_whenever",this.hass)}}if("custom"===this._pick){const e=new Intl.DateTimeFormat(this._lang,{day:"numeric",month:"long"}).format(new Date(this._viewY,this._viewM,this._date));return{head:`${this._pad(this._hour)}:${this._pad(this._minute)}`,sub:e}}const e=this._quick.find(e=>e.key===this._pickKey);return e?{head:e.at,sub:e.name}:{head:ke("sched_when_question",this.hass),sub:ke("sched_pick_moment",this.hass)}}get _dayNames(){const e=new Intl.DateTimeFormat(this._lang,{weekday:"narrow"});return Array.from({length:7},(t,i)=>e.format(new Date(2024,0,1+i)))}get _tabConfig(){const e={clock:{label:this.config.time_tab_label??ke("sched_at_a_time",this.hass),value:"clock",icon:"m3o:schedule"},event:{label:this.config.trigger_tab_label??ke("sched_when_ellipsis",this.hass),value:"event",icon:"m3o:sensors"}};return{size:"m",preset:"primary",options:this._modes.map(t=>e[t])}}get _minuteConfig(){return{size:"s",preset:"primary",options:(this.config.minutes??[0,15,30,45]).map(e=>({label:this._pad(e),value:String(e)}))}}get _weekdayConfig(){return{size:"s",preset:"primary",multi_select:!0,active_shape:"square",options:this._dayNames.map((e,t)=>({label:e,value:String(t)}))}}get _resolvedWhen(){return"event"===this._mode?null:"custom"===this._pickKey?new Date(this._viewY,this._viewM,this._date,this._hour,this._minute,0,0):this._quick.find(e=>e.key===this._pickKey)?.when??null}_actionContext(){const e=this._resolvedWhen,t=e=>String(e).padStart(2,"0");let i="",s="",n="",a="";if(e){s=`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`,n=`${t(e.getHours())}:${t(e.getMinutes())}`,i=`${s} ${n}:00`;const o=Math.max(0,Math.round((e.getTime()-Date.now())/1e3));a=`${t(Math.floor(o/3600))}:${t(Math.floor(o%3600/60))}:${t(o%60)}`}return{datetime:i,date:s,time:n,duration:a,weekdays:this._repeating?["mon","tue","wed","thu","fri","sat","sun"].filter((e,t)=>this._days[t]):[],repeat:!!this._repeating,trigger:this._event??"",label:this._describe.head}}_fill(e,t){if("string"==typeof e){const i=/^\$(\w+)$/.exec(e.trim());return i&&i[1]in t?t[i[1]]:e.replace(/\$(\w+)/g,(e,i)=>i in t?String(t[i]):e)}return Array.isArray(e)?e.map(e=>this._fill(e,t)):e&&"object"==typeof e?Object.fromEntries(Object.entries(e).map(([e,i])=>[e,this._fill(i,t)])):e}_syncFoldHeight(){const e=this.shadowRoot?.querySelector(".custom-body");if(!e)return;const t=this.shadowRoot.querySelector(".custom-inner");e.style.height=this._customOpen&&t?`${t.scrollHeight}px`:"0px"}_seedCustom(){const e=this._quick.find(e=>e.key===this._pickKey)?.when??new Date(Date.now()+36e5);this._viewY=e.getFullYear(),this._viewM=e.getMonth(),this._date=e.getDate();const t=[...this.config.minutes??[0,15,30,45]].sort((e,t)=>e-t),i=e.getMinutes(),s=t.find(e=>e>=i);this._minute=s??t[0],this._hour=null==s?(e.getHours()+1)%24:e.getHours()}_dismiss(){if(this._open=!1,!this._isSheet)return;const e=this.config.close_action??{action:"fire-dom-event",browser_mod:{service:"browser_mod.close_popup",data:{}}};this._handleAction(e)}_commit(){if(!this._hasSelection)return;this._armed={...this._describe,repeating:this._repeating,mode:this._mode},this._open=!1;const e="event"===this._mode?this._events.find(e=>e.key===this._event):this._quick.find(e=>e.key===this._pickKey),t=e?.tap_action??("event"===this._mode?this.config.trigger_action:null)??this.config.confirm_action;t?this._handleAction(this._fill(t,this._actionContext())):this._fireHaptic("success"),this._isSheet&&this._dismiss()}_renderStrip(){const e=this._armed,t=e?e.head:this.config.empty_label??ke("sched_not_scheduled",this.hass),i=e?e.sub:this.config.empty_sub??ke("sched_tap_to_pick",this.hass),s=e?"event"===e.mode?"m3o:sensors":"m3o:alarm":"m3o:add";return I`
      ...
      >
        ...
        ${e?I`<button
            ...
            >${this.config.clear_label??ke("sched_clear",this.hass)}</button>`:V}
      </div>
    `}render(){if(!this.config)return I``;if(this._isSummary)return this._renderSummary();if(!this._open&&!this._isSheet)return I`<ha-card><div class="sheet">${this._renderStrip()}</div></ha-card>`;const e=this._pending,t=this._describe,i="clock"===this._mode;return I`
      <ha-card>
        <div class="sheet">
          <div class="echo">
            <span class="eyebrow">${this.config.name??ke("sched_name_default",this.hass)}</span>
            ${(()=>{const i=this._hasSelection?t.head:e??t.head,s=this._hasSelection?t.sub:e?this.config.pending_sub??ke("sched_pending_sub",this.hass):t.sub;return I`
                ${sn(i,I`<span class="headline swap">${i}</span>`)}
                ${sn(s,I`<span class="subline swap">${s}</span>`)}
              `})()}
          </div>
          ...
          ${e?I`<div class="strip pending-strip">
                ...
                <div class="text">
                  <span class="head">${this.config.pending_label??ke("sched_scheduled",this.hass)}</span>
                  <span class="sub">
                    ${this.config.pending_sub??ke("sched_pending_sub",this.hass)}
                  </span>
                </div>
                <button
                  class="strip-cancel"
                  @click=${()=>{const e=this.config.clear_action;e?this._handleAction(e):this._fireHaptic("success"),this._dismiss()}}
                >${this.config.clear_label??ke("sched_clear",this.hass)}</button>
              </div>`:V}
          ...
          <div class="repeat">
            ...
            <div class="text">
              ...
              <span class="n">${this.config.repeat_label??ke("sched_repeat_weekly",this.hass)}</span>
              ...
              <span class="s">${this._repeating?this.config.repeat_sub_on??ke("sched_repeat_sub_on",this.hass):this.config.repeat_sub_off??ke("sched_repeat_sub_off",this.hass)}</span>
            </div>
          </div>
          ...
          <div class="actions">
            <button class="cancel" @click=${this._dismiss}>
              ${this.config.close_label??ke("sched_close",this.hass)}
            </button>
            <button
              class="confirm"
            ...
            >
              ...
              <span>${this._repeating?ke("sched_save_schedule",this.hass):ke("sched_set_timer",this.hass)}</span>
            </button>
          </div>

          ${this._isWired?V:I`<div class="mock">${ke("sched_mocked_note",this.hass)}</div>`}
        </div>
      </ha-card>
        ...
        <div class="summary">
          ${e?I`<div class="strip armed">
                ...
                ${this.config.skip_action?I`<button
                    ...
                    >${this.config.skip_label??ke("sched_skip",this.hass)}</button>`:V}
              </div>`:V}
          ...
          ${i.length||this.config.add_action?I`<div class="rows">
                ...
                ${this.config.add_action?I`<button
                      class="row-add"
                      aria-label=${this.config.add_label??ke("sched_add",this.hass)}
    ...
    `}_renderClock(){return I`
      ...
      <div class="custom ${this._customOpen?"open":""}">
        ...
        >
          ...
          <span class="lbl">${ke("sched_pick_date_time",this.hass)}</span>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return this._open||this._isSheet?10:2}}customElements.define("materia-schedule",an),window.customCards=window.customCards||[],window.customCards.push({type:"materia-schedule",name:"Materia Schedule",description:"Shortcuts-first schedule picker — quick chips, non-clock triggers, and a calendar that stays folded until asked for. Mocked, no backend.",preview:!0});const on=[qi,a`
  ...
  `];class rn extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null}_formData(){return{variant:"hero",burst:!0,alert_tints_hero:!0,...this._config}}_sectionsSignature(){return this._config?.variant||""}get _sections(){return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",required:!0,selector:{entity:{domain:["select","input_select"]}}},{name:"name",label:"Eyebrow above the option name",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"variant",label:"Emphasis",helper:"Hero is the filled statement block; sidekick is its quiet companion for pages that already have a hero.",selector:{select:{mode:"dropdown",options:[{value:"hero",label:"Hero — filled, owns the panel"},{value:"sidekick",label:"Sidekick — quiet peer of the bars"}]}}},..."sidekick"===this._config?.variant?[]:[{name:"burst",label:"Show the decorative shape",selector:{boolean:{}}}],{name:"color",label:"Block background",color:!0,selector:{text:{}}},{name:"color_on",label:"Block text",color:!0,selector:{text:{}}}]},{title:"Alerts",icon:"mdi:alert-circle-outline",expanded:!1,fields:[{name:"alerts",label:"Alert strip",helper:"List of { entity?, state?, text (template), icon?, color?, tap_action? }. First match wins. A template that renders empty means no alert.",selector:{object:{}}},{name:"alert_tints_hero",label:"An alert recolours the whole block",selector:{boolean:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}get _optionSchema(){return[{name:"label",label:"Name (the big title when chosen)",selector:{text:{}}},{name:"short",label:"Pill label (defaults to the name)",selector:{text:{}}},{name:"value",label:"Select option value",selector:{text:{}}},{name:"secondary",label:"One line of consequence",selector:{text:{}}},{name:"icon",label:"Icon (shown when there is no route glyph)",selector:{icon:{}}},{name:"tap_action",label:"Action (overrides selecting the option)",selector:{ui_action:{}}}]}_renderExtra(){return I`
      ...
      ${De((e,t)=>this._moveOption(e,t),(this._config.options||[]).map((e,t)=>I`
            <div class="option-card">
              <div class="option-header">
                <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
    ...
    `}_toggleExpand(e){this._expanded=this._expanded===e?null:e}_addOption(){const e=[...this._config.options||[],{label:"",value:""}];this._expanded=e.length-1,this._commit({...this._config,options:e})}_removeOption(e){const t=[...this._config.options||[]];t.splice(e,1),this._expanded===e&&(this._expanded=null),this._commit({...this._config,options:t})}_moveOption(e,t){const i=[...this._config.options||[]],[s]=i.splice(e,1);i.splice(t,0,s),this._expanded===e&&(this._expanded=t),this._commit({...this._config,options:i})}_updateOptionForm(e,t){const i=[...this._config.options||[]];i[e]={...i[e],...t},this._commit({...this._config,options:i})}}customElements.define("materia-select-hero-editor",rn);class ln extends(is(ci(Pi(Se(ce))))){static properties={hass:{attribute:!1},config:{state:!0}};static styles=[on,hi];static getConfigElement(){return document.createElement("materia-select-hero-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("select.")||e.startsWith("input_select."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("Materia Select Hero: entity is required");this.config={...e}}get _stateObj(){return this.hass?.states[this.config.entity]}_optimisticActual(){const e=this._stateObj;return e?String(e.state):null}get _current(){return String(this._optimistic??"")}get _options(){if(this.config.options?.length)return this.config.options;const e=this._stateObj;return(e?.attributes?.options||[]).map(e=>({value:e,label:this._capitalize(String(e).replace(/_/g," "))}))}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&(this._resolveAlertTemplates(),this._optimisticReconcile());const t=this._current;t!==this._drawnFor&&(this._drawnFor=t,this._drawRoute())}_drawRoute(){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const e=this.shadowRoot?.querySelector(".route path");e?.animate?.([{strokeDashoffset:100},{strokeDashoffset:0}],{duration:620,easing:"cubic-bezier(0.2, 0, 0, 1)"})}_select(e){if(this._fireHaptic("selection"),null!=e.value&&this._optimisticSet(e.value),e.tap_action)return void this._handleAction(e.tap_action);const t=this.config.entity.split(".")[0];"select"!==t&&"input_select"!==t||this._callService(t,"select_option",{entity_id:this.config.entity,option:String(e.value)})}_onKeydown(e){if(!["ArrowRight","ArrowLeft","ArrowDown","ArrowUp","Home","End"].includes(e.key))return;const t=this._options;if(!t.length)return;e.preventDefault();const i=this._current,s=t.length;let n=t.findIndex(e=>String(e.value)===i);n<0&&(n=0);const a="Home"===e.key?0:"End"===e.key?s-1:"ArrowRight"===e.key||"ArrowDown"===e.key?(n+1)%s:(n-1+s)%s;this._select(t[a]),this.shadowRoot?.querySelectorAll(".pill")[a]?.focus()}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._isUnavailable(e),i=this._current,s=this._options,n=s.find(e=>String(e.value)===i)||null,a=this._activeAlert,o=this._shellPair(!1),r=a?.color||"var(--md-sys-cust-color-error-container, var(--md-sys-color-error-container))",l=a?.color_on||"var(--md-sys-cust-color-on-error-container, var(--md-sys-color-on-error-container))",c=a&&!1!==this.config.alert_tints_hero,h=c?r:this.config.color??o.bg,d=c?l:this.config.color_on??o.fg,p=n?.label??(e?this.hass.formatEntityState?.(e)??this._capitalize(i):"—");return I`
      ...
      >
        <div class="stack">
          ...
          ${this._renderAlertStrip(a,this.config.entity)}
        </div>
      </ha-card>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-select-hero",ln),window.customCards=window.customCards||[],window.customCards.push({type:"materia-select-hero",name:"Materia Select Hero",description:"A select whose current option owns the panel — glyph, name, one line of consequence, and the option pills in one block. A variant of Materia Hero.",preview:!0});const cn=[Ee,ze,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-heading-editor",class extends He{_formData(){return{heading_style:"title",...this._config}}get _sections(){return[{title:"Heading",icon:"mdi:format-title",fields:[{name:"heading",required:!0,selector:{text:{}}},{name:"heading_style",label:"Style",selector:{select:{mode:"dropdown",options:[{value:"title",label:"Title"},{value:"subtitle",label:"Subtitle"}]}}},{name:"icon",selector:{icon:{}}},{name:"secondary",label:"Right-aligned meta line",template:!0,selector:{text:{}}},{name:"tap_action",selector:{ui_action:{default_action:"none"}}}]}]}});class hn extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedSecondary:{state:!0}};static styles=cn;static getConfigElement(){return document.createElement("materia-heading-editor")}static getStubConfig(){return{heading:"Section"}}setConfig(e){this.config={...e}}updated(e){e.has("hass")&&this.hass&&this._resolveField("secondary","_resolvedSecondary")}get _secondary(){const e=this.config.secondary;if(null==e)return null;const t=this._isTemplate(e)?this._resolvedSecondary:e,i=null==t?"":String(t).trim();return i.length?i:null}render(){if(!this.config)return I``;const e="subtitle"===this.config.heading_style,t=this._secondary,i=!!this.config.tap_action;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-heading",hn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-heading",name:"Materia Heading",description:"Section heading in the family's display voice, with a templatable right-aligned meta line.",preview:!0});const dn=[Ee,ze,Te,ge,a`
    ha-card {
      background: var(--ha-card-background, var(--card-background-color));
      overflow: hidden;
      container-type: inline-size;
      ...
      <ha-card>
        ...
        <div class="body">
                ...
                `:this.config.buzz_action||this.config.lock?I`
                  <div class="doors">
                    ${this.config.buzz_action?I`
                          <div class="door ${a?"yes":""}">
                            <ha-icon .icon=${a?"m3o:check-circle":"m3o:bolt"}></ha-icon>
                            <span>${ke("db_eyebrow_street",this.hass)}</span>
                          </div>
                        `:V}
                    ${this.config.lock?I`
                          <div class="door ${this._unlockedNow?"yes":""}">
                            <ha-icon .icon=${this._unlockedNow?"m3o:lock-open-right":"m3o:door-front"}></ha-icon>
                            <span>${ke("db_eyebrow_front",this.hass)}</span>
                          </div>
                        `:V}
                  </div>
                `:V}
            ...
            ${this.config.buzz_action?I`
                  <div class="panel buzz ${i?"busy":""}" @click=${this._buzz}>
                    <div class="cookie-stage">
                      <svg class="wave one" viewBox="0 0 180 180"><path d=${pn}></path></svg>
                      <svg class="wave two" viewBox="0 0 180 180"><path d=${pn}></path></svg>
                      <svg class="cookie" viewBox="0 0 180 180"><path d=${pn}></path></svg>
                    ...
                    <div class="buzz-caption">
                      <span class="big">${this.config.buzz_title??ke("db_buzz_title",this.hass)}</span>
                      <span class="small">${this.config.buzz_sub??ke("db_buzz_sub",this.hass)}</span>
                    </div>
                  </div>
                `:V}
            ${this.config.lock?I`
                  <div class="panel open ${s?"done":""}">
                    <div class="open-head">
                      ...
                      <div class="open-copy">
                        <span class="big">${this.config.open_title??ke("db_open_title",this.hass)}</span>
                        <span class="small">${this.config.open_sub??ke("db_open_sub",this.hass)}</span>
                      </div>
                    </div>
                    <div class="open-spacer"></div>
                    <materia-drag-confirm
                      gesture=${"hold"===this.config.open_gesture?"hold":"slide"}
                      .label=${"unlocking"===this._lockState?ke("lock_unlocking",this.hass):"locking"===this._lockState?ke("lock_locking",this.hass):s&&!this.config.open_action?"hold"===this.config.open_gesture?ke("lock_hold_to_lock",this.hass):ke("lock_slide_to_lock",this.hass):"hold"===this.config.open_gesture?ke("db_hold_hint",this.hass):ke("db_slide_hint",this.hass)}
          ...
          ${this.config.ignore_action||this.config.replay_action||this.config.mute_entity?I`
                <div class="row">
                  ${this.config.ignore_action?I`<button class="lead" @click=${this._ignore}>${ke("db_ignore",this.hass)}</button>`:V}
                  ${this.config.mute_entity?I`
                        <button class=${l?"muted":""} @click=${this._toggleMute}>
                          <ha-icon .icon=${l?"m3o:volume-off":"m3o:volume-up"}></ha-icon>
                          ${ke(l?"db_muted":"db_mute",this.hass)}
                        </button>
                      `:V}
                  <span class="gap"></span>
                  ${this.config.replay_action?I`<button class="trail" @click=${this._replay}>${ke("db_replay",this.hass)}</button>`:V}
                </div>
              `:V}
        </div>
      </ha-card>
    `}getCardSize(){return 5}}customElements.define("materia-doorbell",mn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-doorbell",name:"Materia Doorbell",description:"Doorbell alert — countdown ring, tap-to-buzz, slide-to-unlock. Built for a browser_mod popup.",preview:!0});const gn=[Ee,ze,ge,a`
  ...
  `];class fn extends He{static properties={_expanded:{state:!0},_editingCard:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
      ...
      <div class="rail" role="tablist" aria-orientation=${i?"vertical":"horizontal"} style="height:${i?"auto":"48px"};">
        ${e.map((s,n)=>{const a=String(s.value??s.label),o=t===a,r=this._segmentRadius(n,e.length,o,i);return I`
            ...
            >
              ...
              <span class="label">${s.label??a}</span>
            </button>
          `})}
      </div>
    ...
    `:I`<ha-card>${s}</ha-card>`}getGridOptions(){return this._panes?{columns:12,rows:"auto"}:{columns:2,rows:"auto"}}getCardSize(){return this._panes?6:3}}customElements.define("materia-tabs",bn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-tabs",name:"Materia Tabs",description:"Vertical tab rail — the selected tab grows into the nav-rail indicator. Embed cards per tab, or pair with conditional cards.",preview:!0});const vn=[...di,a`
  ...
  `];class yn extends He{static properties={_editingCard:{state:!0}};static styles=[He.styles,a`
      .cards-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._editingCard??=null}connectedCallback(){super.connectedCallback(),this._loadHuiElements()}async _loadHuiElements(){if(customElements.get("hui-card-element-editor")&&customElements.get("hui-card-picker"))return;const e=await pe(),t=await e.createCardElement({type:"vertical-stack",cards:[]});await t.constructor.getConfigElement(),this.requestUpdate()}_formData(){return{expanded:!1,show_switch:!0,flat:!1,...this._config}}_sectionsSignature(){return this._config?.entity?"entity":"no-entity"}get _sections(){const e=!!this._config?.entity;return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",label:"Entity (optional)",helper:"With an entity the header wears an M3 switch and its state tones the row. Leave empty for a plain drawer.",selector:{entity:{}}},{name:"name",label:e?"Name / template (defaults to the friendly name)":"Name / template",required:!e,template:!0,selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"secondary",label:"Secondary text / template",template:!0,selector:{text:{}}}]},{title:"Behaviour",icon:"mdi:arrow-expand-vertical",fields:[{name:"expanded",label:"Open by default",selector:{boolean:{}}},{name:"show_switch",label:"Show the switch in the header",helper:"Only applies when an entity is set.",selector:{boolean:{}}},{name:"flat",label:"Flat (no card chrome — for nesting)",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Row color (e.g. escalate from state)",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon color",color:!0,template:!0,selector:{text:{}}},{name:"switch_color",label:"Switch track color when on",color:!0,template:!0,selector:{text:{}}},{name:"switch_color_on",label:"Switch thumb color when on",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Switch action (overrides toggling the entity)",selector:{ui_action:{default_action:"toggle"}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}_cards(){return Array.isArray(this._config?.cards)?this._config.cards:[]}_renderExtra(){if(null!=this._editingCard)return this._renderCardEditor();const e=this._cards();return I`
      ...
      ${De((e,t)=>this._moveCard(e,t),e.map((e,t)=>I`
            <div class="card-row">
              <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
              <span>${e?.type||"card"}</span>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return this._open&&this._cards?1+this._cards.length:1}}customElements.define("materia-expander",xn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-expander",name:"Materia Expander",description:"Switch row that opens — the one control that matters stays inline, everything else lives behind the chevron.",preview:!0});const wn=[Ee,ze,Te,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];customElements.define("materia-level-editor",class extends He{_formData(){return{...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"label",label:"Label",template:!0,selector:{text:{}}},{name:"attribute",label:"Attribute holding the level",helper:"Defaults per domain: volume_level, brightness, percentage, current_position. Leave empty for number helpers.",selector:{text:{}}},{name:"icon",label:"Leading icon",template:!0,selector:{icon:{}}}]},{title:"Range",icon:"mdi:ruler",secondary:"Left empty, these come from the entity",fields:[{name:"min",label:"Minimum (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"max",label:"Maximum (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"step",label:"Step (entity units)",selector:{number:{mode:"box",step:"any"}}},{name:"unit",label:"Unit shown after the value",helper:"Defaults to the entity's unit, or % for volume and brightness.",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Tile background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Content color on it",color:!0,template:!0,selector:{text:{}}},{name:"slider_color",label:"Active track & handle",color:!0,template:!0,selector:{text:{}}},{name:"slider_track_color",label:"Inactive track",color:!0,template:!0,selector:{text:{}}},{name:"hide_stops",label:"Hide the stop indicators",helper:"The small M3 dots at each end of the track. Shown by default.",selector:{boolean:{}}}]},{title:"Advanced",icon:"mdi:tune",fields:[{name:"service",label:"Override service (domain.service)",selector:{text:{}}},{name:"service_key",label:"Override service data key",selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});const kn={volume_level:{min:0,max:1,step:.01,factor:100,unit:"%"},brightness:{min:0,max:255,step:1,factor:100/255,unit:"%"},percentage:{min:0,max:100,step:1,factor:1,unit:"%"},current_position:{min:0,max:100,step:1,factor:1,unit:"%"}},$n={media_player:"volume_level",light:"brightness",fan:"percentage",cover:"current_position"},Cn={media_player:["media_player.volume_set","volume_level"],light:["light.turn_on","brightness"],number:["number.set_value","value"],input_number:["input_number.set_value","value"],fan:["fan.set_percentage","percentage"],cover:["cover.set_cover_position","position"]},Sn=(e,t)=>{const i=Number(e);return Number.isFinite(i)?i:t},zn=e=>{const t=String(e),i=t.indexOf(".");return i<0?0:Math.min(6,t.length-i-1)};class Tn extends(is(ci(Se(ce)))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedLabel:{state:!0},_resolvedIcon:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedSliderColor:{state:!0},_resolvedSliderTrackColor:{state:!0},_dragging:{state:!0}};static styles=[wn,hi];static getConfigElement(){return document.createElement("materia-level-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}),i=t.find(e=>e.startsWith("media_player."))||t.find(e=>e.startsWith("input_number."))||t.find(e=>e.startsWith("number."))||t.find(e=>e.startsWith("light."))||"";return{entity:i}}setConfig(e){if(!e.entity)throw new Error("Materia Level: entity is required");this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("label","_resolvedLabel"),this._resolveField("icon","_resolvedIcon"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("slider_color","_resolvedSliderColor"),this._resolveField("slider_track_color","_resolvedSliderTrackColor"),this._optimisticReconcile())}get _stateObj(){return this.hass?.states[this.config.entity]}get _domain(){return String(this.config.entity||"").split(".")[0]}get _attribute(){return this.config.attribute??$n[this._domain]??null}get _scale(){const e=this._stateObj?.attributes||{},t=kn[this._attribute]||{min:Sn(e.min,0),max:Sn(e.max,100),step:Sn(e.step,1),factor:1,unit:e.unit_of_measurement??""},i="percentage"===this._attribute?Sn(e.percentage_step,t.step):t.step;return{min:Sn(this.config.min,t.min),max:Sn(this.config.max,t.max),step:Sn(this.config.step,i),factor:t.factor,unit:this.config.unit??t.unit}}_optimisticActual(){const e=this._stateObj;if(!e)return null;const t=this._attribute?e.attributes?.[this._attribute]:e.state,i=Number(t);return Number.isFinite(i)?String(i):"light"===this._domain&&"off"===e.state?"0":null}get _current(){if(null!=this._dragging)return this._dragging;const e=Number(this._optimistic);return Number.isFinite(e)?e:null}_quantize(e,t){const{min:i,max:s,step:n}=t,a=n>0?Math.round((e-i)/n)*n+i:e,o=Math.min(s,Math.max(i,a));return Number(o.toFixed(zn(n)))}_display(e,t){if(null==e)return"—";const i=e*t.factor,s=1===t.factor?zn(t.step):0;return Number(i.toFixed(s)).toLocaleString(this.hass?.locale?.language||"en",{minimumFractionDigits:s,maximumFractionDigits:s})}_onDragging(e){e.stopPropagation();const t=Number(e.detail?.value);this._dragging=Number.isFinite(t)?t:null}_onCommit(e){e.stopPropagation();const t=Number(e.detail?.value);if(this._dragging=null,!Number.isFinite(t))return;const i=this._quantize(t,this._scale),s=this._stateObj;if(!s)return;const[n,a]=this._writeTarget();if(!n)return;if(this._fireHaptic("selection"),this._optimisticSet(i),!this.config.service&&"light"===this._domain&&i<=0)return void this._callService("light","turn_off",{entity_id:s.entity_id});const[o,r]=n.split(".");this._callService(o,r,{entity_id:s.entity_id,[a]:i})}_writeTarget(){if(this.config.service){const e=this.config.service_key||this._attribute||"value";return[String(this.config.service),e]}const e=Cn[this._domain];return e?[e[0],this.config.service_key||e[1]]:this._attribute?[`${this._domain}.set_${this._attribute}`,this.config.service_key||this._attribute]:[null,null]}_field(e,t){const i=this.config[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._scale,i=this._current,s=!e||this._isUnavailable(e)||"unknown"===e.state||null==i,n=this._field("label","_resolvedLabel")||e?.attributes?.friendly_name||this.config.entity,a=this._field("icon","_resolvedIcon"),o=this._field("color","_resolvedColor"),r=this._field("color_on","_resolvedColorOn"),l=this._field("slider_color","_resolvedSliderColor")||r||"var(--md-sys-color-primary, var(--primary-color))",c=this._field("slider_track_color","_resolvedSliderTrackColor")||"",h=this._display(i,t),d=t.unit;return I`
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 2}}customElements.define("materia-level",Tn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-level",name:"Materia Level",description:"Entity-bound level row with an M3 Expressive slider — volumes, dimmers, number helpers, fan speeds.",preview:!0});const En=[Ee,ze,Te,hi,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `],An=[{value:"home",label:"Home"},{value:"away",label:"Away"},{value:"night",label:"Night"},{value:"vacation",label:"Vacation"},{value:"custom",label:"Custom bypass"}];class Mn extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null}_formData(){return{hero:!0,footnote:!0,direct_switch:!1,zones_start_expanded:!1,show_unavailable:!0,hold_ms:800,hint_ms:2e3,pending_timeout_ms:2e4,zone_settle_ms:8e3,zone_flap_detect:!0,zone_flap_count:6,zone_flap_window_ms:6e4,...this._config}}_sectionsSignature(){const e=this.hass?.states[this._config?.entity];return[this._config?.entity||"",e?.attributes?.code_arm_required?"c":"",(this._config?.zones||[]).length,(this._config?.modes||[]).join(","),this._config?.zone_filter?"f":"",this._config?.bypass_action?"b":"",!1===this._config?.zone_flap_detect?"nf":"",this._config?.arming_duration_ms?"ad":""].join("|")}get _sections(){const e=this.hass?.states[this._config?.entity];return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Alarm panel",selector:{entity:{domain:["alarm_control_panel"]}},required:!0},{name:"modes",label:"Modes to offer (optional)",helper:"Leave empty to offer exactly what the panel reports it supports. Set this only to narrow the row or to change its order.",selector:{select:{multiple:!0,mode:"list",options:An}}},...!!e?.attributes?.code_arm_required||!!e?.attributes?.code_format?[{name:"code",label:"Code",helper:"This panel asks for a code. Without one the hold is refused rather than firing a call the panel will reject. Note it is stored in plain text in the dashboard config.",selector:{text:{type:"password"}}}]:[]]},{title:"Gesture",icon:"mdi:gesture-tap-hold",fields:[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press on the dashboard commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}},{name:"direct_switch",label:"Allow switching between armed modes",helper:"Off by default: while armed, the other modes are inert and must be disarmed through first. Leaving a house armed in the wrong shape is the mistake that gating prevents.",selector:{boolean:{}}},{name:"arming_duration_ms",label:"Exit delay (ms)",helper:"How long this panel takes to arm. Set it and the shape fills across the delay, showing how far through you are. Leave EMPTY and it breathes instead — the honest answer for a wait of unknown length, and better than a progress bar that finishes at the wrong moment. This is not the timeout below: that one is about silence, this one is about how the panel is programmed.",selector:{number:{min:1e3,max:6e5,step:1e3,mode:"box"}}},{name:"pending_duration_ms",label:"Entry delay (ms)",helper:"Same, for the countdown after someone comes in. Leave empty to breathe.",selector:{number:{min:1e3,max:6e5,step:1e3,mode:"box"}}},{name:"pending_timeout_ms",label:"Give up waiting for the panel after (ms, default 20000)",helper:"How long the card keeps showing the state you asked for before admitting the panel never answered. Counts SILENCE only — every arming or entry-delay read restarts it, so a long exit delay does not need a long timeout here.",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}},{name:"hint_ms",label:"How long a refusal hint stays up (ms, default 2000)",selector:{number:{min:500,max:8e3,step:100,mode:"box"}}}]},{title:"Zones",icon:"mdi:door-closed-lock",expanded:!1,fields:[{name:"zone_filter",label:"Find zones automatically",helper:"An entity_id prefix (sensor.ultrasync_zone) or a regex. Leave empty and add zones by hand below instead. A hand-written list always wins over this.",selector:{text:{}}},{name:"zone_pattern",label:"Zone number pattern (default zone(\\d+)state$)",helper:"How to read the panel's zone NUMBER out of an entity_id — the bypass services take a number, not an entity. A zone this does not match offers no Bypass button rather than firing a call with no zone.",selector:{text:{}}},{name:"zone_settle_ms",label:"Settle before a zone counts as ready again (ms, default 8000)",helper:"Going NOT ready is always immediate — that is the warning, and it must never be late. This only delays a zone leaving the not-ready list, so a door being closed does not make the card jump while a contact bounces.",selector:{number:{min:0,max:6e4,step:500,mode:"box"}}},{name:"zone_flap_detect",label:"Treat zones that flap as movement detectors",helper:"Last-resort fallback, for zones with nothing else to go on. A zone that changes repeatedly is behaving like a PIR, not a door: it keeps its place in the list and just recolours, instead of joining the not-ready group and turning the arm gesture amber. Zones are classified from device_class first, then from the integration's own icon, and a per-zone override always wins. Smoke, heat, gas and water zones are never reached by this.",selector:{boolean:{}}},{name:"zone_flap_count",label:"Changes before a zone counts as flapping (default 6)",selector:{number:{min:2,max:50,step:1,mode:"box"}}},{name:"zone_flap_window_ms",label:"Window those changes are counted over (ms, default 60000)",selector:{number:{min:1e3,max:6e5,step:1e3,mode:"box"}}},{name:"bypass_action",label:"Bypass action",helper:"Fired by the Bypass button. Write {zone} anywhere in the data and the zone number is substituted in — e.g. ultrasync.bypass with data zone: {zone}. Leave empty to hide the button everywhere.",selector:{ui_action:{default_action:"none"}}},{name:"unbypass_action",label:"Un-bypass action",helper:"Fired by tapping a bypassed chip. Same {zone} substitution.",selector:{ui_action:{default_action:"none"}}}]},{title:"Layout",icon:"mdi:view-agenda-outline",fields:[{name:"hero",label:"Show the shape, state and sub-line",selector:{boolean:{}}},{name:"footnote",label:"Show the explanation line under the buttons",selector:{boolean:{}}},{name:"zones_start_expanded",label:"Start with the ready zones expanded",selector:{boolean:{}}},{name:"show_unavailable",label:"List zones the panel cannot see",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"armed_color",label:"Accent while armed (default primary)",helper:"Worn by the shape and by the active mode button, so the two read as one object.",color:!0,selector:{text:{}}},{name:"armed_color_on",label:"Ink on that accent",color:!0,selector:{text:{}}},{name:"background",label:"Card background",color:!0,selector:{text:{}}},{name:"background_on",label:"Card text",color:!0,selector:{text:{}}},{name:"disarmed_icon",label:'Shape glyph while disarmed (default "shield")',selector:{icon:{}}},{name:"triggered_icon",label:'Shape glyph while triggered (default "crisis-alert")',selector:{icon:{}}}]},{title:"Mode labels and icons",icon:"mdi:text-short",expanded:!1,fields:An.flatMap(e=>[{name:`label_${e.value}`,label:`${e.label} — label`,selector:{text:{}}},{name:`icon_${e.value}`,label:`${e.label} — icon`,selector:{icon:{}}}])},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",label:"Tapping the shape",selector:{ui_action:{default_action:"more-info"}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}get _zoneSchema(){return[{name:"entity",label:"Zone sensor",helper:'A door, window or contact. Not ready means on / open / unlocked, or the panel\'s own "Not Ready"; a state starting with "Bypass" counts as bypassed. Whether a Bypass button appears is the panel\'s call, via its can_bypass attribute.',selector:{entity:{domain:["binary_sensor","sensor","lock","cover","input_boolean","switch"]}}},{name:"name",label:"Name (optional — defaults to the entity name)",selector:{text:{}}},{name:"icon",label:"Icon (optional)",selector:{icon:{}}},{name:"transient",label:"Movement detector",helper:"Overrides the automatic guess. On: this zone never blocks arming and never turns the gesture amber — it keeps its row and recolours. Off: it always blocks. Leave unset to classify from device_class, falling back to whether it flaps.",selector:{boolean:{}}}]}_zones(){return Array.isArray(this._config?.zones)?this._config.zones:[]}_commitZones(e){const t={...this._config};e.length?t.zones=e:delete t.zones,this._commit(t)}_addZone(){const e=[...this._zones(),{entity:""}];this._expanded=e.length-1,this._commitZones(e)}_removeZone(e){const t=[...this._zones()];t.splice(e,1),this._expanded===e&&(this._expanded=null),this._commitZones(t)}_moveZone(e,t){const i=[...this._zones()],[s]=i.splice(e,1);i.splice(t,0,s),this._expanded===e&&(this._expanded=t),this._commitZones(i)}_updateZone(e,t){const i=[...this._zones()];i[e]={...i[e],...t},this._commitZones(i)}_toggleExpand(e){this._expanded=this._expanded===e?null:e}_zoneTitle(e,t){if(e.name)return e.name;const i=e.entity?this.hass?.states[e.entity]:null;return i?.attributes?.friendly_name||e.entity||`Zone ${t+1}`}_renderExtra(){const e=this._zones();return I`
      ...
      ${De((e,t)=>this._moveZone(e,t),e.map((e,t)=>I`
            <div class="option-card">
              <div class="option-header">
                <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
          ...
          `))}
    `}}customElements.define("materia-alarm-editor",Mn);const On=[{key:"home",feature:1,state:"armed_home",service:"alarm_arm_home",icon:"m3o:home",hero:"m3o:shield-person"},{key:"away",feature:2,state:"armed_away",service:"alarm_arm_away",icon:"m3o:directions-walk",hero:"m3o:shield-lock"},{key:"night",feature:4,state:"armed_night",service:"alarm_arm_night",icon:"m3o:bedtime",hero:"m3o:shield-moon"},{key:"vacation",feature:32,state:"armed_vacation",service:"alarm_arm_vacation",icon:"m3o:beach-access",hero:"m3o:shield-lock"},{key:"custom",feature:16,state:"armed_custom_bypass",service:"alarm_arm_custom_bypass",icon:"m3o:tune",hero:"m3o:shield-lock"}],Fn=new Set(On.map(e=>e.state)),Dn=new Set(["arming","pending"]),qn=new Set(["on","true","open","opening","unlocked","unlocking","detected","running","active","home"]),Pn=new Set(["motion","occupancy","presence","vibration","sound","moving","running","light"]),Rn=new Set(["door","window","opening","garage_door","lock","tamper"]),Nn=new Set(["smoke","gas","heat","moisture","co","safety","problem"]),Ln=["fire","smoke","heat","gas","water","flood"],Un=["motion","walk","presence","occupancy","radar"],jn=["door","window","garage","gate","lock","shield","bell","wardrobe","cupboard","curtain","shutter","blind"],Bn=me.ms;class In extends(ci(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_holdKey:{state:!0},_settling:{state:!0},_hint:{state:!0},_refused:{state:!0},_zonesOpen:{state:!0},_unavailOpen:{state:!0},_turn:{state:!0},_shake:{state:!0},_sweeping:{state:!0}};static styles=En;static getConfigElement(){return document.createElement("materia-alarm-editor")}static getStubConfig(e){const t=e?Object.keys(e.states):[],i=t.find(e=>e.startsWith("alarm_control_panel.")),s=i?{entity:i}:{},n=t.find(e=>/^sensor\..*zone\d+state$/i.test(e));if(n){const t=n.split(".")[1].replace(/_?zone\d+state$/i,"");s.zone_filter="sensor."+t+"_zone";const i=e?.services?.[t];i?.bypass&&i?.unbypass&&(s.bypass_action={action:"perform-action",perform_action:t+".bypass",data:{zone:"{zone}"}},s.unbypass_action={action:"perform-action",perform_action:t+".unbypass",data:{zone:"{zone}"}})}return s}setConfig(e){this.config={...e}}constructor(){super(),this._pending=null,this._holdKey=null,this._p=0,this._settling=!1,this._hint=null,this._refused=null,this._zonesOpen=void 0,this._unavailOpen=!1,this._turn=!1,this._shake=!1,this._sweeping=!1,this._turnDir=1}connectedCallback(){super.connectedCallback(),this._unsub=Li.subscribe(e=>{e===this.config?.entity&&this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=null,clearTimeout(this._pinTimer),clearTimeout(this._hintTimer),clearTimeout(this._refuseTimer),clearTimeout(this._turnTimer),clearTimeout(this._shakeTimer),clearTimeout(this._latchTimer),this._stopSweep(),this._cleanupGesture()}get _stateObj(){return this.hass?.states[this.config?.entity]}get _rawState(){return String(this._stateObj?.state??"")}get _state(){if(this._pending)return this._pending;const e=this._rawState;return Li.peek(this.config.entity,e)||e}get _busy(){const e=this._rawState;return!!Dn.has(e)||!!this._pending&&e!==this._pending}get _triggered(){return"triggered"===this._state}get _disarming(){return"disarmed"===this._pending}get _armedish(){const e=this._state;return Fn.has(e)||Dn.has(e)||"triggered"===e}get _pose(){return this._armedish}get _reduceMotion(){return!!window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches}get _features(){return Number(this._stateObj?.attributes?.supported_features??0)}get _modes(){const e=this._features;let t=On.filter(t=>0!==(e&t.feature));t.length||this.config.modes||(t=On.filter(e=>"home"===e.key||"away"===e.key));const i=this.config.modes;return Array.isArray(i)&&i.length&&(t=i.map(e=>{const t=String(e).replace(/^armed_/,"").replace("custom_bypass","custom");return On.find(e=>e.key===t)}).filter(Boolean)),t}get _activeMode(){const e=this._modes,t=this._state,i=e.find(e=>e.state===t);return i||(("triggered"===t||"pending"===t||"arming"===t)&&(e.find(e=>e.state===this._lastArmed)||e[0])||null)}updated(e){const t=this._lastPose;if(this._lastPose=this._pose,t!==this._lastPose&&(this._poseAt=performance.now()),!e.has("hass"))return;const i=this._rawState;Fn.has(i)&&(this._lastArmed=i),this._pending&&(i===this._pending?this._clearPin():Dn.has(i)||i===this._pinFrom||this._clearPin()),this._punctuate(i)}_punctuate(e){const t=""!==e&&!Dn.has(e)&&"unavailable"!==e&&"unknown"!==e,i=this._lastSettled;t&&(this._lastSettled=e),t&&void 0!==i&&i!==e&&(performance.now()-(this._poseAt??-1/0)<Bn||this._playTurn("disarmed"===e?-1:1))}get _armDurationMs(){const e="pending"===this._rawState||"pending"===this._state?"pending_duration_ms":"arming_duration_ms",t=Number(this.config?.[e]);return Number.isFinite(t)&&t>0?t:null}get _armAnchor(){const e=Dn.has(this._rawState)?Date.parse(this._stateObj?.last_changed??""):NaN,t=null!=this._pending?this._pinAt:void 0;return null!=t&&Number.isFinite(e)?Math.min(t,e):null!=t?t:Number.isFinite(e)?e:null}get _canSweep(){return this._busy&&null!=this._armDurationMs&&null!=this._armAnchor}_syncSweep(){this._canSweep?this._startSweep():this._stopSweep()}_startSweep(){if(this._sweepRaf)return;this._sweeping=!0;const e=()=>{if(!this._canSweep)return void this._stopSweep();const t=this._armDurationMs,i=Math.min(1,Math.max(0,(Date.now()-this._armAnchor)/t)),s=this._reduceMotion?1/Math.max(1,t/1e3):0,n=s?Math.floor(i/s)*s:i;this._applyArmP(Math.min(1,n)),this._sweepRaf=requestAnimationFrame(e)};this._sweepRaf=requestAnimationFrame(e)}_stopSweep(){this._sweepRaf&&(cancelAnimationFrame(this._sweepRaf),this._sweepRaf=null),this.shadowRoot?.querySelector(".shape")?.style.removeProperty("--ma-p"),this._sweeping=!1}_applyArmP(e){this.shadowRoot?.querySelector(".shape")?.style.setProperty("--ma-p",String(e))}_playTurn(e){this._reduceMotion||(clearTimeout(this._turnTimer),this._turnDir=e,this._turn=!1,requestAnimationFrame(()=>{this._turn=!0,this._turnTimer=setTimeout(()=>{this._turn=!1},650)}))}_playShake(){this._reduceMotion||(clearTimeout(this._shakeTimer),this._shake=!1,requestAnimationFrame(()=>{this._shake=!0,this._shakeTimer=setTimeout(()=>{this._shake=!1},500)}))}_clearPin(){this._pending=null,clearTimeout(this._pinTimer)}_zoneWord(e){const t=String(e?.state??"").trim();return t&&"unknown"!==t?t:String(e?.attributes?.status??e?.attributes?.state??t).trim()}_zoneUnavailable(e){if(!e)return!0;const t=this._zoneWord(e).toLowerCase();return""===t||"unavailable"===t||"unknown"===t||"none"===t}_zoneBypassed(e){return/^bypass/i.test(this._zoneWord(e))}_zoneNotReady(e){const t=this._zoneWord(e).toLowerCase();return"not ready"===t||"notready"===t||qn.has(t)}get _zonePattern(){return this.config.zone_pattern??"zone(\\d+)state$"}_zoneNumber(e){const t=this._zonePattern;if(this.__zoneReSrc!==t){this.__zoneReSrc=t;try{this.__zoneRe=new RegExp(t,"i")}catch(e){this.__zoneRe=null}}if(!this.__zoneRe)return null;const i=this.__zoneRe.exec(String(e??""));if(!i||void 0===i[1])return null;const s=Number(i[1]);return Number.isFinite(s)?s:null}get _settleMs(){return Math.max(0,Number(this.config.zone_settle_ms??8e3))}_book(e){this._zoneBook??=new Map;let t=this._zoneBook.get(e);return t||(t={word:null,flips:[],latched:!1,readyAt:null},this._zoneBook.set(e,t)),t}_flapping(e,t){const i=Math.max(1e3,Number(this.config.zone_flap_window_ms??6e4)),s=Math.max(2,Number(this.config.zone_flap_count??6));for(;e.flips.length&&t-e.flips[0]>i;)e.flips.shift();return e.flips.length>=s}_classify(e,t,i,s){if("boolean"==typeof e?.transient)return{transient:e.transient,safety:!1,by:"config"};const n=t?.attributes?.device_class;if(n){if(Nn.has(n))return{transient:!1,safety:!0,by:"device_class"};if(Pn.has(n))return{transient:!0,safety:!1,by:"device_class"};if(Rn.has(n))return{transient:!1,safety:!1,by:"device_class"}}const a=String(t?.attributes?.icon??"").toLowerCase();if(a){const e=e=>e.some(e=>a.includes(e));if(e(Ln))return{transient:!1,safety:!0,by:"icon"};if(e(Un))return{transient:!0,safety:!1,by:"icon"};if(e(jn))return{transient:!1,safety:!1,by:"icon"}}if(!1===this.config.zone_flap_detect)return{transient:!1,safety:!1,by:"default"};const o=this._flapping(i,s);return{transient:o,safety:!1,by:o?"flapping":"default"}}willUpdate(e){super.willUpdate?.(e),this._surveyZones(),this._syncSweep()}_surveyZones(){if(!this.hass||!this.config)return;const e=Date.now(),t=this._settleMs;let i=1/0;for(const s of this._zoneConfigs()){const n=this.hass.states[s.entity],a=this._book(s.entity),o=this._zoneWord(n);a.word!==o&&(null!==a.word&&a.flips.push(e),a.word=o);const r=this._classify(s,n,a,e),l=r.transient;a.transient=l,a.safety=r.safety,a.classifiedBy=r.by;const c=this._zoneUnavailable(n),h=!c&&this._zoneBypassed(n);!l&&!c&&!h&&this._zoneNotReady(n)?(a.latched=!0,a.readyAt=null):a.latched&&(null==a.readyAt&&(a.readyAt=e),e-a.readyAt>=t?(a.latched=!1,a.readyAt=null):i=Math.min(i,a.readyAt+t)),(c||h||l)&&a.latched&&(a.latched=!1,a.readyAt=null)}clearTimeout(this._latchTimer),i!==1/0&&(this._latchTimer=setTimeout(()=>this.requestUpdate(),Math.max(16,i-e)))}_zoneConfigs(){const e=Array.isArray(this.config.zones)?this.config.zones:null;return(e&&e.length?e:this._discoverZones()).filter(e=>e&&e.entity)}_discoverZones(){const e=this.config.zone_filter;if(!e||!this.hass?.states)return[];const t=String(e);let i;if(/[\\^$.*+?()[\]{}|]/.test(t))try{const e=new RegExp(t,"i");i=t=>e.test(t)}catch(e){i=e=>e.startsWith(t)}else i=e=>e.startsWith(t);return Object.keys(this.hass.states).filter(i).map(e=>({entity:e}))}_canSkip(e){if(e.unavailable)return!1;if(!this.config.bypass_action||null==e.zone)return!1;const t=e.st?.attributes?.can_bypass;return null==t||(!0===t||1===t||/^(true|yes|1)$/i.test(String(t)))}_canUnskip(e){return!!this.config.unbypass_action&&null!=e.zone}get _zones(){const e=this._zoneConfigs().map(e=>{const t=this.hass?.states[e.entity],i=this._zoneUnavailable(t),s=!i&&this._zoneBypassed(t),n=this._zoneBook?.get(e.entity),a=n?.transient??!1,o=n?.safety??!1,r=!i&&!s&&this._zoneNotReady(t),l={...e,st:t,zone:this._zoneNumber(e.entity),unavailable:i,bypassed:s,transient:a,safety:o,classifiedBy:n?.classifiedBy??"default",sensing:a&&r,open:n?!a&&n.latched:!a&&r,name:e.name||t?.attributes?.friendly_name||t?.attributes?.name||e.entity,icon:e.icon||t?.attributes?.icon||"m3o:sensors"};return l.skippable=this._canSkip(l),l.unskippable=this._canUnskip(l),l}).filter(e=>!1!==this.config.show_unavailable||!e.unavailable),t=e=>e.bypassed?3:e.open?0:e.unavailable?1:2;return e.sort((e,i)=>{const s=t(e)-t(i);return s||(null!=e.zone&&null!=i.zone?e.zone-i.zone:String(e.name).localeCompare(String(i.name)))})}_notReady(e){return e.filter(e=>e.open)}_withZone(e,t){if("string"==typeof e)return"{zone}"===e.trim()?t:e.includes("{zone}")?e.split("{zone}").join(String(t)):e;if(Array.isArray(e))return e.map(e=>this._withZone(e,t));if(e&&"object"==typeof e){const i={};for(const[s,n]of Object.entries(e))i[s]=this._withZone(n,t);return i}return e}_fireZoneAction(e,t){const i="bypass"===t?this.config.bypass_action:this.config.unbypass_action;i&&null!=e.zone&&("bypass"!==t||e.skippable)&&this._handleAction(this._withZone(i,e.zone))}get _holdMs(){return Math.max(300,Number(this.config.hold_ms??800))}_isInert(e){if(this.config.direct_switch)return!1;const t=this._activeMode;return!!t&&t.key!==e.key}_showHint(e,t,i="warning"){clearTimeout(this._hintTimer),clearTimeout(this._refuseTimer),this._hint={key:e,text:t},this._refused=e,this._fireHaptic(i),this._hintTimer=setTimeout(()=>{this._hint=null},Number(this.config.hint_ms??2e3)),this._refuseTimer=setTimeout(()=>{this._refused=null},450)}_refusalFor(e){if(this._isInert(e))return ke("al_hint_disarm_first",this.hass);return this._activeMode?.key===e.key||!this._stateObj?.attributes?.code_arm_required||this.config.code?null:ke("al_hint_code_required",this.hass)}_onPointerDown(e,t){if(this._isUnavailable(this._stateObj))return;if(e.button&&0!==e.button)return;if(!e.isPrimary)return;if("touch"===e.pointerType&&e.clientX<=30)return;const i=this._refusalFor(t);i?this._showHint(t.key,i):(this._startX=e.clientX,this._startY=e.clientY,this._pointerId=e.pointerId,this._scrollIntent=!1,this._holdEl=e.currentTarget,this._target=e.currentTarget,this._onUpRef=this._onPointerUp.bind(this),window.addEventListener("pointerup",this._onUpRef),window.addEventListener("pointercancel",this._onUpRef),this._onEarlyMoveRef=this._onEarlyMove.bind(this),window.addEventListener("pointermove",this._onEarlyMoveRef),this._engage(t))}_onEarlyMove(e){if(this._scrollIntent)return;const t=Math.abs(e.clientX-this._startX),i=Math.abs(e.clientY-this._startY);i>10&&i>t+4&&(this._scrollIntent=!0,this._release(!1))}_engage(e){if(!this._holdKey){this._holdKey=e.key,this._settling=!1,this._p=0,this._engagedAt=Date.now(),this._holdMode=e;try{this._target?.setPointerCapture?.(this._pointerId)}catch(e){}this._target&&(document.documentElement.style.setProperty("touch-action","none"),document.documentElement.style.setProperty("overscroll-behavior","contain"),this._target.addEventListener("touchmove",this._preventTouch,{passive:!1})),this._onVisibilityRef=()=>{document.hidden&&this._release(!1)},document.addEventListener("visibilitychange",this._onVisibilityRef),this._tick=this._tick.bind(this),this._raf=requestAnimationFrame(this._tick)}}_applyP(){this._holdEl?.style.setProperty("--ma-p",String(this._p))}_preventTouch(e){e.preventDefault()}_tick(){if(!this._holdKey)return;const e=Math.min(1,(Date.now()-this._engagedAt)/this._holdMs);this._p=e,e>=1?this._commit():(this._applyP(),this._raf=requestAnimationFrame(this._tick))}_onPointerUp(e){if("pointercancel"===e.type&&this._engagedAt&&Date.now()-this._engagedAt<150)return clearTimeout(this._graceTimer),void(this._graceTimer=setTimeout(()=>this._release(!1),400));clearTimeout(this._graceTimer),this._release(!1)}_release(e){(this._holdKey||null!=this._startX)&&(e?this._commit():(this._settling=!0,this._p=0,this._cleanupGesture()))}_commit(){const e=this._holdMode;if(this._cleanupGesture(),!e)return;const t=this._activeMode?.key===e.key,i=t?"disarmed":e.state,s=t?"alarm_disarm":e.service;this._settling=!1,this._p=0,this._pinFrom=this._rawState,this._pinAt=Date.now(),this._pending=i,clearTimeout(this._pinTimer),this._armPinExpiry(),Li.publish(this.config.entity,i,this._pinFrom);const n={entity_id:this.config.entity};this.config.code&&(n.code=String(this.config.code)),this._fireHaptic("success"),this._callService("alarm_control_panel",s,n)}_armPinExpiry(){clearTimeout(this._pinTimer),this._pinTimer=setTimeout(()=>{this._pending&&(Dn.has(this._rawState)?this._armPinExpiry():(this._pending=null,this._fireHaptic("warning"),this._playShake()))},Number(this.config.pending_timeout_ms??2e4))}_cleanupGesture(){if(this._holdEl?.style.removeProperty("--ma-p"),this._holdKey=null,this._holdMode=null,this._holdEl=null,this._startX=null,this._engagedAt=null,this._scrollIntent=!1,clearTimeout(this._graceTimer),this._raf&&(cancelAnimationFrame(this._raf),this._raf=null),document.documentElement.style.removeProperty("touch-action"),document.documentElement.style.removeProperty("overscroll-behavior"),this._target){this._target.removeEventListener("touchmove",this._preventTouch);try{this._target.releasePointerCapture?.(this._pointerId)}catch(e){}this._target=null}this._onVisibilityRef&&(document.removeEventListener("visibilitychange",this._onVisibilityRef),this._onVisibilityRef=null),this._onEarlyMoveRef&&(window.removeEventListener("pointermove",this._onEarlyMoveRef),this._onEarlyMoveRef=null),this._onUpRef&&(window.removeEventListener("pointerup",this._onUpRef),window.removeEventListener("pointercancel",this._onUpRef),this._onUpRef=null)}_isHoldKey(e){return"Enter"===e.key||" "===e.key||"Spacebar"===e.key}_onKeyDown(e,t){if(!this._isHoldKey(e))return;if(e.preventDefault(),e.repeat)return;if(this._isUnavailable(this._stateObj))return;const i=this._refusalFor(t);i?this._showHint(t.key,i):(this._target=null,this._holdEl=e.currentTarget,this._engage(t))}_onKeyUp(e){this._isHoldKey(e)&&this._release(!1)}_time(e){if(!e)return"";const t=this.hass?.locale?.language||"en";return new Date(e).toLocaleTimeString(t,{hour:"numeric",minute:"2-digit"})}_modeLabel(e){return this.config[`label_${e.key}`]??ke(`al_mode_${e.key}`,this.hass)}_title(){const e=this._state;if(this._isUnavailable(this._stateObj))return ke("unavailable",this.hass);if("triggered"===e)return ke("al_state_triggered",this.hass);if("arming"===e)return ke("al_state_arming",this.hass);if("pending"===e)return ke("al_state_pending",this.hass);if("disarmed"===e)return ke("al_state_disarmed",this.hass);const t=On.find(t=>t.state===e);return ke(t?`al_state_armed_${t.key}`:"al_state_unknown",this.hass)}_sub(e){const t=this._state,i=this._stateObj;if(this._isUnavailable(i))return{text:ke("al_sub_unavailable",this.hass),warn:!0};if("triggered"===t)return{text:ke("al_sub_triggered",this.hass,{time:this._time(i?.last_changed)}),warn:!0};if("pending"===t)return{text:ke("al_sub_pending",this.hass),warn:!0};if(this._busy)return{text:ke(this._disarming?"al_sub_disarming":"al_sub_arming",this.hass),warn:!1};if("disarmed"===t){if(!e.length)return{text:ke("al_sub_ready",this.hass),warn:!1};return{text:ke(1===e.length?"al_sub_not_ready_one":"al_sub_not_ready",this.hass,{n:e.length}),warn:!0}}return Fn.has(t)?{text:ke("al_sub_armed_since",this.hass,{time:this._time(i?.last_changed)}),warn:!1}:{text:"",warn:!1}}_buttonHint(e){return this._hint?.key===e.key?this._hint.text:this._holdKey===e.key?ke("al_hint_holding",this.hass):this._busy&&this._disarming?ke("al_hint_disarming",this.hass):this._isInert(e)?ke("al_hint_disarm_first",this.hass):this._activeMode?.key===e.key?"pending"===this._rawState?ke("al_hint_hold_to_disarm",this.hass):this._busy?ke(this._disarming?"al_hint_disarming":"al_hint_arming",this.hass):ke("al_hint_hold_to_disarm",this.hass):ke("al_hint_hold_to_arm",this.hass)}_footnote(e){if(this._hint)return{text:this._hint.text,tone:"warn"};const t=this._state,i=this._activeMode;if(this._isUnavailable(this._stateObj))return{text:ke("al_sub_unavailable",this.hass),tone:"warn"};if("triggered"===t)return{text:ke("al_foot_triggered",this.hass,{mode:i?this._modeLabel(i):""}),tone:"alert"};if("pending"===t)return{text:ke("al_foot_pending",this.hass),tone:"alert"};if(this._busy)return{text:ke(this._disarming?"al_foot_disarming":"al_foot_arming",this.hass),tone:""};if(i){return{text:ke("al_foot_armed",this.hass,{mode:this._modeLabel(i)})+(this.config.direct_switch||this._modes.length<2?"":` ${ke("al_foot_locked_modes",this.hass)}`),tone:""}}return e.length?{text:ke("al_foot_disarmed_warn",this.hass,{n:e.length}),tone:"warn"}:{text:ke("al_foot_disarmed",this.hass),tone:""}}_radius(e,t,i){if(i)return"28px";const s="48px",n="16px";return 1===t?s:0===e?`${s} ${n} ${n} ${s}`:e===t-1?`${n} ${s} ${s} ${n}`:n}render(){if(!this.hass||!this.config)return I``;const e="--ma-bg:var(--md-sys-color-surface-container-low, var(--card-background-color));--ma-fg:var(--md-sys-color-on-surface);";if(!this.config.entity)return I`<ha-card style=${e}><div class="body">
        <div class="note">${ke("al_needs_entity",this.hass)}</div>
      </div></ha-card>`;const t=this._stateObj;if(!t)return I`<ha-card style=${e}><div class="body">
        <div class="note">${ke("entity_not_found_with_id",this.hass,{entity:this.config.entity})}</div>
      </div></ha-card>`;const i=this._isUnavailable(t),s=this._zones,n=this._notReady(s),a=this._triggered,o=this._armedish,r=this._modes,l=this._activeMode,c=a?"var(--md-sys-color-error-container)":this.config.background??"var(--md-sys-color-surface-container-low, var(--card-background-color))",h=a?"var(--md-sys-color-on-error-container)":this.config.background_on??"var(--md-sys-color-on-surface)",d=this.config.armed_color??"var(--md-sys-color-primary)",p=this.config.armed_color_on??"var(--md-sys-color-on-primary)",u=this._canSweep&&!a,m=a?"var(--md-sys-color-error)":o?u?`color-mix(in srgb, ${d} 30%, transparent)`:d:`color-mix(in srgb, ${h} 12%, transparent)`,g=a?"var(--md-sys-color-on-error)":o?u?d:p:d,f=a?this.config.triggered_icon??"m3o:crisis-alert":l&&Fn.has(this._state)?this.config[`icon_${l.key}`]??l.hero:this.config.disarmed_icon??"m3o:shield",_=this._sub(n),b=this._footnote(n),v=this.config.tap_action||{action:"more-info",entity:this.config.entity},y="none"!==v.action;return I`
      <ha-card class=${i?"unavailable":""} style="--ma-bg:${c};--ma-fg:${h};">
        <div class="body ${a?"triggered":""}">
          ${!1===this.config.hero?V:I`
                <div class="hero">
                  <div
                    class="shape ${o?"armed":""} ${this._busy?"busy":""} ${u?"sweeping":""} ${this._turn?"turn":""} ${this._shake?"shake":""}"
                    style="--ma-hero-bg:${m};--ma-hero-fg:${g};--ma-sweep-bg:${d};--ma-sweep-fg:${p};--ma-turn-dir:${this._turnDir};${y?"":"cursor:default;"}"
                    role=${y?"button":"img"}
                    tabindex=${y?0:-1}
                  ...
                  <div>
                    ...
                    <div class="sub ${_.warn?"warn":""}">${_.text}</div>
                  </div>
                </div>
              `}

          ${r.length?I`
                <div class="modes" role="group" aria-label=${ke("al_aria_modes",this.hass)}>
                  ${r.map((e,t)=>this._renderMode(e,t,r.length,{active:l,notReady:n,triggered:a,accent:d,accentOn:p,idleBg:"var(--md-sys-color-secondary-container)",idleFg:"var(--md-sys-color-on-secondary-container)",unavailable:i}))}
                </div>
              `:I`<div class="note">${ke("al_no_modes",this.hass)}</div>`}
    ...
    `}_renderMode(e,t,i,s){const n=s.active?.key===e.key,a=this._isInert(e),o=this._holdKey===e.key,r=this._modeLabel(e),l=a?"m3o:lock":this.config[`icon_${e.key}`]??e.icon,c=n?s.triggered?"var(--md-sys-color-error)":s.accent:s.idleBg,h=n?s.triggered?"var(--md-sys-color-on-error)":s.accentOn:s.idleFg,d=!n&&s.notReady.length>0,p=d?"var(--md-sys-cust-color-warning, var(--md-sys-color-error))":n?s.idleBg:s.accent,u=d?"var(--md-sys-cust-color-on-warning, var(--md-sys-color-on-error))":n?s.idleFg:s.accentOn,m=a?ke("al_aria_inert",this.hass,{mode:r}):n?ke("al_aria_hold_disarm",this.hass):ke("al_aria_hold_arm",this.hass,{mode:r}),g=this._buttonHint(e),f=I`
      <ha-icon .icon=${l}></ha-icon>
      <span class="label">${r}</span>
      <span class="hint">${g}</span>
    `;return I`
      <button
        class="mode ${n?"active":""} ${a?"inert":""} ${this._refused===e.key?"refused":""}"
        style="border-radius:${this._radius(t,i,n)};--ma-btn-bg:${c};--ma-btn-fg:${h};--ma-sweep:${p};--ma-sweep-ink:${u};--ma-p:${o?this._p:0};"
        aria-label=${m}
    ...
    `}get _zonesExpanded(){return this._zonesOpen??!!this.config.zones_start_expanded}get _unavailExpanded(){return!!this._unavailOpen}_zoneRow(e,t=""){const i=e.sensing?ke("al_zone_sensing",this.hass):this.hass.formatEntityState?.(e.st)??this._zoneWord(e.st);return I`
      <div class="zrow ${t} ${e.sensing?"sensing":""}">
        ...
        ${e.skippable?I`
              <button
                class="chip"
                aria-label=${ke("al_aria_bypass",this.hass,{name:e.name})}
                @click=${()=>this._fireZoneAction(e,"bypass")}
              >
                <ha-icon icon="m3o:visibility-off"></ha-icon>
                <span>${ke("al_zone_bypass",this.hass)}</span>
              </button>
            `:V}
      </div>
    `}_zoneSummary({icon:e,cls:t,label:i,aria:s,open:n,toggle:a,rows:o}){return I`
      <div class="zgroup">
        <button
          class="zrow summary ${t} ${n?"open":""}"
        ...
        ${n?o.map(e=>this._zoneRow(e)):V}
      </div>
    `}_renderZones(e){const t=e.filter(e=>e.open),i=e.filter(e=>e.unavailable),s=e.filter(e=>e.bypassed),n=e.filter(e=>!e.open&&!e.bypassed&&!e.unavailable),a=n.filter(e=>e.sensing).length;return I`
      <div class="zones">
        ${t.length?I`
              <div class="zgroup">
                <div class="zgroup-title">${ke("al_zones_not_ready",this.hass)}</div>
                ${t.map(e=>this._zoneRow(e,"notready"))}
              </div>
            `:V}

        ${i.length?this._zoneSummary({icon:"m3o:sensors-off",cls:"unavail",label:ke(1===i.length?"al_zones_unavailable_one":"al_zones_unavailable",this.hass,{n:i.length}),aria:ke("al_aria_unavail_toggle",this.hass),open:this._unavailExpanded,toggle:()=>{this._unavailOpen=!this._unavailExpanded},rows:i}):V}

        ${n.length?this._zoneSummary({icon:"m3of:check-circle",cls:"ok",label:a?ke("al_zones_ready_sensing",this.hass,{n:n.length-a,m:a}):ke(1===n.length?"al_zones_ready_one":"al_zones_ready_count",this.hass,{n:n.length}),aria:ke("al_aria_zones_toggle",this.hass),open:this._zonesExpanded,toggle:()=>{this._zonesOpen=!this._zonesExpanded},rows:n}):V}

        ${s.length?I`
              <div class="zgroup">
                <div class="zgroup-title">${ke("al_zones_bypassed",this.hass)}</div>
                <div class="chips">
                  ${s.map(e=>e.unskippable?I`
                          <button
                            class="chip bypassed"
                            aria-label=${ke("al_aria_unbypass",this.hass,{name:e.name})}
  ...
  `];customElements.define("materia-confirm-editor",class extends He{_formData(){return{gesture:"hold",require_gesture:"activate",hold_ms:800,threshold:.55,pending_timeout_ms:1e4,caption_warn:!0,...this._config}}_sectionsSignature(){return[this._config?.entity?"e":"",this._config?.gesture||"hold",this._config?.require_gesture||"activate",this._config?.action?"a":""].join("|")}get _sections(){const e="slide"!==(this._config?.gesture??"hold"),t=!!this._config?.entity;return[{title:"Setup",icon:"mdi:tune",fields:[{name:"entity",label:"Entity to reflect and drive (optional)",helper:"With an entity and no actions below, the gesture turns it on and the active face turns it off — nothing else to configure. Leave empty to fire an action only.",selector:{entity:{}}},...t?[{name:"active_state",label:"State that counts as active",helper:'Defaults to the usual on/open/unlocked family. Set this for a control whose "on" is spelled something else.',selector:{text:{}}}]:[],{name:"action",label:"Action when committing",helper:"Fired when the gesture completes. Overrides the default turn-on.",selector:{ui_action:{default_action:"none"}}},{name:"deactivate_action",label:"Action when switching off",helper:"Fired by the active face. Overrides the default turn-off.",selector:{ui_action:{default_action:"none"}}}]},{title:"Gesture",icon:"mdi:gesture-tap-hold",fields:[{name:"gesture",label:"Commit gesture",selector:{select:{mode:"dropdown",options:[{value:"hold",label:"Press and hold"},{value:"slide",label:"Slide across"}]}}},{name:"require_gesture",label:"Which direction needs the gesture",helper:"Turning ON only, by default: switching an override off returns things to normal and costs nothing, and making the cheap direction ceremonial teaches people the gesture is a formality. Choose both where OFF is the dangerous direction — a control that disables a protection rather than enabling a cost.",selector:{select:{mode:"dropdown",options:[{value:"activate",label:"Only turning on"},{value:"both",label:"Both directions"}]}}},...e?[{name:"hold_ms",label:"Hold for (ms, default 800)",helper:"Keep this above 500ms — the platform long-press timeout — or an ordinary long-press commits by accident.",selector:{number:{min:300,max:5e3,step:50,mode:"box"}}}]:[{name:"threshold",label:"Fraction of the track to cross (default 0.55)",selector:{number:{min:.2,max:1,step:.05,mode:"box"}}}],...t?[{name:"pending_timeout_ms",label:"Give up waiting for the entity after (ms, default 10000)",selector:{number:{min:1e3,max:6e4,step:500,mode:"box"}}}]:[]]},{title:"Words",icon:"mdi:text-short",fields:[{name:"eyebrow",label:"Eyebrow (optional)",template:!0,selector:{text:{}}},{name:"label",label:"Gesture label",helper:"The instruction across the track. Keep it short — it sits on one line.",template:!0,selector:{text:{}}},{name:"caption",label:"Warning / consequence line",helper:"THE POINT OF THIS CARD. Shown before the gesture is touched and while it is held, which is strictly more informative than a dialog that appears after the decision and gets dismissed by reflex. Put the cost or the consequence here.",template:!0,selector:{text:{}}},{name:"caption_warn",label:"Colour the warning line",selector:{boolean:{}}},{name:"active_label",label:"Label while active",template:!0,selector:{text:{}}},{name:"active_caption",label:"Caption while active",helper:"Falls back to the warning line above when empty.",template:!0,selector:{text:{}}},..."both"===this._config?.require_gesture?[]:[{name:"deactivate_hint",label:'Active face hint (default "Tap to stop")',selector:{text:{}}}],...t?[{name:"busy_label",label:'While waiting (default "Working…")',selector:{text:{}}}]:[]]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"active_color",label:"Background while active",color:!0,selector:{text:{}}},{name:"active_color_on",label:"Text while active",color:!0,selector:{text:{}}},{name:"track_color",label:"Gesture track",color:!0,selector:{text:{}}},{name:"track_color_on",label:"Text on the track",color:!0,selector:{text:{}}},...e?[]:[{name:"handle_color",label:"Slide handle",color:!0,selector:{text:{}}},{name:"handle_color_on",label:"Handle glyph",color:!0,selector:{text:{}}}],{name:"active_icon",label:'Icon while active (default "check-circle")',selector:{icon:{}}},{name:"gesture_icon",label:"Icon on the gesture handle (optional)",selector:{icon:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}});const Wn=new Set(["on","true","open","opening","unlocked","unlocking","home","active"]);class Vn extends(ci(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},_pending:{state:!0},_resolvedLabel:{state:!0},_resolvedActiveLabel:{state:!0},_resolvedCaption:{state:!0},_resolvedActiveCaption:{state:!0},_resolvedEyebrow:{state:!0}};static styles=Hn;static getConfigElement(){return document.createElement("materia-confirm-editor")}static getStubConfig(){return{gesture:"hold"}}setConfig(e){this.config={gesture:"hold",...e}}constructor(){super(),this._pending=null}connectedCallback(){super.connectedCallback(),this._unsub=Li.subscribe(e=>{e===this.config?.entity&&this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=null,clearTimeout(this._pinTimer)}updated(e){e.has("hass")&&this.hass&&(this._resolveField("label","_resolvedLabel"),this._resolveField("active_label","_resolvedActiveLabel"),this._resolveField("caption","_resolvedCaption"),this._resolveField("active_caption","_resolvedActiveCaption"),this._resolveField("eyebrow","_resolvedEyebrow"),null!=this._pending&&this._entityActive===this._pending&&(this._pending=null,clearTimeout(this._pinTimer)))}_field(e,t){const i=this.config?.[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}get _stateObj(){return this.config?.entity?this.hass?.states[this.config.entity]:null}get _entityActive(){const e=this._stateObj;if(!e||this._isUnavailable(e))return null;const t=String(e.state).toLowerCase();return this.config.active_state?t===String(this.config.active_state).toLowerCase():Wn.has(t)}get _active(){return null!=this._pending?this._pending:!0===this._entityActive}get _busy(){return null!=this._pending&&this._entityActive!==this._pending}get _gestureBoth(){return"both"===this.config.require_gesture}get _showGesture(){return!this._active||this._gestureBoth}_commit(){const e=!this._active,t=this.config.entity;t&&(this._pending=e,clearTimeout(this._pinTimer),this._pinTimer=setTimeout(()=>{this._pending=null},Number(this.config.pending_timeout_ms??1e4)),Li.publish(t,e?"on":"off",this._stateObj?.state));const i=e?this.config.action:this.config.deactivate_action;i?this._handleAction(i):t&&(this._fireHaptic("success"),this._callService("homeassistant",e?"turn_on":"turn_off",{entity_id:t}))}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj;if(this.config.entity&&!e)return I`<ha-card><div class="body">
        ...
        >
          ...
          ${s?I`
                <materia-drag-confirm
                  ...
                  .label=${this._busy?this.config.busy_label??ke("cf_working",this.hass):i?d:h}
              ...
              `:I`
                <button
                  class="active-face"
                  aria-label=${this.config.deactivate_aria??ke("cf_tap_to_stop_aria",this.hass,{what:d})}
                  ?disabled=${t}
                  @click=${this._commit}
                >
                  ...
                  <div class="face-text">
                    ...
                    <span class="face-hint">
                      ${this._busy?this.config.busy_label??ke("cf_working",this.hass):this.config.deactivate_hint??ke("cf_tap_to_stop",this.hass)}
                    </span>
                  </div>
                  <div class="layer"></div>
                </button>
    ...
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){return 3}}customElements.define("materia-confirm",Vn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-confirm",name:"Materia Confirm",description:"Press-and-hold to commit a consequential action, with the warning in plain view instead of in a dialog. No tap path.",preview:!0});const Gn=[Ee,ze,Te,hi,ge,a`
    ha-card {
      background: transparent;
      box-shadow: none;
      border: none;
  ...
  `];class Xn extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    `];setConfig(e){super.setConfig(e),this._expanded??=null}_formData(){return{...this._config}}_sectionsSignature(){return[(this._config?.rows||[]).length,this._config?.status?"s":"",null!=this._config?.max?"m":"",this._config?.footnote?"f":""].join("|")}get _sections(){return[{title:"Scale",icon:"mdi:ruler",fields:[{name:"max",label:"Full-scale value (optional)",helper:"All bars share one scale, or they cannot be compared. Set this when the domain has a real ceiling — an inverter's kW rating, say — so the bars stop rescaling every time the largest reading moves. Leave empty to scale to the largest current value.",selector:{number:{min:0,step:"any",mode:"box"}}},{name:"precision",label:"Decimal places (optional)",helper:"Leave empty to choose per value: whole numbers above 100, one decimal below.",selector:{number:{min:0,max:4,step:1,mode:"box"}}}]},{title:"Words",icon:"mdi:text-long",fields:[{name:"eyebrow",label:"Block label (optional)",helper:"Sits top-left, uppercased — what this block is. Rendered as a quiet eyebrow, not a headline.",template:!0,selector:{text:{}}},{name:"meta",label:"Freshness note (optional)",helper:'Top-right, quieter still — how current the readings are ("bijgewerkt 1 min"). Templatable, so it can be a relative time.',template:!0,selector:{text:{}}},{name:"status",label:"Status line",helper:"The sentence the page is opened to read. Templatable, so the install supplies its own wording in its own language — this card ships no prose.",template:!0,selector:{text:{}}},{name:"status_icon",label:"Status icon",template:!0,selector:{icon:{}}},{name:"status_color",label:"Status icon colour",color:!0,template:!0,selector:{text:{}}},{name:"footnote",label:"Footnote (optional)",helper:"Quieter than the status it qualifies — a confidence note, a caveat, when the reading was taken.",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"background",label:"Card background",color:!0,selector:{text:{}}},{name:"background_on",label:"Card text",color:!0,selector:{text:{}}}]},{title:"Disabled",icon:"mdi:cancel",expanded:!1,fields:[Ie]}]}get _rowSchema(){return[{name:"entity",label:"Entity",selector:{entity:{}}},{name:"attribute",label:"Attribute (optional)",helper:"Read an attribute instead of the state — for a sensor that carries several numbers at once.",selector:{attribute:{}},context:{filter_entity:"entity"}},{name:"label",label:"Label (optional — defaults to the entity name)",template:!0,selector:{text:{}}},{name:"unit",label:"Unit (optional — defaults to the entity's own)",selector:{text:{}}},{name:"color",label:"Bar colour",color:!0,selector:{text:{}}}]}_rows(){return Array.isArray(this._config?.rows)?this._config.rows:[]}_commitRows(e){const t={...this._config};e.length?t.rows=e:delete t.rows,this._commit(t)}_addRow(){const e=[...this._rows(),{entity:""}];this._expanded=e.length-1,this._commitRows(e)}_removeRow(e){const t=[...this._rows()];t.splice(e,1),this._expanded===e&&(this._expanded=null),this._commitRows(t)}_moveRow(e,t){const i=[...this._rows()],[s]=i.splice(e,1);i.splice(t,0,s),this._expanded===e&&(this._expanded=t),this._commitRows(i)}_updateRow(e,t){const i=[...this._rows()];i[e]={...i[e],...t},this._commitRows(i)}_toggleExpand(e){this._expanded=this._expanded===e?null:e}_rowTitle(e,t){if(e.label&&!String(e.label).includes("{{"))return e.label;const i=e.entity?this.hass?.states[e.entity]:null;return i?.attributes?.friendly_name||e.entity||`Row ${t+1}`}_renderExtra(){const e=this._rows();return I`
      ...
      ${De((e,t)=>this._moveRow(e,t),e.map((e,t)=>I`
            <div class="option-card">
              <div class="option-header">
                <ha-icon class="drag-handle" icon="mdi:drag"></ha-icon>
    ...
    `}}customElements.define("materia-bars-editor",Xn);const Yn=new Set(["","none","null","unknown","unavailable","nan","undefined","-"]);class Kn extends(ci(Se(ce))){static properties={hass:{attribute:!1},config:{state:!0},_resolvedEyebrow:{state:!0},_resolvedMeta:{state:!0},_resolvedStatus:{state:!0},_resolvedStatusIcon:{state:!0},_resolvedFootnote:{state:!0},_resolvedStatusColor:{state:!0}};static styles=Gn;static getConfigElement(){return document.createElement("materia-bars-editor")}static getStubConfig(e){return{rows:(e?Object.keys(e.states):[]).filter(t=>t.startsWith("sensor.")&&Number.isFinite(Number(e.states[t]?.state))).slice(0,2).map(e=>({entity:e}))}}setConfig(e){this.config={...e}}updated(e){e.has("hass")&&this.hass&&(this._resolveField("eyebrow","_resolvedEyebrow"),this._resolveField("meta","_resolvedMeta"),this._resolveField("status","_resolvedStatus"),this._resolveField("status_icon","_resolvedStatusIcon"),this._resolveField("status_color","_resolvedStatusColor"),this._resolveField("footnote","_resolvedFootnote"),(this.config.rows||[]).forEach((e,t)=>{e?.label&&this._resolveTemplateValue(`row_label_${t}`,e.label)}))}_field(e,t){const i=this.config?.[e],s=this._isTemplate(i)?this[t]:i;return"string"==typeof s?s.trim():s}_rowLabel(e,t){const i=e?.label;if(!this._isTemplate(i))return i;const s=this._tplResults?.[`row_label_${t}`];return"string"==typeof s?s.trim():s}_raw(e){const t=e?.entity?this.hass?.states[e.entity]:void 0;if(t)return e.attribute?t.attributes?.[e.attribute]:t.state}_value(e){const t=this._raw(e);if(null==t)return null;if("boolean"==typeof t)return t?1:0;const i=String(t).trim();if(Yn.has(i.toLowerCase()))return null;const s=Number(i);return Number.isFinite(s)?s:null}get _rows(){return(this.config.rows||[]).filter(e=>e&&e.entity).map((e,t)=>{const i=this.hass?.states[e.entity],s=this._value(e);return{...e,st:i,value:s,unknown:null===s,label:this._rowLabel(e,t)||i?.attributes?.friendly_name||e.entity,unit:e.unit??(e.attribute?"":i?.attributes?.unit_of_measurement??""),color:e.color||"var(--md-sys-color-primary)"}})}_scale(e){const t=Number(this.config.max);if(Number.isFinite(t)&&t>0)return t;const i=e.filter(e=>!e.unknown).map(e=>Math.abs(e.value)),s=i.length?Math.max(...i):0;return s>0?s:null}_pct(e,t){if(e.unknown||!t)return"0%";return`${(100*Math.min(1,Math.abs(e.value)/t)).toFixed(2)}%`}_format(e){if(e.unknown)return null;const t=Number(this.config.precision),i=Number.isFinite(t)?t:this._autoPrecision(e.value),s=this.hass?.locale?.language||"en";return e.value.toLocaleString(s,{minimumFractionDigits:i,maximumFractionDigits:i})}_autoPrecision(e){const t=Math.abs(e);return t>=100?0:t>=10?1:t===Math.trunc(t)?0:1}render(){if(!this.hass||!this.config)return I``;const e=this._rows,t=this._scale(e),i=this._field("eyebrow","_resolvedEyebrow"),s=this._field("meta","_resolvedMeta"),n=this._field("status","_resolvedStatus"),a=this._field("status_icon","_resolvedStatusIcon"),o=this._field("status_color","_resolvedStatusColor"),r=this._field("footnote","_resolvedFootnote"),l=this.config.background??"var(--md-sys-color-surface-container-low, var(--card-background-color))",c=this.config.background_on??"var(--md-sys-color-on-surface)";return I`
      <ha-card>
        <div class="body" style="--mb-bg:${l};--mb-fg:${c};">
          ...
          ${e.length?I`<div class="rows">${e.map(e=>this._renderRow(e,t))}</div>`:I`<div class="note">${ke("bars_no_rows",this.hass)}</div>`}
    ...
    `}_renderRow(e,t){const i=this._format(e),s=e.unknown?ke("bars_aria_unknown",this.hass,{label:e.label}):`${e.label}: ${i}${e.unit?" "+e.unit:""}`;return I`
      <div class="row" role="group" aria-label=${s}>
        ...
        <span class="reading">
          ${e.unknown?I`<span class="value unknown" title=${ke("bars_unknown_title",this.hass)}>—</span>`:I`
                <span class="value">${i}</span>
                ${e.unit?I`<span class="unit">${e.unit}</span>`:V}
              `}
        </span>
      </div>
    `}getGridOptions(){return{columns:12,rows:"auto"}}getCardSize(){const e=(this.config?.rows||[]).length;return(this.config?.eyebrow||this.config?.meta?1:0)+Math.ceil(e/2)+(this.config?.status?1:0)+(this.config?.footnote?1:0)||1}}customElements.define("materia-bars",Kn),window.customCards=window.customCards||[],window.customCards.push({type:"materia-bars",name:"Materia Bars",description:"Labelled readings as comparable bars on one shared scale, with a status sentence. A missing reading draws as unknown, never as zero.",preview:!0});const Zn={primary:["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],secondary:["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],tertiary:["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],error:["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],device:["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-container":["var(--md-sys-color-primary-container)","var(--md-sys-color-on-primary-container)"],"secondary-container":["var(--md-sys-color-secondary-container)","var(--md-sys-color-on-secondary-container)"],"tertiary-container":["var(--md-sys-color-tertiary-container)","var(--md-sys-color-on-tertiary-container)"],"error-container":["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"],"device-container":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"],"primary-state":["var(--md-sys-color-primary)","var(--md-sys-color-on-primary)"],"secondary-state":["var(--md-sys-color-secondary)","var(--md-sys-color-on-secondary)"],"tertiary-state":["var(--md-sys-color-tertiary)","var(--md-sys-color-on-tertiary)"],"error-state":["var(--md-sys-color-error)","var(--md-sys-color-on-error)"],"device-state":["var(--md-sys-cust-color-device-container)","var(--md-sys-cust-color-on-device)"]},Qn=[Ee,ge,a`
    :host {
  ...
  `],Jn=[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"},{value:"device",label:"Device"},{value:"primary-container",label:"Primary Container"},{value:"secondary-container",label:"Secondary Container"},{value:"tertiary-container",label:"Tertiary Container"},{value:"error-container",label:"Error Container"},{value:"device-container",label:"Device Container"},{value:"primary-state",label:"Primary State"},{value:"secondary-state",label:"Secondary State"},{value:"tertiary-state",label:"Tertiary State"},{value:"error-state",label:"Error State"},{value:"device-state",label:"Device State"},{value:"battery",label:"Battery"}];customElements.define("materia-badge-editor",class extends He{get _actionRole(){const e=["toggle","perform-action","call-service"],t=this._config?.tap_action?.action;if(t&&"none"!==t)return e.includes(t);const i=this._config?.hold_action?.action;return!!i&&"none"!==i&&e.includes(i)}_formData(){return{show_state:!1,variant:"secondary",...this._actionRole?{shape:"leaf"}:{},...this._config}}_sectionsSignature(){return`${this._config?.entity?"entity":"none"}|${this._actionRole?"verb":"nav"}`}get _sections(){const e=!!this._config?.entity,t=[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,template:!0,selector:{text:{}}},{name:"icon",required:!0,template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},...this._actionRole?[{name:"shape",helper:"The asymmetric corners rise to the right; the mirrored one makes a facing pair.",selector:{select:{mode:"dropdown",options:[{value:"leaf",label:"Asymmetric corners"},{value:"leaf-flip",label:"Asymmetric corners — mirrored"}]}}}]:[],{name:"variant",selector:{select:{mode:"dropdown",options:Jn}}},{name:"secondary",label:"Secondary line",template:!0,helper:"One quiet line under the name. Left empty, a quiet badge shows its state word here instead.",selector:{text:{}}}]}];return e&&t.push({title:"State",icon:"mdi:state-machine",fields:[{name:"show_state",selector:{boolean:{}}},{name:"active_state",selector:{text:{}}},{name:"state_display",template:!0,selector:{text:{}}},{name:"busy_entity",label:"Also active while (optional)",helper:"A script/automation/timer whose 'on' also counts as active — for when the badge's own entity only reflects part of a longer sequence (e.g. a relay that pulses inside a multi-step unlock script).",selector:{entity:{domain:["script","automation","timer","input_boolean","binary_sensor"]}}}]}),t.push({title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"hold_action",helper:"A hold is deliberate by construction — the right slot for actions a stray tap must never fire.",selector:{ui_action:{default_action:"none"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}),t}});const ea={cover:"open",lock:["locked","locking"],vacuum:"cleaning",media_player:"playing",climate:"heat",alarm_control_panel:"armed_away",timer:"active"},ta=new Set(["toggle","perform-action","call-service"]);class ia extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedStateDisplay:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0},_resolvedSecondary:{state:!0}};static getConfigElement(){return document.createElement("materia-badge-editor")}static getStubConfig(e){const t=(e?Object.keys(e.states):[]).find(e=>e.startsWith("light.")||e.startsWith("switch."))||"";return{name:"Badge",icon:"mdi:power-plug",variant:"primary",show_state:!1,entity:t}}static styles=[Te,Qn];setConfig(e){if(!e.icon)throw new Error("icon is required");if(!e.name)throw new Error("name is required");this.config={show_state:!1,variant:"secondary",...e}}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&(this._resolveField("state_display","_resolvedStateDisplay"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"),this._resolveField("secondary","_resolvedSecondary"),this._syncTimerTick())}_syncTimerTick(){const e=(this.config.show_state||this._isActionRole)&&this.config.entity?.startsWith("timer.")&&"active"===this.hass.states[this.config.entity]?.state;e&&!this._timerTick?this._timerTick=setInterval(()=>this.requestUpdate(),1e3):!e&&this._timerTick&&(clearInterval(this._timerTick),this._timerTick=null)}_timerRemaining(e){const t=Date.parse(e.attributes?.finishes_at);if(Number.isNaN(t))return null;const i=Math.max(0,Math.ceil((t-Date.now())/1e3));return`${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`}_timerProgress(e){const t=Date.parse(e?.attributes?.finishes_at),i=String(e?.attributes?.duration||"").split(":").reduce((e,t)=>60*e+Number(t),0);if(Number.isNaN(t)||!i)return null;const s=Math.max(0,(t-Date.now())/1e3);return Math.min(1,Math.max(0,1-s/i))}_isActive(e){if(!e)return!1;const t=e.state,i=this.config.active_state;if(null!=i)return Array.isArray(i)?i.includes(t):t===String(i);const s=e.entity_id.split(".")[0],n=ea[s]||"on";return Array.isArray(n)?n.includes(t):t===n}get _isBusy(){const e=this.config.busy_entity;return!!e&&"on"===this.hass?.states[e]?.state}get _isActionRole(){const e=this.config.tap_action?.action;if(e&&"none"!==e)return ta.has(e);const t=this.config.hold_action?.action;return!(!t||"none"===t)&&ta.has(t)}_getBatteryColors(e){const t=parseFloat(e?.state);return Number.isNaN(t)?["var(--ha-card-background)","var(--primary-text-color)"]:t<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:t<20?["var(--md-sys-cust-color-warning-container, #ffecb3)","var(--md-sys-cust-color-on-warning-container, #6d4c00)"]:["var(--ha-card-background)","var(--primary-text-color)"]}get _templatesReady(){const e=this.config;return(!this._isTemplate(e.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(e.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(e.state_display)||void 0!==this._resolvedStateDisplay)&&((!this._isTemplate(e.icon)||void 0!==this._resolvedIcon)&&((!this._isTemplate(e.name)||void 0!==this._resolvedName)&&(!this._isTemplate(e.secondary)||void 0!==this._resolvedSecondary)))))}render(){if(!this.hass||!this.config)return I``;const e=this.config.entity,t=e?this.hass.states[e]:void 0,i=!!e&&this._isUnavailable(t),s=!i&&(this._isActive(t)||this._isBusy),n=this.config.variant||"secondary",a=this.config.show_state,o=this._isActionRole;let r=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,l=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on;const c=["primary","tertiary","error","primary-container","secondary-container","error-container","device-container"];let h=!!r;if(!r)if("battery"===n){const[e,i]=this._getBatteryColors(t);r=e,l=i,h="var(--ha-card-background)"!==e}else if(c.includes(n)||s&&e){const t="error"===n||"error-state"===n||n.endsWith("-container")?n:`${n.replace(/-state$/,"")}-container`,i=Zn[t]||Zn[n]||Zn.secondary;r=i[0],l=l||i[1],h=!(!s||!e)}else r="var(--ha-card-background)",l=l||"var(--secondary-text-color)";l=l||"var(--primary-text-color)";const d=h&&("error"===n||"error-state"===n)&&(!e||s),p=s?"active":"inactive";let u="";if(a&&i)u=ke("unavailable",this.hass);else if(a&&t){const i=this.config.state_display&&(this.config.state_display.includes("{{")||this.config.state_display.includes("{%"));if(this._resolvedStateDisplay&&i)u=this._resolvedStateDisplay;else if(this.config.state_display&&!i)u=this.config.state_display;else if(e?.startsWith("timer.")&&"active"===t.state&&this._timerRemaining(t))u=this._timerRemaining(t);else{const e=t.state,i=Number(e);if(""===e||null==e||Number.isNaN(i))u=this.hass.formatEntityState?.(t)??e;else{const e=t.attributes?.unit_of_measurement,s=Math.round(100*i)/100;u=e?"%"===e?`${s}%`:`${s} ${e}`:`${s}`}}u=this._capitalize(u)}const m=this._isTemplate(this.config.secondary)?this._resolvedSecondary||"":this.config.secondary,g=o?"leaf-flip"===this.config.shape?"leaf-flip":"leaf":"",f=I`<ha-icon .icon=${this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon} style="color: ${l};"></ha-icon>`,_=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,b=this._holdHint?ke("badge_hold_hint",this.hass):m||(!h&&a?u:""),v=o&&e?.startsWith("timer.")&&"active"===t?.state?this._timerProgress(t):null,y=`badge ${o?`action ${g}`:""} ${p} ${this._firedFlash?"fired":""} ${h?"open":""} ${d?"alarm":""} ${i?"unavailable":""}`;return I`
      ...
      >
        ...
        ${o?I`
              ...
              ${a?I`<div class="value-wrap"><span class="value">${u}</span></div>`:""}
            `:I`
              <div class="row-top">
                <div class="icon-cell">${f}</div>
                ${a?I`<span class="value">${u}</span>`:""}
              </div>
              <div class="text">
                <div class="name">${_}</div>
                ${b?I`<div class="sub">${b}</div>`:""}
  ...
  `];customElements.define("materia-pill-editor",class extends He{_formData(){return{background:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",template:!0,selector:{text:{}}},{name:"icon",template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},{name:"state_display",template:!0,selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Color",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}},{name:"background",selector:{boolean:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{}}}]}]}});class oa extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0},_resolvedStateDisplay:{state:!0}};static getConfigElement(){return document.createElement("materia-pill-editor")}static getStubConfig(e){const t=(e?Object.keys(e.states):[]).find(e=>e.startsWith("sensor."))||"";return{entity:t,name:"",icon:"mdi:information-outline"}}static styles=[Te,aa];setConfig(e){if(!e.entity)throw new Error("entity is required");this.config={icon:"mdi:information-outline",...e}}_classify(e){const t=this.config.ranges||[];if(!t.length)return{label:"",color:""};const i=parseFloat(e);if(Number.isNaN(i))return{label:"",color:""};for(const e of t)if(null==e.max||i<=e.max)return{label:e.label,color:e.color};return{label:"",color:""}}get _templatesReady(){const e=this.config;return(!this._isTemplate(e?.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(e?.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(e?.icon)||void 0!==this._resolvedIcon)&&(!this._isTemplate(e?.name)||void 0!==this._resolvedName)))}updated(e){e.has("hass")&&this.hass&&(this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"),this._resolveField("state_display","_resolvedStateDisplay"))}render(){if(!this.hass||!this.config)return I``;if(!this._templatesReady)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),i=this._isTemplate(this.config.name)?this._resolvedName:this.config.name||e?.attributes?.friendly_name||this.config.entity,s=this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon||e?.attributes?.icon||"",n=e?.attributes?.unit_of_measurement||"",a=e?.state??"",o=this.config.ranges||[],r=this._classify(a);let l;l=t?"Unavailable":this.config.state_display?this._isTemplate(this.config.state_display)?this._resolvedStateDisplay??"":this.config.state_display:o.length?n?`${a} · ${r.label||i}`:a:n?`${this._capitalize(a)} ${n}`:this._capitalize(a);const c=o.length?t?i:n||(r.label||i):"",h=this._resolvedColor||this.config.color||"var(--ha-card-background, var(--card-background-color))",d=this._resolvedColorOn||this.config.color_on||"var(--primary-text-color)",p=!1===this.config.background||"none"===this.config.background;return I`
    ...
    `}_handleTap(){this._handleAction(this.config.tap_action||{action:"more-info"})}getGridOptions(){return{columns:6,rows:"auto"}}getCardSize(){return 1}}customElements.define("materia-pill",oa),window.customCards=window.customCards||[],window.customCards.push({type:"materia-pill",name:"Materia Pill",description:"Compact info pill for sensors, weather, and status indicators.",preview:!0});const ra=[Ee,ze,Te,a`
  :host {
    position: relative;
    z-index: 1;
  }
...
`];class la extends He{static properties={_expanded:{state:!0}};static styles=[He.styles,a`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
      ...
      <ha-card>
        <div class="trigger ${t?"unavailable":""} ${this._open?"above"===this._pos?"open-above":"open-below":""}" style=${r} @click=${this._toggle}>
          ...
          <div class="text-container">
            ...
            <div class="value">
              <span class="value-main">${n}</span>
              ${a?I`<span class="value-sep">${this.config.substate_separator||"•"}</span><span class="value-sub">${a}</span>`:""}
            </div>
          </div>
    ...
    `}getCardSize(){return 1}}customElements.define("materia-menu",ca),window.customCards=window.customCards||[],window.customCards.push({type:"materia-menu",name:"Materia Menu",description:"M3 vertical dropdown menu for select entities.",preview:!0});const ha=a`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-progress-editor",class extends He{_formData(){return{show_times:!0,seekable:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"show_times",selector:{boolean:{}}},{name:"seekable",selector:{boolean:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Wave color",color:!0,template:!0,selector:{text:{}}}]}]}});let da=0;class pa extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_w:{state:!0},_resolvedColor:{state:!0}};static styles=ha;static getConfigElement(){return document.createElement("materia-media-progress-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("media_player."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config=e,this._cid??="mp-clip-"+ ++da}_position(){const e=this.hass?.states[this.config.entity];if(!e)return{pos:0,dur:0,playing:!1,live:!1};const t=Number(e.attributes.media_duration)||0;let i=Number(e.attributes.media_position)||0;const s="playing"===e.state,n=e.attributes.media_position_updated_at;s&&n&&(i+=(Date.now()-new Date(n).getTime())/1e3);const a=`${this.config.entity}|${e.attributes.media_content_id??e.attributes.media_title??""}`;return a!==this._latchKey&&(this._latchKey=a,this._live=!1),s?t>0&&i>=t-.25&&(this._live=!0):this._live=!1,t&&(i=Math.min(i,t)),{pos:Math.max(0,i),dur:t,playing:s,live:this._live}}_fmt(e){e=Math.max(0,Math.round(e));const t=Math.floor(e/3600),i=Math.floor(e%3600/60),s=e%60,n=e=>String(e).padStart(2,"0");return t>0?`${t}:${n(i)}:${n(s)}`:`${i}:${n(s)}`}_wavePath(e,t){let i="";for(let s=e;s<=t;s+=2){const e=14-2*Math.sin(2*Math.PI*s/32);i+=`${i?" L":"M"} ${s.toFixed(1)} ${e.toFixed(1)}`}return i||"M 0 14"}firstUpdated(){const e=this.shadowRoot?.querySelector(".bar");e&&(this._w=e.clientWidth,this._ro=new ResizeObserver(e=>{this._w=e[0].contentRect.width}),this._ro.observe(e))}updated(){const e=this.shadowRoot;this._clipRect=e?.querySelector("clipPath rect"),this._thumbEl=e?.querySelector(".thumb"),this._trackEl=e?.querySelector(".track"),this._posEl=e?.querySelector(".time");"playing"===this.hass?.states[this.config.entity]?.state&&!this._live?this._startLoop():this._stopLoop(),this.hass&&this._resolveField("color","_resolvedColor")}_startLoop(){if(this._raf)return;const e=()=>{this._raf=requestAnimationFrame(e),this._tickDom()};this._raf=requestAnimationFrame(e)}_tickDom(){const{pos:e,dur:t,live:i}=this._position(),s=this._w||300,n=(i?1:t>0?Math.min(1,e/t):0)*s;this._clipRect&&this._clipRect.setAttribute("width",Math.max(0,n)),this._thumbEl&&this._thumbEl.setAttribute("x",n-2),this._trackEl&&this._trackEl.setAttribute("x1",n),this._posEl&&(this._posEl.textContent=this._fmt(e)),i&&this._stopLoop()}_stopLoop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=null}_fullWave(e){return this._waveW!==e&&(this._waveW=e,this._wavePathCache=this._wavePath(-32,e+32)),this._wavePathCache}disconnectedCallback(){super.disconnectedCallback(),this._stopLoop(),this._ro?.disconnect()}_seek(e){if(!1===this.config.seekable)return;const{dur:t}=this._position();if(!t)return;const i=e.currentTarget.getBoundingClientRect(),s=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width));this._callService("media_player","media_seek",{entity_id:this.config.entity,seek_position:s*t})}render(){if(!this.hass||!this.config)return I``;const e=this.hass.states[this.config.entity],t=this._isUnavailable(e),{pos:i,dur:s,playing:n,live:a}=this._position(),o=this._w||300,r=(a?1:s>0?Math.min(1,i/s):0)*o,l=!1!==this.config.show_times,c=this._resolvedColor||this.config.color;return I`
      <ha-card>
          ...
          <div class="bar" @pointerdown=${this._seek}>
            <svg width="100%" height=${28}>
              ...
              <g clip-path="url(#${this._cid})">
                <path class="wave ${n?"playing":""}" d=${this._fullWave(o)}></path>
              </g>
    ...
    `}getCardSize(){return 1}}customElements.define("materia-media-progress",pa),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media-progress",name:"Materia Media Progress",description:"Wavy (M3 expressive) media seek bar with elapsed/duration and tap-to-seek.",preview:!0});const ua=a`
  :host {
    display: block;
  }
...
`;customElements.define("materia-media-editor",class extends He{_formData(){return{show_art:!0,...this._config}}get _sections(){return[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",required:!0,selector:{entity:{domain:"media_player"}}},{name:"name",label:"Title",template:!0,selector:{text:{}}},{name:"subtitle",template:!0,selector:{text:{}}},{name:"image",helper:"Defaults to the entity's album art",template:!0,selector:{text:{}}},{name:"fallback_image",helper:"Shown when there's no art",selector:{text:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"show_art",selector:{boolean:{}}},{name:"art_size",label:"Art size (px)",selector:{number:{min:80,max:480,mode:"box"}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}}]}]}});class ma extends(Se(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedName:{state:!0},_resolvedSubtitle:{state:!0},_resolvedImage:{state:!0}};static styles=ua;static getConfigElement(){return document.createElement("materia-media-editor")}static getStubConfig(e){const t=Object.keys(e?.states||{}).find(e=>e.startsWith("media_player."))||"";return{entity:t}}setConfig(e){if(!e.entity)throw new Error("entity is required");this.config=e}updated(e){if(e.has("hass")&&this.hass){this._resolveField("name","_resolvedName"),this._resolveField("subtitle","_resolvedSubtitle"),this._resolveField("image","_resolvedImage");const e=this._stateObj?.attributes?.media_title;e&&this._lastTrack&&e!==this._lastTrack&&(this._beat=!0,this.requestUpdate(),clearTimeout(this._beatTimer),this._beatTimer=setTimeout(()=>{this._beat=!1,this.requestUpdate()},900)),this._lastTrack=e}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._beatTimer)}get _stateObj(){return this.hass?.states[this.config.entity]}get _title(){if(this.config.name)return this._isTemplate(this.config.name)?this._resolvedName:this.config.name;const e=this._stateObj?.attributes;return e?.media_title||e?.friendly_name||""}get _subtitle(){if(this.config.subtitle)return this._isTemplate(this.config.subtitle)?this._resolvedSubtitle:this.config.subtitle;const e=this._stateObj?.attributes;return e?.media_artist||e?.media_album_name||""}get _image(){if(this.config.image){const e=this._isTemplate(this.config.image)?this._resolvedImage:this.config.image;if(e)return e}return this._stateObj?.attributes?.entity_picture||this.config.fallback_image||""}_tap(){this._handleAction(this.config.tap_action||{action:"more-info"})}render(){if(!this.hass||!this.config)return I``;const e=this._stateObj,t=this._isUnavailable(e),i=this._image,s=this._title,n=this._subtitle,a=this.config.fallback_image,o=[i,a&&a!==i?a:null].filter(Boolean).map(e=>`url('${e}')`).join(", "),r=`${this.config.art_size?`--mm-art:${this.config.art_size}px;`:""}${o?`background-image:${o};`:""}`,l=!t&&!!e?.attributes?.media_title&&!["off","idle","standby"].includes(e.state),c=l&&"paused"===e.state;return I`
      <ha-card>
        <div class="wrap ${t?"unavailable":""} ${l?"editorial":""} ${this._beat?"beat":""} ${c?"paused":""}" @click=${this._tap}>
          ...
          ${n?I`<div class="subtitle">${n}</div>`:V}
        </div>
      </ha-card>
    `}getCardSize(){return 4}}customElements.define("materia-media",ma),window.customCards=window.customCards||[],window.customCards.push({type:"materia-media",name:"Materia Media",description:"Now-playing card — album art, title and subtitle (all templatable).",preview:!0});const ga=a`
  :host {
    display: block;
  }
