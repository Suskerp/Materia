            ...
            ${this.config.lock?I`
                  <div class="panel open ${s?"done":""}">
                    ...
                    <materia-drag-confirm
                      ...
                      .label=${"unlocking"===this._lockState?we("lock_unlocking",this.hass):"locking"===this._lockState?we("lock_locking",this.hass):s?"hold"===this.config.open_gesture?we("lock_hold_to_lock",this.hass):we("lock_slide_to_lock",this.hass):"hold"===this.config.open_gesture?we("lock_hold_to_unlock",this.hass):we("db_slide_hint",this.hass)}
