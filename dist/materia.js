      ...
      <ha-card>
        <div class="sheet">
          <div class="echo">
            ...
            <span class="headline">${e.head}</span>
            <span class="subline">${e.sub}</span>
          </div>
