...
const Ns=Cs(class extends Ss{constructor(){super(...arguments),this.key=W}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(((e,t=ks)=>{e._$AH=t})(e),this.key=t),i}}),Ls=[Ae,Se,Ee,ge,n`
  ...
  `];class Js extends Ie{static properties={_expanded:{state:!0},_editingCard:{state:!0}};static styles=[Ie.styles,n`
      .options-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
