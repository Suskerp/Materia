            ...
            ${this._expandedButton===t?I`
                  <div class="button-body">
                    <materia-button-editor
                      .hass=${this.hass}
                      ${Fs(i=>{i&&i.__materiaIdx!==t&&(i.__materiaIdx=t,i.setConfig(e))})}
  ...
  `],Zs=[{value:"primary",label:"Primary"},{value:"secondary",label:"Secondary"},{value:"tertiary",label:"Tertiary"},{value:"error",label:"Error"},{value:"device",label:"Device"},{value:"primary-container",label:"Primary Container"},{value:"secondary-container",label:"Secondary Container"},{value:"tertiary-container",label:"Tertiary Container"},{value:"error-container",label:"Error Container"},{value:"device-container",label:"Device Container"},{value:"primary-state",label:"Primary State"},{value:"secondary-state",label:"Secondary State"},{value:"tertiary-state",label:"Tertiary State"},{value:"error-state",label:"Error State"},{value:"device-state",label:"Device State"},{value:"battery",label:"Battery"}];customElements.define("materia-badge-editor",class extends Ie{get _actionRole(){const e=["toggle","perform-action","call-service"],t=this._config?.tap_action?.action;if(t&&"none"!==t)return e.includes(t);const i=this._config?.hold_action?.action;return!!i&&"none"!==i&&e.includes(i)}_formData(){return{show_state:!1,variant:"secondary",...this._actionRole?{shape:"leaf"}:{},...this._config}}_sectionsSignature(){return`${this._config?.entity?"entity":"none"}|${this._actionRole?"verb":"nav"}`}get _sections(){const e=!!this._config?.entity,t=[{title:"Content",icon:"mdi:card-text-outline",fields:[{name:"entity",selector:{entity:{}}},{name:"name",required:!0,template:!0,selector:{text:{}}},{name:"icon",required:!0,template:!0,selector:{icon:{}},context:{icon_entity:"entity"}},...this._actionRole?[{name:"shape",helper:"The asymmetric corners rise to the right; the mirrored one makes a facing pair.",selector:{select:{mode:"dropdown",options:[{value:"leaf",label:"Asymmetric corners"},{value:"leaf-flip",label:"Asymmetric corners — mirrored"}]}}}]:[],{name:"variant",selector:{select:{mode:"dropdown",options:Zs}}},{name:"tag",label:"Gesture tag",template:!0,helper:'Leave empty for none. The word "auto" shows the configured gesture — hold when one is set, tap otherwise.',selector:{text:{}}},{name:"secondary",label:"Secondary line",template:!0,helper:"One quiet line under the name. Left empty, a quiet badge shows its state word here instead.",selector:{text:{}}}]}];return e&&t.push({title:"State",icon:"mdi:state-machine",fields:[{name:"show_state",selector:{boolean:{}}},{name:"active_state",selector:{text:{}}},{name:"state_display",template:!0,selector:{text:{}}}]}),t.push({title:"Stages",icon:"mdi:chart-timeline",expanded:!1,fields:[{name:"stages",label:"Stage track",helper:"List of { entity, state? } — one bar along the bottom per stage, lit while the entity matches. state may be a single value or a list; omitted, the domain's active state applies (a timer lights while running).",selector:{object:{}}}]},{title:"Appearance",icon:"mdi:palette-outline",fields:[{name:"color",label:"Background",color:!0,template:!0,selector:{text:{}}},{name:"color_on",label:"Text / icon",color:!0,template:!0,selector:{text:{}}}]},{title:"Actions",icon:"mdi:gesture-tap",fields:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"hold_action",helper:"A hold is deliberate by construction — the right slot for actions a stray tap must never fire.",selector:{ui_action:{default_action:"none"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}),t}});const Qs={cover:"open",lock:["locked","locking"],vacuum:"cleaning",media_player:"playing",climate:"heat",alarm_control_panel:"armed_away",timer:"active"},Js=new Set(["toggle","perform-action","call-service"]);class eo extends(Ce(ce)){static properties={hass:{attribute:!1},config:{state:!0},_resolvedStateDisplay:{state:!0},_resolvedColor:{state:!0},_resolvedColorOn:{state:!0},_resolvedIcon:{state:!0},_resolvedName:{state:!0},_resolvedTag:{state:!0},_resolvedSecondary:{state:!0}};static getConfigElement(){return document.createElement("materia-badge-editor")}static getStubConfig(e){const t=(e?Object.keys(e.states):[]).find(e=>e.startsWith("light.")||e.startsWith("switch."))||"";return{name:"Badge",icon:"mdi:power-plug",variant:"primary",show_state:!1,active_state:"on",entity:t}}static styles=[Ae,Ks];setConfig(e){if(!e.icon)throw new Error("icon is required");if(!e.name)throw new Error("name is required");this.config={show_state:!1,active_state:"on",variant:"secondary",...e}}updated(e){super.updated?.(e),e.has("hass")&&this.hass&&(this._resolveField("state_display","_resolvedStateDisplay"),this._resolveField("color","_resolvedColor"),this._resolveField("color_on","_resolvedColorOn"),this._resolveField("icon","_resolvedIcon"),this._resolveField("name","_resolvedName"),this._resolveField("tag","_resolvedTag"),this._resolveField("secondary","_resolvedSecondary"),this._syncTimerTick())}_syncTimerTick(){const e=(this.config.show_state||this._isActionRole)&&this.config.entity?.startsWith("timer.")&&"active"===this.hass.states[this.config.entity]?.state;e&&!this._timerTick?this._timerTick=setInterval(()=>this.requestUpdate(),1e3):!e&&this._timerTick&&(clearInterval(this._timerTick),this._timerTick=null)}_timerRemaining(e){const t=Date.parse(e.attributes?.finishes_at);if(Number.isNaN(t))return null;const i=Math.max(0,Math.ceil((t-Date.now())/1e3));return`${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`}_timerProgress(e){const t=Date.parse(e?.attributes?.finishes_at),i=String(e?.attributes?.duration||"").split(":").reduce((e,t)=>60*e+Number(t),0);if(Number.isNaN(t)||!i)return null;const s=Math.max(0,(t-Date.now())/1e3);return Math.min(1,Math.max(0,1-s/i))}_isActive(e){if(!e)return!1;const t=e.state,i=this.config.active_state;if(null!=i)return Array.isArray(i)?i.includes(t):t===String(i);const s=e.entity_id.split(".")[0],o=Qs[s]||"on";return Array.isArray(o)?o.includes(t):t===o}get _isActionRole(){const e=this.config.tap_action?.action;if(e&&"none"!==e)return Js.has(e);const t=this.config.hold_action?.action;return!(!t||"none"===t)&&Js.has(t)}_stageActive(e){const t=e?.entity?this.hass.states[e.entity]:void 0;if(!t)return!1;if(null!=e.state)return Array.isArray(e.state)?e.state.map(String).includes(t.state):t.state===String(e.state);const i=Qs[t.entity_id.split(".")[0]]||"on";return Array.isArray(i)?i.includes(t.state):t.state===i}_renderStages(){const e=this.config.stages;return Array.isArray(e)&&e.length?I`
    ...
    `:""}_autoTag(){const e=e=>e?.action&&"none"!==e.action;return e(this.config.hold_action)?we("badge_tag_hold",this.hass):e(this.config.tap_action)?we("badge_tag_tap",this.hass):""}_getBatteryColors(e){const t=parseFloat(e?.state);return Number.isNaN(t)?["var(--ha-card-background)","var(--primary-text-color)"]:t<10?["var(--md-sys-color-error-container)","var(--md-sys-color-on-error-container)"]:t<20?["var(--md-sys-cust-color-warning-container, #ffecb3)","var(--md-sys-cust-color-on-warning-container, #6d4c00)"]:["var(--ha-card-background)","var(--primary-text-color)"]}get _templatesReady(){const e=this.config;return(!this._isTemplate(e.color)||void 0!==this._resolvedColor)&&((!this._isTemplate(e.color_on)||void 0!==this._resolvedColorOn)&&((!this._isTemplate(e.state_display)||void 0!==this._resolvedStateDisplay)&&((!this._isTemplate(e.icon)||void 0!==this._resolvedIcon)&&((!this._isTemplate(e.name)||void 0!==this._resolvedName)&&((!this._isTemplate(e.tag)||void 0!==this._resolvedTag)&&(!this._isTemplate(e.secondary)||void 0!==this._resolvedSecondary))))))}render(){if(!this.hass||!this.config)return I``;const e=this.config.entity,t=e?this.hass.states[e]:void 0,i=!!e&&this._isUnavailable(t),s=!i&&this._isActive(t),o=this.config.variant||"secondary",n=this.config.show_state,a=this._isActionRole;let r=this._isTemplate(this.config.color)?(this._resolvedColor||"").trim():this.config.color,l=this._isTemplate(this.config.color_on)?(this._resolvedColorOn||"").trim():this.config.color_on;const c=["primary","tertiary","error","primary-container","secondary-container","error-container","device-container"];let d=!!r;if(!r)if("battery"===o){const[e,i]=this._getBatteryColors(t);r=e,l=i,d="var(--ha-card-background)"!==e}else if(c.includes(o)||s&&e){const e="error"===o||"error-state"===o||o.endsWith("-container")?o:`${o.replace(/-state$/,"")}-container`,t=Ys[e]||Ys[o]||Ys.secondary;r=t[0],l=l||t[1],d=!0}else r="var(--ha-card-background)",l=l||"var(--secondary-text-color)";l=l||"var(--primary-text-color)";const h=d&&("error"===o||"error-state"===o)&&(!e||s),p=s?"active":"inactive";let u="";if(n&&i)u="Unavailable";else if(n&&t){const i=this.config.state_display&&(this.config.state_display.includes("{{")||this.config.state_display.includes("{%"));if(this._resolvedStateDisplay&&i)u=this._resolvedStateDisplay;else if(this.config.state_display&&!i)u=this.config.state_display;else if(e?.startsWith("timer.")&&"active"===t.state&&this._timerRemaining(t))u=this._timerRemaining(t);else{const e=t.state,i=Number(e);if(""===e||null==e||Number.isNaN(i))u=e;else{const e=t.attributes?.unit_of_measurement,s=Math.round(100*i)/100;u=e?"%"===e?`${s}%`:`${s} ${e}`:`${s}`}}u=this._capitalize(u)}let m="";this.config.tag&&(m=this._isTemplate(this.config.tag)?this._resolvedTag||"":"auto"===this.config.tag?this._autoTag():this.config.tag);const g=this._isTemplate(this.config.secondary)?this._resolvedSecondary||"":this.config.secondary,f=a?"leaf-flip"===this.config.shape?"leaf-flip":"leaf":"",_=Array.isArray(this.config.stages)&&this.config.stages.length>0,b=I`<ha-icon .icon=${this._isTemplate(this.config.icon)?this._resolvedIcon:this.config.icon} style="color: ${l};"></ha-icon>`,v=this._isTemplate(this.config.name)?this._resolvedName:this.config.name,y=this._holdHint?we("badge_hold_hint",this.hass):g||(!d&&n?u:""),x=a&&e?.startsWith("timer.")&&"active"===t?.state?this._timerProgress(t):null,w=`badge ${a?`action ${f}`:""} ${p} ${this._firedFlash?"fired":""} ${d?"open":""} ${h?"alarm":""} ${_?"has-stages":""} ${i?"unavailable":""}`;return I`
      ...
      >
        ...
        ${a?I`
              ${null!=x?I`<div class="run-fill" style="height: ${Math.round(100*x)}%;"></div>`:""}
              <div class="icon-cell">${b}</div>
              <div class="text">
                <div class="name">${v}</div>
                ${y?I`<div class="sub">${y}</div>`:""}
              </div>
